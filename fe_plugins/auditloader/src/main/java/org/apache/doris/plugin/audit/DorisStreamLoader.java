...
public class DorisStreamLoader {
    ...
    private HttpURLConnection getConnection(String urlStr, String label, String clusterToken) throws IOException {
        ...
        conn.addRequestProperty("columns", "query_id, `time`, client_ip, user, db, query_tables, state, error_code, error_message, " +
    ...
    private String toCurl(HttpURLConnection conn) {
        ...
        sb.append("-H \"").append("columns\":").append("\"query_id, time, client_ip, user, db, query_tables, state, error_code, " +
