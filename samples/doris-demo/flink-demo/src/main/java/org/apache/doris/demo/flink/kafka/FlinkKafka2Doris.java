...
public class FlinkKafka2Doris {
    //kafka address
    private static final String bootstrapServer = "10.220.147.155:9092,10.220.147.156:9092,10.220.147.157:9092";
    //kafka groupName
    private static final String groupName = "test_flink_doris_group";
    //kafka topicName
    private static final String topicName = "test_flink_doris";
    //doris ip port
    private static final String hostPort = "10.220.146.10:8030";
    //doris dbName
