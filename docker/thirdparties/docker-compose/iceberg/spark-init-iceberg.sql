...
INSERT INTO complex_parquet_v2_schema_change (id, rename_col8, rename_col9, rename_col10,rename_col1, rename_col2, rename_col3,rename_col4, rename_col5, rename_col6,rename_col7, col_add, col_add2)
VALUES
  (11,100, 11.1, 110.12345,array(11, 12, 13), array(11.1, 12.2, 13.3), array(110.1234, 120.5678, 130.9876),map(11, 1100, 12, 1200), map(11, 11.1, 12, 12.2), map(11, 110.12345, 12, 120.98765),named_struct('add', 11.1, 'x', 11, 'y', 11.1),110, 120),
  (12,200, 22.2, 220.12345,array(14, 15), array(14.4, 15.5), array(140.1234, 150.5678),map(13, 1300, 14, 1400), map(13, 13.3, 14, 14.4), map(13, 130.12345, 14, 140.98765),named_struct('add', 22.2, 'x', 12, 'y', 12.2),130, 140),
  (13,300, 33.3, 330.12345,array(16), array(16.6), array(160.1234),map(15, 1500), map(15, 15.5), map(15, 150.12345),named_struct('add', 33.3, 'x', 13, 'y', 13.3),150, 160),
...
ALTER TABLE complex_orc_v2_schema_change CHANGE COLUMN col1.element type bigint;
ALTER TABLE complex_orc_v2_schema_change CHANGE COLUMN col2.element type double;
ALTER TABLE complex_orc_v2_schema_change CHANGE COLUMN col3.element type decimal(20,4);
...
ALTER TABLE complex_orc_v2_schema_change CHANGE COLUMN col6.value type decimal(20,5);
...
ALTER TABLE complex_orc_v2_schema_change CHANGE COLUMN col7.z type decimal(20,5);
...
alter table complex_orc_v2_schema_change CHANGE COLUMN col10 col10 decimal(20,5);
...
alter table complex_orc_v2_schema_change CHANGE COLUMN rename_col9 after rename_col8;
alter table complex_orc_v2_schema_change CHANGE COLUMN rename_col10 after rename_col9;
...
INSERT INTO complex_orc_v2_schema_change (id, rename_col8, rename_col9, rename_col10,rename_col1, rename_col2, rename_col3,rename_col4, rename_col5, rename_col6,rename_col7, col_add, col_add2)
VALUES
  (11,100, 11.1, 110.12345,array(11, 12, 13), array(11.1, 12.2, 13.3), array(110.1234, 120.5678, 130.9876),map(11, 1100, 12, 1200), map(11, 11.1, 12, 12.2), map(11, 110.12345, 12, 120.98765),named_struct('add', 11.1, 'x', 11, 'y', 11.1),110, 120),
  (12,200, 22.2, 220.12345,array(14, 15), array(14.4, 15.5), array(140.1234, 150.5678),map(13, 1300, 14, 1400), map(13, 13.3, 14, 14.4), map(13, 130.12345, 14, 140.98765),named_struct('add', 22.2, 'x', 12, 'y', 12.2),130, 140),
  (13,300, 33.3, 330.12345,array(16), array(16.6), array(160.1234),map(15, 1500), map(15, 15.5), map(15, 150.12345),named_struct('add', 33.3, 'x', 13, 'y', 13.3),150, 160),
...
ALTER TABLE complex_orc_v1_schema_change CHANGE COLUMN col1.element type bigint;
ALTER TABLE complex_orc_v1_schema_change CHANGE COLUMN col2.element type double;
ALTER TABLE complex_orc_v1_schema_change CHANGE COLUMN col3.element type decimal(20,4);
...
ALTER TABLE complex_orc_v1_schema_change CHANGE COLUMN col6.value type decimal(20,5);
...
ALTER TABLE complex_orc_v1_schema_change CHANGE COLUMN col7.z type decimal(20,5);
...
alter table complex_orc_v1_schema_change CHANGE COLUMN col10 col10 decimal(20,5);
...
alter table complex_orc_v1_schema_change CHANGE COLUMN rename_col9 after rename_col8;
alter table complex_orc_v1_schema_change CHANGE COLUMN rename_col10 after rename_col9;
...
INSERT INTO complex_orc_v1_schema_change (id, rename_col8, rename_col9, rename_col10,rename_col1, rename_col2, rename_col3,rename_col4, rename_col5, rename_col6,rename_col7, col_add, col_add2)
VALUES
  (11,100, 11.1, 110.12345,array(11, 12, 13), array(11.1, 12.2, 13.3), array(110.1234, 120.5678, 130.9876),map(11, 1100, 12, 1200), map(11, 11.1, 12, 12.2), map(11, 110.12345, 12, 120.98765),named_struct('add', 11.1, 'x', 11, 'y', 11.1),110, 120),
  (12,200, 22.2, 220.12345,array(14, 15), array(14.4, 15.5), array(140.1234, 150.5678),map(13, 1300, 14, 1400), map(13, 13.3, 14, 14.4), map(13, 130.12345, 14, 140.98765),named_struct('add', 22.2, 'x', 12, 'y', 12.2),130, 140),
  (13,300, 33.3, 330.12345,array(16), array(16.6), array(160.1234),map(15, 1500), map(15, 15.5), map(15, 150.12345),named_struct('add', 33.3, 'x', 13, 'y', 13.3),150, 160),
