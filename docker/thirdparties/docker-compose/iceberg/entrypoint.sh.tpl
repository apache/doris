...
SPARK_MASTER_URL="spark://doris--spark-master:7077"
...
spark-sql --master "${SPARK_MASTER_URL}" --conf spark.sql.extensions=org.apache.iceberg.spark.extensions.IcebergSparkSessionExtensions -f iceberg_total.sql 
END_TIME1=$(date +%s)
...
spark-sql  --master  "${SPARK_MASTER_URL}" --conf spark.sql.extensions=org.apache.paimon.spark.extensions.PaimonSparkSessionExtensions -f paimon_total.sql
END_TIME2=$(date +%s)
...
spark-sql --master "${SPARK_MASTER_URL}" --conf spark.sql.extensions=org.apache.iceberg.spark.extensions.IcebergSparkSessionExtensions -f iceberg_load_total.sql 
END_TIME3=$(date +%s)
