...
| 变量 | 默认值 | 作用 |
|---|---|---|
| `HIVE_BASELINE_TARBALL_CACHE` | `custom_settings.env` 中的 `docker/thirdparties/docker-compose/hive/scripts/baseline` | 下载 tarball 的本地缓存目录；缓存文件名会带上 `HIVE_BASELINE_VERSION` |
