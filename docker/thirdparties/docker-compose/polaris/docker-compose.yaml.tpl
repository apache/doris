...
services:
  ...
  polaris-init:
    ...
    environment:
      ...
      AWSRegion: ${AWSRegion}
      POLARIS_INIT_CONNECT_TIMEOUT_SECONDS: ${POLARIS_INIT_CONNECT_TIMEOUT_SECONDS}
      POLARIS_INIT_REQUEST_TIMEOUT_SECONDS: ${POLARIS_INIT_REQUEST_TIMEOUT_SECONDS}
      POLARIS_INIT_RETRY_COUNT: ${POLARIS_INIT_RETRY_COUNT}
      POLARIS_INIT_RETRY_DELAY_SECONDS: ${POLARIS_INIT_RETRY_DELAY_SECONDS}
      POLARIS_INIT_RETRY_MAX_TIME_SECONDS: ${POLARIS_INIT_RETRY_MAX_TIME_SECONDS}
      POLARIS_INIT_HEALTH_CHECK_ATTEMPTS: ${POLARIS_INIT_HEALTH_CHECK_ATTEMPTS}
      POLARIS_INIT_HEALTH_CHECK_INTERVAL_SECONDS: ${POLARIS_INIT_HEALTH_CHECK_INTERVAL_SECONDS}
      POLARIS_INIT_HEALTH_CHECK_REQUEST_TIMEOUT_SECONDS: ${POLARIS_INIT_HEALTH_CHECK_REQUEST_TIMEOUT_SECONDS}
    volumes:
