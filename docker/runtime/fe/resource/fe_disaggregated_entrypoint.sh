...
PROBE_MASTER_POD0_TIMEOUT=${PROBE_MASTER_POD0_TIMEOUT:-30} # at most 30 attempts, no less than the times needed for an election
...
function add_cluster_info_to_conf()
{
    ...
    echo "########## doris-operator automatically adds ##########" >> ${DORIS_HOME}/conf/fe.conf
