...
func (s clientSettings) String() string {
	return fmt.Sprintf("clientSettings{%s/{table}/_stream_load, %s, %s, %s}", s.DBURL, s.Timeout, s.LabelPrefix, s.Headers)
}
...
func (client *client) String() string {
	return fmt.Sprintf("doris{%s, %s, %s}", client.url("{table}"), client.labelPrefix, client.headers)
}
