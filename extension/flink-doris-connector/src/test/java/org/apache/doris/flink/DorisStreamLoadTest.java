package org.apache.doris.flink;// Licensed to the Apache Software Foundation (ASF) under one
...
public class DorisStreamLoadTest {
    private final static String DORIS_HOST = "10.220.146.10";
    private final static String DORIS_DB = "test_2";
    private final static String DORIS_TABLE = "stream_load";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DorisStreamLoadTest dorisStreamLoad = new DorisStreamLoadTest();
        dorisStreamLoad.sendData(oneRow.toString());
    }
}
