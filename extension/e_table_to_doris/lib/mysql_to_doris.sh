...
sed -i 's/CHARACTER.*COMMENT/COMMENT/g' $path
sed -i 's/CHARACTER.*,/,/g' $path
sed -i 's/CHARACTER.*//g' $path
sed -i 's/DEFAULT.*COMMENT/COMMENT/g' $path
sed -i 's/DEFAULT.*,/,/g' $path
sed -i 's/DEFAULT.*//g' $path
sed -i 's/COLLATE.*COMMENT/COMMENT/g' $path
sed -i 's/COLLATE.*,/,/g' $path
sed -i 's/COLLATE.*//g' $path
...
sed -i 's/\<binary\>/varchar/g' $path
sed -i 's/\<varbinary\>/varchar/g' $path
