...
static HttpResponse process_adjust_rate_limit(MetaServiceImpl* service, brpc::Controller* cntl) {
    ...
    int64_t default_qps_limit = config::default_max_qps_limit;
    ...
    std::string specific_max_qps_limit = std::string(http_query(uri, "specific_max_qps_limit"));
    ...
    rate_limiter->reset_rate_limit(service, default_qps_limit, specific_max_qps_limit);
