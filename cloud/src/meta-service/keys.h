...
//                                                      0:instance_id  1:tablet_id
using SnapshotTabletKeyInfo = BasicKeyInfo<30, std::tuple<std::string, int64_t>>;
//                                                      0:instance_id  1:tablet_id  2:version
using SnapshotRowsetKeyInfo = BasicKeyInfo<31, std::tuple<std::string, int64_t,     int64_t>>;
