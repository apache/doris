...
static std::unordered_map<std::string_view,
    ...
    {"TableUpdateTimeKey",         {{"instance_id", "db_id", "tbl_id"},                              [](param_type& p) { return table_update_time_key(KeyInfoSetter<TableUpdateTimeKeyInfo>{p}.get());                      }, parse<TableUpdateTimePB>        , parse_json<TableUpdateTimePB>}},
...
static std::unordered_map<std::string_view,
    ...
    {"VersionedTableVersionKey",            {{"instance_id", "table_id"},                                    [](param_type& p) { return versioned::table_version_key(KeyInfoSetter<versioned::TableVersionKeyInfo>{p}.get());              }, true, parse_to_json<TableUpdateTimePB>, parse_json<TableUpdateTimePB>}},
