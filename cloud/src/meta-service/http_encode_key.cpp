...
static std::unordered_map<std::string_view,
    ...
    {"StatsSpillKey",              {{"instance_id", "backend_id"},                                   [](param_type& p) { return stats_spill_key(KeyInfoSetter<StatsSpillKeyInfo>{p}.get());                                 }, parse<SpillStatsPB>             , parse_json<SpillStatsPB>}},
