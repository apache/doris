...
extern bvar::Adder<int64_t> g_bvar_delete_bitmap_lock_txn_get_conflict_counter;
...
extern bvar::Adder<int64_t> g_bvar_delete_bitmap_lock_txn_remove_conflict_by_compaction_counter;
