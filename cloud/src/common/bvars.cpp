...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rowset_put_counter("rpc_kv","get_rowset_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rowset_del_counter("rpc_kv","get_rowset_del_counter");
// get_version
bvar::Adder<int64_t> g_bvar_rpc_kv_get_version_get_counter("rpc_kv","get_version_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_version_put_counter("rpc_kv","get_version_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_version_del_counter("rpc_kv","get_version_del_counter");
// get_schema_dict
bvar::Adder<int64_t> g_bvar_rpc_kv_get_schema_dict_get_counter("rpc_kv","get_schema_dict_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_schema_dict_put_counter("rpc_kv","get_schema_dict_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_schema_dict_del_counter("rpc_kv","get_schema_dict_del_counter");
// create_tablets
...
bvar::Adder<int64_t> g_bvar_rpc_kv_create_tablets_del_counter("rpc_kv","create_tablets_del_counter");
// update_tablet
...
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tablet_del_counter("rpc_kv","update_tablet_del_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tablet_schema_del_counter("rpc_kv","update_tablet_schema_del_counter");
// get_tablet
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_get_counter("rpc_kv","get_tablet_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_put_counter("rpc_kv","get_tablet_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_del_counter("rpc_kv","get_tablet_del_counter");
// prepare_rowset
...
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_rowset_del_counter("rpc_kv","prepare_rowset_del_counter");
// commit_rowset
...
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tmp_rowset_del_counter("rpc_kv","update_tmp_rowset_del_counter");
// get_tablet_stats
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_stats_get_counter("rpc_kv","get_tablet_stats_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_stats_put_counter("rpc_kv","get_tablet_stats_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_stats_del_counter("rpc_kv","get_tablet_stats_del_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_delete_bitmap_put_counter("rpc_kv","get_delete_bitmap_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_delete_bitmap_del_counter("rpc_kv","get_delete_bitmap_del_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_remove_delete_bitmap_get_counter("rpc_kv","remove_delete_bitmap_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_remove_delete_bitmap_put_counter("rpc_kv","remove_delete_bitmap_put_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_start_tablet_job_del_counter("rpc_kv","start_tablet_job_del_counter");
// finish_tablet_job
...
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_index_del_counter("rpc_kv","prepare_index_del_counter");
// commit_index
...
bvar::Adder<int64_t> g_bvar_rpc_kv_drop_index_del_counter("rpc_kv","drop_index_del_counter");
// prepare_partition
...
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_partition_del_counter("rpc_kv","prepare_partition_del_counter");
// commit_partition
...
bvar::Adder<int64_t> g_bvar_rpc_kv_drop_partition_del_counter("rpc_kv","drop_partition_del_counter");
// check_kv
bvar::Adder<int64_t> g_bvar_rpc_kv_check_kv_get_counter("rpc_kv","check_kv_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_check_kv_put_counter("rpc_kv","check_kv_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_check_kv_del_counter("rpc_kv","check_kv_del_counter");
// get_obj_store_info
bvar::Adder<int64_t> g_bvar_rpc_kv_get_obj_store_info_get_counter("rpc_kv","get_obj_store_info_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_obj_store_info_put_counter("rpc_kv","get_obj_store_info_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_obj_store_info_del_counter("rpc_kv","get_obj_store_info_del_counter");
// alter_storage_vault
...
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_obj_store_info_del_counter("rpc_kv","alter_obj_store_info_del_counter");
// update_ak_sk
...
bvar::Adder<int64_t> g_bvar_rpc_kv_update_ak_sk_del_counter("rpc_kv","update_ak_sk_del_counter");
// create_instance
...
bvar::Adder<int64_t> g_bvar_rpc_kv_create_instance_del_counter("rpc_kv","create_instance_del_counter");
// get_instance
bvar::Adder<int64_t> g_bvar_rpc_kv_get_instance_get_counter("rpc_kv","get_instance_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_instance_put_counter("rpc_kv","get_instance_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_instance_del_counter("rpc_kv","get_instance_del_counter");
// alter_cluster
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_cluster_get_counter("rpc_kv","alter_cluster_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_cluster_put_counter("rpc_kv","alter_cluster_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_cluster_del_counter("rpc_kv","alter_cluster_del_counter");
// get_cluster
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_del_counter("rpc_kv","get_cluster_del_counter");
// create_stage
...
bvar::Adder<int64_t> g_bvar_rpc_kv_create_stage_del_counter("rpc_kv","create_stage_del_counter");
// get_stage
bvar::Adder<int64_t> g_bvar_rpc_kv_get_stage_get_counter("rpc_kv","get_stage_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_stage_put_counter("rpc_kv","get_stage_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_stage_del_counter("rpc_kv","get_stage_del_counter");
// get_iam
bvar::Adder<int64_t> g_bvar_rpc_kv_get_iam_get_counter("rpc_kv","get_iam_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_iam_put_counter("rpc_kv","get_iam_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_iam_del_counter("rpc_kv","get_iam_del_counter");
// alter_iam
...
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_iam_del_counter("rpc_kv","alter_iam_del_counter");
// alter_ram_user
...
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_ram_user_del_counter("rpc_kv","alter_ram_user_del_counter");
// begin_copy
...
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_copy_del_counter("rpc_kv","begin_copy_del_counter");
// finish_copy
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_job_put_counter("rpc_kv","get_copy_job_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_job_del_counter("rpc_kv","get_copy_job_del_counter");
// get_copy_files
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_files_get_counter("rpc_kv","get_copy_files_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_files_put_counter("rpc_kv","get_copy_files_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_files_del_counter("rpc_kv","get_copy_files_del_counter");
// filter_copy_files
bvar::Adder<int64_t> g_bvar_rpc_kv_filter_copy_files_get_counter("rpc_kv","filter_copy_files_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_filter_copy_files_put_counter("rpc_kv","filter_copy_files_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_filter_copy_files_del_counter("rpc_kv","filter_copy_files_del_counter");
// get_cluster_status
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_status_get_counter("rpc_kv","get_cluster_status_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_status_put_counter("rpc_kv","get_cluster_status_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_status_del_counter("rpc_kv","get_cluster_status_del_counter");
// begin_txn
...
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_txn_del_counter("rpc_kv","begin_txn_del_counter");
// precommit_txn
...
bvar::Adder<int64_t> g_bvar_rpc_kv_precommit_txn_del_counter("rpc_kv","precommit_txn_del_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rl_task_commit_attach_put_counter("rpc_kv","get_rl_task_commit_attach_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rl_task_commit_attach_del_counter("rpc_kv","get_rl_task_commit_attach_del_counter");
// reset_rl_progress
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_put_counter("rpc_kv","get_txn_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_del_counter("rpc_kv","get_txn_del_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_current_max_txn_id_put_counter("rpc_kv","get_current_max_txn_id_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_current_max_txn_id_del_counter("rpc_kv","get_current_max_txn_id_del_counter");
// begin_sub_txn
...
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_sub_txn_del_counter("rpc_kv","abort_sub_txn_del_counter");
...
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_txn_with_coordinator_put_counter("rpc_kv","abort_txn_with_coordinator_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_txn_with_coordinator_del_counter("rpc_kv","abort_txn_with_coordinator_del_counter");
// check_txn_conflict
bvar::Adder<int64_t> g_bvar_rpc_kv_check_txn_conflict_get_counter("rpc_kv","check_txn_conflict_get_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_check_txn_conflict_put_counter("rpc_kv","check_txn_conflict_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_check_txn_conflict_del_counter("rpc_kv","check_txn_conflict_del_counter");
// clean_txn_label
...
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_id_put_counter("rpc_kv","get_txn_id_put_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_id_del_counter("rpc_kv","get_txn_id_del_counter");
