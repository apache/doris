...
// rpc kv rw count
// get_rowset
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rowset_read_counter("rpc_kv","get_rowset_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rowset_write_counter("rpc_kv","get_rowset_write_counter");
// get_version
bvar::Adder<int64_t> g_bvar_rpc_kv_get_version_read_counter("rpc_kv","get_version_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_version_write_counter("rpc_kv","get_version_write_counter");
// get_schema_dict
bvar::Adder<int64_t> g_bvar_rpc_kv_get_schema_dict_read_counter("rpc_kv","get_schema_dict_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_schema_dict_write_counter("rpc_kv","get_schema_dict_write_counter");
// create_tablets
bvar::Adder<int64_t> g_bvar_rpc_kv_create_tablets_read_counter("rpc_kv","create_tablets_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_create_tablets_write_counter("rpc_kv","create_tablets_write_counter");
// update_tablet
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tablet_read_counter("rpc_kv","update_tablet_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tablet_write_counter("rpc_kv","update_tablet_write_counter");
// update_tablet_schema
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tablet_schema_read_counter("rpc_kv","update_tablet_schema_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tablet_schema_write_counter("rpc_kv","update_tablet_schema_write_counter");
// get_tablet
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_read_counter("rpc_kv","get_tablet_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_write_counter("rpc_kv","get_tablet_write_counter");
// prepare_rowset
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_rowset_read_counter("rpc_kv","prepare_rowset_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_rowset_write_counter("rpc_kv","prepare_rowset_write_counter");
// commit_rowset
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_rowset_read_counter("rpc_kv","commit_rowset_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_rowset_write_counter("rpc_kv","commit_rowset_write_counter");
// update_tmp_rowset
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tmp_rowset_read_counter("rpc_kv","update_tmp_rowset_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_update_tmp_rowset_write_counter("rpc_kv","update_tmp_rowset_write_counter");
// get_tablet_stats
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_stats_read_counter("rpc_kv","get_tablet_stats_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_tablet_stats_write_counter("rpc_kv","get_tablet_stats_write_counter");
// update_delete_bitmap
bvar::Adder<int64_t> g_bvar_rpc_kv_update_delete_bitmap_read_counter("rpc_kv","update_delete_bitmap_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_update_delete_bitmap_write_counter("rpc_kv","update_delete_bitmap_write_counter");
// get_delete_bitmap
bvar::Adder<int64_t> g_bvar_rpc_kv_get_delete_bitmap_read_counter("rpc_kv","get_delete_bitmap_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_delete_bitmap_write_counter("rpc_kv","get_delete_bitmap_write_counter");
// get_delete_bitmap_update_lock
bvar::Adder<int64_t> g_bvar_rpc_kv_get_delete_bitmap_update_lock_read_counter("rpc_kv","get_delete_bitmap_update_lock_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_delete_bitmap_update_lock_write_counter("rpc_kv","get_delete_bitmap_update_lock_write_counter");
// remove_delete_bitmap_update_lock
bvar::Adder<int64_t> g_bvar_rpc_kv_remove_delete_bitmap_update_lock_read_counter("rpc_kv","remove_delete_bitmap_update_lock_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_remove_delete_bitmap_update_lock_write_counter("rpc_kv","remove_delete_bitmap_update_lock_write_counter");
// remove_delete_bitmap
bvar::Adder<int64_t> g_bvar_rpc_kv_remove_delete_bitmap_read_counter("rpc_kv","remove_delete_bitmap_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_remove_delete_bitmap_write_counter("rpc_kv","remove_delete_bitmap_write_counter");
// start_tablet_job
bvar::Adder<int64_t> g_bvar_rpc_kv_start_tablet_job_read_counter("rpc_kv","start_tablet_job_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_start_tablet_job_write_counter("rpc_kv","start_tablet_job_write_counter");
// finish_tablet_job
bvar::Adder<int64_t> g_bvar_rpc_kv_finish_tablet_job_read_counter("rpc_kv","finish_tablet_job_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_finish_tablet_job_write_counter("rpc_kv","finish_tablet_job_write_counter");
// prepare_index
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_index_read_counter("rpc_kv","prepare_index_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_index_write_counter("rpc_kv","prepare_index_write_counter");
// commit_index
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_index_read_counter("rpc_kv","commit_index_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_index_write_counter("rpc_kv","commit_index_write_counter");
// drop_index
bvar::Adder<int64_t> g_bvar_rpc_kv_drop_index_read_counter("rpc_kv","drop_index_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_drop_index_write_counter("rpc_kv","drop_index_write_counter");
// prepare_partition
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_partition_read_counter("rpc_kv","prepare_partition_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_prepare_partition_write_counter("rpc_kv","prepare_partition_write_counter");
// commit_partition
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_partition_read_counter("rpc_kv","commit_partition_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_partition_write_counter("rpc_kv","commit_partition_write_counter");
// drop_partition
bvar::Adder<int64_t> g_bvar_rpc_kv_drop_partition_read_counter("rpc_kv","drop_partition_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_drop_partition_write_counter("rpc_kv","drop_partition_write_counter");
// check_kv
bvar::Adder<int64_t> g_bvar_rpc_kv_check_kv_read_counter("rpc_kv","check_kv_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_check_kv_write_counter("rpc_kv","check_kv_write_counter");
// get_obj_store_info
bvar::Adder<int64_t> g_bvar_rpc_kv_get_obj_store_info_read_counter("rpc_kv","get_obj_store_info_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_obj_store_info_write_counter("rpc_kv","get_obj_store_info_write_counter");
// alter_storage_vault
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_storage_vault_read_counter("rpc_kv","alter_storage_vault_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_storage_vault_write_counter("rpc_kv","alter_storage_vault_write_counter");
// alter_obj_store_info
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_obj_store_info_read_counter("rpc_kv","alter_obj_store_info_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_obj_store_info_write_counter("rpc_kv","alter_obj_store_info_write_counter");
// update_ak_sk
bvar::Adder<int64_t> g_bvar_rpc_kv_update_ak_sk_read_counter("rpc_kv","update_ak_sk_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_update_ak_sk_write_counter("rpc_kv","update_ak_sk_write_counter");
// create_instance
bvar::Adder<int64_t> g_bvar_rpc_kv_create_instance_read_counter("rpc_kv","create_instance_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_create_instance_write_counter("rpc_kv","create_instance_write_counter");
// get_instance
bvar::Adder<int64_t> g_bvar_rpc_kv_get_instance_read_counter("rpc_kv","get_instance_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_instance_write_counter("rpc_kv","get_instance_write_counter");
// alter_cluster
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_cluster_read_counter("rpc_kv","alter_cluster_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_cluster_write_counter("rpc_kv","alter_cluster_write_counter");
// get_cluster
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_read_counter("rpc_kv","get_cluster_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_write_counter("rpc_kv","get_cluster_write_counter");
// create_stage
bvar::Adder<int64_t> g_bvar_rpc_kv_create_stage_read_counter("rpc_kv","create_stage_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_create_stage_write_counter("rpc_kv","create_stage_write_counter");
// get_stage
bvar::Adder<int64_t> g_bvar_rpc_kv_get_stage_read_counter("rpc_kv","get_stage_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_stage_write_counter("rpc_kv","get_stage_write_counter");
// get_iam
bvar::Adder<int64_t> g_bvar_rpc_kv_get_iam_read_counter("rpc_kv","get_iam_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_iam_write_counter("rpc_kv","get_iam_write_counter");
// alter_iam
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_iam_read_counter("rpc_kv","alter_iam_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_iam_write_counter("rpc_kv","alter_iam_write_counter");
// alter_ram_user
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_ram_user_read_counter("rpc_kv","alter_ram_user_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_alter_ram_user_write_counter("rpc_kv","alter_ram_user_write_counter");
// begin_copy
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_copy_read_counter("rpc_kv","begin_copy_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_copy_write_counter("rpc_kv","begin_copy_write_counter");
// finish_copy
bvar::Adder<int64_t> g_bvar_rpc_kv_finish_copy_read_counter("rpc_kv","finish_copy_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_finish_copy_write_counter("rpc_kv","finish_copy_write_counter");
// get_copy_job
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_job_read_counter("rpc_kv","get_copy_job_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_job_write_counter("rpc_kv","get_copy_job_write_counter");
// get_copy_files
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_files_read_counter("rpc_kv","get_copy_files_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_copy_files_write_counter("rpc_kv","get_copy_files_write_counter");
// filter_copy_files
bvar::Adder<int64_t> g_bvar_rpc_kv_filter_copy_files_read_counter("rpc_kv","filter_copy_files_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_filter_copy_files_write_counter("rpc_kv","filter_copy_files_write_counter");
// get_cluster_status
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_status_read_counter("rpc_kv","get_cluster_status_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_cluster_status_write_counter("rpc_kv","get_cluster_status_write_counter");
// begin_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_txn_read_counter("rpc_kv","begin_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_txn_write_counter("rpc_kv","begin_txn_write_counter");
// precommit_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_precommit_txn_read_counter("rpc_kv","precommit_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_precommit_txn_write_counter("rpc_kv","precommit_txn_write_counter");
// get_rl_task_commit_attach
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rl_task_commit_attach_read_counter("rpc_kv","get_rl_task_commit_attach_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_rl_task_commit_attach_write_counter("rpc_kv","get_rl_task_commit_attach_write_counter");
// reset_rl_progress
bvar::Adder<int64_t> g_bvar_rpc_kv_reset_rl_progress_read_counter("rpc_kv","reset_rl_progress_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_reset_rl_progress_write_counter("rpc_kv","reset_rl_progress_write_counter");
// commit_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_txn_read_counter("rpc_kv","commit_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_commit_txn_write_counter("rpc_kv","commit_txn_write_counter");
// abort_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_txn_read_counter("rpc_kv","abort_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_txn_write_counter("rpc_kv","abort_txn_write_counter");
// get_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_read_counter("rpc_kv","get_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_write_counter("rpc_kv","get_txn_write_counter");
// get_current_max_txn_id
bvar::Adder<int64_t> g_bvar_rpc_kv_get_current_max_txn_id_read_counter("rpc_kv","get_current_max_txn_id_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_current_max_txn_id_write_counter("rpc_kv","get_current_max_txn_id_write_counter");
// begin_sub_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_sub_txn_read_counter("rpc_kv","begin_sub_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_begin_sub_txn_write_counter("rpc_kv","begin_sub_txn_write_counter");
// abort_sub_txn
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_sub_txn_read_counter("rpc_kv","abort_sub_txn_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_sub_txn_write_counter("rpc_kv","abort_sub_txn_write_counter");
// abort_txn_with_coordinator
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_txn_with_coordinator_read_counter("rpc_kv","abort_txn_with_coordinator_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_abort_txn_with_coordinator_write_counter("rpc_kv","abort_txn_with_coordinator_write_counter");
// check_txn_conflict
bvar::Adder<int64_t> g_bvar_rpc_kv_check_txn_conflict_read_counter("rpc_kv","check_txn_conflict_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_check_txn_conflict_write_counter("rpc_kv","check_txn_conflict_write_counter");
// clean_txn_label
bvar::Adder<int64_t> g_bvar_rpc_kv_clean_txn_label_read_counter("rpc_kv","clean_txn_label_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_clean_txn_label_write_counter("rpc_kv","clean_txn_label_write_counter");
// get_txn_id
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_id_read_counter("rpc_kv","get_txn_id_read_counter");
bvar::Adder<int64_t> g_bvar_rpc_kv_get_txn_id_write_counter("rpc_kv","get_txn_id_write_counter");
