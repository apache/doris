...
private:
    ...
    int check_txn_info_key(std::string& start_key, const std::string& end_key);

    int check_txn_label_key(std::string& start_key, const std::string& end_key);

    int check_txn_index_key(std::string& start_key, const std::string& end_key);

    int check_txn_running_key(std::string& start_key, const std::string& end_key);
