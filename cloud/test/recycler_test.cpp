...
TEST_F(PackedFileCheckerTest, SharedFileMayRetainDeletedSlices) {
    put_visible(add_reference(1001, "visible"));
    add_reference(1002, "deleted");
...
TEST_F(PackedFileCheckerTest, OrphanBitmapIsNotAReference) {
    auto rowset = make_rowset(1001, "orphan_bitmap");
