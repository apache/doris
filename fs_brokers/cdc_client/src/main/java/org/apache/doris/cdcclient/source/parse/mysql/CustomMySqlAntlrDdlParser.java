...
public class CustomMySqlAntlrDdlParser extends MySqlAntlrDdlParser {
    ...
    protected AntlrDdlParserListener createParseTreeWalkerListener() {
        return new CustomMySqlAntlrDdlParserListener(this, parsedChanges);
    }

    public List<MySqlSchemaChange> getAndClearParsedChanges() {
        List<MySqlSchemaChange> result = new ArrayList<>(parsedChanges);
        parsedChanges.clear();
        return result;
    }
