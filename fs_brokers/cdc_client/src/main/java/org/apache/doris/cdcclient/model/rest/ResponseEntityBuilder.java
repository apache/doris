...
/**
 * A utility class for creating a ResponseEntity easier. All response will return with http code
 * 200, and a internal code represent the real code.
 */
public class ResponseEntityBuilder {
    ...
    public static ResponseEntity badRequest(Object data) {
        ResponseBody body =
                new ResponseBody()
                        .code(RestApiStatusCode.BAD_REQUEST)
                        .msg("Bad Request")
                        .data(data);
    ...
    public static ResponseEntity okWithCommonError(String msg) {
        ResponseBody body =
                new ResponseBody().code(RestApiStatusCode.COMMON_ERROR).msg("Error").data(msg);
        return ResponseEntity.status(HttpStatus.OK).body(body);
    }
    ...
    public static ResponseEntity unauthorized(Object data) {
        ResponseBody body =
                new ResponseBody()
                        .code(RestApiStatusCode.UNAUTHORIZED)
                        .msg("Unauthorized")
                        .data(data);
        return ResponseEntity.status(HttpStatus.OK).body(body);
    }
    ...
    public static ResponseEntity notFound(Object data) {
        ResponseBody body =
                new ResponseBody().code(RestApiStatusCode.NOT_FOUND).msg("Not Found").data(data);
        return ResponseEntity.status(HttpStatus.OK).body(body);
    }
}
