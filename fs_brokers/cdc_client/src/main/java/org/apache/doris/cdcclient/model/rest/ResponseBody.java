 ...
 *
 * <p>The getter setter methods of all member variables need to be retained to ensure that Spring
 * can perform json format conversion.
 *
...
public class ResponseBody<T> {
    ...
    // If there is an error, it is usually Doris's internal error code, not the HTTP standard error
    // code.
