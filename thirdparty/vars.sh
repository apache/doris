...
# ORC
ORC_DOWNLOAD="http://mirror.bit.edu.cn/apache/orc/orc-1.4.5/orc-1.4.5.tar.gz"
ORC_NAME=orc-1.4.5.tar.gz
ORC_SOURCE=orc-1.4.5
ORC_MD5SUM="0b1607c3fd022aa72c055acd3f2ab6b1"

# all thirdparties which need to be downloaded is set in array TP_ARCHIVES
export TP_ARCHIVES="LIBEVENT OPENSSL THRIFT LLVM CLANG COMPILER_RT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP LZO2 CURL RE2 BOOST MYSQL BOOST_FOR_MYSQL LEVELDB BRPC ROCKSDB LIBRDKAFKA FLATBUFFERS ARROW BROTLI DOUBLE_CONVERSION URIPARSER ZSTD S2 BITSHUFFLE CROARINGBITMAP ORC"
