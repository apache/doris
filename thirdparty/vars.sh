...
# libevent
LIBEVENT_DOWNLOAD="https://ghproxy.net/https://github.com/libevent/libevent/archive/release-2.1.12-stable.tar.gz"
...
# openssl
OPENSSL_DOWNLOAD="https://ghproxy.net/https://github.com/openssl/openssl/archive/OpenSSL_1_1_1s.tar.gz"
...
PROTOBUF_DOWNLOAD="https://ghproxy.net/https://github.com/protocolbuffers/protobuf/releases/download/v21.11/protobuf-all-21.11.tar.gz"
PROTOBUF_NAME="protobuf-all-21.11.tar.gz"
PROTOBUF_SOURCE=protobuf-21.11
PROTOBUF_MD5SUM="b3b104f0374802e1add5d5d7a5a845ac"

# gflags
GFLAGS_DOWNLOAD="https://ghproxy.net/https://github.com/gflags/gflags/archive/v2.2.2.tar.gz"
GFLAGS_NAME=gflags-2.2.2.tar.gz
GFLAGS_SOURCE=gflags-2.2.2
GFLAGS_MD5SUM="1a865b93bacfa963201af3f75b7bd64c"

# glog
GLOG_DOWNLOAD="https://ghproxy.net/https://github.com/google/glog/archive/refs/tags/v0.6.0.tar.gz"
GLOG_NAME="glog-v0.6.0.tar.gz"
GLOG_SOURCE=glog-0.6.0
GLOG_MD5SUM="c98a6068bc9b8ad9cebaca625ca73aa2"

# gtest
GTEST_DOWNLOAD="https://ghproxy.net/https://github.com/google/googletest/archive/release-1.11.0.tar.gz"
...
# snappy
SNAPPY_DOWNLOAD="https://ghproxy.net/https://github.com/google/snappy/archive/1.1.8.tar.gz"
SNAPPY_NAME=snappy-1.1.8.tar.gz
SNAPPY_SOURCE=snappy-1.1.8
SNAPPY_MD5SUM="70e48cba7fecf289153d009791c9977f"

# gperftools
GPERFTOOLS_DOWNLOAD="https://ghproxy.net/https://github.com/gperftools/gperftools/releases/download/gperftools-2.10/gperftools-2.10.tar.gz"
...
# lz4
LZ4_DOWNLOAD="https://ghproxy.net/https://github.com/lz4/lz4/archive/v1.9.4.tar.gz"
LZ4_NAME=lz4-1.9.4.tar.gz
LZ4_SOURCE=lz4-1.9.4
LZ4_MD5SUM="e9286adb64040071c5e23498bf753261"

# bzip
BZIP_DOWNLOAD="https://ghproxy.net/https://fossies.org/linux/misc/bzip2-1.0.8.tar.gz"
BZIP_NAME=bzip2-1.0.8.tar.gz
BZIP_SOURCE=bzip2-1.0.8
BZIP_MD5SUM="67e051268d0c475ea773822f7500d0e5"

# lzo2
LZO2_DOWNLOAD="https://ghproxy.net/https://fossies.org/linux/misc/lzo-2.10.tar.gz"
LZO2_NAME=lzo-2.10.tar.gz
LZO2_SOURCE=lzo-2.10
LZO2_MD5SUM="39d3f3f9c55c87b1e5d6888e1420f4b5"

# rapidjson
RAPIDJSON_DOWNLOAD="https://ghproxy.net/https://github.com/Tencent/rapidjson/archive/1a803826f1197b5e30703afe4b9c0e7dd48074f5.zip"
...
# RE2
RE2_DOWNLOAD="https://ghproxy.net/https://github.com/google/re2/archive/2021-02-02.tar.gz"
RE2_NAME=re2-2021-02-02.tar.gz
RE2_SOURCE=re2-2021-02-02
RE2_MD5SUM="48bc665463a86f68243c5af1bac75cd0"

# hyperscan
HYPERSCAN_DOWNLOAD="https://ghproxy.net/https://github.com/intel/hyperscan/archive/refs/tags/v5.4.2.tar.gz"
...
if [[ "${MACHINE_TYPE}" == "aarch64" || "${MACHINE_TYPE}" == 'arm64' ]]; then
    ...
    HYPERSCAN_DOWNLOAD="https://ghproxy.net/https://github.com/VectorCamp/vectorscan/archive/refs/tags/vectorscan/5.4.11.tar.gz"
...
# mysql
MYSQL_DOWNLOAD="https://ghproxy.net/https://github.com/mysql/mysql-server/archive/mysql-5.7.18.tar.gz"
...
# leveldb
LEVELDB_DOWNLOAD="https://ghproxy.net/https://github.com/google/leveldb/archive/refs/tags/1.23.tar.gz"
LEVELDB_NAME=leveldb-1.23.tar.gz
LEVELDB_SOURCE=leveldb-1.23
LEVELDB_MD5SUM="afbde776fb8760312009963f09a586c7"

# brpc
BRPC_DOWNLOAD="https://ghproxy.net/https://github.com/apache/brpc/archive/refs/tags/1.4.0.tar.gz"
BRPC_NAME="brpc-1.4.0.tar.gz"
BRPC_SOURCE="brpc-1.4.0"
BRPC_MD5SUM="6af9d50822c33a3abc56a1ec0af0e0bc"

# rocksdb
ROCKSDB_DOWNLOAD="https://ghproxy.net/https://github.com/facebook/rocksdb/archive/v5.14.2.tar.gz"
ROCKSDB_NAME=rocksdb-5.14.2.tar.gz
ROCKSDB_SOURCE=rocksdb-5.14.2
ROCKSDB_MD5SUM="b72720ea3b1e9ca9e4ed0febfef65b14"

# cyrus-sasl
CYRUS_SASL_DOWNLOAD="https://ghproxy.net/https://github.com/cyrusimap/cyrus-sasl/releases/download/cyrus-sasl-2.1.27/cyrus-sasl-2.1.27.tar.gz"
...
# librdkafka-1.9.2
LIBRDKAFKA_DOWNLOAD="https://ghproxy.net/https://github.com/edenhill/librdkafka/archive/v1.9.2.tar.gz"
...
# zstd
ZSTD_DOWNLOAD="https://ghproxy.net/https://github.com/facebook/zstd/releases/download/v1.5.5/zstd-1.5.5.tar.gz"
ZSTD_NAME=zstd-1.5.5.tar.gz
ZSTD_SOURCE=zstd-1.5.5
ZSTD_MD5SUM="63251602329a106220e0a5ad26ba656f"

# brotli
BROTLI_DOWNLOAD="https://ghproxy.net/https://github.com/google/brotli/archive/v1.0.9.tar.gz"
BROTLI_NAME="brotli-1.0.9.tar.gz"
BROTLI_SOURCE="brotli-1.0.9"
BROTLI_MD5SUM="c2274f0c7af8470ad514637c35bcee7d"

# flatbuffers
FLATBUFFERS_DOWNLOAD="https://ghproxy.net/https://github.com/google/flatbuffers/archive/v2.0.0.tar.gz"
...
# c-ares
CARES_DOWNLOAD="https://ghproxy.net/https://github.com/c-ares/c-ares/releases/download/cares-1_19_1/c-ares-1.19.1.tar.gz"
...
GRPC_DOWNLOAD="https://ghproxy.net/https://github.com/grpc/grpc/archive/refs/tags/v1.54.3.tar.gz"
GRPC_NAME="grpc-v1.54.3.tar.gz"
GRPC_SOURCE=grpc-1.54.3
GRPC_MD5SUM="af00a2edeae0f02bb25917cc3473b7de"

# arrow
ARROW_DOWNLOAD="https://ghproxy.net/https://github.com/apache/arrow/archive/refs/tags/apache-arrow-17.0.0.tar.gz"
ARROW_NAME="apache-arrow-17.0.0.tar.gz"
ARROW_SOURCE="arrow-apache-arrow-17.0.0"
ARROW_MD5SUM="ba18bf83e2164abd34b9ac4cb164f0f0"

# Abseil
ABSEIL_DOWNLOAD="https://ghproxy.net/https://github.com/abseil/abseil-cpp/archive/refs/tags/20230125.3.tar.gz"
...
# S2
S2_DOWNLOAD="https://ghproxy.net/https://github.com/google/s2geometry/archive/refs/tags/v0.10.0.tar.gz"
S2_NAME=s2geometry-0.10.0.tar.gz
S2_SOURCE=s2geometry-0.10.0
S2_MD5SUM="c68f3c5d326dde9255681b9201393a9f"

# bitshuffle
BITSHUFFLE_DOWNLOAD="https://ghproxy.net/https://github.com/kiyo-masui/bitshuffle/archive/0.5.1.tar.gz"
...
# croaringbitmap
CROARINGBITMAP_DOWNLOAD="https://ghproxy.net/https://github.com/RoaringBitmap/CRoaring/archive/refs/tags/v2.1.2.tar.gz"
...
# fmt
FMT_DOWNLOAD="https://ghproxy.net/https://github.com/fmtlib/fmt/archive/7.1.3.tar.gz"
FMT_NAME="fmt-7.1.3.tar.gz"
FMT_SOURCE="fmt-7.1.3"
FMT_MD5SUM="2522ec65070c0bda0ca288677ded2831"

# parallel-hashmap
PARALLEL_HASHMAP_DOWNLOAD="https://ghproxy.net/https://github.com/greg7mdp/parallel-hashmap/archive/refs/tags/v1.3.8.tar.gz"
...
# jemalloc for arrow
JEMALLOC_ARROW_DOWNLOAD="https://ghproxy.net/https://github.com/jemalloc/jemalloc/releases/download/5.3.0/jemalloc-5.3.0.tar.bz2"
...
# jemalloc for doris
JEMALLOC_DORIS_DOWNLOAD="https://ghproxy.net/https://github.com/jemalloc/jemalloc/releases/download/5.3.0/jemalloc-5.3.0.tar.bz2"
...
# libunwind
LIBUNWIND_DOWNLOAD="https://ghproxy.net/https://github.com/libunwind/libunwind/releases/download/v1.6.2/libunwind-1.6.2.tar.gz"
LIBUNWIND_NAME="libunwind-1.6.2.tar.gz"
LIBUNWIND_SOURCE="libunwind-1.6.2"
LIBUNWIND_MD5SUM="f625b6a98ac1976116c71708a73dc44a"

# cctz
CCTZ_DOWNLOAD="https://ghproxy.net/https://github.com/google/cctz/archive/v2.3.tar.gz"
...
DATATABLES_DOWNLOAD="https://ghproxy.net/https://github.com/apache/doris-thirdparty/releases/download/datatables-1.12.1/DataTables.zip"
...
# aws sdk
AWS_SDK_DOWNLOAD="https://ghproxy.net/https://github.com/aws/aws-sdk-cpp/archive/refs/tags/1.11.119.tar.gz"
...
# lzma
LZMA_DOWNLOAD="https://ghproxy.net/https://github.com/kobolabs/liblzma/archive/refs/heads/master.zip"
...
# hdfs3
HDFS3_DOWNLOAD="https://ghproxy.net/https://github.com/apache/doris-thirdparty/archive/refs/tags/libhdfs3-v2.3.9.tar.gz"
...
#libdivide
LIBDIVIDE_DOWNLOAD="https://ghproxy.net/https://github.com/ridiculousfish/libdivide/archive/refs/tags/v5.2.0.tar.gz"
...
# benchmark
BENCHMARK_DOWNLOAD="https://ghproxy.net/https://github.com/google/benchmark/archive/refs/tags/v1.8.0.tar.gz"
...
XSIMD_DOWNLOAD="https://ghproxy.net/https://github.com/xtensor-stack/xsimd/archive/refs/tags/13.0.0.tar.gz"
XSIMD_NAME="13.0.0.tar.gz"
XSIMD_SOURCE=xsimd-13.0.0
XSIMD_MD5SUM="c661deb91836e82d3070f81032014fe6"

# simdjson
SIMDJSON_DOWNLOAD="https://ghproxy.net/https://github.com/simdjson/simdjson/archive/refs/tags/v3.0.1.tar.gz"
SIMDJSON_NAME=simdjson-3.0.1.tar.gz
SIMDJSON_SOURCE=simdjson-3.0.1
SIMDJSON_MD5SUM="993576b47249f2bade2bfb2552b2896a"

# nlohmann_json
NLOHMANN_JSON_DOWNLOAD="https://ghproxy.net/https://github.com/nlohmann/json/archive/refs/tags/v3.10.1.tar.gz"
...
# sse2noen
SSE2NEON_DOWNLOAD="https://ghproxy.net/https://github.com/DLTcollab/sse2neon/archive/refs/tags/v1.6.0.tar.gz"
SSE2NEON_NAME=sse2neon-1.6.0.tar.gz
SSE2NEON_SOURCE=sse2neon-1.6.0
SSE2NEON_MD5SUM="dce28eb6a78f45bf98740d5fad73febb"

# xxhash
XXHASH_DOWNLOAD="https://ghproxy.net/https://github.com/Cyan4973/xxHash/archive/refs/tags/v0.8.1.tar.gz"
XXHASH_NAME=xxHash-0.8.1.tar.gz
XXHASH_SOURCE=xxHash-0.8.1
XXHASH_MD5SUM="b67c587f5ff4894253da0095ba7ea393"

# concurrentqueue
CONCURRENTQUEUE_DOWNLOAD="https://ghproxy.net/https://github.com/cameron314/concurrentqueue/archive/refs/tags/v1.0.3.tar.gz"
...
# fast_float
FAST_FLOAT_DOWNLOAD="https://ghproxy.net/https://github.com/fastfloat/fast_float/archive/refs/tags/v3.9.0.tar.gz"
...
# libhdfs
HADOOP_LIBS_DOWNLOAD="https://ghproxy.net/https://github.com/apache/doris-thirdparty/archive/refs/tags/hadoop-3.3.6.6-for-doris.tar.gz"
...
# AvxToNeon
AVX2NEON_DOWNLOAD="https://ghproxy.net/https://github.com/kunpengcompute/AvxToNeon/archive/refs/tags/v1.0.0.tar.gz"
AVX2NEON_NAME=v1.0.0.tar.gz
AVX2NEON_SOURCE=AvxToNeon-1.0.0
AVX2NEON_MD5SUM="692d0e0f8b885a86ebc5172a9d8ee8db"

# libdeflate
LIBDEFLATE_DOWNLOAD="https://ghproxy.net/https://github.com/ebiggers/libdeflate/archive/refs/tags/v1.19.tar.gz"
...
# streamvbyte
STREAMVBYTE_DOWNLOAD="https://ghproxy.net/https://github.com/lemire/streamvbyte/archive/refs/tags/v1.0.0.tar.gz"
...
# jsoncpp
JSONCPP_DOWNLOAD="https://ghproxy.net/https://github.com/open-source-parsers/jsoncpp/archive/refs/tags/1.9.5.tar.gz"
...
# ali
ALI_SDK_DOWNLOAD="https://ghproxy.net/https://github.com/aliyun/aliyun-openapi-cpp-sdk/archive/refs/tags/1.36.1586.tar.gz"
...
# base64
BASE64_DOWNLOAD="https://ghproxy.net/https://github.com/aklomp/base64/archive/refs/tags/v0.5.2.tar.gz"
BASE64_NAME="v0.5.2.tar.gz"
BASE64_SOURCE="base64-0.5.2"
BASE64_MD5SUM="49e5a6c98bd0192aedd16c16eec39974"

# azure blob
AZURE_DOWNLOAD="https://ghproxy.net/https://github.com/Azure/azure-sdk-for-cpp/archive/azure-core_1.10.3.tar.gz"
...
DRAGONBOX_DOWNLOAD="https://ghproxy.net/https://github.com/jk-jeon/dragonbox/archive/refs/tags/1.1.3.tar.gz"
DRAGONBOX_NAME=dragonbox-1.1.3.tar.gz
DRAGONBOX_SOURCE=dragonbox-1.1.3
DRAGONBOX_MD5SUM="889dc00db9612c6949a4ccf8115e0e6a"

# icu
ICU_DOWNLOAD="https://ghproxy.net/https://github.com/unicode-org/icu/archive/refs/tags/release-69-1.tar.gz"
ICU_NAME=release-69-1.tar.gz
ICU_SOURCE=icu-release-69-1
ICU_MD5SUM="135125f633864285d637db5c01e0388b"

# jindofs
JINDOFS_DOWNLOAD="https://ghproxy.net/https://github.com/apache/doris-thirdparty/releases/download/alibabacloud-jindodata-releases/jindofs-6.8.2-libs-0.1.tar.gz"
...
# pugixml
PUGIXML_DOWNLOAD="https://ghproxy.net/https://github.com/zeux/pugixml/releases/download/v1.15/pugixml-1.15.tar.gz"
PUGIXML_NAME=pugixml-1.15.tar.gz
PUGIXML_SOURCE=pugixml-1.15
PUGIXML_MD5SUM="3b894c29455eb33a40b165c6e2de5895"

# openblas
OPENBLAS_DOWNLOAD="https://ghproxy.net/https://github.com/OpenMathLib/OpenBLAS/releases/download/v0.3.29/OpenBLAS-0.3.29.tar.gz"
OPENBLAS_NAME="OpenBLAS-0.3.29.tar.gz"
OPENBLAS_SOURCE="OpenBLAS-0.3.29"
OPENBLAS_MD5SUM="853a0c5c0747c5943e7ef4bbb793162d"

# faiss
FAISS_DOWNLOAD="https://ghproxy.net/https://github.com/facebookresearch/faiss/archive/refs/tags/v1.10.0.tar.gz"
