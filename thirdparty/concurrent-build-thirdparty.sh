...
build_list=(build_boost, build_libevent, build_zlib, build_bzip, build_lzo2, \
            build_openssl, build_protobuf, build_lz4, build_gflags, build_gtest, \
            build_glog, build_rapidjson, build_snappy, build_gperftools, build_curl, \
            build_re2, build_mysql, build_leveldb, build_brpc, build_rocksdb, \
            build_librdkafka, build_flatbuffers, build_arrow, build_s2, build_bitshuffle,\
            build_croaringbitmap, build_orc, build_cctz, build_thrift)

for build_func in ${build_list[@]} 
do
    build_func &
done
wait
