...
build_nlohmann_json() {
    ...
    $CMAKE_CMD -DCMAKE_INSTALL_PREFIX=$TP_INSTALL_DIR -DCMAKE_PREFIX_PATH=$TP_INSTALL_DIR -DJSON_BuildTests=OFF ..
    $CMAKE_CMD --build .
...
build_opentelemetry() {
    ...
    $CMAKE_CMD -DCMAKE_INSTALL_PREFIX=$TP_INSTALL_DIR -DCMAKE_PREFIX_PATH=$TP_INSTALL_DIR -DBUILD_TESTING=OFF -DWITH_OTLP=ON -DWITH_OTLP_GRPC=OFF -DWITH_ZIPKIN=ON -DWITH_EXAMPLES=OFF ..
