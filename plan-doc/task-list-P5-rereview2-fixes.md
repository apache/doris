...
| 9 | FIX-NATIVE-SUBSPLIT | MAJOR* | M-3 | native ORC/Parquet sub-file splitting (parallelism); connector-side port of FileSplitter + determineTargetFileSplitSize | no | ✅ | ✅ | ✅ 258/0/0 | 🔄 pending |
...
- **✅ DONE** (commit pending; design [`P5-fix-NATIVE-SUBSPLIT-design.md`](./tasks/designs/P5-fix-NATIVE-SUBSPLIT-design.md), [D-055](./decisions-log.md), [DV-033](./deviations-log.md)). User signed off (2026-06-12): **implement now**.
