...
## R-008 — fe-filesystem typed OSS/COS/OBS BE map 缺 AWS_CREDENTIALS_PROVIDER_TYPE（无凭据 catalog 的 ANONYMOUS 漂移）｜ 状态：修复中（2026-06-18 D-011：P1-T06 之前先修，FU-T02 active-next；授权 fe-filesystem-{oss,cos,obs}）
