...
- ▶ **下一步**：**P2-T02**（新建 fe-connector-metastore-spi：解析器 + MetaStoreProvider SPI/ServiceLoader + 增量补 fe-kerberos authenticator 机制）。**P3a-T01 facts-carrier ✅ + P2-T01 ✅**（2026-06-18）。**P1-T06 推迟**（D-012，docker 验证折进 P2-T05 一次跑）。
