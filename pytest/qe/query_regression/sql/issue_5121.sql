...
CREATE TABLE IF NOT EXISTS doris_app_event_record (pt_d INT NULL,app VARCHAR(256) NULL, event VARCHAR(256)  NULL, distribute_id VARCHAR(256)  NULL, bitmap_id BITMAP BITMAP_UNION , row_count INT  SUM NULL)PARTITION BY RANGE (pt_d) ( ) DISTRIBUTED BY HASH(distribute_id) BUCKETS 3;
