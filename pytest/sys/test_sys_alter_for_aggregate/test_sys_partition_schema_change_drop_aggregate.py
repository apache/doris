...
def partition_check(table_name, column_name, partition_name_list, \
    ...
    if is_new:
        schema = DATA.schema_1_new
    else:
        schema = DATA.schema_1
...
def test_drop_col_v1():
    """
    {
    "title": "test_sys_partition_schema_change_drop_aggregate.test_drop_col_v1",
    "describe": "删除一个value列",
    "tag": "function,p1"
    }
    """
...
def test_drop_col_v1_v2():
    """
    {
    "title": "test_sys_partition_schema_change_drop_aggregate.test_drop_col_v1_v2",
    "describe": "删除 v1 v2 列",
    "tag": "function,p1"
    }
    """
...
def test_drop_col_k2():
    """
    {
    "title": "test_sys_partition_schema_change_drop_aggregate.test_drop_col_k2",
    "describe": "删除一个key列",
    "tag": "function,p1"
    }
    """
