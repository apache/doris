...
def test_add_v4_v5_v6():
    """
    {
    "title": "test_sys_schema_change_add_b_aggregate.test_add_v4_v5_v6",
    ...
    ret = client.verify(DATA.expected_data_file_list_6_agg, table_name)
    assert ret
    client.clean(database_name)
...
def test_add_v4_v5_v6_v7():
    """
    {
    "title": "test_sys_schema_change_add_b_aggregate.test_add_v4_v5_v6_v7",
...
def test_add_k3_v4_v5_v6_v7():
    """
    {
    "title": "test_sys_schema_change_add_b_aggregate.test_add_k3_v4_v5_v6_v7",
    ...
    ret = client.verify(DATA.expected_data_file_list_8_agg, table_name)
    assert ret
    client.clean(database_name)
