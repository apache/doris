...
def test_drop_col_v1():
    """
    {
    "title": "test_sys_schema_change_drop_aggregate.test_drop_col_v1",
    "describe": "删除一个value列",
    "tag": "function,p1"
    }
    """
...
def test_drop_col_v1_v2():
    """
    {
    "title": "test_sys_schema_change_drop_aggregate.test_drop_col_v1_v2",
    "describe": "删除 v1 v2 列",
    "tag": "function,p1"
    }
    """
...
def test_drop_col_k2():
    """
    {
    "title": "test_sys_schema_change_drop_aggregate.test_drop_col_k2",
    "describe": "删除一个key列",
    "tag": "function,p1"
    }
    """
...
#    client.create_table(table_name, DATA.schema_1, distribution_info=distribution_info, \
#            keys_desc='AGGREGATE KEY (k1, k2)')
    client.create_table(table_name, DATA.schema_1_new, distribution_info=distribution_info, \
                        keys_desc='AGGREGATE KEY (k1, k2, v1)')
...
def test_drop_k1():
    """
    {
    "title": "test_sys_schema_change_drop_aggregate.test_drop_k1",
    ...
    column_list = [('key_add', 'INT', None, '5')]
