...
def test_add_key_mid():
    """
    {
    "title": "test_sys_partition_schema_change_add_a_aggregate.test_add_key_mid",
    "describe": "在key中间新加一列",
    "tag": "function,p1"
    }
    """
...
def test_add_key_tail():
    """
    {
    "title": "test_sys_partition_schema_change_add_a_aggregate.test_add_key_tail",
...
def test_add_value():
    """
    {
    "title": "test_sys_partition_schema_change_add_a_aggregate.test_add_value",
...
def test_add_v4_v5():
    """
    {
    "title": "test_sys_partition_schema_change_add_a_aggregate.test_add_v4_v5",
