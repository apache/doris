...
def test_add_key_mid():
    """
    {
    "title": "test_sys_schema_change_add_a_duplicate.test_add_key_mid",
    "describe": "在key中间新加一列",
    "tag": "function,p1"
    }
    """
...
def test_add_key_tail():
    """
    {
    "title": "test_sys_schema_change_add_a_duplicate.test_add_key_tail",
    "describe": "在key后边新加一列",
    "tag": "function,p1"
    }
    """
...
def test_add_value():
    ...
    client.clean(database_name)
    client.create_database(database_name)
    client.create_table(table_name, DATA.schema_1_dup, keys_desc='DUPLICATE KEY (k1, k2)')
