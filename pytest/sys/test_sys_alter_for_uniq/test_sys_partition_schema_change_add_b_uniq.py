...
def test_add_v4_v5_v6():
    """
    {
    "title": "test_sys_partition_schema_change_add_b_uniq.test_add_v4_v5_v6",
...
def test_add_v4_v5_v6_v7():
    """
    {
    "title": "test_sys_partition_schema_change_add_b_uniq.test_add_v4_v5_v6_v7",
    ...
    ret = client.schema_change_add_column(table_name, column_list, 
                                          after_column_name='v1', is_wait_job=True)
    assert ret
    ...
    ret = client.schema_change_add_column(table_name, column_list, 
                                          after_column_name='v3', is_wait_job=True)
    assert ret

    column_list = [('v7', 'INT', None, '701')]
    ret = client.schema_change_add_column(table_name, column_list, 
                                          after_column_name='v6', is_wait_job=True)
    assert ret
...
def test_add_k3_v4_v5_v6_v7():
    """
    {
    "title": "test_sys_partition_schema_change_add_b_uniq.test_add_k3_v4_v5_v6_v7",
