...
export STUDIO_HOME=`cd "$curdir"; pwd`
echo "$STUDIO_HOME"

export LOG_DIR="$STUDIO_HOME/logs"
...
done < $STUDIO_HOME/conf/studio.conf
...
#start manager
nohup $JAVA -jar $STUDIO_HOME/doris-studio-manager.jar > $LOG_DIR/manager.out 2>&1 </dev/null &
