...
suite("agg_sync_mv") {
    ...
    mv_rewrite_success("select id, variance(kint) from agg_mv_test group by id order by id;", "mv_sync47")
    ...
    mv_rewrite_success("select id, var_pop(kint) from agg_mv_test group by id order by id;", "mv_sync47")
