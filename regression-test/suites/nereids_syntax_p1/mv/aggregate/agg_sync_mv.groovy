...
suite("agg_sync_mv") {
    ...
    createMV("""create materialized view mv_sync40 as select id as g2, stddev(kint) as stddev_col from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync41 as select id as g3, stddev_pop(kint) as g3v from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync42 as select id as g4, stddev_samp(kint) as stddev_samp_col from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync47 as select id as s3, variance(kint) as variance_col from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync48 as select id as s4, var_pop(kint) as s4v from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync49 as select id as s5, variance_samp(kint) as variance_samp_col from agg_mv_test group by id order by id;""")
