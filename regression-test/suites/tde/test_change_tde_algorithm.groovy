...
suite("test_change_tde_algorithm", "docker") {
    ...
    cloudMode.each {mode ->
        tdeAlgorithm.each {algorithm ->
            ...
            docker(options) {
                def tblName = "test_change_tde_algorithm"
                ...
                def tblName2 = "test_change_tde_algorithm2"
                ...
                // assert tblName2 not encrypted
                tablets = sql_return_maparray "SHOW TABLETS FROM ${tblName2}"
