    ...
    def create_table = { ->
        ...
        sql """
            CREATE TABLE IF NOT EXISTS ${tbl} (
                ...
                v_json JSON NULL,
                v_variant_1 VARIANT<properties("variant_sparse_bucket_num" = "1")> NULL,
                v_variant_32 VARIANT<properties("variant_sparse_bucket_num" = "32")> NULL,
                v_variant_64 VARIANT<properties("variant_sparse_bucket_num" = "64")> NULL
            )
            DUPLICATE KEY(`id`)
