...
suite("test_warm_up_partition") {
    ...
    sql (new File("""${context.file.parent}/../ddl/customer_with_partition.sql""").text + ttlProperties)
    sleep(10000)
    ...
    waitJobDone(jobId_)
    jobId_ = sql "warm up cluster regression_cluster_name1 with table customer partition p3;"
    waitJobDone(jobId_)
