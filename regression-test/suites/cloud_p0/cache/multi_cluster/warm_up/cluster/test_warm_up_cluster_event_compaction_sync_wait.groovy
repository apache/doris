...
suite('test_warm_up_cluster_event_compaction_sync_wait', 'docker') {
    ...
    docker(options) {
        ...
        GetDebugPoint().enableDebugPoint(be.ip, be.http_port as int, NodeType.BE, "S3FileReader::read_at_impl.io_slow", [sleep:10])
        ...
        assertEquals(num_finished + 1, getBrpcMetrics(be.ip, be.rpc_port, "file_cache_event_driven_warm_up_finished_segment_num"))
