...
1. When enable_file_cache_olap_tables = false, it is expected that the S3 TVF load (import phase) will NOT enter the cache, while the query
...
2. When enable_file_cache_olap_tables = true, it is expected that the S3 TVF load (import phase) will enter the Normal queue, and the query
...
suite('test_load_cache', 'docker') {
    ...
    docker(options) {
        ...
        // ============================================================================
        // SCENARIO 1: enable_file_cache_olap_tables = false
        // ============================================================================
        ...
        sql "set enable_file_cache_olap_tables = false;"
        ...
        // ============================================================================
        // SCENARIO 2: enable_file_cache_olap_tables = true
        // ============================================================================
