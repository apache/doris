...
suite("test_reset_capacity") {
    ...
    for (def backend in backends) {
        ...
        if (backend.Alive.equals("true") &&
            ((cloud_tag.containsKey('cloud_cluster_name') && cloud_tag.cloud_cluster_name.contains("regression_cluster_name1")) ||
              cloud_tag.containsKey('compute_group_name') && cloud_tag.compute_group_name.contains("regression_cluster_name1"))) {
