...
"""
            ...
            def fmt = java.time.format.DateTimeFormatter.ofPattern("yyyyMMddHHmmss'Z'")
            ...
            runCommand("openssl x509 -req -in ${certDir}/certificate.csr -CA ${certDir}/ca.crt -CAkey ${certDir}/ca.key " +
                    "-CAcreateserial -out ${certDir}/certificate.crt -extensions v3_req -extfile ${certDir}/openssl.cnf " +
                    "-not_before ${startDate} -not_after ${endDate}", "sign expired")
