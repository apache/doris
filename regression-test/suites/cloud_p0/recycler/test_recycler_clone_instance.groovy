...
suite("test_recycler_clone_instance") {
    ...
    sql "create database if not exists regression_test_cloud_p0_recycler"

    def instanceId = get_instance_id(metaServiceHttpAddress)
    def username = "wangyixuan"

    logger.info("Step 1: Querying cluster snapshots")
    ...
    logger.info("Step 2: Getting FE information and stopping master FE")
    ...
    logger.info("Step 4: Getting BE information and stopping all BEs")
    ...
    logger.info("Step 5: Cleaning storage directory on all BEs")
    ...
    logger.info("Stopping master FE on ${masterFeHost}")
    ...
    logger.info("Step 3: Cleaning FE doris-meta directory and creating snapshot_info.json")
    ...
    logger.info("Step 6: Starting master FE with snapshot_info.json")
    ...
    logger.info("Step 7: Starting all BEs")
    for (def beHost : beHosts) {
