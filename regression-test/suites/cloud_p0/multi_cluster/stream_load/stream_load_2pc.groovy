...
suite("stream_load_2pc") {
    ...
    add_cluster.call(beUniqueIdList[0], ipList[0], hbPortList[0],
                     "stream_load_2pc_cluster_name0", "stream_load_2pc_cluster_id0");

    add_cluster.call(beUniqueIdList[1], ipList[1], hbPortList[1],
                     "stream_load_2pc_cluster_name1", "stream_load_2pc_cluster_id1");
    sleep(20000)
    ...
    streamLoad {
        ...
        set 'cloud_cluster', 'stream_load_2pc_cluster_name1'
    ...
    streamLoad {
        ...
        check { loadResult, exception, startTime, endTime ->
            ...
            log.info("Stream load 2pc commit result: ${loadResult}".toString())
            def json = parseJson(loadResult)
            assertEquals("success", json.status.toLowerCase())
        }
    }
    ...
    tableName3 = "test_all_2pc_no_specific_cluster"
    ...
    */
    ...
    sql "SET PROPERTY 'default_cloud_cluster' = 'stream_load_2pc_cluster_name0'"
    tableName3 = "test_all_2pc_default_cluster"
    sql """ drop table if exists ${tableName3} """
