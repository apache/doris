...
suite('use_vcg_read_write_s3_load', 'multi_cluster,docker') {
    ...
    def execute_s3_Load = {
        ...
        //def tables = [customer: 15000000, lineitem: 600037902, nation: 25, orders: 150000000, part: 20000000, partsupp: 80000000, region: 6, supplier: 1000000]
