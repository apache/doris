...
suite('failover_standby_disable_compaction', 'multi_cluster,docker') {
    ...
    for (def j = 0; j < 2; j++) {
        docker(options) {
            ...
            assertTrue(vcgInShow.Policy.contains('"activeComputeGroup":"a_newcluster1","standbyComputeGroup":"a_newcluster2"'))
