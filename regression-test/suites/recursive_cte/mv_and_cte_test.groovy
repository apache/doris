...
suite("mv_and_cte_test", "rec_cte") {
    ...
    def sql_str = """WITH recursive SubordinateHierarchy (
            EmployeeID, 
            EmployeeName, 
            ManagerID, 
            Level,
        ...
        ORDER BY 
            Level, EmployeeID;"""
    def mv_name = prefix_str + "cte_mv"
    test {
        sql "CREATE MATERIALIZED VIEW ${mv_name} AS " + sql_str
        exception "LogicalCTEAnchor is not supported in sync materialized view"
    }
