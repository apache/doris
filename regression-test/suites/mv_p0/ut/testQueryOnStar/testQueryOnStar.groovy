...
suite ("testQueryOnStar") {
    ...
    createMV("create materialized view emps_mv as select time_col, deptno,empid, name, salary, commission from emps order by time_col, deptno, empid,name, salary, commission;")
