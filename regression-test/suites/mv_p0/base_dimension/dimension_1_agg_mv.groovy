...
suite("partition_mv_rewrite_dimension_1_agg_mv", "partition_mv_rewrite_dimension") {
    ...
    sql """alter table orders_agg modify column o_orderkey set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_custkey set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_orderdate set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_orderstatus set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_totalprice set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_orderpriority set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_clerk set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_shippriority set stats ('row_count'='50');"""
    sql """alter table orders_agg modify column o_comment set stats ('row_count'='50');"""

    sql """alter table lineitem_agg modify column l_orderkey set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_linenumber set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_partkey set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_suppkey set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_quantity set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_extendedprice set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_discount set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_tax set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_returnflag set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_linestatus set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_commitdate set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_receiptdate set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_shipinstruct set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_shipmode set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_comment set stats ('row_count'='50');"""
    sql """alter table lineitem_agg modify column l_shipdate set stats ('row_count'='50');"""
    ...
    def mv_sql = """CREATE MATERIALIZED VIEW ${agg_mv_name_1}
        AS
        select
            o_orderkey,
    ...
    /*
    TODO: agg table group by key column bug
    ...
    mv_rewrite_success(single_table_query_stmt_3, mv_name_1)
    compare_res(single_table_query_stmt_3 + " order by 1,2,3")

    mv_rewrite_success(single_table_query_stmt_4, mv_name_1)
