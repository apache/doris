...
suite ("diffrent_serialize") {
    ...
    createMV("create materialized view mv1_1 as select k1,bitmap_intersect(bitmap_hash(k2)) from d_table group by k1;")
    ...
    */
    ...
    explain {
        sql("select k1,bitmap_intersect(bitmap_hash(k2)) from d_table group by k1 order by 1;")
        contains "(mv1_1)"
    }
    qt_select_mv "select k1,bitmap_intersect(bitmap_hash(k2)) from d_table group by k1 order by 1;"
