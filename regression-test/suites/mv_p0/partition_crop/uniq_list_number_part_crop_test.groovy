...
suite("uniq_list_number_part_crop", "mv_part_crop") {
    String db = context.config.getDbNameByFile(context.file)
    String orders_tb = "uniq_orders_list_number_crop_part"
    ...
    (4, 2, '2023-10-20', 'o', null, 'a', 'b', 1, 'yy');
    """
    ...
    def mv_name = "uniq_list_number_crop_part_mtmv"
    def mv_sql = """
    ...
    explain {
        sql("${query_sql}")
        contains "partitions=3/5 (p_2,p_3,p_4)"
    }
    mv_rewrite_success(query_sql, mv_name)
    compare_res(query_sql + " order by 1,2,3")
