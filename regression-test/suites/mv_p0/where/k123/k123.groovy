...
suite ("k123p") {
    ...
    createMV ("""create materialized index k123p1w as select k1,k2+k3 from d_table where k1 = 1;""")
    createMV ("""create materialized index k123p4w as select k1,k2+k3 from d_table where k4 = "b";""")
