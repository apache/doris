...
suite("test_validate_restore_backup_temp_partition", "validate_restore") {
    def runValidateRestoreBackupTempPartition = { String version ->
        String validateSuiteName = "test_backup_restore_backup_temp_partition"
