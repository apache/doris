...
suite("test_validate_restore_bloom_filter", "validate_restore") {
    def runValidateRestoreBloomFilter = { String version ->
        String validateSuiteName = "test_backup_restore_bloom_filter"
