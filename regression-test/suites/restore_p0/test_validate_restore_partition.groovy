...
suite("test_validate_restore_partition", "validate_restore") {
    def runValidateRestorePartition = { String version ->
        String validateSuiteName = "test_backup_restore_partition"
