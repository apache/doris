...
suite("test_validate_restore_exclude", "validate_restore") {
    def runValidateRestoreExclude = { String version ->
        String validateSuiteName = "test_backup_restore_exclude"
        ...
        try {
            ...
            sql """
                CREATE TABLE ${dbName}.${restoreExcludeTable} (
            ...
            sql "INSERT INTO ${dbName}.${restoreExcludeTable} VALUES (1, 1), (2, 2)"
            qt_select "SELECT * FROM ${dbName}.${restoreExcludeTable} ORDER BY id"
            ...
            def result = sql "SELECT * FROM ${dbName}.${restoreExcludeTable}"
