...
suite("test_create_table_like_nereids") {
    ...
    waitForRollUpJob("mal_test_create_table_like", "r1", 30000)
    waitForRollUpJob("mal_test_create_table_like", "r2", 15000)
    explain {
    ...
    waitForRollUpJob("mal_test_create_table_like", "r1", 15000)
