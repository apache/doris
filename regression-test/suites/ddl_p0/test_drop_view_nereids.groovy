...
suite("test_drop_view_nereids") {
    ...
    """
    qt_test_view_6 """ SHOW VIEW FROM view_column_name_test_drop_nereids;"""
    ...
    qt_test_with_as_sql "show create view test_view_with_as_drop"
    ...
    qt_test_union_sql "show create view test_view_union_drop"
    ...
    qt_test_count_star_sql "show create view test_view_count_star_drop"
    ...
    qt_test_expression_sql "show create view test_view_expression_drop;"
    ...
    qt_test_alias_sql "show create view test_view_alias_drop;"
    ...
    qt_test_star_except_sql "show create view test_view_star_except_drop;"
    ...
    qt_test_create_view_from_view_sql "show create view test_view_from_view_drop"
    ...
    qt_test_backquote_in_view_define_drop_sql "show create view test_backquote_in_view_define_drop;"
    ...
    qt_test_backquote_in_table_alias_drop_sql "show create view test_backquote_in_table_alias_drop;"
    ...
    order_qt_test_invalid_column_name_in_table_drop_define_sql "show create view test_invalid_column_name_in_table_drop;"
    ...
    qt_test_generate_sql "show create view test_view_generate_drop;"
    ...
    qt_test_generate_with_column_sql "show create view test_view_generate_drop_with_column_drop;"
    ...
    qt_test_col_alias_sql "show create view test_view_col_alias_drop;"
    ...
    qt_test_col_alias_with_specific_name_sql "show create view test_view_col_alias_drop_specific_name_drop;"
    ...
    qt_test_table_alias_sql "show create view test_view_table_alias_drop;"
    ...
    qt_test_join_table_alias_sql "show create view test_view_join_table_alias_drop;"
    ...
    qt_test_alias_udf_sql "show create view test_view_alias_drop_udf_drop;"
    ...
    qt_test_alias_with_db_udf_sql "show create view test_view_alias_drop_udf_drop_with_db_drop;"
    ...
    qt_test_udf_sql "show create view test_view_udf_drop;"
    ...
    qt_test_with_as_with_columns_sql "show create view test_view_with_as_drop_with_columns_drop"
    ...
    qt_test_having_drop_sql "show create view test_having_drop"
    ...
    qt_complicated_view1_sql "show create view test_view_complicated_drop;"
