...
suite("partition_mv_rewrite") {
   ...
   """
    ...
    // Test that the mv only contains partial partitions of the original table.
    def mvName = "mv_1"
    def tableName = "t1"
    ...
    sql """
      ...
      """
    // Use partition_sync_limit to make the mv contain only 1 partition.
    sql """
    ...
    def query_all_partition = """
        select * from ${tableName};
      """
    mv_rewrite_fail(query_all_partition, mvName)
    order_qt_query_23_0 "${query_all_partition}"
}
