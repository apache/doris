...
suite("cross_join_range_number_increment_create", "p1") {
    ...
    sql """CREATE TABLE `orders_cross_3` (
    ...
    sql """
    drop table if exists lineitem_cross_3
    """

    sql """CREATE TABLE `lineitem_cross_3` (
    ...
    sql """
    insert into orders_cross_3 values 
    ...
    sql """
    insert into lineitem_cross_3 values 
    ...
    sql """analyze table orders_cross_3 with sync;"""
    sql """analyze table lineitem_cross_3 with sync;"""

    def mv_name = "mv_range_number"
    ...
    def mv_sql_7 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_3.O_ORDERDATE) over (partition by lineitem_cross_3.L_SHIPDATE order by lineitem_cross_3.L_ORDERKEY) as window_count 
        from lineitem_cross_3 
        cross join orders_cross_3  
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""

    def mv_sql_8 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_3.O_ORDERDATE) over (partition by lineitem_cross_3.l_orderkey order by lineitem_cross_3.l_orderkey) as window_count
        from lineitem_cross_3
        cross join orders_cross_3
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""

    def mv_sql_9 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_3.O_ORDERDATE) over (order by lineitem_cross_3.l_orderkey) as window_count 
        from lineitem_cross_3 
        cross join orders_cross_3  
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_3.O_ORDERDATE) over (partition by orders_cross_3.o_orderkey order by lineitem_cross_3.l_orderkey) as window_count
        from lineitem_cross_3
        cross join orders_cross_3
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
