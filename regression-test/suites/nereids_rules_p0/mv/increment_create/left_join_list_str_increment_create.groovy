...
suite("left_join_list_str_increment_create", "increment_create") {
    ...
    sql """CREATE TABLE `orders_left_1` (
    ...
    sql """
    drop table if exists lineitem_left_1
    """

    sql """CREATE TABLE `lineitem_left_1` (
    ...
    sql """
    insert into orders_left_1 values 
    ...
    sql """
    insert into lineitem_left_1 values 
    ...
    sql """analyze table orders_left_1 with sync;"""
    sql """analyze table lineitem_left_1 with sync;"""

    def mv_name = "mv_left_list_str"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, count(l_shipdate), count(l_orderkey) 
        ...
        left join orders_left_1
        on lineitem_left_1.l_shipdate = orders_left_1.o_orderdate
    ...
    def mv_sql_7 = """select l_shipdate, l_orderkey, O_ORDERDATE, 
        count(orders_left_1.O_ORDERDATE) over (partition by lineitem_left_1.L_SHIPDATE order by lineitem_left_1.L_ORDERKEY) as window_count 
        from lineitem_left_1 
        left join orders_left_1 
        on lineitem_left_1.l_orderkey = orders_left_1.o_orderkey 
    ...
    def mv_sql_8 = """select l_shipdate, l_orderkey, O_ORDERDATE,
        count(orders_left_1.O_ORDERDATE) over (partition by lineitem_left_1.l_orderkey order by lineitem_left_1.l_orderkey) as window_count
        from lineitem_left_1
        left join orders_left_1
        on lineitem_left_1.l_orderkey = orders_left_1.o_orderkey
        group by l_shipdate, l_orderkey, O_ORDERDATE"""
    ...
    def mv_sql_9 = """select l_shipdate, l_orderkey, O_ORDERDATE, 
        count(orders_left_1.O_ORDERDATE) over (order by lineitem_left_1.l_orderkey) as window_count 
        from lineitem_left_1 
        left join orders_left_1 
        on lineitem_left_1.l_orderkey = orders_left_1.o_orderkey 
        group by l_shipdate, l_orderkey, O_ORDERDATE"""
