...
suite("self_conn_list_str_increment_create", "increment_create") {
    ...
    def sql_increment_list1 = [mv_sql_4, mv_sql_6]
    list_judgement(sql_all_list, sql_increment_list1, sql_complete_list, sql_error_list1,
