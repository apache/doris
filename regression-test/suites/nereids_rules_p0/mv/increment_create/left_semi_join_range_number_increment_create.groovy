...
suite("left_semi_join_range_number_increment_create") {
    ...
    sql """CREATE TABLE `orders_left_semi_3` (
    ...
    sql """
    drop table if exists lineitem_left_semi_3
    """

    sql """CREATE TABLE `lineitem_left_semi_3` (
    ...
    sql """
    insert into orders_left_semi_3 values 
    ...
    sql """
    insert into lineitem_left_semi_3 values 
    ...
    sql """analyze table orders_left_semi_3 with sync;"""
    sql """analyze table lineitem_left_semi_3 with sync;"""

    def mv_name = "mv_left_semi_range_number"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, l_partkey, l_suppkey  
        ...
        left semi join orders_left_semi_3
        on lineitem_left_semi_3.l_shipdate = orders_left_semi_3.o_orderdate
    ...
    def sql_partition_col_list = [mv_sql_1, mv_sql_3, mv_sql_7, mv_sql_9]
    def sql_not_partition_col_list = [mv_sql_4, mv_sql_6]
