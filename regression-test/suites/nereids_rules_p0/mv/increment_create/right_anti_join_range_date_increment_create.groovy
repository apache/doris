...
suite("right_anti_join_range_date_increment_create", "increment_create") {
    ...
    sql """CREATE TABLE `orders_right_anti_2` (
    ...
    sql """
    drop table if exists lineitem_right_anti_2
    """

    sql """CREATE TABLE `lineitem_right_anti_2` (
    ...
    sql """
    insert into orders_right_anti_2 values 
    ...
    sql """
    insert into lineitem_right_anti_2 values 
    ...
    sql """analyze table orders_right_anti_2 with sync;"""
    sql """analyze table lineitem_right_anti_2 with sync;"""


    def mv_name = "mv_right_anti_range_date"
    def partition_by_part_col = "o_orderdate"
    def partition_by_not_part_col = "o_orderkey"
    def partition_by_part_col_right = "l_shipdate"
    def partition_by_not_part_col_right = "l_orderkey"
    ...
    def mv_sql_1 = """select o_custkey, o_totalprice, o_orderdate, o_orderkey, 1 
        ...
        right join orders_right_anti_2
        on lineitem_right_anti_2.l_shipdate = orders_right_anti_2.o_orderdate
    ...
    def mv_sql_10 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_anti_2.O_ORDERDATE) over (partition by orders_right_anti_2.O_ORDERDATE order by orders_right_anti_2.o_orderkey) as window_count 
        from lineitem_right_anti_2 
        right join orders_right_anti_2 
        on lineitem_right_anti_2.l_orderkey = orders_right_anti_2.o_orderkey 
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_anti_2.O_ORDERDATE) over (partition by orders_right_anti_2.o_orderkey order by orders_right_anti_2.o_orderkey) as window_count
        from lineitem_right_anti_2
        right join orders_right_anti_2
        on lineitem_right_anti_2.l_orderkey = orders_right_anti_2.o_orderkey
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_12 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_anti_2.O_ORDERDATE) over (order by orders_right_anti_2.o_orderkey) as window_count 
        from lineitem_right_anti_2 
        right join orders_right_anti_2 
        on lineitem_right_anti_2.l_orderkey = orders_right_anti_2.o_orderkey 
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
