...
suite("right_semi_join_range_number_increment_create") {
    ...
    sql """CREATE TABLE `orders_right_semi_3` (
    ...
    sql """
    drop table if exists lineitem_right_semi_3
    """

    sql """CREATE TABLE `lineitem_right_semi_3` (
    ...
    sql """
    insert into lineitem_right_semi_3 values 
    ...
    sql """analyze table orders_right_semi_3 with sync;"""
    sql """analyze table lineitem_right_semi_3 with sync;"""


    def mv_name = "mv_right_semi_range_number"
    ...
    def mv_sql_1 = """select o_custkey, o_totalprice, o_orderdate, o_orderkey, 1 
        ...
        right join orders_right_semi_3
        on lineitem_right_semi_3.l_shipdate = orders_right_semi_3.o_orderdate
    ...
    def mv_sql_10 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_semi_3.O_ORDERDATE) over (partition by orders_right_semi_3.O_ORDERDATE order by orders_right_semi_3.o_orderkey) as window_count 
        from lineitem_right_semi_3 
        right join orders_right_semi_3 
        on lineitem_right_semi_3.l_orderkey = orders_right_semi_3.o_orderkey 
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_semi_3.O_ORDERDATE) over (partition by orders_right_semi_3.o_orderkey order by orders_right_semi_3.o_orderkey) as window_count
        from lineitem_right_semi_3
        right join orders_right_semi_3
        on lineitem_right_semi_3.l_orderkey = orders_right_semi_3.o_orderkey
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_12 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_semi_3.O_ORDERDATE) over (order by orders_right_semi_3.o_orderkey) as window_count 
        from lineitem_right_semi_3 
        right join orders_right_semi_3 
        on lineitem_right_semi_3.l_orderkey = orders_right_semi_3.o_orderkey 
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
