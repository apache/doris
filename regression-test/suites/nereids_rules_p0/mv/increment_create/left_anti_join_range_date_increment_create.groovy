...
suite("left_anti_join_range_date_increment_create", "increment_create") {
    ...
    sql """
    drop table if exists lineitem_left_anti_2
    """

    sql """CREATE TABLE `lineitem_left_anti_2` (
    ...
    sql """
    insert into orders_left_anti_2 values 
    ...
    sql """
    insert into lineitem_left_anti_2 values 
    ...
    sql """analyze table orders_left_anti_2 with sync;"""
    sql """analyze table lineitem_left_anti_2 with sync;"""


    def mv_name = "mv_left_anti_range_date"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, l_partkey, l_suppkey 
        ...
        left anti join orders_left_anti_2
        on lineitem_left_anti_2.l_shipdate = orders_left_anti_2.o_orderdate
