...
suite("full_join_list_str_increment_create", "increment_create") {
    ...
    sql """
    drop table if exists lineitem_full_1
    """

    sql """CREATE TABLE `lineitem_full_1` (
    ...
    sql """
    insert into orders_full_1 values 
    ...
    sql """
    insert into lineitem_full_1 values 
    ...
    sql """analyze table orders_full_1 with sync;"""
    sql """analyze table lineitem_full_1 with sync;"""


    def mv_name = "mv_full_list_str"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, o_orderdate, o_orderkey, 1 
        ...
        on lineitem_full_1.l_shipdate = orders_full_1.o_orderdate
    ...
    def mv_sql_7 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_full_1.O_ORDERDATE) over (partition by lineitem_full_1.L_SHIPDATE order by lineitem_full_1.L_ORDERKEY) as window_count 
        from lineitem_full_1 
        full join orders_full_1 
        on lineitem_full_1.l_orderkey = orders_full_1.o_orderkey 
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_8 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_full_1.O_ORDERDATE) over (partition by lineitem_full_1.l_orderkey order by lineitem_full_1.l_orderkey) as window_count
        from lineitem_full_1
        full join orders_full_1
        on lineitem_full_1.l_orderkey = orders_full_1.o_orderkey
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_9 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_full_1.O_ORDERDATE) over (order by lineitem_full_1.l_orderkey) as window_count 
        from lineitem_full_1 
        full join orders_full_1 
        on lineitem_full_1.l_orderkey = orders_full_1.o_orderkey 
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_full_1.O_ORDERDATE) over (partition by orders_full_1.o_orderkey order by lineitem_full_1.l_orderkey) as window_count
        from lineitem_full_1
        full join orders_full_1
        on lineitem_full_1.l_orderkey = orders_full_1.o_orderkey
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
