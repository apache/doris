...
suite("inner_join_list_str_increment_create", "increment_create") {
    ...
    sql """analyze table orders_inner_1 with sync;"""
    sql """analyze table lineitem_inner_1 with sync;"""


    def mv_name = "mv_inner_list_str"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, o_orderdate, o_orderkey, 1 
        ...
        on lineitem_inner_1.l_shipdate = orders_inner_1.o_orderdate
    ...
    def mv_sql_7 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_inner_1.O_ORDERDATE) over (partition by lineitem_inner_1.L_SHIPDATE order by lineitem_inner_1.L_ORDERKEY) as window_count 
        from lineitem_inner_1 
        inner join orders_inner_1 
        on lineitem_inner_1.l_orderkey = orders_inner_1.o_orderkey 
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_8 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_inner_1.O_ORDERDATE) over (partition by lineitem_inner_1.l_orderkey order by lineitem_inner_1.l_orderkey) as window_count
        from lineitem_inner_1
        inner join orders_inner_1
        on lineitem_inner_1.l_orderkey = orders_inner_1.o_orderkey
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_9 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_inner_1.O_ORDERDATE) over (order by lineitem_inner_1.l_orderkey) as window_count 
        from lineitem_inner_1 
        inner join orders_inner_1 
        on lineitem_inner_1.l_orderkey = orders_inner_1.o_orderkey 
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_inner_1.O_ORDERDATE) over (partition by orders_inner_1.o_orderkey order by lineitem_inner_1.l_orderkey) as window_count
        from lineitem_inner_1
        inner join orders_inner_1
        on lineitem_inner_1.l_orderkey = orders_inner_1.o_orderkey
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
