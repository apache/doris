...
suite("left_anti_join_list_str_increment_create", "increment_create") {
    ...
    sql """CREATE TABLE `orders_left_anti_1` (
    ...
    sql """
    drop table if exists lineitem_left_anti_1
    """

    sql """CREATE TABLE `lineitem_left_anti_1` (
    ...
    sql """
    insert into orders_left_anti_1 values 
    ...
    sql """
    insert into lineitem_left_anti_1 values 
    ...
    sql """analyze table orders_left_anti_1 with sync;"""
    sql """analyze table lineitem_left_anti_1 with sync;"""

    def mv_name = "mv_left_anti_list_str"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, count(l_shipdate), count(l_orderkey) 
        ...
        left anti join orders_left_anti_1
        on lineitem_left_anti_1.l_shipdate = orders_left_anti_1.o_orderdate
