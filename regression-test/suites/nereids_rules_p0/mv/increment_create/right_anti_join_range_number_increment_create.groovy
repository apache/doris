...
suite("right_anti_join_range_number_increment_create") {
    ...
    sql """CREATE TABLE `orders_right_anti_3` (
    ...
    sql """
    drop table if exists lineitem_right_anti_3
    """

    sql """CREATE TABLE `lineitem_right_anti_3` (
    ...
    sql """
    insert into orders_right_anti_3 values 
    ...
    sql """
    insert into lineitem_right_anti_3 values 
    ...
    sql """analyze table orders_right_anti_3 with sync;"""
    sql """analyze table lineitem_right_anti_3 with sync;"""


    def mv_name = "mv_right_anti_range_number"
    ...
    def is_increment_change = { def cur_job_name ->
        ...
        assert (refresh_info[0][15] == "[\"p_2_3\"]")
        assert (refresh_info[0][16] == "[\"p_2_3\"]")
    ...
    def is_complete_change = { def cur_job_name ->
        ...
        assert (refresh_info[0][17] == "100.00% (4/4)")
    }
    ...
    def mv_sql_1 = """select o_custkey, o_totalprice, o_orderdate, o_orderkey, 1 
        ...
        right join orders_right_anti_3
        on lineitem_right_anti_3.l_shipdate = orders_right_anti_3.o_orderdate
    ...
    def mv_sql_10 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_anti_3.O_ORDERDATE) over (partition by orders_right_anti_3.O_ORDERDATE order by orders_right_anti_3.o_orderkey) as window_count 
        from lineitem_right_anti_3 
        right join orders_right_anti_3 
        on lineitem_right_anti_3.l_orderkey = orders_right_anti_3.o_orderkey 
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_anti_3.O_ORDERDATE) over (partition by orders_right_anti_3.o_orderkey order by orders_right_anti_3.o_orderkey) as window_count
        from lineitem_right_anti_3
        right join orders_right_anti_3
        on lineitem_right_anti_3.l_orderkey = orders_right_anti_3.o_orderkey
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_12 = """select o_custkey, o_totalprice, O_ORDERDATE, o_orderkey, 
        count(orders_right_anti_3.O_ORDERDATE) over (order by orders_right_anti_3.o_orderkey) as window_count 
        from lineitem_right_anti_3 
        right join orders_right_anti_3 
        on lineitem_right_anti_3.l_orderkey = orders_right_anti_3.o_orderkey 
        group by o_custkey, o_totalprice, O_ORDERDATE, o_orderkey"""
