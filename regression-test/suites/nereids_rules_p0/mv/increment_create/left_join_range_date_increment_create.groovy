...
suite("left_join_range_date_increment_create") {
    ...
    sql """CREATE TABLE `orders_left_2` (
    ...
    sql """
    drop table if exists lineitem_left_2
    """

    sql """CREATE TABLE `lineitem_left_2` (
    ...
    sql """
    insert into orders_left_2 values 
    ...
    sql """
    insert into lineitem_left_2 values 
    ...
    sql """analyze table orders_left_2 with sync;"""
    sql """analyze table lineitem_left_2 with sync;"""


    def mv_name = "mv_left_range_date"
    ...
    def mv_sql_1 = """select l_shipdate, l_orderkey, o_orderdate, o_orderkey   
        from lineitem_left_2
        left join orders_left_2
        on lineitem_left_2.l_shipdate = orders_left_2.o_orderdate
    ...
    def mv_sql_4 = """select l_shipdate, l_orderkey, o_orderdate, o_orderkey    
        from lineitem_left_2 
        left join orders_left_2 
    ...
    def mv_sql_8 = """select l_shipdate, l_orderkey, O_ORDERDATE,
        count(orders_left_2.O_ORDERDATE) over (partition by lineitem_left_2.l_orderkey order by lineitem_left_2.l_orderkey) as window_count
        from lineitem_left_2
        left join orders_left_2
        on lineitem_left_2.l_orderkey = orders_left_2.o_orderkey
        group by l_shipdate, l_orderkey, O_ORDERDATE"""
    ...
    def mv_sql_9 = """select l_shipdate, l_orderkey, O_ORDERDATE, 
        count(orders_left_2.O_ORDERDATE) over (order by lineitem_left_2.l_orderkey) as window_count 
        from lineitem_left_2 
        left join orders_left_2 
        on lineitem_left_2.l_orderkey = orders_left_2.o_orderkey 
        group by l_shipdate, l_orderkey, O_ORDERDATE"""
