...
suite("cross_join_list_str_increment_create", "increment_create") {
    ...
    sql """CREATE TABLE `orders_cross_1` (
    ...
    sql """
    drop table if exists lineitem_cross_1
    """

    sql """CREATE TABLE `lineitem_cross_1` (
    ...
    sql """
    insert into orders_cross_1 values 
    ...
    sql """
    insert into lineitem_cross_1 values 
    ...
    sql """analyze table orders_cross_1 with sync;"""
    sql """analyze table lineitem_cross_1 with sync;"""


    def mv_name = "mv_cross_list_str"
    ...
    def mv_sql_7 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_1.O_ORDERDATE) over (partition by lineitem_cross_1.L_SHIPDATE order by lineitem_cross_1.L_ORDERKEY) as window_count 
        from lineitem_cross_1 
        cross join orders_cross_1 
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""

    def mv_sql_8 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_1.O_ORDERDATE) over (partition by lineitem_cross_1.l_orderkey order by lineitem_cross_1.l_orderkey) as window_count
        from lineitem_cross_1
        cross join orders_cross_1
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""

    def mv_sql_9 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_1.O_ORDERDATE) over (order by lineitem_cross_1.l_orderkey) as window_count 
        from lineitem_cross_1 
        cross join orders_cross_1 
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
    ...
    def mv_sql_11 = """select l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey, 
        count(orders_cross_1.O_ORDERDATE) over (partition by orders_cross_1.o_orderkey order by lineitem_cross_1.l_orderkey) as window_count
        from lineitem_cross_1
        cross join orders_cross_1
        group by l_shipdate, l_orderkey, O_ORDERDATE, o_orderkey"""
