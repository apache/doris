...
suite("self_conn_range_number_increment_create", "increment_create") {
    ...
    sql """CREATE TABLE `orders_self_conn_3` (
    ...
    sql """
    drop table if exists lineitem_selt_conn_3
    """

    sql """CREATE TABLE `lineitem_selt_conn_3` (
    ...
    sql """
    insert into orders_self_conn_3 values 
    ...
    sql """
    insert into lineitem_selt_conn_3 values 
    ...
    sql """analyze table orders_self_conn_3 with sync;"""
    sql """analyze table lineitem_selt_conn_3 with sync;"""


    def mv_name = "mv_self_conn_range_number"
    ...
    def sql_error_list1 = [mv_sql_1, mv_sql_3, mv_sql_7, mv_sql_9, mv_sql_10, mv_sql_12,
                      mv_sql_13, mv_sql_15, mv_sql_16, mv_sql_18]
    list_judgement(sql_all_list, sql_increment_list, sql_complete_list, sql_error_list1,
