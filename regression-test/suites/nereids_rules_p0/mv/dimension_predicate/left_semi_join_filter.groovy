...
suite("left_semi_join_filter") {
    ...
    sql """
    drop table if exists orders_left_semi_join
    """

    sql """CREATE TABLE `orders_left_semi_join` (
    ...
    sql """
    drop table if exists lineitem_left_semi_join
    """

    sql """CREATE TABLE `lineitem_left_semi_join` (
    ...
    sql """
    insert into orders_left_semi_join values 
    ...
    sql """
    insert into lineitem_left_semi_join values 
    ...
    def mv_stmt_0 = """select t.l_shipdate, t.l_partkey, t.l_suppkey  
        from (select l_shipdate, l_partkey, l_suppkey, l_orderkey from lineitem_left_semi_join where l_shipdate > '2023-10-17') t
        left semi join orders_left_semi_join 
        on t.l_orderkey = orders_left_semi_join.o_orderkey"""

    def mv_stmt_1 = """select l_shipdate, l_partkey, l_suppkey 
        from lineitem_left_semi_join  
        left semi join (select o_orderdate,o_orderkey from orders_left_semi_join where o_orderdate > '2023-10-17' ) t 
        on lineitem_left_semi_join.l_orderkey = t.o_orderkey"""

    def mv_stmt_2 = """select l_shipdate, l_partkey, l_suppkey 
        from lineitem_left_semi_join  
        left semi join orders_left_semi_join 
        on lineitem_left_semi_join.l_orderkey = orders_left_semi_join.o_orderkey 
    ...
    def mv_stmt_4 = """select o_orderdate, o_orderkey, o_custkey 
        from orders_left_semi_join 
        left semi join  (select l_shipdate, l_orderkey, l_partkey, l_suppkey  from lineitem_left_semi_join  where l_shipdate > '2023-10-17') t 
        on t.l_orderkey = orders_left_semi_join.o_orderkey"""

    def mv_stmt_5 = """select t.o_orderdate, t.o_orderkey, t.o_custkey 
        from (select o_orderdate, o_orderkey, o_custkey from orders_left_semi_join where o_orderdate > '2023-10-17' ) t 
        left semi join lineitem_left_semi_join   
        on lineitem_left_semi_join.l_orderkey = t.o_orderkey"""
