...
// Test the case where multiple different constants appear in an SQL statement containing subqueries and the JOIN operator.
// eg: select plac_1 from tb1 left join (select plac_2 as col1 from tb2) as t1 on plac_1 = t1.col1
suite ("constant_genaration_random_mtmv_10", "constant_genaration_random_mtmv") {
    ...
    def sql12 = "select plac_1 from ${table1} left join (select plac_2 as col1 from ${table2}) as t1 on plac_1 = t1.col1 "
    def sql_lists = [sql12]
