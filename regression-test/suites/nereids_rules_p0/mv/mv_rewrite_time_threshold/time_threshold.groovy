...
suite("mv_rewrite_time_threshold") {
 ...
 create_async_mv(db, "mv1_0", test_sql)
    ...
    sql "set materialized_view_rewrite_duration_threshold = 1000"
    explain {
        sql(test_sql)
        notContains "materialized view rewrite duration is exceeded"
    }
