...
//        cross join orders_1"""
    ...
    def agg_sql_1 = """select 
        ...
        from orders_1
        """
    mv_rewrite_success(agg_sql_1, agg_mv_name_1, enable_sync_mv_cost_based_rewrite(), true,
            [TRY_IN_RBO, FORCE_IN_RBO])
    mv_rewrite_fail(agg_sql_1, enable_sync_mv_cost_based_rewrite(), agg_mv_name_1, [NOT_IN_RBO])
