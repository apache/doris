...
suite("partition_mv_rewrite_dimension_2_3") {
    ...
    def sql_stmt_1 = """select
            ...
            from orders_2_3
            left join lineitem_2_3 on lineitem_2_3.l_orderkey = orders_2_3.o_orderkey"""
    mv_rewrite_success(sql_stmt_1, mv_name_1, enable_sync_mv_cost_based_rewrite(), true,
            [TRY_IN_RBO, FORCE_IN_RBO])
    mv_rewrite_fail(sql_stmt_1, mv_name_1, enable_sync_mv_cost_based_rewrite(), [NOT_IN_RBO])
