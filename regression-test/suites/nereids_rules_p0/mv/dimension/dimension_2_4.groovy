...
//    }
    ...
    mv_rewrite_success(sql_stmt_13, mv_name_13, enable_sync_mv_cost_based_rewrite(),
            true, [TRY_IN_RBO, FORCE_IN_RBO])
    mv_rewrite_fail(sql_stmt_13, mv_name_13, enable_sync_mv_cost_based_rewrite(), [NOT_IN_RBO])
