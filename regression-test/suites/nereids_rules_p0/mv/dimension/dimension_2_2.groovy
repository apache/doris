...
//    sql "SET disable_nereids_rules = 'INFER_PREDICATES, ELIMINATE_OUTER_JOIN, OLAP_SCAN_PARTITION_PRUNE'"
    ...
    def mv_stmt_1 = """select l_shipdate, t.o_orderdate, l_partkey, l_suppkey, t.o_orderkey
        from lineitem  
        inner join (select o_orderdate,o_orderkey from orders where o_orderdate = '2023-10-17' ) t 
    ...
    def mv_stmt_6 = """select t.l_shipdate, o_orderdate, t.l_partkey, t.l_suppkey, orders.o_orderkey 
        from orders 
        inner join  (select l_shipdate, l_orderkey, l_partkey, l_suppkey  from lineitem  where l_shipdate = '2023-10-17') t 
        on t.l_orderkey = orders.o_orderkey"""
