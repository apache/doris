...
suite("partition_mv_rewrite_dimension_2_1") {
    ...
    def mv_stmt_0 = """select t.l_shipdate, o_orderdate, t.l_partkey, t.l_suppkey, orders.o_orderkey 
        ...
        left join orders 
        on t.l_orderkey = orders.o_orderkey"""

    def mv_stmt_1 = """select l_shipdate, t.o_orderdate, l_partkey, l_suppkey, t.o_orderkey
        from lineitem  
        left join (select o_orderdate,o_orderkey from orders where o_orderdate = '2023-10-17' ) t 
        on lineitem.l_orderkey = t.o_orderkey"""

    def mv_stmt_2 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey 
        from lineitem  
        left join orders 
        on lineitem.l_orderkey = orders.o_orderkey 
        where l_shipdate = '2023-10-17'"""

    def mv_stmt_3 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey 
        from lineitem  
        left join orders 
        on lineitem.l_orderkey = orders.o_orderkey 
        where o_orderdate = '2023-10-17'"""

    def mv_stmt_4 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey  
        from lineitem  
        left join orders 
        on lineitem.l_orderkey = orders.o_orderkey 
        where l_shipdate = '2023-10-17'  and o_orderdate = '2023-10-17'"""

    def mv_stmt_5 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey 
        from lineitem  
        left join orders 
        on lineitem.l_orderkey = orders.o_orderkey 
        where l_shipdate = '2023-10-17'  and o_orderdate = '2023-10-17'  
    ...
    def mv_stmt_6 = """select t.l_shipdate, o_orderdate, t.l_partkey, t.l_suppkey, orders.o_orderkey 
        from orders 
        left join  (select l_shipdate, l_orderkey, l_partkey, l_suppkey  from lineitem  where l_shipdate = '2023-10-17') t 
        on t.l_orderkey = orders.o_orderkey"""

    def mv_stmt_7 = """select l_shipdate, t.o_orderdate, l_partkey, l_suppkey, t.o_orderkey 
        from (select o_orderdate, o_orderkey from orders where o_orderdate = '2023-10-17' ) t 
        left join lineitem   
        on lineitem.l_orderkey = t.o_orderkey"""

    def mv_stmt_8 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey 
        from orders  
        left join lineitem  
        on lineitem.l_orderkey = orders.o_orderkey 
        where l_shipdate = '2023-10-17' """

    def mv_stmt_9 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey 
        from orders 
        left join lineitem  
        on lineitem.l_orderkey = orders.o_orderkey 
        where o_orderdate = '2023-10-17'  """

    def mv_stmt_10 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey  
        from orders 
        left join  lineitem  
        on lineitem.l_orderkey = orders.o_orderkey 
        where l_shipdate = '2023-10-17'  and o_orderdate = '2023-10-17'  """

    def mv_stmt_11 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders.o_orderkey 
        from orders  
        left join lineitem  
        on lineitem.l_orderkey = orders.o_orderkey
        where l_shipdate = '2023-10-17'  and o_orderdate = '2023-10-17'   
