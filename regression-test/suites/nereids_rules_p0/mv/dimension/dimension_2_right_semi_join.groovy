...
suite("partition_mv_rewrite_dimension_2_right_semi_join") {
    ...
    sql """CREATE TABLE `orders_2_right_semi_join` (
    ...
    sql """
    drop table if exists lineitem_2_right_semi_join
    """

    sql """CREATE TABLE `lineitem_2_right_semi_join` (
    ...
    sql """
    insert into orders_2_right_semi_join values 
    ...
    sql """
    insert into lineitem_2_right_semi_join values 
    ...
    def mv_stmt_0 = """select o_orderkey, o_orderdate, o_custkey 
        from (select l_shipdate, l_partkey, l_suppkey, l_orderkey from lineitem_2_right_semi_join where l_shipdate = '2023-10-17') t
