...
suite("partition_mv_rewrite_dimension_2_right_join") {
    ...
    sql """CREATE TABLE `orders_2_right_join` (
    ...
    sql """
    drop table if exists lineitem_2_right_join
    """

    sql """CREATE TABLE `lineitem_2_right_join` (
    ...
    sql """
    insert into orders_2_right_join values 
    ...
    sql """
    insert into lineitem_2_right_join values 
    ...
    def mv_stmt_6 = """select t.l_shipdate, o_orderdate, t.l_partkey, t.l_suppkey, orders_2_right_join.o_orderkey 
        ...
        right join orders_2_right_join 
        on t.l_orderkey = orders_2_right_join.o_orderkey"""

    def mv_stmt_7 = """select l_shipdate, t.o_orderdate, l_partkey, l_suppkey, t.o_orderkey
        from lineitem_2_right_join  
        right join (select o_orderdate,o_orderkey from orders_2_right_join where o_orderdate = '2023-10-17' ) t 
        on lineitem_2_right_join.l_orderkey = t.o_orderkey"""

    def mv_stmt_8 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders_2_right_join.o_orderkey 
        from lineitem_2_right_join  
        right join orders_2_right_join 
        on lineitem_2_right_join.l_orderkey = orders_2_right_join.o_orderkey 
        where l_shipdate = '2023-10-17'"""

    def mv_stmt_9 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders_2_right_join.o_orderkey 
        from lineitem_2_right_join  
        right join orders_2_right_join 
        on lineitem_2_right_join.l_orderkey = orders_2_right_join.o_orderkey 
        where o_orderdate = '2023-10-17'"""

    def mv_stmt_10 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders_2_right_join.o_orderkey  
        from lineitem_2_right_join  
        right join orders_2_right_join 
        on lineitem_2_right_join.l_orderkey = orders_2_right_join.o_orderkey 
        where l_shipdate = '2023-10-17'  and o_orderdate = '2023-10-17'"""

    def mv_stmt_11 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey, orders_2_right_join.o_orderkey 
        from lineitem_2_right_join  
        right join orders_2_right_join 
        on lineitem_2_right_join.l_orderkey = orders_2_right_join.o_orderkey 
        where l_shipdate = '2023-10-17'  and o_orderdate = '2023-10-17'  
