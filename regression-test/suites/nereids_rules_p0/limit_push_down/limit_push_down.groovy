...
suite("limit_push_down") {
    ...
    //`limit 1, project`:
    qt_limit_project """ explain shape plan SELECT t1.id FROM t1 LIMIT 1; """
    //`limit 1 + sort, project`:
    qt_limit_sort_project """ explain shape plan SELECT t1.id FROM t1 ORDER BY id LIMIT 1; """
    //`limit 1 offset 1, project`:
    qt_limit_offset_project """ explain shape plan SELECT t1.id FROM t1 LIMIT 1 OFFSET 1; """
    ...
    qt_limit_sort_agg_having """ explain shape plan SELECT  COUNT(distinct id) c FROM t1 ORDER BY c LIMIT 1; """
    ...
    qt_limit_offset_sort_agg_having """ explain shape plan SELECT COUNT(distinct id) c FROM t1 ORDER BY c LIMIT 1 OFFSET 1; """
    //`limit 1, Set Operation`:
    qt_limit_set_operation """ explain shape plan SELECT t1.id FROM t1 UNION SELECT t2.id FROM t2 LIMIT 1; """
    //`limit 1 + sort, Set Operation`:
    qt_limit_sort_set_operation """ explain shape plan SELECT t1.id FROM t1 UNION all SELECT t2.id FROM t2 ORDER BY id LIMIT 1; """
    ...
    //`limit 1 offset 1 + sort, Set Operation`:
    qt_limit_offset_sort_set_operation """ explain shape plan SELECT t1.id FROM t1 EXCEPT SELECT t2.id FROM t2 ORDER BY id LIMIT 1 OFFSET 1; """
    //`limit 1, window`:
    ...
    qt_limit_offset_sort_filter """ explain shape plan SELECT t1.id FROM t1 WHERE id = 1 ORDER BY id LIMIT 1 OFFSET 1; """
}