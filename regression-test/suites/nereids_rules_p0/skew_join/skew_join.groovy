...
suite("skew_join") {
    ...
    drop table if exists table_30_undef_partitions2_keys3_properties4_distributed_by52;
    ...
    drop table if exists table_200_undef_partitions2_keys3_properties4_distributed_by5;
