...
suite("infer_unequal_predicates") {
    ...
    """
    sql "insert into test_like1 values(1,'d2',3,5);"
    sql "insert into test_like1 values(0,'d2',3,5);"
    sql "insert into test_like1 values(0,'d2',3,7);"
    ...
    explain shape plan
    SELECT * FROM test_like1 t1 INNER JOIN test_like2 t2 ON t1.a<t2.d AND t2.d<t2.c AND t2.c<10
    """

    qt_infer_with_constant_and_columns """
    explain shape plan
    SELECT * FROM test_like1 t1 INNER JOIN test_like2 t2 ON t1.a>1 AND t1.a=t2.c AND t2.c<t2.d
    """

    qt_no_infer """
    explain shape plan
    SELECT * FROM test_like1 t1 INNER JOIN test_like2 t2 ON t1.a<t2.d AND t2.d>t2.c
    """

    qt_no_infer_cyclic_dependency """
    explain shape plan
    SELECT * FROM test_like1 t1 INNER JOIN test_like2 t2 ON t1.a<t2.c AND t2.c<t1.a
    """
