...
suite('test_simplify_comparison_predicate_int_vs_double') {
    sql """
        ...
        insert into tbl1_test_simplify_comparison_predicate_int_vs_double values(100, "870479087484055553"), (101, "870479087484055554");
        insert into tbl2_test_simplify_comparison_predicate_int_vs_double values(200, 870479087484055553);
    """
