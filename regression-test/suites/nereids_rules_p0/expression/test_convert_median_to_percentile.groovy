...
suite("test_convert_median_to_percentile") {
    ...
    assertTrue(explainStr1.toString().contains("percentile_v2(profit, 0.5)"))
    qt_select_1 "${sql1}"
    qt_select_2 "${sql2}"
    ...
    assertTrue(explainStr3.toString().contains("percentile_v2(profit"))
    qt_select_3 "${sql3}"
    qt_select_4 "${sql4}"
    ...
    assertTrue(explainStr5.toString().contains("percentile_v2(profit"))
    qt_select_5 "${sql5}"
    qt_select_6 "${sql6}"
