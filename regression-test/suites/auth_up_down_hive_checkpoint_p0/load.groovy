...
suite("test_up_down_hive_prepare_checkpoint_auth","p0,auth,restart_fe,external,hive,external_docker,external_docker_hive") {
    ...
    sql """ADMIN SET FRONTEND CONFIG ('edit_log_roll_num' = '3')"""
    ...
    sql """ADMIN SET FRONTEND CONFIG ('edit_log_roll_num' = '50000')"""
}
