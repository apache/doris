...
suite("test_hudi_partition_prune", "p2,external,hudi,external_remote,external_remote_hudi") {
    ...
    //time travel 
    def time_travel_two_partition_1_3 = "select id,name,part1,part2 from two_partition_tb  FOR TIME AS OF '20241126012025218' order by id;"
    def time_travel_two_partition_2_2 = "select id,name,part1,part2 from two_partition_tb  FOR TIME AS OF '20241126012025218' where part1='US' order by id;"
    def time_travel_two_partition_3_1 = "select id,name,part1,part2 from two_partition_tb  FOR TIME AS OF '20241126012025218' where part2=2 order by id;"
    def time_travel_two_partition_4_0 = "select id,name,part1,part2 from two_partition_tb  FOR TIME AS OF '20241126012025218' where part2=10 order by id;"
