...
suite("test_paimon_hms_catalog_write", "p2,external,paimon,new_catalog_property") {
    ...
    String catalogName = "test_paimon_hms_catalog_write"
    String dbName = "hdfs_db"
    String appendTable = "test_paimon_hms_write_append"
    String primaryKeyTable = "test_paimon_hms_write_pk"
    ...
    sql """
        CREATE CATALOG `${catalogName}` PROPERTIES (
            ...
            'warehouse' = 'hdfs://${externalEnvIp}:${hdfsPort}/user/hive/warehouse',
