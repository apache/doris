...
suite("test_mysql_jdbc_catalog", "p0") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        order_qt_ex_tb1  """ select * from ${ex_tb1}; """
        order_qt_ex_tb2  """ select * from ${ex_tb2}; """
        order_qt_ex_tb3  """ select * from ${ex_tb3}; """
        order_qt_ex_tb4  """ select * from ${ex_tb4}; """
        order_qt_ex_tb5  """ select * from ${ex_tb5}; """
        order_qt_ex_tb6  """ select * from ${ex_tb6}; """
        order_qt_ex_tb7  """ select * from ${ex_tb7}; """
        order_qt_ex_tb8  """ select * from ${ex_tb8}; """
        order_qt_ex_tb9  """ select * from ${ex_tb9}; """
        order_qt_ex_tb10  """ select * from ${ex_tb10}; """
        order_qt_ex_tb11  """ select * from ${ex_tb11}; """
        order_qt_ex_tb12  """ select * from ${ex_tb12}; """
        order_qt_ex_tb13  """ select * from ${ex_tb13}; """
        order_qt_ex_tb14  """ select * from ${ex_tb14}; """
        order_qt_ex_tb15  """ select * from ${ex_tb15}; """
        order_qt_ex_tb16  """ select * from ${ex_tb16}; """
        order_qt_ex_tb17  """ select * from ${ex_tb17}; """
        order_qt_ex_tb18  """ select * from ${ex_tb18}; """
        order_qt_ex_tb18  """ select * from ${ex_tb19}; """
