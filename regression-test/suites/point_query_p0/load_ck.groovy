...
suite("test_load_and_schema_change_row_store_ck", "p0") {
    ...
    sql """
        CREATE TABLE IF NOT EXISTS tbl_scalar_types_dup_ck_1 (
            `k1` bigint(11) NULL,
            `c_bool` boolean NULL,
            `c_tinyint` tinyint(4) NULL,
            `c_smallint` smallint(6) NULL,
        ...
        UNIQUE KEY(`k1`)
        ORDER BY(c_datev2, c_date, c_largeint, c_tinyint, c_varchar, c_char, c_datetimev2, c_int, c_decimalv3, k1, c_decimal)
        COMMENT 'OLAP'
        DISTRIBUTED BY HASH(`k1`) BUCKETS 10
    ...
    sql """insert into tbl_scalar_types_dup_ck_1(new_column1) values (9999999)"""
    qt_sql """select length(__DORIS_ROW_STORE_COL__) from tbl_scalar_types_dup_ck_1 where new_column1 = 9999999"""
    ...
    qt_sql "select /*+ SET_VAR(enable_nereids_planner=true)*/ k1, c_decimalv3 from tbl_scalar_types_dup_ck_1 where k1 = -2147303679"
}
