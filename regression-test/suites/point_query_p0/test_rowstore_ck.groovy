...
suite("test_rowstore_ck", "p0,nonConcurrent") {
    ...
    sql """
        CREATE TABLE IF NOT EXISTS table_with_column_group_ck (
    ...
    """
    sql """
        insert into table_with_column_group_ck values (1, "11111111111111111111111111111111111111", 3, 4.0, '2021-02-01 11:11:11'), (2, "222222222222222222222222222222222", 3, 4, '2022-02-01 11:11:11'), (3, "33333333333333333333333333333333", 3, 4, '2023-02-01 11:11:11');
    """
    sql "set show_hidden_columns = true"
    qt_sql """
        select length(__DORIS_ROW_STORE_COL__) from table_with_column_group_ck order by k1;
    """

     sql "DROP TABLE IF EXISTS table_with_column_group_ck1"
    sql """
        CREATE TABLE IF NOT EXISTS table_with_column_group_ck1 (
                `k1` int(11) NULL COMMENT "",
                `v1` text NULL COMMENT "",
                `v2` bigint NULL COMMENT "",
                `v3` double NULL COMMENT "",
    ...
    """
    sql """
        insert into table_with_column_group_ck1 values (1, "11111111111111111111111111111111111111", 3, 4.0, '2021-02-01 11:11:11'), (2, "222222222222222222222222222222222", 3, 4, '2022-02-01 11:11:11'), (3, "33333333333333333333333333333333", 3, 4, '2023-02-01 11:11:11');
    """
    sql "set show_hidden_columns = true"
    qt_sql """
        select length(__DORIS_ROW_STORE_COL__) from table_with_column_group_ck1 order by k1;
    """

    sql "DROP TABLE IF EXISTS table_with_column_group_ck2"
    sql """
        CREATE TABLE IF NOT EXISTS table_with_column_group_ck2 (
                `k1` int(11) NULL COMMENT "",
                `v1` text NULL COMMENT "",
                `v2` bigint NULL COMMENT "",
                `v3` double NULL COMMENT "",
    ...
    """
    sql """
        insert into table_with_column_group_ck2 values (1, "11111111111111111111111111111111111111", 3, 4.0, '2021-02-01 11:11:11'), (2, "222222222222222222222222222222222", 3, 4, '2022-02-01 11:11:11'), (3, "33333333333333333333333333333333", 3, 4, '2023-02-01 11:11:11');
    """
    qt_sql """
        select length(__DORIS_ROW_STORE_COL__) from table_with_column_group_ck2 order by k1;
    """

    sql "DROP TABLE IF EXISTS table_with_column_group_ck3"
    sql """
        CREATE TABLE IF NOT EXISTS table_with_column_group_ck3 (
                `k1` int(11) NULL COMMENT "",
                `v1` text NULL COMMENT "",
                `v2` bigint NULL COMMENT "",
                `v3` double NULL COMMENT "",
    ...
    """
     sql """
        insert into table_with_column_group_ck3 values (1, "11111111111111111111111111111111111111", 3, 4.0, '2021-02-01 11:11:11'), (2, "222222222222222222222222222222222", 3, 4, '2022-02-01 11:11:11'), (3, "33333333333333333333333333333333", 3, 4, '2023-02-01 11:11:11');
    """
    qt_sql """
        select length(__DORIS_ROW_STORE_COL__) from table_with_column_group_ck3 order by k1;
    """
    sql "set show_hidden_columns = false"

    sql """DROP TABLE IF EXISTS table_with_column_group_ck_xxx"""
    sql """
            CREATE TABLE IF NOT EXISTS table_with_column_group_ck_xxx (
        ...
        """
    sql """ INSERT INTO table_with_column_group_ck_xxx values
    ...
    connect(user = user, password = password, url = prepare_url) {
        ...
        def sql_str = "select v1, v2 from table_with_column_group_ck where k1 = ?"
        prep_sql sql_str, 1
        prep_sql sql_str, 2 
        prep_sql sql_str, 3
        sql_str = "select v2 from table_with_column_group_ck where k1 = ?"
        prep_sql sql_str, 1
        prep_sql sql_str, 2 
        prep_sql sql_str, 3
        sql_str = "select v1 from table_with_column_group_ck where k1 = ?"
        prep_sql sql_str, 3
        sql_str = "select v2, v1 from table_with_column_group_ck where k1 = ?"
        prep_sql sql_str, 3
        ...
        sql_str = "select v2 from table_with_column_group_ck2 where k1 = ?"
        prep_sql sql_str, 1
        prep_sql sql_str, 2
        prep_sql sql_str, 3

        sql_str = "select v4 from table_with_column_group_ck3 where k1 = ?"
        prep_sql sql_str, 1
        prep_sql sql_str, 2
        prep_sql sql_str, 3
        ...
        def stmt = prepareStatement """ SELECT datetimev2_1,datetime_val1,datetime_val2,max_dwell_time FROM table_with_column_group_ck_xxx t where user_id = ? and date = ? and datev2 = ? and datetimev2_1 = ? and datetimev2_2 = ? and city = ? and age = ? and sex = ?; """
    ...
    sql "DROP TABLE IF EXISTS table_with_column_group_ck4"
    sql """
         CREATE TABLE IF NOT EXISTS table_with_column_group_ck4 (
                 `k1` int(11) NULL COMMENT "",
                 `v1` text NULL COMMENT "",
                 `v2` bigint NULL COMMENT "",
                 `v3` double NULL COMMENT "",
    ...
    """
    sql "select /*+ SET_VAR(enable_nereids_planner=true)*/ * from table_with_column_group_ck where k1 = 1"

    sql """DROP TABLE IF EXISTS rs_query_ck"""
    ...
    sql """
         ALTER table rs_query_ck ADD COLUMN new_column1 INT default "123";
    """
    qt_sql """select * from rs_query_ck where k1 = 1"""

    sql """
         ALTER table rs_query_ck ADD COLUMN new_column2 DATETIMEV2(3) DEFAULT "1970-01-01 00:00:00.111";
    """
    sleep(1000)
    qt_sql """select * from rs_query_ck where k1 = 1"""
   
    sql """insert into rs_query_ck values (2, 'def', 1111919.12345678919, 456, NULL)"""
    qt_sql """select * from rs_query_ck where k1 = 2"""
