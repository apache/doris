...
suite("test_show_repository_auth","p0,auth_call") {
    String user = 'test_show_repository_auth_user'
    String pwd = 'C123_567p'
    String dbName = 'test_show_repository_auth_db'
    String repositoryName = 'test_show_repository_auth_rps'
