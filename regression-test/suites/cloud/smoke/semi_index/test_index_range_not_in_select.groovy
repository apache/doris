suite("smoke_test_index_not_in_select", "smoke"){
    if (context.config.cloudVersion != null && !context.config.cloudVersion.isEmpty()
        ...
        log.info("case: smoke_test_index_not_in_select, cloud version ${context.config.cloudVersion} bigger than 3.0.0, skip".toString());
        return
    }
