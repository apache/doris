...
suite("smoke_test_match_query_without_index", "smoke"){
    if (context.config.cloudVersion != null && !context.config.cloudVersion.isEmpty()
        ...
        log.info("case: smoke_test_match_query_without_index, cloud version ${context.config.cloudVersion} less than 3.0.0, skip".toString());
        return
    }
