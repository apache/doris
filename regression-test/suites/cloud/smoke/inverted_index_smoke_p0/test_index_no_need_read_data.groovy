...
// under the License.
suite("smoke_test_index_no_need_read_data", "smoke"){
    if (context.config.cloudVersion != null && !context.config.cloudVersion.isEmpty()
        ...
        log.info("case: smoke_test_index_no_need_read_data, cloud version ${context.config.cloudVersion} less than 3.0.0, skip".toString());
        return
    }
