...
suite("smoke_test_inverted_index_null", "smoke") {
    if (context.config.cloudVersion != null && !context.config.cloudVersion.isEmpty()
        ...
        log.info("case: smoke_test_inverted_index_null, cloud version ${context.config.cloudVersion} less than 3.0.0, skip".toString());
        return
    }
