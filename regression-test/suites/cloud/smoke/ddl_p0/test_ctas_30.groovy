...
suite("smoke_test_ctas_30", "smoke") {
    if (context.config.cloudVersion != null && !context.config.cloudVersion.isEmpty()
        ...
        log.info("case: smoke_test_ctas, cloud version ${context.config.cloudVersion} less than 3.0.0, skip".toString());
        return
    }
    def dbname = "test_ctas_30";
