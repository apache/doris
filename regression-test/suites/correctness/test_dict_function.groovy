...
suite("test_dict_function") {
    ...
    qt_select1 """
        select id, dict_get_int64("dict_key_int64","i64" ,id) from test_dict_function order by id;
    """
    qt_select2 """
        select id, dict_get_string("dict_key_int64","str" ,id) from test_dict_function order by id;
    """ 
    qt_select3 """
        select id, dict_get_float32("dict_key_int64","f32" ,id) from test_dict_function order by id;
    """
   
   test {
        sql """
        select id, dict_get_string("dict_key_int64","f32" ,id) from test_dict_function order by id;
        """
    ...
    qt_select1 """
        select id, name,  dict_get_int64("dict_key_string","i64" ,name) from test_dict_str_function order by id;
    """
    qt_select2 """
    ...
    """ 
    qt_select3 """
        select id, name,  dict_get_float32("dict_key_string","f32" ,name) from test_dict_str_function order by id;

    """
   
   test {
        sql """
            select id, dict_get_int64("dict_key_string","i64" ,id) from test_dict_str_function order by id;
        """
