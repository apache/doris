...
suite("txn_insert_with_drop", "nonConcurrent") {
    def table = "txn_insert_with_drop"
    def dbName = "regression_test_insert_p0_txn_drop"
    ...
    try {
        ...
        sql """ insert into ${table}_2 select * from ${table}_4; """
        sql """ commit; """
        sql """ sync; """
