...
// 2. In docker closure:
//    a. deprecated dockerAwaitUntil(...), should use 'Awaitility.await()...until(f)' directly;
//    b. can use java Thread, No need force use regress framework's ThreadAction(see example demo_p0/thread_action.groovy);
