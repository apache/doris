...
suite("test_base_comment_multi_level_mtmv","mtmv") {
    ...
    sql """
        ...
        """
    order_qt_comment_t1_mv1 "select Name,State,RefreshState,SyncWithBaseTables  from mv_infos('database'='${dbName}') where Name='${mvName1}'"
    order_qt_comment_t1_mv2 "select Name,State,RefreshState,SyncWithBaseTables  from mv_infos('database'='${dbName}') where Name='${mvName2}'"
    order_qt_comment_t1_mv3 "select Name,State,RefreshState,SyncWithBaseTables  from mv_infos('database'='${dbName}') where Name='${mvName3}'"
    order_qt_comment_t1_mv4 "select Name,State,RefreshState,SyncWithBaseTables  from mv_infos('database'='${dbName}') where Name='${mvName4}'"
