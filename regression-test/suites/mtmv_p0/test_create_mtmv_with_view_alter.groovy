...
suite("test_create_mtmv_with_view_alter","mtmv") {
    String suiteName = "test_create_mtmv_with_view_alter"
    ...
    sql"""
        create view ${viewName} as select k2,k3+1 as k4 from ${tableName};
        """
    ...
    order_qt_state_alter_view "select State from mv_infos('database'='${dbName}') where Name='${mvName}'"
