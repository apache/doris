...
suite("fold_constant") {
    ...
    sql """
    delete from  delete_condition PARTITION p201702  where  `create_date` > '2017-02-02 00:00:00'; 
    """
    ...
    sql """
    delete from  delete_condition2 PARTITION p201702  where  `create_date` > '2017-02-02 00:00:00'; 
    """
