...
suite("load") {
    ...
    // ---- primary key / foreign key / unique key constraints ----
    sql """alter table item add constraint i_pk primary key (i_item_sk);"""
    sql """alter table customer add constraint c_pk primary key (c_customer_sk);"""
    sql """alter table store_sales add constraint ss_c_fk foreign key(ss_customer_sk) references customer(c_customer_sk);"""
    sql """alter table web_sales add constraint ws_c_fk foreign key(ws_bill_customer_sk) references customer(c_customer_sk);"""
    sql """alter table catalog_sales add constraint cs_c_fk foreign key(cs_bill_customer_sk) references customer(c_customer_sk);"""
    sql """alter table customer add constraint c_uk unique (c_customer_id);"""
}
