...
//    sql """use ${dbName}"""
    ...
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-02-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-03-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-04-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-05-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-06-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-07-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-08-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-09-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-010-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-11-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName1} PARTITION(dt='2017-12-15') values (1,1)"""
    ...
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-02-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-03-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-04-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-05-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-06-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-07-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-08-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-09-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-010-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-11-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName2} PARTITION(dt='2017-12-15') values (1,1)"""
    ...
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-02-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-03-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-04-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-05-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-06-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-07-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-08-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-09-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-010-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-11-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName3} PARTITION(dt='2017-12-15') values (1,1)"""
    ...
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-02-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-03-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-04-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-05-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-06-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-07-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-08-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-09-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-010-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-11-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName5} PARTITION(dt='2017-12-15') values (1,1)"""
    ...
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-02-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-03-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-04-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-05-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-06-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-07-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-08-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-09-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-010-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-11-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName6} PARTITION(dt='2017-12-15') values (1,1)"""
    ...
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-02-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-03-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-04-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-05-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-06-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-07-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-08-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-09-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-010-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-11-15') values (1,1)"""
    hive_docker """insert into ${dbName}.${tableName9} PARTITION(dt='2017-12-15') values (1,1)"""
