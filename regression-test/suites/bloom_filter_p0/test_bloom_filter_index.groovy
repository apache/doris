...
suite("test_bloom_filter_index", "nonConcurrent") {
    ...
    def runShowProc = { tag, procPath ->
        quickRunTest(tag, "SHOW PROC '${procPath}'", false) { row ->
            [row[0], row[1], row[5]]
        }
    }
    ...
    runDesc("desc_named_inline", "test_bloom_filter_named_inline")
    runDesc("desc_all_named_inline", "test_bloom_filter_named_inline", true)
    runShowProc("show_proc_named_inline_mixed", getBaseIndexSchemaProcPath("test_bloom_filter_named_inline"))
    runShowIndex("show_index_named_inline", "test_bloom_filter_named_inline")
    ...
    runDesc("desc_named_inline_after_legacy_drop", "test_bloom_filter_named_inline")
    ...
    runDesc("desc_named_add_on_legacy", "test_bloom_filter_named_add_on_legacy")
    runShowIndex("show_index_named_add_on_legacy", "test_bloom_filter_named_add_on_legacy")
    ...
    runDesc("desc_named_drop_mixed_before", "test_bloom_filter_named_drop_mixed")
    runShowIndex("show_index_named_drop_mixed_before", "test_bloom_filter_named_drop_mixed")
    ...
    runDesc("desc_named_drop_mixed_after", "test_bloom_filter_named_drop_mixed")
    runShowIndex("show_index_named_drop_mixed_after", "test_bloom_filter_named_drop_mixed")
    ...
    runDesc("desc_named_rename_legacy_mixed", "test_bloom_filter_named_rename_legacy_mixed")
    runShowIndex("show_index_named_rename_legacy_mixed", "test_bloom_filter_named_rename_legacy_mixed")
    ...
    runDesc("desc_named_drop_legacy_column_mixed", "test_bloom_filter_named_drop_legacy_column_mixed")
    runShowIndex("show_index_named_drop_legacy_column_mixed", "test_bloom_filter_named_drop_legacy_column_mixed")
    ...
    runDesc("desc_all_named_rollup", "test_bloom_filter_named_rollup", true)
    ...
    runDesc("desc_all_named_rollup_after_drop", "test_bloom_filter_named_rollup", true)
    ...
    runDesc("desc_named_create_index", "test_bloom_filter_named_create_index")
    runShowIndex("show_index_named_create_index", "test_bloom_filter_named_create_index")
    ...
    runDesc("desc_named_create_index_after_drop", "test_bloom_filter_named_create_index")
    runShowIndex("show_index_named_create_index_after_drop", "test_bloom_filter_named_create_index")
    ...
    test {
        sql """ALTER TABLE test_bloom_filter_cov_add_index_with_properties
                ADD INDEX idx_v1 (v1) USING BLOOMFILTER PROPERTIES ("bloom_filter_fpp" = "foo")"""
        exception "Bloom filter fpp is not Double"
    }
    ...
    runShowIndex("show_index_named_variant", "test_bloom_filter_named_variant")
    ...
    // BfColumns use the table-level FPP, while BfIndex entries
    ...
    // Step 2: remove BfColumns, create a BfIndex on v1 with its own FPP.
    // Only the BfIndex is active → index-level FPP (0.02) is used.
    ...
    // Step 3: after removing the last bf_columns, re-adding k1 without FPP uses the default 0.05.
    // The following ALTER explicitly changes the table-level FPP back to 0.03.
