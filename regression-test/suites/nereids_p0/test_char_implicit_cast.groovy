...
suite("test_char_implicit_cast") {
    ...
    qt_test_timediff_varchar 'select timediff("2010-01-01 01:00:00.123456", "2010-01-05 01:00:00.654321");'
    qt_test_timediff_char 'select timediff("2010-01-01 01:00:00", cast("2010-01-02 01:00:00" as string));'
