    ...
    for (def __ in 0..3) {
        combineFutures(
            ...
            extraThread("test_drop_column", {
                ...
                sql "insert into test_use_plan_cache25 values('2', '2', '2')"
                sleep(100)
                sql "insert into test_use_plan_cache25 values('1', '1', '1')"
                ...
                sql "alter table test_use_plan_cache25 drop column c1"
                assertNoCache "select * from test_use_plan_cache25"
            }),
