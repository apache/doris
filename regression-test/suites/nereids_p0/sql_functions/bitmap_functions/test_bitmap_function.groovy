...
suite("test_bitmap_function") {
    ...
    // result is not stable, need to fix
    // qt_sql_orthogonal_bitmap_intersect_count3 """ select orthogonal_bitmap_intersect_count(members, tag_group, 1,11) from test_arthogonal_bitmap; """
