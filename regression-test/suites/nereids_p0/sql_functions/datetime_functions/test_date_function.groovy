...
suite("test_date_function") {
   ...
   tableName = "test_time_add_sub_function"
    ...
    sql """ CREATE TABLE IF NOT EXISTS dt_null(
            ...
            properties("replication_num" = "1"); """
    sql """ insert into dt_null values ('1', '2020-12-12', '2020-12-12', '2020-12-12', '2020-12-12'),
            ('2', '2020-12-12 12:12:12', '2020-12-12 12:12:12', '2020-12-12 12:12:12', '2020-12-12 12:12:12'),
            ('3', '2020-12-12 12:12:12.0', '2020-12-12 12:12:12.0', '2020-12-12 12:12:12.0', '2020-12-12 12:12:12.0'),
            ('4', '2020-12-12 12:12:12.123', '2020-12-12 12:12:12.123', '2020-12-12 12:12:12.123', '2020-12-12 12:12:12.123'),
            ('5', '2020-12-12 12:12:12.666666', '2020-12-12 12:12:12.666666', '2020-12-12 12:12:12.666666', '2020-12-12 12:12:12.666666'); """

    qt_sql_dt_null_1 """ select unix_timestamp(dtv24), unix_timestamp(dtv20n),unix_timestamp(dv2),unix_timestamp(dv2n) from dt_null order by k1; """
}
