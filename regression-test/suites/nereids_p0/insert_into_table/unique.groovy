...
suite("nereids_insert_unique") {
    ...
    sql 'drop table if exists uni_light_sc_t'
    sql 'drop table if exists uni_light_sc_mow_t'
    sql 'drop table if exists uni_light_sc_not_null_t'
    sql 'drop table if exists uni_light_sc_mow_not_null_t'
    sql '''
