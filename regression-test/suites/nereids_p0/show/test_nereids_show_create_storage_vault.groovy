...
suite("test_show_create_storage_vault_command", "storage_vault,cloud") {
    def suiteName = name;
    ...
    def hdfsVaultInfo = try_sql """SHOW CREATE STORAGE VAULT FOR ${hdfsVaultName}"""
    def s3VaultInfo = try_sql """SHOW CREATE STORAGE VAULT FOR ${s3VaultName}"""
