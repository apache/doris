...
suite("test_show_storage_policy_nereids", "query,storage_policy") {
    ...
    try {
        ...
        // Execute the SHOW STORAGE POLICY command and verify the output
        checkNereidsExecute("SHOW STORAGE POLICY")
        checkNereidsExecute("SHOW STORAGE POLICY USING FOR ${policyName}")
    } catch (Exception e) {
