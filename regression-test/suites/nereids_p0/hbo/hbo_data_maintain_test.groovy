...
suite("hbo_data_maintain_test", "nonConcurrent") {
    ...
    sql """insert into hbo_data_maintain_test1 select number, number from numbers("number" = "10000");"""
    sql """insert into hbo_data_maintain_test1 select 1,1 from numbers("number" = "10000000");"""
    ...
    sql """insert into hbo_data_maintain_test2 select number, number from numbers("number" = "10000");"""
    ...
    /**
     ...
     |          +--PhysicalProject[371]@6 ( stats=1, projects=[1 AS `1`#8] )                                                                                                                                                                                        |
     |             +--PhysicalHashJoin[366]@5 ( stats=1, type=INNER_JOIN, hashCondition=[(b#1 = b#3)], otherCondition=[], markCondition=[], runtimeFilters=[RF0[b#1->[b#3](ndv/size = 1/1) , RF1[b#1->[b#3](ndv/size = 1/1) ] )                                     |
     |                |--PhysicalProject[345]@4 ( stats=100,000, projects=[b#3] )                                                                                                                                                                                   |
     |                |  +--PhysicalOlapScan[hbo_data_maintain_test2]@3 ( stats=100,000, RFs= RF0 RF1 )                                                                                                                                                             |
     |                +--PhysicalDistribute[361]@2 ( stats=1, distributionSpec=DistributionSpecReplicated )                                                                                                                                                         |
     |                   +--PhysicalProject[356]@2 ( stats=1, projects=[b#1] )                                                                                                                                                                                      |
     |                      +--PhysicalFilter[351]@1 ( stats=1, predicates=(a#0 = 1) )                                                                                                                                                                              |
     |                         +--PhysicalOlapScan[hbo_data_maintain_test1]@0 ( stats=100,000 )
     +--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
     */
    explain {
    ...
    /**
     ...
     | PhysicalResultSink[391] ( outputExprs=[__count_0#4] )                                                                                                                                                                                                             |
     | +--PhysicalHashAggregate[386]@7 ( stats=(hbo)1, aggPhase=GLOBAL, aggMode=BUFFER_TO_RESULT, maybeUseStreaming=false, groupByExpr=[], outputExpr=[count(partial_count(*)#9) AS `count(*)`#4], partitionExpr=Optional[[]], topnFilter=false, topnPushDown=false )    |
     |    +--PhysicalDistribute[381]@9 ( stats=(hbo)0, distributionSpec=DistributionSpecGather )                                                                                                                                                                         |
     |       +--PhysicalHashAggregate[376]@9 ( stats=(hbo)0, aggPhase=LOCAL, aggMode=INPUT_TO_BUFFER, maybeUseStreaming=false, groupByExpr=[], outputExpr=[partial_count(*) AS `partial_count(*)`#9], partitionExpr=Optional[[]], topnFilter=false, topnPushDown=false ) |
     |          +--PhysicalProject[371]@6 ( stats=0, projects=[1 AS `1`#8] )                                                                                                                                                                                             |
     |             +--PhysicalHashJoin[366]@5 ( stats=(hbo)0, type=INNER_JOIN, hashCondition=[(b#1 = b#3)], otherCondition=[], markCondition=[], runtimeFilters=[RF0[b#1->[b#3](ndv/size = 1/1) , RF1[b#1->[b#3](ndv/size = 1/1) ] )                                     |
     |                |--PhysicalProject[345]@4 ( stats=100,000, projects=[b#3] )                                                                                                                                                                                        |
     |                |  +--PhysicalOlapScan[hbo_data_maintain_test2]@3 ( stats=100,000, RFs= RF0 RF1 )                                                                                                                                                                  |
     |                +--PhysicalDistribute[361]@2 ( stats=0, distributionSpec=DistributionSpecReplicated )                                                                                                                                                              |
     |                   +--PhysicalProject[356]@2 ( stats=0, projects=[b#1] )                                                                                                                                                                                           |
     |                      +--PhysicalFilter[351]@1 ( stats=(hbo)0, predicates=(a#0 = 1) )                                                                                                                                                                              |
     |                         +--PhysicalOlapScan[hbo_data_maintain_test1]@0 ( stats=100,100,000 )
     +-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
     */
    explain {
