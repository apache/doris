...
suite("hbo_slow_query_test") {
    ...
    sql "set hbo_slow_query_threshold=10;"
    ...
    explain {
        ...
        contains("PhysicalHashAggregate[228]@3 ( stats=(hbo)1, aggPhase=GLOBAL")
    }

    sql "set hbo_slow_query_threshold=1000;"
    sql "select count(1) from hbo_slow_query_test where a > 0;"
