...
suite("test_backup_store_with_db_properties","backup_restore") {
    ...
    sql """ 
        ...
        PROPERTIES ("replication_allocation" = "tag.location.default:${replicaNum}")
        """

    def result_kv_origin = sql "SHOW CREATE DATABASE ${dbName}"
    assertTrue(result_kv_origin.toString().containsIgnoreCase("tag.location.default:${replicaNum}"))
    ...
    def result_kv_restore = sql "SHOW CREATE DATABASE ${dbName}"
