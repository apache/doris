...
suite("spark_connector_read_filter", "connector") {


    def tableReadName = "test_spark_read_filter"
    def tableWriterName = "test_spark_writer_filter"
    ...
    def download_spark_jar = "/usr/bin/curl ${getS3Url()}/regression/spark-doris-read-filter-jar-with-dependencies.jar --output spark-doris-read-filter.jar".execute().getText()
    logger.info("finish download spark doris demo ...")
    def run_cmd = "java -jar spark-doris-read-filter.jar $context.config.feHttpAddress $context.config.feHttpUser regression_test_connector_p0_spark_connector.$tableReadName regression_test_connector_p0_spark_connector.$tableWriterName"
