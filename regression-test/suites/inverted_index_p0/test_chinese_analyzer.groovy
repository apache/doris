...
suite("test_chinese_analyzer"){
    ...
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '清华' ORDER BY id;"
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '大学' ORDER BY id;"
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '清华大学' ORDER BY id;"
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '人民' ORDER BY id;"
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '陕西' ORDER BY id;"
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '12345678901' ORDER BY id;"
    qt_sql "SELECT * FROM $indexTblName3 WHERE c MATCH '12345678' ORDER BY id;"
