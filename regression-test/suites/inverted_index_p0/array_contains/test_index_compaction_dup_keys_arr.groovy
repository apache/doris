...
suite("test_index_compaction_dup_keys_array", "array_contains_inverted_index") {
    ...
    def tableName = "test_index_compaction_dup_keys_array"
    ...
    try {
        ...
        qt_sql """ select * from ${tableName} order by id, name[1], hobbies[1], score[1] """
        qt_sql """ select * from ${tableName} where array_contains(name, "andy") order by id, name[1], hobbies[1], score[1] """
        qt_sql """ select * from ${tableName} where array_contains(hobbies, "pear") order by id, name[1], hobbies[1], score[1] """
        qt_sql """ select * from ${tableName} where score[1] < 100 order by id, name[1], hobbies[1], score[1] """
