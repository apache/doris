...
suite("test_index_change_6_arr", "array_contains_inverted_index") {
    def timeout = 60000
    def delta_time = 1000
    def alter_res = "null"
    def useTime = 0
    ...
    def tableName = "test_index_change_6_arr"
    ...
    qt_select4_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(note, 'engineer') and sex = 0 ORDER BY user_id; """
    qt_select5_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(note, 'electrical engineer') ORDER BY user_id; """
    qt_select6_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(note, 'engineer Developer') AND array_contains(city, 'Shanghai China') ORDER BY user_id; """
    ...
    qt_select7_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(city, 'beijing') ORDER BY user_id; """
    qt_select8_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(city, 'beijing') and sex = 1 ORDER BY user_id; """
    qt_select9_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(note, 'engineer') and sex = 0 ORDER BY user_id; """
    qt_select10_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(note, 'electrical engineer') ORDER BY user_id; """
    qt_select11_v1 """ SELECT * FROM ${tableName} t WHERE array_contains(note, 'engineer Developer') AND array_contains(city, 'Shanghai China') ORDER BY user_id; """
