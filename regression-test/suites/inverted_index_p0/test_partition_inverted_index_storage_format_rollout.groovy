...
suite("test_partition_inverted_index_storage_format_rollout", "p0,nonConcurrent") {
    ...
    sql "DROP TABLE IF EXISTS test_partition_inverted_index_storage_format_list"
    ...
    sql """
        CREATE TABLE test_partition_inverted_index_storage_format_list (
            k INT NOT NULL,
    ...
    """
    assertPartitionFormat(
            "test_partition_inverted_index_storage_format_list", "p_old", "V2")

    sql """ALTER TABLE test_partition_inverted_index_storage_format_list
    ...
    assertPartitionFormat(
            "test_partition_inverted_index_storage_format_list", "p_old", "V2")
    assertPartitionFormat(
            "test_partition_inverted_index_storage_format_list", "p_new", "V3")

    sql """
        INSERT INTO test_partition_inverted_index_storage_format_list VALUES
            (1, "old", "old list token"),
            (2, "new", "new list token")
    """
    def listRows = sql """
        SELECT category, v
        FROM test_partition_inverted_index_storage_format_list
