...
suite("test_streaming_mysql_job_col_filter", "p0,external,mysql,external_docker,external_docker_mysql,nondatalake") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        connect("root", "123456", "jdbc:mysql://${externalEnvIp}:${mysql_port}") {
            ...
            sql """INSERT INTO ${mysqlDb}.${table1} VALUES ('A1', 1, 'secret_A1')"""
            sql """INSERT INTO ${mysqlDb}.${table1} VALUES ('B1', 2, 'secret_B1')"""
        }
        ...
        connect("root", "123456", "jdbc:mysql://${externalEnvIp}:${mysql_port}") {
            sql """INSERT INTO ${mysqlDb}.${table1} VALUES ('C1', 3, 'secret_C1')"""
            sql """UPDATE ${mysqlDb}.${table1} SET age = 20, secret = 'updated_secret' WHERE name = 'B1'"""
