...
// that splitting actually happens in batches: with 1500 rows / split_size=5 = 300 chunks
// > default batch_size=100, the splitter takes ~3 RPCs so streaming_job_meta.chunk_list
// grows incrementally (>=3 distinct lengths observed during snapshot) — a single-shot
// synchronous splitter would write the full list in one UPSERT.
