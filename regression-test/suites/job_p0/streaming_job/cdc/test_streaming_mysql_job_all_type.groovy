...
suite("test_streaming_mysql_job_all_type", "p0,external,mysql,external_docker,external_docker_mysql,nondatalake") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        connect("root", "123456", "jdbc:mysql://${externalEnvIp}:${mysql_port}") {
            ...
            """
            // Use numeric YEAR 0 to verify yearIsDateType=false preserves 0000 instead of 2000.
            sql """
            insert into ${mysqlDb}.${table1} values (1,120,50000,1000000,9000000000,1000,12345.67,987654.12345,123456789.1234567890,99999999.123456789012345678901234567890,123.45,12.34,true,-5,-300,-20000,-500000,-8000000000,-123.45,-12.34,-1000,-1234.56,-98765.43210,-123456789.1234567890,-99999999.123456789012345678901234567890,0,'08:30:00','08:30:00.123','08:30:00.123456','2023-06-15','2023-06-15 08:30:00','2023-06-15 08:30:00','2023-06-15 08:30:00.123','2023-06-15 08:30:00.123456','abc','user_001','normal text content','simple blob data','{"id":1,"name":"userA"}','Option1',b'110011','binary_data1','varbin_01','Value1');
            """
        }
