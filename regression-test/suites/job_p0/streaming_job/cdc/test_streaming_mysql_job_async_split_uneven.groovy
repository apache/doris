...
// in cdc_client). 1500 rows / split_size=5 = 300 chunks > default batch_size=100,
// so chunk_list growth is observably stepped across ~3 RPCs without mutating the
// global FE config (which would race with concurrent cdc cases).
