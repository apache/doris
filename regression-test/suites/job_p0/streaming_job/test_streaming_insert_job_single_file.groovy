...
suite("test_streaming_insert_job_single_file") {
    def tableName = "test_streaming_insert_job_single_file_tbl"
    def jobName = "test_streaming_insert_job_single_file_name"
    ...
    assert jobInfo.get(0).get(0) == "{\"fileName\":\"regression/load/data/example_0.csv\"}";
    assert jobInfo.get(0).get(1) == "{\"fileName\":\"regression/load/data/example_0.csv\"}";
    assert jobInfo.get(0).get(2) == "{\"scannedRows\":10,\"loadBytes\":207,\"fileNumber\":1,\"fileSize\":118}"
