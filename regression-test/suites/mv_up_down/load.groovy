...
suite("mv_up_down_load") {
    ...
    def mv_stmt_agg = """select o_orderkey,
            sum(o_totalprice) as sum_total  
            from orders_2_agg 
            where o_orderdate >= '2023-10-17' group by o_orderkey"""
    create_all_mv(mv_name_agg, mv_stmt_agg)
    waitingMVTaskFinished("orders_2_agg", mv_name_agg)
    ...
    def mv_stmt_dup = """select
            ...
            """
    create_all_mv(mv_name_dup, mv_stmt_dup)
    waitingMVTaskFinished("orders_2_3", mv_name_dup)
    ...
    def mv_stmt_uniq = """
        ...
        """
    create_all_mv(mv_name_uniq, mv_stmt_uniq)
    waitingMVTaskFinished("orders_2_uniq", mv_name_uniq)
