...
suite("test_cast_double_to_decimal") {
	...
	sql "insert into test5 values(7,15.0245)"
	...
	sql "insert into test5 values(17,-15.0245)"
	...
	def keyAndExcpectedValues = [
		...
		["7", "15.025", "15.025", "15.02450000","15.02450000"],
		...
		["17", "-15.025", "-15.025", "-15.02450000","-15.02450000"],
	]
