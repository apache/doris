...
suite("test_agg_schema_value_modify2", "p0") {
    def tbName1 = "test_agg_model_value_change2"
    def tbName2 = "test_agg_model_value_change_2"
    ...
    /**
     *  Test the agg model by modify a value type from CHAR to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    ...
    //TODO Test the agg model by modify a value type from CHAR  to BOOLEAN
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to BOOLEAN"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city BOOLEAN  REPLACE_IF_NOT_NULL """
    ...
    // TODO Test the agg model by modify a value type from CHAR  to TINYINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city TINYINT  REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from CHAR  to SMALLINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city SMALLINT REPLACE_IF_NOT_NULL  """
    ...
    //Test the agg model by modify a value type from CHAR  to INT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city INT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from CHAR  to BIGINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city BIGINT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from  CHAR to LARGEINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city LARGEINT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from CHAR  to FLOAT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city FLOAT REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from CHAR  to DECIMAL
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to DECIMAL128"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city DECIMAL(38,0) REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from CHAR  to DATE
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to DATEV2"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city DATE  REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from CHAR  to DATEV2
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to DATEV2"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city DATEV2  REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from CHAR  to DATETIME
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to DATETIMEV2"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city DATETIME  REPLACE_IF_NOT_NULL """
    ...
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city DATETIMEV2 REPLACE_IF_NOT_NULL """
    ...
    //TODO Data doubling Test the agg model by modify a value type from CHAR  to VARCHAR
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column city VARCHAR(100)  REPLACE_IF_NOT_NULL """
    ...
    initTable1 = " CREATE TABLE IF NOT EXISTS ${tbName2}\n" +
            ...
            "              `username` VARCHAR(50) NOT NULL COMMENT \"用户昵称\",\n" +
            "              `score` DECIMAL(38,10) REPLACE_IF_NOT_NULL COMMENT \"分数\",\n" +
            "              `city` VARCHAR(100) REPLACE_IF_NOT_NULL COMMENT \"用户所在城市\",\n" +
            "              `age` SMALLINT REPLACE_IF_NOT_NULL COMMENT \"用户年龄\",\n" +
            "              `sex` TINYINT REPLACE_IF_NOT_NULL COMMENT \"用户性别\",\n" +
            "              `phone` LARGEINT REPLACE_IF_NOT_NULL COMMENT \"用户电话\",\n" +
            "              `address` VARCHAR(500) REPLACE_IF_NOT_NULL COMMENT \"用户地址\",\n" +
...
//    checkTableData("${tbName1}","${tbName2}","city")
    ...
    //Test the agg model by modify a value type from CHAR  to STRING
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column city STRING REPLACE_IF_NOT_NULL """
    ...
    initTable1 = " CREATE TABLE IF NOT EXISTS ${tbName2}\n" +
            ...
            "              `username` VARCHAR(50) NOT NULL COMMENT \"用户昵称\",\n" +
            "              `score` DECIMAL(38,10) REPLACE_IF_NOT_NULL COMMENT \"分数\",\n" +
            "              `city` STRING REPLACE_IF_NOT_NULL COMMENT \"用户所在城市\",\n" +
            "              `age` SMALLINT REPLACE_IF_NOT_NULL COMMENT \"用户年龄\",\n" +
            "              `sex` TINYINT REPLACE_IF_NOT_NULL COMMENT \"用户性别\",\n" +
            "              `phone` LARGEINT REPLACE_IF_NOT_NULL COMMENT \"用户电话\",\n" +
            "              `address` VARCHAR(500) REPLACE_IF_NOT_NULL COMMENT \"用户地址\",\n" +
    ...
    //TODO Test the agg model by modify a  value type from CHAR  to map
    //Test the agg model by modify a value type from CHAR  to map
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to MAP"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city Map<STRING, INT> REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from CHAR  to JSON
    errorMessage = "errCode = 2, detailMessage = Can not change CHAR to JSON"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column city JSON REPLACE_IF_NOT_NULL """
    ...
    /**
     *  Test the agg model by modify a value type from VARCHAR to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
            ...
            "              `username` VARCHAR(50) NOT NULL COMMENT \"用户昵称\",\n" +
            "              `score` DECIMAL(38,10) REPLACE_IF_NOT_NULL COMMENT \"分数\",\n" +
            "              `city` VARCHAR(255) REPLACE_IF_NOT_NULL COMMENT \"用户所在城市\",\n" +
            "              `age` SMALLINT REPLACE_IF_NOT_NULL COMMENT \"用户年龄\",\n" +
            "              `sex` TINYINT REPLACE_IF_NOT_NULL COMMENT \"用户性别\",\n" +
            "              `phone` LARGEINT REPLACE_IF_NOT_NULL COMMENT \"用户电话\",\n" +
            "              `address` VARCHAR(500) REPLACE_IF_NOT_NULL COMMENT \"用户地址\",\n" +
    ...
    //TODO Test the agg model by modify a value type from VARCHAR  to BOOLEAN
    ...
    // TODO Test the agg model by modify a value type from VARCHAR  to TINYINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from VARCHAR  to SMALLINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from VARCHAR  to INT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from VARCHAR  to BIGINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from  VARCHAR to LARGEINT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from VARCHAR  to FLOAT
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from VARCHAR  to DECIMAL
    ...
    //TODO Test the agg model by modify a value type from VARCHAR  to DATE
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from VARCHAR  to DATEV2
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from VARCHAR  to DATETIME
    ...
    //Test the agg model by modify a value type from VARCHAR  to CHAR
    errorMessage = "errCode = 2, detailMessage = Can not change VARCHAR to CHAR"
    expectException({
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column city CHAR(3) REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(923456689, 'Alice', 5.69, 'Yaan1', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    waitForSchemaChangeDone({
        sql getTableStatusSql
        time 600
    ...
    //TODO Data doubling Test the agg model by modify a value type from VARCHAR  to STRING
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column city STRING REPLACE_IF_NOT_NULL  """
    insertSql = "insert into ${tbName1} values(923456689, 'Alice', 6.59, 'Yaan2', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
...
//    checkTableData("${tbName1}","${tbName2}","city")
    ...
    //TODO Test the agg model by modify a  value type from VARCHAR  to map
    //Test the agg model by modify a value type from VARCHAR  to STRING
    ...
    //Test the agg model by modify a value type from VARCHAR  to JSON
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
    ...
    /**
     *  Test the agg model by modify a value type from STRING to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from STRING  to BOOLEAN
    ...
    // TODO Test the agg model by modify a value type from STRING  to TINYINT
    ...
    //Test the agg model by modify a value type from STRING  to SMALLINT
    ...
    //Test the agg model by modify a value type from STRING  to INT
    ...
    //Test the agg model by modify a value type from STRING  to BIGINT
    ...
    //Test the agg model by modify a value type from  STRING to LARGEINT
    ...
    //Test the agg model by modify a value type from STRING  to FLOAT
    ...
    //TODO Test the agg model by modify a value type from STRING  to DECIMAL
    ...
    //TODO Test the agg model by modify a value type from STRING  to DATE
    ...
    //TODO Test the agg model by modify a value type from STRING  to DATEV2
    errorMessage = "errCode = 2, detailMessage = Can not change STRING to DATEV2"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from STRING  to DATETIME
    ...
    //Test the agg model by modify a value type from STRING  to CHAR
    ...
    //Test the agg model by modify a value type from  STRING to VARCHAR
    errorMessage = "errCode = 2, detailMessage = Can not change STRING to VARCHAR"
    expectException({
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column city VARCHAR(256) REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(923456689, 'Alice', 6.59, 'Yaan2', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    waitForSchemaChangeDone({
        sql getTableStatusSql
        time 600
    ...
    //TODO Test the agg model by modify a  value type from STRING  to map
    //Test the agg model by modify a value type from STRING  to STRING
    ...
    //Test the agg model by modify a value type from STRING  to JSON
    errorMessage = "expected:<[FINISH]ED> but was:<[CANCELL]ED>"
    expectException({
        sql initTable
        sql initTableData
