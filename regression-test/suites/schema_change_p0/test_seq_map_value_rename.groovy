...
suite('test_seq_map_value_rename', 'p0') {
    def tbName = 'test_seq_map_value_rename'
    ...
    def errorMessage = 'table use sequence mapping do not support rename yet'
    expectExceptionLike({
        sql """ alter table ${tbName} rename column s1 s2 """
    }, errorMessage)
