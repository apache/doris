...
suite("test_dup_schema_key_drop", "p0") {
    ...
    //TODO Test the duplicate model by drop a key type from BOOLEAN
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the duplicate model by drop a key type from TINYINT
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the duplicate model by drop a key type from SMALLINT
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from LARGEINT
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from DATE
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from DATEV2
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from t_datetimev2
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from t_datetime
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from CHAR
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO  Test the duplicate model by drop a key type from VARCHAR
    errorMessage = "errCode = 2, detailMessage = Can not drop key column in Duplicate data model table"
    expectException({
        sql initTable
        sql initTableData
