...
suite("test_agg_schema_value_modify1", "p0") {
    def tbName1 = "agg_model_value_change1"
    def tbName2 = "agg_model_value_change_1"
    def on_write = getRandomBoolean()
    println String.format("current enable_agg_key_merge_on_write is : %s ", on_write)
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to BOOLEAN
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to BOOLEAN"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score BOOLEAN REPLACE_IF_NOT_NULL """
    ...
    // TODO Test the agg model by modify a value type from FLOAT  to TINYINT
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to TINYINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score TINYINT REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to SMALLINT
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to SMALLINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score SMALLINT REPLACE_IF_NOT_NULL  """
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to INT
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to INT"
    expectException({
        sql initTable
        sql initTableData

        sql """ alter  table ${tbName1} MODIFY  column score INT REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to BIGINT
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to BIGINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score BIGINT REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from  FLOAT to LARGEINT
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to LARGEINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score LARGEINT REPLACE_IF_NOT_NULL """
    ...
    //TODO Loss of accuracy Test the agg model by modify a value type from FLOAT  to DOUBLE

    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column score DOUBLE REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to DECIMAL
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to DATE
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to DATEV2"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score DATE REPLACE_IF_NOT_NULL """
    ...
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score DATEV2 REPLACE_IF_NOT_NULL """
        insertSql = "insert into ${tbName1} values(993456689, 'Alice', '2003-12-31', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
        waitForSchemaChangeDone({
            sql getTableStatusSql
            time 600
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to DATETIME
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to DATETIMEV2"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score DATETIME REPLACE_IF_NOT_NULL """
    ...
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score DATETIMEV2 REPLACE_IF_NOT_NULL """
        insertSql = "insert into ${tbName1} values(993456689, 'Alice', '2003-12-31 20:12:12', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
        waitForSchemaChangeDone({
            sql getTableStatusSql
            time 600
    ...
    //TODO Test the agg model by modify a  value type from FLOAT  to CHAR
    ...
    initTableData2 = "insert into ${tbName2} values(123456789, 'Alice', '1.79999995', 'Beijing', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (234567890, 'Bob', '1.88999999', 'Shanghai', 30, 1, 13998765432, 'No. 456 Street, Shanghai', '2022-02-02 12:00:00', {'a': 200, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (345678901, 'Carol', '2.5999999', 'Guangzhou', 28, 0, 13724681357, 'No. 789 Street, Guangzhou', '2022-03-03 14:00:00', {'a': 300, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (456789012, 'Dave', '3.9000001', 'Shenzhen', 35, 1, 13680864279, 'No. 987 Street, Shenzhen', '2022-04-04 16:00:00', {'a': 400, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (567890123, 'Eve', '4.19999981', 'Chengdu', 27, 0, 13572468091, 'No. 654 Street, Chengdu', '2022-05-05 18:00:00', {'a': 500, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (678901234, 'Frank', 2.5, 'Hangzhou', 32, 1, 13467985213, 'No. 321 Street, Hangzhou', '2022-06-06 20:00:00', {'a': 600, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (993456689, 'Alice', 'asdv', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\\\"abc\\\", \\\"def\\\"]')," +
            "               (789012345, 'Grace', '2.0999999', 'Xian', 29, 0, 13333333333, 'No. 222 Street, Xian', '2022-07-07 22:00:00', {'a': 700, 'b': 200}, '[\"abc\", \"def\"]');"
    ...
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column score STRING REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a  value type from FLOAT  to map
    //Test the agg model by modify a value type from FLOAT  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to MAP"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score Map<STRING, INT> REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from FLOAT  to JSON
    errorMessage = "errCode = 2, detailMessage = Can not change FLOAT to JSON"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score JSON REPLACE_IF_NOT_NULL """
        insertSql = "insert into ${tbName1} values(993456689, 'Alice', '{'a': 100, 'b': 200}', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
        waitForSchemaChangeDone({
            sql getTableStatusSql
            time 600
    ...
    /**
     *  Test the agg model by modify a value type from DOUBLE to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from DOUBLE  to BOOLEAN
    ...
    // TODO Test the agg model by modify a value type from DOUBLE  to TINYINT
    ...
    //Test the agg model by modify a value type from DOUBLE  to SMALLINT
    ...
    //Test the agg model by modify a value type from DOUBLE  to INT
    ...
    //Test the agg model by modify a value type from DOUBLE  to BIGINT
    ...
    //Test the agg model by modify a value type from  DOUBLE to LARGEINT
    ...
    //Test the agg model by modify a value type from DOUBLE  to FLOAT
    errorMessage = "errCode = 2, detailMessage = Can not change DOUBLE to FLOAT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column score FLOAT REPLACE_IF_NOT_NULL """
        insertSql = "insert into ${tbName1} values(993456689, 'Alice', 1.23, 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
        waitForSchemaChangeDone({
            sql getTableStatusSql
            time 600
    ...
    //TODO Test the agg model by modify a value type from DOUBLE  to DECIMAL
    ...
    //TODO Test the agg model by modify a value type from DOUBLE  to DATE
    ...
    //TODO Test the agg model by modify a value type from DOUBLE  to DATETIME
    ...
    //TODO Test the agg model by modify a  value type from DOUBLE  to CHAR
    ...
    //Test the agg model by modify a value type from DOUBLE  to VARCHAR
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column score VARCHAR(100) REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(993456689, 'Alice', 'asd', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    initTableData2 = "insert into ${tbName2} values(123456789, 'Alice', '1.8', 'Beijing', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (234567890, 'Bob', '1.8899999999999999', 'Shanghai', 30, 1, 13998765432, 'No. 456 Street, Shanghai', '2022-02-02 12:00:00', {'a': 200, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (345678901, 'Carol', '2.6000000000000001', 'Guangzhou', 28, 0, 13724681357, 'No. 789 Street, Guangzhou', '2022-03-03 14:00:00', {'a': 300, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (456789012, 'Dave', '3.8999999999999999', 'Shenzhen', 35, 1, 13680864279, 'No. 987 Street, Shenzhen', '2022-04-04 16:00:00', {'a': 400, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (567890123, 'Eve', '4.2000000000000002', 'Chengdu', 27, 0, 13572468091, 'No. 654 Street, Chengdu', '2022-05-05 18:00:00', {'a': 500, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (678901234, 'Frank', 2.5, 'Hangzhou', 32, 1, 13467985213, 'No. 321 Street, Hangzhou', '2022-06-06 20:00:00', {'a': 600, 'b': 200}, '[\"abc\", \"def\"]')," +
            "               (993456689, 'Alice', 'asd', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\\\"abc\\\", \\\"def\\\"]')," +
            "               (789012345, 'Grace', '2.1000000000000001', 'Xian', 29, 0, 13333333333, 'No. 222 Street, Xian', '2022-07-07 22:00:00', {'a': 700, 'b': 200}, '[\"abc\", \"def\"]');"
    ...
    //Test the agg model by modify a value type from DOUBLE  to STRING
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column score STRING REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(993456689, 'Alice', 'asd', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    //TODO Test the agg model by modify a  value type from DOUBLE  to map
    //Test the agg model by modify a value type from DOUBLE  to STRING
    ...
    //Test the agg model by modify a value type from DOUBLE  to JSON
    ...
    /**
     *  Test the agg model by modify a value type from DECIMAL to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from DECIMAL128  to BOOLEAN
    ...
    // TODO Test the agg model by modify a value type from DECIMAL128  to TINYINT
    ...
    //Test the agg model by modify a value type from DECIMAL128  to SMALLINT
    ...
    //Test the agg model by modify a value type from DECIMAL128  to INT
    ...
    //Test the agg model by modify a value type from DECIMAL128  to BIGINT
    ...
    //Test the agg model by modify a value type from  DECIMAL128 to LARGEINT
    ...
    //Test the agg model by modify a value type from DECIMAL128  to FLOAT
    ...
    //TODO Test the agg model by modify a value type from DECIMAL128  to DATE
    ...
    //TODO Test the agg model by modify a value type from DECIMAL128  to DATETIME
    ...
    //TODO Test the agg model by modify a  value type from DECIMAL128  to CHAR
    ...
    //Test Data accuracy loss the agg model by modify a value type from DECIMAL128  to VARCHAR
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column score VARCHAR(100) REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(993456689, 'Alice', 'asd', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    //TODO Data accuracy loss Test the agg model by modify a value type from DECIMAL128  to STRING
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column score STRING REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(993456689, 'Alice', 'asd', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    //TODO Test the agg model by modify a  value type from DECIMAL128  to map
    //Test the agg model by modify a value type from DECIMAL128  to STRING
    ...
    //Test the agg model by modify a value type from DECIMAL128  to JSON
    ...
    /**
     *  Test the agg model by modify a value type from DATE to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from DATE  to BOOLEAN
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to BOOLEAN"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time BOOLEAN REPLACE_IF_NOT_NULL """
    ...
    // TODO Test the agg model by modify a value type from DATE  to TINYINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to TINYINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time TINYINT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from DATE  to SMALLINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to SMALLINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time SMALLINT REPLACE_IF_NOT_NULL  """
    ...
    //Test the agg model by modify a value type from DATE  to INT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to INT"
    expectException({
        sql initTable
        sql initTableData

        sql """ alter  table ${tbName1} MODIFY  column register_time INT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from DATE  to BIGINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to BIGINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time BIGINT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from  DATE to LARGEINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to LARGEINT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time LARGEINT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from DATE  to DOUBLE
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to DOUBLE"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time DOUBLE REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from DATE  to DECIMAL
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to DECIMAL128"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time DECIMAL(38,0) REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from DATE  to FLOAT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to FLOAT"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time FLOAT REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from DATE  to DATETIME
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATETIME REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from DATE  to DATETIME
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATETIMEV2 REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a  value type from DATE  to CHAR
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to CHAR"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time CHAR(15) REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a  value type from DATE  to VARCHAR
    //Test the agg model by modify a value type from DATE  to VARCHAR
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to VARCHAR"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time VARCHAR(100) REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a  value type from DATE  to STRING
    //Test the agg model by modify a value type from DATE  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to STRING"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time STRING REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a  value type from DATE  to map
    //Test the agg model by modify a value type from DATE  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to MAP"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time Map<STRING, INT> REPLACE_IF_NOT_NULL """
    ...
    //Test the agg model by modify a value type from DATE  to JSON
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to JSON"
    expectException({
        sql initTable
        sql initTableData
        sql """ alter  table ${tbName1} MODIFY  column register_time JSON REPLACE_IF_NOT_NULL """
    ...
    /**
     *  Test the agg model by modify a value type from DATEV2 to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from DATEV2  to BOOLEAN
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to BOOLEAN"
    expectException({
        sql initTable
        sql initTableData
    ...
    // TODO Test the agg model by modify a value type from DATEV2  to TINYINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to TINYINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATEV2  to SMALLINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to SMALLINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATEV2  to INT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to INT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATEV2  to BIGINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to BIGINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from  DATEV2 to LARGEINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to LARGEINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATEV2  to DOUBLE
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to DOUBLE"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from DATEV2  to DECIMAL
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to DECIMAL128"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from DATEV2  to FLOAT
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to FLOAT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from DATEV2  to DATETIME
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATETIME REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(923456689, 'Alice', 1.2, 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2003-12-31 20:12:12', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    //TODO Test the agg model by modify a  value type from DATEV2  to CHAR
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to CHAR"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a  value type from DATEV2  to VARCHAR
    //Test the agg model by modify a value type from DATE  to VARCHAR
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to VARCHAR"
    expectException({
        sql initTable
    ...
    //TODO Test the agg model by modify a  value type from DATEV2  to STRING
    //Test the agg model by modify a value type from DATE  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to STRING"
    expectException({
        sql initTable
    ...
    //TODO Test the agg model by modify a  value type from DATEV2  to map
    //Test the agg model by modify a value type from DATE  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to MAP"
    expectException({
        sql initTable
    ...
    //Test the agg model by modify a value type from DATEV2  to JSON
    errorMessage = "errCode = 2, detailMessage = Can not change DATEV2 to JSON"
    expectException({
        sql initTable
        sql initTableData
    ...
    /**
     *  Test the agg model by modify a value type from DATETIME to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from DATETIME  to BOOLEAN
    ...
    // TODO Test the agg model by modify a value type from DATETIME  to TINYINT
    ...
    //Test the agg model by modify a value type from DATETIME  to SMALLINT
    ...
    //Test the agg model by modify a value type from DATETIME  to INT
    ...
    //Test the agg model by modify a value type from DATETIME  to BIGINT
    ...
    //Test the agg model by modify a value type from  DATETIME to LARGEINT
    ...
    //Test the agg model by modify a value type from DATETIME  to DOUBLE
    ...
    //TODO Test the agg model by modify a value type from DATETIME  to DECIMAL
    ...
    //TODO Test the agg model by modify a value type from DATETIME  to FLOAT
    ...
    //TODO Test the agg model by modify a value type from DATETIME  to DATE
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATE REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a value type from DATETIME  to DATEV2
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATEV2 REPLACE_IF_NOT_NULL """
    ...
    //TODO Test the agg model by modify a  value type from DATETIME  to CHAR
    ...
    //TODO Test the agg model by modify a  value type from DATETIME  to VARCHAR
    //Test the agg model by modify a value type from DATETIME  to VARCHAR
    ...
    //TODO Test the agg model by modify a  value type from DATETIME  to STRING
    //Test the agg model by modify a value type from DATETIME  to STRING
    ...
    //TODO Test the agg model by modify a  value type from DATETIME  to map
    //Test the agg model by modify a value type from DATETIME  to STRING
    ...
    //Test the agg model by modify a value type from DATETIME  to JSON
    ...
    /**
     *  Test the agg model by modify a value type from DATETIMEV2 to other type
     */
    sql """ DROP TABLE IF EXISTS ${tbName1} """
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
    ...
    //TODO Test the agg model by modify a value type from DATETIMEV2  to BOOLEAN
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to BOOLEAN"
    expectException({
        sql initTable
        sql initTableData
    ...
    // TODO Test the agg model by modify a value type from DATETIMEV2  to TINYINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to TINYINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATETIMEV2  to SMALLINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to SMALLINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATETIMEV2  to INT
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to INT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATETIMEV2  to BIGINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to BIGINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from  DATETIMEV2 to LARGEINT
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to LARGEINT"
    expectException({
        sql initTable
        sql initTableData
    ...
    //Test the agg model by modify a value type from DATETIMEV2  to DOUBLE
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to DOUBLE"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from DATETIMEV2  to DECIMAL
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to DECIMAL128"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a value type from DATETIMEV2  to FLOAT
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to FLOAT"
    expectException({
        sql initTable
        sql initTableData
    ...
    // Test the agg model by modify a value type from DATETIMEV2  to DATE
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATE REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(923456689, 'Alice', 1.2, 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2003-12-31', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    //Test the agg model by modify a value type from DATETIMEV2  to DATEV2
    sql initTable
    sql initTableData
    sql """ alter  table ${tbName1} MODIFY  column register_time DATEV2 REPLACE_IF_NOT_NULL """
    insertSql = "insert into ${tbName1} values(923456689, 'Alice', 5.69, 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2003-12-31', {'a': 100, 'b': 200}, '[\"abc\", \"def\"]'); "
    ...
    //TODO Test the agg model by modify a  value type from DATETIMEV2  to CHAR
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to CHAR"
    expectException({
        sql initTable
        sql initTableData
    ...
    //TODO Test the agg model by modify a  value type from DATETIMEV2  to VARCHAR
    //Test the agg model by modify a value type from DATETIME  to VARCHAR
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to VARCHAR"
    expectException({
        sql initTable
    ...
    //TODO Test the agg model by modify a  value type from DATETIMEV2  to STRING
    //Test the agg model by modify a value type from DATETIME  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to STRING"
    expectException({
        sql initTable
    ...
    //TODO Test the agg model by modify a  value type from DATETIMEV2  to map
    //Test the agg model by modify a value type from DATETIME  to STRING
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to MAP"
    expectException({
        sql initTable
    ...
    //Test the agg model by modify a value type from DATETIMEV2  to JSON
    errorMessage = "errCode = 2, detailMessage = Can not change DATETIMEV2 to JSON"
    expectException({
        sql initTable
        sql initTableData
