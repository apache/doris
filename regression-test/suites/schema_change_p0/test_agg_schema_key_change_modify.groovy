...
suite("test_agg_schema_key_change_modify","p0") {
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to SMALLINT
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to INT
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to BIGINT
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to FLOAT
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to DECIMAL
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to CHAR
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to STRING
     ...
     //TODO Test the agg model by modify a key type from BOOLEAN to VARCHAR
     ...
     /**
      *  Test the agg model by modify a key type from TINYINT to other type
      */
     sql """ DROP TABLE IF EXISTS ${tbName1} """
     ...
     //TODO Test the agg model by modify a key type from TINYINT  to BOOLEAN
     ...
     //TODO Data doubling Test the agg model by modify a key type from TINYINT  to SMALLINT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from TINYINT  to INT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from TINYINT  to BIGINT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from TINYINT  to LARGEINT
     sql initTable
     sql initTableData
     ...
     //TODO Test the agg model by modify a key type from TINYINT  to FLOAT
     errorMessage="errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //TODO Test the agg model by modify a key type from TINYINT  to DOUBLE
     errorMessage="errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //TODO Test the agg model by modify a key type from TINYINT  to DECIMAL
     ...
     //TODO Test the agg model by modify a key type from TINYINT  to CHAR
     ...
     //TODO Data doubling Test the agg model by modify a key type from TINYINT  to VARCHAR
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from TINYINT  to STRING
     ...
     /**
      *  Test the agg model by modify a key type from SMALLINT to other type
      */
     sql """ DROP TABLE IF EXISTS ${tbName1} """
     initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
             "          (\n" +
     ...
     //TODO Test the agg model by modify a key type from SMALLINT  to BOOLEAN
     ...
     // TODO Test the agg model by modify a key type from SMALLINT  to TINYINT
     ...
     //TODO Data doubling Test the agg model by modify a key type from SMALLINT  to INT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from SMALLINT  to BIGINT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from SMALLINT  to LARGEINT
     sql initTable
     sql initTableData
     ...
     //TODO Test the agg model by modify a key type from SMALLINT  to FLOAT
     errorMessage="errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //TODO Test the agg model by modify a key type from SMALLINT  to DOUBLE
     errorMessage="errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //TODO Test the agg model by modify a key type from SMALLINT  to DECIMAL
     ...
     //TODO Test the agg model by modify a key type from SMALLINT  to CHAR
     ...
     //Test the agg model by modify a key type from SMALLINT  to VARCHAR
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from SMALLINT  to STRING
     ...
     /**
      *  Test the agg model by modify a key type from INT to other type
      */
     sql """ DROP TABLE IF EXISTS ${tbName1} """
     initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
             "          (\n" +
     ...
     //TODO Test the agg model by modify a key type from INT  to BOOLEAN
     ...
     // TODO Test the agg model by modify a key type from INT  to TINYINT
     ...
     //Test the agg model by modify a key type from INT  to SMALLINT
     ...
     //TODO Data doubling Test the agg model by modify a key type from INT  to BIGINT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from INT  to LARGEINT
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from INT  to FLOAT
     errorMessage = "errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //Test the agg model by modify a key type from INT  to DOUBLE
     errorMessage = "errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //TODO Test the agg model by modify a key type from INT  to DECIMAL
     ...
     //TODO Test the agg model by modify a  key type from INT  to CHAR
     ...
     //Test the agg model by modify a key type from INT  to VARCHAR
     sql initTable
     sql initTableData
     ...
     //Test the agg model by modify a key type from INT  to STRING
     ...
     /**
      *  Test the agg model by modify a key type from BIGINT to other type
      */
     sql """ DROP TABLE IF EXISTS ${tbName1} """
     initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
             "          (\n" +
     ...
     //TODO Test the agg model by modify a key type from BIGINT  to BOOLEAN
     ...
     // TODO Test the agg model by modify a key type from BIGINT  to TINYINT
     ...
     //Test the agg model by modify a key type from BIGINT  to SMALLINT
     ...
     //Test the agg model by modify a key type from BIGINT  to INT
     ...
     //TODO Data doubling Test the agg model by modify a key type from BIGINT  to LARGEINT
     sql initTable
     sql initTableData
     sql """ alter  table ${tbName1} MODIFY  column sn_number LARGEINT key """
     insertSql = "insert into ${tbName1} values(923456689, 'Alice', 5, 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00'); "
     ...
     //TODO Test the agg model by modify a key type from BIGINT  to DECIMAL
     ...
     //TODO Test the agg model by modify a  key type from BIGINT  to CHAR
     ...
     //Test the agg model by modify a key type from BIGINT  to VARCHAR
     sql initTable
     sql initTableData
     sql """ alter  table ${tbName1} MODIFY  column sn_number VARCHAR(100) key """
     insertSql = "insert into ${tbName1} values(923456689, 'Alice', 'vasd', 'Yaan', 25, 0, 13812345678, 'No. 123 Street, Beijing', '2022-01-01 10:00:00'); "
     ...
     //Test the agg model by modify a key type from BIGINT  to STRING
     errorMessage = "errCode = 2, detailMessage = String Type should not be used in key column[sn_number]."
     expectException({
          sql initTable
          sql initTableData
