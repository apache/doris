...
suite("test_dup_schema_key_add","p0") {
     ...
     //Test the duplicate model by adding a key column with BOOLEAN
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with TINYINT
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with SMALLINT
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with BIGINT
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with LARGEINT
     sql initTable
     sql initTableData
     ...
     //TODO Test the duplicate model by adding a key column with FLOAT
     ...
     //TODO Test the duplicate model by adding a key column with DOUBLE
     errorMessage="errCode = 2, detailMessage = Float or double can not used as a key, use decimal instead."
     expectException({
          sql initTable
          sql initTableData
     ...
     //TODO (Double the amount of data)Test the duplicate model by adding a key column with DECIMAL
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with DATE
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with DATETIME
     sql initTable
     sql initTableData
     ...
     //Test the duplicate model by adding a key column with CHAR
     sql initTable
     sql initTableData
     ...
     //TODO Test the duplicate model by adding a key column with STRING
     ...
     //TODO Test the duplicate model by adding a key column with bitmap
     ...
     //TODO Test the duplicate model by adding a key column with Map
     ...
     //TODO Test the duplicate model by adding a key column with JSON
