...
suite("test_agg_schema_value_drop", "p0") {
    def tbName1 = "test_agg_schema_value_drop"
    def tbName2 = "test_agg_schema_value_drop_1"
    ...
    /**
     *  Test the AGGREGATE model by drop a value type
     */
    ...
    // Test the AGGREGATE model by drop a value type from BOOLEAN
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from TINYINT
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from SMALLINT
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from INT
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from BIGINT
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from LARGEINT
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from DATE
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from DATEV2
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from t_datetimev2
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from t_datetime
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from CHAR
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from VARCHAR
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from STRING
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from Map
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from JSON
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from DECIMAL
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from FLOAT
    sql initTable
    sql initTableData
    ...
    // Test the AGGREGATE model by drop a value type from DOUBLE
    sql initTable
    sql initTableData
    ...
    initTable = " CREATE TABLE IF NOT EXISTS ${tbName1}\n" +
            "          (\n" +
            "              `user_id` LARGEINT NOT NULL COMMENT \"用户id\",\n" +
            "              `c_array` ARRAY<int(11)> REPLACE_IF_NOT_NULL COMMENT \"测试ARRAY\",\n" +
            "              `s_info` STRUCT<s_id:int(11), s_name:string, s_address:string> REPLACE_IF_NOT_NULL COMMENT \"测试STRUCT\"\n" +
            "          )\n" +
            "          AGGREGATE KEY(`user_id`)\n" +
            "          DISTRIBUTED BY HASH(`user_id`) BUCKETS 1\n" +
            "          PROPERTIES (\n" +
    ...
    // Test the AGGREGATE model by drop a value type from ARRAY
    sql initTable
    sql initTableData
