...
suite("test_agg_schema_value_modify4", "p0") {
    def tbName1 = "test_agg_model_value_change3"
    def tbName2 = "test_agg_model_value_change_3"
    ...
    //Test the agg model by adding a value column with VARCHAR
    sql initTable
    sql initTableData
