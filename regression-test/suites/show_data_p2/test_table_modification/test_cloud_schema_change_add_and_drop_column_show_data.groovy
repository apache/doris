...
suite("test_cloud_schema_change_add_and_drop_column_show_data","p2, nonConcurrent") {
    //cloud-mode
    if (!isCloudMode()) {
    ...
    def check = {String tableName -> 
        ...
        schema_change_drop_column(tableName)
    ...
    def main = {
        def tableName="test_cloud_schema_change_add_and_drop_column_show_data"
        create_table(tableName)
        check(tableName)
        tableName="test_cloud_schema_change_add_and_drop_column_show_data_index"
