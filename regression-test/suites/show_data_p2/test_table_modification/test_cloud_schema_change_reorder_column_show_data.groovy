...
suite("test_cloud_schema_change_reorder_column_show_data","p2, nonConcurrent") {
    ...
    def schema_change_reorder_column= { String tableName ->
        sql """
        ALTER TABLE ${tableName} modify column L_SHIPMODE CHAR(10) NOT NULL after L_COMMENT;
        """
    ...
    def main = {
        def tableName="test_cloud_schema_change_reorder_column_show_data"
        create_table(tableName)
        check(tableName)
        tableName="test_cloud_schema_change_reorder_column_show_data_index"
