...
HAVING (min(cast(v:created_at as datetime)) <= '2019-01-01 00:00:00') AND (max(cast(v:created_at as datetime)) >= '2020-06-01 00:00:00') AND (stars2019 >= 1000)
ORDER BY yoy,cast(v:repo.name as string)
LIMIT 50
