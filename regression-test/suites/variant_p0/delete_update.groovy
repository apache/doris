...
suite("regression_test_variant_delete_and_update", "variant_type"){
    ...
    sql """
        ...
        properties("replication_num" = "1", "enable_unique_key_merge_on_write" = "false", "deprecated_variant_enable_flatten_nested" = "true");
    """
    // test mor table
    ...
    // Write numeric rows together so updates cannot race a physical rewrite of their Variant path.
    sql """insert into var_delete_update_mow values
            (6, '{"a":4,"b":[4],"c":4.1}', 'xxx'),
            (7, '{"a":4,"b":[4],"c":4.1}', 'yyy')"""
