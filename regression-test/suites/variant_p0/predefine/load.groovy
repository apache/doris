...
suite("regression_test_variant_predefine_schema", "p0,nonConcurrent"){
    ...
    sql """insert into test_predefine values(1, '1', ${variantV2Function}('{"a" : {"b" : {"c" : "123456", "d" : "11.111"}}, "ss" : 199991111, "dcm" : 123.456, "dt" : "2021-01-01 00:00:00", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(2, '2', ${variantV2Function}('{"a" : {"b" : {"c" : 678910, "d" : 22.222}}, "ss" : "29999111", "dcm" : "456.123", "dt" : "2022-01-01 11:11:11", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(3, '3', ${variantV2Function}('{"dcm" : 789.123, "dt" : "2025-01-01 11:11:11.1", "ip" : "127.0.0.1"}'))"""
    sql """insert into test_predefine values(4, '4', ${variantV2Function}('{"a" : {"b" : {"c" : "678910", "d" : "33.222"}}}'))"""
    sql """insert into test_predefine values(5, '5', null)"""
    sql """insert into test_predefine values(6, '6', null)"""
    sql """insert into test_predefine values(7, '7', ${variantV2Function}('{"xxx" : 12345}'))"""
    sql """insert into test_predefine values(8, '8', ${variantV2Function}('{"yyy" : 111.111}'))"""
    sql """insert into test_predefine values(9, '2', ${variantV2Function}('{"a" : {"b" : {"c" : 678910, "d" : 22.222}}, "ss" : "29999111", "dcm" : "456.123", "dt" : "2022-01-01 11:11:11", "ip" : "127.0.0.1"}'))"""
    ...
    sql """insert into test_predefine1 values(4, ${variantV2Function}('{"predefine_col4" : "2020-01-01-01"}'))"""

    sql """insert into test_predefine1 values(5, ${variantV2Function}('{"PREDEFINE_COL1" : 1024}'))"""
    sql """insert into test_predefine1 values(6, ${variantV2Function}('{"PREDEFINE_COL2" : 1.11111}'))"""
    sql """insert into test_predefine1 values(7, ${variantV2Function}('{"PREDEFINE_COL3" : "11111.00000"}'))"""
    sql """insert into test_predefine1 values(8, ${variantV2Function}('{"PREDEFINE_COL4" : "2020-01-01-01"}'))"""
    ...
    """
    sql "insert into test_predefine2 values(1, ${variantV2Function}('${json1}'))"
    ...
    sql """insert into test_predefine1 values(101, ${variantV2Function}('{"a" :1}'), ${variantV2Function}('{"dcm": 1111111}'))"""
    sql "alter table test_predefine1 add column v3 variant<'dcm':decimal(38, 9),'dt':datetime,'ip':ipv6> default null"
    sql """insert into test_predefine1 values(102, ${variantV2Function}('{"a" :1}'), ${variantV2Function}('{"dcm": 1111111}'), ${variantV2Function}('{"dcm": 1111111}'));"""
    ...
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"nested" : [{"a" : 123, "b" : "456"}]}'))"""
    ...
    sql "truncate table test_predefine3"
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : 1234.1111}'))"""
    // sql "alter table test_predefine3 modify column v variant<`auto_type`: int>"
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : "124511111"}'))"""
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : 1111122334}'))"""
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : 111223341111}'))"""
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : true}'))"""
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : 1}'))"""
    sql """insert into test_predefine3 values (1, ${variantV2Function}('{"auto_type" : 256}'))"""
    ...
    """
    sql """insert into test_array_with_nulls values(3, ${variantV2Function}('{"array_decimal" : [null, 2.2, 3.3, 4.4]}'))"""
    qt_sql_arr_null_1 """select k, cast(var['array_decimal'] as array<decimal(27, 9)>)
                         from test_array_with_nulls order by k"""
    sql """insert into test_array_with_nulls values(1, ${variantV2Function}('{"array_decimal" : [1.1, 2.2, 3.3, null]}'))"""
    sql """insert into test_array_with_nulls values(2, ${variantV2Function}('{"array_decimal" : [1.1, 2.2, null, 4.4]}'))"""
    sql """insert into test_array_with_nulls values(4, ${variantV2Function}('{"array_decimal" : [1.1, null, 3.3, 4.4]}'))"""
    sql """insert into test_array_with_nulls values(5, ${variantV2Function}('{"array_decimal" : [1.1, 2.2, 3.3, 4.4]}'))"""
    sql """insert into test_array_with_nulls values(6, ${variantV2Function}('{"array_decimal" : []}'))"""
    sql """insert into test_array_with_nulls values(7, ${variantV2Function}('{"array_decimal" : [null, null]}'))"""
    qt_sql_arr_null_2 """select k, cast(var['array_decimal'] as array<decimal(27, 9)>)
                         from test_array_with_nulls order by k limit 5"""
