...
suite("test_variant_predefine_index_type", "p0"){ 
    ...
    ) ENGINE=OLAP DUPLICATE KEY(`id`) DISTRIBUTED BY HASH(`id`) BUCKETS 1 PROPERTIES ( "replication_allocation" = "tag.location.default: 1", "disable_auto_compaction" = "false", "variant_max_subcolumns_count" = "0")"""

    sql """insert into ${tableName} values(1, '{"path" : {"int" : 123, "decimal" : 123.123456789012}}'),
                                          (2, '{"path" : {"int" : 456, "decimal" : 456.456789123456}}'),
                                          (3, '{"path" : {"int" : 789, "decimal" : 789.789123456789}}'),
                                          (4, '{"path" : {"int" : 100, "decimal" : 100.100123456789}}'),
                                          (5, '{"path" : {"int" : 111, "decimal" : 111.111111111111}}')"""
