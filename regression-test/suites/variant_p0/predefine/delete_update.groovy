...
suite("regression_test_variant_predefine_delete_and_update", "variant_type"){
    ...
    sql """insert into ${table_name} values (1, ${variantV2Function}('{"a":1,"b":[1],"c":1.1, "d" : [{"x" : 1}]}'))"""
    sql """insert into ${table_name} values (2, ${variantV2Function}('{"a":2,"b":[1],"c":2.1, "d" : [{"y" : 1}]}'))"""
    sql """insert into ${table_name} values (3, ${variantV2Function}('{"a":3,"b":[3],"c":3.1, "d" : [{"o" : 1}]}'))"""
    sql """insert into ${table_name} values (4, ${variantV2Function}('{"a":4,"b":[4],"c":4.1, "d" : [{"p" : 1}]}'))"""
    sql """insert into ${table_name} values (5, ${variantV2Function}('{"a":5,"b":[5],"c":5.1, "d" : [{"q" : 1}]}'))"""
