...
suite("regression_test_variant", "p0"){
    ...
    try {
        ...
        for (int i = 0; i < key_types.size(); i++) {
            ...
            sql """insert into ${table_name} values (1,  ${variantV2Function}('[1]')),(1,  ${variantV2Function}('{"a" : 1}'));"""
            sql """insert into ${table_name} values (2,  ${variantV2Function}('[2]')),(1,  ${variantV2Function}('{"a" : [[[1]]]}'));"""
            sql """insert into ${table_name} values (3,  ${variantV2Function}('3')),(1,  ${variantV2Function}('{"a" : 1}')), (1,  ${variantV2Function}('{"a" : [1]}'));"""
            sql """insert into ${table_name} values (4,  ${variantV2Function}('"4"')),(1,  ${variantV2Function}('{"a" : "1223"}'));"""
            sql """insert into ${table_name} values (5,  ${variantV2Function}('5')),(1,  ${variantV2Function}('{"a" : [1]}'));"""
            sql """insert into ${table_name} values (6,  ${variantV2Function}('"[6]"')),(1,  ${variantV2Function}('{"a" : ["1", 2, 1.1]}'));"""
            sql """insert into ${table_name} values (7,  ${variantV2Function}('7')),(1,  ${variantV2Function}('{"a" : 1, "b" : {"c" : 1}}'));"""
            sql """insert into ${table_name} values (8,  ${variantV2Function}('8.11111')),(1,  ${variantV2Function}('{"a" : 1, "b" : {"c" : [{"a" : 1}]}}'));"""
            sql """insert into ${table_name} values (9,  ${variantV2Function}('"9999"')),(1,  ${variantV2Function}('{"a" : 1, "b" : {"c" : [{"a" : 1}]}}'));"""
        ...
        sql "insert into simple_variant_DUPLICATE select k, ${variantV2Function}(cast(v as string)) from simple_variant_UNIQUE;"

        // 2. type confilct cases
        def table_name = "type_conflict_resolution"
        create_table table_name
        sql """insert into ${table_name} values (1, ${variantV2Function}('{"c" : "123"}'));"""
        sql """insert into ${table_name} values (2, ${variantV2Function}('{"c" : 123}'));"""
        sql """insert into ${table_name} values (3, ${variantV2Function}('{"cc" : [123.2]}'));"""
        sql """insert into ${table_name} values (4, ${variantV2Function}('{"cc" : [123.1]}'));"""
        sql """insert into ${table_name} values (5, ${variantV2Function}('{"ccc" : 123}'));"""
        sql """insert into ${table_name} values (6, ${variantV2Function}('{"ccc" : 123321}'));"""
        sql """insert into ${table_name} values (7, ${variantV2Function}('{"cccc" : 123.22}'));"""
        sql """insert into ${table_name} values (8, ${variantV2Function}('{"cccc" : 123.11}'));"""
        sql """insert into ${table_name} values (9, ${variantV2Function}('{"ccccc" : [123]}'));"""
        sql """insert into ${table_name} values (10, ${variantV2Function}('{"ccccc" : [123456789]}'));"""
        sql """insert into ${table_name} values (11, ${variantV2Function}('{"b" : 1111111111111111}'));"""
        sql """insert into ${table_name} values (12, ${variantV2Function}('{"b" : 1.222222}'));"""
        sql """insert into ${table_name} values (13, ${variantV2Function}('{"bb" : 1}'));"""
        sql """insert into ${table_name} values (14, ${variantV2Function}('{"bb" : 214748364711}'));"""
        sql """insert into ${table_name} values (15, ${variantV2Function}('{"A" : 1}'));"""
        ...
        create_table table_name
        sql """insert into ${table_name} values (1,  ${variantV2Function}('{"A" : 123}'));"""
        sql """insert into ${table_name} values (2,  ${variantV2Function}('{"A" : 1}'));"""
        sql """insert into ${table_name} values (4,  ${variantV2Function}('{"A" : 123456}'));"""
        sql """insert into ${table_name} values (8,  ${variantV2Function}('{"A" : 123456789101112}'));"""
        qt_sql_2 "select v['A'] from ${table_name} order by cast(v['A'] as bigint)"
        sql """insert into ${table_name} values (12,  ${variantV2Function}('{"AA" : [123456]}'));"""
        sql """insert into ${table_name} values (14,  ${variantV2Function}('{"AA" : [123456789101112]}'));"""
        ...
        sql """insert into ${table_name} values (16,  ${variantV2Function}('{"a" : 123.22, "A" : 191191, "c": 123}'));"""
        sql """insert into ${table_name} values (18,  ${variantV2Function}('{"a" : "123", "c" : 123456}'));"""
        sql """insert into ${table_name} values (20,  ${variantV2Function}('{"a" : 1.10111, "A" : 1800, "c" : [12345]}'));"""
        // sql """insert into ${table_name} values (12,  '{"a" : [123]}, "c": "123456"');"""
        sql """insert into ${table_name} values (22,  ${variantV2Function}('{"a" : 1.1111, "A" : 17211, "c" : 111111}'));"""
        sql "sync"
        ...
        sql """insert into simple_select_variant values (12, ${variantV2Function}('{"oamama": 1.1}'))"""
        ...
        sql """insert into simple_select_variant values (11, ${variantV2Function}('{"x": [123456]}'));"""
        sql """insert into simple_select_variant values (12, ${variantV2Function}('{"x": [123456789101112]}'));"""
        sql """insert into simple_select_variant values (12, ${variantV2Function}('{"xxx" : 123, "yyy" : 456}'));"""
        ...
        sql """
                ...
                properties("replication_num" = "1", "disable_auto_compaction" = "false");
            """
        sql """insert into ${table_name} values (1,  ${variantV2Function}('{"A" : 123}'), ${variantV2Function}('{"B" : 123}'), ${variantV2Function}('{"C" : 456}'));"""
        sql """insert into ${table_name} values (2,  ${variantV2Function}('{"C" : "123"}'), ${variantV2Function}('{"D" : [123]}'), ${variantV2Function}('{"E" : 789}'));"""
        sql """insert into ${table_name} values (3,  ${variantV2Function}('{"C" : "123"}'), ${variantV2Function}('{"C" : [123]}'), ${variantV2Function}('{"E" : "789"}'));"""
        sql "sync"
        verify table_name
        ...
        create_table table_name
        sql """INSERT INTO t_json_parallel SELECT *, ${variantV2Function}('{"k1":1, "k2": "some", "k3" : [1234], "k4" : 1.10000, "k5" : [[123]]}') FROM numbers("number" = "50000");"""
        qt_sql_25 """ SELECT sum(cast(v['k1'] as int)), round(sum(cast(v['k4'] as double)), 6), sum(cast(json_extract(cast(v['k5'] as JSONB), "\$.[0].[0]") as int)) from t_json_parallel; """
        ...
        create_table table_name
        sql """INSERT INTO empty_string VALUES (1, ''), (2, ${variantV2Function}('{"k1": 1, "k2": "v1"}')), (3, ${variantV2Function}('{}')), (4, ${variantV2Function}('{"k1": 2}'));"""
        sql """INSERT INTO empty_string VALUES (3, null), (4, ${variantV2Function}('{"k1": 1, "k2": "v1"}')), (3, ${variantV2Function}('{}')), (4, ${variantV2Function}('{"k1": 2}'));"""
        sql """INSERT INTO empty_string VALUES (3, null), (4, null), (3, ${variantV2Function}('{}')), (4, ${variantV2Function}('{"k1": 2}'));"""
        sql """INSERT INTO empty_string VALUES (3, ''), (4, null), (3, ${variantV2Function}('{}')), (4, null);"""
        ...
        create_table table_name
        sql """INSERT INTO ${table_name} VALUES (1, ''), (1, ${variantV2Function}('{"k1": 1, "k2": "v1"}')), (1, ${variantV2Function}('{}')), (1, ${variantV2Function}('{"k1": 2}'));"""
        sql "alter table ${table_name} add column v2 variant default null"
        sql """INSERT INTO ${table_name} VALUES (1, ${variantV2Function}('{"kyyyy" : "123"}'), ${variantV2Function}('{"kxkxkxkx" : [123]}')), (1, ${variantV2Function}('{"kxxxx" : 123}'), ${variantV2Function}('{"xxxxyyyy": 123}'));"""
        ...
        create_table table_name
        sql """INSERT INTO ${table_name} VALUES (1, ''), (2, ${variantV2Function}('{"k1": true, "k2": false}')), (3, ${variantV2Function}('{}')), (4, ${variantV2Function}('{"k1": false}'));"""
        verify table_name

        // 12. jsonb values
        table_name = "jsonb_values"
        create_table.call(table_name, "DUPLICATE", "1")
        sql """insert into ${table_name} values (1, ${variantV2Function}('{"a" : ["123", 123, [123]]}'))"""
        // FIXME array -> jsonb will parse error
        // sql """insert into ${table_name} values (2, '{"a" : ["123"]}')"""
        sql """insert into ${table_name} values (3, ${variantV2Function}('{"a" : "123"}'))"""
        sql """insert into ${table_name} values (4, ${variantV2Function}('{"a" : 123456}'))"""
        sql """insert into ${table_name} values (5, ${variantV2Function}('{"a" : [123, "123", 1.11111]}'))"""
        sql """insert into ${table_name} values (6, ${variantV2Function}('{"a" : [123, 1.11, "123"]}'))"""
        sql """insert into ${table_name} values(7, ${variantV2Function}('{"a" : [123, {"xx" : 1}], "b" : {"c" : 456, "d" : null, "e" : 7.111}}'))"""
        // FIXME data bellow is invalid at present
        // sql """insert into ${table_name} values (8, '{"a" : [123, 111........]}')"""
        sql """insert into ${table_name} values (9, ${variantV2Function}('{"a" : [123, {"a" : 1}]}'))"""
        sql """insert into ${table_name} values (10, ${variantV2Function}('{"a" : [{"a" : 1}, 123]}'))"""
        ...
        sql """insert into  sparse_columns select * from (select 0, ${variantV2Function}('{"a": 1123, "b" : [123, {"xx" : 1}], "c" : {"c" : 456, "d" : null, "e" : 7.111}, "zzz" : null, "oooo" : {"akakaka" : null, "xxxx" : {"xxx" : 123}}}') as json_str
        ...
        qt_sql_31 """ select json_parse(cast(v as string)) from sparse_columns where cast(v as string) != "{}" order by cast(v as string) limit 10"""
        sql "truncate table sparse_columns"
        ...
        sql """insert into ${table_name} values (1, ${variantV2Function}('{"a" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (2, ${variantV2Function}('{"b" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (2, ${variantV2Function}('{"c" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (3, ${variantV2Function}('{"d" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (3, ${variantV2Function}('{"e" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (4, ${variantV2Function}('{"f" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (4, ${variantV2Function}('{"g" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (5, ${variantV2Function}('{"h" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (5, ${variantV2Function}('{"i" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (6, ${variantV2Function}('{"j" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        sql """insert into ${table_name} values (6, ${variantV2Function}('{"k" : 1}')), (1, ${variantV2Function}('{"a" : 1}'))"""
        ...
        sql """UPDATE ${table_name} set v = ${variantV2Function}('{"updated_value" : 10}') where k = 2"""
        ...
        create_table.call(table_name,  "DUPLICATE", "1")
        sql """insert into ${table_name} values (1, ${variantV2Function}('{"a" : 1}')), (1, ${variantV2Function}('{"a":  "1"}'))"""
        sql """insert into ${table_name} values (1, ${variantV2Function}('{"a" : 1}')), (1, ${variantV2Function}('{"a":  "2"}'))"""
        ...
        """
        sql """insert into ${table_name} values (1, "abc", ${variantV2Function}('{"a" : 1}')), (1, "cde", ${variantV2Function}('{"b" : 1}'))"""
        sql """insert into ${table_name} values (2, "abe", ${variantV2Function}('{"c" : 1}'))"""
        sql """insert into ${table_name} values (3, "abd", ${variantV2Function}('{"d" : 1}'))"""
        ...
        create_table.call(table_name,  "DUPLICATE", "1")
        sql """
            insert into variant_cast values(1,${variantV2Function}('["CXO0N: 1045901740", "HMkTa: 1348450505", "44 HHD: 915015173", "j9WoJ: -1517316688"]')),(2,${variantV2Function}('"[1]"')),(3,${variantV2Function}('123456')),(4,${variantV2Function}('1.11111'))
        """
        qt_sql_39 "select k, if(json_type(cast(v as json), '\$') in ('int', 'bigint'), 'integer', json_type(cast(v as json), '\$')) from variant_cast order by k"
        ...
        """
        sql """insert into var_as_key values(1, ${variantV2Function}('{"a" : 10}'))"""
        sql """insert into var_as_key values(2, ${variantV2Function}('{"b" : 11}'))"""
        ...
        """
        sql """ insert into ${table_name} values (1, ${variantV2Function}('{"a": 1122323232313223, "b": 1.2, "c" : "ddddd", "d" : {"e": 1.2, "f": "ggggg"}}')), (2, NULL) """
        qt_sql """ select variant_type(v) is not null from ${table_name} """
        if (!enableVariantV2) {
            qt_variant_type_v1 """ select variant_type(v) from ${table_name} """
        }
    } finally {
        // reset flags
    }
