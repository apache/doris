...
suite("update_test_index_load", "nonConcurrent,p0") {
    ...
    create_table_load_data.call("test_update_index_sc_v1", "V2")
    create_table_load_data.call("test_update_index_sc_v2", "V2")
    create_table_load_data.call("test_update_index_sc2_v1", "V2")
    create_table_load_data.call("test_update_index_sc2_v2", "V2")
    create_table_load_data.call("test_update_index_compact_v1", "V2")
    create_table_load_data.call("test_update_index_compact_v2", "V2")
    create_table_load_data.call("test_update_index_compact2_v1", "V2")
