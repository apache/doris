...
suite("test_variant_external_meta_with_sparse", "nonConcurrent") {
    ...
    trigger_and_wait_compaction("test_sparse_embedded", "full", 600)
    ...
    trigger_and_wait_compaction("test_bucket_sparse", "full", 600)
    ...
    trigger_and_wait_compaction("test_extraction_threshold", "full", 600)
    ...
    // Compact
    trigger_and_wait_compaction("test_sparse_config_toggle", "full", 600)
    ...
    trigger_and_wait_compaction("test_high_cardinality_sparse", "full", 600)
