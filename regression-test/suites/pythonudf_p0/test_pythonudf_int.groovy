...
suite("test_pythonudf_int") {
    def tableName = "test_pythonudf_int"
    ...
    try {
        ...
        qt_select """ SELECT python_udf_int_test(user_id) result FROM ${tableName} ORDER BY result; """
        ...
        qt_select """ SELECT python_udf_tinyint_test(tinyint_col) result FROM ${tableName} ORDER BY result; """
        ...
        qt_select """ SELECT python_udf_smallint_test(smallint_col) result FROM ${tableName} ORDER BY result; """
        ...
        qt_select """ SELECT python_udf_bigint_test(bigint_col) result FROM ${tableName} ORDER BY result; """
        ...
        qt_select_global_1 """ SELECT python_udf_int_test_global(user_id) result FROM ${tableName} ORDER BY result; """
        qt_select_global_2 """ SELECT python_udf_int_test_global(null) result ; """
        qt_select_global_3 """ SELECT python_udf_int_test_global(3) result FROM ${tableName} ORDER BY result; """
        qt_select_global_4 """ SELECT abs(python_udf_int_test_global(3)) result FROM ${tableName} ORDER BY result; """
