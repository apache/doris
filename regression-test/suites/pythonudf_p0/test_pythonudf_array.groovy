...
suite("test_pythonudf_array") {
    def tableName = "test_pythonudf_array"
    ...
    try {
        ...
        qt_select_1 """ SELECT python_udf_array_int_test(array(user_id)) result FROM ${tableName} ORDER BY result; """
        ...
        sql """ CREATE FUNCTION python_udf_array_return_int_test(array<int>) RETURNS array<int> PROPERTIES (
            "file"="file://${pyPath}",
            "symbol"="array_return_array_int_test",
            "type"="PYTHON_UDF"
        ); """
        qt_select_3 """ SELECT python_udf_array_return_int_test(array(user_id)), tinyint_col as result FROM ${tableName} ORDER BY result; """
        qt_select_4 """ SELECT python_udf_array_return_int_test(array(user_id,user_id)), tinyint_col as result FROM ${tableName} ORDER BY result; """
        ...
        sql """ CREATE FUNCTION python_udf_array_return_string_test(array<string>) RETURNS array<string> PROPERTIES (
            "file"="file://${pyPath}",
            "symbol"="array_return_array_string_test",
            "type"="PYTHON_UDF"
        ); """
        qt_select_6 """ SELECT python_udf_array_return_string_test(array(string_col)), tinyint_col as result FROM ${tableName} ORDER BY result; """
        qt_select_7 """ SELECT python_udf_array_return_string_test(array(string_col, cast(user_id as string))), tinyint_col as result FROM ${tableName} ORDER BY result; """
        ...
        qt_select_9 """ SELECT python_udf_array_string_test(array(string_col)), tinyint_col as result FROM ${tableName} ORDER BY result; """
        qt_select_10 """ SELECT python_udf_array_string_test(array(string_col, cast(user_id as string))), tinyint_col as result FROM ${tableName} ORDER BY result; """
