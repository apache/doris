...
suite("test_cast_to_decimal64_10_9_from_decimalv2_const") {
    ...
    def const_sql_0_1 = """select "8", cast(cast("8" as decimalv2(1, 0)) as decimalv3(10, 9));"""
    qt_sql_0_1_strict "${const_sql_0_1}"
    testFoldConst("${const_sql_0_1}")
    def const_sql_0_2 = """select "9", cast(cast("9" as decimalv2(1, 0)) as decimalv3(10, 9));"""
    ...
    def const_sql_1_1 = """select "0.1", cast(cast("0.1" as decimalv2(1, 1)) as decimalv3(10, 9));"""
    qt_sql_1_1_strict "${const_sql_1_1}"
    testFoldConst("${const_sql_1_1}")
    def const_sql_1_2 = """select "0.8", cast(cast("0.8" as decimalv2(1, 1)) as decimalv3(10, 9));"""
    qt_sql_1_2_strict "${const_sql_1_2}"
    testFoldConst("${const_sql_1_2}")
    def const_sql_1_3 = """select "0.9", cast(cast("0.9" as decimalv2(1, 1)) as decimalv3(10, 9));"""
    ...
    def const_sql_3_1 = """select "0.00001", cast(cast("0.00001" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_1_strict "${const_sql_3_1}"
    testFoldConst("${const_sql_3_1}")
    def const_sql_3_2 = """select "0.00009", cast(cast("0.00009" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_2_strict "${const_sql_3_2}"
    testFoldConst("${const_sql_3_2}")
    def const_sql_3_3 = """select "0.09999", cast(cast("0.09999" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_3_strict "${const_sql_3_3}"
    testFoldConst("${const_sql_3_3}")
    def const_sql_3_4 = """select "0.90000", cast(cast("0.90000" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_4_strict "${const_sql_3_4}"
    testFoldConst("${const_sql_3_4}")
    def const_sql_3_5 = """select "0.90001", cast(cast("0.90001" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_5_strict "${const_sql_3_5}"
    testFoldConst("${const_sql_3_5}")
    def const_sql_3_6 = """select "0.99998", cast(cast("0.99998" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_6_strict "${const_sql_3_6}"
    testFoldConst("${const_sql_3_6}")
    def const_sql_3_7 = """select "0.99999", cast(cast("0.99999" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_7_strict "${const_sql_3_7}"
    testFoldConst("${const_sql_3_7}")
    def const_sql_3_8 = """select "8.00000", cast(cast("8.00000" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_8_strict "${const_sql_3_8}"
    testFoldConst("${const_sql_3_8}")
    def const_sql_3_9 = """select "8.00001", cast(cast("8.00001" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_9_strict "${const_sql_3_9}"
    testFoldConst("${const_sql_3_9}")
    def const_sql_3_10 = """select "8.00009", cast(cast("8.00009" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_10_strict "${const_sql_3_10}"
    testFoldConst("${const_sql_3_10}")
    def const_sql_3_11 = """select "8.09999", cast(cast("8.09999" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_11_strict "${const_sql_3_11}"
    testFoldConst("${const_sql_3_11}")
    def const_sql_3_12 = """select "8.90000", cast(cast("8.90000" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_12_strict "${const_sql_3_12}"
    testFoldConst("${const_sql_3_12}")
    def const_sql_3_13 = """select "8.90001", cast(cast("8.90001" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_13_strict "${const_sql_3_13}"
    testFoldConst("${const_sql_3_13}")
    def const_sql_3_14 = """select "8.99998", cast(cast("8.99998" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_14_strict "${const_sql_3_14}"
    testFoldConst("${const_sql_3_14}")
    def const_sql_3_15 = """select "8.99999", cast(cast("8.99999" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_15_strict "${const_sql_3_15}"
    testFoldConst("${const_sql_3_15}")
    def const_sql_3_16 = """select "9.00000", cast(cast("9.00000" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_16_strict "${const_sql_3_16}"
    testFoldConst("${const_sql_3_16}")
    def const_sql_3_17 = """select "9.00001", cast(cast("9.00001" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_17_strict "${const_sql_3_17}"
    testFoldConst("${const_sql_3_17}")
    def const_sql_3_18 = """select "9.00009", cast(cast("9.00009" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_18_strict "${const_sql_3_18}"
    testFoldConst("${const_sql_3_18}")
    def const_sql_3_19 = """select "9.09999", cast(cast("9.09999" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_19_strict "${const_sql_3_19}"
    testFoldConst("${const_sql_3_19}")
    def const_sql_3_20 = """select "9.90000", cast(cast("9.90000" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_20_strict "${const_sql_3_20}"
    testFoldConst("${const_sql_3_20}")
    def const_sql_3_21 = """select "9.90001", cast(cast("9.90001" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_21_strict "${const_sql_3_21}"
    testFoldConst("${const_sql_3_21}")
    def const_sql_3_22 = """select "9.99998", cast(cast("9.99998" as decimalv2(20, 5)) as decimalv3(10, 9));"""
    qt_sql_3_22_strict "${const_sql_3_22}"
    testFoldConst("${const_sql_3_22}")
    def const_sql_3_23 = """select "9.99999", cast(cast("9.99999" as decimalv2(20, 5)) as decimalv3(10, 9));"""
