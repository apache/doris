...
suite("test_cast_to_decimal64_10_from_decimal128i_overflow_const") {
    ...
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_0_from_decimal_19_1_overflow_1_test_data = ["""9999999999.9""","""9999999999.5""","""10000000000.9""","""10000000000.5""","""999999999999999998.9""","""999999999999999998.5""","""999999999999999999.9""","""999999999999999999.5"""]
    sql "set enable_strict_cast=true;"
    ...
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_0_from_decimal_38_1_overflow_5_test_data = ["""9999999999.9""","""9999999999.5""","""10000000000.9""","""10000000000.5""","""9999999999999999999999999999999999998.9""","""9999999999999999999999999999999999998.5""","""9999999999999999999999999999999999999.9""","""9999999999999999999999999999999999999.5"""]
    sql "set enable_strict_cast=true;"
    ...
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_9_from_decimal_19_0_overflow_16_test_data = ["""10""","""9999999999999999998""","""9999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_9_from_decimal_19_0_overflow_16_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_9_from_decimal_19_0_overflow_16_test_data) {
        qt_sql_test_cast_to_decimal_10_9_from_decimal_19_0_overflow_16 """select cast(cast("${test_str}" as decimalv3(19, 0)) as decimalv3(10, 9));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 0)) as decimalv3(10, 9));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_9_from_decimal_19_1_overflow_17_test_data = ["""10.9""","""999999999999999998.9""","""999999999999999999.9"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_9_from_decimal_19_1_overflow_17_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_9_from_decimal_19_1_overflow_17_test_data) {
        qt_sql_test_cast_to_decimal_10_9_from_decimal_19_1_overflow_17 """select cast(cast("${test_str}" as decimalv3(19, 1)) as decimalv3(10, 9));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 1)) as decimalv3(10, 9));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_9_from_decimal_19_18_overflow_18_test_data = ["""9.999999999999999999""","""9.999999999500000000"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_9_from_decimal_19_18_overflow_18_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_9_from_decimal_19_18_overflow_18_test_data) {
        qt_sql_test_cast_to_decimal_10_9_from_decimal_19_18_overflow_18 """select cast(cast("${test_str}" as decimalv3(19, 18)) as decimalv3(10, 9));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 18)) as decimalv3(10, 9));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_9_from_decimal_38_0_overflow_20_test_data = ["""10""","""99999999999999999999999999999999999998""","""99999999999999999999999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_9_from_decimal_38_0_overflow_20_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_9_from_decimal_38_0_overflow_20_test_data) {
        qt_sql_test_cast_to_decimal_10_9_from_decimal_38_0_overflow_20 """select cast(cast("${test_str}" as decimalv3(38, 0)) as decimalv3(10, 9));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 0)) as decimalv3(10, 9));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_9_from_decimal_38_1_overflow_21_test_data = ["""10.9""","""9999999999999999999999999999999999998.9""","""9999999999999999999999999999999999999.9"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_9_from_decimal_38_1_overflow_21_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_9_from_decimal_38_1_overflow_21_test_data) {
        qt_sql_test_cast_to_decimal_10_9_from_decimal_38_1_overflow_21 """select cast(cast("${test_str}" as decimalv3(38, 1)) as decimalv3(10, 9));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 1)) as decimalv3(10, 9));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_9_from_decimal_38_37_overflow_22_test_data = ["""9.9999999999999999999999999999999999999""","""9.9999999995000000000000000000000000000"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_9_from_decimal_38_37_overflow_22_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_9_from_decimal_38_37_overflow_22_test_data) {
        qt_sql_test_cast_to_decimal_10_9_from_decimal_38_37_overflow_22 """select cast(cast("${test_str}" as decimalv3(38, 37)) as decimalv3(10, 9));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 37)) as decimalv3(10, 9));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_19_0_overflow_24_test_data = ["""1""","""9999999999999999998""","""9999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_19_0_overflow_24_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_19_0_overflow_24_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_19_0_overflow_24 """select cast(cast("${test_str}" as decimalv3(19, 0)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 0)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_19_1_overflow_25_test_data = ["""1.9""","""999999999999999998.9""","""999999999999999999.9"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_19_1_overflow_25_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_19_1_overflow_25_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_19_1_overflow_25 """select cast(cast("${test_str}" as decimalv3(19, 1)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 1)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_19_18_overflow_26_test_data = ["""0.999999999999999999""","""0.999999999950000000""","""1.999999999999999999""","""1.999999999950000000""","""8.999999999999999999""","""8.999999999950000000""","""9.999999999999999999""","""9.999999999950000000"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_19_18_overflow_26_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_19_18_overflow_26_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_19_18_overflow_26 """select cast(cast("${test_str}" as decimalv3(19, 18)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 18)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_19_19_overflow_27_test_data = ["""0.9999999999999999999""","""0.9999999999500000000"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_19_19_overflow_27_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_19_19_overflow_27_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_19_19_overflow_27 """select cast(cast("${test_str}" as decimalv3(19, 19)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 19)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_38_0_overflow_28_test_data = ["""1""","""99999999999999999999999999999999999998""","""99999999999999999999999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_38_0_overflow_28_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_38_0_overflow_28_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_38_0_overflow_28 """select cast(cast("${test_str}" as decimalv3(38, 0)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 0)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_38_1_overflow_29_test_data = ["""1.9""","""9999999999999999999999999999999999998.9""","""9999999999999999999999999999999999999.9"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_38_1_overflow_29_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_38_1_overflow_29_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_38_1_overflow_29 """select cast(cast("${test_str}" as decimalv3(38, 1)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 1)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_38_37_overflow_30_test_data = ["""0.9999999999999999999999999999999999999""","""0.9999999999500000000000000000000000000""","""1.9999999999999999999999999999999999999""","""1.9999999999500000000000000000000000000""","""8.9999999999999999999999999999999999999""","""8.9999999999500000000000000000000000000""","""9.9999999999999999999999999999999999999""","""9.9999999999500000000000000000000000000"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_38_37_overflow_30_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_38_37_overflow_30_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_38_37_overflow_30 """select cast(cast("${test_str}" as decimalv3(38, 37)) as decimalv3(10, 10));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 37)) as decimalv3(10, 10));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_10_10_from_decimal_38_38_overflow_31_test_data = ["""0.99999999999999999999999999999999999999""","""0.99999999995000000000000000000000000000"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_10_10_from_decimal_38_38_overflow_31_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_10_10_from_decimal_38_38_overflow_31_test_data) {
        qt_sql_test_cast_to_decimal_10_10_from_decimal_38_38_overflow_31 """select cast(cast("${test_str}" as decimalv3(38, 38)) as decimalv3(10, 10));"""
