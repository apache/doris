...
suite("test_cast_to_decimal64_18_from_decimal256_overflow_const") {
    ...
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_18_0_from_decimal_39_0_overflow_0_test_data = ["""1000000000000000000""","""999999999999999999999999999999999999998""","""999999999999999999999999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_0_from_decimal_39_0_overflow_0_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_0_from_decimal_39_0_overflow_0_test_data) {
        qt_sql_test_cast_to_decimal_18_0_from_decimal_39_0_overflow_0 """select cast(cast("${test_str}" as decimalv3(39, 0)) as decimalv3(18, 0));"""
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_0_from_decimal_39_1_overflow_1_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_0_from_decimal_39_1_overflow_1_test_data) {
        qt_sql_test_cast_to_decimal_18_0_from_decimal_39_1_overflow_1 """select cast(cast("${test_str}" as decimalv3(39, 1)) as decimalv3(18, 0));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(39, 1)) as decimalv3(18, 0));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_18_0_from_decimal_76_0_overflow_4_test_data = ["""1000000000000000000""","""9999999999999999999999999999999999999999999999999999999999999999999999999998""","""9999999999999999999999999999999999999999999999999999999999999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_0_from_decimal_76_0_overflow_4_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_0_from_decimal_76_0_overflow_4_test_data) {
        qt_sql_test_cast_to_decimal_18_0_from_decimal_76_0_overflow_4 """select cast(cast("${test_str}" as decimalv3(76, 0)) as decimalv3(18, 0));"""
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_0_from_decimal_76_1_overflow_5_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_0_from_decimal_76_1_overflow_5_test_data) {
        qt_sql_test_cast_to_decimal_18_0_from_decimal_76_1_overflow_5 """select cast(cast("${test_str}" as decimalv3(76, 1)) as decimalv3(18, 0));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(76, 1)) as decimalv3(18, 0));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_18_1_from_decimal_39_0_overflow_8_test_data = ["""100000000000000000""","""999999999999999999999999999999999999998""","""999999999999999999999999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_1_from_decimal_39_0_overflow_8_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_1_from_decimal_39_0_overflow_8_test_data) {
        qt_sql_test_cast_to_decimal_18_1_from_decimal_39_0_overflow_8 """select cast(cast("${test_str}" as decimalv3(39, 0)) as decimalv3(18, 1));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(39, 0)) as decimalv3(18, 1));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_18_1_from_decimal_39_1_overflow_9_test_data = ["""100000000000000000.9""","""99999999999999999999999999999999999998.9""","""99999999999999999999999999999999999999.9"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_1_from_decimal_39_1_overflow_9_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_1_from_decimal_39_1_overflow_9_test_data) {
        qt_sql_test_cast_to_decimal_18_1_from_decimal_39_1_overflow_9 """select cast(cast("${test_str}" as decimalv3(39, 1)) as decimalv3(18, 1));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(39, 1)) as decimalv3(18, 1));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_18_1_from_decimal_76_0_overflow_12_test_data = ["""100000000000000000""","""9999999999999999999999999999999999999999999999999999999999999999999999999998""","""9999999999999999999999999999999999999999999999999999999999999999999999999999"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_1_from_decimal_76_0_overflow_12_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_1_from_decimal_76_0_overflow_12_test_data) {
        qt_sql_test_cast_to_decimal_18_1_from_decimal_76_0_overflow_12 """select cast(cast("${test_str}" as decimalv3(76, 0)) as decimalv3(18, 1));"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(76, 0)) as decimalv3(18, 1));""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_decimal_18_1_from_decimal_76_1_overflow_13_test_data = ["""100000000000000000.9""","""999999999999999999999999999999999999999999999999999999999999999999999999998.9""","""999999999999999999999999999999999999999999999999999999999999999999999999999.9"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_decimal_18_1_from_decimal_76_1_overflow_13_test_data) {
            test {
    ...
    for (test_str in test_cast_to_decimal_18_1_from_decimal_76_1_overflow_13_test_data) {
        qt_sql_test_cast_to_decimal_18_1_from_decimal_76_1_overflow_13 """select cast(cast("${test_str}" as decimalv3(76, 1)) as decimalv3(18, 1));"""
