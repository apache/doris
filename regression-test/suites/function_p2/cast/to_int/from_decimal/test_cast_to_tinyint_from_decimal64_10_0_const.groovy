...
suite("test_cast_to_tinyint_from_decimal64_10_0_const") {
    ...
    def const_sql_0_0 = """select "0", cast(cast("0" as decimalv3(10, 0)) as tinyint);"""
    qt_sql_0_0_strict "${const_sql_0_0}"
    testFoldConst("${const_sql_0_0}")
    def const_sql_0_1 = """select "1", cast(cast("1" as decimalv3(10, 0)) as tinyint);"""
    qt_sql_0_1_strict "${const_sql_0_1}"
    testFoldConst("${const_sql_0_1}")
    def const_sql_0_2 = """select "9", cast(cast("9" as decimalv3(10, 0)) as tinyint);"""
    qt_sql_0_2_strict "${const_sql_0_2}"
    testFoldConst("${const_sql_0_2}")
    def const_sql_0_3 = """select "127", cast(cast("127" as decimalv3(10, 0)) as tinyint);"""
    qt_sql_0_3_strict "${const_sql_0_3}"
    testFoldConst("${const_sql_0_3}")
    def const_sql_0_4 = """select "126", cast(cast("126" as decimalv3(10, 0)) as tinyint);"""
    qt_sql_0_4_strict "${const_sql_0_4}"
    testFoldConst("${const_sql_0_4}")
    def const_sql_0_5 = """select "-128", cast(cast("-128" as decimalv3(10, 0)) as tinyint);"""
    qt_sql_0_5_strict "${const_sql_0_5}"
    testFoldConst("${const_sql_0_5}")
    def const_sql_0_6 = """select "-127", cast(cast("-127" as decimalv3(10, 0)) as tinyint);"""
