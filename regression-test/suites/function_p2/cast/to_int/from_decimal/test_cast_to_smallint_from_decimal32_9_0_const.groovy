...
suite("test_cast_to_smallint_from_decimal32_9_0_const") {
    ...
    def const_sql_0_0 = """select "0", cast(cast("0" as decimalv3(9, 0)) as smallint);"""
    qt_sql_0_0_strict "${const_sql_0_0}"
    testFoldConst("${const_sql_0_0}")
    def const_sql_0_1 = """select "1", cast(cast("1" as decimalv3(9, 0)) as smallint);"""
    qt_sql_0_1_strict "${const_sql_0_1}"
    testFoldConst("${const_sql_0_1}")
    def const_sql_0_2 = """select "9", cast(cast("9" as decimalv3(9, 0)) as smallint);"""
    qt_sql_0_2_strict "${const_sql_0_2}"
    testFoldConst("${const_sql_0_2}")
    def const_sql_0_3 = """select "32767", cast(cast("32767" as decimalv3(9, 0)) as smallint);"""
    qt_sql_0_3_strict "${const_sql_0_3}"
    testFoldConst("${const_sql_0_3}")
    def const_sql_0_4 = """select "32766", cast(cast("32766" as decimalv3(9, 0)) as smallint);"""
    qt_sql_0_4_strict "${const_sql_0_4}"
    testFoldConst("${const_sql_0_4}")
    def const_sql_0_5 = """select "-32768", cast(cast("-32768" as decimalv3(9, 0)) as smallint);"""
    qt_sql_0_5_strict "${const_sql_0_5}"
    testFoldConst("${const_sql_0_5}")
    def const_sql_0_6 = """select "-32767", cast(cast("-32767" as decimalv3(9, 0)) as smallint);"""
