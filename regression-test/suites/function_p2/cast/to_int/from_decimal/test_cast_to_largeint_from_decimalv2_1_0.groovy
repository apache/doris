...
suite("test_cast_to_largeint_from_decimalv2_1_0") {
    ...
    qt_sql_0_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_decimalv2_1_0_0_nullable order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_decimalv2_1_0_0_nullable order by 1;'
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_0_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_decimalv2_1_0_0_not_nullable order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_decimalv2_1_0_0_not_nullable order by 1;'
