...
suite("test_cast_to_int_from_decimal64_18_0_const") {
    ...
    def const_sql_0_0 = """select "0", cast(cast("0" as decimalv3(18, 0)) as int);"""
    qt_sql_0_0_strict "${const_sql_0_0}"
    testFoldConst("${const_sql_0_0}")
    def const_sql_0_1 = """select "1", cast(cast("1" as decimalv3(18, 0)) as int);"""
    qt_sql_0_1_strict "${const_sql_0_1}"
    testFoldConst("${const_sql_0_1}")
    def const_sql_0_2 = """select "9", cast(cast("9" as decimalv3(18, 0)) as int);"""
    qt_sql_0_2_strict "${const_sql_0_2}"
    testFoldConst("${const_sql_0_2}")
    def const_sql_0_3 = """select "2147483647", cast(cast("2147483647" as decimalv3(18, 0)) as int);"""
    qt_sql_0_3_strict "${const_sql_0_3}"
    testFoldConst("${const_sql_0_3}")
    def const_sql_0_4 = """select "2147483646", cast(cast("2147483646" as decimalv3(18, 0)) as int);"""
    qt_sql_0_4_strict "${const_sql_0_4}"
    testFoldConst("${const_sql_0_4}")
    def const_sql_0_5 = """select "-2147483648", cast(cast("-2147483648" as decimalv3(18, 0)) as int);"""
    qt_sql_0_5_strict "${const_sql_0_5}"
    testFoldConst("${const_sql_0_5}")
    def const_sql_0_6 = """select "-2147483647", cast(cast("-2147483647" as decimalv3(18, 0)) as int);"""
