...
suite("test_ngram_bloomfilter_index_change") {
    ...
    def insertTestData = { ->
        // insert 10 records
        sql "INSERT INTO ${tableNmae} VALUES (1001, '2023-10-06 15:00:00', 'Laptop', 'John Smith', 199.99, 'North');"
        sql "INSERT INTO ${tableNmae} VALUES (1002, '2023-10-09 17:05:00', 'Smartphone', 'Emily Johnson', 299.99, 'South');"
        sql "INSERT INTO ${tableNmae} VALUES (1003, '2023-10-12 19:10:00', 'Headphones', 'Michael Brown', 399.99, 'East');"
        sql "INSERT INTO ${tableNmae} VALUES (1004, '2023-10-15 21:15:00', 'Monitor', 'Jessica Davis', 499.99, 'West');"
        sql "INSERT INTO ${tableNmae} VALUES (1005, '2023-10-18 23:20:00', 'Keyboard', 'David Wilson', 89.99, 'North');"
        sql "INSERT INTO ${tableNmae} VALUES (1006, '2023-10-21 07:25:00', 'Mouse', 'Sarah Taylor', 699.99, 'South');"
        sql "INSERT INTO ${tableNmae} VALUES (1007, '2023-10-24 09:30:00', 'Printer', 'Thomas Anderson', 799.99, 'East');"
        sql "INSERT INTO ${tableNmae} VALUES (1008, '2023-10-27 11:35:00', 'Speaker', 'Jennifer Martin', 899.99, 'West');"
        sql "INSERT INTO ${tableNmae} VALUES (1009, '2023-10-02 13:40:00', 'External SSD', 'Robert Clark', 999.99, 'North');"
        sql "INSERT INTO ${tableNmae} VALUES (1010, '2023-10-05 15:45:00', 'Webcam', 'Amanda Lewis', 89.99, 'South');"
        sql "sync"
    }
