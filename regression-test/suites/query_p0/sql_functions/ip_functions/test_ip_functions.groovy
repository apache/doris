...
suite("test_ip_functions", "arrow_flight_sql") {
    ...
    qt_sql "SELECT hex(ipv6stringtonum('192.168.0.1'));"
    qt_sql "SELECT hex(ipv6stringtonum('2a02:6b8::11'));"
    qt_sql "SELECT hex(ipv6stringtonum('::'));"
    qt_sql "SELECT hex(ipv6stringtonum('a0:50:9100::'));"
    qt_sql "SELECT hex(ipv6stringtonumordefault('192.168.0.1'));"
    qt_sql "SELECT hex(ipv6stringtonumordefault('2a02:6b8::11'));"
    qt_sql "SELECT hex(ipv6stringtonumordefault('::'));"
    qt_sql "SELECT hex(ipv6stringtonumordefault('KK'));"
    qt_sql "SELECT hex(ipv6stringtonumordefault('ffffffffffffffffffffffffffffffffffffffffffffffffffffff'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('192.168.0.1'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('2a02:6b8::11'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('::'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('KK'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('ffffffffffffffffffffffffffffffffffffffffffffffffffffff'));"
    qt_sql "SELECT hex(ipv6stringtonumornull(''));"
    qt_sql "SELECT hex(ipv6stringtonumornull(NULL));"
    qt_sql "SELECT hex(ipv6stringtonumornull('\0'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('00'));"
    qt_sql "SELECT hex(ipv6stringtonumornull('aaaa:aaaa:ffff:ffff:ffff:ffff:aaaa:aaaa'));"
