...
suite("test_ipv4_cidr_to_range") {
    ...
    qt_sql "select id, struct_element(ipv4_cidr_to_range(addr, 16), 'min') as min_range, struct_element(ipv4_cidr_to_range(addr, 16), 'max') as max_range from test_ipv4_cidr_to_range order by id"

    qt_sql "select id, struct_element(ipv4_cidr_to_range('127.0.0.1', cidr), 'min') as min_range, struct_element(ipv4_cidr_to_range('127.0.0.1', cidr), 'max') as max_range from test_ipv4_cidr_to_range order by id"
