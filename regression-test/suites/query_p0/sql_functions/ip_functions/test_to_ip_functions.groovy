...
suite("test_to_ip_functions") {
    ...
    qt_sql "select cast(to_ipv4_or_null(ip_v4) as int), to_ipv4_int(ip_v4), cast(to_ipv6_or_null(ip_v6) as LARGEINT) , to_ipv6_int(ip_v6) from test_to_ip_functions order by id"
