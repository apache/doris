...
suite("test_nullif") {
    ...
    qt_if_nullif3 """select /*+ enable_nereids_planner=false */ if(k1, 10, -1) a from baseall order by k1"""
    ...
    qt_if_nullif7 """select /*+ enable_nereids_planner=false */ if(k6, -1, 0) a from baseall order by k6"""
