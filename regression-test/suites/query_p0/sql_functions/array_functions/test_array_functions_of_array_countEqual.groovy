...
suite("test_array_functions_of_array_countEqual") {
    def tableName = "test_array_functions_of_array_countEqual"
    ...
    sql """ INSERT INTO ${tableName} VALUES(8, NULL) """
    sql """ INSERT INTO ${tableName} VALUES(9, [NULL,NULL,NULL]) """
    ...
    qt_select "select 7 = select 3 = countEqual(k2, 7) from from ${tableName} order by k1"
