...
suite("test_array_aggregation_functions") {
    ...
    sql """ INSERT INTO ${tableName} VALUES(3, [-1, 0, 1], [-32767, -32768], [-50000, -2147483647], [-9223372036854775808, 0], [-117341182548128045443221445, 170141183460469231731687303715884105727], [-9.999999, 9.999999], [-1.0, 0.0, 1.0], [-128.0001, 127.0001], NULL, NULL, NULL, NULL, [111111.111, 111111.111], [222.2222, 222.2222], [333333.33333, 333333.33333], [444444.44444, 444444.44444]) """
    sql """ INSERT INTO ${tableName} VALUES(4, [], [], [], [], [], [], [], [], [], NULL, NULL, NULL, [], [], [], []) """

    qt_select "SELECT k1, array_min(a1), array_min(a2), array_min(a3), array_min(a4), array_min(a5), array_min(a6), array_min(a7), array_min(a8), array_min(a9), array_min(a10), array_min(a11), array_min(a12), array_min(a13), array_min(a14), array_min(a15), array_min(a16) from ${tableName} order by k1"
