...
suite("test_array_functions") {
    ...
    qt_select "SELECT k1, array_reverse_sort(k2), array_reverse_sort(k3), array_reverse_sort(k4) FROM ${tableName} ORDER BY k1"
    qt_select "SELECT k1, array_reverse_sort(k8), array_reverse_sort(k10) FROM ${tableName} ORDER BY k1"
    qt_select "SELECT k1, array_reverse_sort(k12) FROM ${tableName} ORDER BY k1"
