...
suite("test_array_functions") {
    ...
    qt_select_array_shuffle1 "SELECT k1, k2, array_shuffle(k2, 0), shuffle(k2, 0) from ${tableName} ORDER BY k1"
    qt_select_array_shuffle2 "SELECT k1, k5, array_shuffle(k5, 0), shuffle(k5, 0) from ${tableName} ORDER BY k1"
    qt_select_array_shuffle3 "SELECT k1, k6, array_shuffle(k6, 0), shuffle(k6, 0) from ${tableName} ORDER BY k1"
    qt_select_array_shuffle4 "SELECT k1, k7, array_shuffle(k7, 0), shuffle(k7, 0) from ${tableName} ORDER BY k1"
    qt_select_array_shuffle5 "SELECT k1, k10, array_shuffle(k10, 0), shuffle(k10, 0) from ${tableName} ORDER BY k1"
    qt_select_array_shuffle6 "SELECT k1, k12, array_shuffle(k12, 1), shuffle(k12, 1) from ${tableName} ORDER BY k1"
