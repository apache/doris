...
suite("test_array_functions") {
    ...
    qt_select "SELECT array_remove(k2, k1, 0), k1 FROM ${tableName} ORDER BY k1"
    qt_select "SELECT array_remove(k8, cast('2023-02-05' as datev2), 0) FROM ${tableName} ORDER BY k1"
    qt_select "SELECT array_remove(k10, cast('2022-10-15 10:30:00.999' as datetimev2(3)), 0) FROM ${tableName} ORDER BY k1"
    qt_select "SELECT array_remove(k2, k1, 1), k1 FROM ${tableName} ORDER BY k1"
    qt_select "SELECT array_remove(k2, NULL, 1), NULL FROM ${tableName} ORDER BY k1"
    qt_select "SELECT array_remove(k8, cast('2023-02-05' as datev2), 1) FROM ${tableName} ORDER BY k1"
    qt_select "SELECT array_remove(k10, cast('2022-10-15 10:30:00.999' as datetimev2(3)), 1) FROM ${tableName} ORDER BY k1"
