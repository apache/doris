...
suite("test_array_functions") {
    ...
    qt_select "SELECT k1, array_with_constant(3, k1),  array_repeat(k1, 3) from ${tableName} ORDER BY k1"
    qt_select "SELECT k1, array_with_constant(10, null), array_repeat(null, 10) from ${tableName} ORDER BY k1"
    qt_select "SELECT k1, array_with_constant(2, 'a'), array_repeat('a', 2) from ${tableName} ORDER BY k1"
    qt_select "SELECT k1, array_with_constant(2, 123), array_repeat(123, 2) from ${tableName} ORDER BY k1"
