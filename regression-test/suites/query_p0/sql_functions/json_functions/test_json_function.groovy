...
suite("test_json_function") {
    ...
    qt_sql "SELECT json_depth(NULL);"
    qt_sql "SELECT json_depth('1');"
    qt_sql "SELECT json_depth('\"a\"');"
    qt_sql "SELECT json_depth('true');"
    qt_sql "SELECT json_depth('{}');"
    qt_sql "SELECT json_depth('[]');"
    qt_sql "SELECT json_depth('[1]');"
    qt_sql "SELECT json_depth('[1, 2]');"
    qt_sql "SELECT json_depth('[[], []]');"
    qt_sql "SELECT json_depth('[[1, 2], [3, 4]]');"
    qt_sql "SELECT json_depth('[[1, 2], 3, 4]');"
    qt_sql "SELECT json_depth('[{}]');"
    qt_sql "SELECT json_depth('[{\"a\": \"b\"}]');"
    qt_sql "SELECT json_depth('[10, {\"a\": 20}]');"
    qt_sql "SELECT json_depth('[{\"a\": [\"b\", \"c\"]}]');"
}
