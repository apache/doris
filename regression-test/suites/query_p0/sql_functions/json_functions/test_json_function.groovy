...
suite("test_json_function") {
    ...
    qt_sql "SELECT JSON_MERGE_PRESERVE('{}','{}');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('[1]','[1]');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('[1, true, 0.1, [1], {\"a\": 1}, \"123\"]','[1]');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('1', 'true', '0.1', '[1]', '{\"a\": 1}', '\"123\"');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('1', 'true', '0.1', '[]', '{}', '\"123\"', NULL);"
    qt_sql "SELECT JSON_MERGE_PRESERVE('{\"a\": 1}','{\"a\": 2}');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('{\"a\": {\"b\": 1}, \"c\": 1}', '{\"a\": {\"b\": 2}}');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('{\"a\": {\"b\": true}, \"c\": 1}', '{\"a\": {\"b\": {}}}');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('{\"a\": {\"b\": 0.1}, \"c\": 1}', '{\"a\": {\"b\": {}}}');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('{\"a\": {\"b\": []}, \"c\": 1}', '{\"a\": {\"b\": {}}}');"
    qt_sql "SELECT JSON_MERGE_PRESERVE('{\"a\": 1, \"b\": 2 }', '{ \"a\": 3, \"c\": 4 }', '{ \"a\": 5, \"d\": 6}');"
}
