...
suite("test_date_trunc") {
    ...
    qt_select_date_trunc_second """ SELECT k11, date_trunc('SECoND', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_minute """ SELECT k11, date_trunc('MINutE', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_hour """ SELECT k11, date_trunc('Hour', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_day """ SELECT k11, date_trunc('DAY', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_week """ SELECT k11, date_trunc('Week', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_month """ SELECT k11, date_trunc('MONTH', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_quarter """ SELECT k11, date_trunc('quarter', k11) FROM baseall order by k1,k2,k3;"""
    qt_select_date_trunc_year """ SELECT k11, date_trunc('YeaR', k11) FROM baseall order by k1,k2,k3;"""
