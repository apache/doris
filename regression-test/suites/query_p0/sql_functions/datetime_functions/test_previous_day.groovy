...
suite("test_previous_day") {
    ...
    order_qt_empty_nullable "select previous_day(a, e), previous_day(c, e) from previous_day_args"
    order_qt_empty_not_nullable "select previous_day(b, f), previous_day(d, f) from previous_day_args"
    order_qt_empty_partial_nullable "select previous_day(a, f), previous_day(c, f) from previous_day_args"
    ...
    order_qt_all_null "select previous_day(b, f), previous_day(d, f) from previous_day_args"
    ...
    order_qt_const_nullable "select previous_day(NULL, NULL) from previous_day_args"
    order_qt_partial_const_nullable "select previous_day(NULL, e) from previous_day_args"
    order_qt_const_not_nullable "select previous_day('2025-01-01', 'MONDAY') from previous_day_args"
    order_qt_const_other_nullable "select previous_day('2025-01-01', f) from previous_day_args"
    order_qt_const_other_not_nullable "select previous_day(a, 'FRI') from previous_day_args"
    order_qt_const_nullable_no_null "select previous_day(nullable('2025-01-01'), nullable('MON'))"
    order_qt_const_nullable_no_null_multirows "select previous_day(nullable(c), nullable(e)) from previous_day_args"
    order_qt_const_partial_nullable_no_null "select previous_day('2025-01-01', nullable(e)) from previous_day_args"

    /// folding
    check_fold_consistency "previous_day('', 'SA')"
    check_fold_consistency "previous_day(NULL, NULL)"
    check_fold_consistency "previous_day(NULL, 'FRI')"
    check_fold_consistency "previous_day('2025-01-01', NULL)"
    check_fold_consistency "previous_day('2025-01-01', 'MONDAY')"
    check_fold_consistency "previous_day(nullable('2025-01-01'), nullable('SUN'))"
    check_fold_consistency "previous_day('2025-01-01', nullable('WE'))"
    check_fold_consistency "previous_day(nullable('2025-01-01'), 'TH')"
    check_fold_consistency "previous_day(nullable('2025-01-01 12:34:56'), 'MONDAY')"  
    // test cast date/datetime to date/datetime
    check_fold_consistency "previous_day(cast('2025-01-01' as date), 'MONDAY')"
    check_fold_consistency "previous_day(cast('2025-01-01' as datetime), 'MONDAY')"
    check_fold_consistency "previous_day(cast('2025-01-01 12:34:56' as date), 'MONDAY')"
    check_fold_consistency "previous_day(cast('2025-01-01 12:34:56' as datetime), 'MONDAY')"

    /// wrong date
    order_qt_wrong_date "select previous_day('2025-02-31', 'MONDAY')"
    order_qt_wrong_date "select previous_day('2025-02-29', 'MONDAY')"
    order_qt_wrong_date "select previous_day('2025-03-32', 'MONDAY')"
