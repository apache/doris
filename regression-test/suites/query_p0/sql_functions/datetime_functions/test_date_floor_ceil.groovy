...
suite("test_date_floor_ceil") {
    ...
    qt_date_floor_corner_case_5 """ select date_floor('0000-01-01 00:00:00', interval 7 minute); """ // be's result is wrong
    ...
    qt_date_ceil_corner_case_4 """ select date_ceil('0000-01-01 23:59:59.999999', interval 7 month); """ // be's result is wrong
