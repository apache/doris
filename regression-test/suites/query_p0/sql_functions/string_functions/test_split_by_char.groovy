...
suite("test_split_by_char") {
    ...
    sql """ INSERT INTO ${tableName} VALUES(4, '', 'a') """
    sql """ INSERT INTO ${tableName} VALUES(5, 'a1b1c1d', '1') """
    sql """ INSERT INTO ${tableName} VALUES(6, ',,,', ',') """
    sql """ INSERT INTO ${tableName} VALUES(7, 'a,b,c', ',') """
