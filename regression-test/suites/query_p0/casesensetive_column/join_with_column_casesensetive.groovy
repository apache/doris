...
suite("join_with_column_casesensetive") {
    ...
    explain {
        sql("select /*+ enable_nereids_planner=false */ ad_order_data.pin_id,  ad_order_data_v1.rptcnt from ad_order_data left join ad_order_data_v1 on ad_order_data.pin_id=ad_order_data_v1.pin_id;")
        notContains "PIN_ID"
    }
