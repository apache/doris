...
suite("test_regr_intercept") {
    sql """ DROP TABLE IF EXISTS test_regr_intercept_int """
    sql """ DROP TABLE IF EXISTS test_regr_intercept_double """
    ...
    sql """
        ...
        """
    sql """
        CREATE TABLE test_regr_intercept_double (
          `id` int,
          `x` double,
          `y` double
        ) ENGINE=OLAP
    ...
    sql """
        INSERT INTO test_regr_intercept_int VALUES
        (1, 18, 13),
        (2, 14, 27),
        (3, 12, 2),
        (4, 5, 6),
    ...
    sql """
        INSERT INTO test_regr_intercept_double VALUES
    ...
    qt_sql_int_1 "select regr_intercept(10, x) from test_regr_intercept_int"
    ...
    qt_sql_int_5 "select regr_intercept(y, non_nullable(x)) from test_regr_intercept_int"
    ...
    // parameter is literal and columns
    // _xxx can help use to distinguish the result
    qt_sql_int_6 "select regr_intercept(10, x) from test_regr_intercept_int"
    ...
    qt_sql_int_9 "select regr_intercept(non_nullable(y), non_nullable(x)) from test_regr_intercept_int where id >= 3 group by id order by id"
    // qt_sql_int_4 tests mix nullable 
    qt_sql_int_10 "select regr_intercept(y, non_nullable(x)) from test_regr_intercept_int where id >= 3"
    qt_sql_int_10 "select regr_intercept(y, non_nullable(x)) from test_regr_intercept_int where id >= 3 group by id order by id"

    //// Repeat same thing for double ////

    // parameter is literal and columns
    // _xxx can help use to distinguish the result
    qt_sql_double_1 "select regr_intercept(10, x) from test_regr_intercept_double"
    ...
    qt_sql_double_4 "select regr_intercept(non_nullable(y), non_nullable(x)) from test_regr_intercept_double group by id order by id"
    // qt_sql_int_4 tests mix nullable 
    qt_sql_double_5 "select regr_intercept(y, non_nullable(x)) from test_regr_intercept_double"

    sql """ TRUNCATE TABLE test_regr_intercept_double """
    ...
    // parameter is literal and columns
    // _xxx can help use to distinguish the result
    qt_sql_double_6 "select regr_intercept(10, x) from test_regr_intercept_double"
    ...
    qt_sql_double_9 "select regr_intercept(non_nullable(y), non_nullable(x)) from test_regr_intercept_double where id >= 3 group by id order by id"
    // qt_sql_int_4 tests mix nullable 
