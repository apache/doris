...
suite("group_array_intersect") {
    ...
    qt_int_1_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (6, 12);"""
    qt_int_2_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (14, 12);"""
    qt_int_3_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (0, 6);"""
    qt_int_4_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (13);"""
    qt_int_5_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (2, 5);"""
    qt_int_6_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (6, 13);"""
    qt_int_7_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (12);"""
    qt_int_8_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (6, 7);"""
    qt_int_9_union """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (9, 12);"""
    qt_float_1_union """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test where id = 7;"""
    qt_float_2_union """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test where id between 7 and 8;"""
    qt_float_3_union """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test where id in (7, 9);"""
    qt_datetimev2_1_union """select array_sort(group_array_union(c_array_datetimev2)) from group_array_intersect_test;"""
    qt_datetimev2_2_union """select array_sort(group_array_union(c_array_datetimev2)) from group_array_intersect_test where id in (10, 11);"""
    qt_datev2_1_union """select array_sort(group_array_union(c_array_datev2)) from group_array_intersect_test where id in (15, 16);"""
    qt_datev2_2_union """select array_sort(group_array_union(c_array_datev2)) from group_array_intersect_test where id in (15, 17);"""
    qt_string_1_union """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test where id in (17, 20);"""
    qt_string_2_union """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test where id in (18, 20);"""
    qt_bigint_union """select array_sort(group_array_union(c_array_bigint)) from group_array_intersect_test where id in (23, 24);"""
    qt_decimal_union """select array_sort(group_array_union(c_array_decimal)) from group_array_intersect_test where id in (25, 26);"""
    qt_groupby_1_union """select id, array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id <= 1 group by id order by id;"""
    qt_groupby_2_union """select id, array_sort(group_array_union(c_array_string)) from group_array_intersect_test where c_array_string is not null group by id order by id;"""
    qt_groupby_3_union """select id, array_sort(group_array_union(c_array_string)) from group_array_intersect_test where id = 18 group by id order by id;"""
    ...
    qt_notnull_11_union """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where array_size(c_array_float) between 1 and 2;"""
    qt_notnull_12_union """select array_sort(group_array_union(c_array_int)), array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where id between 2 and 3;"""
    qt_notnull_13_union """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where array_size(c_array_float) between 2 and 3;"""
    qt_notnull_14_union """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test_not_null where id between 1 and 2;"""
    qt_notnull_15_union """select array_sort(group_array_union(c_array_int)), array_sort(group_array_union(c_array_float)), array_sort(group_array_union(c_array_string)) from group_array_intersect_test_not_null where id between 3 and 4;"""
    qt_notnull_16_union """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test_not_null where id between 1 and 5;"""
    qt_notnull_17_union """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where id between 1 and 5;"""
