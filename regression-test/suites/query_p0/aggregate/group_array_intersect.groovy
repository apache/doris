...
suite("group_array_intersect") {
    ...
    qt_int_1 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (6, 12);"""
    qt_int_2 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (14, 12);"""
    qt_int_3 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (0, 6);"""
    qt_int_4 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (13);"""
    qt_int_5 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (2, 5);"""
    qt_int_6 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (6, 13);"""
    qt_int_7 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (12);"""
    qt_int_8 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (6, 7);"""
    qt_int_9 """select array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id in (9, 12);"""
    qt_float_1 """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test where id = 7;"""
    qt_float_2 """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test where id between 7 and 8;"""
    qt_float_3 """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test where id in (7, 9);"""
    qt_datetimev2_1 """select array_sort(group_array_union(c_array_datetimev2)) from group_array_intersect_test;"""
    qt_datetimev2_2 """select array_sort(group_array_union(c_array_datetimev2)) from group_array_intersect_test where id in (10, 11);"""
    qt_datev2_1 """select array_sort(group_array_union(c_array_datev2)) from group_array_intersect_test where id in (15, 16);"""
    qt_datev2_2 """select array_sort(group_array_union(c_array_datev2)) from group_array_intersect_test where id in (15, 17);"""
    qt_string_1 """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test where id in (17, 20);"""
    qt_string_2 """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test where id in (18, 20);"""
    qt_bigint """select array_sort(group_array_union(c_array_bigint)) from group_array_intersect_test where id in (23, 24);"""
    qt_decimal """select array_sort(group_array_union(c_array_decimal)) from group_array_intersect_test where id in (25, 26);"""
    qt_groupby_1 """select id, array_sort(group_array_union(c_array_int)) from group_array_intersect_test where id <= 1 group by id order by id;"""
    qt_groupby_2 """select id, array_sort(group_array_union(c_array_string)) from group_array_intersect_test where c_array_string is not null group by id order by id;"""
    qt_groupby_3 """select id, array_sort(group_array_union(c_array_string)) from group_array_intersect_test where id = 18 group by id order by id;"""
    ...
    qt_notnull_11 """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where array_size(c_array_float) between 1 and 2;"""
    qt_notnull_12 """select array_sort(group_array_union(c_array_int)), array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where id between 2 and 3;"""
    qt_notnull_13 """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where array_size(c_array_float) between 2 and 3;"""
    qt_notnull_14 """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test_not_null where id between 1 and 2;"""
    qt_notnull_15 """select array_sort(group_array_union(c_array_int)), array_sort(group_array_union(c_array_float)), array_sort(group_array_union(c_array_string)) from group_array_intersect_test_not_null where id between 3 and 4;"""
    qt_notnull_16 """select array_sort(group_array_union(c_array_string)) from group_array_intersect_test_not_null where id between 1 and 5;"""
    qt_notnull_17 """select array_sort(group_array_union(c_array_float)) from group_array_intersect_test_not_null where id between 1 and 5;"""
