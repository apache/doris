...
suite("rqg4265") {
	...
	"""
	order_qt_rqg265 """
	SELECT /*+   leading( tbl3 ) */ 4 AS col_int_undef_signed , tbl3 . col_int_undef_signed3 AS col_int_undef_signed2 , 1 AS col_int_undef_signed3 , tbl2 . col_int_undef_signed3 AS col_int_undef_signed4 FROM table_30_undef_partitions2_keys3_properties4_distributed_by5 AS tbl1   JOIN (  SELECT /*+   leading(  tbl1 { tbl3 tbl4 } ) */ tbl3 . col_int_undef_signed AS col_int_undef_signed , tbl1 . col_int_undef_signed AS col_int_undef_signed2 , tbl1 . col_int_undef_signed2 AS col_int_undef_signed3 , 2 AS col_int_undef_signed4 FROM table_50_undef_partitions2_keys3_properties4_distributed_by52 AS tbl1  INNER JOIN table_20_undef_partitions2_keys3_properties4_distributed_by52 AS tbl2 ON tbl2 . col_int_undef_signed2 = tbl2 . col_int_undef_signed2   INNER JOIN table_50_undef_partitions2_keys3_properties4_distributed_by5 AS tbl3 ON tbl3 . col_int_undef_signed2 = tbl3 . col_int_undef_signed   LEFT  JOIN table_20_undef_partitions2_keys3_properties4_distributed_by52 AS tbl4 ON tbl1 . col_int_undef_signed2  <  tbl2 . col_int_undef_signed    WHERE  ( tbl1 . col_int_undef_signed3  <=  tbl2 . col_int_undef_signed4 ) ORDER BY 1,2,3,4 DESC LIMIT 6666 OFFSET 100  ) AS tbl2 ON tbl1 . col_int_undef_signed = tbl2 . col_int_undef_signed4 AND tbl1 . col_int_undef_signed = tbl2 . col_int_undef_signed4 OR tbl1 . col_int_undef_signed3 = tbl2 . col_int_undef_signed2   INNER JOIN table_50_undef_partitions2_keys3_properties4_distributed_by52 AS tbl3 ON tbl3 . col_int_undef_signed3  >=  tbl1 . col_int_undef_signed4     WHERE  ( tbl3 . col_int_undef_signed3 IN ( 9 ) AND  ( tbl2 . col_int_undef_signed2 IS  NULL ) ) ORDER BY 2,4,1,3 DESC LIMIT 6666 OFFSET 100 ;
	"""
