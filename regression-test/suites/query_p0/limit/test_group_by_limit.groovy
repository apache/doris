...
suite("test_group_by_limit", "query") {
    ...
    explain{
        ...
        contains("VTOP-N")
        contains("sortInfo:[encode_as_largeint(shipmode)]")
    }
    ...
    explain {
        ...
        contains("VTOP-N")
        contains("sortInfo:[cast(commitdate as DATETIMEV2(0))]")
    }
    ...
    explain{
        ...
        contains("VTOP-N")
        contains("sortInfo:[month(commitdate)]")
    }
    ...
    explain{
        ...
        contains("VTOP-N")
        contains("sortInfo:[encode_as_largeint(shipmode), linenumber]")
    }
    ...
    explain{
        ...
        contains("VTOP-N")
        contains("sortInfo:[encode_as_largeint(shipmode), linenumber, tax]")
    }
    ...
    explain{
        ...
        contains("VTOP-N")
        contains("sortInfo:[encode_as_largeint(shipmode), linenumber, tax, commitdate]")
    }
    ...
    explain {
        sql """ select  sum(orderkey), count(partkey), shipmode, linenumber , tax from tpch_tiny_lineitem group by rollup(shipmode, linenumber, tax) order by shipmode desc, linenumber, tax desc limit 3; """
        contains("sortInfo:null")
    } 

    explain {
        sql """ select  sum(orderkey), count(partkey), shipmode, linenumber , tax from tpch_tiny_lineitem group by rollup(shipmode, linenumber, tax) limit 3; """
        notContains("VTOP-N")
        contains("sortInfo:null")
    } 

    explain {
        sql """ select  sum(orderkey), count(partkey) from tpch_tiny_lineitem limit 3; """
        notContains("VTOP-N")
        contains("sortInfo:null")
    } 
