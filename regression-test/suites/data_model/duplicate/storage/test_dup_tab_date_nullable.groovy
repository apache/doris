...
"storage_format" = "V2"
    ...
    sql "insert into ${table1} values(1, '2021-03-01', '2021-03-02', '2021-03-03')"
    sql "insert into ${table1} values(1, '2021-02-01', '2021-02-02', '2021-02-03')"
    sql "insert into ${table1} values(1, '2021-01-01', '2021-01-02', '2021-01-03')"
    sql "insert into ${table1} values(null, '2021-05-01', 'null', '2021-04-03')"
