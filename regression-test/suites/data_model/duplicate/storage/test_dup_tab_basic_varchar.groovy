...
"storage_format" = "V2"
    ...
    sql "insert into ${table1} values('b1','b2','b3','b4')"
    sql "insert into ${table1} values('c1','f1','d3','f4')"
    sql "insert into ${table1} values('c1','c2','c3','c4')"
    sql "insert into ${table1} values('d1','d2','d3','d4')"
    sql "insert into ${table1} values('e1','e2','e3','e4')"
