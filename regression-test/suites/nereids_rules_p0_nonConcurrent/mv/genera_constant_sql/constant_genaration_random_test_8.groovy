...
suite ("constant_genaration_random_mtmv_8", "constant_genaration_random_mtmv") {
    ...
    def sql10 = "select t1.col1 from (select plac_1 as col1 from ${table1} where plac_1 = plac_1) as t1 left join (select plac_1 as col2 from ${table1}) as t2 on t1.col1 = t2.col2 group by t1.col1"
