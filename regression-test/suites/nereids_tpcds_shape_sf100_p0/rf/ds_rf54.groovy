...
suite("ds_rf54") {
 ...
 limit 100;
    ...
    assertEquals("RF5[d_date_sk->[ss_sold_date_sk],RF4[c_customer_sk->[ss_customer_sk],RF2[s_county->[ca_county],RF3[s_state->[ca_state],RF1[c_current_addr_sk->[ca_address_sk],RF0[customer_sk->[c_customer_sk]", getRuntimeFilters(plan))
}
