...
suite("test_kinesis_routine_load_partial_update_new_key_behavior") {
    ...
    def streamName = "doris-newkey-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_new_key"
    def jobName = "testKinesisNewKey"
    ...
    try {
        ...
        // Partial update with new key
        def data1 = "{\"id\": 1, \"name\": \"Alice\"}"
        def data2 = "{\"id\": 2, \"age\": 30}"
