...
suite("test_kinesis_routine_load_flexible_partial_update") {
    ...
    def streamName = "doris-flex-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_flex_partial"
    def jobName = "testKinesisFlex"
    ...
    try {
        ...
        sql """INSERT INTO ${tableName} VALUES
            (1, 'Alice', 25, 'Beijing', 90),
            (2, 'Bob', 30, 'Shanghai', 85)
        """

        // Flexible partial update with different columns
        def data1 = "{\"id\": 1, \"age\": 26, \"score\": 95}"
        ...
        assertTrue(result[0][2] == 26)  // age updated
        assertTrue(result[0][4] == 95)  // score updated
        assertTrue(result[1][3] == "Shenzhen")  // city updated
