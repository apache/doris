...
suite("test_kinesis_routine_load_jsonpath") {
    ...
    def streamName = "doris-test-json-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_jsonpath"
    def jobName = "testKinesisJson"
    ...
    try {
        ...
        for (int i = 1; i <= 20; i++) {
            def data = "{\"data\": {\"id\": ${i}, \"info\": {\"name\": \"user_${i}\", \"age\": ${20 + i}}}}"
