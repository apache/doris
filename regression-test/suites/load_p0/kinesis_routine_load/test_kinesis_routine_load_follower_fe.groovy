...
suite("test_kinesis_routine_load_follower_fe") {
    ...
    def streamName = "doris-follower-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_follower"
    def jobName = "testKinesisFollower"
    ...
    try {
        ...
        logger.info("Job info: ${jobInfo[0]}")
