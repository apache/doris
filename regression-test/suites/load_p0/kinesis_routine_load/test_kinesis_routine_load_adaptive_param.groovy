...
suite("test_kinesis_routine_load_adaptive_param") {
    ...
    def streamName = "doris-adaptive-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_adaptive"
    def jobName = "testKinesisAdaptive"
