...
suite("test_kinesis_routine_load_timeout_value", "nonConcurrent") {
    ...
    def streamName = "doris-timeout-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_timeout"
    def jobName = "testKinesisTimeout"
