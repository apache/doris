...
suite("test_kinesis_routine_load_alter") {
    ...
    def streamName = "doris-test-alter-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_alter"
    def jobName = "testKinesisAlter"
    ...
    try {
        ...
        logger.info("Job config after ALTER: ${result}")
