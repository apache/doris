...
suite("test_kinesis_routine_load_schedule") {
    ...
    def streamName = "doris-sched2-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_sched"
    def jobName = "testKinesisSched"
