...
suite("test_kinesis_routine_load_with_user") {
    ...
    def streamName = "doris-user-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_user"
    def jobName = "testKinesisUser"
    def testUser = "test_kinesis_user"
    ...
    try {
        ...
        sql "GRANT LOAD_PRIV ON *.* TO ${testUser}"
