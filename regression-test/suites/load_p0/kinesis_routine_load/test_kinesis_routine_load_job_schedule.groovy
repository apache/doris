...
suite("test_kinesis_routine_load_job_schedule") {
    ...
    def streamName = "doris-schedule-${UUID.randomUUID().toString().substring(0, 8)}"
    def tableName = "test_kinesis_schedule"
    def jobName = "testKinesisSchedule"
    ...
    try {
        ...
        logger.info("Job schedule info: ${jobInfo[0]}")
