...
suite("test_routine_load","p0") {
    ...
    sql "create workload group if not exists create_routine_load_group $forComputeGroupStr properties ( 'min_cpu_percent'='12');"
    sql "create workload group if not exists alter_routine_load_group $forComputeGroupStr properties ( 'min_cpu_percent'='12');"
