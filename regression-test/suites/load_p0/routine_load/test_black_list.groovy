...
suite("test_black_list","nonConcurrent,p0") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        try {
            GetDebugPoint().enableDebugPointForAllFEs("FE.GET_KAFKA_META_FAIL")
            sql """
            ...
            count = 0
            GetDebugPoint().disableDebugPointForAllFEs("FE.GET_KAFKA_META_FAIL")
            while (true) {
                sleep(1000)
            ...
            GetDebugPoint().disableDebugPointForAllBEs("FE.GET_KAFKA_META_FAIL")
