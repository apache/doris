...
suite("test_routine_load_condition","p0") {
    def kafkaCsvTpoics = [
    ...
    def tableName = "test_routine_load_where_condition"
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        try {
            sql """
            ...
            sql """
                CREATE ROUTINE LOAD ${jobName} on test_routine_load_where_condition
                COLUMNS(k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17,k18),
                COLUMNS TERMINATED BY "|",
                where k12 >= date_sub(CURDATE(), INTERVAL 2 DAY)
                PROPERTIES
                (
                ...
                (
                    ...
                    "kafka_topic" = "test_where_condition",
