        ...
        try {
            sql """
                ...
                FROM KAFKA (
                    ...
                    "kafka_topic" = "test_routine_load_persistence_topic"
                )
            """
            ...
            assertTrue(latestImageSequence(oldMaster) < alterJournalId,
                    "ALTER must be tested through journal replay before checkpoint")
