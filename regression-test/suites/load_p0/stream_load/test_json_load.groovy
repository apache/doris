...
suite("test_json_load", "p0") { 
    ...
    try {
        ...
        create_test_table1.call(testTable)
        load_json_data.call("${testTable}", "${testTable}_case18_1", 'true', '', 'json', 'id, code, city',
                            '[\"$.id\", \"$.code\", \"$.city[2]\"]', '$.item', '', 'true', 'invalid_nest_json_array.json', true) 
        load_json_data.call("${testTable}", "${testTable}_case18_2", 'true', '', 'json', 'id, code, city',
                            '[\"$.id\", \"$.code\", \"$.city[100]\"]', '$.item', '', 'true', 'invalid_nest_json_array1.json', true) 
        load_json_data.call("${testTable}", "${testTable}_case18_3", 'true', '', 'json', 'id, code, city',
                            '[\"$.id\", \"$.code\", \"$.city\"]', '$.item', '', 'true', 'invalid_nest_json_array2.json', true) 
        load_json_data.call("${testTable}", "${testTable}_case18_4", 'true', '', 'json', 'id, code, city',
    ...
    try {
        ...
        sql """
            ...
            """
        load_json_data.call("${testTable}", "${testTable}_case21" , 'false', '', 'json', '', '', '', '', '', 'with_jsonb.json')
