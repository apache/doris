...
suite("test_s3_load_parquet_orc_complex_type", "load_p0,external") {
    ...
    def submitS3Load = { String tableName, String path, String format ->
    ...
    submitS3Load.call(parquetTable, "${s3BasePath}/parquet", "parquet")
    submitS3Load.call(orcTable, "${s3BasePath}/orc", "orc")
