...
suite('test_ingestion_load_type_bitmap', 'p0') {
    ...
    def testIngestLoadJob = { testTable, loadLabel, String dataFile ->
        ...
        String dppResult = '{\\"isSuccess\\":true,\\"failedReason\\":\\"\\",\\"scannedRows\\":5,\\"fileNumber\\":1,' +
                '\\"fileSize\\":757,\\"normalRows\\":5,\\"abnormalRows\\":0,\\"unselectRows\\":0,' +
        ...
        String updateStatusReqBody =
                ...
                "statusInfo": {
                    ...
                    "appId": "",
                    "dppResult": "${dppResult}",
                    "filePathToSize": "{\\"${etlResultFilePath}\\": 757}",
        ...
        while (max_try_milli_secs) {
            ...
            if (result[0][2] == "FINISHED") {
                sql "sync"
                qt_select "select c_int, bitmap_count(c_bitmap) as cnt from ${testTable} order by 1"
                break
            } else {
    ...
    if (enableHdfs()) {
        ...
        def tableName = 'test_ingestion_load_type_bitmap'
        ...
        def label = "test_ingestion_load_type_bitmap"

        testIngestLoadJob.call(tableName, label, context.config.dataPath + '/load_p0/ingestion_load/data3.parquet')
