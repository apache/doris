...
suite('test_ingestion_load_type_hll', 'p0') {
    ...
    def testIngestLoadJob = { testTable, loadLabel, String dataFile ->
        ...
        String dppResult = '{\\"isSuccess\\":true,\\"failedReason\\":\\"\\",\\"scannedRows\\":5,\\"fileNumber\\":1,' +
                '\\"fileSize\\":812,\\"normalRows\\":5,\\"abnormalRows\\":0,\\"unselectRows\\":0,' +
        ...
        String updateStatusReqBody =
                ...
                "statusInfo": {
                    ...
                    "appId": "",
                    "dppResult": "${dppResult}",
                    "filePathToSize": "{\\"${etlResultFilePath}\\": 812}",
        ...
        while (max_try_milli_secs) {
            ...
            if (result[0][2] == "FINISHED") {
                sql "sync"
                qt_select "select c_int, hll_cardinality(c_hll) as cnt from ${testTable} order by 1"
                break
            } else {
    ...
    if (enableHdfs()) {
        ...
        def tableName = 'test_ingestion_load_type_hll'
        ...
        def label = "test_ingestion_load_type_hll"

        testIngestLoadJob.call(tableName, label, context.config.dataPath + '/load_p0/ingestion_load/data4.parquet')
