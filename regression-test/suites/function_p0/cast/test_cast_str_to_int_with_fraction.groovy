...
suite("test_cast_str_to_int_with_fraction") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.test_from_string --gen_regression_case
    sql "drop table if exists test_cast_str_to_int_with_fraction_0;"
    sql "create table test_cast_str_to_int_with_fraction_0(f1 int, f2 string) properties('replication_num'='1');"
    sql """insert into test_cast_str_to_int_with_fraction_0 values (0, "+0000.4"),(1, "+0000.5"),(2, "+0001.4"),(3, "+0001.5"),(4, "+0009.4"),(5, "+0009.5"),(6, "+000123.4"),(7, "+000123.5"),(8, "+0002147483647.4"),(9, "+0002147483647.5"),(10, "-0001.4"),(11, "-0001.5"),(12, "-0009.4"),(13, "-0009.5"),(14, "-000123.4"),(15, "-000123.5"),(16, "-0002147483648.4"),(17, "-0002147483648.5"),(18, "+0002147483646.4"),(19, "+0002147483646.5"),
    ...
    def test_cast_str_to_int_with_fraction_data_start_index = 0
    def test_cast_str_to_int_with_fraction_data_end_index = 88
    for (int data_index = test_cast_str_to_int_with_fraction_data_start_index; data_index < test_cast_str_to_int_with_fraction_data_end_index; data_index++) {
        test {
            sql "select f1, cast(f2 as int) from test_cast_str_to_int_with_fraction where f1 = ${data_index}"
            exception ""
        }
    }
    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as int) from test_cast_str_to_int_with_fraction_0 order by 1;'
