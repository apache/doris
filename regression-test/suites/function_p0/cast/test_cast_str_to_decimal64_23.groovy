...
suite("test_cast_str_to_decimal64_23") {
    ...
    qt_sql_23_strict 'select f1, cast(f2 as decimalv3(18, 18)) from test_cast_str_to_decimal64_23_23_18_18 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_23_non_strict 'select f1, cast(f2 as decimalv3(18, 18)) from test_cast_str_to_decimal64_23_23_18_18 order by 1;'
