...
suite("test_cast_to_double_from_decimal32_9_4") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_double_from_decimal32_9_4_0;"
    sql "create table test_cast_to_double_from_decimal32_9_4_0(f1 int, f2 decimalv3(9, 4)) properties('replication_num'='1');"
    sql """insert into test_cast_to_double_from_decimal32_9_4_0 values (0, "0.0000"),(1, "0.0000"),(2, "0.0001"),(3, "-0.0001"),(4, "0.0009"),(5, "-0.0009"),(6, "0.0999"),(7, "-0.0999"),(8, "0.9000"),(9, "-0.9000"),(10, "0.9001"),(11, "-0.9001"),(12, "0.9998"),(13, "-0.9998"),(14, "0.9999"),(15, "-0.9999"),(16, "1.0000"),(17, "-1.0000"),(18, "1.0001"),(19, "-1.0001"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as double) from test_cast_to_double_from_decimal32_9_4_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as double) from test_cast_to_double_from_decimal32_9_4_0 order by 1;'
