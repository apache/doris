...
suite("test_cast_to_float_from_decimal64_18_1") {
    ...
    sql "drop table if exists test_cast_to_float_from_decimal64_18_1_0;"
    sql "create table test_cast_to_float_from_decimal64_18_1_0(f1 int, f2 decimalv3(18, 1)) properties('replication_num'='1');"
    sql """insert into test_cast_to_float_from_decimal64_18_1_0 values (0, "0.0"),(1, "0.0"),(2, "0.1"),(3, "-0.1"),(4, "0.8"),(5, "-0.8"),(6, "0.9"),(7, "-0.9"),(8, "1.0"),(9, "-1.0"),(10, "1.1"),(11, "-1.1"),(12, "1.8"),(13, "-1.8"),(14, "1.9"),(15, "-1.9"),(16, "9.0"),(17, "-9.0"),(18, "9.1"),(19, "-9.1"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_decimal64_18_1_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_decimal64_18_1_0 order by 1;'
