...
suite("test_cast_to_double_from_decimalv2_1_1_const") {
    ...
    def const_sql_0_0 = """select "0.0", cast(cast("0.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_0_strict "${const_sql_0_0}"
    testFoldConst("${const_sql_0_0}")
    def const_sql_0_1 = """select "0.0", cast(cast("0.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_1_strict "${const_sql_0_1}"
    testFoldConst("${const_sql_0_1}")
    def const_sql_0_2 = """select "0.9", cast(cast("0.9" as decimalv2(1, 1)) as double);"""
    qt_sql_0_2_strict "${const_sql_0_2}"
    testFoldConst("${const_sql_0_2}")
    def const_sql_0_3 = """select "-0.9", cast(cast("-0.9" as decimalv2(1, 1)) as double);"""
    qt_sql_0_3_strict "${const_sql_0_3}"
    testFoldConst("${const_sql_0_3}")
    def const_sql_0_4 = """select "10000000.0", cast(cast("10000000.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_4_strict "${const_sql_0_4}"
    testFoldConst("${const_sql_0_4}")
    def const_sql_0_5 = """select "-10000000.0", cast(cast("-10000000.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_5_strict "${const_sql_0_5}"
    testFoldConst("${const_sql_0_5}")
    def const_sql_0_6 = """select "80000000.0", cast(cast("80000000.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_6_strict "${const_sql_0_6}"
    testFoldConst("${const_sql_0_6}")
    def const_sql_0_7 = """select "-80000000.0", cast(cast("-80000000.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_7_strict "${const_sql_0_7}"
    testFoldConst("${const_sql_0_7}")
    def const_sql_0_8 = """select "90000000.0", cast(cast("90000000.0" as decimalv2(1, 1)) as double);"""
    qt_sql_0_8_strict "${const_sql_0_8}"
    testFoldConst("${const_sql_0_8}")
    def const_sql_0_9 = """select "-90000000.0", cast(cast("-90000000.0" as decimalv2(1, 1)) as double);"""
