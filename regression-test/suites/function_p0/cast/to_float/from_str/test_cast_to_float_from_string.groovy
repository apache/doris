...
suite("test_cast_to_float_from_string") {
    ...
    sql "drop table if exists test_cast_to_float_from_string_0;"
    sql "create table test_cast_to_float_from_string_0(f1 int, f2 string) properties('replication_num'='1');"
    sql """insert into test_cast_to_float_from_string_0 values (0, "0"),(1, "1"),(2, "9"),(3, "100000"),(4, "123456"),(5, "999999"),(6, "0."),(7, "1."),(8, "9."),(9, "100000."),(10, "123456."),(11, "999999."),(12, ".0"),(13, ".1"),(14, ".9"),(15, ".000001"),(16, ".000009"),(17, ".100000"),(18, ".900000"),(19, ".100001"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_string_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_string_0 order by 1;'
