...
suite("test_cast_to_double_from_datetimev2_0_part6") {
    ...
    test {
        sql """select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_0_part6_6 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_6_non_strict 'select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_0_part6_6 order by 1;'
