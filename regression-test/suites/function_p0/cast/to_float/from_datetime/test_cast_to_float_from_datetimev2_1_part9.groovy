...
suite("test_cast_to_float_from_datetimev2_1_part9") {
    ...
    test {
        sql """select f1, cast(f2 as float) from test_cast_to_float_from_datetimev2_1_part9_9 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_9_non_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_datetimev2_1_part9_9 order by 1;'
