...
suite("test_cast_to_float_from_datetimev2_0_part1") {
    ...
    sql "drop table if exists test_cast_to_float_from_datetimev2_0_part1_1;"
    sql "create table test_cast_to_float_from_datetimev2_0_part1_1(f1 int, f2 datetimev2(0)) properties('replication_num'='1');"
    sql """insert into test_cast_to_float_from_datetimev2_0_part1_1 values (0, "0000-12-01 01:00:59"),(1, "0000-12-01 01:00:59"),(2, "0000-12-01 01:00:59"),(3, "0000-12-01 01:01:00"),(4, "0000-12-01 01:01:00"),(5, "0000-12-01 01:01:00"),(6, "0000-12-01 01:01:01"),(7, "0000-12-01 01:01:01"),(8, "0000-12-01 01:01:01"),(9, "0000-12-01 01:01:59"),(10, "0000-12-01 01:01:59"),(11, "0000-12-01 01:01:59"),(12, "0000-12-01 01:59:00"),(13, "0000-12-01 01:59:00"),(14, "0000-12-01 01:59:00"),(15, "0000-12-01 01:59:01"),(16, "0000-12-01 01:59:01"),(17, "0000-12-01 01:59:01"),(18, "0000-12-01 01:59:59"),(19, "0000-12-01 01:59:59"),
    ...
    test {
        sql """select f1, cast(f2 as float) from test_cast_to_float_from_datetimev2_0_part1_1 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_1_non_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_datetimev2_0_part1_1 order by 1;'
