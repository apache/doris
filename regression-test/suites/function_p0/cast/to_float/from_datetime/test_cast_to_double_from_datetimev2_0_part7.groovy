...
suite("test_cast_to_double_from_datetimev2_0_part7") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_double_from_datetimev2_0_part7_7;"
    sql "create table test_cast_to_double_from_datetimev2_0_part7_7(f1 int, f2 datetimev2(0)) properties('replication_num'='1');"
    sql """insert into test_cast_to_double_from_datetimev2_0_part7_7 values (0, "2025-01-01 23:01:59"),(1, "2025-01-01 23:01:59"),(2, "2025-01-01 23:01:59"),(3, "2025-01-01 23:59:00"),(4, "2025-01-01 23:59:00"),(5, "2025-01-01 23:59:00"),(6, "2025-01-01 23:59:01"),(7, "2025-01-01 23:59:01"),(8, "2025-01-01 23:59:01"),(9, "2025-01-01 23:59:59"),(10, "2025-01-01 23:59:59"),(11, "2025-01-01 23:59:59"),(12, "2025-01-28 00:00:00"),(13, "2025-01-28 00:00:00"),(14, "2025-01-28 00:00:00"),(15, "2025-01-28 00:00:01"),(16, "2025-01-28 00:00:01"),(17, "2025-01-28 00:00:01"),(18, "2025-01-28 00:00:59"),(19, "2025-01-28 00:00:59"),
    ...
    test {
        sql """select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_0_part7_7 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_7_non_strict 'select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_0_part7_7 order by 1;'
