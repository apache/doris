...
suite("test_cast_to_float_from_datetimev2_0_part9") {
    ...
    sql "drop table if exists test_cast_to_float_from_datetimev2_0_part9_9;"
    sql "create table test_cast_to_float_from_datetimev2_0_part9_9(f1 int, f2 datetimev2(0)) properties('replication_num'='1');"
    sql """insert into test_cast_to_float_from_datetimev2_0_part9_9 values (0, "9999-01-28 23:00:00"),(1, "9999-01-28 23:00:00"),(2, "9999-01-28 23:00:00"),(3, "9999-01-28 23:00:01"),(4, "9999-01-28 23:00:01"),(5, "9999-01-28 23:00:01"),(6, "9999-01-28 23:00:59"),(7, "9999-01-28 23:00:59"),(8, "9999-01-28 23:00:59"),(9, "9999-01-28 23:01:00"),(10, "9999-01-28 23:01:00"),(11, "9999-01-28 23:01:00"),(12, "9999-01-28 23:01:01"),(13, "9999-01-28 23:01:01"),(14, "9999-01-28 23:01:01"),(15, "9999-01-28 23:01:59"),(16, "9999-01-28 23:01:59"),(17, "9999-01-28 23:01:59"),(18, "9999-01-28 23:59:00"),(19, "9999-01-28 23:59:00"),
    ...
    test {
        sql """select f1, cast(f2 as float) from test_cast_to_float_from_datetimev2_0_part9_9 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_9_non_strict 'select f1, cast(f2 as float) from test_cast_to_float_from_datetimev2_0_part9_9 order by 1;'
