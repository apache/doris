...
suite("test_cast_to_double_from_datetimev2_1_part9") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_double_from_datetimev2_1_part9_9;"
    sql "create table test_cast_to_double_from_datetimev2_1_part9_9(f1 int, f2 datetimev2(1)) properties('replication_num'='1');"
    sql """insert into test_cast_to_double_from_datetimev2_1_part9_9 values (0, "9999-01-28 23:00:00.0"),(1, "9999-01-28 23:00:00.0"),(2, "9999-01-28 23:00:00.9"),(3, "9999-01-28 23:00:01.0"),(4, "9999-01-28 23:00:01.0"),(5, "9999-01-28 23:00:01.9"),(6, "9999-01-28 23:00:59.0"),(7, "9999-01-28 23:00:59.0"),(8, "9999-01-28 23:00:59.9"),(9, "9999-01-28 23:01:00.0"),(10, "9999-01-28 23:01:00.0"),(11, "9999-01-28 23:01:00.9"),(12, "9999-01-28 23:01:01.0"),(13, "9999-01-28 23:01:01.0"),(14, "9999-01-28 23:01:01.9"),(15, "9999-01-28 23:01:59.0"),(16, "9999-01-28 23:01:59.0"),(17, "9999-01-28 23:01:59.9"),(18, "9999-01-28 23:59:00.0"),(19, "9999-01-28 23:59:00.0"),
    ...
    test {
        sql """select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_1_part9_9 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_9_non_strict 'select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_1_part9_9 order by 1;'
