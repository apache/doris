...
suite("test_cast_to_double_from_datetimev2_0_part5") {
    ...
    test {
        sql """select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_0_part5_5 order by 1;"""
        exception ""
    }
    sql "set enable_strict_cast=false;"
    qt_sql_5_non_strict 'select f1, cast(f2 as double) from test_cast_to_double_from_datetimev2_0_part5_5 order by 1;'
