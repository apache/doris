...
suite("test_cast_str_to_int_overflow") {
    ...
    def test_cast_str_to_int_overflow_data_start_index = 0
    def test_cast_str_to_int_overflow_data_end_index = 46
    for (int data_index = test_cast_str_to_int_overflow_data_start_index; data_index < test_cast_str_to_int_overflow_data_end_index; data_index++) {
        test {
            sql "select f1, cast(f2 as int) from test_cast_str_to_int_overflow where f1 = ${data_index}"
            exception ""
        }
    }
    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as int) from test_cast_str_to_int_overflow_0 order by 1;'
