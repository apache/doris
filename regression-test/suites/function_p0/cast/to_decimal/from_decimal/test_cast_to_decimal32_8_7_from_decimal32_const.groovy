...
suite("test_cast_to_decimal32_8_7_from_decimal32_const") {
    ...
    def const_sql_0 = """select cast(cast("0" as decimalv3(1,0)) as decimalv3(8,7));"""
    qt_sql_0_strict "${const_sql_0}"
    testFoldConst("${const_sql_0}")
    def const_sql_1 = """select cast(cast("8" as decimalv3(1,0)) as decimalv3(8,7));"""
    qt_sql_1_strict "${const_sql_1}"
    testFoldConst("${const_sql_1}")
    def const_sql_2 = """select cast(cast("9" as decimalv3(1,0)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_2}")
    sql "set enable_strict_cast=true;"
    def const_sql_3 = """select cast(cast("0.0" as decimalv3(1,1)) as decimalv3(8,7));"""
    qt_sql_3_strict "${const_sql_3}"
    testFoldConst("${const_sql_3}")
    def const_sql_4 = """select cast(cast("0.1" as decimalv3(1,1)) as decimalv3(8,7));"""
    qt_sql_4_strict "${const_sql_4}"
    testFoldConst("${const_sql_4}")
    def const_sql_5 = """select cast(cast("0.8" as decimalv3(1,1)) as decimalv3(8,7));"""
    qt_sql_5_strict "${const_sql_5}"
    testFoldConst("${const_sql_5}")
    def const_sql_6 = """select cast(cast("0.9" as decimalv3(1,1)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_6}")
    sql "set enable_strict_cast=true;"
    def const_sql_7 = """select cast(cast("0" as decimalv3(4,0)) as decimalv3(8,7));"""
    qt_sql_7_strict "${const_sql_7}"
    testFoldConst("${const_sql_7}")
    def const_sql_8 = """select cast(cast("8" as decimalv3(4,0)) as decimalv3(8,7));"""
    qt_sql_8_strict "${const_sql_8}"
    testFoldConst("${const_sql_8}")
    def const_sql_9 = """select cast(cast("9" as decimalv3(4,0)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_9}")
    sql "set enable_strict_cast=true;"
    def const_sql_10 = """select cast(cast("0.0" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_10_strict "${const_sql_10}"
    testFoldConst("${const_sql_10}")
    def const_sql_11 = """select cast(cast("0.1" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_11_strict "${const_sql_11}"
    testFoldConst("${const_sql_11}")
    def const_sql_12 = """select cast(cast("0.8" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_12_strict "${const_sql_12}"
    testFoldConst("${const_sql_12}")
    def const_sql_13 = """select cast(cast("0.9" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_13_strict "${const_sql_13}"
    testFoldConst("${const_sql_13}")
    def const_sql_14 = """select cast(cast("8.0" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_14_strict "${const_sql_14}"
    testFoldConst("${const_sql_14}")
    def const_sql_15 = """select cast(cast("8.1" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_15_strict "${const_sql_15}"
    testFoldConst("${const_sql_15}")
    def const_sql_16 = """select cast(cast("8.8" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_16_strict "${const_sql_16}"
    testFoldConst("${const_sql_16}")
    def const_sql_17 = """select cast(cast("8.9" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_17_strict "${const_sql_17}"
    testFoldConst("${const_sql_17}")
    def const_sql_18 = """select cast(cast("9.0" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_18_strict "${const_sql_18}"
    testFoldConst("${const_sql_18}")
    def const_sql_19 = """select cast(cast("9.1" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_19_strict "${const_sql_19}"
    testFoldConst("${const_sql_19}")
    def const_sql_20 = """select cast(cast("9.8" as decimalv3(4,1)) as decimalv3(8,7));"""
    qt_sql_20_strict "${const_sql_20}"
    testFoldConst("${const_sql_20}")
    def const_sql_21 = """select cast(cast("9.9" as decimalv3(4,1)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_21}")
    sql "set enable_strict_cast=true;"
    def const_sql_22 = """select cast(cast("0.00" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_22_strict "${const_sql_22}"
    testFoldConst("${const_sql_22}")
    def const_sql_23 = """select cast(cast("0.01" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_23_strict "${const_sql_23}"
    testFoldConst("${const_sql_23}")
    def const_sql_24 = """select cast(cast("0.09" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_24_strict "${const_sql_24}"
    testFoldConst("${const_sql_24}")
    def const_sql_25 = """select cast(cast("0.90" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_25_strict "${const_sql_25}"
    testFoldConst("${const_sql_25}")
    def const_sql_26 = """select cast(cast("0.91" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_26_strict "${const_sql_26}"
    testFoldConst("${const_sql_26}")
    def const_sql_27 = """select cast(cast("0.98" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_27_strict "${const_sql_27}"
    testFoldConst("${const_sql_27}")
    def const_sql_28 = """select cast(cast("0.99" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_28_strict "${const_sql_28}"
    testFoldConst("${const_sql_28}")
    def const_sql_29 = """select cast(cast("8.00" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_29_strict "${const_sql_29}"
    testFoldConst("${const_sql_29}")
    def const_sql_30 = """select cast(cast("8.01" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_30_strict "${const_sql_30}"
    testFoldConst("${const_sql_30}")
    def const_sql_31 = """select cast(cast("8.09" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_31_strict "${const_sql_31}"
    testFoldConst("${const_sql_31}")
    def const_sql_32 = """select cast(cast("8.90" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_32_strict "${const_sql_32}"
    testFoldConst("${const_sql_32}")
    def const_sql_33 = """select cast(cast("8.91" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_33_strict "${const_sql_33}"
    testFoldConst("${const_sql_33}")
    def const_sql_34 = """select cast(cast("8.98" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_34_strict "${const_sql_34}"
    testFoldConst("${const_sql_34}")
    def const_sql_35 = """select cast(cast("8.99" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_35_strict "${const_sql_35}"
    testFoldConst("${const_sql_35}")
    def const_sql_36 = """select cast(cast("9.00" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_36_strict "${const_sql_36}"
    testFoldConst("${const_sql_36}")
    def const_sql_37 = """select cast(cast("9.01" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_37_strict "${const_sql_37}"
    testFoldConst("${const_sql_37}")
    def const_sql_38 = """select cast(cast("9.09" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_38_strict "${const_sql_38}"
    testFoldConst("${const_sql_38}")
    def const_sql_39 = """select cast(cast("9.90" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_39_strict "${const_sql_39}"
    testFoldConst("${const_sql_39}")
    def const_sql_40 = """select cast(cast("9.91" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_40_strict "${const_sql_40}"
    testFoldConst("${const_sql_40}")
    def const_sql_41 = """select cast(cast("9.98" as decimalv3(4,2)) as decimalv3(8,7));"""
    qt_sql_41_strict "${const_sql_41}"
    testFoldConst("${const_sql_41}")
    def const_sql_42 = """select cast(cast("9.99" as decimalv3(4,2)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_42}")
    sql "set enable_strict_cast=true;"
    def const_sql_43 = """select cast(cast("0.000" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_43_strict "${const_sql_43}"
    testFoldConst("${const_sql_43}")
    def const_sql_44 = """select cast(cast("0.001" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_44_strict "${const_sql_44}"
    testFoldConst("${const_sql_44}")
    def const_sql_45 = """select cast(cast("0.009" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_45_strict "${const_sql_45}"
    testFoldConst("${const_sql_45}")
    def const_sql_46 = """select cast(cast("0.099" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_46_strict "${const_sql_46}"
    testFoldConst("${const_sql_46}")
    def const_sql_47 = """select cast(cast("0.900" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_47_strict "${const_sql_47}"
    testFoldConst("${const_sql_47}")
    def const_sql_48 = """select cast(cast("0.901" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_48_strict "${const_sql_48}"
    testFoldConst("${const_sql_48}")
    def const_sql_49 = """select cast(cast("0.998" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_49_strict "${const_sql_49}"
    testFoldConst("${const_sql_49}")
    def const_sql_50 = """select cast(cast("0.999" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_50_strict "${const_sql_50}"
    testFoldConst("${const_sql_50}")
    def const_sql_51 = """select cast(cast("8.000" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_51_strict "${const_sql_51}"
    testFoldConst("${const_sql_51}")
    def const_sql_52 = """select cast(cast("8.001" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_52_strict "${const_sql_52}"
    testFoldConst("${const_sql_52}")
    def const_sql_53 = """select cast(cast("8.009" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_53_strict "${const_sql_53}"
    testFoldConst("${const_sql_53}")
    def const_sql_54 = """select cast(cast("8.099" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_54_strict "${const_sql_54}"
    testFoldConst("${const_sql_54}")
    def const_sql_55 = """select cast(cast("8.900" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_55_strict "${const_sql_55}"
    testFoldConst("${const_sql_55}")
    def const_sql_56 = """select cast(cast("8.901" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_56_strict "${const_sql_56}"
    testFoldConst("${const_sql_56}")
    def const_sql_57 = """select cast(cast("8.998" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_57_strict "${const_sql_57}"
    testFoldConst("${const_sql_57}")
    def const_sql_58 = """select cast(cast("8.999" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_58_strict "${const_sql_58}"
    testFoldConst("${const_sql_58}")
    def const_sql_59 = """select cast(cast("9.000" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_59_strict "${const_sql_59}"
    testFoldConst("${const_sql_59}")
    def const_sql_60 = """select cast(cast("9.001" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_60_strict "${const_sql_60}"
    testFoldConst("${const_sql_60}")
    def const_sql_61 = """select cast(cast("9.009" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_61_strict "${const_sql_61}"
    testFoldConst("${const_sql_61}")
    def const_sql_62 = """select cast(cast("9.099" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_62_strict "${const_sql_62}"
    testFoldConst("${const_sql_62}")
    def const_sql_63 = """select cast(cast("9.900" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_63_strict "${const_sql_63}"
    testFoldConst("${const_sql_63}")
    def const_sql_64 = """select cast(cast("9.901" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_64_strict "${const_sql_64}"
    testFoldConst("${const_sql_64}")
    def const_sql_65 = """select cast(cast("9.998" as decimalv3(4,3)) as decimalv3(8,7));"""
    qt_sql_65_strict "${const_sql_65}"
    testFoldConst("${const_sql_65}")
    def const_sql_66 = """select cast(cast("9.999" as decimalv3(4,3)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_66}")
    sql "set enable_strict_cast=true;"
    def const_sql_67 = """select cast(cast("0.0000" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_67_strict "${const_sql_67}"
    testFoldConst("${const_sql_67}")
    def const_sql_68 = """select cast(cast("0.0001" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_68_strict "${const_sql_68}"
    testFoldConst("${const_sql_68}")
    def const_sql_69 = """select cast(cast("0.0009" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_69_strict "${const_sql_69}"
    testFoldConst("${const_sql_69}")
    def const_sql_70 = """select cast(cast("0.0999" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_70_strict "${const_sql_70}"
    testFoldConst("${const_sql_70}")
    def const_sql_71 = """select cast(cast("0.9000" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_71_strict "${const_sql_71}"
    testFoldConst("${const_sql_71}")
    def const_sql_72 = """select cast(cast("0.9001" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_72_strict "${const_sql_72}"
    testFoldConst("${const_sql_72}")
    def const_sql_73 = """select cast(cast("0.9998" as decimalv3(4,4)) as decimalv3(8,7));"""
    qt_sql_73_strict "${const_sql_73}"
    testFoldConst("${const_sql_73}")
    def const_sql_74 = """select cast(cast("0.9999" as decimalv3(4,4)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_74}")
    sql "set enable_strict_cast=true;"
    def const_sql_75 = """select cast(cast("0" as decimalv3(8,0)) as decimalv3(8,7));"""
    qt_sql_75_strict "${const_sql_75}"
    testFoldConst("${const_sql_75}")
    def const_sql_76 = """select cast(cast("8" as decimalv3(8,0)) as decimalv3(8,7));"""
    qt_sql_76_strict "${const_sql_76}"
    testFoldConst("${const_sql_76}")
    def const_sql_77 = """select cast(cast("9" as decimalv3(8,0)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_77}")
    sql "set enable_strict_cast=true;"
    def const_sql_78 = """select cast(cast("0.0" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_78_strict "${const_sql_78}"
    testFoldConst("${const_sql_78}")
    def const_sql_79 = """select cast(cast("0.1" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_79_strict "${const_sql_79}"
    testFoldConst("${const_sql_79}")
    def const_sql_80 = """select cast(cast("0.8" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_80_strict "${const_sql_80}"
    testFoldConst("${const_sql_80}")
    def const_sql_81 = """select cast(cast("0.9" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_81_strict "${const_sql_81}"
    testFoldConst("${const_sql_81}")
    def const_sql_82 = """select cast(cast("8.0" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_82_strict "${const_sql_82}"
    testFoldConst("${const_sql_82}")
    def const_sql_83 = """select cast(cast("8.1" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_83_strict "${const_sql_83}"
    testFoldConst("${const_sql_83}")
    def const_sql_84 = """select cast(cast("8.8" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_84_strict "${const_sql_84}"
    testFoldConst("${const_sql_84}")
    def const_sql_85 = """select cast(cast("8.9" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_85_strict "${const_sql_85}"
    testFoldConst("${const_sql_85}")
    def const_sql_86 = """select cast(cast("9.0" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_86_strict "${const_sql_86}"
    testFoldConst("${const_sql_86}")
    def const_sql_87 = """select cast(cast("9.1" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_87_strict "${const_sql_87}"
    testFoldConst("${const_sql_87}")
    def const_sql_88 = """select cast(cast("9.8" as decimalv3(8,1)) as decimalv3(8,7));"""
    qt_sql_88_strict "${const_sql_88}"
    testFoldConst("${const_sql_88}")
    def const_sql_89 = """select cast(cast("9.9" as decimalv3(8,1)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_89}")
    sql "set enable_strict_cast=true;"
    def const_sql_90 = """select cast(cast("0.0000" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_90_strict "${const_sql_90}"
    testFoldConst("${const_sql_90}")
    def const_sql_91 = """select cast(cast("0.0001" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_91_strict "${const_sql_91}"
    testFoldConst("${const_sql_91}")
    def const_sql_92 = """select cast(cast("0.0009" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_92_strict "${const_sql_92}"
    testFoldConst("${const_sql_92}")
    def const_sql_93 = """select cast(cast("0.0999" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_93_strict "${const_sql_93}"
    testFoldConst("${const_sql_93}")
    def const_sql_94 = """select cast(cast("0.9000" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_94_strict "${const_sql_94}"
    testFoldConst("${const_sql_94}")
    def const_sql_95 = """select cast(cast("0.9001" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_95_strict "${const_sql_95}"
    testFoldConst("${const_sql_95}")
    def const_sql_96 = """select cast(cast("0.9998" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_96_strict "${const_sql_96}"
    testFoldConst("${const_sql_96}")
    def const_sql_97 = """select cast(cast("0.9999" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_97_strict "${const_sql_97}"
    testFoldConst("${const_sql_97}")
    def const_sql_98 = """select cast(cast("8.0000" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_98_strict "${const_sql_98}"
    testFoldConst("${const_sql_98}")
    def const_sql_99 = """select cast(cast("8.0001" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_99_strict "${const_sql_99}"
    testFoldConst("${const_sql_99}")
    def const_sql_100 = """select cast(cast("8.0009" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_100_strict "${const_sql_100}"
    testFoldConst("${const_sql_100}")
    def const_sql_101 = """select cast(cast("8.0999" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_101_strict "${const_sql_101}"
    testFoldConst("${const_sql_101}")
    def const_sql_102 = """select cast(cast("8.9000" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_102_strict "${const_sql_102}"
    testFoldConst("${const_sql_102}")
    def const_sql_103 = """select cast(cast("8.9001" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_103_strict "${const_sql_103}"
    testFoldConst("${const_sql_103}")
    def const_sql_104 = """select cast(cast("8.9998" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_104_strict "${const_sql_104}"
    testFoldConst("${const_sql_104}")
    def const_sql_105 = """select cast(cast("8.9999" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_105_strict "${const_sql_105}"
    testFoldConst("${const_sql_105}")
    def const_sql_106 = """select cast(cast("9.0000" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_106_strict "${const_sql_106}"
    testFoldConst("${const_sql_106}")
    def const_sql_107 = """select cast(cast("9.0001" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_107_strict "${const_sql_107}"
    testFoldConst("${const_sql_107}")
    def const_sql_108 = """select cast(cast("9.0009" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_108_strict "${const_sql_108}"
    testFoldConst("${const_sql_108}")
    def const_sql_109 = """select cast(cast("9.0999" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_109_strict "${const_sql_109}"
    testFoldConst("${const_sql_109}")
    def const_sql_110 = """select cast(cast("9.9000" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_110_strict "${const_sql_110}"
    testFoldConst("${const_sql_110}")
    def const_sql_111 = """select cast(cast("9.9001" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_111_strict "${const_sql_111}"
    testFoldConst("${const_sql_111}")
    def const_sql_112 = """select cast(cast("9.9998" as decimalv3(8,4)) as decimalv3(8,7));"""
    qt_sql_112_strict "${const_sql_112}"
    testFoldConst("${const_sql_112}")
    def const_sql_113 = """select cast(cast("9.9999" as decimalv3(8,4)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_113}")
    sql "set enable_strict_cast=true;"
    def const_sql_114 = """select cast(cast("0.0000000" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_114_strict "${const_sql_114}"
    testFoldConst("${const_sql_114}")
    def const_sql_115 = """select cast(cast("0.0000001" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_115_strict "${const_sql_115}"
    testFoldConst("${const_sql_115}")
    def const_sql_116 = """select cast(cast("0.0000009" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_116_strict "${const_sql_116}"
    testFoldConst("${const_sql_116}")
    def const_sql_117 = """select cast(cast("0.0999999" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_117_strict "${const_sql_117}"
    testFoldConst("${const_sql_117}")
    def const_sql_118 = """select cast(cast("0.9000000" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_118_strict "${const_sql_118}"
    testFoldConst("${const_sql_118}")
    def const_sql_119 = """select cast(cast("0.9000001" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_119_strict "${const_sql_119}"
    testFoldConst("${const_sql_119}")
    def const_sql_120 = """select cast(cast("0.9999998" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_120_strict "${const_sql_120}"
    testFoldConst("${const_sql_120}")
    def const_sql_121 = """select cast(cast("0.9999999" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_121_strict "${const_sql_121}"
    testFoldConst("${const_sql_121}")
    def const_sql_122 = """select cast(cast("8.0000000" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_122_strict "${const_sql_122}"
    testFoldConst("${const_sql_122}")
    def const_sql_123 = """select cast(cast("8.0000001" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_123_strict "${const_sql_123}"
    testFoldConst("${const_sql_123}")
    def const_sql_124 = """select cast(cast("8.0000009" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_124_strict "${const_sql_124}"
    testFoldConst("${const_sql_124}")
    def const_sql_125 = """select cast(cast("8.0999999" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_125_strict "${const_sql_125}"
    testFoldConst("${const_sql_125}")
    def const_sql_126 = """select cast(cast("8.9000000" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_126_strict "${const_sql_126}"
    testFoldConst("${const_sql_126}")
    def const_sql_127 = """select cast(cast("8.9000001" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_127_strict "${const_sql_127}"
    testFoldConst("${const_sql_127}")
    def const_sql_128 = """select cast(cast("8.9999998" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_128_strict "${const_sql_128}"
    testFoldConst("${const_sql_128}")
    def const_sql_129 = """select cast(cast("8.9999999" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_129_strict "${const_sql_129}"
    testFoldConst("${const_sql_129}")
    def const_sql_130 = """select cast(cast("9.0000000" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_130_strict "${const_sql_130}"
    testFoldConst("${const_sql_130}")
    def const_sql_131 = """select cast(cast("9.0000001" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_131_strict "${const_sql_131}"
    testFoldConst("${const_sql_131}")
    def const_sql_132 = """select cast(cast("9.0000009" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_132_strict "${const_sql_132}"
    testFoldConst("${const_sql_132}")
    def const_sql_133 = """select cast(cast("9.0999999" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_133_strict "${const_sql_133}"
    testFoldConst("${const_sql_133}")
    def const_sql_134 = """select cast(cast("9.9000000" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_134_strict "${const_sql_134}"
    testFoldConst("${const_sql_134}")
    def const_sql_135 = """select cast(cast("9.9000001" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_135_strict "${const_sql_135}"
    testFoldConst("${const_sql_135}")
    def const_sql_136 = """select cast(cast("9.9999998" as decimalv3(8,7)) as decimalv3(8,7));"""
    qt_sql_136_strict "${const_sql_136}"
    testFoldConst("${const_sql_136}")
    def const_sql_137 = """select cast(cast("9.9999999" as decimalv3(8,7)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_137}")
    sql "set enable_strict_cast=true;"
    def const_sql_138 = """select cast(cast("0.00000000" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_138_strict "${const_sql_138}"
    testFoldConst("${const_sql_138}")
    def const_sql_139 = """select cast(cast("0.00000001" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_139_strict "${const_sql_139}"
    testFoldConst("${const_sql_139}")
    def const_sql_140 = """select cast(cast("0.00000009" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_140_strict "${const_sql_140}"
    testFoldConst("${const_sql_140}")
    def const_sql_141 = """select cast(cast("0.09999999" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_141_strict "${const_sql_141}"
    testFoldConst("${const_sql_141}")
    def const_sql_142 = """select cast(cast("0.90000000" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_142_strict "${const_sql_142}"
    testFoldConst("${const_sql_142}")
    def const_sql_143 = """select cast(cast("0.90000001" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_143_strict "${const_sql_143}"
    testFoldConst("${const_sql_143}")
    def const_sql_144 = """select cast(cast("0.99999998" as decimalv3(8,8)) as decimalv3(8,7));"""
    qt_sql_144_strict "${const_sql_144}"
    testFoldConst("${const_sql_144}")
    def const_sql_145 = """select cast(cast("0.99999999" as decimalv3(8,8)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_145}")
    sql "set enable_strict_cast=true;"
    def const_sql_146 = """select cast(cast("0" as decimalv3(9,0)) as decimalv3(8,7));"""
    qt_sql_146_strict "${const_sql_146}"
    testFoldConst("${const_sql_146}")
    def const_sql_147 = """select cast(cast("8" as decimalv3(9,0)) as decimalv3(8,7));"""
    qt_sql_147_strict "${const_sql_147}"
    testFoldConst("${const_sql_147}")
    def const_sql_148 = """select cast(cast("9" as decimalv3(9,0)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_148}")
    sql "set enable_strict_cast=true;"
    def const_sql_149 = """select cast(cast("0.0" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_149_strict "${const_sql_149}"
    testFoldConst("${const_sql_149}")
    def const_sql_150 = """select cast(cast("0.1" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_150_strict "${const_sql_150}"
    testFoldConst("${const_sql_150}")
    def const_sql_151 = """select cast(cast("0.8" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_151_strict "${const_sql_151}"
    testFoldConst("${const_sql_151}")
    def const_sql_152 = """select cast(cast("0.9" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_152_strict "${const_sql_152}"
    testFoldConst("${const_sql_152}")
    def const_sql_153 = """select cast(cast("8.0" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_153_strict "${const_sql_153}"
    testFoldConst("${const_sql_153}")
    def const_sql_154 = """select cast(cast("8.1" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_154_strict "${const_sql_154}"
    testFoldConst("${const_sql_154}")
    def const_sql_155 = """select cast(cast("8.8" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_155_strict "${const_sql_155}"
    testFoldConst("${const_sql_155}")
    def const_sql_156 = """select cast(cast("8.9" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_156_strict "${const_sql_156}"
    testFoldConst("${const_sql_156}")
    def const_sql_157 = """select cast(cast("9.0" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_157_strict "${const_sql_157}"
    testFoldConst("${const_sql_157}")
    def const_sql_158 = """select cast(cast("9.1" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_158_strict "${const_sql_158}"
    testFoldConst("${const_sql_158}")
    def const_sql_159 = """select cast(cast("9.8" as decimalv3(9,1)) as decimalv3(8,7));"""
    qt_sql_159_strict "${const_sql_159}"
    testFoldConst("${const_sql_159}")
    def const_sql_160 = """select cast(cast("9.9" as decimalv3(9,1)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_160}")
    sql "set enable_strict_cast=true;"
    def const_sql_161 = """select cast(cast("0.0000" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_161_strict "${const_sql_161}"
    testFoldConst("${const_sql_161}")
    def const_sql_162 = """select cast(cast("0.0001" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_162_strict "${const_sql_162}"
    testFoldConst("${const_sql_162}")
    def const_sql_163 = """select cast(cast("0.0009" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_163_strict "${const_sql_163}"
    testFoldConst("${const_sql_163}")
    def const_sql_164 = """select cast(cast("0.0999" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_164_strict "${const_sql_164}"
    testFoldConst("${const_sql_164}")
    def const_sql_165 = """select cast(cast("0.9000" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_165_strict "${const_sql_165}"
    testFoldConst("${const_sql_165}")
    def const_sql_166 = """select cast(cast("0.9001" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_166_strict "${const_sql_166}"
    testFoldConst("${const_sql_166}")
    def const_sql_167 = """select cast(cast("0.9998" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_167_strict "${const_sql_167}"
    testFoldConst("${const_sql_167}")
    def const_sql_168 = """select cast(cast("0.9999" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_168_strict "${const_sql_168}"
    testFoldConst("${const_sql_168}")
    def const_sql_169 = """select cast(cast("8.0000" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_169_strict "${const_sql_169}"
    testFoldConst("${const_sql_169}")
    def const_sql_170 = """select cast(cast("8.0001" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_170_strict "${const_sql_170}"
    testFoldConst("${const_sql_170}")
    def const_sql_171 = """select cast(cast("8.0009" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_171_strict "${const_sql_171}"
    testFoldConst("${const_sql_171}")
    def const_sql_172 = """select cast(cast("8.0999" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_172_strict "${const_sql_172}"
    testFoldConst("${const_sql_172}")
    def const_sql_173 = """select cast(cast("8.9000" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_173_strict "${const_sql_173}"
    testFoldConst("${const_sql_173}")
    def const_sql_174 = """select cast(cast("8.9001" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_174_strict "${const_sql_174}"
    testFoldConst("${const_sql_174}")
    def const_sql_175 = """select cast(cast("8.9998" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_175_strict "${const_sql_175}"
    testFoldConst("${const_sql_175}")
    def const_sql_176 = """select cast(cast("8.9999" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_176_strict "${const_sql_176}"
    testFoldConst("${const_sql_176}")
    def const_sql_177 = """select cast(cast("9.0000" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_177_strict "${const_sql_177}"
    testFoldConst("${const_sql_177}")
    def const_sql_178 = """select cast(cast("9.0001" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_178_strict "${const_sql_178}"
    testFoldConst("${const_sql_178}")
    def const_sql_179 = """select cast(cast("9.0009" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_179_strict "${const_sql_179}"
    testFoldConst("${const_sql_179}")
    def const_sql_180 = """select cast(cast("9.0999" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_180_strict "${const_sql_180}"
    testFoldConst("${const_sql_180}")
    def const_sql_181 = """select cast(cast("9.9000" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_181_strict "${const_sql_181}"
    testFoldConst("${const_sql_181}")
    def const_sql_182 = """select cast(cast("9.9001" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_182_strict "${const_sql_182}"
    testFoldConst("${const_sql_182}")
    def const_sql_183 = """select cast(cast("9.9998" as decimalv3(9,4)) as decimalv3(8,7));"""
    qt_sql_183_strict "${const_sql_183}"
    testFoldConst("${const_sql_183}")
    def const_sql_184 = """select cast(cast("9.9999" as decimalv3(9,4)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_184}")
    sql "set enable_strict_cast=true;"
    def const_sql_185 = """select cast(cast("0.00000000" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_185_strict "${const_sql_185}"
    testFoldConst("${const_sql_185}")
    def const_sql_186 = """select cast(cast("0.00000001" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_186_strict "${const_sql_186}"
    testFoldConst("${const_sql_186}")
    def const_sql_187 = """select cast(cast("0.00000009" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_187_strict "${const_sql_187}"
    testFoldConst("${const_sql_187}")
    def const_sql_188 = """select cast(cast("0.09999999" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_188_strict "${const_sql_188}"
    testFoldConst("${const_sql_188}")
    def const_sql_189 = """select cast(cast("0.90000000" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_189_strict "${const_sql_189}"
    testFoldConst("${const_sql_189}")
    def const_sql_190 = """select cast(cast("0.90000001" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_190_strict "${const_sql_190}"
    testFoldConst("${const_sql_190}")
    def const_sql_191 = """select cast(cast("0.99999998" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_191_strict "${const_sql_191}"
    testFoldConst("${const_sql_191}")
    def const_sql_192 = """select cast(cast("0.99999999" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_192_strict "${const_sql_192}"
    testFoldConst("${const_sql_192}")
    def const_sql_193 = """select cast(cast("8.00000000" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_193_strict "${const_sql_193}"
    testFoldConst("${const_sql_193}")
    def const_sql_194 = """select cast(cast("8.00000001" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_194_strict "${const_sql_194}"
    testFoldConst("${const_sql_194}")
    def const_sql_195 = """select cast(cast("8.00000009" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_195_strict "${const_sql_195}"
    testFoldConst("${const_sql_195}")
    def const_sql_196 = """select cast(cast("8.09999999" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_196_strict "${const_sql_196}"
    testFoldConst("${const_sql_196}")
    def const_sql_197 = """select cast(cast("8.90000000" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_197_strict "${const_sql_197}"
    testFoldConst("${const_sql_197}")
    def const_sql_198 = """select cast(cast("8.90000001" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_198_strict "${const_sql_198}"
    testFoldConst("${const_sql_198}")
    def const_sql_199 = """select cast(cast("8.99999998" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_199_strict "${const_sql_199}"
    testFoldConst("${const_sql_199}")
    def const_sql_200 = """select cast(cast("8.99999999" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_200_strict "${const_sql_200}"
    testFoldConst("${const_sql_200}")
    def const_sql_201 = """select cast(cast("9.00000000" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_201_strict "${const_sql_201}"
    testFoldConst("${const_sql_201}")
    def const_sql_202 = """select cast(cast("9.00000001" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_202_strict "${const_sql_202}"
    testFoldConst("${const_sql_202}")
    def const_sql_203 = """select cast(cast("9.00000009" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_203_strict "${const_sql_203}"
    testFoldConst("${const_sql_203}")
    def const_sql_204 = """select cast(cast("9.09999999" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_204_strict "${const_sql_204}"
    testFoldConst("${const_sql_204}")
    def const_sql_205 = """select cast(cast("9.90000000" as decimalv3(9,8)) as decimalv3(8,7));"""
    qt_sql_205_strict "${const_sql_205}"
    testFoldConst("${const_sql_205}")
    def const_sql_206 = """select cast(cast("9.90000001" as decimalv3(9,8)) as decimalv3(8,7));"""
    ...
    testFoldConst("${const_sql_206}")
    sql "set enable_strict_cast=true;"
    def const_sql_207 = """select cast(cast("0.000000000" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_207_strict "${const_sql_207}"
    testFoldConst("${const_sql_207}")
    def const_sql_208 = """select cast(cast("0.000000001" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_208_strict "${const_sql_208}"
    testFoldConst("${const_sql_208}")
    def const_sql_209 = """select cast(cast("0.000000009" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_209_strict "${const_sql_209}"
    testFoldConst("${const_sql_209}")
    def const_sql_210 = """select cast(cast("0.099999999" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_210_strict "${const_sql_210}"
    testFoldConst("${const_sql_210}")
    def const_sql_211 = """select cast(cast("0.900000000" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_211_strict "${const_sql_211}"
    testFoldConst("${const_sql_211}")
    def const_sql_212 = """select cast(cast("0.900000001" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_212_strict "${const_sql_212}"
    testFoldConst("${const_sql_212}")
    def const_sql_213 = """select cast(cast("0.999999998" as decimalv3(9,9)) as decimalv3(8,7));"""
    qt_sql_213_strict "${const_sql_213}"
    testFoldConst("${const_sql_213}")
    def const_sql_214 = """select cast(cast("0.999999999" as decimalv3(9,9)) as decimalv3(8,7));"""
