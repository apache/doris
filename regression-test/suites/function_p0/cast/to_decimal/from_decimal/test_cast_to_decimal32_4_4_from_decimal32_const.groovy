...
suite("test_cast_to_decimal32_4_4_from_decimal32_const") {
    ...
    def const_sql_0 = """select cast(cast("0" as decimalv3(1,0)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_0}")
    sql "set enable_strict_cast=true;"
    def const_sql_1 = """select cast(cast("0.0" as decimalv3(1,1)) as decimalv3(4,4));"""
    qt_sql_1_strict "${const_sql_1}"
    testFoldConst("${const_sql_1}")
    def const_sql_2 = """select cast(cast("0.1" as decimalv3(1,1)) as decimalv3(4,4));"""
    qt_sql_2_strict "${const_sql_2}"
    testFoldConst("${const_sql_2}")
    def const_sql_3 = """select cast(cast("0.8" as decimalv3(1,1)) as decimalv3(4,4));"""
    qt_sql_3_strict "${const_sql_3}"
    testFoldConst("${const_sql_3}")
    def const_sql_4 = """select cast(cast("0.9" as decimalv3(1,1)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_4}")
    sql "set enable_strict_cast=true;"
    def const_sql_5 = """select cast(cast("0" as decimalv3(4,0)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_5}")
    sql "set enable_strict_cast=true;"
    def const_sql_6 = """select cast(cast("0.0" as decimalv3(4,1)) as decimalv3(4,4));"""
    qt_sql_6_strict "${const_sql_6}"
    testFoldConst("${const_sql_6}")
    def const_sql_7 = """select cast(cast("0.1" as decimalv3(4,1)) as decimalv3(4,4));"""
    qt_sql_7_strict "${const_sql_7}"
    testFoldConst("${const_sql_7}")
    def const_sql_8 = """select cast(cast("0.8" as decimalv3(4,1)) as decimalv3(4,4));"""
    qt_sql_8_strict "${const_sql_8}"
    testFoldConst("${const_sql_8}")
    def const_sql_9 = """select cast(cast("0.9" as decimalv3(4,1)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_9}")
    sql "set enable_strict_cast=true;"
    def const_sql_10 = """select cast(cast("0.00" as decimalv3(4,2)) as decimalv3(4,4));"""
    qt_sql_10_strict "${const_sql_10}"
    testFoldConst("${const_sql_10}")
    def const_sql_11 = """select cast(cast("0.01" as decimalv3(4,2)) as decimalv3(4,4));"""
    qt_sql_11_strict "${const_sql_11}"
    testFoldConst("${const_sql_11}")
    def const_sql_12 = """select cast(cast("0.09" as decimalv3(4,2)) as decimalv3(4,4));"""
    qt_sql_12_strict "${const_sql_12}"
    testFoldConst("${const_sql_12}")
    def const_sql_13 = """select cast(cast("0.90" as decimalv3(4,2)) as decimalv3(4,4));"""
    qt_sql_13_strict "${const_sql_13}"
    testFoldConst("${const_sql_13}")
    def const_sql_14 = """select cast(cast("0.91" as decimalv3(4,2)) as decimalv3(4,4));"""
    qt_sql_14_strict "${const_sql_14}"
    testFoldConst("${const_sql_14}")
    def const_sql_15 = """select cast(cast("0.98" as decimalv3(4,2)) as decimalv3(4,4));"""
    qt_sql_15_strict "${const_sql_15}"
    testFoldConst("${const_sql_15}")
    def const_sql_16 = """select cast(cast("0.99" as decimalv3(4,2)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_16}")
    sql "set enable_strict_cast=true;"
    def const_sql_17 = """select cast(cast("0.000" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_17_strict "${const_sql_17}"
    testFoldConst("${const_sql_17}")
    def const_sql_18 = """select cast(cast("0.001" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_18_strict "${const_sql_18}"
    testFoldConst("${const_sql_18}")
    def const_sql_19 = """select cast(cast("0.009" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_19_strict "${const_sql_19}"
    testFoldConst("${const_sql_19}")
    def const_sql_20 = """select cast(cast("0.099" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_20_strict "${const_sql_20}"
    testFoldConst("${const_sql_20}")
    def const_sql_21 = """select cast(cast("0.900" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_21_strict "${const_sql_21}"
    testFoldConst("${const_sql_21}")
    def const_sql_22 = """select cast(cast("0.901" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_22_strict "${const_sql_22}"
    testFoldConst("${const_sql_22}")
    def const_sql_23 = """select cast(cast("0.998" as decimalv3(4,3)) as decimalv3(4,4));"""
    qt_sql_23_strict "${const_sql_23}"
    testFoldConst("${const_sql_23}")
    def const_sql_24 = """select cast(cast("0.999" as decimalv3(4,3)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_24}")
    sql "set enable_strict_cast=true;"
    def const_sql_25 = """select cast(cast("0.0000" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_25_strict "${const_sql_25}"
    testFoldConst("${const_sql_25}")
    def const_sql_26 = """select cast(cast("0.0001" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_26_strict "${const_sql_26}"
    testFoldConst("${const_sql_26}")
    def const_sql_27 = """select cast(cast("0.0009" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_27_strict "${const_sql_27}"
    testFoldConst("${const_sql_27}")
    def const_sql_28 = """select cast(cast("0.0999" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_28_strict "${const_sql_28}"
    testFoldConst("${const_sql_28}")
    def const_sql_29 = """select cast(cast("0.9000" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_29_strict "${const_sql_29}"
    testFoldConst("${const_sql_29}")
    def const_sql_30 = """select cast(cast("0.9001" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_30_strict "${const_sql_30}"
    testFoldConst("${const_sql_30}")
    def const_sql_31 = """select cast(cast("0.9998" as decimalv3(4,4)) as decimalv3(4,4));"""
    qt_sql_31_strict "${const_sql_31}"
    testFoldConst("${const_sql_31}")
    def const_sql_32 = """select cast(cast("0.9999" as decimalv3(4,4)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_32}")
    sql "set enable_strict_cast=true;"
    def const_sql_33 = """select cast(cast("0" as decimalv3(8,0)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_33}")
    sql "set enable_strict_cast=true;"
    def const_sql_34 = """select cast(cast("0.0" as decimalv3(8,1)) as decimalv3(4,4));"""
    qt_sql_34_strict "${const_sql_34}"
    testFoldConst("${const_sql_34}")
    def const_sql_35 = """select cast(cast("0.1" as decimalv3(8,1)) as decimalv3(4,4));"""
    qt_sql_35_strict "${const_sql_35}"
    testFoldConst("${const_sql_35}")
    def const_sql_36 = """select cast(cast("0.8" as decimalv3(8,1)) as decimalv3(4,4));"""
    qt_sql_36_strict "${const_sql_36}"
    testFoldConst("${const_sql_36}")
    def const_sql_37 = """select cast(cast("0.9" as decimalv3(8,1)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_37}")
    sql "set enable_strict_cast=true;"
    def const_sql_38 = """select cast(cast("0.0000" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_38_strict "${const_sql_38}"
    testFoldConst("${const_sql_38}")
    def const_sql_39 = """select cast(cast("0.0001" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_39_strict "${const_sql_39}"
    testFoldConst("${const_sql_39}")
    def const_sql_40 = """select cast(cast("0.0009" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_40_strict "${const_sql_40}"
    testFoldConst("${const_sql_40}")
    def const_sql_41 = """select cast(cast("0.0999" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_41_strict "${const_sql_41}"
    testFoldConst("${const_sql_41}")
    def const_sql_42 = """select cast(cast("0.9000" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_42_strict "${const_sql_42}"
    testFoldConst("${const_sql_42}")
    def const_sql_43 = """select cast(cast("0.9001" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_43_strict "${const_sql_43}"
    testFoldConst("${const_sql_43}")
    def const_sql_44 = """select cast(cast("0.9998" as decimalv3(8,4)) as decimalv3(4,4));"""
    qt_sql_44_strict "${const_sql_44}"
    testFoldConst("${const_sql_44}")
    def const_sql_45 = """select cast(cast("0.9999" as decimalv3(8,4)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_45}")
    sql "set enable_strict_cast=true;"
    def const_sql_46 = """select cast(cast("0.0000000" as decimalv3(8,7)) as decimalv3(4,4));"""
    qt_sql_46_strict "${const_sql_46}"
    testFoldConst("${const_sql_46}")
    def const_sql_47 = """select cast(cast("0.0000001" as decimalv3(8,7)) as decimalv3(4,4));"""
    qt_sql_47_strict "${const_sql_47}"
    testFoldConst("${const_sql_47}")
    def const_sql_48 = """select cast(cast("0.0000009" as decimalv3(8,7)) as decimalv3(4,4));"""
    qt_sql_48_strict "${const_sql_48}"
    testFoldConst("${const_sql_48}")
    def const_sql_49 = """select cast(cast("0.0999999" as decimalv3(8,7)) as decimalv3(4,4));"""
    qt_sql_49_strict "${const_sql_49}"
    testFoldConst("${const_sql_49}")
    def const_sql_50 = """select cast(cast("0.9000000" as decimalv3(8,7)) as decimalv3(4,4));"""
    qt_sql_50_strict "${const_sql_50}"
    testFoldConst("${const_sql_50}")
    def const_sql_51 = """select cast(cast("0.9000001" as decimalv3(8,7)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_51}")
    sql "set enable_strict_cast=true;"
    def const_sql_52 = """select cast(cast("0.00000000" as decimalv3(8,8)) as decimalv3(4,4));"""
    qt_sql_52_strict "${const_sql_52}"
    testFoldConst("${const_sql_52}")
    def const_sql_53 = """select cast(cast("0.00000001" as decimalv3(8,8)) as decimalv3(4,4));"""
    qt_sql_53_strict "${const_sql_53}"
    testFoldConst("${const_sql_53}")
    def const_sql_54 = """select cast(cast("0.00000009" as decimalv3(8,8)) as decimalv3(4,4));"""
    qt_sql_54_strict "${const_sql_54}"
    testFoldConst("${const_sql_54}")
    def const_sql_55 = """select cast(cast("0.09999999" as decimalv3(8,8)) as decimalv3(4,4));"""
    qt_sql_55_strict "${const_sql_55}"
    testFoldConst("${const_sql_55}")
    def const_sql_56 = """select cast(cast("0.90000000" as decimalv3(8,8)) as decimalv3(4,4));"""
    qt_sql_56_strict "${const_sql_56}"
    testFoldConst("${const_sql_56}")
    def const_sql_57 = """select cast(cast("0.90000001" as decimalv3(8,8)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_57}")
    sql "set enable_strict_cast=true;"
    def const_sql_58 = """select cast(cast("0" as decimalv3(9,0)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_58}")
    sql "set enable_strict_cast=true;"
    def const_sql_59 = """select cast(cast("0.0" as decimalv3(9,1)) as decimalv3(4,4));"""
    qt_sql_59_strict "${const_sql_59}"
    testFoldConst("${const_sql_59}")
    def const_sql_60 = """select cast(cast("0.1" as decimalv3(9,1)) as decimalv3(4,4));"""
    qt_sql_60_strict "${const_sql_60}"
    testFoldConst("${const_sql_60}")
    def const_sql_61 = """select cast(cast("0.8" as decimalv3(9,1)) as decimalv3(4,4));"""
    qt_sql_61_strict "${const_sql_61}"
    testFoldConst("${const_sql_61}")
    def const_sql_62 = """select cast(cast("0.9" as decimalv3(9,1)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_62}")
    sql "set enable_strict_cast=true;"
    def const_sql_63 = """select cast(cast("0.0000" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_63_strict "${const_sql_63}"
    testFoldConst("${const_sql_63}")
    def const_sql_64 = """select cast(cast("0.0001" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_64_strict "${const_sql_64}"
    testFoldConst("${const_sql_64}")
    def const_sql_65 = """select cast(cast("0.0009" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_65_strict "${const_sql_65}"
    testFoldConst("${const_sql_65}")
    def const_sql_66 = """select cast(cast("0.0999" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_66_strict "${const_sql_66}"
    testFoldConst("${const_sql_66}")
    def const_sql_67 = """select cast(cast("0.9000" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_67_strict "${const_sql_67}"
    testFoldConst("${const_sql_67}")
    def const_sql_68 = """select cast(cast("0.9001" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_68_strict "${const_sql_68}"
    testFoldConst("${const_sql_68}")
    def const_sql_69 = """select cast(cast("0.9998" as decimalv3(9,4)) as decimalv3(4,4));"""
    qt_sql_69_strict "${const_sql_69}"
    testFoldConst("${const_sql_69}")
    def const_sql_70 = """select cast(cast("0.9999" as decimalv3(9,4)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_70}")
    sql "set enable_strict_cast=true;"
    def const_sql_71 = """select cast(cast("0.00000000" as decimalv3(9,8)) as decimalv3(4,4));"""
    qt_sql_71_strict "${const_sql_71}"
    testFoldConst("${const_sql_71}")
    def const_sql_72 = """select cast(cast("0.00000001" as decimalv3(9,8)) as decimalv3(4,4));"""
    qt_sql_72_strict "${const_sql_72}"
    testFoldConst("${const_sql_72}")
    def const_sql_73 = """select cast(cast("0.00000009" as decimalv3(9,8)) as decimalv3(4,4));"""
    qt_sql_73_strict "${const_sql_73}"
    testFoldConst("${const_sql_73}")
    def const_sql_74 = """select cast(cast("0.09999999" as decimalv3(9,8)) as decimalv3(4,4));"""
    qt_sql_74_strict "${const_sql_74}"
    testFoldConst("${const_sql_74}")
    def const_sql_75 = """select cast(cast("0.90000000" as decimalv3(9,8)) as decimalv3(4,4));"""
    qt_sql_75_strict "${const_sql_75}"
    testFoldConst("${const_sql_75}")
    def const_sql_76 = """select cast(cast("0.90000001" as decimalv3(9,8)) as decimalv3(4,4));"""
    ...
    testFoldConst("${const_sql_76}")
    sql "set enable_strict_cast=true;"
    def const_sql_77 = """select cast(cast("0.000000000" as decimalv3(9,9)) as decimalv3(4,4));"""
    qt_sql_77_strict "${const_sql_77}"
    testFoldConst("${const_sql_77}")
    def const_sql_78 = """select cast(cast("0.000000001" as decimalv3(9,9)) as decimalv3(4,4));"""
    qt_sql_78_strict "${const_sql_78}"
    testFoldConst("${const_sql_78}")
    def const_sql_79 = """select cast(cast("0.000000009" as decimalv3(9,9)) as decimalv3(4,4));"""
    qt_sql_79_strict "${const_sql_79}"
    testFoldConst("${const_sql_79}")
    def const_sql_80 = """select cast(cast("0.099999999" as decimalv3(9,9)) as decimalv3(4,4));"""
    qt_sql_80_strict "${const_sql_80}"
    testFoldConst("${const_sql_80}")
    def const_sql_81 = """select cast(cast("0.900000000" as decimalv3(9,9)) as decimalv3(4,4));"""
    qt_sql_81_strict "${const_sql_81}"
    testFoldConst("${const_sql_81}")
    def const_sql_82 = """select cast(cast("0.900000001" as decimalv3(9,9)) as decimalv3(4,4));"""
