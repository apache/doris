...
suite("test_cast_to_decimal64_17_0_from_decimal128i") {
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_19_0 values (0, "0"),(1, "9999999999999999"),(2, "90000000000000000"),(3, "90000000000000001"),(4, "99999999999999998"),(5, "99999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_0_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_0 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_19_1 values (6, "0.0"),(7, "0.1"),(8, "0.8"),(9, "0.9"),(10, "9999999999999999.0"),(11, "9999999999999999.1"),(12, "9999999999999999.8"),(13, "9999999999999999.9"),(14, "90000000000000000.0"),(15, "90000000000000000.1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_1_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_1 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_1_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_1 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_19_9;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_19_9(f1 int, f2 decimalv3(19, 9)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_19_9 values (28, "0.000000000"),(29, "0.000000001"),(30, "0.000000009"),(31, "0.099999999"),(32, "0.900000000"),(33, "0.900000001"),(34, "0.999999998"),(35, "0.999999999"),(36, "999999999.000000000"),(37, "999999999.000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_2_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_9 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_2_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_9 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_19_18;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_19_18(f1 int, f2 decimalv3(19, 18)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_19_18 values (76, "0.000000000000000000"),(77, "0.000000000000000001"),(78, "0.000000000000000009"),(79, "0.099999999999999999"),(80, "0.900000000000000000"),(81, "0.900000000000000001"),(82, "0.999999999999999998"),(83, "0.999999999999999999"),(84, "8.000000000000000000"),(85, "8.000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_3_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_18 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_3_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_18 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_19_19;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_19_19(f1 int, f2 decimalv3(19, 19)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_19_19 values (100, "0.0000000000000000000"),(101, "0.0000000000000000001"),(102, "0.0000000000000000009"),(103, "0.0999999999999999999"),(104, "0.9000000000000000000"),(105, "0.9000000000000000001"),(106, "0.9999999999999999998"),(107, "0.9999999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_4_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_19 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_4_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_19_19 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_37_0 values (108, "0"),(109, "9999999999999999"),(110, "90000000000000000"),(111, "90000000000000001"),(112, "99999999999999998"),(113, "99999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_5_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_5_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_0 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_37_1 values (114, "0.0"),(115, "0.1"),(116, "0.8"),(117, "0.9"),(118, "9999999999999999.0"),(119, "9999999999999999.1"),(120, "9999999999999999.8"),(121, "9999999999999999.9"),(122, "90000000000000000.0"),(123, "90000000000000000.1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_6_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_1 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_6_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_1 order by 1;'
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_7_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_18 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_7_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_18 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_37_36;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_37_36(f1 int, f2 decimalv3(37, 36)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_37_36 values (180, "0.000000000000000000000000000000000000"),(181, "0.000000000000000000000000000000000001"),(182, "0.000000000000000000000000000000000009"),(183, "0.099999999999999999999999999999999999"),(184, "0.900000000000000000000000000000000000"),(185, "0.900000000000000000000000000000000001"),(186, "0.999999999999999999999999999999999998"),(187, "0.999999999999999999999999999999999999"),(188, "8.000000000000000000000000000000000000"),(189, "8.000000000000000000000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_8_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_36 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_8_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_36 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_37_37;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_37_37(f1 int, f2 decimalv3(37, 37)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_37_37 values (204, "0.0000000000000000000000000000000000000"),(205, "0.0000000000000000000000000000000000001"),(206, "0.0000000000000000000000000000000000009"),(207, "0.0999999999999999999999999999999999999"),(208, "0.9000000000000000000000000000000000000"),(209, "0.9000000000000000000000000000000000001"),(210, "0.9999999999999999999999999999999999998"),(211, "0.9999999999999999999999999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_9_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_37 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_9_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_37_37 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_38_0 values (212, "0"),(213, "9999999999999999"),(214, "90000000000000000"),(215, "90000000000000001"),(216, "99999999999999998"),(217, "99999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_10_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_10_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_0 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_38_1 values (218, "0.0"),(219, "0.1"),(220, "0.8"),(221, "0.9"),(222, "9999999999999999.0"),(223, "9999999999999999.1"),(224, "9999999999999999.8"),(225, "9999999999999999.9"),(226, "90000000000000000.0"),(227, "90000000000000000.1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_11_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_1 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_11_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_1 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_38_19 values (240, "0.0000000000000000000"),(241, "0.0000000000000000001"),(242, "0.0000000000000000009"),(243, "0.0999999999999999999"),(244, "0.9000000000000000000"),(245, "0.9000000000000000001"),(246, "0.9999999999999999998"),(247, "0.9999999999999999999"),(248, "9999999999999999.0000000000000000000"),(249, "9999999999999999.0000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_12_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_19 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_12_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_19 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_38_37;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_38_37(f1 int, f2 decimalv3(38, 37)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_38_37 values (284, "0.0000000000000000000000000000000000000"),(285, "0.0000000000000000000000000000000000001"),(286, "0.0000000000000000000000000000000000009"),(287, "0.0999999999999999999999999999999999999"),(288, "0.9000000000000000000000000000000000000"),(289, "0.9000000000000000000000000000000000001"),(290, "0.9999999999999999999999999999999999998"),(291, "0.9999999999999999999999999999999999999"),(292, "8.0000000000000000000000000000000000000"),(293, "8.0000000000000000000000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_13_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_37 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_13_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_37 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_17_0_from_decimal128i_38_38;"
    sql "create table test_cast_to_decimal64_17_0_from_decimal128i_38_38(f1 int, f2 decimalv3(38, 38)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_17_0_from_decimal128i_38_38 values (308, "0.00000000000000000000000000000000000000"),(309, "0.00000000000000000000000000000000000001"),(310, "0.00000000000000000000000000000000000009"),(311, "0.09999999999999999999999999999999999999"),(312, "0.90000000000000000000000000000000000000"),(313, "0.90000000000000000000000000000000000001"),(314, "0.99999999999999999999999999999999999998"),(315, "0.99999999999999999999999999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_14_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_38 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_14_non_strict 'select f1, cast(f2 as decimalv3(17, 0)) from test_cast_to_decimal64_17_0_from_decimal128i_38_38 order by 1;'
