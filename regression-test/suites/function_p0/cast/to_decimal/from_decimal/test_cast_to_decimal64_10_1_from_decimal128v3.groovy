...
suite("test_cast_to_decimal64_10_1_from_decimal128v3") {
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_19_0 values (0, "0"),(1, "99999999"),(2, "900000000"),(3, "900000001"),(4, "999999998"),(5, "999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_0_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_0 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_19_1 values (6, "0.0"),(7, "0.1"),(8, "0.8"),(9, "0.9"),(10, "99999999.0"),(11, "99999999.1"),(12, "99999999.8"),(13, "99999999.9"),(14, "900000000.0"),(15, "900000000.1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_1_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_1 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_1_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_1 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_19_9 values (30, "0.000000000"),(31, "0.000000001"),(32, "0.000000009"),(33, "0.099999999"),(34, "0.900000000"),(35, "0.900000001"),(36, "0.999999998"),(37, "0.999999999"),(38, "99999999.000000000"),(39, "99999999.000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_2_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_9 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_2_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_9 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_10_1_from_decimal128v3_19_18;"
    sql "create table test_cast_to_decimal64_10_1_from_decimal128v3_19_18(f1 int, f2 decimalv3(19, 18)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_19_18 values (76, "0.000000000000000000"),(77, "0.000000000000000001"),(78, "0.000000000000000009"),(79, "0.099999999999999999"),(80, "0.900000000000000000"),(81, "0.900000000000000001"),(82, "0.999999999999999998"),(83, "0.999999999999999999"),(84, "8.000000000000000000"),(85, "8.000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_3_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_18 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_3_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_18 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_10_1_from_decimal128v3_19_19;"
    sql "create table test_cast_to_decimal64_10_1_from_decimal128v3_19_19(f1 int, f2 decimalv3(19, 19)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_19_19 values (100, "0.0000000000000000000"),(101, "0.0000000000000000001"),(102, "0.0000000000000000009"),(103, "0.0999999999999999999"),(104, "0.9000000000000000000"),(105, "0.9000000000000000001"),(106, "0.9999999999999999998"),(107, "0.9999999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_4_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_19 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_4_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_19_19 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_37_0 values (108, "0"),(109, "99999999"),(110, "900000000"),(111, "900000001"),(112, "999999998"),(113, "999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_5_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_5_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_0 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_37_1 values (114, "0.0"),(115, "0.1"),(116, "0.8"),(117, "0.9"),(118, "99999999.0"),(119, "99999999.1"),(120, "99999999.8"),(121, "99999999.9"),(122, "900000000.0"),(123, "900000000.1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_6_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_1 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_6_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_1 order by 1;'
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_7_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_18 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_7_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_18 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_10_1_from_decimal128v3_37_36;"
    sql "create table test_cast_to_decimal64_10_1_from_decimal128v3_37_36(f1 int, f2 decimalv3(37, 36)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_37_36 values (184, "0.000000000000000000000000000000000000"),(185, "0.000000000000000000000000000000000001"),(186, "0.000000000000000000000000000000000009"),(187, "0.099999999999999999999999999999999999"),(188, "0.900000000000000000000000000000000000"),(189, "0.900000000000000000000000000000000001"),(190, "0.999999999999999999999999999999999998"),(191, "0.999999999999999999999999999999999999"),(192, "8.000000000000000000000000000000000000"),(193, "8.000000000000000000000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_8_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_36 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_8_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_36 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_10_1_from_decimal128v3_37_37;"
    sql "create table test_cast_to_decimal64_10_1_from_decimal128v3_37_37(f1 int, f2 decimalv3(37, 37)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_37_37 values (208, "0.0000000000000000000000000000000000000"),(209, "0.0000000000000000000000000000000000001"),(210, "0.0000000000000000000000000000000000009"),(211, "0.0999999999999999999999999999999999999"),(212, "0.9000000000000000000000000000000000000"),(213, "0.9000000000000000000000000000000000001"),(214, "0.9999999999999999999999999999999999998"),(215, "0.9999999999999999999999999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_9_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_37 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_9_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_37_37 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_38_0 values (216, "0"),(217, "99999999"),(218, "900000000"),(219, "900000001"),(220, "999999998"),(221, "999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_10_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_10_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_0 order by 1;'
    ...
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_38_1 values (222, "0.0"),(223, "0.1"),(224, "0.8"),(225, "0.9"),(226, "99999999.0"),(227, "99999999.1"),(228, "99999999.8"),(229, "99999999.9"),(230, "900000000.0"),(231, "900000000.1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_11_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_1 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_11_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_1 order by 1;'
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_12_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_19 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_12_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_19 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_10_1_from_decimal128v3_38_37;"
    sql "create table test_cast_to_decimal64_10_1_from_decimal128v3_38_37(f1 int, f2 decimalv3(38, 37)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_38_37 values (292, "0.0000000000000000000000000000000000000"),(293, "0.0000000000000000000000000000000000001"),(294, "0.0000000000000000000000000000000000009"),(295, "0.0999999999999999999999999999999999999"),(296, "0.9000000000000000000000000000000000000"),(297, "0.9000000000000000000000000000000000001"),(298, "0.9999999999999999999999999999999999998"),(299, "0.9999999999999999999999999999999999999"),(300, "8.0000000000000000000000000000000000000"),(301, "8.0000000000000000000000000000000000001"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_13_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_37 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_13_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_37 order by 1;'

    sql "drop table if exists test_cast_to_decimal64_10_1_from_decimal128v3_38_38;"
    sql "create table test_cast_to_decimal64_10_1_from_decimal128v3_38_38(f1 int, f2 decimalv3(38, 38)) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal64_10_1_from_decimal128v3_38_38 values (316, "0.00000000000000000000000000000000000000"),(317, "0.00000000000000000000000000000000000001"),(318, "0.00000000000000000000000000000000000009"),(319, "0.09999999999999999999999999999999999999"),(320, "0.90000000000000000000000000000000000000"),(321, "0.90000000000000000000000000000000000001"),(322, "0.99999999999999999999999999999999999998"),(323, "0.99999999999999999999999999999999999999");
    """

    sql "set enable_strict_cast=true;"
    qt_sql_14_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_38 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_14_non_strict 'select f1, cast(f2 as decimalv3(10, 1)) from test_cast_to_decimal64_10_1_from_decimal128v3_38_38 order by 1;'
