...
suite("test_cast_to_decimal128_from_double") {
    ...
    sql "drop table if exists test_cast_to_decimal128v3_38_0_from_float64;"
    sql "create table test_cast_to_decimal128v3_38_0_from_float64(f1 int, f2 double) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal128v3_38_0_from_float64 values (0, "0.04"),(1, "1.04"),(2, "9.04"),(3, "1e+37"),(4, "9e+37"),(5, "9e+37"),(6, "0.05"),(7, "1.05"),(8, "9.05"),(9, "1e+37"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as decimalv3(38, 0)) from test_cast_to_decimal128v3_38_0_from_float64 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as decimalv3(38, 0)) from test_cast_to_decimal128v3_38_0_from_float64 order by 1;'

    sql "drop table if exists test_cast_to_decimal128v3_38_19_from_float64;"
    sql "create table test_cast_to_decimal128v3_38_19_from_float64(f1 int, f2 double) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal128v3_38_19_from_float64 values (24, "4e-20"),(25, "1.4e-19"),(26, "9.4e-19"),(27, "0.1"),(28, "0.9"),(29, "0.9"),(30, "1"),(31, "1"),(32, "1"),(33, "1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_1_strict 'select f1, cast(f2 as decimalv3(38, 19)) from test_cast_to_decimal128v3_38_19_from_float64 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_1_non_strict 'select f1, cast(f2 as decimalv3(38, 19)) from test_cast_to_decimal128v3_38_19_from_float64 order by 1;'

    sql "drop table if exists test_cast_to_decimal128v3_38_37_from_float64;"
    sql "create table test_cast_to_decimal128v3_38_37_from_float64(f1 int, f2 double) properties('replication_num'='1');"
    sql """insert into test_cast_to_decimal128v3_38_37_from_float64 values (216, "4e-38"),(217, "1.4e-37"),(218, "9.4e-37"),(219, "0.1"),(220, "0.9"),(221, "0.9"),(222, "1"),(223, "1"),(224, "1"),(225, "1"),
    ...
    sql "set enable_strict_cast=true;"
    qt_sql_2_strict 'select f1, cast(f2 as decimalv3(38, 37)) from test_cast_to_decimal128v3_38_37_from_float64 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_2_non_strict 'select f1, cast(f2 as decimalv3(38, 37)) from test_cast_to_decimal128v3_38_37_from_float64 order by 1;'
