...
suite("test_cast_to_decimal32_from_double_const") {
    ...
    def const_sql_0 = """select cast(cast("1.4e-08" as double) as decimalv3(9, 8));"""
    qt_sql_0_strict "${const_sql_0}"
    testFoldConst("${const_sql_0}")
    def const_sql_1 = """select cast(cast("1.5e-08" as double) as decimalv3(9, 8));"""
    qt_sql_1_strict "${const_sql_1}"
    testFoldConst("${const_sql_1}")
    def const_sql_2 = """select cast(cast("-1.4e-08" as double) as decimalv3(9, 8));"""
    qt_sql_2_strict "${const_sql_2}"
    testFoldConst("${const_sql_2}")
    def const_sql_3 = """select cast(cast("-1.5e-08" as double) as decimalv3(9, 8));"""
