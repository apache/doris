...
suite("test_cast_to_decimal32_from_int_const") {
    ...
    testFoldConst("${const_sql_58}")
    sql "set enable_strict_cast=true;"
    def const_sql_59 = """select cast(-9 as decimalv3(1, 0));"""
    qt_sql_59_strict "${const_sql_59}"
    testFoldConst("${const_sql_59}")
    def const_sql_60 = """select cast(-8 as decimalv3(1, 0));"""
    ...
    def const_sql_62 = """select cast(0 as decimalv3(1, 0));"""
    qt_sql_62_strict "${const_sql_62}"
    testFoldConst("${const_sql_62}")
    def const_sql_63 = """select cast(1 as decimalv3(1, 0));"""
    qt_sql_63_strict "${const_sql_63}"
    testFoldConst("${const_sql_63}")
    def const_sql_64 = """select cast(8 as decimalv3(1, 0));"""
    qt_sql_64_strict "${const_sql_64}"
    testFoldConst("${const_sql_64}")
    def const_sql_65 = """select cast(9 as decimalv3(1, 0));"""
