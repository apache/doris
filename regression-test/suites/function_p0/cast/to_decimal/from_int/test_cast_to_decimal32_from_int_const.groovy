...
suite("test_cast_to_decimal32_from_int_const") {
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_1_0 = """select "-128", cast(cast("-128" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_0_strict "${const_sql_1_0}"
    testFoldConst("${const_sql_1_0}")
    def const_sql_1_1 = """select "-127", cast(cast("-127" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_1_strict "${const_sql_1_1}"
    testFoldConst("${const_sql_1_1}")
    def const_sql_1_2 = """select "-9", cast(cast("-9" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_2_strict "${const_sql_1_2}"
    testFoldConst("${const_sql_1_2}")
    def const_sql_1_3 = """select "-1", cast(cast("-1" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_3_strict "${const_sql_1_3}"
    testFoldConst("${const_sql_1_3}")
    def const_sql_1_4 = """select "0", cast(cast("0" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_4_strict "${const_sql_1_4}"
    testFoldConst("${const_sql_1_4}")
    def const_sql_1_5 = """select "1", cast(cast("1" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_5_strict "${const_sql_1_5}"
    testFoldConst("${const_sql_1_5}")
    def const_sql_1_6 = """select "9", cast(cast("9" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_6_strict "${const_sql_1_6}"
    testFoldConst("${const_sql_1_6}")
    def const_sql_1_7 = """select "126", cast(cast("126" as tinyint) as decimalv3(4, 0));"""
    qt_sql_1_7_strict "${const_sql_1_7}"
    testFoldConst("${const_sql_1_7}")
    def const_sql_1_8 = """select "127", cast(cast("127" as tinyint) as decimalv3(4, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_2_0 = """select "-99", cast(cast("-99" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_0_strict "${const_sql_2_0}"
    testFoldConst("${const_sql_2_0}")
    def const_sql_2_1 = """select "-91", cast(cast("-91" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_1_strict "${const_sql_2_1}"
    testFoldConst("${const_sql_2_1}")
    def const_sql_2_2 = """select "-90", cast(cast("-90" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_2_strict "${const_sql_2_2}"
    testFoldConst("${const_sql_2_2}")
    def const_sql_2_3 = """select "-9", cast(cast("-9" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_3_strict "${const_sql_2_3}"
    testFoldConst("${const_sql_2_3}")
    def const_sql_2_4 = """select "-1", cast(cast("-1" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_4_strict "${const_sql_2_4}"
    testFoldConst("${const_sql_2_4}")
    def const_sql_2_5 = """select "0", cast(cast("0" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_5_strict "${const_sql_2_5}"
    testFoldConst("${const_sql_2_5}")
    def const_sql_2_6 = """select "1", cast(cast("1" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_6_strict "${const_sql_2_6}"
    testFoldConst("${const_sql_2_6}")
    def const_sql_2_7 = """select "9", cast(cast("9" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_7_strict "${const_sql_2_7}"
    testFoldConst("${const_sql_2_7}")
    def const_sql_2_8 = """select "90", cast(cast("90" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_8_strict "${const_sql_2_8}"
    testFoldConst("${const_sql_2_8}")
    def const_sql_2_9 = """select "91", cast(cast("91" as tinyint) as decimalv3(4, 2));"""
    qt_sql_2_9_strict "${const_sql_2_9}"
    testFoldConst("${const_sql_2_9}")
    def const_sql_2_10 = """select "99", cast(cast("99" as tinyint) as decimalv3(4, 2));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_3_0 = """select "-9", cast(cast("-9" as tinyint) as decimalv3(4, 3));"""
    qt_sql_3_0_strict "${const_sql_3_0}"
    testFoldConst("${const_sql_3_0}")
    def const_sql_3_1 = """select "-8", cast(cast("-8" as tinyint) as decimalv3(4, 3));"""
    qt_sql_3_1_strict "${const_sql_3_1}"
    testFoldConst("${const_sql_3_1}")
    def const_sql_3_2 = """select "-1", cast(cast("-1" as tinyint) as decimalv3(4, 3));"""
    qt_sql_3_2_strict "${const_sql_3_2}"
    testFoldConst("${const_sql_3_2}")
    def const_sql_3_3 = """select "0", cast(cast("0" as tinyint) as decimalv3(4, 3));"""
    qt_sql_3_3_strict "${const_sql_3_3}"
    testFoldConst("${const_sql_3_3}")
    def const_sql_3_4 = """select "1", cast(cast("1" as tinyint) as decimalv3(4, 3));"""
    qt_sql_3_4_strict "${const_sql_3_4}"
    testFoldConst("${const_sql_3_4}")
    def const_sql_3_5 = """select "8", cast(cast("8" as tinyint) as decimalv3(4, 3));"""
    qt_sql_3_5_strict "${const_sql_3_5}"
    testFoldConst("${const_sql_3_5}")
    def const_sql_3_6 = """select "9", cast(cast("9" as tinyint) as decimalv3(4, 3));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_4_0 = """select "-128", cast(cast("-128" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_0_strict "${const_sql_4_0}"
    testFoldConst("${const_sql_4_0}")
    def const_sql_4_1 = """select "-127", cast(cast("-127" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_1_strict "${const_sql_4_1}"
    testFoldConst("${const_sql_4_1}")
    def const_sql_4_2 = """select "-9", cast(cast("-9" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_2_strict "${const_sql_4_2}"
    testFoldConst("${const_sql_4_2}")
    def const_sql_4_3 = """select "-1", cast(cast("-1" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_3_strict "${const_sql_4_3}"
    testFoldConst("${const_sql_4_3}")
    def const_sql_4_4 = """select "0", cast(cast("0" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_4_strict "${const_sql_4_4}"
    testFoldConst("${const_sql_4_4}")
    def const_sql_4_5 = """select "1", cast(cast("1" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_5_strict "${const_sql_4_5}"
    testFoldConst("${const_sql_4_5}")
    def const_sql_4_6 = """select "9", cast(cast("9" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_6_strict "${const_sql_4_6}"
    testFoldConst("${const_sql_4_6}")
    def const_sql_4_7 = """select "126", cast(cast("126" as tinyint) as decimalv3(9, 0));"""
    qt_sql_4_7_strict "${const_sql_4_7}"
    testFoldConst("${const_sql_4_7}")
    def const_sql_4_8 = """select "127", cast(cast("127" as tinyint) as decimalv3(9, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_5_0 = """select "-128", cast(cast("-128" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_0_strict "${const_sql_5_0}"
    testFoldConst("${const_sql_5_0}")
    def const_sql_5_1 = """select "-127", cast(cast("-127" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_1_strict "${const_sql_5_1}"
    testFoldConst("${const_sql_5_1}")
    def const_sql_5_2 = """select "-9", cast(cast("-9" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_2_strict "${const_sql_5_2}"
    testFoldConst("${const_sql_5_2}")
    def const_sql_5_3 = """select "-1", cast(cast("-1" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_3_strict "${const_sql_5_3}"
    testFoldConst("${const_sql_5_3}")
    def const_sql_5_4 = """select "0", cast(cast("0" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_4_strict "${const_sql_5_4}"
    testFoldConst("${const_sql_5_4}")
    def const_sql_5_5 = """select "1", cast(cast("1" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_5_strict "${const_sql_5_5}"
    testFoldConst("${const_sql_5_5}")
    def const_sql_5_6 = """select "9", cast(cast("9" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_6_strict "${const_sql_5_6}"
    testFoldConst("${const_sql_5_6}")
    def const_sql_5_7 = """select "126", cast(cast("126" as tinyint) as decimalv3(9, 4));"""
    qt_sql_5_7_strict "${const_sql_5_7}"
    testFoldConst("${const_sql_5_7}")
    def const_sql_5_8 = """select "127", cast(cast("127" as tinyint) as decimalv3(9, 4));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_6_0 = """select "-9", cast(cast("-9" as tinyint) as decimalv3(9, 8));"""
    qt_sql_6_0_strict "${const_sql_6_0}"
    testFoldConst("${const_sql_6_0}")
    def const_sql_6_1 = """select "-8", cast(cast("-8" as tinyint) as decimalv3(9, 8));"""
    qt_sql_6_1_strict "${const_sql_6_1}"
    testFoldConst("${const_sql_6_1}")
    def const_sql_6_2 = """select "-1", cast(cast("-1" as tinyint) as decimalv3(9, 8));"""
    qt_sql_6_2_strict "${const_sql_6_2}"
    testFoldConst("${const_sql_6_2}")
    def const_sql_6_3 = """select "0", cast(cast("0" as tinyint) as decimalv3(9, 8));"""
    qt_sql_6_3_strict "${const_sql_6_3}"
    testFoldConst("${const_sql_6_3}")
    def const_sql_6_4 = """select "1", cast(cast("1" as tinyint) as decimalv3(9, 8));"""
    qt_sql_6_4_strict "${const_sql_6_4}"
    testFoldConst("${const_sql_6_4}")
    def const_sql_6_5 = """select "8", cast(cast("8" as tinyint) as decimalv3(9, 8));"""
    qt_sql_6_5_strict "${const_sql_6_5}"
    testFoldConst("${const_sql_6_5}")
    def const_sql_6_6 = """select "9", cast(cast("9" as tinyint) as decimalv3(9, 8));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_8_0 = """select "-9999", cast(cast("-9999" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_0_strict "${const_sql_8_0}"
    testFoldConst("${const_sql_8_0}")
    def const_sql_8_1 = """select "-9001", cast(cast("-9001" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_1_strict "${const_sql_8_1}"
    testFoldConst("${const_sql_8_1}")
    def const_sql_8_2 = """select "-9000", cast(cast("-9000" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_2_strict "${const_sql_8_2}"
    testFoldConst("${const_sql_8_2}")
    def const_sql_8_3 = """select "-999", cast(cast("-999" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_3_strict "${const_sql_8_3}"
    testFoldConst("${const_sql_8_3}")
    def const_sql_8_4 = """select "-9", cast(cast("-9" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_4_strict "${const_sql_8_4}"
    testFoldConst("${const_sql_8_4}")
    def const_sql_8_5 = """select "-1", cast(cast("-1" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_5_strict "${const_sql_8_5}"
    testFoldConst("${const_sql_8_5}")
    def const_sql_8_6 = """select "0", cast(cast("0" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_6_strict "${const_sql_8_6}"
    testFoldConst("${const_sql_8_6}")
    def const_sql_8_7 = """select "1", cast(cast("1" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_7_strict "${const_sql_8_7}"
    testFoldConst("${const_sql_8_7}")
    def const_sql_8_8 = """select "9", cast(cast("9" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_8_strict "${const_sql_8_8}"
    testFoldConst("${const_sql_8_8}")
    def const_sql_8_9 = """select "999", cast(cast("999" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_9_strict "${const_sql_8_9}"
    testFoldConst("${const_sql_8_9}")
    def const_sql_8_10 = """select "9000", cast(cast("9000" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_10_strict "${const_sql_8_10}"
    testFoldConst("${const_sql_8_10}")
    def const_sql_8_11 = """select "9001", cast(cast("9001" as smallint) as decimalv3(4, 0));"""
    qt_sql_8_11_strict "${const_sql_8_11}"
    testFoldConst("${const_sql_8_11}")
    def const_sql_8_12 = """select "9999", cast(cast("9999" as smallint) as decimalv3(4, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_9_0 = """select "-99", cast(cast("-99" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_0_strict "${const_sql_9_0}"
    testFoldConst("${const_sql_9_0}")
    def const_sql_9_1 = """select "-91", cast(cast("-91" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_1_strict "${const_sql_9_1}"
    testFoldConst("${const_sql_9_1}")
    def const_sql_9_2 = """select "-90", cast(cast("-90" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_2_strict "${const_sql_9_2}"
    testFoldConst("${const_sql_9_2}")
    def const_sql_9_3 = """select "-9", cast(cast("-9" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_3_strict "${const_sql_9_3}"
    testFoldConst("${const_sql_9_3}")
    def const_sql_9_4 = """select "-1", cast(cast("-1" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_4_strict "${const_sql_9_4}"
    testFoldConst("${const_sql_9_4}")
    def const_sql_9_5 = """select "0", cast(cast("0" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_5_strict "${const_sql_9_5}"
    testFoldConst("${const_sql_9_5}")
    def const_sql_9_6 = """select "1", cast(cast("1" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_6_strict "${const_sql_9_6}"
    testFoldConst("${const_sql_9_6}")
    def const_sql_9_7 = """select "9", cast(cast("9" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_7_strict "${const_sql_9_7}"
    testFoldConst("${const_sql_9_7}")
    def const_sql_9_8 = """select "90", cast(cast("90" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_8_strict "${const_sql_9_8}"
    testFoldConst("${const_sql_9_8}")
    def const_sql_9_9 = """select "91", cast(cast("91" as smallint) as decimalv3(4, 2));"""
    qt_sql_9_9_strict "${const_sql_9_9}"
    testFoldConst("${const_sql_9_9}")
    def const_sql_9_10 = """select "99", cast(cast("99" as smallint) as decimalv3(4, 2));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_10_0 = """select "-9", cast(cast("-9" as smallint) as decimalv3(4, 3));"""
    qt_sql_10_0_strict "${const_sql_10_0}"
    testFoldConst("${const_sql_10_0}")
    def const_sql_10_1 = """select "-8", cast(cast("-8" as smallint) as decimalv3(4, 3));"""
    qt_sql_10_1_strict "${const_sql_10_1}"
    testFoldConst("${const_sql_10_1}")
    def const_sql_10_2 = """select "-1", cast(cast("-1" as smallint) as decimalv3(4, 3));"""
    qt_sql_10_2_strict "${const_sql_10_2}"
    testFoldConst("${const_sql_10_2}")
    def const_sql_10_3 = """select "0", cast(cast("0" as smallint) as decimalv3(4, 3));"""
    qt_sql_10_3_strict "${const_sql_10_3}"
    testFoldConst("${const_sql_10_3}")
    def const_sql_10_4 = """select "1", cast(cast("1" as smallint) as decimalv3(4, 3));"""
    qt_sql_10_4_strict "${const_sql_10_4}"
    testFoldConst("${const_sql_10_4}")
    def const_sql_10_5 = """select "8", cast(cast("8" as smallint) as decimalv3(4, 3));"""
    qt_sql_10_5_strict "${const_sql_10_5}"
    testFoldConst("${const_sql_10_5}")
    def const_sql_10_6 = """select "9", cast(cast("9" as smallint) as decimalv3(4, 3));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_11_0 = """select "-32768", cast(cast("-32768" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_0_strict "${const_sql_11_0}"
    testFoldConst("${const_sql_11_0}")
    def const_sql_11_1 = """select "-32767", cast(cast("-32767" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_1_strict "${const_sql_11_1}"
    testFoldConst("${const_sql_11_1}")
    def const_sql_11_2 = """select "-9", cast(cast("-9" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_2_strict "${const_sql_11_2}"
    testFoldConst("${const_sql_11_2}")
    def const_sql_11_3 = """select "-1", cast(cast("-1" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_3_strict "${const_sql_11_3}"
    testFoldConst("${const_sql_11_3}")
    def const_sql_11_4 = """select "0", cast(cast("0" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_4_strict "${const_sql_11_4}"
    testFoldConst("${const_sql_11_4}")
    def const_sql_11_5 = """select "1", cast(cast("1" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_5_strict "${const_sql_11_5}"
    testFoldConst("${const_sql_11_5}")
    def const_sql_11_6 = """select "9", cast(cast("9" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_6_strict "${const_sql_11_6}"
    testFoldConst("${const_sql_11_6}")
    def const_sql_11_7 = """select "32766", cast(cast("32766" as smallint) as decimalv3(9, 0));"""
    qt_sql_11_7_strict "${const_sql_11_7}"
    testFoldConst("${const_sql_11_7}")
    def const_sql_11_8 = """select "32767", cast(cast("32767" as smallint) as decimalv3(9, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_12_0 = """select "-32768", cast(cast("-32768" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_0_strict "${const_sql_12_0}"
    testFoldConst("${const_sql_12_0}")
    def const_sql_12_1 = """select "-32767", cast(cast("-32767" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_1_strict "${const_sql_12_1}"
    testFoldConst("${const_sql_12_1}")
    def const_sql_12_2 = """select "-9", cast(cast("-9" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_2_strict "${const_sql_12_2}"
    testFoldConst("${const_sql_12_2}")
    def const_sql_12_3 = """select "-1", cast(cast("-1" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_3_strict "${const_sql_12_3}"
    testFoldConst("${const_sql_12_3}")
    def const_sql_12_4 = """select "0", cast(cast("0" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_4_strict "${const_sql_12_4}"
    testFoldConst("${const_sql_12_4}")
    def const_sql_12_5 = """select "1", cast(cast("1" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_5_strict "${const_sql_12_5}"
    testFoldConst("${const_sql_12_5}")
    def const_sql_12_6 = """select "9", cast(cast("9" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_6_strict "${const_sql_12_6}"
    testFoldConst("${const_sql_12_6}")
    def const_sql_12_7 = """select "32766", cast(cast("32766" as smallint) as decimalv3(9, 4));"""
    qt_sql_12_7_strict "${const_sql_12_7}"
    testFoldConst("${const_sql_12_7}")
    def const_sql_12_8 = """select "32767", cast(cast("32767" as smallint) as decimalv3(9, 4));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_13_0 = """select "-9", cast(cast("-9" as smallint) as decimalv3(9, 8));"""
    qt_sql_13_0_strict "${const_sql_13_0}"
    testFoldConst("${const_sql_13_0}")
    def const_sql_13_1 = """select "-8", cast(cast("-8" as smallint) as decimalv3(9, 8));"""
    qt_sql_13_1_strict "${const_sql_13_1}"
    testFoldConst("${const_sql_13_1}")
    def const_sql_13_2 = """select "-1", cast(cast("-1" as smallint) as decimalv3(9, 8));"""
    qt_sql_13_2_strict "${const_sql_13_2}"
    testFoldConst("${const_sql_13_2}")
    def const_sql_13_3 = """select "0", cast(cast("0" as smallint) as decimalv3(9, 8));"""
    qt_sql_13_3_strict "${const_sql_13_3}"
    testFoldConst("${const_sql_13_3}")
    def const_sql_13_4 = """select "1", cast(cast("1" as smallint) as decimalv3(9, 8));"""
    qt_sql_13_4_strict "${const_sql_13_4}"
    testFoldConst("${const_sql_13_4}")
    def const_sql_13_5 = """select "8", cast(cast("8" as smallint) as decimalv3(9, 8));"""
    qt_sql_13_5_strict "${const_sql_13_5}"
    testFoldConst("${const_sql_13_5}")
    def const_sql_13_6 = """select "9", cast(cast("9" as smallint) as decimalv3(9, 8));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_15_0 = """select "-9999", cast(cast("-9999" as int) as decimalv3(4, 0));"""
    qt_sql_15_0_strict "${const_sql_15_0}"
    testFoldConst("${const_sql_15_0}")
    def const_sql_15_1 = """select "-9001", cast(cast("-9001" as int) as decimalv3(4, 0));"""
    qt_sql_15_1_strict "${const_sql_15_1}"
    testFoldConst("${const_sql_15_1}")
    def const_sql_15_2 = """select "-9000", cast(cast("-9000" as int) as decimalv3(4, 0));"""
    qt_sql_15_2_strict "${const_sql_15_2}"
    testFoldConst("${const_sql_15_2}")
    def const_sql_15_3 = """select "-999", cast(cast("-999" as int) as decimalv3(4, 0));"""
    qt_sql_15_3_strict "${const_sql_15_3}"
    testFoldConst("${const_sql_15_3}")
    def const_sql_15_4 = """select "-9", cast(cast("-9" as int) as decimalv3(4, 0));"""
    qt_sql_15_4_strict "${const_sql_15_4}"
    testFoldConst("${const_sql_15_4}")
    def const_sql_15_5 = """select "-1", cast(cast("-1" as int) as decimalv3(4, 0));"""
    qt_sql_15_5_strict "${const_sql_15_5}"
    testFoldConst("${const_sql_15_5}")
    def const_sql_15_6 = """select "0", cast(cast("0" as int) as decimalv3(4, 0));"""
    qt_sql_15_6_strict "${const_sql_15_6}"
    testFoldConst("${const_sql_15_6}")
    def const_sql_15_7 = """select "1", cast(cast("1" as int) as decimalv3(4, 0));"""
    qt_sql_15_7_strict "${const_sql_15_7}"
    testFoldConst("${const_sql_15_7}")
    def const_sql_15_8 = """select "9", cast(cast("9" as int) as decimalv3(4, 0));"""
    qt_sql_15_8_strict "${const_sql_15_8}"
    testFoldConst("${const_sql_15_8}")
    def const_sql_15_9 = """select "999", cast(cast("999" as int) as decimalv3(4, 0));"""
    qt_sql_15_9_strict "${const_sql_15_9}"
    testFoldConst("${const_sql_15_9}")
    def const_sql_15_10 = """select "9000", cast(cast("9000" as int) as decimalv3(4, 0));"""
    qt_sql_15_10_strict "${const_sql_15_10}"
    testFoldConst("${const_sql_15_10}")
    def const_sql_15_11 = """select "9001", cast(cast("9001" as int) as decimalv3(4, 0));"""
    qt_sql_15_11_strict "${const_sql_15_11}"
    testFoldConst("${const_sql_15_11}")
    def const_sql_15_12 = """select "9999", cast(cast("9999" as int) as decimalv3(4, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_16_0 = """select "-99", cast(cast("-99" as int) as decimalv3(4, 2));"""
    qt_sql_16_0_strict "${const_sql_16_0}"
    testFoldConst("${const_sql_16_0}")
    def const_sql_16_1 = """select "-91", cast(cast("-91" as int) as decimalv3(4, 2));"""
    qt_sql_16_1_strict "${const_sql_16_1}"
    testFoldConst("${const_sql_16_1}")
    def const_sql_16_2 = """select "-90", cast(cast("-90" as int) as decimalv3(4, 2));"""
    qt_sql_16_2_strict "${const_sql_16_2}"
    testFoldConst("${const_sql_16_2}")
    def const_sql_16_3 = """select "-9", cast(cast("-9" as int) as decimalv3(4, 2));"""
    qt_sql_16_3_strict "${const_sql_16_3}"
    testFoldConst("${const_sql_16_3}")
    def const_sql_16_4 = """select "-1", cast(cast("-1" as int) as decimalv3(4, 2));"""
    qt_sql_16_4_strict "${const_sql_16_4}"
    testFoldConst("${const_sql_16_4}")
    def const_sql_16_5 = """select "0", cast(cast("0" as int) as decimalv3(4, 2));"""
    qt_sql_16_5_strict "${const_sql_16_5}"
    testFoldConst("${const_sql_16_5}")
    def const_sql_16_6 = """select "1", cast(cast("1" as int) as decimalv3(4, 2));"""
    qt_sql_16_6_strict "${const_sql_16_6}"
    testFoldConst("${const_sql_16_6}")
    def const_sql_16_7 = """select "9", cast(cast("9" as int) as decimalv3(4, 2));"""
    qt_sql_16_7_strict "${const_sql_16_7}"
    testFoldConst("${const_sql_16_7}")
    def const_sql_16_8 = """select "90", cast(cast("90" as int) as decimalv3(4, 2));"""
    qt_sql_16_8_strict "${const_sql_16_8}"
    testFoldConst("${const_sql_16_8}")
    def const_sql_16_9 = """select "91", cast(cast("91" as int) as decimalv3(4, 2));"""
    qt_sql_16_9_strict "${const_sql_16_9}"
    testFoldConst("${const_sql_16_9}")
    def const_sql_16_10 = """select "99", cast(cast("99" as int) as decimalv3(4, 2));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_17_0 = """select "-9", cast(cast("-9" as int) as decimalv3(4, 3));"""
    qt_sql_17_0_strict "${const_sql_17_0}"
    testFoldConst("${const_sql_17_0}")
    def const_sql_17_1 = """select "-8", cast(cast("-8" as int) as decimalv3(4, 3));"""
    qt_sql_17_1_strict "${const_sql_17_1}"
    testFoldConst("${const_sql_17_1}")
    def const_sql_17_2 = """select "-1", cast(cast("-1" as int) as decimalv3(4, 3));"""
    qt_sql_17_2_strict "${const_sql_17_2}"
    testFoldConst("${const_sql_17_2}")
    def const_sql_17_3 = """select "0", cast(cast("0" as int) as decimalv3(4, 3));"""
    qt_sql_17_3_strict "${const_sql_17_3}"
    testFoldConst("${const_sql_17_3}")
    def const_sql_17_4 = """select "1", cast(cast("1" as int) as decimalv3(4, 3));"""
    qt_sql_17_4_strict "${const_sql_17_4}"
    testFoldConst("${const_sql_17_4}")
    def const_sql_17_5 = """select "8", cast(cast("8" as int) as decimalv3(4, 3));"""
    qt_sql_17_5_strict "${const_sql_17_5}"
    testFoldConst("${const_sql_17_5}")
    def const_sql_17_6 = """select "9", cast(cast("9" as int) as decimalv3(4, 3));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_18_0 = """select "-999999999", cast(cast("-999999999" as int) as decimalv3(9, 0));"""
    qt_sql_18_0_strict "${const_sql_18_0}"
    testFoldConst("${const_sql_18_0}")
    def const_sql_18_1 = """select "-900000001", cast(cast("-900000001" as int) as decimalv3(9, 0));"""
    qt_sql_18_1_strict "${const_sql_18_1}"
    testFoldConst("${const_sql_18_1}")
    def const_sql_18_2 = """select "-900000000", cast(cast("-900000000" as int) as decimalv3(9, 0));"""
    qt_sql_18_2_strict "${const_sql_18_2}"
    testFoldConst("${const_sql_18_2}")
    def const_sql_18_3 = """select "-99999999", cast(cast("-99999999" as int) as decimalv3(9, 0));"""
    qt_sql_18_3_strict "${const_sql_18_3}"
    testFoldConst("${const_sql_18_3}")
    def const_sql_18_4 = """select "-9", cast(cast("-9" as int) as decimalv3(9, 0));"""
    qt_sql_18_4_strict "${const_sql_18_4}"
    testFoldConst("${const_sql_18_4}")
    def const_sql_18_5 = """select "-1", cast(cast("-1" as int) as decimalv3(9, 0));"""
    qt_sql_18_5_strict "${const_sql_18_5}"
    testFoldConst("${const_sql_18_5}")
    def const_sql_18_6 = """select "0", cast(cast("0" as int) as decimalv3(9, 0));"""
    qt_sql_18_6_strict "${const_sql_18_6}"
    testFoldConst("${const_sql_18_6}")
    def const_sql_18_7 = """select "1", cast(cast("1" as int) as decimalv3(9, 0));"""
    qt_sql_18_7_strict "${const_sql_18_7}"
    testFoldConst("${const_sql_18_7}")
    def const_sql_18_8 = """select "9", cast(cast("9" as int) as decimalv3(9, 0));"""
    qt_sql_18_8_strict "${const_sql_18_8}"
    testFoldConst("${const_sql_18_8}")
    def const_sql_18_9 = """select "99999999", cast(cast("99999999" as int) as decimalv3(9, 0));"""
    qt_sql_18_9_strict "${const_sql_18_9}"
    testFoldConst("${const_sql_18_9}")
    def const_sql_18_10 = """select "900000000", cast(cast("900000000" as int) as decimalv3(9, 0));"""
    qt_sql_18_10_strict "${const_sql_18_10}"
    testFoldConst("${const_sql_18_10}")
    def const_sql_18_11 = """select "900000001", cast(cast("900000001" as int) as decimalv3(9, 0));"""
    qt_sql_18_11_strict "${const_sql_18_11}"
    testFoldConst("${const_sql_18_11}")
    def const_sql_18_12 = """select "999999999", cast(cast("999999999" as int) as decimalv3(9, 0));"""
    qt_sql_18_12_strict "${const_sql_18_12}"
    testFoldConst("${const_sql_18_12}")
    ...
    testFoldConst("${const_sql_18_8}")
    qt_sql_18_9_non_strict "${const_sql_18_9}"
    testFoldConst("${const_sql_18_9}")
    qt_sql_18_10_non_strict "${const_sql_18_10}"
    testFoldConst("${const_sql_18_10}")
    qt_sql_18_11_non_strict "${const_sql_18_11}"
    testFoldConst("${const_sql_18_11}")
    qt_sql_18_12_non_strict "${const_sql_18_12}"
    testFoldConst("${const_sql_18_12}")
    sql "set debug_skip_fold_constant = true;"

    sql "set enable_strict_cast=true;"
    def const_sql_19_0 = """select "-99999", cast(cast("-99999" as int) as decimalv3(9, 4));"""
    qt_sql_19_0_strict "${const_sql_19_0}"
    testFoldConst("${const_sql_19_0}")
    def const_sql_19_1 = """select "-90001", cast(cast("-90001" as int) as decimalv3(9, 4));"""
    qt_sql_19_1_strict "${const_sql_19_1}"
    testFoldConst("${const_sql_19_1}")
    def const_sql_19_2 = """select "-90000", cast(cast("-90000" as int) as decimalv3(9, 4));"""
    qt_sql_19_2_strict "${const_sql_19_2}"
    testFoldConst("${const_sql_19_2}")
    def const_sql_19_3 = """select "-9999", cast(cast("-9999" as int) as decimalv3(9, 4));"""
    qt_sql_19_3_strict "${const_sql_19_3}"
    testFoldConst("${const_sql_19_3}")
    def const_sql_19_4 = """select "-9", cast(cast("-9" as int) as decimalv3(9, 4));"""
    qt_sql_19_4_strict "${const_sql_19_4}"
    testFoldConst("${const_sql_19_4}")
    def const_sql_19_5 = """select "-1", cast(cast("-1" as int) as decimalv3(9, 4));"""
    qt_sql_19_5_strict "${const_sql_19_5}"
    testFoldConst("${const_sql_19_5}")
    def const_sql_19_6 = """select "0", cast(cast("0" as int) as decimalv3(9, 4));"""
    qt_sql_19_6_strict "${const_sql_19_6}"
    testFoldConst("${const_sql_19_6}")
    def const_sql_19_7 = """select "1", cast(cast("1" as int) as decimalv3(9, 4));"""
    qt_sql_19_7_strict "${const_sql_19_7}"
    testFoldConst("${const_sql_19_7}")
    def const_sql_19_8 = """select "9", cast(cast("9" as int) as decimalv3(9, 4));"""
    qt_sql_19_8_strict "${const_sql_19_8}"
    testFoldConst("${const_sql_19_8}")
    def const_sql_19_9 = """select "9999", cast(cast("9999" as int) as decimalv3(9, 4));"""
    qt_sql_19_9_strict "${const_sql_19_9}"
    testFoldConst("${const_sql_19_9}")
    def const_sql_19_10 = """select "90000", cast(cast("90000" as int) as decimalv3(9, 4));"""
    qt_sql_19_10_strict "${const_sql_19_10}"
    testFoldConst("${const_sql_19_10}")
    def const_sql_19_11 = """select "90001", cast(cast("90001" as int) as decimalv3(9, 4));"""
    qt_sql_19_11_strict "${const_sql_19_11}"
    testFoldConst("${const_sql_19_11}")
    def const_sql_19_12 = """select "99999", cast(cast("99999" as int) as decimalv3(9, 4));"""
    qt_sql_19_12_strict "${const_sql_19_12}"
    testFoldConst("${const_sql_19_12}")
    ...
    testFoldConst("${const_sql_19_8}")
    qt_sql_19_9_non_strict "${const_sql_19_9}"
    testFoldConst("${const_sql_19_9}")
    qt_sql_19_10_non_strict "${const_sql_19_10}"
    testFoldConst("${const_sql_19_10}")
    qt_sql_19_11_non_strict "${const_sql_19_11}"
    testFoldConst("${const_sql_19_11}")
    qt_sql_19_12_non_strict "${const_sql_19_12}"
    testFoldConst("${const_sql_19_12}")
    sql "set debug_skip_fold_constant = true;"

    sql "set enable_strict_cast=true;"
    def const_sql_20_0 = """select "-9", cast(cast("-9" as int) as decimalv3(9, 8));"""
    qt_sql_20_0_strict "${const_sql_20_0}"
    testFoldConst("${const_sql_20_0}")
    def const_sql_20_1 = """select "-8", cast(cast("-8" as int) as decimalv3(9, 8));"""
    qt_sql_20_1_strict "${const_sql_20_1}"
    testFoldConst("${const_sql_20_1}")
    def const_sql_20_2 = """select "-1", cast(cast("-1" as int) as decimalv3(9, 8));"""
    qt_sql_20_2_strict "${const_sql_20_2}"
    testFoldConst("${const_sql_20_2}")
    def const_sql_20_3 = """select "0", cast(cast("0" as int) as decimalv3(9, 8));"""
    qt_sql_20_3_strict "${const_sql_20_3}"
    testFoldConst("${const_sql_20_3}")
    def const_sql_20_4 = """select "1", cast(cast("1" as int) as decimalv3(9, 8));"""
    qt_sql_20_4_strict "${const_sql_20_4}"
    testFoldConst("${const_sql_20_4}")
    def const_sql_20_5 = """select "8", cast(cast("8" as int) as decimalv3(9, 8));"""
    qt_sql_20_5_strict "${const_sql_20_5}"
    testFoldConst("${const_sql_20_5}")
    def const_sql_20_6 = """select "9", cast(cast("9" as int) as decimalv3(9, 8));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_22_0 = """select "-9999", cast(cast("-9999" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_0_strict "${const_sql_22_0}"
    testFoldConst("${const_sql_22_0}")
    def const_sql_22_1 = """select "-9001", cast(cast("-9001" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_1_strict "${const_sql_22_1}"
    testFoldConst("${const_sql_22_1}")
    def const_sql_22_2 = """select "-9000", cast(cast("-9000" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_2_strict "${const_sql_22_2}"
    testFoldConst("${const_sql_22_2}")
    def const_sql_22_3 = """select "-999", cast(cast("-999" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_3_strict "${const_sql_22_3}"
    testFoldConst("${const_sql_22_3}")
    def const_sql_22_4 = """select "-9", cast(cast("-9" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_4_strict "${const_sql_22_4}"
    testFoldConst("${const_sql_22_4}")
    def const_sql_22_5 = """select "-1", cast(cast("-1" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_5_strict "${const_sql_22_5}"
    testFoldConst("${const_sql_22_5}")
    def const_sql_22_6 = """select "0", cast(cast("0" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_6_strict "${const_sql_22_6}"
    testFoldConst("${const_sql_22_6}")
    def const_sql_22_7 = """select "1", cast(cast("1" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_7_strict "${const_sql_22_7}"
    testFoldConst("${const_sql_22_7}")
    def const_sql_22_8 = """select "9", cast(cast("9" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_8_strict "${const_sql_22_8}"
    testFoldConst("${const_sql_22_8}")
    def const_sql_22_9 = """select "999", cast(cast("999" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_9_strict "${const_sql_22_9}"
    testFoldConst("${const_sql_22_9}")
    def const_sql_22_10 = """select "9000", cast(cast("9000" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_10_strict "${const_sql_22_10}"
    testFoldConst("${const_sql_22_10}")
    def const_sql_22_11 = """select "9001", cast(cast("9001" as bigint) as decimalv3(4, 0));"""
    qt_sql_22_11_strict "${const_sql_22_11}"
    testFoldConst("${const_sql_22_11}")
    def const_sql_22_12 = """select "9999", cast(cast("9999" as bigint) as decimalv3(4, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_23_0 = """select "-99", cast(cast("-99" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_0_strict "${const_sql_23_0}"
    testFoldConst("${const_sql_23_0}")
    def const_sql_23_1 = """select "-91", cast(cast("-91" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_1_strict "${const_sql_23_1}"
    testFoldConst("${const_sql_23_1}")
    def const_sql_23_2 = """select "-90", cast(cast("-90" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_2_strict "${const_sql_23_2}"
    testFoldConst("${const_sql_23_2}")
    def const_sql_23_3 = """select "-9", cast(cast("-9" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_3_strict "${const_sql_23_3}"
    testFoldConst("${const_sql_23_3}")
    def const_sql_23_4 = """select "-1", cast(cast("-1" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_4_strict "${const_sql_23_4}"
    testFoldConst("${const_sql_23_4}")
    def const_sql_23_5 = """select "0", cast(cast("0" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_5_strict "${const_sql_23_5}"
    testFoldConst("${const_sql_23_5}")
    def const_sql_23_6 = """select "1", cast(cast("1" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_6_strict "${const_sql_23_6}"
    testFoldConst("${const_sql_23_6}")
    def const_sql_23_7 = """select "9", cast(cast("9" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_7_strict "${const_sql_23_7}"
    testFoldConst("${const_sql_23_7}")
    def const_sql_23_8 = """select "90", cast(cast("90" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_8_strict "${const_sql_23_8}"
    testFoldConst("${const_sql_23_8}")
    def const_sql_23_9 = """select "91", cast(cast("91" as bigint) as decimalv3(4, 2));"""
    qt_sql_23_9_strict "${const_sql_23_9}"
    testFoldConst("${const_sql_23_9}")
    def const_sql_23_10 = """select "99", cast(cast("99" as bigint) as decimalv3(4, 2));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_24_0 = """select "-9", cast(cast("-9" as bigint) as decimalv3(4, 3));"""
    qt_sql_24_0_strict "${const_sql_24_0}"
    testFoldConst("${const_sql_24_0}")
    def const_sql_24_1 = """select "-8", cast(cast("-8" as bigint) as decimalv3(4, 3));"""
    qt_sql_24_1_strict "${const_sql_24_1}"
    testFoldConst("${const_sql_24_1}")
    def const_sql_24_2 = """select "-1", cast(cast("-1" as bigint) as decimalv3(4, 3));"""
    qt_sql_24_2_strict "${const_sql_24_2}"
    testFoldConst("${const_sql_24_2}")
    def const_sql_24_3 = """select "0", cast(cast("0" as bigint) as decimalv3(4, 3));"""
    qt_sql_24_3_strict "${const_sql_24_3}"
    testFoldConst("${const_sql_24_3}")
    def const_sql_24_4 = """select "1", cast(cast("1" as bigint) as decimalv3(4, 3));"""
    qt_sql_24_4_strict "${const_sql_24_4}"
    testFoldConst("${const_sql_24_4}")
    def const_sql_24_5 = """select "8", cast(cast("8" as bigint) as decimalv3(4, 3));"""
    qt_sql_24_5_strict "${const_sql_24_5}"
    testFoldConst("${const_sql_24_5}")
    def const_sql_24_6 = """select "9", cast(cast("9" as bigint) as decimalv3(4, 3));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_25_0 = """select "-999999999", cast(cast("-999999999" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_0_strict "${const_sql_25_0}"
    testFoldConst("${const_sql_25_0}")
    def const_sql_25_1 = """select "-900000001", cast(cast("-900000001" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_1_strict "${const_sql_25_1}"
    testFoldConst("${const_sql_25_1}")
    def const_sql_25_2 = """select "-900000000", cast(cast("-900000000" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_2_strict "${const_sql_25_2}"
    testFoldConst("${const_sql_25_2}")
    def const_sql_25_3 = """select "-99999999", cast(cast("-99999999" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_3_strict "${const_sql_25_3}"
    testFoldConst("${const_sql_25_3}")
    def const_sql_25_4 = """select "-9", cast(cast("-9" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_4_strict "${const_sql_25_4}"
    testFoldConst("${const_sql_25_4}")
    def const_sql_25_5 = """select "-1", cast(cast("-1" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_5_strict "${const_sql_25_5}"
    testFoldConst("${const_sql_25_5}")
    def const_sql_25_6 = """select "0", cast(cast("0" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_6_strict "${const_sql_25_6}"
    testFoldConst("${const_sql_25_6}")
    def const_sql_25_7 = """select "1", cast(cast("1" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_7_strict "${const_sql_25_7}"
    testFoldConst("${const_sql_25_7}")
    def const_sql_25_8 = """select "9", cast(cast("9" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_8_strict "${const_sql_25_8}"
    testFoldConst("${const_sql_25_8}")
    def const_sql_25_9 = """select "99999999", cast(cast("99999999" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_9_strict "${const_sql_25_9}"
    testFoldConst("${const_sql_25_9}")
    def const_sql_25_10 = """select "900000000", cast(cast("900000000" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_10_strict "${const_sql_25_10}"
    testFoldConst("${const_sql_25_10}")
    def const_sql_25_11 = """select "900000001", cast(cast("900000001" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_11_strict "${const_sql_25_11}"
    testFoldConst("${const_sql_25_11}")
    def const_sql_25_12 = """select "999999999", cast(cast("999999999" as bigint) as decimalv3(9, 0));"""
    qt_sql_25_12_strict "${const_sql_25_12}"
    testFoldConst("${const_sql_25_12}")
    ...
    testFoldConst("${const_sql_25_8}")
    qt_sql_25_9_non_strict "${const_sql_25_9}"
    testFoldConst("${const_sql_25_9}")
    qt_sql_25_10_non_strict "${const_sql_25_10}"
    testFoldConst("${const_sql_25_10}")
    qt_sql_25_11_non_strict "${const_sql_25_11}"
    testFoldConst("${const_sql_25_11}")
    qt_sql_25_12_non_strict "${const_sql_25_12}"
    testFoldConst("${const_sql_25_12}")
    sql "set debug_skip_fold_constant = true;"

    sql "set enable_strict_cast=true;"
    def const_sql_26_0 = """select "-99999", cast(cast("-99999" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_0_strict "${const_sql_26_0}"
    testFoldConst("${const_sql_26_0}")
    def const_sql_26_1 = """select "-90001", cast(cast("-90001" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_1_strict "${const_sql_26_1}"
    testFoldConst("${const_sql_26_1}")
    def const_sql_26_2 = """select "-90000", cast(cast("-90000" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_2_strict "${const_sql_26_2}"
    testFoldConst("${const_sql_26_2}")
    def const_sql_26_3 = """select "-9999", cast(cast("-9999" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_3_strict "${const_sql_26_3}"
    testFoldConst("${const_sql_26_3}")
    def const_sql_26_4 = """select "-9", cast(cast("-9" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_4_strict "${const_sql_26_4}"
    testFoldConst("${const_sql_26_4}")
    def const_sql_26_5 = """select "-1", cast(cast("-1" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_5_strict "${const_sql_26_5}"
    testFoldConst("${const_sql_26_5}")
    def const_sql_26_6 = """select "0", cast(cast("0" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_6_strict "${const_sql_26_6}"
    testFoldConst("${const_sql_26_6}")
    def const_sql_26_7 = """select "1", cast(cast("1" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_7_strict "${const_sql_26_7}"
    testFoldConst("${const_sql_26_7}")
    def const_sql_26_8 = """select "9", cast(cast("9" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_8_strict "${const_sql_26_8}"
    testFoldConst("${const_sql_26_8}")
    def const_sql_26_9 = """select "9999", cast(cast("9999" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_9_strict "${const_sql_26_9}"
    testFoldConst("${const_sql_26_9}")
    def const_sql_26_10 = """select "90000", cast(cast("90000" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_10_strict "${const_sql_26_10}"
    testFoldConst("${const_sql_26_10}")
    def const_sql_26_11 = """select "90001", cast(cast("90001" as bigint) as decimalv3(9, 4));"""
    qt_sql_26_11_strict "${const_sql_26_11}"
    testFoldConst("${const_sql_26_11}")
    def const_sql_26_12 = """select "99999", cast(cast("99999" as bigint) as decimalv3(9, 4));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_27_0 = """select "-9", cast(cast("-9" as bigint) as decimalv3(9, 8));"""
    qt_sql_27_0_strict "${const_sql_27_0}"
    testFoldConst("${const_sql_27_0}")
    def const_sql_27_1 = """select "-8", cast(cast("-8" as bigint) as decimalv3(9, 8));"""
    qt_sql_27_1_strict "${const_sql_27_1}"
    testFoldConst("${const_sql_27_1}")
    def const_sql_27_2 = """select "-1", cast(cast("-1" as bigint) as decimalv3(9, 8));"""
    qt_sql_27_2_strict "${const_sql_27_2}"
    testFoldConst("${const_sql_27_2}")
    def const_sql_27_3 = """select "0", cast(cast("0" as bigint) as decimalv3(9, 8));"""
    qt_sql_27_3_strict "${const_sql_27_3}"
    testFoldConst("${const_sql_27_3}")
    def const_sql_27_4 = """select "1", cast(cast("1" as bigint) as decimalv3(9, 8));"""
    qt_sql_27_4_strict "${const_sql_27_4}"
    testFoldConst("${const_sql_27_4}")
    def const_sql_27_5 = """select "8", cast(cast("8" as bigint) as decimalv3(9, 8));"""
    qt_sql_27_5_strict "${const_sql_27_5}"
    testFoldConst("${const_sql_27_5}")
    def const_sql_27_6 = """select "9", cast(cast("9" as bigint) as decimalv3(9, 8));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_29_0 = """select "-9999", cast(cast("-9999" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_0_strict "${const_sql_29_0}"
    testFoldConst("${const_sql_29_0}")
    def const_sql_29_1 = """select "-9001", cast(cast("-9001" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_1_strict "${const_sql_29_1}"
    testFoldConst("${const_sql_29_1}")
    def const_sql_29_2 = """select "-9000", cast(cast("-9000" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_2_strict "${const_sql_29_2}"
    testFoldConst("${const_sql_29_2}")
    def const_sql_29_3 = """select "-999", cast(cast("-999" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_3_strict "${const_sql_29_3}"
    testFoldConst("${const_sql_29_3}")
    def const_sql_29_4 = """select "-9", cast(cast("-9" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_4_strict "${const_sql_29_4}"
    testFoldConst("${const_sql_29_4}")
    def const_sql_29_5 = """select "-1", cast(cast("-1" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_5_strict "${const_sql_29_5}"
    testFoldConst("${const_sql_29_5}")
    def const_sql_29_6 = """select "0", cast(cast("0" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_6_strict "${const_sql_29_6}"
    testFoldConst("${const_sql_29_6}")
    def const_sql_29_7 = """select "1", cast(cast("1" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_7_strict "${const_sql_29_7}"
    testFoldConst("${const_sql_29_7}")
    def const_sql_29_8 = """select "9", cast(cast("9" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_8_strict "${const_sql_29_8}"
    testFoldConst("${const_sql_29_8}")
    def const_sql_29_9 = """select "999", cast(cast("999" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_9_strict "${const_sql_29_9}"
    testFoldConst("${const_sql_29_9}")
    def const_sql_29_10 = """select "9000", cast(cast("9000" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_10_strict "${const_sql_29_10}"
    testFoldConst("${const_sql_29_10}")
    def const_sql_29_11 = """select "9001", cast(cast("9001" as largeint) as decimalv3(4, 0));"""
    qt_sql_29_11_strict "${const_sql_29_11}"
    testFoldConst("${const_sql_29_11}")
    def const_sql_29_12 = """select "9999", cast(cast("9999" as largeint) as decimalv3(4, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_30_0 = """select "-99", cast(cast("-99" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_0_strict "${const_sql_30_0}"
    testFoldConst("${const_sql_30_0}")
    def const_sql_30_1 = """select "-91", cast(cast("-91" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_1_strict "${const_sql_30_1}"
    testFoldConst("${const_sql_30_1}")
    def const_sql_30_2 = """select "-90", cast(cast("-90" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_2_strict "${const_sql_30_2}"
    testFoldConst("${const_sql_30_2}")
    def const_sql_30_3 = """select "-9", cast(cast("-9" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_3_strict "${const_sql_30_3}"
    testFoldConst("${const_sql_30_3}")
    def const_sql_30_4 = """select "-1", cast(cast("-1" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_4_strict "${const_sql_30_4}"
    testFoldConst("${const_sql_30_4}")
    def const_sql_30_5 = """select "0", cast(cast("0" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_5_strict "${const_sql_30_5}"
    testFoldConst("${const_sql_30_5}")
    def const_sql_30_6 = """select "1", cast(cast("1" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_6_strict "${const_sql_30_6}"
    testFoldConst("${const_sql_30_6}")
    def const_sql_30_7 = """select "9", cast(cast("9" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_7_strict "${const_sql_30_7}"
    testFoldConst("${const_sql_30_7}")
    def const_sql_30_8 = """select "90", cast(cast("90" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_8_strict "${const_sql_30_8}"
    testFoldConst("${const_sql_30_8}")
    def const_sql_30_9 = """select "91", cast(cast("91" as largeint) as decimalv3(4, 2));"""
    qt_sql_30_9_strict "${const_sql_30_9}"
    testFoldConst("${const_sql_30_9}")
    def const_sql_30_10 = """select "99", cast(cast("99" as largeint) as decimalv3(4, 2));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_31_0 = """select "-9", cast(cast("-9" as largeint) as decimalv3(4, 3));"""
    qt_sql_31_0_strict "${const_sql_31_0}"
    testFoldConst("${const_sql_31_0}")
    def const_sql_31_1 = """select "-8", cast(cast("-8" as largeint) as decimalv3(4, 3));"""
    qt_sql_31_1_strict "${const_sql_31_1}"
    testFoldConst("${const_sql_31_1}")
    def const_sql_31_2 = """select "-1", cast(cast("-1" as largeint) as decimalv3(4, 3));"""
    qt_sql_31_2_strict "${const_sql_31_2}"
    testFoldConst("${const_sql_31_2}")
    def const_sql_31_3 = """select "0", cast(cast("0" as largeint) as decimalv3(4, 3));"""
    qt_sql_31_3_strict "${const_sql_31_3}"
    testFoldConst("${const_sql_31_3}")
    def const_sql_31_4 = """select "1", cast(cast("1" as largeint) as decimalv3(4, 3));"""
    qt_sql_31_4_strict "${const_sql_31_4}"
    testFoldConst("${const_sql_31_4}")
    def const_sql_31_5 = """select "8", cast(cast("8" as largeint) as decimalv3(4, 3));"""
    qt_sql_31_5_strict "${const_sql_31_5}"
    testFoldConst("${const_sql_31_5}")
    def const_sql_31_6 = """select "9", cast(cast("9" as largeint) as decimalv3(4, 3));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_32_0 = """select "-999999999", cast(cast("-999999999" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_0_strict "${const_sql_32_0}"
    testFoldConst("${const_sql_32_0}")
    def const_sql_32_1 = """select "-900000001", cast(cast("-900000001" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_1_strict "${const_sql_32_1}"
    testFoldConst("${const_sql_32_1}")
    def const_sql_32_2 = """select "-900000000", cast(cast("-900000000" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_2_strict "${const_sql_32_2}"
    testFoldConst("${const_sql_32_2}")
    def const_sql_32_3 = """select "-99999999", cast(cast("-99999999" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_3_strict "${const_sql_32_3}"
    testFoldConst("${const_sql_32_3}")
    def const_sql_32_4 = """select "-9", cast(cast("-9" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_4_strict "${const_sql_32_4}"
    testFoldConst("${const_sql_32_4}")
    def const_sql_32_5 = """select "-1", cast(cast("-1" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_5_strict "${const_sql_32_5}"
    testFoldConst("${const_sql_32_5}")
    def const_sql_32_6 = """select "0", cast(cast("0" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_6_strict "${const_sql_32_6}"
    testFoldConst("${const_sql_32_6}")
    def const_sql_32_7 = """select "1", cast(cast("1" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_7_strict "${const_sql_32_7}"
    testFoldConst("${const_sql_32_7}")
    def const_sql_32_8 = """select "9", cast(cast("9" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_8_strict "${const_sql_32_8}"
    testFoldConst("${const_sql_32_8}")
    def const_sql_32_9 = """select "99999999", cast(cast("99999999" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_9_strict "${const_sql_32_9}"
    testFoldConst("${const_sql_32_9}")
    def const_sql_32_10 = """select "900000000", cast(cast("900000000" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_10_strict "${const_sql_32_10}"
    testFoldConst("${const_sql_32_10}")
    def const_sql_32_11 = """select "900000001", cast(cast("900000001" as largeint) as decimalv3(9, 0));"""
    qt_sql_32_11_strict "${const_sql_32_11}"
    testFoldConst("${const_sql_32_11}")
    def const_sql_32_12 = """select "999999999", cast(cast("999999999" as largeint) as decimalv3(9, 0));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_33_0 = """select "-99999", cast(cast("-99999" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_0_strict "${const_sql_33_0}"
    testFoldConst("${const_sql_33_0}")
    def const_sql_33_1 = """select "-90001", cast(cast("-90001" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_1_strict "${const_sql_33_1}"
    testFoldConst("${const_sql_33_1}")
    def const_sql_33_2 = """select "-90000", cast(cast("-90000" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_2_strict "${const_sql_33_2}"
    testFoldConst("${const_sql_33_2}")
    def const_sql_33_3 = """select "-9999", cast(cast("-9999" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_3_strict "${const_sql_33_3}"
    testFoldConst("${const_sql_33_3}")
    def const_sql_33_4 = """select "-9", cast(cast("-9" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_4_strict "${const_sql_33_4}"
    testFoldConst("${const_sql_33_4}")
    def const_sql_33_5 = """select "-1", cast(cast("-1" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_5_strict "${const_sql_33_5}"
    testFoldConst("${const_sql_33_5}")
    def const_sql_33_6 = """select "0", cast(cast("0" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_6_strict "${const_sql_33_6}"
    testFoldConst("${const_sql_33_6}")
    def const_sql_33_7 = """select "1", cast(cast("1" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_7_strict "${const_sql_33_7}"
    testFoldConst("${const_sql_33_7}")
    def const_sql_33_8 = """select "9", cast(cast("9" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_8_strict "${const_sql_33_8}"
    testFoldConst("${const_sql_33_8}")
    def const_sql_33_9 = """select "9999", cast(cast("9999" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_9_strict "${const_sql_33_9}"
    testFoldConst("${const_sql_33_9}")
    def const_sql_33_10 = """select "90000", cast(cast("90000" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_10_strict "${const_sql_33_10}"
    testFoldConst("${const_sql_33_10}")
    def const_sql_33_11 = """select "90001", cast(cast("90001" as largeint) as decimalv3(9, 4));"""
    qt_sql_33_11_strict "${const_sql_33_11}"
    testFoldConst("${const_sql_33_11}")
    def const_sql_33_12 = """select "99999", cast(cast("99999" as largeint) as decimalv3(9, 4));"""
    ...
    sql "set enable_strict_cast=true;"
    def const_sql_34_0 = """select "-9", cast(cast("-9" as largeint) as decimalv3(9, 8));"""
    qt_sql_34_0_strict "${const_sql_34_0}"
    testFoldConst("${const_sql_34_0}")
    def const_sql_34_1 = """select "-8", cast(cast("-8" as largeint) as decimalv3(9, 8));"""
    qt_sql_34_1_strict "${const_sql_34_1}"
    testFoldConst("${const_sql_34_1}")
    def const_sql_34_2 = """select "-1", cast(cast("-1" as largeint) as decimalv3(9, 8));"""
    qt_sql_34_2_strict "${const_sql_34_2}"
    testFoldConst("${const_sql_34_2}")
    def const_sql_34_3 = """select "0", cast(cast("0" as largeint) as decimalv3(9, 8));"""
    qt_sql_34_3_strict "${const_sql_34_3}"
    testFoldConst("${const_sql_34_3}")
    def const_sql_34_4 = """select "1", cast(cast("1" as largeint) as decimalv3(9, 8));"""
    qt_sql_34_4_strict "${const_sql_34_4}"
    testFoldConst("${const_sql_34_4}")
    def const_sql_34_5 = """select "8", cast(cast("8" as largeint) as decimalv3(9, 8));"""
    qt_sql_34_5_strict "${const_sql_34_5}"
    testFoldConst("${const_sql_34_5}")
    def const_sql_34_6 = """select "9", cast(cast("9" as largeint) as decimalv3(9, 8));"""
