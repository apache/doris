...
suite("test_cast_to_decimal_from_str_invalid_input") {
...
a"),(15, "12a3.456"),(16, "123a.456"),(17, "123.a456"),(18, "123.4a56"),(19, "+-123.456"),
    ...
    def test_cast_to_decimal_from_str_invalid_input_data_start_index = 0
    def test_cast_to_decimal_from_str_invalid_input_data_end_index = 53
    for (int data_index = test_cast_to_decimal_from_str_invalid_input_data_start_index; data_index < test_cast_to_decimal_from_str_invalid_input_data_end_index; data_index++) {
        test {
            sql "select f1, cast(f2 as decimalv3(9, 3)) from test_cast_to_decimal_from_str_invalid_input where f1 = ${data_index}"
            exception ""
        }
    }
    sql "set enable_strict_cast=false;"
    qt_sql_0 'select f1, cast(f2 as decimalv3(9, 3)) from test_cast_to_decimal_from_str_invalid_input order by 1;'
