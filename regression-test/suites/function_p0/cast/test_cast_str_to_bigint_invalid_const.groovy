...
suite("test_cast_str_to_bigint_invalid_const") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.test_from_string --gen_regression_case
    def test_cast_str_to_bigint_invalid_strs = ["""""",""".""",""" ""","""	""","""abc""","""abc1231abc12123abc""","""1 23""","""1	23""","""1.2.3""","""a123.456""",""" a123.456""","""	a123.456""","""123.456a""","""123.456a	""","""123.456	a""","""123.456
a""","""12a3.456""","""123a.456""","""123.a456""","""123.4a56""",
    ...
    for (test_str in test_cast_str_to_bigint_invalid_strs) {
       test {
    ...
    for (test_str in test_cast_str_to_bigint_invalid_strs) {
        qt_sql_test_cast_str_to_bigint_invalid """select cast("${test_str}" as bigint);"""
    }
}