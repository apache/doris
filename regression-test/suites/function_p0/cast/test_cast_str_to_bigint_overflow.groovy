...
suite("test_cast_str_to_bigint_overflow") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.test_from_string --gen_regression_case
    sql "drop table if exists test_cast_str_to_bigint_overflow_0;"
    sql "create table test_cast_str_to_bigint_overflow_0(f1 int, f2 string) properties('replication_num'='1');"
    sql """insert into test_cast_str_to_bigint_overflow_0 values (0, "9223372036854775808"),(1, "-9223372036854775809"),(2, "9223372036854775809"),(3, "-9223372036854775810"),(4, "9223372036854775810"),(5, "-9223372036854775811"),(6, "9223372036854775811"),(7, "-9223372036854775812"),(8, "9223372036854775812"),(9, "-9223372036854775813"),(10, "9223372036854775813"),(11, "-9223372036854775814"),(12, "9223372036854775814"),(13, "-9223372036854775815"),(14, "9223372036854775815"),(15, "-9223372036854775816"),(16, "9223372036854775816"),(17, "-9223372036854775817"),(18, "9223372036854775817"),(19, "-9223372036854775818"),
    ...
    def test_cast_str_to_bigint_overflow_data_start_index = 0
    def test_cast_str_to_bigint_overflow_data_end_index = 44
    for (int data_index = test_cast_str_to_bigint_overflow_data_start_index; data_index < test_cast_str_to_bigint_overflow_data_end_index; data_index++) {
        test {
            sql "select f1, cast(f2 as bigint) from test_cast_str_to_bigint_overflow where f1 = ${data_index}"
            exception ""
        }
    }
    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as bigint) from test_cast_str_to_bigint_overflow_0 order by 1;'
