...
suite("test_cast_str_to_float_invalid_const") {
...
a""","""12a3.456""","""123a.456""","""123.a456""","""123.4a56""","""+-123.456""",
    ...
    for (test_str in test_cast_str_to_float_invalid_strs) {
        test {
    ...
    for (test_str in test_cast_str_to_float_invalid_strs) {
        qt_sql_test_cast_str_to_float_invalid """select cast("${test_str}" as float);"""
    }
}