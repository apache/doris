...
suite("test_cast_str_to_largeint_overflow") {
    ...
    def test_cast_str_to_largeint_overflow_data_start_index = 0
    def test_cast_str_to_largeint_overflow_data_end_index = 42
    for (int data_index = test_cast_str_to_largeint_overflow_data_start_index; data_index < test_cast_str_to_largeint_overflow_data_end_index; data_index++) {
        test {
            sql "select f1, cast(f2 as largeint) from test_cast_str_to_largeint_overflow where f1 = ${data_index}"
            exception ""
        }
    }
    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as largeint) from test_cast_str_to_largeint_overflow_0 order by 1;'
