...
suite("test_cast_to_int_from_decimal64_10_5") {
    ...
    sql "drop table if exists test_cast_to_int_from_decimal64_10_5_0;"
    sql "create table test_cast_to_int_from_decimal64_10_5_0(f1 int, f2 decimalv3(10, 5)) properties('replication_num'='1');"
    sql """insert into test_cast_to_int_from_decimal64_10_5_0 values (0, "0.00000"),(1, "0.00000"),(2, "0.00001"),(3, "-0.00001"),(4, "0.00009"),(5, "-0.00009"),(6, "0.99999"),(7, "-0.99999"),(8, "0.99998"),(9, "-0.99998"),(10, "0.09999"),(11, "-0.09999"),(12, "0.90000"),(13, "-0.90000"),(14, "0.90001"),(15, "-0.90001"),(16, "1.00000"),(17, "-1.00000"),(18, "1.00001"),(19, "-1.00001"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as int) from test_cast_to_int_from_decimal64_10_5_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as int) from test_cast_to_int_from_decimal64_10_5_0 order by 1;'
