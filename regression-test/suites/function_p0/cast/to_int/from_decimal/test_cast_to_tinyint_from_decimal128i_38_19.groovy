...
suite("test_cast_to_tinyint_from_decimal128i_38_19") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_tinyint_from_decimal128i_38_19_0;"
    sql "create table test_cast_to_tinyint_from_decimal128i_38_19_0(f1 int, f2 decimalv3(38, 19)) properties('replication_num'='1');"
    sql """insert into test_cast_to_tinyint_from_decimal128i_38_19_0 values (0, "0.0000000000000000000"),(1, "0.0000000000000000001"),(2, "0.0000000000000000009"),(3, "0.9999999999999999999"),(4, "0.9999999999999999998"),(5, "0.0999999999999999999"),(6, "0.9000000000000000000"),(7, "0.9000000000000000001"),(8, "1.0000000000000000000"),(9, "1.0000000000000000001"),(10, "1.0000000000000000009"),(11, "1.9999999999999999999"),(12, "1.9999999999999999998"),(13, "1.0999999999999999999"),(14, "1.9000000000000000000"),(15, "1.9000000000000000001"),(16, "9.0000000000000000000"),(17, "9.0000000000000000001"),(18, "9.0000000000000000009"),(19, "9.9999999999999999999"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as tinyint) from test_cast_to_tinyint_from_decimal128i_38_19_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as tinyint) from test_cast_to_tinyint_from_decimal128i_38_19_0 order by 1;'
