...
suite("test_cast_to_smallint_from_decimal128v3_19_9") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_smallint_from_decimal128v3_19_9_0;"
    sql "create table test_cast_to_smallint_from_decimal128v3_19_9_0(f1 int, f2 decimalv3(19, 9)) properties('replication_num'='1');"
    sql """insert into test_cast_to_smallint_from_decimal128v3_19_9_0 values (0, "0.000000000"),(1, "0.000000001"),(2, "0.000000009"),(3, "0.999999999"),(4, "0.999999998"),(5, "0.099999999"),(6, "0.900000000"),(7, "0.900000001"),(8, "1.000000000"),(9, "1.000000001"),(10, "1.000000009"),(11, "1.999999999"),(12, "1.999999998"),(13, "1.099999999"),(14, "1.900000000"),(15, "1.900000001"),(16, "9.000000000"),(17, "9.000000001"),(18, "9.000000009"),(19, "9.999999999"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as smallint) from test_cast_to_smallint_from_decimal128v3_19_9_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as smallint) from test_cast_to_smallint_from_decimal128v3_19_9_0 order by 1;'
