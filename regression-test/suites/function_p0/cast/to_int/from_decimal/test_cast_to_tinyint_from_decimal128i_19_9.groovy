...
suite("test_cast_to_tinyint_from_decimal128i_19_9") {
    ...
    qt_sql_0_strict 'select f1, cast(f2 as tinyint) from test_cast_to_tinyint_from_decimal128i_19_9_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as tinyint) from test_cast_to_tinyint_from_decimal128i_19_9_0 order by 1;'
