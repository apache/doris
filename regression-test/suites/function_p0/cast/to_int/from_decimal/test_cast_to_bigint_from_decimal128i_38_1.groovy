...
suite("test_cast_to_bigint_from_decimal128i_38_1") {
    ...
    sql "drop table if exists test_cast_to_bigint_from_decimal128i_38_1_0;"
    sql "create table test_cast_to_bigint_from_decimal128i_38_1_0(f1 int, f2 decimalv3(38, 1)) properties('replication_num'='1');"
    sql """insert into test_cast_to_bigint_from_decimal128i_38_1_0 values (0, "0.0"),(1, "0.1"),(2, "0.9"),(3, "0.9"),(4, "0.8"),(5, "0.0"),(6, "0.9"),(7, "0.8"),(8, "1.0"),(9, "1.1"),(10, "1.9"),(11, "1.9"),(12, "1.8"),(13, "1.0"),(14, "1.9"),(15, "1.8"),(16, "9.0"),(17, "9.1"),(18, "9.9"),(19, "9.9"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as bigint) from test_cast_to_bigint_from_decimal128i_38_1_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as bigint) from test_cast_to_bigint_from_decimal128i_38_1_0 order by 1;'
