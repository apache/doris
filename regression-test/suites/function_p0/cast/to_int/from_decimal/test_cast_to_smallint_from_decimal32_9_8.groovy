...
suite("test_cast_to_smallint_from_decimal32_9_8") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_smallint_from_decimal32_9_8_0;"
    sql "create table test_cast_to_smallint_from_decimal32_9_8_0(f1 int, f2 decimalv3(9, 8)) properties('replication_num'='1');"
    sql """insert into test_cast_to_smallint_from_decimal32_9_8_0 values (0, "0.00000000"),(1, "0.00000000"),(2, "0.00000001"),(3, "-0.00000001"),(4, "0.00000009"),(5, "-0.00000009"),(6, "0.99999999"),(7, "-0.99999999"),(8, "0.99999998"),(9, "-0.99999998"),(10, "0.09999999"),(11, "-0.09999999"),(12, "0.90000000"),(13, "-0.90000000"),(14, "0.90000001"),(15, "-0.90000001"),(16, "1.00000000"),(17, "-1.00000000"),(18, "1.00000001"),(19, "-1.00000001"),
    ...
    qt_sql_0_strict 'select f1, cast(f2 as smallint) from test_cast_to_smallint_from_decimal32_9_8_0 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_0_non_strict 'select f1, cast(f2 as smallint) from test_cast_to_smallint_from_decimal32_9_8_0 order by 1;'
