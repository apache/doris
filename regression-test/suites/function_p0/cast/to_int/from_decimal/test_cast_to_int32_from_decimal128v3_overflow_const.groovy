...
suite("test_cast_to_int32_from_decimal128v3_overflow_const") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int32_from_decimal128v3_overflow_0_test_data = ["""2147483648""","""-2147483649""","""9999999999999999999""","""-9999999999999999999""","""9999999999999999998""","""-9999999999999999998"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int32_from_decimal128v3_overflow_0_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int32_from_decimal128v3_overflow_0_test_data) {
        qt_sql_test_cast_to_int32_from_decimal128v3_overflow_0 """select cast(cast("${test_str}" as decimalv3(19, 0)) as int);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 0)) as int);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int32_from_decimal128v3_overflow_1_test_data = ["""2147483648.000000000""","""2147483648.000000001""","""2147483648.000000009""","""2147483648.999999999""","""2147483648.999999998""","""2147483648.099999999""","""2147483648.900000000""","""2147483648.900000001""","""-2147483649.000000000""","""-2147483649.000000001""","""-2147483649.000000009""","""-2147483649.999999999""","""-2147483649.999999998""","""-2147483649.099999999""","""-2147483649.900000000""","""-2147483649.900000001""","""9999999999.000000000""","""9999999999.000000001""","""9999999999.000000009""","""9999999999.999999999""",
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int32_from_decimal128v3_overflow_1_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int32_from_decimal128v3_overflow_1_test_data) {
        qt_sql_test_cast_to_int32_from_decimal128v3_overflow_1 """select cast(cast("${test_str}" as decimalv3(19, 9)) as int);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 9)) as int);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int32_from_decimal128v3_overflow_4_test_data = ["""2147483648""","""-2147483649""","""99999999999999999999999999999999999999""","""-99999999999999999999999999999999999999""","""99999999999999999999999999999999999998""","""-99999999999999999999999999999999999998"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int32_from_decimal128v3_overflow_4_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int32_from_decimal128v3_overflow_4_test_data) {
        qt_sql_test_cast_to_int32_from_decimal128v3_overflow_4 """select cast(cast("${test_str}" as decimalv3(38, 0)) as int);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(38, 0)) as int);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int32_from_decimal128v3_overflow_5_test_data = ["""2147483648.0""","""2147483648.1""","""2147483648.9""","""2147483648.9""","""2147483648.8""","""2147483648.0""","""2147483648.9""","""2147483648.8""","""-2147483649.0""","""-2147483649.1""","""-2147483649.9""","""-2147483649.9""","""-2147483649.8""","""-2147483649.0""","""-2147483649.9""","""-2147483649.8""","""9999999999999999999999999999999999999.0""","""9999999999999999999999999999999999999.1""","""9999999999999999999999999999999999999.9""","""9999999999999999999999999999999999999.9""",
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int32_from_decimal128v3_overflow_5_test_data) {
            test {
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int32_from_decimal128v3_overflow_6_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int32_from_decimal128v3_overflow_6_test_data) {
        qt_sql_test_cast_to_int32_from_decimal128v3_overflow_6 """select cast(cast("${test_str}" as decimalv3(38, 19)) as int);"""
