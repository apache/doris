...
suite("test_cast_to_int16_from_decimal128v3_overflow_const") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal128v3_overflow_0_test_data = ["""32768""","""-32769""","""9999999999999999999""","""-9999999999999999999""","""9999999999999999998""","""-9999999999999999998"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal128v3_overflow_0_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal128v3_overflow_0_test_data) {
        qt_sql_test_cast_to_int16_from_decimal128v3_overflow_0 """select cast(cast("${test_str}" as decimalv3(19, 0)) as smallint);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 0)) as smallint);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal128v3_overflow_1_test_data = ["""32768.000000000""","""32768.000000001""","""32768.000000009""","""32768.999999999""","""32768.999999998""","""32768.099999999""","""32768.900000000""","""32768.900000001""","""-32769.000000000""","""-32769.000000001""","""-32769.000000009""","""-32769.999999999""","""-32769.999999998""","""-32769.099999999""","""-32769.900000000""","""-32769.900000001""","""9999999999.000000000""","""9999999999.000000001""","""9999999999.000000009""","""9999999999.999999999""",
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal128v3_overflow_1_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal128v3_overflow_1_test_data) {
        qt_sql_test_cast_to_int16_from_decimal128v3_overflow_1 """select cast(cast("${test_str}" as decimalv3(19, 9)) as smallint);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(19, 9)) as smallint);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal128v3_overflow_4_test_data = ["""32768""","""-32769""","""99999999999999999999999999999999999999""","""-99999999999999999999999999999999999999""","""99999999999999999999999999999999999998""","""-99999999999999999999999999999999999998"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal128v3_overflow_4_test_data) {
            test {
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal128v3_overflow_5_test_data) {
            test {
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal128v3_overflow_6_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal128v3_overflow_6_test_data) {
        qt_sql_test_cast_to_int16_from_decimal128v3_overflow_6 """select cast(cast("${test_str}" as decimalv3(38, 19)) as smallint);"""
