...
suite("test_cast_to_int16_from_decimal64_overflow_const") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal64_overflow_0_test_data = ["""32768""","""-32769""","""9999999999""","""-9999999999""","""9999999998""","""-9999999998"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal64_overflow_0_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal64_overflow_0_test_data) {
        qt_sql_test_cast_to_int16_from_decimal64_overflow_0 """select cast(cast("${test_str}" as decimalv3(10, 0)) as smallint);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(10, 0)) as smallint);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal64_overflow_1_test_data = ["""32768.00000""","""32768.00001""","""32768.00009""","""32768.99999""","""32768.99998""","""32768.09999""","""32768.90000""","""32768.90001""","""-32769.00000""","""-32769.00001""","""-32769.00009""","""-32769.99999""","""-32769.99998""","""-32769.09999""","""-32769.90000""","""-32769.90001""","""99999.00000""","""99999.00001""","""99999.00009""","""99999.99999""",
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal64_overflow_1_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal64_overflow_1_test_data) {
        qt_sql_test_cast_to_int16_from_decimal64_overflow_1 """select cast(cast("${test_str}" as decimalv3(10, 5)) as smallint);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(10, 5)) as smallint);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal64_overflow_4_test_data = ["""32768""","""-32769""","""999999999999999999""","""-999999999999999999""","""999999999999999998""","""-999999999999999998"""]
    sql "set enable_strict_cast=true;"

    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal64_overflow_4_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal64_overflow_4_test_data) {
        qt_sql_test_cast_to_int16_from_decimal64_overflow_4 """select cast(cast("${test_str}" as decimalv3(18, 0)) as smallint);"""
        testFoldConst("""select cast(cast("${test_str}" as decimalv3(18, 0)) as smallint);""")
    }
    sql "set debug_skip_fold_constant = true;"
    def test_cast_to_int16_from_decimal64_overflow_5_test_data = ["""32768.0""","""32768.1""","""32768.9""","""32768.9""","""32768.8""","""32768.0""","""32768.9""","""32768.8""","""-32769.0""","""-32769.1""","""-32769.9""","""-32769.9""","""-32769.8""","""-32769.0""","""-32769.9""","""-32769.8""","""99999999999999999.0""","""99999999999999999.1""","""99999999999999999.9""","""99999999999999999.9""",
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal64_overflow_5_test_data) {
            test {
    ...
    for (b in ["false", "true"]) {
        sql """set debug_skip_fold_constant = "${b}";"""
        for (test_str in test_cast_to_int16_from_decimal64_overflow_6_test_data) {
            test {
    ...
    for (test_str in test_cast_to_int16_from_decimal64_overflow_6_test_data) {
        qt_sql_test_cast_to_int16_from_decimal64_overflow_6 """select cast(cast("${test_str}" as decimalv3(18, 9)) as smallint);"""
