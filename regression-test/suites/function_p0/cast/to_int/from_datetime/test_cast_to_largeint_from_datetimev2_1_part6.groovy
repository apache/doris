...
suite("test_cast_to_largeint_from_datetimev2_1_part6") {
    ...
    qt_sql_6_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_datetimev2_1_part6_6 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_6_non_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_datetimev2_1_part6_6 order by 1;'
