...
suite("test_cast_to_largeint_from_datetimev2_0_part9") {
    ...
    qt_sql_9_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_datetimev2_0_part9_9 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_9_non_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_datetimev2_0_part9_9 order by 1;'
