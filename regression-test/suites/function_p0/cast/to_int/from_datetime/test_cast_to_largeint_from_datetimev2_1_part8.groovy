...
suite("test_cast_to_largeint_from_datetimev2_1_part8") {
    ...
    qt_sql_8_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_datetimev2_1_part8_8 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_8_non_strict 'select f1, cast(f2 as largeint) from test_cast_to_largeint_from_datetimev2_1_part8_8 order by 1;'
