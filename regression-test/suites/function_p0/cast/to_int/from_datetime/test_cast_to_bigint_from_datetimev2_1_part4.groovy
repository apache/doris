...
suite("test_cast_to_bigint_from_datetimev2_1_part4") {

    // This test case is generated from the correspoinding be UT test case,
    // update this case if the correspoinding be UT test case is updated,
    // e.g.: ../run-be-ut.sh --run --filter=FunctionCastToDecimalTest.* --gen_regression_case
    sql "drop table if exists test_cast_to_bigint_from_datetimev2_1_part4_4;"
    sql "create table test_cast_to_bigint_from_datetimev2_1_part4_4(f1 int, f2 datetimev2(1)) properties('replication_num'='1');"
    sql """insert into test_cast_to_bigint_from_datetimev2_1_part4_4 values (0, "0010-01-28 01:59:59.0"),(1, "0010-01-28 01:59:59.0"),(2, "0010-01-28 01:59:59.9"),(3, "0010-01-28 23:00:00.0"),(4, "0010-01-28 23:00:00.0"),(5, "0010-01-28 23:00:00.9"),(6, "0010-01-28 23:00:01.0"),(7, "0010-01-28 23:00:01.0"),(8, "0010-01-28 23:00:01.9"),(9, "0010-01-28 23:00:59.0"),(10, "0010-01-28 23:00:59.0"),(11, "0010-01-28 23:00:59.9"),(12, "0010-01-28 23:01:00.0"),(13, "0010-01-28 23:01:00.0"),(14, "0010-01-28 23:01:00.9"),(15, "0010-01-28 23:01:01.0"),(16, "0010-01-28 23:01:01.0"),(17, "0010-01-28 23:01:01.9"),(18, "0010-01-28 23:01:59.0"),(19, "0010-01-28 23:01:59.0"),
    ...
    qt_sql_4_strict 'select f1, cast(f2 as bigint) from test_cast_to_bigint_from_datetimev2_1_part4_4 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_4_non_strict 'select f1, cast(f2 as bigint) from test_cast_to_bigint_from_datetimev2_1_part4_4 order by 1;'
