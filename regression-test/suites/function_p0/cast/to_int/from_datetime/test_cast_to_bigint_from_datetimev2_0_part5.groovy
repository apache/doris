...
suite("test_cast_to_bigint_from_datetimev2_0_part5") {
    ...
    qt_sql_5_strict 'select f1, cast(f2 as bigint) from test_cast_to_bigint_from_datetimev2_0_part5_5 order by 1;'

    sql "set enable_strict_cast=false;"
    qt_sql_5_non_strict 'select f1, cast(f2 as bigint) from test_cast_to_bigint_from_datetimev2_0_part5_5 order by 1;'
