...
suite("test_s3_tvf", "p2") {
   ...
   for (String table : basicTables) {
    attributeList.add(new TvfAttribute(table, "c1 as k00,c2 as k01,c3 as k02,c4 as k03,c5 as k04,c6 as k05,c7 as k06,c8 as k07,c9 as k08,c10 as k09,c11 as k10,c12 as k11,c13 as k12,c14 as k13,c15 as k14,c16 as k15,c17 as k16,c18 as k17,c19 as k18, kd16", "K00,K01,K02,K03,K04,K05,K06,K07,K08,K09,K10,K11,K12,K13,K14,K15,K16,K17,K18,Kd16", "", "")
                 .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/kd16=abcdefg/basic_data.csv")
   ...
   attributeList.add(new TvfAttribute("agg_tbl_basic_tvf", "c1 as k00,c2 as k01,c3 as k02,c4 as k03,c5 as k04,c6 as k05,c7 as k06,c8 as k07,c9 as k08,c10 as k09,c11 as k10,c12 as k11,c13 as k12,c14 as k13,c15 as k14,c16 as k15,c17 as k16,c18 as k17,c19 as k18, to_bitmap(c6) as k19, HLL_HASH(c6) as k20, TO_QUANTILE_STATE(c5, 1.0) as k21, to_bitmap(c6) as kd19, HLL_HASH(c6) as kd20, TO_QUANTILE_STATE(c5, 1.0) as kd21, kd16",
    ...
    //             .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/kd16=[1,2,3,4]/basic_array_data.csv")
    //             .addProperty("format", "csv")
    //             .addProperty("column_separator", "|")
    //             .addProperty("force_parsing_by_standard_uri", "true")
    //             .addProperty("path_partition_keys", "kd16"))
    ...
    for (String table : basicTables) {
        attributeList.add(new TvfAttribute(table, "c1 as k00,c2 as k01,c3 as k02,c4 as k03,c5 as k04,c6 as k05,c7 as k06,c8 as k07,c9 as k08,c10 as k09,c11 as k10,c12 as k11,c13 as k12,c14 as k13,c15 as k14,c16 as k15,c17 as k16,c18 as k17,c19 as k18, kd16, kd17", "K00,K01,K02,K03,K04,K05,K06,K07,K08,K09,K10,K11,K12,K13,K14,K15,K16,K17,K18,Kd16, kd17", "", "")
                 .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/kd16=abcdefg/kd17=hello/basic_data.csv")
                 .addProperty("format", "csv")
                 .addProperty("column_separator", "|")
                 .addProperty("use_path_style", "true")
                 .addProperty("force_parsing_by_standard_uri", "true")
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["K00", "K01", "K02", "K03", "K04", "K05", "K06", "K07", "K08", "K09", "K10", "K11", "K12", "K13", "K14", "K15", "K16", "K17", "K18"], "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data_trim_double_quotes.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["K00", "K01", "K02", "K03", "K04", "K05", "K06", "K07", "K08", "K09", "K10", "K11", "K12", "K13", "K14", "K15", "K16", "K17"], "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data_trim_double_quotes.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true")
                .addProperty("trim_double_quotes", "true"))
    ...
    //             "uri" = "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.json",
    //             "format" = "json",
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, "*","k00,k01,k12", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.json")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, "k00,k01,k02,k03,k04", "k00,k01,k02,k03,k04", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.json")
                .addProperty("format", "json")
                .addProperty("read_json_by_line", "false")
                .addProperty("strip_outer_array", "true")
                .addProperty("column_separator", "|")
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, "*","k00,k01,k12", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data_by_line.json")
                .addProperty("format", "json")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, "k00,k01,k02,k03,k04", "k00,k01,k02,k03,k04", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data_by_line.json")
                .addProperty("format", "json")
                .addProperty("read_json_by_line", "true")
                .addProperty("strip_outer_array", "false")
                .addProperty("column_separator", "|")
    ...
    attributeList.add(new TvfAttribute("nest_tbl_basic_tvf", "id, city, code", "id, city, code", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/nest_json.json")
                .addProperty("format", "json")
                .addProperty("read_json_by_line", "true")
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["K00", "K01", "K02", "K03", "K04", "K05", "K06", "K07", "K08", "K09", "K10", "K11", "K12", "K13", "K14", "K15", "K16", "K17", "K18"], "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true"))
    }
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["K00", "K01", "K02", "K03", "K04", "K05", "K06", "K07", "K08", "K09", "K10", "K11", "K12", "K13", "K14", "K15", "K16", "K17"], "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true"))
    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|"))
    }
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|"))
    }
...
//    for(String table : basicTables) {
//        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
//                .addProperty("uri", "https://cos.ap-beijing.myqcloud.com/${s3BucketName}/regression/load/data/basic_data.csv")
//                .addProperty("format", "csv")
//                .addProperty("column_separator", "|")
//                .addProperty("use_path_style", "true"))
//    }
...
//    attributeList.add(new TvfAttribute("agg_tbl_basic_tvf", "c1 as k00,c2 as k01,c3 as k02,c4 as k03,c5 as k04,c6 as k05,c7 as k06,c8 as k07,c9 as k08,c10 as k09,c11 as k10,c12 as k11,c13 as k12,c14 as k13,c15 as k14,c16 as k15,c17 as k16,c18 as k17,c19 as k18, to_bitmap(c6) as k19, HLL_HASH(c6) as k20, TO_QUANTILE_STATE(c5, 1.0) as k21, to_bitmap(c6) as kd19, HLL_HASH(c6) as kd20, TO_QUANTILE_STATE(c5, 1.0) as kd21",
//            "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17,k18,k19,k20,k21,kd19,kd20,kd21" ,"", "")
//            .addProperty("uri", "https://cos.ap-beijing.myqcloud.com/${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv")
//            .addProperty("format", "csv")
//            .addProperty("column_separator", "|")
//            .addProperty("use_path_style", "true"))
//
//    for(String table : arrayTables) {
//        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
//                .addProperty("uri", "https://cos.ap-beijing.myqcloud.com/${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv")
//                .addProperty("format", "csv")
//                .addProperty("column_separator", "|")
//                .addProperty("use_path_style", "true"))
//    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "", true)
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data_with_errors.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true"))
    }
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "kd01", "kd02", "kd03", "kd04", "kd05", "kd06", "kd07", "kd08", "kd09", "kd10", "kd11", "kd12", "kd13", "kd14", "kd15", "kd16"], "", "", true)
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data_with_errors.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true"))
    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv.gz")
                .addProperty("format", "csv")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv.gz")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("compress_type", "GZ"))
    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv.bz2")
                .addProperty("format", "csv")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv.bz2")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("compress_type", "BZ2"))
    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv.lz4")
                .addProperty("format", "csv")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv.lz4")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("compress_type", "LZ4FRAME"))
    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.csv.lzo")
                .addProperty("format", "csv")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
                .addProperty("uri", "https://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv.lzo")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("compress_type", "LZO"))
    }
    ...
    // for(String table : basicTables) {
    //     attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17", "k18"], "", "")
    //             .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data_test.csv.deflate")
    //             .addProperty("format", "csv")
    //             .addProperty("column_separator", "|")
    ...
    // for(String table : arrayTables) {
    //     attributeList.add(new TvfAttribute(table, ["k00", "k01", "k02", "k03", "k04", "k05", "k06", "k07", "k08", "k09", "k10", "k11", "k12", "k13", "k14", "k15", "k16", "k17"], "", "")
    //             .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.csv.deflate")
    //             .addProperty("format", "csv")
    //             .addProperty("column_separator", "|")
    //             .addProperty("compress_type", "DEFLATE")
    //             .addProperty("force_parsing_by_standard_uri", "true"))
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17,k18","k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17,k18", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.parq")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17", "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.parq")
                .addProperty("format", "parquet")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true"))
    }
    ...
    for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17,k18","k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17,k18", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data.orc")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17", "k00,k01,k02,k03,k04,k05,k06,k07,k08,k09,k10,k11,k12,k13,k14,k15,k16,k17", "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data.orc")
                .addProperty("format", "orc")
                .addProperty("column_separator", "|")
                .addProperty("force_parsing_by_standard_uri", "true"))
    }
   ...
   for(String table : basicTables) {
        attributeList.add(new TvfAttribute(table, ["K00", "K01", "K02", "K03", "K04", "K05", "K06", "K07", "K08", "K09", "K10", "K11", "K12", "K13", "K14", "K15", "K16", "K17", "K18"], "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_data_by_line_delimiter.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
    ...
    for(String table : arrayTables) {
        attributeList.add(new TvfAttribute(table, ["K00", "K01", "K02", "K03", "K04", "K05", "K06", "K07", "K08", "K09", "K10", "K11", "K12", "K13", "K14", "K15", "K16", "K17"], "", "")
                .addProperty("uri", "s3://${s3BucketName}.cos.ap-beijing.myqcloud.com/regression/load/data/basic_array_data_by_tab_line_delimiter.csv")
                .addProperty("format", "csv")
                .addProperty("column_separator", "|")
                .addProperty("line_delimiter", "\t")
                .addProperty("force_parsing_by_standard_uri", "true"))
