...
suite("agg_sync_mv") {
    ...
    createMV("""create materialized view mv_sync3 as select id as a3, approx_count_distinct(kint) as a4 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync4 as select id as a5, collect_set(kint) as a6 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync5 as select id as a7, collect_list(kint) as a8 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync6 as select id as b1, corr(kint, kbint) as b2 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync7 as select id as b3, percentile_array(kint, [0.5,0.55,0.805]) as b4 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync8 as select id as b5, quantile_union(to_quantile_state(kbint, 2048)) as b6 from agg_mv_test group by id order by id;""")
    mv_rewrite_success("select id, quantile_union(to_quantile_state(kbint, 2048)) from agg_mv_test group by id order by id;", "mv_sync8")
    ...
    createMV("""create materialized view mv_sync9 as select id as b7, count_by_enum(kstr) as b8 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync10 as select id as c1, avg_weighted(ktint, kdbl) as c2 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync11 as select id as c3, bitmap_intersect(bitmap_hash(kbint)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync12 as select id as c4, bitmap_agg(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync13 as select id as c5, bitmap_union(bitmap_hash(kbint)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync15 as select id as c7, bitmap_union_int(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync16 as select id as c8, group_array_intersect(kaint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync17 as select id as d1, group_bit_and(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync18 as select id as d2, group_bit_or(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync19 as select id as d3, group_bit_xor(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync20 as select id as d4, group_bitmap_xor(bitmap_hash(kbint)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync21 as select id as d5, hll_union_agg(hll_hash(kbint)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync22 as select id as d6, hll_union(hll_hash(kbint)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync23 as select id as d7, intersect_count(bitmap_hash(kbint), kint, 3, 4) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync24 as select id as d8, group_concat(cast(abs(kint) as varchar)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync as select id as e1, linear_histogram(kint, 10) from agg_mv_test group by id order by id;""")
    mv_rewrite_success("select id, linear_histogram(kint, 10) from agg_mv_test group by id order by id;", "mv_sync")
    ...
    createMV("""create materialized view mv_sync25 as select id as e2, multi_distinct_group_concat(cast(abs(kint) as varchar)) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync26 as select id as e3, multi_distinct_sum0(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync27 as select id as e4, multi_distinct_sum(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync28 as select id as e5, histogram(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync29 as select id as e6, max_by(kint, kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync30 as select id as e7, min_by(kint, kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync31 as select id as e8, multi_distinct_count(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync33 as select id as f2, covar(kint, kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync35 as select id as f4, percentile(kbint, 0.6) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync39 as select id as f7, sequence_match('(?1)(?2)', kdtv2, kint = 1, kint = 2) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync40 as select id as f8, stddev(kint) as xx1 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync41 as select id as g1, stddev_pop(kint) as xx2 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync42 as select id as g2, stddev_samp(kint) as xx3 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync43 as select id as g3, sum0(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync44 as select id as g4, topn(kvchrs1, 3) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync45 as select id as g5, topn_array(kvchrs1, 3) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync46 as select id as g6, topn_weighted(kvchrs1, ktint, 3) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync47 as select id as g7, variance(kint) as xx7 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync48 as select id as g8, var_pop(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync49 as select id as s1, variance_samp(kint) ss1 from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync50 as select id as s2, var_samp(kint) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync51 as select id as s3, window_funnel(3600 * 3, 'default', kdtm, kint = 1, kint = 2) from agg_mv_test group by id order by id;""")
    ...
    createMV("""create materialized view mv_sync52 as select id as s4, map_agg(kint, kstr) from agg_mv_test group by id order by id;""")
    mv_rewrite_success("select id, map_agg(kint, kstr) from agg_mv_test group by id order by id;", "mv_sync52")
    ...
    createMV("""create materialized view mv_sync53 as select id as s5, array_agg(kstr) from agg_mv_test group by id order by id;""")
    mv_rewrite_success("select id, array_agg(kstr) from agg_mv_test group by id order by id;", "mv_sync53")
    ...
    createMV("""create materialized view mv_sync54 as select id as s6, retention(kdtm = '2012-03-11', kdtm = '2012-03-12') from agg_mv_test group by id order by id;""")
