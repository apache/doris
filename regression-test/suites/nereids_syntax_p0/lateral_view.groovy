...
suite("nereids_lateral_view") {
	...
	qt_sql_explode_bitmap1 """ select dt, e1 from test_explode_bitmap lateral view explode_bitmap(user_id) tmp1 as e1  lateral view explode_bitmap((user_id)) tmp1 as e2 order by dt, e1;"""
	qt_sql_explode_bitmap2 """ select dt, e1 from test_explode_bitmap lateral view explode_bitmap((user_id)) tmp1 as e1  lateral view explode_bitmap((user_id)) tmp1 as e2 order by dt, e1;"""
	qt_sql_explode_bitmap3 """ select dt, e1 from test_explode_bitmap lateral view explode_bitmap_outer(user_id) tmp1 as e1  lateral view explode_bitmap_outer((user_id)) tmp1 as e2 order by dt, e1;"""
	qt_sql_explode_bitmap4 """ select dt, e1 from test_explode_bitmap lateral view explode_bitmap_outer((user_id)) tmp1 as e1  lateral view explode_bitmap_outer((user_id)) tmp1 as e2 order by dt, e1;"""
