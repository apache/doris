...
suite("nereids_function") {
    ...
    sql """
        CREATE TABLE IF NOT EXISTS `t1` (
            ...
            `kdcmls1` decimal(9, 3) null comment "",
            `kdcmls2` decimal(15, 5) null comment "",
            `kdcmls3` decimal(30, 15) null comment "",
            `kdcmlv3s1` decimalv3(9, 3) null comment "",
            `kdcmlv3s2` decimalv3(15, 5) null comment "",
            `kdcmlv3s3` decimalv3(30, 20) null comment "",
            `kchrs1` char(5) null comment "",
            `kchrs2` char(20) null comment "",
            `kchrs3` char(50) null comment "",
            `kvhrs1` varchar(10) null comment "",
            `kvhrs2` varchar(20) null comment "",
            `kvhrs3` varchar(50) null comment "",
            ...
            `katint` array<tinyint> null comment "",
            `kasint` array<smallint> null comment "",
            `kaint` array<int> null comment "",
            `kabint` array<bigint> null comment "",
            `kalint` array<largeint> null comment "",
            `kasint` array<smallint> null comment "",
            `kasint` array<smallint> null comment "",
            `kasint` array<smallint> null comment "",
            `kasint` array<smallint> null comment "",
