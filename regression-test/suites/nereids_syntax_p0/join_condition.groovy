...
suite("join_condition") {
    ...
    order_qt_join_with_add_min_max_rule """SELECT *  FROM table_9_undef_partitions2_keys3_properties4_distributed_by5 AS t1
            LEFT ANTI JOIN table_100_undef_partitions2_keys3_properties4_distributed_by5 AS t2 ON t2 . `pk` = 2 OR t2 . `pk` < 0
            RIGHT ANTI JOIN table_9_undef_partitions2_keys3_properties4_distributed_by5 AS alias1 ON alias1 . `pk` >= 3
            CROSS JOIN table_20_undef_partitions2_keys3_properties4_distributed_by5 AS alias2
            INNER JOIN table_8_undef_partitions2_keys3_properties4_distributed_by5 AS alias3 ;
            """
}