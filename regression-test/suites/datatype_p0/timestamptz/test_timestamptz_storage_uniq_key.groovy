...
suite("test_timestamptz_storage_uniq_key") {
    ...
    """
    qt_select_timestamptz_storage_uniq_key_eq """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz = '2023-01-01 12:00:00 +03:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_neq """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz != '2023-01-01 12:00:00 +03:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_gt """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz > '2023-03-03 12:00:00 -05:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_ge """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz >= '2023-03-03 12:00:00 -05:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_lt """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz < '2023-05-05 00:00:00 +08:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_le """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz <= '2023-05-05 00:00:00 +08:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_in """
    ...
    """
    qt_select_timestamptz_storage_uniq_key_not_in """
    ...
    """
    qt_select_timestamptz_storage_uniq_key_is_null """
        SELECT * FROM timestamptz_storage_uniq_key where ts_tz IS NULL ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_is_not_null """
    ...
    qt_select_timestamptz_storage_uniq_key_scale """
        SELECT * FROM timestamptz_storage_uniq_key_scale ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_scale_eq """
        SELECT * FROM timestamptz_storage_uniq_key_scale where ts_tz = '0000-01-01 00:00:00.000001 +00:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_scale_neq """
        SELECT * FROM timestamptz_storage_uniq_key_scale where ts_tz != '0000-01-01 00:00:00.000001 +00:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_scale_gt """
        SELECT * FROM timestamptz_storage_uniq_key_scale where ts_tz > '0000-01-01 00:00:00.000001 +00:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_scale_ge """
        SELECT * FROM timestamptz_storage_uniq_key_scale where ts_tz >= '0000-01-01 00:00:00.000001 +00:00' ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_scale_lt """
    ...
    """
    qt_select_timestamptz_storage_uniq_key_scale_not_in """
    ...
    qt_select_timestamptz_storage_uniq_key_scale_is_null """
        SELECT * FROM timestamptz_storage_uniq_key_scale where ts_tz IS NULL ORDER BY 1, 2;
    """
    qt_select_timestamptz_storage_uniq_key_scale_is_not_null """
