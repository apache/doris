...
suite("test_timestamptz_delete") {
    ...
    ('0000-01-01 00:00:00 +00:00', 10),
    ('2023-01-01 12:00:00 +00:00', 1),
    ('2023-08-08 20:20:20 +00:00', 8),
    ('2023-12-12 12:12:12 +00:00', 12),
    ('9999-12-30 23:59:59 +00:00', 8998),
    ('9999-12-31 23:59:59 +00:00', 9998),
    ('9999-12-31 23:59:59 +00:00', 9999);
    """
    }
    ...
    qt_all0 """
        SELECT * FROM timestamptz_delete_dup_key_no_scale ORDER BY 1, 2;
    """
    ...
    qt_all0 """
        SELECT * FROM timestamptz_delete_dup_key_with_scale ORDER BY 1, 2;
    """
    ...
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz != '0000-01-01 00:00:00 +00:00';
    """
    qt_delete_dup_key_with_scale_ne0 """
        SELECT * FROM timestamptz_delete_dup_key_with_scale ORDER BY 1, 2;
    """
    ...
    dup_key_with_scale_insert_data()
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz != '9999-12-31 23:59:59 +00:00';
    """
    qt_delete_dup_key_with_scale_ne1 """
        SELECT * FROM timestamptz_delete_dup_key_with_scale ORDER BY 1, 2;
    """
    ...
    dup_key_with_scale_insert_data()
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz != '2023-08-08 20:20:20 +00:00';
    """
    qt_delete_dup_key_with_scale_ne2 """
        SELECT * FROM timestamptz_delete_dup_key_with_scale ORDER BY 1, 2;
    """
    ...
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz >= '2023-06-06 15:30:30 +00:00';
    """
    ...
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz < '2023-02-02 12:00:00 +00:00';
    """
    ...
    dup_key_with_scale_insert_data()
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz IN ('0000-01-01 00:00:00 +00:00', '2023-01-01 12:00:00 +00:00', '9999-12-31 23:59:59 +00:00');
    """
    ...
    dup_key_with_scale_insert_data()
    sql """
        DELETE FROM timestamptz_delete_dup_key_with_scale WHERE ts_tz not IN ('0000-01-01 00:00:00 +00:00', '2023-01-01 12:00:00 +00:00', '9999-12-31 23:59:59 +00:00');
    """
