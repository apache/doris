...
suite("test_timestamptz_storage_agg_key") {
    ...
    def ret = sql """
        explain SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz = '2023-01-01 12:00:00 +03:00' ORDER BY 1, 2;
    """
    ...
    qt_agg_key_eq """
        SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz = '2023-01-01 12:00:00 +03:00' ORDER BY 1, 2;
    """
    ...
    ret = sql """
        explain SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz > '2023-03-03 12:00:00 -05:00' ORDER BY 1, 2;
    """
    assertFalse(ret.toString().contains("CAST")) && assertFalse(ret.toString().contains("cast"))
    assertTrue(ret.toString().contains("""> '2023-03-03 17:00:00'"""))
    qt_agg_key_gt """
        SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz > '2023-03-03 12:00:00 -05:00' ORDER BY 1, 2;
    """
    ...
    ret = sql """
        explain SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz < '2023-05-05 00:00:00 +08:00' ORDER BY 1, 2;
    """
    assertFalse(ret.toString().contains("CAST")) && assertFalse(ret.toString().contains("cast"))
    assertTrue(ret.toString().contains("""< '2023-05-04 16:00:00'"""))
    qt_agg_key_lt """
        SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz < '2023-05-05 00:00:00 +08:00' ORDER BY 1, 2;
    """
    ...
    ret = sql """
        explain SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz in('2023-01-01 12:00:00 +03:00', '2023-02-02 12:00:00 +03:00', '2023-10-10 10:10:10 -03:00') ORDER BY 1, 2;
    """
    assertFalse(ret.toString().contains("CAST")) && assertFalse(ret.toString().contains("cast"))
    assertTrue(ret.toString().contains("""IN ('2023-01-01 09:00:00', '2023-02-02 09:00:00', '2023-10-10 13:10:10')"""))
    qt_agg_key_in """
        SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz in('2023-01-01 12:00:00 +03:00', '2023-02-02 12:00:00 +03:00', '2023-10-10 10:10:10 -03:00') ORDER BY 1, 2;
    """

    ret = sql """
        explain SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz not in('2023-01-01 12:00:00 +03:00', '2023-02-02 12:00:00 +03:00', '2023-10-10 10:10:10 -03:00') ORDER BY 1, 2;
    """
    assertFalse(ret.toString().contains("CAST")) && assertFalse(ret.toString().contains("cast"))
    assertTrue(ret.toString().contains("""NOT IN ('2023-01-01 09:00:00', '2023-02-02 09:00:00', '2023-10-10 13:10:10')"""))
    qt_agg_key_not_in """
        SELECT * FROM timestamptz_storage_agg_key_no_scale where ts_tz not in('2023-01-01 12:00:00 +03:00', '2023-02-02 12:00:00 +03:00', '2023-10-10 10:10:10 -03:00') ORDER BY 1, 2;
    """
    ...
    test {
        sql """
        INSERT INTO timestamptz_storage_agg_key_no_scale VALUES ('9999-12-31 23:59:59 +08:00', null, null, null, null);
        """
    ...
    test {
        sql """
        INSERT INTO timestamptz_storage_agg_key_scale VALUES ('9999-12-31 23:59:59.999999 +08:00', 9999);
        """
        exception "no partition for this tuple"
    }
