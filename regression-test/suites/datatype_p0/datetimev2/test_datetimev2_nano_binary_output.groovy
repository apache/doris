...
suite("test_datetimev2_nano_binary_output") {
    ...
    sql "drop table if exists test_datetimev2_nano_binary_output"
    sql """
        create table test_datetimev2_nano_binary_output (
            id int,
            dt datetimev2(9)
        )
        duplicate key(id)
    ...
    """
    sql """
        insert into test_datetimev2_nano_binary_output values
