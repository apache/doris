...
suite("test_timezone") {
    ...
    sql """insert into test_timezone values('2022-03-01 01:02:55UTC+8', '2022-03-01 01:02:55.123UTC')"""
    sql """insert into test_timezone values('2022-04-01T01:02:55UTC-6', '2022-04-01T01:02:55.123UTC+6')"""
    ...
    sql """insert into test_timezone values('20220801GMT+5', '20220801GMT-3')"""
    qt_analysis "select * from test_timezone order by k1"
