...
suite("test_timestamp_ns_named_zone_gap") {
    ...
    try {
        ...
        qt_named_zone_gap_fraction_fold """
            select cast('2024-03-10 02:30:00.123456789America/New_York' as timestamp_ns)
        """

        sql "set debug_skip_fold_constant = true"
        qt_named_zone_gap_fraction_without_fold """
            select cast('2024-03-10 02:30:00.123456789America/New_York' as timestamp_ns)
        """
    } finally {
