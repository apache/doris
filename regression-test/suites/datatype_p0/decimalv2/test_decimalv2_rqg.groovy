...
suite("test_decimalv2_rqg") {
    ...
    sql """
        SELECT ARRAY_AGG(ARG0) FROM (SELECT TEMPDATA . data, TABLE0.ARG0 FROM TEMPDATA CROSS JOIN (SELECT data AS ARG0 FROM DECIMALV2_10_0_DATA_NOT_EMPTY_NOT_NULLABLE ) AS TABLE0) t  GROUP BY ARG0;
    """
}