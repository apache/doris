...
suite("test_outfile_csv_map_type", "p0") {
    // open nereids
    ...
    def export_table_name = "outfile_csv_map_type_export_test"
    def load_table_name = "outfile_csv_map_type_load_test"
    def outFilePath = "${bucket}/outfile/csv/map_type/exp_"
