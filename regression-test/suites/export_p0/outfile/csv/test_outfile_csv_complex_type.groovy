...
suite("test_outfile_csv_complex_type", "p0") {
    // open nereids
    ...
    def export_table_name = "outfile_csv_complex_type_export_test"
    def load_table_name = "outfile_csv_complex_type_load_test"
