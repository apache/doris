...
suite('test_f_seq_col_no_vertical_segment_writer', 'docker') {
    // NOTE: This case is the same as test_flexible_partial_update_seq_col, just set `enable_vertical_segment_writer=false`
    // to test code path in SegmentWriter
    ...
    docker(options) {
        for (def use_row_store : [false, true]) {
            ...
            def tableName = "test_f_seq_col_map_col1_${use_row_store}"
            ...
            tableName = "test_f_seq_col_map_col2_${use_row_store}"
            sql """ DROP TABLE IF EXISTS ${tableName} force;"""
            sql """ CREATE TABLE ${tableName} (
            `k` int(11) NULL, 
            `v1` BIGINT NULL,
            ...
            // 3. sequence type col
            tableName = "test_f_seq_col_type_col1_${use_row_store}"
            sql """ DROP TABLE IF EXISTS ${tableName} force;"""
            sql """ CREATE TABLE ${tableName} (
            `k` int(11) NULL, 
            `v1` BIGINT NULL,
            ...
            // 4. sequence type col
            tableName = "test_f_seq_col_type_col2_${use_row_store}"
            sql """ DROP TABLE IF EXISTS ${tableName} force;"""
            sql """ CREATE TABLE ${tableName} (
            `k` int(11) NULL, 
            `v1` BIGINT NULL,
            ...
            tableName = "test_f_seq_col_map_col3_${use_row_store}"
            sql """ DROP TABLE IF EXISTS ${tableName} force;"""
            sql """ CREATE TABLE ${tableName} (
            `k` int(11) NULL, 
            `v1` BIGINT NULL,
            ...
            tableName = "test_f_seq_col_map_col4_${use_row_store}"
            sql """ DROP TABLE IF EXISTS ${tableName} force;"""
            sql """ CREATE TABLE ${tableName} (
            `k` int(11) NULL, 
            `v1` BIGINT NULL,
