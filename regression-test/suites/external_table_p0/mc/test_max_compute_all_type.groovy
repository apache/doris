 ...
 */
suite("test_max_compute_all_type", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        qt_test_76 """ select id,char_col1 from ${table_name} where  char_col1  = "varchar_value11111" order by id """
        qt_test_77 """ select id,char_col1 from ${table_name} where  char_col1  != "varchar_value11111" order by id """
        qt_test_78 """ select id,char_col1 from ${table_name} where  char_col1  != "varchar_value1" order by id """
        qt_test_79 """ select id,char_col1 from ${table_name} where  char_col1  in ("varchar_value1") order by id """
        qt_test_80 """ select id,char_col1 from ${table_name} where  char_col1  not in ("varchar_value1") order by id """
        qt_test_81 """ select id,char_col1 from ${table_name} where  char_col1  in ("varchar_value1","varchar_value11111") order by id """
        qt_test_82 """ select id,char_col1 from ${table_name} where  char_col1  not in ("varchar_value1","varchar_value11111") order by id """


        qt_test_83 """ select id,char_col2 from ${table_name} order by id """
        qt_test_84 """ select id,char_col2 from ${table_name} where  char_col2  = "varchar_value22222" order by id """
        qt_test_85 """ select id,char_col2 from ${table_name} where  char_col2  != "varchar_value22222" order by id """
        qt_test_86 """ select id,char_col2 from ${table_name} where  char_col2  != "varchar_value2" order by id """
        qt_test_87 """ select id,char_col2 from ${table_name} where  char_col2  in ("varchar_value2") order by id """
        qt_test_88 """ select id,char_col2 from ${table_name} where  char_col2  not in ("varchar_value2") order by id """
        qt_test_89 """ select id,char_col2 from ${table_name} where  char_col2  in ("varchar_value2","varchar_value22222") order by id """
        qt_test_90 """ select id,char_col2 from ${table_name} where  char_col2  not in ("varchar_value2","varchar_value22222") order by id """

        qt_test_91 """ select id,char_col3 from ${table_name} order by id """
        qt_test_92 """ select id,char_col3 from ${table_name} where  char_col3  =  "varchar_value33333" order by id """
        qt_test_93 """ select id,char_col3 from ${table_name} where  char_col3  != "varchar_value33333" order by id """
        qt_test_94 """ select id,char_col3 from ${table_name} where  char_col3  != "varchar_value3" order by id """
        qt_test_95 """ select id,char_col3 from ${table_name} where  char_col3  in ("varchar_value3") order by id """
        qt_test_96 """ select id,char_col3 from ${table_name} where  char_col3  not in ("varchar_value3") order by id """
        qt_test_97 """ select id,char_col3 from ${table_name} where  char_col3  in ("varchar_value3","varchar_value33333") order by id """
        qt_test_98 """ select id,char_col3 from ${table_name} where  char_col3  not in ("varchar_value3","varchar_value33333") order by id """
