...
suite("test_iceberg_schema_dual_relation_matrix",
    ...
    try {
        ...
        // Scenario TC07-nested-union: nested field lookup is also relation-local (iceberg field-ids are
        // stable across the rename, so info.added@old and info.renamed@new read the same physical field).
