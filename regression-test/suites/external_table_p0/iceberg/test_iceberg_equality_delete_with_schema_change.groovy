...
suite("test_iceberg_equality_delete_with_schema_change", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    // The existing output was generated by the legacy scanner and is kept as the differential
    // baseline. Run the complete schema-evolution matrix through V2 so missing/renamed equality
