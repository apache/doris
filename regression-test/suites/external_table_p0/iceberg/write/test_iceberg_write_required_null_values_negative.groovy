...
suite("test_iceberg_write_required_null_values_negative",
    ...
    String catalogName = "test_iceberg_write_required_null_values_negative"
    String dbName = "iceberg_write_required_null_values_negative_db"
