    ...
    try {
        ...
        sql """
            CREATE CATALOG ${catalog_name} PROPERTIES (
                ...
                'iceberg.driver_url' = '${driver_name}',
                'iceberg.driver_class' = 'org.postgresql.Driver',
            ...
            try {
                ...
                sql """
                    CREATE CATALOG ${mysql_catalog_name} PROPERTIES (
                        ...
                        'iceberg.driver_url' = 'file://${jdbc_drivers_dir}/${mysql_driver_name}',
                        'iceberg.driver_class' = 'com.mysql.jdbc.Driver',
