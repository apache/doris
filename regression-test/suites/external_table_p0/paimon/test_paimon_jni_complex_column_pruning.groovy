...
suite("test_paimon_jni_complex_column_pruning",
    ...
    try {
        ...
        explain {
            sql "select id, profile.city from jni_complex_column_pruning order by id"
        ...
        explain {
            sql "select id, events[1].score from jni_complex_column_pruning order by id"
            contains "paimonNativeReadSplits=0/1"
            contains "pruned type:"
        ...
        // Different projected and predicate children must be combined into one requested read type.
