...
suite("paimon_base_filesystem", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    try {
        ...
        def cos = """select c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12,c13,c14,c15,c16,c18 from ${catalog_cosn}.zd.all_table order by c18"""
        def cosn = """select c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12,c13,c14,c15,c16,c18 from ${catalog_cosn}.zd.all_table order by c18"""
        def oss = """select * from ${catalog_oss}.paimonossdb1.test_tableoss order by a"""
        def obs = """select * from ${catalog_obs}.piamon_obs_db.paimon_table_obs order by k"""
