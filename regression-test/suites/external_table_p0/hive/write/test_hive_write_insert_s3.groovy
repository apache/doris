...
suite("test_hive_write_insert_s3", "p0,external,hive,external_docker,external_docker_hive") {
    ...
    def q02 = { String format_compression, String catalog_name ->
        ...
        hive_docker """ DROP TABLE IF EXISTS all_types_par_${format_compression}_s3_${catalog_name}_q02; """
        logger.info("hive sql: " + """ CREATE TABLE IF NOT EXISTS all_types_par_${format_compression}_s3_${catalog_name}_q02 like all_types_par_${format_compression}; """)
        hive_docker """ CREATE TABLE IF NOT EXISTS all_types_par_${format_compression}_s3_${catalog_name}_q02 like all_types_par_${format_compression}; """
        sql """refresh catalog ${catalog_name};"""
