...
suite("test_hive_write_legacy_hive_compatible.groovy", "p0,external,hive,external_docker,external_docker_hive") {
    def format_compressions = ["orc_zlib"]
    ...
    for (String hivePrefix : ["hive3"]) {
        ...
        try {
            ...
            sql """create catalog if not exists ${catalog_name} properties (
                ...
                'hive.orc.writer.legacy_hive_compatible' = 'true'
            );"""
