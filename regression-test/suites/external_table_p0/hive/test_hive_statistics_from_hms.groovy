...
suite("test_hive_statistics_from_hms", "p0,external,hive,external_docker,external_docker_hive") {
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        ...
        String catalog_name = "${hivePrefix}_test_hive_statistics_from_hms"
