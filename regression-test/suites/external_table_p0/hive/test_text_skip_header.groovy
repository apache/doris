...
suite("test_hive_text_skip_header","p0,external,tvf,hive,external_docker,external_docker_hive") {
    ...
    for (String hivePrefix : ["hive2","hive3"]) {
        ...
        qt_text_skip_header_normal """select * from text_table_normal_skip_header order by id;"""
        qt_text_skip_header_compressed """select * from text_table_compressed_skip_header order by id;"""
    }
}