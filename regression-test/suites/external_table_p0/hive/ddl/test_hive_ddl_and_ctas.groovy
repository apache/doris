...
suite("test_hive_ddl_and_ctas", "p0,external,hive,external_docker,external_docker_hive") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        ...
        def test_db_tbl = { String file_format, String catalog_name ->
            ...
            hive_docker """ truncate table test_hive_db.unpart_tbl_${file_format}; """
            ...
            hive_docker """ truncate table test_hive_db.part_tbl_${file_format}; """
        ...
        def test_ctas_tbl = { String file_format, String catalog_name ->
            ...
            hive_docker """ TRUNCATE TABLE test_ctas.hive_ctas1 """
            ...
            hive_docker """ TRUNCATE TABLE test_ctas.hive_ctas2 """
            ...
            hive_docker """ TRUNCATE TABLE test_ctas.ctas_o1 """
            ...
            hive_docker """ TRUNCATE TABLE test_ctas.ctas_o2 """
            ...
            sql """ switch `${catalog_name}` """
            hive_docker """ TRUNCATE TABLE `test_ctas`.part_ctas_src """
            sql """ DROP TABLE `test_ctas`.part_ctas_src """
            hive_docker """ TRUNCATE TABLE `test_ctas`.unpart_ctas_src """
        ...
        """
            ...
            hive_docker """ TRUNCATE TABLE test_complex_type.unpart_tbl_${file_format} """
