...
suite("hive_partition_special_characters", "p0,external,hive,external_docker,external_docker_hive") {
    ...
    for (String hivePrefix : [ "hive2"]) {
        ...
        try {
            ...
            String catalog_name = "test_${hivePrefix}_partition_special_characters"
