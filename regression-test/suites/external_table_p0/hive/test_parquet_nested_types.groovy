...
suite("test_parquet_nested_types", "p0,external,hive,external_docker,external_docker_hive") {
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        ...
        qt_nested_cross_page1_parquet_q1 """select array_col from nested_cross_page1_parquet where id = 1"""
        
        qt_nested_cross_page1_parquet_q2 """select array_col from nested_cross_page1_parquet where id = 2"""
        
        qt_nested_cross_page1_parquet_q3 """select array_col from nested_cross_page1_parquet where id = 3"""

        qt_nested_cross_page1_parquet_q4 """
            SELECT id, array_size(array_col) as arr_size
            FROM nested_cross_page1_parquet
            ORDER BY id
        """

        qt_nested_cross_page1_parquet_q5 """
            SELECT id, array_col[1] as first_elem, array_col[3] as third_elem
            FROM nested_cross_page1_parquet
            ORDER BY id
        """

        qt_nested_cross_page1_parquet_q6 """
            SELECT id, array_col
            FROM nested_cross_page1_parquet
        ...
        qt_nested_cross_page1_parquet_q7 """
            SELECT id, array_col
            FROM nested_cross_page1_parquet
        ...
        qt_nested_cross_page1_parquet_q8 """
        ...
        qt_nested_cross_page1_parquet_q9 """
            SELECT
                id,
        ...
        qt_nested_cross_page1_parquet_q10 """
            SELECT id, array_col
            FROM nested_cross_page1_parquet
        ...
        qt_nested_cross_page2_parquet_q1 """
            SELECT
            id,
            nested_array_col,
        ...
        qt_nested_cross_page2_parquet_q2 """
            SELECT
            id,
            nested_array_col,
            array_size(nested_array_col) as outer_size
        ...
        qt_nested_cross_page2_parquet_q3 """
            SELECT
            id,
            nested_array_col,
            array_size(nested_array_col) as outer_size
        ...
        qt_nested_cross_page2_parquet_q4 """
            SELECT
                id,
                array_struct_col,
        ...
        qt_nested_cross_page2_parquet_q5 """
            SELECT
                id,
                item_x as x_value,
                item_y as y_value
        ...
        qt_nested_cross_page2_parquet_q6 """
            SELECT
                id,
                map_array_col,
