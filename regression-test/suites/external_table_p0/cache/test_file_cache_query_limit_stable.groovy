...
// Use a distinct suite name for the stable variant to avoid selection collisions.
suite("test_file_cache_query_limit_stable", "p0,external,nonConcurrent") {
    ...
    // Use a distinct catalog name to avoid interference when multiple variants run in the same environment.
    String catalog_name = "test_file_cache_query_limit_stable"
