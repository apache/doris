...
suite("test_remote_doris_session_var", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    def db_name = "test_remote_doris_session_var_db"
    def catalog_name = "test_remote_doris_session_var_catalog"
    def table_name = "test_remote_doris_session_var_t"
    ...
    explain {
        ...
        contains("enable_parallel_result_sink='false'")
    }
}
