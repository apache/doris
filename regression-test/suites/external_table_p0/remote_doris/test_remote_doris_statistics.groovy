...
suite("test_remote_doris_statistics", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    def catalog_id = get_catalog_id("test_remote_doris_statistics_catalog");

    sql """analyze table test_remote_doris_statistics_catalog.test_remote_doris_statistics_db.test_remote_doris_statistics_t1 with sync"""
