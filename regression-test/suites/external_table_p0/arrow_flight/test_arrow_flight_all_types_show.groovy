...
suite("test_arrow_flight_all_types_show", "p0,external,doris,external_docker,external_docker_doris") {
    ...
    def db_name = "test_arrow_flight_all_types_db"
    def catalog_name = "test_arrow_flight_all_types_catalog"
    ...
    sql """
        CREATE TABLE `${db_name}`.`test_arrow_flight_all_types_t1` (
    ...
    sql """
        CREATE TABLE `${db_name}`.`test_arrow_flight_all_types_t2` (
          `id` datetime(3) NOT NULL,
    ...
    sql """
        CREATE TABLE `${db_name}`.`test_arrow_flight_all_types_t3` (
    ...
    sql """
        CREATE TABLE `${db_name}`.`test_arrow_flight_all_types_t4` (
          `id` datetime NOT NULL,
    ...
    sql """
        CREATE TABLE `${db_name}`.`test_arrow_flight_all_types_t5` (
          `id` datetime NOT NULL,
          `id2` int NOT NULL,
    ...
    qt_sql """ SHOW CREATE TABLE ${catalog_name}.${db_name}.test_arrow_flight_all_types_t1"""
    qt_sql """ DESC ${catalog_name}.${db_name}.test_arrow_flight_all_types_t1"""

    qt_sql """ SHOW CREATE TABLE ${catalog_name}.${db_name}.test_arrow_flight_all_types_t2"""
    qt_sql """ DESC ${catalog_name}.${db_name}.test_arrow_flight_all_types_t2"""

    qt_sql """ SHOW CREATE TABLE ${catalog_name}.${db_name}.test_arrow_flight_all_types_t3"""
    qt_sql """ DESC ${catalog_name}.${db_name}.test_arrow_flight_all_types_t3"""

    qt_sql """ SHOW CREATE TABLE ${catalog_name}.${db_name}.test_arrow_flight_all_types_t4"""
    qt_sql """ DESC ${catalog_name}.${db_name}.test_arrow_flight_all_types_t4"""

    qt_sql """ SHOW CREATE TABLE ${catalog_name}.${db_name}.test_arrow_flight_all_types_t5"""
    qt_sql """ DESC ${catalog_name}.${db_name}.test_arrow_flight_all_types_t5"""
