    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
       ...
       sql """
        ...
        def query_catalogs = { -> 
            ...
            order_qt_sql_5_28 """select test1, test2 from test1 where test1 like 'string%';"""
            order_qt_sql_5_29 """select test1, test2 from test1 where test2 like 'text%';"""
            ...
            order_qt_sql_6_28 """select test1, test2 from test1 where test1 like 'string%';"""
            order_qt_sql_6_29 """select test1, test2 from test1 where test2 like 'text%';"""
