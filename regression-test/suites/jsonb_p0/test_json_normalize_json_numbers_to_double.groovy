...
suite("test_json_normalize_json_numbers_to_double") {
    qt_sql """
        select normalize_json_numbers_to_double(cast('{"b":1234567890123456789,"b":456,"a":789}' as json)) ,   normalize_jsonb_numbers_to_double(cast('{"b":123,"b":456,"a":789}' as json));
    """


    qt_sql """
        select normalize_json_numbers_to_double(cast('[{"b":123,"b":456,"a":1234567890123456789.231231} ,{"b":1213379817829313213},{"b":456123123123123123},{"a":74124123132189} ]' as json));
    """


    qt_sql """
         select normalize_json_numbers_to_double(to_json(cast('nan' as double)) );
    """

    qt_sql """
         select normalize_json_numbers_to_double(to_json(cast('-0.0' as double)) );
    """

    qt_sql """
         select normalize_json_numbers_to_double(to_json(cast('1231231322.23123' as Decimal)) );
    """

    sql "DROP TABLE IF EXISTS test_json_normalize_json_numbers_to_double_table"

    sql """
    CREATE TABLE IF NOT EXISTS test_json_normalize_json_numbers_to_double_table (
        id INT,
        j JSON
    )
