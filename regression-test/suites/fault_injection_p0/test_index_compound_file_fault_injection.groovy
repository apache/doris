...
suite("test_index_compound_file_fault_injection", "nonConcurrent") {
    def indexTbName = "test_index_compound_file_fault_injection"
    ...
    sql """
      CREATE TABLE ${indexTbName} (
        ...
        INDEX size_idx (`size`) USING INVERTED
      ) ENGINE=OLAP
    ...
    try {
        load_httplogs_data.call(indexTbName, 'test_index_compound_file_fault_injection', 'true', 'json', 'documents-1000.json')
