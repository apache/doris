...
suite("variant_p2_load", "variant_type,p2"){
    ...
    def load_ckb = { ->
        def create_table = { table_name, buckets="auto" ->
            ...
            sql """CREATE TABLE ${table_name} (
                    ...
                    URLHash BIGINT ,
                    var VARIANT,
                    INDEX idx_var (`var`) USING INVERTED COMMENT ''
                )
        ...
        def table_name = "ckb_hits"
        create_table.call(table_name)
        s3load_paral_wait.call(table_name, "JSON", "regression/variant/ckb/*", 3)
    ...
    def load_gh = { ->
        ...
        def numberOfThreads = 5 // Set this to your desired number of threads
