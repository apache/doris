...
suite("spm_tpch_sf01_q15", "spm") {

    // SPM baseline DDL + match verification on the ORIGINAL TPCH q15 query
    // (SQL unchanged from sql/q15.sql) against the REAL TPCH sf0.1 data loaded
    // by load.groovy.
