...
suite("spm_tpch_sf01_q10", "spm") {

    // SPM baseline DDL + match verification on the ORIGINAL TPCH q10 query
    // (SQL unchanged from sql/q10.sql) against the REAL TPCH sf0.1 data loaded
    // by load.groovy.
