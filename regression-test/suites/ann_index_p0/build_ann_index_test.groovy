...
suite("build_ann_index_test") {
    ...
    // CREATE INDEX
    sql """
    CREATE INDEX idx_test_ann ON table_build_ann_index_on_mow(`embedding`) USING ANN PROPERTIES(
        "index_type"="hnsw",
        "metric_type"="l2_distance",
        "dim"="8"
    );
    ...
    wait_for_last_build_index_on_table_finish("table_build_ann_index_on_mow", timeout)
}
