...
suite("ann_range_search") {
    ...
    """
    qt_q0 """
        select * from ann_range_search_l2 ORDER BY id;
    """

    qt_q1 """
        select * from ann_range_search_l2 where l2_distance_approximate(embedding, [26.360261917114258,7.05784273147583,32.361351013183594,86.39714050292969,58.79527282714844,27.189321517944336,99.38946533203125,80.19270324707031]) < 105.66439056396484 ORDER BY id;
    """
    ...
    qt_q3 """
        select * from ann_range_search_ip where inner_product_approximate(embedding, [26.360261917114258,7.05784273147583,32.361351013183594,86.39714050292969,58.79527282714844,27.189321517944336,99.38946533203125,80.19270324707031]) < 105.66439056396484 ORDER BY id;
    """
