...
suite("create_ann_index_test") {
    ...
    if (isCloudMode()) {
        // Test CREATE INDEX for ANN in cloud mode
        sql "drop table if exists tbl_not_null_cloud"
        sql """
        CREATE TABLE `tbl_not_null_cloud` (
        ...
        test {
            sql """
                CREATE INDEX idx_test_ann_cloud ON tbl_not_null_cloud(`embedding`) USING ANN PROPERTIES(
                    "index_type"="hnsw",
