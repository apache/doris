...
suite("test_workload_sched_policy") {
    ...
    sql "create workload group test_set_session_wg $forComputeGroupStr properties('min_cpu_percent'='30');"
    sql "create workload group test_set_session_wg2 $forComputeGroupStr properties('min_cpu_percent'='30');"
    ...
    sql "create workload group if not exists policy_group $forComputeGroupStr properties ('min_cpu_percent'='30');"
    sql "create workload group if not exists policy_group2 $forComputeGroupStr properties ('min_cpu_percent'='30');"
