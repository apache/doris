...
select creationDate, title, tag from test_es_nested_json where  title  like '%java%'  order by  creationDate limit 10;
...
select tag, title, qid + 10222 from test_es_nested_json where  title  like '%java%'  order by  creationDate limit 10;
select tag, title, qid + 10222 from test_es_nested_json where  title  match 'java'  order by  creationDate limit 10;
select * from test_es_nested_json where creationDate > '2012-04-01'  order by  creationDate limit 10;
select * from test_es_nested_json where creationDate > '2012-04-01' and title  match 'java' order by  creationDate limit 10;
