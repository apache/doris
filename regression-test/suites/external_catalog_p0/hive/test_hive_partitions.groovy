...
suite("test_hive_partitions", "p0") {
    ...
    if (enabled != null && enabled.equalsIgnoreCase("true")) {
        try {
            ...
            sql """create resource if not exists hms_resource_hive_partitions properties (
                "type"="hms",
                'hive.metastore.uris' = 'thrift://127.0.0.1:${hms_port}'
            );"""
            sql """create catalog if not exists ${catalog_name} with resource hms_resource_hive_partitions;"""
