...
suite("test_lag_lead_window") {
    ...
    qt_select_lag_1 """ select id, create_time, lag(create_time) over() as "prev_time" from test1 order by 1 ,2 ; """
    qt_select_lag_2 """ select id, create_time, lag(create_time,1) over() as "prev_time" from test1 order by 1 ,2 ; """
    qt_select_lag_3 """ select id, create_time, lag(create_time,1,NULL) over() as "prev_time" from test1 order by 1 ,2 ; """
    qt_select_lag_4 """ select id, create_time, lead(create_time) over() as "prev_time" from test1 order by 1 ,2 ; """
    qt_select_lag_5 """ select id, create_time, lead(create_time,1) over() as "prev_time" from test1 order by 1 ,2 ; """
    qt_select_lag_6 """ select id, create_time, lead(create_time,1,NULL) over() as "prev_time" from test1 order by 1 ,2 ; """
