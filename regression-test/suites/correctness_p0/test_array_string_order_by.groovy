...
suite("test_array_string_order_by") {
    ...
    sql """insert into test_array_order_by values(1,'name1',NULL), (1,'name2',['a','b','c','d','e']), (1,'name3',['b','d','c']), (1,'name4',['a', 'a' , 'd']), (1,'name2',['a','b','c','d','e']), (1,'name2',['a', 'e' , 'd']), (1,'name2',['a', 'b' , 'd']), (1,'name2',['a', NULL , 'd']);"""
