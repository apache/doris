...
suite("nereids_scalar_fn_W") {
	...
	qt_sql_week_DateTime "select week(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_week_DateTimeV2 "select week(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_week_DateTimeV2 "select week(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_week_DateV2 "select week(kdtv2) from fn_test order by kdtv2"
	qt_sql_week_DateV2 "select week(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_week_DateTime_Integer "select week(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_week_DateTime_Integer "select week(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_week_DateTimeV2_Integer "select week(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_week_DateTimeV2_Integer "select week(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_week_DateV2_Integer "select week(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_week_DateV2_Integer "select week(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_week_ceil_DateTime "select week_ceil(kdtm) from fn_test order by kdtm"
	qt_sql_week_ceil_DateTime "select week_ceil(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_week_ceil_DateTimeV2 "select week_ceil(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_week_ceil_DateTimeV2 "select week_ceil(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_week_ceil_DateV2 "select week_ceil(kdtv2) from fn_test order by kdtv2"
	qt_sql_week_ceil_DateV2 "select week_ceil(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_week_ceil_DateTime_DateTime "select week_ceil(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_week_ceil_DateTime_DateTime "select week_ceil(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_week_ceil_DateTime_Integer "select week_ceil(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_week_ceil_DateTime_Integer "select week_ceil(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_week_ceil_DateTimeV2_DateTimeV2 "select week_ceil(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_week_ceil_DateTimeV2_DateTimeV2 "select week_ceil(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_week_ceil_DateTimeV2_Integer "select week_ceil(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_week_ceil_DateTimeV2_Integer "select week_ceil(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_week_ceil_DateV2_DateV2 "select week_ceil(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_week_ceil_DateV2_DateV2 "select week_ceil(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_week_ceil_DateV2_Integer "select week_ceil(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_week_ceil_DateV2_Integer "select week_ceil(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_week_ceil_DateTime_Integer_DateTime "select week_ceil(kdtm, kint, kdtm) from fn_test order by kdtm, kint, kdtm"
	qt_sql_week_ceil_DateTime_Integer_DateTime "select week_ceil(kdtm, kint, kdtm) from fn_test_not_nullable order by kdtm, kint, kdtm"
	...
	qt_sql_week_ceil_DateTimeV2_Integer_DateTimeV2 "select week_ceil(kdtmv2s1, kint, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kint, kdtmv2s1"
	qt_sql_week_ceil_DateV2_Integer_DateV2 "select week_ceil(kdtv2, kint, kdtv2) from fn_test order by kdtv2, kint, kdtv2"
	qt_sql_week_ceil_DateV2_Integer_DateV2 "select week_ceil(kdtv2, kint, kdtv2) from fn_test_not_nullable order by kdtv2, kint, kdtv2"
	qt_sql_week_floor_DateTime "select week_floor(kdtm) from fn_test order by kdtm"
	qt_sql_week_floor_DateTime "select week_floor(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_week_floor_DateTimeV2 "select week_floor(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_week_floor_DateTimeV2 "select week_floor(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_week_floor_DateV2 "select week_floor(kdtv2) from fn_test order by kdtv2"
	qt_sql_week_floor_DateV2 "select week_floor(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_week_floor_DateTime_DateTime "select week_floor(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_week_floor_DateTime_DateTime "select week_floor(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_week_floor_DateTime_Integer "select week_floor(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_week_floor_DateTime_Integer "select week_floor(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_week_floor_DateTimeV2_DateTimeV2 "select week_floor(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_week_floor_DateTimeV2_DateTimeV2 "select week_floor(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_week_floor_DateTimeV2_Integer "select week_floor(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_week_floor_DateTimeV2_Integer "select week_floor(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_week_floor_DateV2_DateV2 "select week_floor(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_week_floor_DateV2_DateV2 "select week_floor(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_week_floor_DateV2_Integer "select week_floor(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_week_floor_DateV2_Integer "select week_floor(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_week_floor_DateTime_Integer_DateTime "select week_floor(kdtm, kint, kdtm) from fn_test order by kdtm, kint, kdtm"
	qt_sql_week_floor_DateTime_Integer_DateTime "select week_floor(kdtm, kint, kdtm) from fn_test_not_nullable order by kdtm, kint, kdtm"
	...
	qt_sql_week_floor_DateTimeV2_Integer_DateTimeV2 "select week_floor(kdtmv2s1, kint, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kint, kdtmv2s1"
	qt_sql_week_floor_DateV2_Integer_DateV2 "select week_floor(kdtv2, kint, kdtv2) from fn_test order by kdtv2, kint, kdtv2"
	qt_sql_week_floor_DateV2_Integer_DateV2 "select week_floor(kdtv2, kint, kdtv2) from fn_test_not_nullable order by kdtv2, kint, kdtv2"
	qt_sql_weekday_DateTime "select weekday(kdtm) from fn_test order by kdtm"
	qt_sql_weekday_DateTime "select weekday(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_weekday_DateTimeV2 "select weekday(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_weekday_DateTimeV2 "select weekday(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_weekday_DateV2 "select weekday(kdtv2) from fn_test order by kdtv2"
	qt_sql_weekday_DateV2 "select weekday(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_weekofyear_DateTime "select weekofyear(kdtm) from fn_test order by kdtm"
	qt_sql_weekofyear_DateTime "select weekofyear(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_weekofyear_DateTimeV2 "select weekofyear(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_weekofyear_DateTimeV2 "select weekofyear(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_weekofyear_DateV2 "select weekofyear(kdtv2) from fn_test order by kdtv2"
	qt_sql_weekofyear_DateV2 "select weekofyear(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_weeks_add_DateTimeV2_Integer "select weeks_add(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_weeks_add_DateTimeV2_Integer "select weeks_add(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_weeks_add_DateV2_Integer "select weeks_add(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_weeks_add_DateV2_Integer "select weeks_add(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_weeks_add_DateTime_Integer "select weeks_add(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_weeks_add_DateTime_Integer "select weeks_add(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_weeks_add_Date_Integer "select weeks_add(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_weeks_add_Date_Integer "select weeks_add(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_weeks_add_DateTime_Integer "select weeks_add(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_weeks_add_DateTime_Integer "select weeks_add(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_weeks_add_Date_Integer "select weeks_add(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_weeks_add_Date_Integer "select weeks_add(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	...
	qt_sql_weeks_diff_DateTime_DateTime "select weeks_diff(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_weeks_diff_DateTimeV2_DateTimeV2 "select weeks_diff(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_weeks_diff_DateTimeV2_DateTimeV2 "select weeks_diff(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_weeks_diff_DateV2_DateTimeV2 "select weeks_diff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_weeks_diff_DateV2_DateTimeV2 "select weeks_diff(kdtv2, kdtmv2s1) from fn_test_not_nullable order by kdtv2, kdtmv2s1"
	qt_sql_weeks_diff_DateTimeV2_DateV2 "select weeks_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_weeks_diff_DateTimeV2_DateV2 "select weeks_diff(kdtmv2s1, kdtv2) from fn_test_not_nullable order by kdtmv2s1, kdtv2"
	qt_sql_weeks_diff_DateV2_DateV2 "select weeks_diff(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_weeks_diff_DateV2_DateV2 "select weeks_diff(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_weeks_diff_DateV2_DateTime "select weeks_diff(kdtv2, kdtm) from fn_test order by kdtv2, kdtm"
	qt_sql_weeks_diff_DateV2_DateTime "select weeks_diff(kdtv2, kdtm) from fn_test_not_nullable order by kdtv2, kdtm"
	qt_sql_weeks_diff_DateTime_DateV2 "select weeks_diff(kdtm, kdtv2) from fn_test order by kdtm, kdtv2"
	qt_sql_weeks_diff_DateTime_DateV2 "select weeks_diff(kdtm, kdtv2) from fn_test_not_nullable order by kdtm, kdtv2"
	qt_sql_weeks_diff_DateTimeV2_DateTime "select weeks_diff(kdtmv2s1, kdtm) from fn_test order by kdtmv2s1, kdtm"
	qt_sql_weeks_diff_DateTimeV2_DateTime "select weeks_diff(kdtmv2s1, kdtm) from fn_test_not_nullable order by kdtmv2s1, kdtm"
	qt_sql_weeks_diff_DateTime_DateTimeV2 "select weeks_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_weeks_diff_DateTime_DateTimeV2 "select weeks_diff(kdtm, kdtmv2s1) from fn_test_not_nullable order by kdtm, kdtmv2s1"
	...
	qt_sql_weeks_sub_DateTime_Integer "select weeks_sub(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_weeks_sub_Date_Integer "select weeks_sub(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_weeks_sub_Date_Integer "select weeks_sub(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_weeks_sub_DateTime_Integer "select weeks_sub(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_weeks_sub_DateTime_Integer "select weeks_sub(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_weeks_sub_Date_Integer "select weeks_sub(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_weeks_sub_Date_Integer "select weeks_sub(kdt, kint) from fn_test_not_nullable order by kdt, kint"
