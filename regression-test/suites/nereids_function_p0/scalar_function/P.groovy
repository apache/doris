...
suite("nereids_scalar_fn_P") {
	...
	qt_sql_position_Varchar_Varchar "select position(kvchrs1 in kvchrs1) from fn_test order by kvchrs1, kvchrs1"
	qt_sql_position_Varchar_Varchar_notnull "select position(kvchrs1 in kvchrs1) from fn_test_not_nullable order by kvchrs1, kvchrs1"
	qt_sql_position_String_String "select position(kstr in kstr) from fn_test order by kstr, kstr"
	qt_sql_position_String_String_notnull "select position(kstr in kstr) from fn_test_not_nullable order by kstr, kstr"
