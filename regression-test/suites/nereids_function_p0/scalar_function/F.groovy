...
suite("nereids_scalar_fn_F") {
	...
	qt_sql_field_SmallInt "select field(ksint, 1, 2) from fn_test_not_nullable order by ksint"
	qt_sql_field_Integer "select field(kint, 1, 2) from fn_test order by kint"
	qt_sql_field_Integer "select field(kint, 1, 2) from fn_test_not_nullable order by kint"
	qt_sql_field_BigInt "select field(kbint, 1, 2) from fn_test order by kbint"
	qt_sql_field_BigInt "select field(kbint, 1, 2) from fn_test_not_nullable order by kbint"
	qt_sql_field_LargeInt "select field(klint, 1, 2) from fn_test order by klint"
	qt_sql_field_LargeInt "select field(klint, 1, 2) from fn_test_not_nullable order by klint"
	qt_sql_field_Float "select field(kfloat, 1, 2) from fn_test order by kfloat"
	qt_sql_field_Float "select field(kfloat, 1, 2) from fn_test_not_nullable order by kfloat"
	qt_sql_field_Double "select field(kdbl, 1, 2) from fn_test order by kdbl"
	qt_sql_field_Double "select field(kdbl, 1, 2) from fn_test_not_nullable order by kdbl"
	qt_sql_field_DecimalV2 "select field(kdcmls1, 1, 2) from fn_test order by kdcmls1"
	qt_sql_field_DecimalV2 "select field(kdcmls1, 1, 2) from fn_test_not_nullable order by kdcmls1"
	qt_sql_field_DateV2 "select field(kdtv2, 1, 2) from fn_test order by kdtv2"
	qt_sql_field_DateV2 "select field(kdtv2, 1, 2) from fn_test_not_nullable order by kdtv2"
	qt_sql_field_DateTimeV2 "select field(kdtmv2s1, 1, 2) from fn_test order by kdtmv2s1"
	qt_sql_field_DateTimeV2 "select field(kdtmv2s1, 1, 2) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_field_Varchar "select field(kvchrs1, 1, 2) from fn_test order by kvchrs1"
	qt_sql_field_Varchar "select field(kvchrs1, 1, 2) from fn_test_not_nullable order by kvchrs1"
	qt_sql_field_String "select field(kstr, 1, 2) from fn_test order by kstr"
	qt_sql_field_String "select field(kstr, 1, 2) from fn_test_not_nullable order by kstr"
	qt_sql_find_in_set_Varchar_Varchar "select find_in_set(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
	qt_sql_find_in_set_Varchar_Varchar "select find_in_set(kvchrs1, kvchrs1) from fn_test_not_nullable order by kvchrs1, kvchrs1"
	qt_sql_find_in_set_String_String "select find_in_set(kstr, kstr) from fn_test order by kstr, kstr"
	qt_sql_find_in_set_String_String "select find_in_set(kstr, kstr) from fn_test_not_nullable order by kstr, kstr"
	qt_sql_floor_Double "select floor(kdbl) from fn_test order by kdbl"
	qt_sql_floor_Double "select floor(kdbl) from fn_test_not_nullable order by kdbl"
	qt_sql_fmod_Float_Float "select fmod(kfloat, kfloat) from fn_test order by kfloat, kfloat"
	qt_sql_fmod_Float_Float "select fmod(kfloat, kfloat) from fn_test_not_nullable order by kfloat, kfloat"
	qt_sql_fmod_Double_Double "select fmod(kdbl, kdbl) from fn_test order by kdbl, kdbl"
	qt_sql_fmod_Double_Double "select fmod(kdbl, kdbl) from fn_test_not_nullable order by kdbl, kdbl"
	qt_sql_fpow_Double_Double "select fpow(kdbl, kdbl) from fn_test order by kdbl, kdbl"
	qt_sql_fpow_Double_Double "select fpow(kdbl, kdbl) from fn_test_not_nullable order by kdbl, kdbl"
	...
	qt_sql_from_days_Integer "select from_days(kint) from fn_test_not_nullable order by kint"
	qt_sql_from_unixtime_Integer "select from_unixtime(kint) from fn_test order by kint"
	qt_sql_from_unixtime_Integer "select from_unixtime(kint) from fn_test_not_nullable order by kint"
	qt_sql_from_unixtime_Integer_Varchar "select from_unixtime(kint, 'varchar') from fn_test order by kint"
	qt_sql_from_unixtime_Integer_Varchar "select from_unixtime(kint, 'varchar') from fn_test_not_nullable order by kint"
	qt_sql_from_unixtime_Integer_String "select from_unixtime(kint, 'string') from fn_test order by kint"
	qt_sql_from_unixtime_Integer_String "select from_unixtime(kint, 'string') from fn_test_not_nullable order by kint"
}