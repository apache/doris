...
suite("nereids_scalar_fn_F") {
	...
	qt_sql_field_TimestampNs "select field(cast(kdtmv2s1 as timestamp_ns), 1, 2) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_field_DateTimeV2_notnull "select field(kdtmv2s1, 1, 2) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_field_TimestampNs_notnull "select field(cast(kdtmv2s1 as timestamp_ns), 1, 2) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
