...
// function hll_cardinality(hll) is unsupported for the test suite.
    sql "select hll_empty() from fn_test order by "
    ...
    sql "select json_array(kvchrs1) from fn_test order by kvchrs1"
    sql "select json_object(kvchrs1) from fn_test order by kvchrs1"
    sql "select json_quote(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_error_to_invalid(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_error_to_null(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_error_to_value(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    sql "select jsonb_parse_notnull(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_notnull_error_to_invalid(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_notnull_error_to_value(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    sql "select jsonb_parse_nullable(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_nullable_error_to_invalid(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_nullable_error_to_null(kvchrs1) from fn_test order by kvchrs1"
    sql "select jsonb_parse_nullable_error_to_value(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
}