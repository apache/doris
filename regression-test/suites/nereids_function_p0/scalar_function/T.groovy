...
suite("nereids_scalar_fn_T") {
	...
	qt_sql_timediff_TimestampNs_DateV2 "select timediff(ktsns, kdtv2) from fn_test order by ktsns, kdtv2"
	...
	qt_sql_timediff_TimestampNs_DateV2_notnull "select timediff(ktsns, kdtv2) from fn_test_not_nullable order by ktsns, kdtv2"
	qt_sql_timediff_DateV2_DateTimeV2 "select timediff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_timediff_DateV2_TimestampNs "select timediff(kdtv2, ktsns) from fn_test order by kdtv2, ktsns"
	...
	qt_sql_timediff_DateV2_TimestampNs_notnull "select timediff(kdtv2, ktsns) from fn_test_not_nullable order by kdtv2, ktsns"
	...
	qt_sql_timediff_TimestampNs_DateTime "select timediff(ktsns, kdtm) from fn_test order by ktsns, kdtm"
	...
	qt_sql_timediff_TimestampNs_DateTime_notnull "select timediff(ktsns, kdtm) from fn_test_not_nullable order by ktsns, kdtm"
