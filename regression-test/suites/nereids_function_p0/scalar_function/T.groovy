...
suite("nereids_scalar_fn_T") {
	...
	qt_sql_timediff_TimestampNs_TimestampNs "select timediff(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_timediff_TimestampNs_TimestampNs_notnull "select timediff(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_timediff_DateTimeV2_DateV2 "select timediff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_timediff_TimestampNs_DateV2 "select timediff(cast(kdtmv2s1 as timestamp_ns), kdtv2) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kdtv2"
	...
	qt_sql_timediff_TimestampNs_DateV2_notnull "select timediff(cast(kdtmv2s1 as timestamp_ns), kdtv2) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kdtv2"
	qt_sql_timediff_DateV2_DateTimeV2 "select timediff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_timediff_DateV2_TimestampNs "select timediff(kdtv2, cast(kdtmv2s1 as timestamp_ns)) from fn_test order by kdtv2, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_timediff_DateV2_TimestampNs_notnull "select timediff(kdtv2, cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by kdtv2, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_timediff_TimestampNs_DateTime "select timediff(cast(kdtmv2s1 as timestamp_ns), kdtm) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kdtm"
	...
	qt_sql_timediff_TimestampNs_DateTime_notnull "select timediff(cast(kdtmv2s1 as timestamp_ns), kdtm) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kdtm"
	...
	qt_sql_timestamp_TimestampNs "select timestamp(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_timestamp_DateTimeV2_notnull "select timestamp(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_timestamp_TimestampNs_notnull "select timestamp(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_to_date_TimestampNs "select to_date(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_to_date_DateTimeV2_notnull "select to_date(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_date_TimestampNs_notnull "select to_date(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_to_datev2_DateTimeV2 "select to_datev2(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_to_datev2_TimestampNs "select to_datev2(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_to_datev2_DateTimeV2_notnull "select to_datev2(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_datev2_TimestampNs_notnull "select to_datev2(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_to_monday_TimestampNs "select to_monday(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_to_monday_DateTimeV2_notnull "select to_monday(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_monday_TimestampNs_notnull "select to_monday(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
