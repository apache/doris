...
suite("nereids_scalar_fn_T") {
	...
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2_notnull "select timestamp(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_timestamp_DateTime "select timestamp(kdtm,'Asia/Bangkok') from fn_test order by kdtm"
	qt_sql_timestamp_DateTime_notnull "select timestamp(kdtm,'Asia/Bangkok') from fn_test_not_nullable order by kdtm"
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1,'Asia/Bangkok') from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2_notnull "select timestamp(kdtmv2s1,'Asia/Bangkok') from fn_test_not_nullable order by kdtmv2s1"
