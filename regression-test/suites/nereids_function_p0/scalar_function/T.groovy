...
suite("nereids_scalar_fn_T") {
	...
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2_notnull "select timestamp(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_timestamp_DateTime_tz "select timestamp(kdtm,'Asia/Bangkok') from fn_test order by kdtm"
	qt_sql_timestamp_DateTime_notnull_tz "select timestamp(kdtm,'Asia/Bangkok') from fn_test_not_nullable order by kdtm"
	qt_sql_timestamp_DateTimeV2_tz "select timestamp(kdtmv2s1,'Asia/Bangkok') from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2_notnull_tz "select timestamp(kdtmv2s1,'Asia/Bangkok') from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_timestamp_DateTime_tz_c "select timestamp(kdtm, kchrs2) from fn_test order by kdtm"
	qt_sql_timestamp_DateTime_notnull_tz_c "select timestamp(kdtm, kchrs2) from fn_test_not_nullable order by kdtm"
	qt_sql_timestamp_DateTimeV2_tz_c "select timestamp(kdtmv2s1, kchrs2) from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2_notnull_tz_c "select timestamp(kdtmv2s1, kchrs2) from fn_test_not_nullable order by kdtmv2s1"
