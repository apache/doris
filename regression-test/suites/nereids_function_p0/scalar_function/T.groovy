...
suite("nereids_scalar_fn_T") {
	...
	qt_sql_timediff_DateTime_DateTime "select timediff(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_timediff_DateTimeV2_DateTimeV2 "select timediff(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_timediff_DateTimeV2_DateTimeV2 "select timediff(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_timediff_DateTimeV2_DateV2 "select timediff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_timediff_DateTimeV2_DateV2 "select timediff(kdtmv2s1, kdtv2) from fn_test_not_nullable order by kdtmv2s1, kdtv2"
	qt_sql_timediff_DateV2_DateTimeV2 "select timediff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_timediff_DateV2_DateTimeV2 "select timediff(kdtv2, kdtmv2s1) from fn_test_not_nullable order by kdtv2, kdtmv2s1"
	qt_sql_timediff_DateV2_DateV2 "select timediff(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_timediff_DateV2_DateV2 "select timediff(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_timediff_DateTimeV2_DateTime "select timediff(kdtmv2s1, kdtm) from fn_test order by kdtmv2s1, kdtm"
	qt_sql_timediff_DateTimeV2_DateTime "select timediff(kdtmv2s1, kdtm) from fn_test_not_nullable order by kdtmv2s1, kdtm"
	qt_sql_timediff_DateV2_DateTime "select timediff(kdtv2, kdtm) from fn_test order by kdtv2, kdtm"
	qt_sql_timediff_DateV2_DateTime "select timediff(kdtv2, kdtm) from fn_test_not_nullable order by kdtv2, kdtm"
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_timestamp_DateTime "select timestamp(kdtm) from fn_test order by kdtm"
	qt_sql_timestamp_DateTime "select timestamp(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_timestamp_DateTime "select timestamp(kdtm) from fn_test order by kdtm"
	qt_sql_timestamp_DateTime "select timestamp(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_timestamp_DateTimeV2 "select timestamp(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_base64_String "select to_base64(kstr) from fn_test order by kstr"
	qt_sql_to_base64_String "select to_base64(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_to_bitmap_Varchar "select to_bitmap(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_to_bitmap_Varchar "select to_bitmap(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_to_bitmap_String "select to_bitmap(kstr) from fn_test order by kstr"
	qt_sql_to_bitmap_String "select to_bitmap(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_to_bitmap_with_check_BigInt "select to_bitmap_with_check(kbint) from fn_test order by kbint"
	qt_sql_to_bitmap_with_check_BigInt "select to_bitmap_with_check(kbint) from fn_test_not_nullable order by kbint"
	qt_sql_to_date_DateTime "select to_date(kdtm) from fn_test order by kdtm"
	qt_sql_to_date_DateTime "select to_date(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_to_date_DateTimeV2 "select to_date(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_to_date_DateTimeV2 "select to_date(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_datev2_DateTimeV2 "select to_datev2(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_to_datev2_DateTimeV2 "select to_datev2(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_days_Date "select to_days(kdt) from fn_test order by kdt"
	qt_sql_to_days_Date "select to_days(kdt) from fn_test_not_nullable order by kdt"
	qt_sql_to_days_DateV2 "select to_days(kdtv2) from fn_test order by kdtv2"
	qt_sql_to_days_DateV2 "select to_days(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_to_monday_DateTimeV2 "select to_monday(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_to_monday_DateTimeV2 "select to_monday(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_to_monday_DateV2 "select to_monday(kdtv2) from fn_test order by kdtv2"
	qt_sql_to_monday_DateV2 "select to_monday(kdtv2) from fn_test_not_nullable order by kdtv2"
	...
	qt_sql_trim_String "select trim(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_truncate_Double_Integer "select truncate(kdbl, 2) from fn_test order by kdbl"
	qt_sql_truncate_Double_Integer "select truncate(kdbl, 2) from fn_test_not_nullable order by kdbl"
}