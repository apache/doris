...
suite("nereids_scalar_fn_D") {
	...
	qt_sql_date_DateTime_tz "select date(kdtm, 'Asia/Bangkok') from fn_test order by kdtm"
	qt_sql_date_DateTime_tz_c "select date(kdtm, kchrs2) from fn_test order by kdtm"
	qt_sql_date_DateTime_notnull "select date(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_date_DateTime_notnull_tz "select date(kdtm, 'Asia/Bangkok') from fn_test_not_nullable order by kdtm"
	qt_sql_date_DateTime_notnull_tz_c "select date(kdtm, kchrs2) from fn_test_not_nullable order by kdtm"
