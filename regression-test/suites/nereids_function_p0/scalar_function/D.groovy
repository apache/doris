...
suite("nereids_scalar_fn_D") {
	...
	qt_sql_datediff_TimestampNs_DateV2 "select datediff(ktsns, kdtv2) from fn_test order by ktsns, kdtv2"
	...
	qt_sql_datediff_TimestampNs_DateV2_notnull "select datediff(ktsns, kdtv2) from fn_test_not_nullable order by ktsns, kdtv2"
	qt_sql_datediff_DateV2_DateTimeV2 "select datediff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_datediff_DateV2_TimestampNs "select datediff(kdtv2, ktsns) from fn_test order by kdtv2, ktsns"
	...
	qt_sql_datediff_DateV2_TimestampNs_notnull "select datediff(kdtv2, ktsns) from fn_test_not_nullable order by kdtv2, ktsns"
	...
	qt_sql_datediff_TimestampNs_DateTime "select datediff(ktsns, kdtm) from fn_test order by ktsns, kdtm"
	...
	qt_sql_datediff_TimestampNs_DateTime_notnull "select datediff(ktsns, kdtm) from fn_test_not_nullable order by ktsns, kdtm"
	...
	qt_sql_days_diff_DateV2_TimestampNs "select days_diff(kdtv2, ktsns) from fn_test order by kdtv2, ktsns"
	...
	qt_sql_days_diff_DateV2_TimestampNs_notnull "select days_diff(kdtv2, ktsns) from fn_test_not_nullable order by kdtv2, ktsns"
	qt_sql_days_diff_DateTimeV2_DateV2 "select days_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_days_diff_TimestampNs_DateV2 "select days_diff(ktsns, kdtv2) from fn_test order by ktsns, kdtv2"
	...
	qt_sql_days_diff_TimestampNs_DateV2_notnull "select days_diff(ktsns, kdtv2) from fn_test_not_nullable order by ktsns, kdtv2"
	...
	qt_sql_days_diff_TimestampNs_DateTime "select days_diff(ktsns, kdtm) from fn_test order by ktsns, kdtm"
	...
	qt_sql_days_diff_TimestampNs_DateTime_notnull "select days_diff(ktsns, kdtm) from fn_test_not_nullable order by ktsns, kdtm"
	qt_sql_days_diff_DateTime_DateTimeV2 "select days_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_days_diff_DateTime_TimestampNs "select days_diff(kdtm, ktsns) from fn_test order by kdtm, ktsns"
	...
	qt_sql_days_diff_DateTime_TimestampNs_notnull "select days_diff(kdtm, ktsns) from fn_test_not_nullable order by kdtm, ktsns"
