...
suite("nereids_scalar_fn_N") {
	...
	qt_sql_nullif_TimestampNs_TimestampNs "select nullif(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_nullif_TimestampNs_TimestampNs_notnull "select nullif(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_nvl_TimestampNs_TimestampNs "select nvl(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_nvl_TimestampNs_TimestampNs_notnull "select nvl(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
