...
suite("nereids_scalar_fn_L") {
	...
	qt_sql_last_day_TimestampNs "select last_day(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_last_day_DateTimeV2_notnull "select last_day(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_last_day_TimestampNs_notnull "select last_day(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_lcm_TinyInt_TinyInt "select lcm(ktint, ktint) from fn_test order by ktint, ktint"
    qt_sql_lcm_TinyInt_TinyInt_notnull "select lcm(ktint, ktint) from fn_test_not_nullable order by ktint, ktint"
    qt_sql_lcm_SmallInt_SmallInt "select lcm(ksint, ksint) from fn_test order by ksint, ksint"
    qt_sql_lcm_SmallInt_SmallInt_notnull "select lcm(ksint, ksint) from fn_test_not_nullable order by ksint, ksint"
    qt_sql_lcm_Integer_Integer "select lcm(kint, kint) from fn_test order by kint, kint"
	...
	qt_sql_least_TimestampNs "select least(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_least_DateTimeV2_notnull "select least(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_least_TimestampNs_notnull "select least(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
