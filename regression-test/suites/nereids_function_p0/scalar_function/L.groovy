...
suite("nereids_scalar_fn_L") {
	...
	qt_sql_last_day_TimestampNs "select last_day(ktsns) from fn_test order by ktsns"
	qt_sql_last_day_DateTimeV2_notnull "select last_day(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_last_day_TimestampNs_notnull "select last_day(ktsns) from fn_test_not_nullable order by ktsns"
	...
	qt_sql_least_TimestampNs "select least(ktsns) from fn_test order by ktsns"
	qt_sql_least_DateTimeV2_notnull "select least(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_least_TimestampNs_notnull "select least(ktsns) from fn_test_not_nullable order by ktsns"
