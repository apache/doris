...
suite("nereids_scalar_fn_Y") {
	...
	qt_sql_years_diff_DateV2_TimestampNs "select years_diff(kdtv2, ktsns) from fn_test order by kdtv2, ktsns"
	...
	qt_sql_years_diff_DateV2_TimestampNs_notnull "select years_diff(kdtv2, ktsns) from fn_test_not_nullable order by kdtv2, ktsns"
	qt_sql_years_diff_DateTimeV2_DateV2 "select years_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_years_diff_TimestampNs_DateV2 "select years_diff(ktsns, kdtv2) from fn_test order by ktsns, kdtv2"
	...
	qt_sql_years_diff_TimestampNs_DateV2_notnull "select years_diff(ktsns, kdtv2) from fn_test_not_nullable order by ktsns, kdtv2"
	...
	qt_sql_years_diff_TimestampNs_DateTime "select years_diff(ktsns, kdtm) from fn_test order by ktsns, kdtm"
	...
	qt_sql_years_diff_TimestampNs_DateTime_notnull "select years_diff(ktsns, kdtm) from fn_test_not_nullable order by ktsns, kdtm"
	qt_sql_years_diff_DateTime_DateTimeV2 "select years_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_years_diff_DateTime_TimestampNs "select years_diff(kdtm, ktsns) from fn_test order by kdtm, ktsns"
	...
	qt_sql_years_diff_DateTime_TimestampNs_notnull "select years_diff(kdtm, ktsns) from fn_test_not_nullable order by kdtm, ktsns"
