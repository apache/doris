...
suite("nereids_scalar_fn_5") {
    ...
    // qt_sql "select year_week(kdtm, kint) from fn_test order by kdtm, kint"
    // qt_sql "select year_week(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
    // qt_sql "select year_week(kdtv2, kint) from fn_test order by kdtv2, kint"
