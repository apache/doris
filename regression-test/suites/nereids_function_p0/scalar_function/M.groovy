...
//	qt_sql_mask_last_n_String_Integer_notnull "select mask_last_n(kstr, kint) from fn_test_not_nullable order by kstr, kint"
	...
	qt_sql_minutes_diff_DateV2_TimestampNs "select minutes_diff(kdtv2, ktsns) from fn_test order by kdtv2, ktsns"
	...
	qt_sql_minutes_diff_DateV2_TimestampNs_notnull "select minutes_diff(kdtv2, ktsns) from fn_test_not_nullable order by kdtv2, ktsns"
	qt_sql_minutes_diff_DateTimeV2_DateV2 "select minutes_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_minutes_diff_TimestampNs_DateV2 "select minutes_diff(ktsns, kdtv2) from fn_test order by ktsns, kdtv2"
	...
	qt_sql_minutes_diff_TimestampNs_DateV2_notnull "select minutes_diff(ktsns, kdtv2) from fn_test_not_nullable order by ktsns, kdtv2"
	...
	qt_sql_minutes_diff_TimestampNs_DateTime "select minutes_diff(ktsns, kdtm) from fn_test order by ktsns, kdtm"
	...
	qt_sql_minutes_diff_TimestampNs_DateTime_notnull "select minutes_diff(ktsns, kdtm) from fn_test_not_nullable order by ktsns, kdtm"
	qt_sql_minutes_diff_DateTime_DateTimeV2 "select minutes_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_minutes_diff_DateTime_TimestampNs "select minutes_diff(kdtm, ktsns) from fn_test order by kdtm, ktsns"
	...
	qt_sql_minutes_diff_DateTime_TimestampNs_notnull "select minutes_diff(kdtm, ktsns) from fn_test_not_nullable order by kdtm, ktsns"
	...
	qt_sql_months_diff_DateV2_TimestampNs "select months_diff(kdtv2, ktsns) from fn_test order by kdtv2, ktsns"
	...
	qt_sql_months_diff_DateV2_TimestampNs_notnull "select months_diff(kdtv2, ktsns) from fn_test_not_nullable order by kdtv2, ktsns"
	qt_sql_months_diff_DateTimeV2_DateV2 "select months_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_months_diff_TimestampNs_DateV2 "select months_diff(ktsns, kdtv2) from fn_test order by ktsns, kdtv2"
	...
	qt_sql_months_diff_TimestampNs_DateV2_notnull "select months_diff(ktsns, kdtv2) from fn_test_not_nullable order by ktsns, kdtv2"
	...
	qt_sql_months_diff_TimestampNs_DateTime "select months_diff(ktsns, kdtm) from fn_test order by ktsns, kdtm"
	...
	qt_sql_months_diff_TimestampNs_DateTime_notnull "select months_diff(ktsns, kdtm) from fn_test_not_nullable order by ktsns, kdtm"
	qt_sql_months_diff_DateTime_DateTimeV2 "select months_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_months_diff_DateTime_TimestampNs "select months_diff(kdtm, ktsns) from fn_test order by kdtm, ktsns"
	...
	qt_sql_months_diff_DateTime_TimestampNs_notnull "select months_diff(kdtm, ktsns) from fn_test_not_nullable order by kdtm, ktsns"
