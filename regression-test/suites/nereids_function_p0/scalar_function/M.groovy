...
suite("nereids_scalar_fn_M") {
	...
	qt_sql_mask_Varchar "select mask(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_mask_String "select mask(kstr) from fn_test order by kstr"
	qt_sql_mask_String "select mask(kstr) from fn_test_not_nullable order by kstr"
	...
	qt_sql_md5_String "select md5(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_md5sum_Varchar "select md5sum(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_md5sum_Varchar "select md5sum(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_md5sum_String "select md5sum(kstr) from fn_test order by kstr"
	qt_sql_md5sum_String "select md5sum(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_minute_DateTime "select minute(kdtm) from fn_test order by kdtm"
	qt_sql_minute_DateTime "select minute(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_minute_DateTimeV2 "select minute(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_minute_DateTimeV2 "select minute(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_minute_DateV2 "select minute(kdtv2) from fn_test order by kdtv2"
	qt_sql_minute_DateV2 "select minute(kdtv2) from fn_test_not_nullable order by kdtv2"
	...
	qt_sql_minutes_add_DateTimeV2_Integer "select minutes_add(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_minutes_add_Date_Integer "select minutes_add(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_minutes_add_Date_Integer "select minutes_add(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_minutes_add_DateV2_Integer "select minutes_add(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_minutes_add_DateV2_Integer "select minutes_add(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_minutes_diff_DateTime_DateTime "select minutes_diff(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_minutes_diff_DateTime_DateTime "select minutes_diff(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_minutes_diff_DateTimeV2_DateTimeV2 "select minutes_diff(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_minutes_diff_DateTimeV2_DateTimeV2 "select minutes_diff(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_minutes_diff_DateV2_DateTimeV2 "select minutes_diff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_minutes_diff_DateV2_DateTimeV2 "select minutes_diff(kdtv2, kdtmv2s1) from fn_test_not_nullable order by kdtv2, kdtmv2s1"
	qt_sql_minutes_diff_DateTimeV2_DateV2 "select minutes_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_minutes_diff_DateTimeV2_DateV2 "select minutes_diff(kdtmv2s1, kdtv2) from fn_test_not_nullable order by kdtmv2s1, kdtv2"
	qt_sql_minutes_diff_DateV2_DateV2 "select minutes_diff(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_minutes_diff_DateV2_DateV2 "select minutes_diff(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_minutes_diff_DateV2_DateTime "select minutes_diff(kdtv2, kdtm) from fn_test order by kdtv2, kdtm"
	qt_sql_minutes_diff_DateV2_DateTime "select minutes_diff(kdtv2, kdtm) from fn_test_not_nullable order by kdtv2, kdtm"
	qt_sql_minutes_diff_DateTime_DateV2 "select minutes_diff(kdtm, kdtv2) from fn_test order by kdtm, kdtv2"
	qt_sql_minutes_diff_DateTime_DateV2 "select minutes_diff(kdtm, kdtv2) from fn_test_not_nullable order by kdtm, kdtv2"
	qt_sql_minutes_diff_DateTimeV2_DateTime "select minutes_diff(kdtmv2s1, kdtm) from fn_test order by kdtmv2s1, kdtm"
	qt_sql_minutes_diff_DateTimeV2_DateTime "select minutes_diff(kdtmv2s1, kdtm) from fn_test_not_nullable order by kdtmv2s1, kdtm"
	qt_sql_minutes_diff_DateTime_DateTimeV2 "select minutes_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_minutes_diff_DateTime_DateTimeV2 "select minutes_diff(kdtm, kdtmv2s1) from fn_test_not_nullable order by kdtm, kdtmv2s1"
	qt_sql_minutes_sub_DateTime_Integer "select minutes_sub(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_minutes_sub_DateTime_Integer "select minutes_sub(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_minutes_sub_DateTimeV2_Integer "select minutes_sub(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_minutes_sub_DateTimeV2_Integer "select minutes_sub(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_minutes_sub_Date_Integer "select minutes_sub(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_minutes_sub_Date_Integer "select minutes_sub(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_minutes_sub_DateV2_Integer "select minutes_sub(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_minutes_sub_DateV2_Integer "select minutes_sub(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_money_format_BigInt "select money_format(kbint) from fn_test order by kbint"
	qt_sql_money_format_BigInt "select money_format(kbint) from fn_test_not_nullable order by kbint"
	qt_sql_money_format_LargeInt "select money_format(klint) from fn_test order by klint"
	qt_sql_money_format_LargeInt "select money_format(klint) from fn_test_not_nullable order by klint"
	qt_sql_money_format_Double "select money_format(kdbl) from fn_test order by kdbl"
	qt_sql_money_format_Double "select money_format(kdbl) from fn_test_not_nullable order by kdbl"
	qt_sql_money_format_DecimalV2 "select money_format(kdcmls1) from fn_test order by kdcmls1"
	qt_sql_money_format_DecimalV2 "select money_format(kdcmls1) from fn_test_not_nullable order by kdcmls1"
	qt_sql_month_DateTime "select month(kdtm) from fn_test order by kdtm"
	qt_sql_month_DateTime "select month(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_month_DateTimeV2 "select month(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_month_DateTimeV2 "select month(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_month_DateV2 "select month(kdtv2) from fn_test order by kdtv2"
	qt_sql_month_DateV2 "select month(kdtv2) from fn_test_not_nullable order by kdtv2"
	...
	qt_sql_monthname_DateTimeV2 "select monthname(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_monthname_DateV2 "select monthname(kdtv2) from fn_test order by kdtv2"
	qt_sql_monthname_DateV2 "select monthname(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_months_add_DateTime_Integer "select months_add(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_months_add_DateTime_Integer "select months_add(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_months_add_DateTimeV2_Integer "select months_add(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_months_add_DateTimeV2_Integer "select months_add(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_months_add_Date_Integer "select months_add(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_months_add_Date_Integer "select months_add(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_months_add_DateV2_Integer "select months_add(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_months_add_DateV2_Integer "select months_add(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_months_diff_DateTime_DateTime "select months_diff(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_months_diff_DateTime_DateTime "select months_diff(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_months_diff_DateTimeV2_DateTimeV2 "select months_diff(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_months_diff_DateTimeV2_DateTimeV2 "select months_diff(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_months_diff_DateV2_DateTimeV2 "select months_diff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_months_diff_DateV2_DateTimeV2 "select months_diff(kdtv2, kdtmv2s1) from fn_test_not_nullable order by kdtv2, kdtmv2s1"
	qt_sql_months_diff_DateTimeV2_DateV2 "select months_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_months_diff_DateTimeV2_DateV2 "select months_diff(kdtmv2s1, kdtv2) from fn_test_not_nullable order by kdtmv2s1, kdtv2"
	qt_sql_months_diff_DateV2_DateV2 "select months_diff(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_months_diff_DateV2_DateV2 "select months_diff(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_months_diff_DateV2_DateTime "select months_diff(kdtv2, kdtm) from fn_test order by kdtv2, kdtm"
	qt_sql_months_diff_DateV2_DateTime "select months_diff(kdtv2, kdtm) from fn_test_not_nullable order by kdtv2, kdtm"
	qt_sql_months_diff_DateTime_DateV2 "select months_diff(kdtm, kdtv2) from fn_test order by kdtm, kdtv2"
	qt_sql_months_diff_DateTime_DateV2 "select months_diff(kdtm, kdtv2) from fn_test_not_nullable order by kdtm, kdtv2"
	qt_sql_months_diff_DateTimeV2_DateTime "select months_diff(kdtmv2s1, kdtm) from fn_test order by kdtmv2s1, kdtm"
	qt_sql_months_diff_DateTimeV2_DateTime "select months_diff(kdtmv2s1, kdtm) from fn_test_not_nullable order by kdtmv2s1, kdtm"
	qt_sql_months_diff_DateTime_DateTimeV2 "select months_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_months_diff_DateTime_DateTimeV2 "select months_diff(kdtm, kdtmv2s1) from fn_test_not_nullable order by kdtm, kdtmv2s1"
	qt_sql_months_sub_DateTime_Integer "select months_sub(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_months_sub_DateTime_Integer "select months_sub(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_months_sub_DateTimeV2_Integer "select months_sub(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_months_sub_DateTimeV2_Integer "select months_sub(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_months_sub_Date_Integer "select months_sub(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_months_sub_Date_Integer "select months_sub(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_months_sub_DateV2_Integer "select months_sub(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_months_sub_DateV2_Integer "select months_sub(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_murmur_hash3_32_Varchar "select murmur_hash3_32(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_murmur_hash3_32_Varchar "select murmur_hash3_32(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_murmur_hash3_32_String "select murmur_hash3_32(kstr) from fn_test order by kstr"
	qt_sql_murmur_hash3_32_String "select murmur_hash3_32(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_murmur_hash3_64_Varchar "select murmur_hash3_64(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_murmur_hash3_64_Varchar "select murmur_hash3_64(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_murmur_hash3_64_String "select murmur_hash3_64(kstr) from fn_test order by kstr"
	qt_sql_murmur_hash3_64_String "select murmur_hash3_64(kstr) from fn_test_not_nullable order by kstr"
}