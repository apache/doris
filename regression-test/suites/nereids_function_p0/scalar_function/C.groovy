...
suite("nereids_scalar_fn_C") {
	...
	qt_sql_coalesce_TimestampNs "select coalesce(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_coalesce_DateTimeV2_notnull "select coalesce(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_coalesce_TimestampNs_notnull "select coalesce(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_convert_tz_TimestampNs_Varchar_Varchar "select convert_tz(cast(kdtmv2s1 as timestamp_ns), 'Asia/Shanghai', 'Europe/Sofia') from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_convert_tz_TimestampNs_Varchar_Varchar_notnull "select convert_tz(cast(kdtmv2s1 as timestamp_ns), 'Asia/Shanghai', 'Europe/Sofia') from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_kadtmv2_timestamp_ns "select count(cast(kadtmv2 as array<timestamp_ns>)) from fn_test "
	qt_kadtmv2_not_nullable "select count(kadtmv2) from fn_test_not_nullable "
	qt_kadtmv2_not_nullable_timestamp_ns "select count(cast(kadtmv2 as array<timestamp_ns>)) from fn_test_not_nullable "
