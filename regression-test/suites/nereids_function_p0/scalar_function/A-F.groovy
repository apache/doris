...
suite("nereids_scalar_fn_1") {
    ...
    qt_sql "select aes_decrypt(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    qt_sql "select aes_decrypt(kstr, kstr) from fn_test order by kstr, kstr"
    qt_sql "select aes_decrypt(kvchrs1, kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1, kvchrs1"
    qt_sql "select aes_decrypt(kstr, kstr, kstr) from fn_test order by kstr, kstr, kstr"
    // qt_sql "select aes_decrypt(kvchrs1, kvchrs1, kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1, kvchrs1, kvchrs1"
    // qt_sql "select aes_decrypt(kstr, kstr, kstr, kstr) from fn_test order by kstr, kstr, kstr, kstr"
    qt_sql "select aes_encrypt(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    qt_sql "select aes_encrypt(kstr, kstr) from fn_test order by kstr, kstr"
    qt_sql "select aes_encrypt(kvchrs1, kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1, kvchrs1"
    qt_sql "select aes_encrypt(kstr, kstr, kstr) from fn_test order by kstr, kstr, kstr"
    // qt_sql "select aes_encrypt(kvchrs1, kvchrs1, kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1, kvchrs1, kvchrs1"
    // qt_sql "select aes_encrypt(kstr, kstr, kstr, kstr) from fn_test order by kstr, kstr, kstr, kstr"
...
// function coalesce(bitmap) is unsupported for the test suite.
    ...
    qt_sql "select connection_id() from fn_test"
    ...
    qt_sql "select current_date() from fn_test"
    qt_sql "select current_time() from fn_test"
    qt_sql "select current_timestamp() from fn_test"
    // qt_sql "select current_timestamp(kint) from fn_test order by kint"
    qt_sql "select current_user() from fn_test"
    qt_sql "select curtime() from fn_test"
    qt_sql "select database() from fn_test"
