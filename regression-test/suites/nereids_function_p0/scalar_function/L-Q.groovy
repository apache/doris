...
suite("nereids_scalar_fn_3") {
    ...
    qt_sql "select makedate(kint, kint) from fn_test order by kint, kint"
    ...
    // cannot find function
    qt_sql "select md5sum(kvchrs1) from fn_test order by kvchrs1"
    qt_sql "select md5sum(kstr) from fn_test order by kstr"
    ...
    qt_sql "select monthname(kdtm) from fn_test order by kdtm"
    qt_sql "select monthname(kdtmv2s1) from fn_test order by kdtmv2s1"
    qt_sql "select monthname(kdtv2) from fn_test order by kdtv2"
    ...
    qt_sql "select murmur_hash3_32(kvchrs1) from fn_test order by kvchrs1"
    qt_sql "select murmur_hash3_32(kstr) from fn_test order by kstr"
    qt_sql "select murmur_hash3_64(kvchrs1) from fn_test order by kvchrs1"
    qt_sql "select murmur_hash3_64(kstr) from fn_test order by kstr"
    ...
    // cannot find function
    qt_sql "select nullif(kbool, kbool) from fn_test order by kbool, kbool"
    qt_sql "select nullif(ktint, ktint) from fn_test order by ktint, ktint"
    qt_sql "select nullif(ksint, ksint) from fn_test order by ksint, ksint"
    qt_sql "select nullif(kint, kint) from fn_test order by kint, kint"
    qt_sql "select nullif(kbint, kbint) from fn_test order by kbint, kbint"
    qt_sql "select nullif(klint, klint) from fn_test order by klint, klint"
    qt_sql "select nullif(kfloat, kfloat) from fn_test order by kfloat, kfloat"
    qt_sql "select nullif(kdbl, kdbl) from fn_test order by kdbl, kdbl"
    qt_sql "select nullif(kdtm, kdtm) from fn_test order by kdtm, kdtm"
    qt_sql "select nullif(kdt, kdt) from fn_test order by kdt, kdt"
    qt_sql "select nullif(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
    qt_sql "select nullif(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
    qt_sql "select nullif(kdcmls1, kdcmls1) from fn_test order by kdcmls1, kdcmls1"
    qt_sql "select nullif(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    qt_sql "select nullif(kstr, kstr) from fn_test order by kstr, kstr"
