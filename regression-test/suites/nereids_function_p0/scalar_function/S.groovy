...
suite("nereids_scalar_fn_S") {
	...
	qt_sql_st_asbinary_Varchar "select ST_AsBinary(st_polyfromtext(polygon_wkt)) from fn_test order by 1"
    qt_sql_st_asbinary_Varchar_notnull "select ST_AsBinary(st_polyfromtext(polygon_wkt)) from fn_test_not_nullable order by 1"
	...
	qt_sql_st_asewkb_Varchar "select ST_AsEWKB(st_polyfromtext(polygon_wkt)) from fn_test order by 1"
    qt_sql_st_asewkb_Varchar_notnull "select ST_AsEWKB(st_polyfromtext(polygon_wkt)) from fn_test_not_nullable order by 1"
