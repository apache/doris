...
suite("nereids_scalar_fn_S") {
	...
	qt_sql_st_astext_Varchar_notnull "select st_astext(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_astext_String "select st_astext(kstr) from fn_test order by kstr"
	qt_sql_st_astext_String_notnull "select st_astext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_aswkt_Varchar "select st_aswkt(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_aswkt_Varchar_notnull "select st_aswkt(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_aswkt_String "select st_aswkt(kstr) from fn_test order by kstr"
	qt_sql_st_aswkt_String_notnull "select st_aswkt(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_circle_Double_Double_Double "select st_circle(kdbl, kdbl, kdbl) from fn_test order by kdbl, kdbl, kdbl"
	qt_sql_st_circle_Double_Double_Double_notnull "select st_circle(kdbl, kdbl, kdbl) from fn_test_not_nullable order by kdbl, kdbl, kdbl"
	...
	qt_sql_st_geometryfromtext_String_notnull "select st_geometryfromtext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_geomfromtext_Varchar "select st_geomfromtext(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_geomfromtext_Varchar_notnull "select st_geomfromtext(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_geomfromtext_String "select st_geomfromtext(kstr) from fn_test order by kstr"
	qt_sql_st_geomfromtext_String_notnull "select st_geomfromtext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_linefromtext_Varchar "select st_linefromtext(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_linefromtext_Varchar_notnull "select st_linefromtext(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_linefromtext_String "select st_linefromtext(kstr) from fn_test order by kstr"
	qt_sql_st_linefromtext_String_notnull "select st_linefromtext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_linestringfromtext_Varchar "select st_linestringfromtext(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_linestringfromtext_Varchar_notnull "select st_linestringfromtext(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_linestringfromtext_String "select st_linestringfromtext(kstr) from fn_test order by kstr"
	qt_sql_st_linestringfromtext_String_notnull "select st_linestringfromtext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_point_Double_Double "select st_point(kdbl, kdbl) from fn_test order by kdbl, kdbl"
	qt_sql_st_point_Double_Double_notnull "select st_point(kdbl, kdbl) from fn_test_not_nullable order by kdbl, kdbl"
	qt_sql_st_polyfromtext_Varchar "select st_polyfromtext(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_polyfromtext_Varchar_notnull "select st_polyfromtext(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_polyfromtext_String "select st_polyfromtext(kstr) from fn_test order by kstr"
	qt_sql_st_polyfromtext_String_notnull "select st_polyfromtext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_polygon_Varchar "select st_polygon(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_polygon_Varchar_notnull "select st_polygon(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_polygon_String "select st_polygon(kstr) from fn_test order by kstr"
	qt_sql_st_polygon_String_notnull "select st_polygon(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_polygonfromtext_Varchar "select st_polygonfromtext(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_polygonfromtext_Varchar_notnull "select st_polygonfromtext(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_polygonfromtext_String "select st_polygonfromtext(kstr) from fn_test order by kstr"
	qt_sql_st_polygonfromtext_String_notnull "select st_polygonfromtext(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_x_Varchar "select st_x(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_x_Varchar_notnull "select st_x(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_x_String "select st_x(kstr) from fn_test order by kstr"
	qt_sql_st_x_String_notnull "select st_x(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_st_y_Varchar "select st_y(kvchrs1) from fn_test order by kvchrs1"
	qt_sql_st_y_Varchar_notnull "select st_y(kvchrs1) from fn_test_not_nullable order by kvchrs1"
	qt_sql_st_y_String "select st_y(kstr) from fn_test order by kstr"
	qt_sql_st_y_String_notnull "select st_y(kstr) from fn_test_not_nullable order by kstr"
