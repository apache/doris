...
suite("nereids_scalar_fn_S") {
	...
	qt_sql_second_ceil_DateTime "select second_ceil(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_second_ceil_DateTimeV2 "select second_ceil(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_second_ceil_DateTimeV2 "select second_ceil(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_second_ceil_DateV2 "select second_ceil(kdtv2) from fn_test order by kdtv2"
	qt_sql_second_ceil_DateV2 "select second_ceil(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_second_ceil_DateTime_DateTime "select second_ceil(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_second_ceil_DateTime_DateTime "select second_ceil(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_second_ceil_DateTime_Integer "select second_ceil(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_second_ceil_DateTime_Integer "select second_ceil(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_second_ceil_DateTimeV2_DateTimeV2 "select second_ceil(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_second_ceil_DateTimeV2_DateTimeV2 "select second_ceil(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_second_ceil_DateTimeV2_Integer "select second_ceil(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_second_ceil_DateTimeV2_Integer "select second_ceil(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_second_ceil_DateV2_DateV2 "select second_ceil(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_second_ceil_DateV2_DateV2 "select second_ceil(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_second_ceil_DateV2_Integer "select second_ceil(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_second_ceil_DateV2_Integer "select second_ceil(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_second_ceil_DateTime_Integer_DateTime "select second_ceil(kdtm, kint, kdtm) from fn_test order by kdtm, kint, kdtm"
	qt_sql_second_ceil_DateTime_Integer_DateTime "select second_ceil(kdtm, kint, kdtm) from fn_test_not_nullable order by kdtm, kint, kdtm"
	...
	qt_sql_second_ceil_DateTimeV2_Integer_DateTimeV2 "select second_ceil(kdtmv2s1, kint, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kint, kdtmv2s1"
	qt_sql_second_ceil_DateV2_Integer_DateV2 "select second_ceil(kdtv2, kint, kdtv2) from fn_test order by kdtv2, kint, kdtv2"
	qt_sql_second_ceil_DateV2_Integer_DateV2 "select second_ceil(kdtv2, kint, kdtv2) from fn_test_not_nullable order by kdtv2, kint, kdtv2"
	qt_sql_second_floor_DateTime "select second_floor(kdtm) from fn_test order by kdtm"
	qt_sql_second_floor_DateTime "select second_floor(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_second_floor_DateTimeV2 "select second_floor(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_second_floor_DateTimeV2 "select second_floor(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_second_floor_DateV2 "select second_floor(kdtv2) from fn_test order by kdtv2"
	qt_sql_second_floor_DateV2 "select second_floor(kdtv2) from fn_test_not_nullable order by kdtv2"
	qt_sql_second_floor_DateTime_DateTime "select second_floor(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_second_floor_DateTime_DateTime "select second_floor(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_second_floor_DateTime_Integer "select second_floor(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_second_floor_DateTime_Integer "select second_floor(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_second_floor_DateTimeV2_DateTimeV2 "select second_floor(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_second_floor_DateTimeV2_DateTimeV2 "select second_floor(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_second_floor_DateTimeV2_Integer "select second_floor(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_second_floor_DateTimeV2_Integer "select second_floor(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_second_floor_DateV2_DateV2 "select second_floor(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_second_floor_DateV2_DateV2 "select second_floor(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_second_floor_DateV2_Integer "select second_floor(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_second_floor_DateV2_Integer "select second_floor(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_second_floor_DateTime_Integer_DateTime "select second_floor(kdtm, kint, kdtm) from fn_test order by kdtm, kint, kdtm"
	qt_sql_second_floor_DateTime_Integer_DateTime "select second_floor(kdtm, kint, kdtm) from fn_test_not_nullable order by kdtm, kint, kdtm"
	...
	qt_sql_second_floor_DateTimeV2_Integer_DateTimeV2 "select second_floor(kdtmv2s1, kint, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kint, kdtmv2s1"
	qt_sql_second_floor_DateV2_Integer_DateV2 "select second_floor(kdtv2, kint, kdtv2) from fn_test order by kdtv2, kint, kdtv2"
	qt_sql_second_floor_DateV2_Integer_DateV2 "select second_floor(kdtv2, kint, kdtv2) from fn_test_not_nullable order by kdtv2, kint, kdtv2"
	...
	qt_sql_sub_bitmap_Bitmap_BigInt_BigInt "select sub_bitmap(to_bitmap(kbint), kbint, kbint) from fn_test_not_nullable order by kbint, kbint, kbint"
