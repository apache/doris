...
suite("nereids_scalar_fn_S") {
	...
	qt_sql_second_TimestampNs "select second(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_second_DateTimeV2_notnull "select second(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_second_TimestampNs_notnull "select second(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_ceil_TimestampNs "select second_ceil(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_second_ceil_DateTimeV2_notnull "select second_ceil(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_second_ceil_TimestampNs_notnull "select second_ceil(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_ceil_TimestampNs_TimestampNs "select second_ceil(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_ceil_TimestampNs_TimestampNs_notnull "select second_ceil(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_second_ceil_DateTimeV2_Integer "select second_ceil(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_second_ceil_TimestampNs_Integer "select second_ceil(cast(kdtmv2s1 as timestamp_ns), kint) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kint"
	...
	qt_sql_second_ceil_TimestampNs_Integer_notnull "select second_ceil(cast(kdtmv2s1 as timestamp_ns), kint) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kint"
	...
	qt_sql_second_ceil_TimestampNs_Integer_TimestampNs "select second_ceil(cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_ceil_TimestampNs_Integer_TimestampNs_notnull "select second_ceil(cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_floor_TimestampNs "select second_floor(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_second_floor_DateTimeV2_notnull "select second_floor(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_second_floor_TimestampNs_notnull "select second_floor(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_floor_TimestampNs_TimestampNs "select second_floor(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_floor_TimestampNs_TimestampNs_notnull "select second_floor(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_second_floor_DateTimeV2_Integer "select second_floor(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_second_floor_TimestampNs_Integer "select second_floor(cast(kdtmv2s1 as timestamp_ns), kint) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kint"
	...
	qt_sql_second_floor_TimestampNs_Integer_notnull "select second_floor(cast(kdtmv2s1 as timestamp_ns), kint) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kint"
	...
	qt_sql_second_floor_TimestampNs_Integer_TimestampNs "select second_floor(cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_second_floor_TimestampNs_Integer_TimestampNs_notnull "select second_floor(cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kint, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_seconds_add_TimestampNs_Integer "select seconds_add(cast(kdtmv2s1 as timestamp_ns), kint) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kint"
	...
	qt_sql_seconds_add_TimestampNs_Integer_notnull "select seconds_add(cast(kdtmv2s1 as timestamp_ns), kint) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kint"
	...
	qt_sql_seconds_diff_TimestampNs_TimestampNs "select seconds_diff(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_seconds_diff_TimestampNs_TimestampNs_notnull "select seconds_diff(cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_seconds_diff_DateV2_DateTimeV2 "select seconds_diff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_seconds_diff_DateV2_TimestampNs "select seconds_diff(kdtv2, cast(kdtmv2s1 as timestamp_ns)) from fn_test order by kdtv2, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_seconds_diff_DateV2_TimestampNs_notnull "select seconds_diff(kdtv2, cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by kdtv2, cast(kdtmv2s1 as timestamp_ns)"
	qt_sql_seconds_diff_DateTimeV2_DateV2 "select seconds_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_seconds_diff_TimestampNs_DateV2 "select seconds_diff(cast(kdtmv2s1 as timestamp_ns), kdtv2) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kdtv2"
	...
	qt_sql_seconds_diff_TimestampNs_DateV2_notnull "select seconds_diff(cast(kdtmv2s1 as timestamp_ns), kdtv2) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kdtv2"
	...
	qt_sql_seconds_diff_TimestampNs_DateTime "select seconds_diff(cast(kdtmv2s1 as timestamp_ns), kdtm) from fn_test order by cast(kdtmv2s1 as timestamp_ns), kdtm"
	...
	qt_sql_seconds_diff_TimestampNs_DateTime_notnull "select seconds_diff(cast(kdtmv2s1 as timestamp_ns), kdtm) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns), kdtm"
	qt_sql_seconds_diff_DateTime_DateTimeV2 "select seconds_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_seconds_diff_DateTime_TimestampNs "select seconds_diff(kdtm, cast(kdtmv2s1 as timestamp_ns)) from fn_test order by kdtm, cast(kdtmv2s1 as timestamp_ns)"
	...
	qt_sql_seconds_diff_DateTime_TimestampNs_notnull "select seconds_diff(kdtm, cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by kdtm, cast(kdtmv2s1 as timestamp_ns)"
