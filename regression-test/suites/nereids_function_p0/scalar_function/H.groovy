...
suite("nereids_scalar_fn_H") {
	...
	qt_sql_hex_BigInt "select hex(kbint) from fn_test_not_nullable order by kbint"
	...
	qt_sql_hll_hash_String "select hll_hash(kstr) from fn_test_not_nullable order by kstr"
	qt_sql_hour_DateTime "select hour(kdtm) from fn_test order by kdtm"
	qt_sql_hour_DateTime "select hour(kdtm) from fn_test_not_nullable order by kdtm"
	qt_sql_hour_DateTimeV2 "select hour(kdtmv2s1) from fn_test order by kdtmv2s1"
	qt_sql_hour_DateTimeV2 "select hour(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
	qt_sql_hour_DateV2 "select hour(kdtv2) from fn_test order by kdtv2"
	qt_sql_hour_DateV2 "select hour(kdtv2) from fn_test_not_nullable order by kdtv2"
	...
	qt_sql_hours_add_DateTimeV2_Integer "select hours_add(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_hours_add_Date_Integer "select hours_add(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_hours_add_Date_Integer "select hours_add(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_hours_add_DateV2_Integer "select hours_add(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_hours_add_DateV2_Integer "select hours_add(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
	qt_sql_hours_diff_DateTime_DateTime "select hours_diff(kdtm, kdtm) from fn_test order by kdtm, kdtm"
	qt_sql_hours_diff_DateTime_DateTime "select hours_diff(kdtm, kdtm) from fn_test_not_nullable order by kdtm, kdtm"
	qt_sql_hours_diff_DateTimeV2_DateTimeV2 "select hours_diff(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
	qt_sql_hours_diff_DateTimeV2_DateTimeV2 "select hours_diff(kdtmv2s1, kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1, kdtmv2s1"
	qt_sql_hours_diff_DateV2_DateTimeV2 "select hours_diff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
	qt_sql_hours_diff_DateV2_DateTimeV2 "select hours_diff(kdtv2, kdtmv2s1) from fn_test_not_nullable order by kdtv2, kdtmv2s1"
	qt_sql_hours_diff_DateTimeV2_DateV2 "select hours_diff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
	qt_sql_hours_diff_DateTimeV2_DateV2 "select hours_diff(kdtmv2s1, kdtv2) from fn_test_not_nullable order by kdtmv2s1, kdtv2"
	qt_sql_hours_diff_DateV2_DateV2 "select hours_diff(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
	qt_sql_hours_diff_DateV2_DateV2 "select hours_diff(kdtv2, kdtv2) from fn_test_not_nullable order by kdtv2, kdtv2"
	qt_sql_hours_diff_DateV2_DateTime "select hours_diff(kdtv2, kdtm) from fn_test order by kdtv2, kdtm"
	qt_sql_hours_diff_DateV2_DateTime "select hours_diff(kdtv2, kdtm) from fn_test_not_nullable order by kdtv2, kdtm"
	qt_sql_hours_diff_DateTime_DateV2 "select hours_diff(kdtm, kdtv2) from fn_test order by kdtm, kdtv2"
	qt_sql_hours_diff_DateTime_DateV2 "select hours_diff(kdtm, kdtv2) from fn_test_not_nullable order by kdtm, kdtv2"
	qt_sql_hours_diff_DateTimeV2_DateTime "select hours_diff(kdtmv2s1, kdtm) from fn_test order by kdtmv2s1, kdtm"
	qt_sql_hours_diff_DateTimeV2_DateTime "select hours_diff(kdtmv2s1, kdtm) from fn_test_not_nullable order by kdtmv2s1, kdtm"
	qt_sql_hours_diff_DateTime_DateTimeV2 "select hours_diff(kdtm, kdtmv2s1) from fn_test order by kdtm, kdtmv2s1"
	qt_sql_hours_diff_DateTime_DateTimeV2 "select hours_diff(kdtm, kdtmv2s1) from fn_test_not_nullable order by kdtm, kdtmv2s1"
	qt_sql_hours_sub_DateTime_Integer "select hours_sub(kdtm, kint) from fn_test order by kdtm, kint"
	qt_sql_hours_sub_DateTime_Integer "select hours_sub(kdtm, kint) from fn_test_not_nullable order by kdtm, kint"
	qt_sql_hours_sub_DateTimeV2_Integer "select hours_sub(kdtmv2s1, kint) from fn_test order by kdtmv2s1, kint"
	qt_sql_hours_sub_DateTimeV2_Integer "select hours_sub(kdtmv2s1, kint) from fn_test_not_nullable order by kdtmv2s1, kint"
	qt_sql_hours_sub_Date_Integer "select hours_sub(kdt, kint) from fn_test order by kdt, kint"
	qt_sql_hours_sub_Date_Integer "select hours_sub(kdt, kint) from fn_test_not_nullable order by kdt, kint"
	qt_sql_hours_sub_DateV2_Integer "select hours_sub(kdtv2, kint) from fn_test order by kdtv2, kint"
	qt_sql_hours_sub_DateV2_Integer "select hours_sub(kdtv2, kint) from fn_test_not_nullable order by kdtv2, kint"
}