...
suite("nereids_scalar_fn_G") {
    ...
    qt_sql_greatest_TimestampNs "select greatest(cast(kdtmv2s1 as timestamp_ns)) from fn_test order by cast(kdtmv2s1 as timestamp_ns)"
    qt_sql_greatest_DateTimeV2_notnull "select greatest(kdtmv2s1) from fn_test_not_nullable order by kdtmv2s1"
    qt_sql_greatest_TimestampNs_notnull "select greatest(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable order by cast(kdtmv2s1 as timestamp_ns)"
