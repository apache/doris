...
suite("nereids_scalar_fn_4") {
    ...
    qt_sql "select running_difference(ktint) from fn_test order by ktint"
    qt_sql "select running_difference(ksint) from fn_test order by ksint"
    qt_sql "select running_difference(kint) from fn_test order by kint"
    // qt_sql "select running_difference(kbint) from fn_test order by kbint"
    qt_sql "select running_difference(klint) from fn_test order by klint"
    qt_sql "select running_difference(kfloat) from fn_test order by kfloat"
    qt_sql "select running_difference(kdbl) from fn_test order by kdbl"
    qt_sql "select running_difference(kdcmls1) from fn_test order by kdcmls1"
    qt_sql "select running_difference(kdt) from fn_test order by kdt"
    qt_sql "select running_difference(kdtv2) from fn_test order by kdtv2"
    ...
    qt_sql "select sm4_decrypt(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    qt_sql "select sm4_decrypt(kstr, kstr) from fn_test order by kstr, kstr"
    qt_sql "select sm4_decrypt(kvchrs1, kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1, kvchrs1"
    qt_sql "select sm4_decrypt(kstr, kstr, kstr) from fn_test order by kstr, kstr, kstr"
    ...
    qt_sql "select sm4_encrypt(kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1"
    qt_sql "select sm4_encrypt(kstr, kstr) from fn_test order by kstr, kstr"
    qt_sql "select sm4_encrypt(kvchrs1, kvchrs1, kvchrs1) from fn_test order by kvchrs1, kvchrs1, kvchrs1"
    qt_sql "select sm4_encrypt(kstr, kstr, kstr) from fn_test order by kstr, kstr, kstr"
...
// function sub_bitmap(bitmap, bigint, bigint) is unsupported for the test suite.
    ...
    qt_sql "select unix_timestamp() from fn_test"
    ...
    qt_sql "select user() from fn_test"
    qt_sql "select utc_timestamp() from fn_test"
    qt_sql "select uuid() from fn_test"
    qt_sql "select version() from fn_test"
