...
suite("nereids_scalar_fn_4") {
    ...
    qt_sql """ select split_part(kvchrs1, " ", 1) from fn_test order by kvchrs1, kvchrs1, kint"""
    qt_sql """ select split_part(kstr, " ", 1) from fn_test order by kstr, kstr, kint"""
    qt_sql "select sqrt(kdbl) from fn_test order by kdbl"
    qt_sql "select st_astext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_astext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_aswkt(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_aswkt(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_circle(kdbl, kdbl, kdbl) from fn_test order by kdbl, kdbl, kdbl"
    qt_sql "select st_contains(st_point_vc, st_point_vc) from fn_test order by st_point_vc, st_point_vc"
    qt_sql "select st_distance_sphere(kdbl, kdbl, kdbl, kdbl) from fn_test order by kdbl, kdbl, kdbl, kdbl"
    qt_sql "select st_geometryfromtext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_geometryfromtext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_geomfromtext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_geomfromtext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_linefromtext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_linefromtext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_linestringfromtext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_linestringfromtext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_point(kdbl, kdbl) from fn_test order by kdbl, kdbl"
    qt_sql "select st_polyfromtext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_polyfromtext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_polygon(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_polygon(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_polygonfromtext(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_polygonfromtext(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_x(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_x(st_point_str) from fn_test order by st_point_str"
    qt_sql "select st_y(st_point_vc) from fn_test order by st_point_vc"
    qt_sql "select st_y(st_point_str) from fn_test order by st_point_str"
    ...
    qt_sql "select strleft(kvchrs1, kint) from fn_test order by kvchrs1, kint"
    qt_sql "select strleft(kstr, kint) from fn_test order by kstr, kint"
    qt_sql "select strright(kvchrs1, kint) from fn_test order by kvchrs1, kint"
    qt_sql "select strright(kstr, kint) from fn_test order by kstr, kint"
...
// function sub_bitmap(bitmap, bigint, bigint) is unsupported for the test suite.
    ...
    qt_sql "select substring_index(kvchrs1, ' ', 2) from fn_test order by kvchrs1, kvchrs1, kint"
    qt_sql "select substring_index(kstr, ' ', 2) from fn_test order by kstr, kstr, kint"
    qt_sql "select tan(kdbl) from fn_test order by kdbl"
    qt_sql "select timediff(kdtm, kdtm) from fn_test order by kdtm, kdtm"
    qt_sql "select timediff(kdtmv2s1, kdtmv2s1) from fn_test order by kdtmv2s1, kdtmv2s1"
    qt_sql "select timediff(kdtmv2s1, kdtv2) from fn_test order by kdtmv2s1, kdtv2"
    qt_sql "select timediff(kdtv2, kdtmv2s1) from fn_test order by kdtv2, kdtmv2s1"
    qt_sql "select timediff(kdtv2, kdtv2) from fn_test order by kdtv2, kdtv2"
    qt_sql "select timediff(kdtmv2s1, kdtm) from fn_test order by kdtmv2s1, kdtm"
    qt_sql "select timediff(kdtv2, kdtm) from fn_test order by kdtv2, kdtm"
    ...
    qt_sql "select to_datev2(kdtmv2s1) from fn_test order by kdtmv2s1"
