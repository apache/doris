...
suite("test_regr_slope") {
    ...
    sql """
        ...
        """
    sql """
        CREATE TABLE test_regr_slope_nullable_col (
          `id` int,
          `x` int,
          `y` int
        ) ENGINE=OLAP
        ...
        """
    // no value
    qt_sql "select regr_slope(y,x) from test_regr_slope_int"
    ...
    sql """
        INSERT INTO test_regr_slope_nullable_col VALUES
        (1, 18, 13),
        (2, 14, 27),
        (3, 5, 7),
        (4, 10, 20);
    ...
    // value is null
    sql """SELECT regr_slope(NULL, NULL);"""

    // parameter is literal and columns
    qt_sql "select regr_slope(10,x) from test_regr_slope_int"

    // literal and column
    qt_sql "select regr_slope(4,x) from test_regr_slope_int"
    ...
    // double value
    qt_sql "select regr_slope(y,x) from test_regr_slope_double"
    sql """ TRUNCATE TABLE test_regr_slope_double """

    // nullable and non_nullable
    qt_sql "select regr_slope(y,non_nullable(x)) from test_regr_slope_nullable_col"

    // non_nullable and nullable
    qt_sql "select regr_slope(non_nullable(y),x) from test_regr_slope_nullable_col"

    // non_nullable and non_nullable
    qt_sql "select regr_slope(non_nullable(y),non_nullable(x)) from test_regr_slope_nullable_col"
    sql """ TRUNCATE TABLE test_regr_slope_nullable_col """
