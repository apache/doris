...
suite("nereids_agg_fn") {
	...
	qt_sql_group_concat_Varchar_AnyData_gb "select group_concat(kvchrs1, kint) from fn_test group by kbool order by kbool"
	qt_sql_group_concat_Varchar_AnyData_gb "select group_concat(kvchrs1, kint) from fn_test"
	qt_sql_group_concat_Varchar_AnyData_gb_notnull_gb "select group_concat(kvchrs1, kint) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_group_concat_Varchar_AnyData_gb_notnull_gb_notnull "select group_concat(kvchrs1, kint) from fn_test_not_nullable"
	...
	qt_sql_percentile_BigInt_Double_gb "select percentile(kbint, kdbl) from fn_test group by kbool order by kbool"
	qt_sql_percentile_BigInt_Double_gb "select percentile(kbint, kdbl) from fn_test"
	qt_sql_percentile_BigInt_Double_gb_notnull_gb "select percentile(kbint, kdbl) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_percentile_BigInt_Double_gb_notnull_gb_notnull "select percentile(kbint, kdbl) from fn_test_not_nullable"

	qt_sql_percentile_approx_Double_Double_gb "select percentile_approx(kdbl, kdbl) from fn_test group by kbool order by kbool"
	qt_sql_percentile_approx_Double_Double_gb "select percentile_approx(kdbl, kdbl) from fn_test"
	qt_sql_percentile_approx_Double_Double_gb_notnull_gb "select percentile_approx(kdbl, kdbl) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_percentile_approx_Double_Double_gb_notnull_gb_notnull "select percentile_approx(kdbl, kdbl) from fn_test_not_nullable"

	qt_sql_percentile_approx_Double_Double_Double_gb "select percentile_approx(kdbl, kdbl, kdbl) from fn_test group by kbool order by kbool"
	qt_sql_percentile_approx_Double_Double_Double_gb "select percentile_approx(kdbl, kdbl, kdbl) from fn_test"
	qt_sql_percentile_approx_Double_Double_Double_gb_notnull_gb "select percentile_approx(kdbl, kdbl, kdbl) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_percentile_approx_Double_Double_Double_gb_notnull_gb_notnull "select percentile_approx(kdbl, kdbl, kdbl) from fn_test_not_nullable"

	qt_sql_sequence_count_String_DateV2_Boolean_gb "select sequence_count(kstr, kdtv2, kbool) from fn_test group by kbool order by kbool"
	qt_sql_sequence_count_String_DateV2_Boolean_gb "select sequence_count(kstr, kdtv2, kbool) from fn_test"
	qt_sql_sequence_count_String_DateV2_Boolean_gb_notnull_gb "select sequence_count(kstr, kdtv2, kbool) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_sequence_count_String_DateV2_Boolean_gb_notnull_gb_notnull "select sequence_count(kstr, kdtv2, kbool) from fn_test_not_nullable"

	qt_sql_sequence_count_String_DateTime_Boolean_gb "select sequence_count(kstr, kdtm, kbool) from fn_test group by kbool order by kbool"
	qt_sql_sequence_count_String_DateTime_Boolean_gb "select sequence_count(kstr, kdtm, kbool) from fn_test"
	qt_sql_sequence_count_String_DateTime_Boolean_gb_notnull_gb "select sequence_count(kstr, kdtm, kbool) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_sequence_count_String_DateTime_Boolean_gb_notnull_gb_notnull "select sequence_count(kstr, kdtm, kbool) from fn_test_not_nullable"

	qt_sql_sequence_count_String_DateTimeV2_Boolean_gb "select sequence_count(kstr, kdtmv2s1, kbool) from fn_test group by kbool order by kbool"
	qt_sql_sequence_count_String_DateTimeV2_Boolean_gb "select sequence_count(kstr, kdtmv2s1, kbool) from fn_test"
	qt_sql_sequence_count_String_DateTimeV2_Boolean_gb_notnull_gb "select sequence_count(kstr, kdtmv2s1, kbool) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_sequence_count_String_DateTimeV2_Boolean_gb_notnull_gb_notnull "select sequence_count(kstr, kdtmv2s1, kbool) from fn_test_not_nullable"

	qt_sql_sequence_match_String_DateV2_Boolean_gb "select sequence_match(kstr, kdtv2, kbool) from fn_test group by kbool order by kbool"
	qt_sql_sequence_match_String_DateV2_Boolean_gb "select sequence_match(kstr, kdtv2, kbool) from fn_test"
	qt_sql_sequence_match_String_DateV2_Boolean_gb_notnull_gb "select sequence_match(kstr, kdtv2, kbool) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_sequence_match_String_DateV2_Boolean_gb_notnull_gb_notnull "select sequence_match(kstr, kdtv2, kbool) from fn_test_not_nullable"

	qt_sql_sequence_match_String_DateTime_Boolean_gb "select sequence_match(kstr, kdtm, kbool) from fn_test group by kbool order by kbool"
	qt_sql_sequence_match_String_DateTime_Boolean_gb "select sequence_match(kstr, kdtm, kbool) from fn_test"
	qt_sql_sequence_match_String_DateTime_Boolean_gb_notnull_gb "select sequence_match(kstr, kdtm, kbool) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_sequence_match_String_DateTime_Boolean_gb_notnull_gb_notnull "select sequence_match(kstr, kdtm, kbool) from fn_test_not_nullable"

	qt_sql_sequence_match_String_DateTimeV2_Boolean_gb "select sequence_match(kstr, kdtmv2s1, kbool) from fn_test group by kbool order by kbool"
	qt_sql_sequence_match_String_DateTimeV2_Boolean_gb "select sequence_match(kstr, kdtmv2s1, kbool) from fn_test"
	qt_sql_sequence_match_String_DateTimeV2_Boolean_gb_notnull_gb "select sequence_match(kstr, kdtmv2s1, kbool) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_sequence_match_String_DateTimeV2_Boolean_gb_notnull_gb_notnull "select sequence_match(kstr, kdtmv2s1, kbool) from fn_test_not_nullable"
	...
	qt_sql_topn_Varchar_Integer_gb "select topn(kvchrs1, kint) from fn_test group by kbool order by kbool"
	qt_sql_topn_Varchar_Integer_gb "select topn(kvchrs1, kint) from fn_test"
	qt_sql_topn_Varchar_Integer_gb_notnull_gb "select topn(kvchrs1, kint) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_topn_Varchar_Integer_gb_notnull_gb_notnull "select topn(kvchrs1, kint) from fn_test_not_nullable"

	qt_sql_topn_String_Integer_gb "select topn(kstr, kint) from fn_test group by kbool order by kbool"
	qt_sql_topn_String_Integer_gb "select topn(kstr, kint) from fn_test"
	qt_sql_topn_String_Integer_gb_notnull_gb "select topn(kstr, kint) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_topn_String_Integer_gb_notnull_gb_notnull "select topn(kstr, kint) from fn_test_not_nullable"

	qt_sql_topn_Varchar_Integer_Integer_gb "select topn(kvchrs1, kint, kint) from fn_test group by kbool order by kbool"
	qt_sql_topn_Varchar_Integer_Integer_gb "select topn(kvchrs1, kint, kint) from fn_test"
	qt_sql_topn_Varchar_Integer_Integer_gb_notnull_gb "select topn(kvchrs1, kint, kint) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_topn_Varchar_Integer_Integer_gb_notnull_gb_notnull "select topn(kvchrs1, kint, kint) from fn_test_not_nullable"

	qt_sql_topn_String_Integer_Integer_gb "select topn(kstr, kint, kint) from fn_test group by kbool order by kbool"
	qt_sql_topn_String_Integer_Integer_gb "select topn(kstr, kint, kint) from fn_test"
	qt_sql_topn_String_Integer_Integer_gb_notnull_gb "select topn(kstr, kint, kint) from fn_test_not_nullable group by kbool order by kbool"
	qt_sql_topn_String_Integer_Integer_gb_notnull_gb_notnull "select topn(kstr, kint, kint) from fn_test_not_nullable"
