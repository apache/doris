...
suite("nereids_agg_fn") {
	...
	sql '''
		select count(distinct id, kint), any_value(kint) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), any_value(kint) from fn_test'''
	sql '''
	...
	qt_sql_avg_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), avg(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), avg(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_Integer_agg_phase_3 '''
		select count(distinct id, kint), avg(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_BigInt_agg_phase_3 '''
		select count(distinct id, kint), avg(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_Double_agg_phase_3 '''
		select count(distinct id, kint), avg(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), avg(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_TinyInt_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(ktint, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_SmallInt_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(ksint, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_Integer_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(kint, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_BigInt_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(kbint, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_Float_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(kfloat, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_Double_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(kdbl, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_avg_weighted_DecimalV2_Double_agg_phase_3 '''
		select count(distinct id, kint), avg_weighted(kdcmls1, kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_bitmap_intersect_Bitmap_agg_phase_3 '''
		select count(distinct id, kint), bitmap_intersect(bitmap_hash(kbint)) from fn_test group by kbool order by kbool'''
	...
	qt_sql_bitmap_union_Bitmap_agg_phase_3 '''
		select count(distinct id, kint), bitmap_union(bitmap_hash(kbint)) from fn_test group by kbool order by kbool'''
	...
	qt_sql_bitmap_union_count_Bitmap_agg_phase_3 '''
		select count(distinct id, kint), bitmap_union_count(bitmap_hash(kbint)) from fn_test group by kbool order by kbool'''
	...
	qt_sql_bitmap_union_int_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), bitmap_union_int(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_bitmap_union_int_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), bitmap_union_int(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_bitmap_union_int_Integer_agg_phase_3 '''
		select count(distinct id, kint), bitmap_union_int(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_count_agg_phase_3 '''
		select count(distinct id, kint), count() from fn_test group by kbool order by kbool'''
	...
	qt_sql_count_AnyData_agg_phase_3 '''
		select count(distinct id, kint), count(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_and_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_and(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_and_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_and(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_and_Integer_agg_phase_3 '''
		select count(distinct id, kint), group_bit_and(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_and_BigInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_and(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_and_LargeInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_and(klint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_or_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_or(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_or_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_or(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_or_Integer_agg_phase_3 '''
		select count(distinct id, kint), group_bit_or(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_or_BigInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_or(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_or_LargeInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_or(klint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_xor_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_xor(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_xor_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_xor(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_xor_Integer_agg_phase_3 '''
		select count(distinct id, kint), group_bit_xor(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_xor_BigInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_xor(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bit_xor_LargeInt_agg_phase_3 '''
		select count(distinct id, kint), group_bit_xor(klint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_3 '''
		select count(distinct id, kint), group_bitmap_xor(bitmap_hash(kbint)) from fn_test group by kbool order by kbool'''
	...
	sql '''
		select count(distinct id, kint), histogram(ktint) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(ktint) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(ksint) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(ksint) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kint) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kint) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kbint) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kbint) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(klint) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(klint) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kfloat) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kfloat) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kdbl) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kdbl) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kdcmls1) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kdcmls1) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kdt) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kdt) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kdtm) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kdtm) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kdtv2) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kdtv2) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kdtmv2s1) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kdtmv2s1) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kchrs1) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kchrs1) from fn_test'''
	sql '''
	...
	sql '''
		select count(distinct id, kint), histogram(kstr) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(kstr) from fn_test'''
	sql '''
	...
	qt_sql_linear_histogram_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(ktint, 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(ksint, 3) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_Integer_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(kint, 5) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_BigInt_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(kbint, 10) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_Double_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(kdbl, 6.0) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(kdcmls1, 10) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_LargeInt_agg_phase_3 '''
		select count(distinct id, kint), linear_histogram(klint, 10) from fn_test group by kbool order by kbool'''
	...
	qt_sql_max_by_AnyData_AnyData_agg_phase_3 '''
		select count(distinct id, kint), max_by(kint, kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_min_by_AnyData_AnyData_agg_phase_3 '''
		select count(distinct id, kint), min_by(kint, kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_ndv_AnyData_agg_phase_3 '''
		select count(distinct id, kint), ndv(kint) from fn_test group by kbool order by kbool'''
	...
	// 	select count(distinct id, kint), orthogonal_bitmap_union_count(bitmap_hash(kbint)) from fn_test group by kbool order by kbool'''
	...
	qt_sql_percentile_BigInt_Double_agg_phase_3 '''
		select count(distinct id, kint), percentile(kbint, 0.6) from fn_test group by kbool order by kbool'''
	...
	qt_sql_percentile_approx_Double_Double_agg_phase_3 '''
		select count(distinct id, kint), percentile_approx(kdbl, 0.6) from fn_test group by kbool order by kbool'''
	...
	qt_sql_percentile_approx_Double_Double_Double_agg_phase_3 '''
		select count(distinct id, kint), percentile_approx(kdbl, 0.6, 4096.0) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sequence_count_String_DateV2_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_count('(?1)(?2)', kdtv2, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sequence_count_String_DateTime_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_count('(?1)(?2)', kdtm, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sequence_count_String_DateTimeV2_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_count('(?1)(?2)', kdtmv2s1, kint = 1, kint = 5) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sequence_match_String_DateV2_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_match('(?1)(?2)', kdtv2, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sequence_match_String_DateTime_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_match('(?1)(?2)', kdtm, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sequence_match_String_DateTimeV2_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_match('(?1)(?2)', kdtmv2s1, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), stddev(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), stddev(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_Integer_agg_phase_3 '''
		select count(distinct id, kint), stddev(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_BigInt_agg_phase_3 '''
		select count(distinct id, kint), stddev(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_Float_agg_phase_3 '''
		select count(distinct id, kint), stddev(kfloat) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_Double_agg_phase_3 '''
		select count(distinct id, kint), stddev(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), stddev(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_Integer_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_BigInt_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_Float_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(kfloat) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_Double_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_stddev_samp_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), stddev_samp(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), sum(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), sum(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_Integer_agg_phase_3 '''
		select count(distinct id, kint), sum(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_BigInt_agg_phase_3 '''
		select count(distinct id, kint), sum(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_Double_agg_phase_3 '''
		select count(distinct id, kint), sum(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), sum(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum_LargeInt_agg_phase_3 '''
		select count(distinct id, kint), sum(klint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), sum0(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), sum0(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_Integer_agg_phase_3 '''
		select count(distinct id, kint), sum0(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_BigInt_agg_phase_3 '''
		select count(distinct id, kint), sum0(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_Double_agg_phase_3 '''
		select count(distinct id, kint), sum0(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), sum0(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_sum0_LargeInt_agg_phase_3 '''
		select count(distinct id, kint), sum0(klint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_topn_Varchar_Integer_agg_phase_3 '''
		select count(distinct id, kint), topn(kvchrs1, 3) from fn_test group by kbool order by kbool'''
	...
	qt_sql_topn_String_Integer_agg_phase_3 '''
		select count(distinct id, kint), topn(kstr, 3) from fn_test group by kbool order by kbool'''
	...
	qt_sql_topn_Varchar_Integer_Integer_agg_phase_3 '''
		select count(distinct id, kint), topn(kvchrs1, 3, 100) from fn_test group by kbool order by kbool'''
	...
	qt_sql_topn_String_Integer_Integer_agg_phase_3 '''
		select count(distinct id, kint), topn(kstr, 3, 100) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), variance(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), variance(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_Integer_agg_phase_3 '''
		select count(distinct id, kint), variance(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_BigInt_agg_phase_3 '''
		select count(distinct id, kint), variance(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_Float_agg_phase_3 '''
		select count(distinct id, kint), variance(kfloat) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_Double_agg_phase_3 '''
		select count(distinct id, kint), variance(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), variance(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_TinyInt_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(ktint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_SmallInt_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(ksint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_Integer_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(kint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_BigInt_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(kbint) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_Float_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(kfloat) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_Double_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(kdbl) from fn_test group by kbool order by kbool'''
	...
	qt_sql_variance_samp_DecimalV2_agg_phase_3 '''
		select count(distinct id, kint), variance_samp(kdcmls1) from fn_test group by kbool order by kbool'''
	...
	qt_sql_window_funnel_BigInt_String_DateTime_Boolean_agg_phase_3 '''
		select count(distinct id, kint), window_funnel(3600 * 3, 'default', kdtm, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	qt_sql_window_funnel_BigInt_String_DateTimeV2_Boolean_agg_phase_3 '''
		select count(distinct id, kint), window_funnel(3600 * 3, 'default', kdtmv2s1, kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	...
	// TIMESTAMP_NS coverage mirrors the DATETIMEV2 aggregate-function matrix.
	sql '''
		select histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test group by kbool order by kbool'''
	sql '''
		select histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test'''
	sql '''
		select count(id), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test group by id order by id'''
	sql '''
		select count(distinct id), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test'''
	sql '''
		select count(distinct id, kint), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test'''
	sql '''
		select histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable group by kbool order by kbool'''
	sql '''
		select histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable'''
	sql '''
		select count(id), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable group by id order by id'''
	sql '''
		select count(distinct id), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test_not_nullable'''
	sql '''
		select count(distinct id, kint), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test group by kbool order by kbool'''
	sql '''
		select count(distinct id), histogram(cast(kdtmv2s1 as timestamp_ns)) from fn_test'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_gb '''
		select sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test group by kbool order by kbool'''
	qt_sql_sequence_count_String_TimestampNs_Boolean '''
		select sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_1 '''
		select count(id), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test group by id order by id'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test group by kbool order by kbool'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_4 '''
		select count(distinct id), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_gb_notnull '''
		select sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_notnull '''
		select sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test_not_nullable'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_1_notnull '''
		select count(id), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test_not_nullable group by id order by id'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_2_notnull '''
		select count(distinct id), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test_not_nullable'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_3_notnull '''
		select count(distinct id, kint), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test group by kbool order by kbool'''
	qt_sql_sequence_count_String_TimestampNs_Boolean_agg_phase_4_notnull '''
		select count(distinct id), sequence_count('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 5) from fn_test'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_gb '''
		select sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	qt_sql_sequence_match_String_TimestampNs_Boolean '''
		select sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_1 '''
		select count(id), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by id order by id'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_3 '''
		select count(distinct id, kint), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_4 '''
		select count(distinct id), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_gb_notnull '''
		select sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_notnull '''
		select sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_1_notnull '''
		select count(id), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable group by id order by id'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_2_notnull '''
		select count(distinct id), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_3_notnull '''
		select count(distinct id, kint), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	qt_sql_sequence_match_String_TimestampNs_Boolean_agg_phase_4_notnull '''
		select count(distinct id), sequence_match('(?1)(?2)', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_gb '''
		select window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean '''
		select window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_1 '''
		select count(id), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by id order by id'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_2 '''
		select count(distinct id), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_3 '''
		select count(distinct id, kint), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_4 '''
		select count(distinct id), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_gb_notnull '''
		select window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_notnull '''
		select window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_1_notnull '''
		select count(id), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable group by id order by id'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_2_notnull '''
		select count(distinct id), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test_not_nullable'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_3_notnull '''
		select count(distinct id, kint), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test group by kbool order by kbool'''
	qt_sql_window_funnel_BigInt_String_TimestampNs_Boolean_agg_phase_4_notnull '''
		select count(distinct id), window_funnel(3600 * 3, 'default', cast(kdtmv2s1 as timestamp_ns), kint = 1, kint = 2) from fn_test'''
