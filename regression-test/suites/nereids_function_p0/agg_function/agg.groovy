...
suite("nereids_agg_fn") {
	...
	qt_sql_linear_histogram_TinyInt_gb '''
		select linear_histogram(ktint, 10) from fn_test group by kbool order by kbool'''
	...
	qt_sql_linear_histogram_TinyInt_agg_phase_1 '''
		select count(id), linear_histogram(ktint, 10) from fn_test group by id order by id'''
	qt_sql_linear_histogram_TinyInt_agg_phase_2 '''
		select count(distinct id), linear_histogram(ktint, 10) from fn_test'''
	qt_sql_linear_histogram_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), linear_histogram(ktint, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_TinyInt_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), linear_histogram(ktint, 10) from fn_test'''
	qt_sql_linear_histogram_TinyInt_gb_notnull '''
		select linear_histogram(ktint, 10) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_linear_histogram_TinyInt_notnull '''
		select linear_histogram(ktint, 10) from fn_test_not_nullable'''
	qt_sql_linear_histogram_TinyInt_agg_phase_1_notnull '''
		select count(id), linear_histogram(ktint, 10) from fn_test_not_nullable group by id order by id'''
	qt_sql_linear_histogram_TinyInt_agg_phase_2_notnull '''
		select count(distinct id), linear_histogram(ktint, 10) from fn_test_not_nullable'''
	...
	qt_sql_linear_histogram_SmallInt_gb '''
		select linear_histogram(ksint, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_SmallInt '''
		select linear_histogram(ksint, 10) from fn_test'''
	qt_sql_linear_histogram_SmallInt_agg_phase_1 '''
		select count(id), linear_histogram(ksint, 10) from fn_test group by id order by id'''
	qt_sql_linear_histogram_SmallInt_agg_phase_2 '''
		select count(distinct id), linear_histogram(ksint, 10) from fn_test'''
	qt_sql_linear_histogram_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), linear_histogram(ksint, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_SmallInt_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), linear_histogram(ksint, 10) from fn_test'''
	qt_sql_linear_histogram_SmallInt_gb_notnull '''
		select linear_histogram(ksint, 10) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_linear_histogram_SmallInt_notnull '''
		select linear_histogram(ksint, 10) from fn_test_not_nullable'''
	qt_sql_linear_histogram_SmallInt_agg_phase_1_notnull '''
		select count(id), linear_histogram(ksint, 10) from fn_test_not_nullable group by id order by id'''
	qt_sql_linear_histogram_SmallInt_agg_phase_2_notnull '''
		select count(distinct id), linear_histogram(ksint, 10) from fn_test_not_nullable'''
	...
	qt_sql_linear_histogram_Integer_gb '''
		select linear_histogram(kint, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_Integer '''
		select linear_histogram(kint, 10) from fn_test'''
	qt_sql_linear_histogram_Integer_agg_phase_1 '''
		select count(id), linear_histogram(kint, 10) from fn_test group by id order by id'''
	qt_sql_linear_histogram_Integer_agg_phase_2 '''
		select count(distinct id), linear_histogram(kint, 10) from fn_test'''
	qt_sql_linear_histogram_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), linear_histogram(kint, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_Integer_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), linear_histogram(kint, 10) from fn_test'''
	qt_sql_linear_histogram_Integer_gb_notnull '''
		select linear_histogram(kint, 10) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_linear_histogram_Integer_notnull '''
		select linear_histogram(kint, 10) from fn_test_not_nullable'''
	qt_sql_linear_histogram_Integer_agg_phase_1_notnull '''
		select count(id), linear_histogram(kint, 10) from fn_test_not_nullable group by id order by id'''
	qt_sql_linear_histogram_Integer_agg_phase_2_notnull '''
		select count(distinct id), linear_histogram(kint, 10) from fn_test_not_nullable'''
	...
	qt_sql_linear_histogram_Double_gb '''
		select linear_histogram(kdbl, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_Double '''
		select linear_histogram(kdbl, 10) from fn_test'''
	qt_sql_linear_histogram_Double_agg_phase_1 '''
		select count(id), linear_histogram(kdbl, 10) from fn_test group by id order by id'''
	qt_sql_linear_histogram_Double_agg_phase_2 '''
		select count(distinct id), linear_histogram(kdbl, 10) from fn_test'''
	qt_sql_linear_histogram_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), linear_histogram(kdbl, 10) from fn_test group by kbool order by kbool'''
	qt_sql_linear_histogram_Double_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), linear_histogram(kdbl, 10) from fn_test'''
	qt_sql_linear_histogram_Double_gb_notnull '''
		select linear_histogram(kdbl, 10) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_linear_histogram_Double_notnull '''
		select linear_histogram(kdbl, 10) from fn_test_not_nullable'''
	qt_sql_linear_histogram_Double_agg_phase_1_notnull '''
		select count(id), linear_histogram(kdbl, 10) from fn_test_not_nullable group by id order by id'''
	qt_sql_linear_histogram_Double_agg_phase_2_notnull '''
		select count(distinct id), linear_histogram(kdbl, 10) from fn_test_not_nullable'''
