...
suite("test_regr_sxy") {
    ...
    sql """
        CREATE TABLE test_regr_sxy_int (
          `id` int,
          `x` int,
          `y` int,
        ) ENGINE=OLAP
        ...
        """
    sql """
        CREATE TABLE test_regr_sxy_double (
          `id` int,
          `x` double,
          `y` double,
        ) ENGINE=OLAP
    ...
    sql """
        ...
        """
    // no value
    qt_sql "select regr_sxy(y,x) from test_regr_sxy_int"
    sql """ truncate table test_regr_sxy_int """
    
    sql """
        insert into test_regr_sxy_int values
        (1, 18, 13),
        (2, 14, 27),
        (3, 12, 2),
        (4, 5, 6),
    ...
    sql """
        insert into test_regr_sxy_double values
    ...
    // value is literal and columns
    qt_sql "select regr_sxy(10,x) from test_regr_sxy_int"
    sql """ truncate table test_regr_sxy_int """
    ...
    // double value
    qt_sql "select regr_sxy(y,x) from test_regr_sxy_double"
