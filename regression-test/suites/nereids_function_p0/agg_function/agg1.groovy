...
suite("nereids_agg_fn") {
	...
	qt_sql_any_value_AnyData_gb '''
		select any_value(kint) from fn_test group by kbool order by kbool'''
	qt_sql_any_value_AnyData '''
		select any_value(kint) from fn_test'''
	qt_sql_any_value_AnyData_agg_phase_1 '''
		select count(id), any_value(kint) from fn_test group by id'''
	qt_sql_any_value_AnyData_agg_phase_2 '''
		select count(distinct id), any_value(kint) from fn_test'''
	qt_sql_any_value_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), any_value(kint) from fn_test group by kbool'''
	qt_sql_any_value_AnyData_agg_phase_4 '''
	...
	qt_sql_any_value_AnyData_gb_notnull '''
		select any_value(kint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_any_value_AnyData_notnull '''
		select any_value(kint) from fn_test_not_nullable'''
	qt_sql_any_value_AnyData_agg_phase_1_notnull '''
		select count(id), any_value(kint) from fn_test_not_nullable group by id'''
	qt_sql_any_value_AnyData_agg_phase_2_notnull '''
		select count(distinct id), any_value(kint) from fn_test_not_nullable'''
	qt_sql_any_value_AnyData_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), any_value(kint) from fn_test group by kbool'''
	qt_sql_any_value_AnyData_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), any_value(kint) from fn_test'''
	...
	qt_sql_avg_TinyInt_agg_phase_1 '''
		select count(id), avg(ktint) from fn_test group by id'''
	qt_sql_avg_TinyInt_agg_phase_2 '''
		select count(distinct id), avg(ktint) from fn_test'''
	qt_sql_avg_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg(ktint) from fn_test group by kbool'''
	...
	qt_sql_avg_TinyInt_agg_phase_1_notnull '''
		select count(id), avg(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_SmallInt_agg_phase_1 '''
		select count(id), avg(ksint) from fn_test group by id'''
	qt_sql_avg_SmallInt_agg_phase_2 '''
		select count(distinct id), avg(ksint) from fn_test'''
	qt_sql_avg_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg(ksint) from fn_test group by kbool'''
	...
	qt_sql_avg_SmallInt_agg_phase_1_notnull '''
		select count(id), avg(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_Integer_agg_phase_1 '''
		select count(id), avg(kint) from fn_test group by id'''
	qt_sql_avg_Integer_agg_phase_2 '''
		select count(distinct id), avg(kint) from fn_test'''
	qt_sql_avg_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg(kint) from fn_test group by kbool'''
	...
	qt_sql_avg_Integer_agg_phase_1_notnull '''
		select count(id), avg(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_BigInt_agg_phase_1 '''
		select count(id), avg(kbint) from fn_test group by id'''
	qt_sql_avg_BigInt_agg_phase_2 '''
		select count(distinct id), avg(kbint) from fn_test'''
	qt_sql_avg_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg(kbint) from fn_test group by kbool'''
	...
	qt_sql_avg_BigInt_agg_phase_1_notnull '''
		select count(id), avg(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_Double_agg_phase_1 '''
		select count(id), avg(kdbl) from fn_test group by id'''
	qt_sql_avg_Double_agg_phase_2 '''
		select count(distinct id), avg(kdbl) from fn_test'''
	qt_sql_avg_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg(kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_Double_agg_phase_1_notnull '''
		select count(id), avg(kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_DecimalV2_agg_phase_1 '''
		select count(id), avg(kdcmls1) from fn_test group by id'''
	qt_sql_avg_DecimalV2_agg_phase_2 '''
		select count(distinct id), avg(kdcmls1) from fn_test'''
	qt_sql_avg_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg(kdcmls1) from fn_test group by kbool'''
	...
	qt_sql_avg_DecimalV2_agg_phase_1_notnull '''
		select count(id), avg(kdcmls1) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_TinyInt_Double_agg_phase_1 '''
		select count(id), avg_weighted(ktint, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_TinyInt_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(ktint, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_TinyInt_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(ktint, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_SmallInt_Double_agg_phase_1 '''
		select count(id), avg_weighted(ksint, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_SmallInt_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(ksint, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_SmallInt_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(ksint, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_Integer_Double_agg_phase_1 '''
		select count(id), avg_weighted(kint, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_Integer_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(kint, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_Integer_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(kint, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_BigInt_Double_agg_phase_1 '''
		select count(id), avg_weighted(kbint, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_BigInt_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(kbint, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_BigInt_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(kbint, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_Float_Double_agg_phase_1 '''
		select count(id), avg_weighted(kfloat, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_Float_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(kfloat, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_Float_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(kfloat, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_Double_Double_agg_phase_1 '''
		select count(id), avg_weighted(kdbl, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_Double_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(kdbl, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_Double_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(kdbl, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_avg_weighted_DecimalV2_Double_agg_phase_1 '''
		select count(id), avg_weighted(kdcmls1, kdbl) from fn_test group by id'''
	...
	qt_sql_avg_weighted_DecimalV2_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), avg_weighted(kdcmls1, kdbl) from fn_test group by kbool'''
	...
	qt_sql_avg_weighted_DecimalV2_Double_agg_phase_1_notnull '''
		select count(id), avg_weighted(kdcmls1, kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_bitmap_intersect_Bitmap_gb '''
		select bitmap_intersect(to_bitmap(kbint)) from fn_test group by kbool order by kbool'''
	qt_sql_bitmap_intersect_Bitmap '''
		select bitmap_intersect(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_intersect_Bitmap_agg_phase_1 '''
		select count(id), bitmap_intersect(to_bitmap(kbint)) from fn_test group by id'''
	qt_sql_bitmap_intersect_Bitmap_agg_phase_2 '''
		select count(distinct id), bitmap_intersect(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_intersect_Bitmap_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_intersect(to_bitmap(kbint)) from fn_test group by kbool'''
	qt_sql_bitmap_intersect_Bitmap_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), bitmap_intersect(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_intersect_Bitmap_gb_notnull '''
		select bitmap_intersect(to_bitmap(kbint)) from fn_test_not_nullable group by kbool order by kbool'''
	...
	qt_sql_bitmap_intersect_Bitmap_agg_phase_1_notnull '''
		select count(id), bitmap_intersect(to_bitmap(kbint)) from fn_test_not_nullable group by id'''
	qt_sql_bitmap_intersect_Bitmap_agg_phase_2_notnull '''
		select count(distinct id), bitmap_intersect(to_bitmap(kbint)) from fn_test_not_nullable'''
	...
	qt_sql_bitmap_union_Bitmap_gb '''
		select bitmap_union(to_bitmap(kbint)) from fn_test group by kbool order by kbool'''
	qt_sql_bitmap_union_Bitmap '''
		select bitmap_union(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_union_Bitmap_agg_phase_1 '''
		select count(id), bitmap_union(to_bitmap(kbint)) from fn_test group by id'''
	qt_sql_bitmap_union_Bitmap_agg_phase_2 '''
		select count(distinct id), bitmap_union(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_union_Bitmap_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union(to_bitmap(kbint)) from fn_test group by kbool'''
	qt_sql_bitmap_union_Bitmap_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), bitmap_union(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_union_Bitmap_gb_notnull '''
		select bitmap_union(to_bitmap(kbint)) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_bitmap_union_Bitmap_notnull '''
		select bitmap_union(to_bitmap(kbint)) from fn_test_not_nullable'''
	qt_sql_bitmap_union_Bitmap_agg_phase_1_notnull '''
		select count(id), bitmap_union(to_bitmap(kbint)) from fn_test_not_nullable group by id'''
	qt_sql_bitmap_union_Bitmap_agg_phase_2_notnull '''
		select count(distinct id), bitmap_union(to_bitmap(kbint)) from fn_test_not_nullable'''
	...
	qt_sql_bitmap_union_count_Bitmap_gb '''
		select bitmap_union_count(to_bitmap(kbint)) from fn_test group by kbool order by kbool'''
	qt_sql_bitmap_union_count_Bitmap '''
		select bitmap_union_count(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_union_count_Bitmap_agg_phase_1 '''
		select count(id), bitmap_union_count(to_bitmap(kbint)) from fn_test group by id'''
	qt_sql_bitmap_union_count_Bitmap_agg_phase_2 '''
		select count(distinct id), bitmap_union_count(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_union_count_Bitmap_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union_count(to_bitmap(kbint)) from fn_test group by kbool'''
	qt_sql_bitmap_union_count_Bitmap_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), bitmap_union_count(to_bitmap(kbint)) from fn_test'''
	qt_sql_bitmap_union_count_Bitmap_gb_notnull '''
		select bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_bitmap_union_count_Bitmap_notnull '''
		select bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable'''
	qt_sql_bitmap_union_count_Bitmap_agg_phase_1_notnull '''
		select count(id), bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable group by id'''
	qt_sql_bitmap_union_count_Bitmap_agg_phase_2_notnull '''
		select count(distinct id), bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable'''
	...
	qt_sql_bitmap_union_int_SmallInt_agg_phase_1 '''
		select count(id), bitmap_union_int(ksint) from fn_test group by id'''
	...
	qt_sql_bitmap_union_int_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union_int(ksint) from fn_test group by kbool'''
	...
	qt_sql_bitmap_union_int_SmallInt_agg_phase_1_notnull '''
		select count(id), bitmap_union_int(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_bitmap_union_int_TinyInt_agg_phase_1 '''
		select count(id), bitmap_union_int(ktint) from fn_test group by id'''
	...
	qt_sql_bitmap_union_int_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union_int(ktint) from fn_test group by kbool'''
	...
	qt_sql_bitmap_union_int_TinyInt_agg_phase_1_notnull '''
		select count(id), bitmap_union_int(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_bitmap_union_int_Integer_agg_phase_1 '''
		select count(id), bitmap_union_int(kint) from fn_test group by id'''
	...
	qt_sql_bitmap_union_int_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union_int(kint) from fn_test group by kbool'''
	...
	qt_sql_bitmap_union_int_Integer_agg_phase_1_notnull '''
		select count(id), bitmap_union_int(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_bitmap_union_int_BigInt_gb '''
		select bitmap_union_int(kbint) from fn_test group by kbool order by kbool'''
	qt_sql_bitmap_union_int_BigInt '''
		select bitmap_union_int(kbint) from fn_test'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_1 '''
		select count(id), bitmap_union_int(kbint) from fn_test group by id'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_2 '''
		select count(distinct id), bitmap_union_int(kbint) from fn_test'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union_int(kbint) from fn_test group by kbool'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), bitmap_union_int(kbint) from fn_test'''
	qt_sql_bitmap_union_int_BigInt_gb_notnull '''
		select bitmap_union_int(kbint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_bitmap_union_int_BigInt_notnull '''
		select bitmap_union_int(kbint) from fn_test_not_nullable'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_1_notnull '''
		select count(id), bitmap_union_int(kbint) from fn_test_not_nullable group by id'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_2_notnull '''
		select count(distinct id), bitmap_union_int(kbint) from fn_test_not_nullable'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), bitmap_union_int(kbint) from fn_test group by kbool'''
	qt_sql_bitmap_union_int_BigInt_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), bitmap_union_int(kbint) from fn_test'''
	...
	qt_sql_count_agg_phase_1 '''
		select count(id), count() from fn_test group by id'''
	qt_sql_count_agg_phase_2 '''
		select count(distinct id), count() from fn_test'''
	qt_sql_count_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), count() from fn_test group by kbool'''
	...
	qt_sql_count_agg_phase_1_notnull '''
		select count(id), count() from fn_test_not_nullable group by id'''
	...
	qt_sql_count_AnyData_agg_phase_1 '''
		select count(id), count(kint) from fn_test group by id'''
	qt_sql_count_AnyData_agg_phase_2 '''
		select count(distinct id), count(kint) from fn_test'''
	qt_sql_count_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), count(kint) from fn_test group by kbool'''
	...
	qt_sql_count_AnyData_agg_phase_1_notnull '''
		select count(id), count(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_and_TinyInt_agg_phase_1 '''
		select count(id), group_bit_and(ktint) from fn_test group by id'''
	...
	qt_sql_group_bit_and_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_and(ktint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_and_TinyInt_agg_phase_1_notnull '''
		select count(id), group_bit_and(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_and_SmallInt_agg_phase_1 '''
		select count(id), group_bit_and(ksint) from fn_test group by id'''
	...
	qt_sql_group_bit_and_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_and(ksint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_and_SmallInt_agg_phase_1_notnull '''
		select count(id), group_bit_and(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_and_Integer_agg_phase_1 '''
		select count(id), group_bit_and(kint) from fn_test group by id'''
	...
	qt_sql_group_bit_and_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_and(kint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_and_Integer_agg_phase_1_notnull '''
		select count(id), group_bit_and(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_and_BigInt_agg_phase_1 '''
		select count(id), group_bit_and(kbint) from fn_test group by id'''
	...
	qt_sql_group_bit_and_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_and(kbint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_and_BigInt_agg_phase_1_notnull '''
		select count(id), group_bit_and(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_and_LargeInt_agg_phase_1 '''
		select count(id), group_bit_and(klint) from fn_test group by id'''
	...
	qt_sql_group_bit_and_LargeInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_and(klint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_and_LargeInt_agg_phase_1_notnull '''
		select count(id), group_bit_and(klint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_or_TinyInt_agg_phase_1 '''
		select count(id), group_bit_or(ktint) from fn_test group by id'''
	...
	qt_sql_group_bit_or_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_or(ktint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_or_TinyInt_agg_phase_1_notnull '''
		select count(id), group_bit_or(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_or_SmallInt_agg_phase_1 '''
		select count(id), group_bit_or(ksint) from fn_test group by id'''
	...
	qt_sql_group_bit_or_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_or(ksint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_or_SmallInt_agg_phase_1_notnull '''
		select count(id), group_bit_or(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_or_Integer_agg_phase_1 '''
		select count(id), group_bit_or(kint) from fn_test group by id'''
	...
	qt_sql_group_bit_or_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_or(kint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_or_Integer_agg_phase_1_notnull '''
		select count(id), group_bit_or(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_or_BigInt_agg_phase_1 '''
		select count(id), group_bit_or(kbint) from fn_test group by id'''
	...
	qt_sql_group_bit_or_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_or(kbint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_or_BigInt_agg_phase_1_notnull '''
		select count(id), group_bit_or(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_or_LargeInt_agg_phase_1 '''
		select count(id), group_bit_or(klint) from fn_test group by id'''
	...
	qt_sql_group_bit_or_LargeInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_or(klint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_or_LargeInt_agg_phase_1_notnull '''
		select count(id), group_bit_or(klint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_xor_TinyInt_agg_phase_1 '''
		select count(id), group_bit_xor(ktint) from fn_test group by id'''
	...
	qt_sql_group_bit_xor_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_xor(ktint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_xor_TinyInt_agg_phase_1_notnull '''
		select count(id), group_bit_xor(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_xor_SmallInt_agg_phase_1 '''
		select count(id), group_bit_xor(ksint) from fn_test group by id'''
	...
	qt_sql_group_bit_xor_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_xor(ksint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_xor_SmallInt_agg_phase_1_notnull '''
		select count(id), group_bit_xor(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_xor_Integer_agg_phase_1 '''
		select count(id), group_bit_xor(kint) from fn_test group by id'''
	...
	qt_sql_group_bit_xor_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_xor(kint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_xor_Integer_agg_phase_1_notnull '''
		select count(id), group_bit_xor(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_xor_BigInt_agg_phase_1 '''
		select count(id), group_bit_xor(kbint) from fn_test group by id'''
	...
	qt_sql_group_bit_xor_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_xor(kbint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_xor_BigInt_agg_phase_1_notnull '''
		select count(id), group_bit_xor(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bit_xor_LargeInt_agg_phase_1 '''
		select count(id), group_bit_xor(klint) from fn_test group by id'''
	...
	qt_sql_group_bit_xor_LargeInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bit_xor(klint) from fn_test group by kbool'''
	...
	qt_sql_group_bit_xor_LargeInt_agg_phase_1_notnull '''
		select count(id), group_bit_xor(klint) from fn_test_not_nullable group by id'''
	...
	qt_sql_group_bitmap_xor_Bitmap_gb '''
		select group_bitmap_xor(to_bitmap(kbint)) from fn_test group by kbool order by kbool'''
	qt_sql_group_bitmap_xor_Bitmap '''
		select group_bitmap_xor(to_bitmap(kbint)) from fn_test'''
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_1 '''
		select count(id), group_bitmap_xor(to_bitmap(kbint)) from fn_test group by id'''
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_2 '''
		select count(distinct id), group_bitmap_xor(to_bitmap(kbint)) from fn_test'''
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_bitmap_xor(to_bitmap(kbint)) from fn_test group by kbool'''
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_bitmap_xor(to_bitmap(kbint)) from fn_test'''
	qt_sql_group_bitmap_xor_Bitmap_gb_notnull '''
		select group_bitmap_xor(to_bitmap(kbint)) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_group_bitmap_xor_Bitmap_notnull '''
		select group_bitmap_xor(to_bitmap(kbint)) from fn_test_not_nullable'''
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_1_notnull '''
		select count(id), group_bitmap_xor(to_bitmap(kbint)) from fn_test_not_nullable group by id'''
	qt_sql_group_bitmap_xor_Bitmap_agg_phase_2_notnull '''
		select count(distinct id), group_bitmap_xor(to_bitmap(kbint)) from fn_test_not_nullable'''
	...
	qt_sql_group_concat_Varchar_gb '''
		select group_concat(kvchrs1) from fn_test group by kbool order by kbool'''
	qt_sql_group_concat_Varchar '''
		select group_concat(kvchrs1) from fn_test'''
	qt_sql_group_concat_Varchar_agg_phase_1 '''
		select count(id), group_concat(kvchrs1) from fn_test group by id'''
	qt_sql_group_concat_Varchar_agg_phase_2 '''
		select count(distinct id), group_concat(kvchrs1) from fn_test'''
	qt_sql_group_concat_Varchar_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_concat(kvchrs1) from fn_test group by kbool'''
	qt_sql_group_concat_Varchar_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_concat(kvchrs1) from fn_test'''
	qt_sql_group_concat_Varchar_gb_notnull '''
		select group_concat(kvchrs1) from fn_test_not_nullable group by kbool order by kbool'''
	...
	qt_sql_group_concat_Varchar_agg_phase_1_notnull '''
		select count(id), group_concat(kvchrs1) from fn_test_not_nullable group by id'''
	qt_sql_group_concat_Varchar_agg_phase_2_notnull '''
		select count(distinct id), group_concat(kvchrs1) from fn_test_not_nullable'''
	qt_sql_group_concat_Varchar_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_concat(kvchrs1) from fn_test group by kbool'''
	qt_sql_group_concat_Varchar_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_concat(kvchrs1) from fn_test'''
	...
	qt_sql_group_concat_Varchar_AnyData_agg_phase_1 '''
		select count(id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t} group by id'''
	qt_sql_group_concat_Varchar_AnyData_agg_phase_2 '''
		select count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t}'''
	qt_sql_group_concat_Varchar_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test group by kbool'''
	qt_sql_group_concat_Varchar_AnyData_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test'''
	...
	qt_sql_group_concat_Varchar_AnyData_agg_phase_1_notnull '''
		select count(id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t} group by id'''
	qt_sql_group_concat_Varchar_AnyData_agg_phase_2_notnull '''
		select count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t}'''
	qt_sql_group_concat_Varchar_AnyData_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test group by kbool'''
	qt_sql_group_concat_Varchar_AnyData_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test'''
	...
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_1 '''
		select count(id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t} group by id'''
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_2 '''
		select count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t}'''
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test group by kbool'''
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test'''
	...
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_1_notnull '''
		select count(id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t} group by id'''
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_2_notnull '''
		select count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from ${t}'''
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test group by kbool'''
	qt_sql_group_concat_Varchar_Varchar_AnyData_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), group_concat(distinct cast(abs(kint) as varchar) order by abs(ksint), kdt) from fn_test'''

	qt_sql_histogram_Boolean_gb '''
		select histogram(kbool) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_Boolean '''
		select histogram(kbool) from fn_test'''
	qt_sql_histogram_Boolean_agg_phase_1 '''
		select count(id), histogram(kbool) from fn_test group by id'''
	qt_sql_histogram_Boolean_agg_phase_2 '''
		select count(distinct id), histogram(kbool) from fn_test'''
	qt_sql_histogram_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kbool) from fn_test group by kbool'''
	qt_sql_histogram_Boolean_agg_phase_4 '''
	...
	qt_sql_histogram_Boolean_gb_notnull '''
		select histogram(kbool) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_Boolean_notnull '''
		select histogram(kbool) from fn_test_not_nullable'''
	qt_sql_histogram_Boolean_agg_phase_1_notnull '''
		select count(id), histogram(kbool) from fn_test_not_nullable group by id'''
	qt_sql_histogram_Boolean_agg_phase_2_notnull '''
		select count(distinct id), histogram(kbool) from fn_test_not_nullable'''
	qt_sql_histogram_Boolean_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kbool) from fn_test group by kbool'''
	qt_sql_histogram_Boolean_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kbool) from fn_test'''

	qt_sql_histogram_TinyInt_gb '''
		select histogram(ktint) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_TinyInt '''
		select histogram(ktint) from fn_test'''
	qt_sql_histogram_TinyInt_agg_phase_1 '''
		select count(id), histogram(ktint) from fn_test group by id'''
	qt_sql_histogram_TinyInt_agg_phase_2 '''
		select count(distinct id), histogram(ktint) from fn_test'''
	qt_sql_histogram_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(ktint) from fn_test group by kbool'''
	qt_sql_histogram_TinyInt_agg_phase_4 '''
	...
	qt_sql_histogram_TinyInt_gb_notnull '''
		select histogram(ktint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_TinyInt_notnull '''
		select histogram(ktint) from fn_test_not_nullable'''
	qt_sql_histogram_TinyInt_agg_phase_1_notnull '''
		select count(id), histogram(ktint) from fn_test_not_nullable group by id'''
	qt_sql_histogram_TinyInt_agg_phase_2_notnull '''
		select count(distinct id), histogram(ktint) from fn_test_not_nullable'''
	qt_sql_histogram_TinyInt_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(ktint) from fn_test group by kbool'''
	qt_sql_histogram_TinyInt_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(ktint) from fn_test'''

	qt_sql_histogram_SmallInt_gb '''
		select histogram(ksint) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_SmallInt '''
		select histogram(ksint) from fn_test'''
	qt_sql_histogram_SmallInt_agg_phase_1 '''
		select count(id), histogram(ksint) from fn_test group by id'''
	qt_sql_histogram_SmallInt_agg_phase_2 '''
		select count(distinct id), histogram(ksint) from fn_test'''
	qt_sql_histogram_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(ksint) from fn_test group by kbool'''
	qt_sql_histogram_SmallInt_agg_phase_4 '''
	...
	qt_sql_histogram_SmallInt_gb_notnull '''
		select histogram(ksint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_SmallInt_notnull '''
		select histogram(ksint) from fn_test_not_nullable'''
	qt_sql_histogram_SmallInt_agg_phase_1_notnull '''
		select count(id), histogram(ksint) from fn_test_not_nullable group by id'''
	qt_sql_histogram_SmallInt_agg_phase_2_notnull '''
		select count(distinct id), histogram(ksint) from fn_test_not_nullable'''
	qt_sql_histogram_SmallInt_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(ksint) from fn_test group by kbool'''
	qt_sql_histogram_SmallInt_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(ksint) from fn_test'''

	qt_sql_histogram_Integer_gb '''
		select histogram(kint) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_Integer '''
		select histogram(kint) from fn_test'''
	qt_sql_histogram_Integer_agg_phase_1 '''
		select count(id), histogram(kint) from fn_test group by id'''
	qt_sql_histogram_Integer_agg_phase_2 '''
		select count(distinct id), histogram(kint) from fn_test'''
	qt_sql_histogram_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kint) from fn_test group by kbool'''
	qt_sql_histogram_Integer_agg_phase_4 '''
	...
	qt_sql_histogram_Integer_gb_notnull '''
		select histogram(kint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_Integer_notnull '''
		select histogram(kint) from fn_test_not_nullable'''
	qt_sql_histogram_Integer_agg_phase_1_notnull '''
		select count(id), histogram(kint) from fn_test_not_nullable group by id'''
	qt_sql_histogram_Integer_agg_phase_2_notnull '''
		select count(distinct id), histogram(kint) from fn_test_not_nullable'''
	qt_sql_histogram_Integer_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kint) from fn_test group by kbool'''
	qt_sql_histogram_Integer_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kint) from fn_test'''

	qt_sql_histogram_BigInt_gb '''
		select histogram(kbint) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_BigInt '''
		select histogram(kbint) from fn_test'''
	qt_sql_histogram_BigInt_agg_phase_1 '''
		select count(id), histogram(kbint) from fn_test group by id'''
	qt_sql_histogram_BigInt_agg_phase_2 '''
		select count(distinct id), histogram(kbint) from fn_test'''
	qt_sql_histogram_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kbint) from fn_test group by kbool'''
	qt_sql_histogram_BigInt_agg_phase_4 '''
	...
	qt_sql_histogram_BigInt_gb_notnull '''
		select histogram(kbint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_BigInt_notnull '''
		select histogram(kbint) from fn_test_not_nullable'''
	qt_sql_histogram_BigInt_agg_phase_1_notnull '''
		select count(id), histogram(kbint) from fn_test_not_nullable group by id'''
	qt_sql_histogram_BigInt_agg_phase_2_notnull '''
		select count(distinct id), histogram(kbint) from fn_test_not_nullable'''
	qt_sql_histogram_BigInt_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kbint) from fn_test group by kbool'''
	qt_sql_histogram_BigInt_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kbint) from fn_test'''

	qt_sql_histogram_LargeInt_gb '''
		select histogram(klint) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_LargeInt '''
		select histogram(klint) from fn_test'''
	qt_sql_histogram_LargeInt_agg_phase_1 '''
		select count(id), histogram(klint) from fn_test group by id'''
	qt_sql_histogram_LargeInt_agg_phase_2 '''
		select count(distinct id), histogram(klint) from fn_test'''
	qt_sql_histogram_LargeInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(klint) from fn_test group by kbool'''
	qt_sql_histogram_LargeInt_agg_phase_4 '''
	...
	qt_sql_histogram_LargeInt_gb_notnull '''
		select histogram(klint) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_LargeInt_notnull '''
		select histogram(klint) from fn_test_not_nullable'''
	qt_sql_histogram_LargeInt_agg_phase_1_notnull '''
		select count(id), histogram(klint) from fn_test_not_nullable group by id'''
	qt_sql_histogram_LargeInt_agg_phase_2_notnull '''
		select count(distinct id), histogram(klint) from fn_test_not_nullable'''
	qt_sql_histogram_LargeInt_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(klint) from fn_test group by kbool'''
	qt_sql_histogram_LargeInt_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(klint) from fn_test'''

	qt_sql_histogram_Float_gb '''
		select histogram(kfloat) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_Float '''
		select histogram(kfloat) from fn_test'''
	qt_sql_histogram_Float_agg_phase_1 '''
		select count(id), histogram(kfloat) from fn_test group by id'''
	qt_sql_histogram_Float_agg_phase_2 '''
		select count(distinct id), histogram(kfloat) from fn_test'''
	qt_sql_histogram_Float_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kfloat) from fn_test group by kbool'''
	qt_sql_histogram_Float_agg_phase_4 '''
	...
	qt_sql_histogram_Float_gb_notnull '''
		select histogram(kfloat) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_Float_notnull '''
		select histogram(kfloat) from fn_test_not_nullable'''
	qt_sql_histogram_Float_agg_phase_1_notnull '''
		select count(id), histogram(kfloat) from fn_test_not_nullable group by id'''
	qt_sql_histogram_Float_agg_phase_2_notnull '''
		select count(distinct id), histogram(kfloat) from fn_test_not_nullable'''
	qt_sql_histogram_Float_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kfloat) from fn_test group by kbool'''
	qt_sql_histogram_Float_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kfloat) from fn_test'''

	qt_sql_histogram_Double_gb '''
		select histogram(kdbl) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_Double '''
		select histogram(kdbl) from fn_test'''
	qt_sql_histogram_Double_agg_phase_1 '''
		select count(id), histogram(kdbl) from fn_test group by id'''
	qt_sql_histogram_Double_agg_phase_2 '''
		select count(distinct id), histogram(kdbl) from fn_test'''
	qt_sql_histogram_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdbl) from fn_test group by kbool'''
	qt_sql_histogram_Double_agg_phase_4 '''
	...
	qt_sql_histogram_Double_gb_notnull '''
		select histogram(kdbl) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_Double_notnull '''
		select histogram(kdbl) from fn_test_not_nullable'''
	qt_sql_histogram_Double_agg_phase_1_notnull '''
		select count(id), histogram(kdbl) from fn_test_not_nullable group by id'''
	qt_sql_histogram_Double_agg_phase_2_notnull '''
		select count(distinct id), histogram(kdbl) from fn_test_not_nullable'''
	qt_sql_histogram_Double_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdbl) from fn_test group by kbool'''
	qt_sql_histogram_Double_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kdbl) from fn_test'''

	qt_sql_histogram_DecimalV2_gb '''
		select histogram(kdcmls1) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_DecimalV2 '''
		select histogram(kdcmls1) from fn_test'''
	qt_sql_histogram_DecimalV2_agg_phase_1 '''
		select count(id), histogram(kdcmls1) from fn_test group by id'''
	qt_sql_histogram_DecimalV2_agg_phase_2 '''
		select count(distinct id), histogram(kdcmls1) from fn_test'''
	qt_sql_histogram_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdcmls1) from fn_test group by kbool'''
	qt_sql_histogram_DecimalV2_agg_phase_4 '''
	...
	qt_sql_histogram_DecimalV2_gb_notnull '''
		select histogram(kdcmls1) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_DecimalV2_notnull '''
		select histogram(kdcmls1) from fn_test_not_nullable'''
	qt_sql_histogram_DecimalV2_agg_phase_1_notnull '''
		select count(id), histogram(kdcmls1) from fn_test_not_nullable group by id'''
	qt_sql_histogram_DecimalV2_agg_phase_2_notnull '''
		select count(distinct id), histogram(kdcmls1) from fn_test_not_nullable'''
	qt_sql_histogram_DecimalV2_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdcmls1) from fn_test group by kbool'''
	qt_sql_histogram_DecimalV2_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kdcmls1) from fn_test'''

	qt_sql_histogram_Date_gb '''
		select histogram(kdt) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_Date '''
		select histogram(kdt) from fn_test'''
	qt_sql_histogram_Date_agg_phase_1 '''
		select count(id), histogram(kdt) from fn_test group by id'''
	qt_sql_histogram_Date_agg_phase_2 '''
		select count(distinct id), histogram(kdt) from fn_test'''
	qt_sql_histogram_Date_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdt) from fn_test group by kbool'''
	qt_sql_histogram_Date_agg_phase_4 '''
	...
	qt_sql_histogram_Date_gb_notnull '''
		select histogram(kdt) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_Date_notnull '''
		select histogram(kdt) from fn_test_not_nullable'''
	qt_sql_histogram_Date_agg_phase_1_notnull '''
		select count(id), histogram(kdt) from fn_test_not_nullable group by id'''
	qt_sql_histogram_Date_agg_phase_2_notnull '''
		select count(distinct id), histogram(kdt) from fn_test_not_nullable'''
	qt_sql_histogram_Date_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdt) from fn_test group by kbool'''
	qt_sql_histogram_Date_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kdt) from fn_test'''

	qt_sql_histogram_DateTime_gb '''
		select histogram(kdtm) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_DateTime '''
		select histogram(kdtm) from fn_test'''
	qt_sql_histogram_DateTime_agg_phase_1 '''
		select count(id), histogram(kdtm) from fn_test group by id'''
	qt_sql_histogram_DateTime_agg_phase_2 '''
		select count(distinct id), histogram(kdtm) from fn_test'''
	qt_sql_histogram_DateTime_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdtm) from fn_test group by kbool'''
	qt_sql_histogram_DateTime_agg_phase_4 '''
	...
	qt_sql_histogram_DateTime_gb_notnull '''
		select histogram(kdtm) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_DateTime_notnull '''
		select histogram(kdtm) from fn_test_not_nullable'''
	qt_sql_histogram_DateTime_agg_phase_1_notnull '''
		select count(id), histogram(kdtm) from fn_test_not_nullable group by id'''
	qt_sql_histogram_DateTime_agg_phase_2_notnull '''
		select count(distinct id), histogram(kdtm) from fn_test_not_nullable'''
	qt_sql_histogram_DateTime_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdtm) from fn_test group by kbool'''
	qt_sql_histogram_DateTime_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kdtm) from fn_test'''

	qt_sql_histogram_DateV2_gb '''
		select histogram(kdtv2) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_DateV2 '''
		select histogram(kdtv2) from fn_test'''
	qt_sql_histogram_DateV2_agg_phase_1 '''
		select count(id), histogram(kdtv2) from fn_test group by id'''
	qt_sql_histogram_DateV2_agg_phase_2 '''
		select count(distinct id), histogram(kdtv2) from fn_test'''
	qt_sql_histogram_DateV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdtv2) from fn_test group by kbool'''
	qt_sql_histogram_DateV2_agg_phase_4 '''
	...
	qt_sql_histogram_DateV2_gb_notnull '''
		select histogram(kdtv2) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_DateV2_notnull '''
		select histogram(kdtv2) from fn_test_not_nullable'''
	qt_sql_histogram_DateV2_agg_phase_1_notnull '''
		select count(id), histogram(kdtv2) from fn_test_not_nullable group by id'''
	qt_sql_histogram_DateV2_agg_phase_2_notnull '''
		select count(distinct id), histogram(kdtv2) from fn_test_not_nullable'''
	qt_sql_histogram_DateV2_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdtv2) from fn_test group by kbool'''
	qt_sql_histogram_DateV2_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kdtv2) from fn_test'''

	qt_sql_histogram_DateTimeV2_gb '''
		select histogram(kdtmv2s1) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_DateTimeV2 '''
		select histogram(kdtmv2s1) from fn_test'''
	qt_sql_histogram_DateTimeV2_agg_phase_1 '''
		select count(id), histogram(kdtmv2s1) from fn_test group by id'''
	qt_sql_histogram_DateTimeV2_agg_phase_2 '''
		select count(distinct id), histogram(kdtmv2s1) from fn_test'''
	qt_sql_histogram_DateTimeV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdtmv2s1) from fn_test group by kbool'''
	qt_sql_histogram_DateTimeV2_agg_phase_4 '''
	...
	qt_sql_histogram_DateTimeV2_gb_notnull '''
		select histogram(kdtmv2s1) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_DateTimeV2_notnull '''
		select histogram(kdtmv2s1) from fn_test_not_nullable'''
	qt_sql_histogram_DateTimeV2_agg_phase_1_notnull '''
		select count(id), histogram(kdtmv2s1) from fn_test_not_nullable group by id'''
	qt_sql_histogram_DateTimeV2_agg_phase_2_notnull '''
		select count(distinct id), histogram(kdtmv2s1) from fn_test_not_nullable'''
	qt_sql_histogram_DateTimeV2_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kdtmv2s1) from fn_test group by kbool'''
	qt_sql_histogram_DateTimeV2_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kdtmv2s1) from fn_test'''

	qt_sql_histogram_Char_gb '''
		select histogram(kchrs1) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_Char '''
		select histogram(kchrs1) from fn_test'''
	qt_sql_histogram_Char_agg_phase_1 '''
		select count(id), histogram(kchrs1) from fn_test group by id'''
	qt_sql_histogram_Char_agg_phase_2 '''
		select count(distinct id), histogram(kchrs1) from fn_test'''
	qt_sql_histogram_Char_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kchrs1) from fn_test group by kbool'''
	qt_sql_histogram_Char_agg_phase_4 '''
	...
	qt_sql_histogram_Char_gb_notnull '''
		select histogram(kchrs1) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_Char_notnull '''
		select histogram(kchrs1) from fn_test_not_nullable'''
	qt_sql_histogram_Char_agg_phase_1_notnull '''
		select count(id), histogram(kchrs1) from fn_test_not_nullable group by id'''
	qt_sql_histogram_Char_agg_phase_2_notnull '''
		select count(distinct id), histogram(kchrs1) from fn_test_not_nullable'''
	qt_sql_histogram_Char_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kchrs1) from fn_test group by kbool'''
	qt_sql_histogram_Char_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kchrs1) from fn_test'''

	qt_sql_histogram_String_gb '''
		select histogram(kstr) from fn_test group by kbool order by kbool'''
	qt_sql_histogram_String '''
		select histogram(kstr) from fn_test'''
	qt_sql_histogram_String_agg_phase_1 '''
		select count(id), histogram(kstr) from fn_test group by id'''
	qt_sql_histogram_String_agg_phase_2 '''
		select count(distinct id), histogram(kstr) from fn_test'''
	qt_sql_histogram_String_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kstr) from fn_test group by kbool'''
	qt_sql_histogram_String_agg_phase_4 '''
	...
	qt_sql_histogram_String_gb_notnull '''
		select histogram(kstr) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_histogram_String_notnull '''
		select histogram(kstr) from fn_test_not_nullable'''
	qt_sql_histogram_String_agg_phase_1_notnull '''
		select count(id), histogram(kstr) from fn_test_not_nullable group by id'''
	qt_sql_histogram_String_agg_phase_2_notnull '''
		select count(distinct id), histogram(kstr) from fn_test_not_nullable'''
	qt_sql_histogram_String_agg_phase_3_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), histogram(kstr) from fn_test group by kbool'''
	qt_sql_histogram_String_agg_phase_4_notnull '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), histogram(kstr) from fn_test'''
	...
	qt_sql_max_by_AnyData_AnyData_agg_phase_1 '''
		select count(id), max_by(kint, kint) from fn_test group by id'''
	...
	qt_sql_max_by_AnyData_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), max_by(kint, kint) from fn_test group by kbool'''
	...
	qt_sql_max_by_AnyData_AnyData_agg_phase_1_notnull '''
		select count(id), max_by(kint, kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_min_by_AnyData_AnyData_agg_phase_1 '''
		select count(id), min_by(kint, kint) from fn_test group by id'''
	...
	qt_sql_min_by_AnyData_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), min_by(kint, kint) from fn_test group by kbool'''
	...
	qt_sql_min_by_AnyData_AnyData_agg_phase_1_notnull '''
		select count(id), min_by(kint, kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_ndv_AnyData_agg_phase_1 '''
		select count(id), ndv(kint) from fn_test group by id'''
	qt_sql_ndv_AnyData_agg_phase_2 '''
		select count(distinct id), ndv(kint) from fn_test'''
	qt_sql_ndv_AnyData_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), ndv(kint) from fn_test group by kbool'''
	...
	qt_sql_ndv_AnyData_agg_phase_1_notnull '''
		select count(id), ndv(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_orthogonal_bitmap_union_count_Bitmap_gb '''
		select orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test group by kbool order by kbool'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap '''
		select orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_agg_phase_1 '''
		select count(id), orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test group by id'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_agg_phase_2 '''
		select count(distinct id), orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test group by kbool'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_agg_phase_4 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id), orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_gb_notnull '''
		select orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable group by kbool order by kbool'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_notnull '''
		select orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_agg_phase_1_notnull '''
		select count(id), orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable group by id'''
	qt_sql_orthogonal_bitmap_union_count_Bitmap_agg_phase_2_notnull '''
		select count(distinct id), orthogonal_bitmap_union_count(to_bitmap(kbint)) from fn_test_not_nullable'''
	...
	qt_sql_percentile_BigInt_Double_agg_phase_1 '''
		select count(id), percentile(kbint, 0.6) from ${t} group by id'''
	qt_sql_percentile_BigInt_Double_agg_phase_2 '''
		select count(distinct id), percentile(kbint, 0.6) from ${t}'''
	qt_sql_percentile_BigInt_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), percentile(kbint, 0.6) from fn_test group by kbool'''
	...
	qt_sql_percentile_approx_Double_Double_agg_phase_1 '''
		select count(id), percentile_approx(kdbl, 0.6) from ${t} group by id'''
	qt_sql_percentile_approx_Double_Double_agg_phase_2 '''
		select count(distinct id), percentile_approx(kdbl, 0.6) from ${t}'''
	qt_sql_percentile_approx_Double_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), percentile_approx(kdbl, 0.6) from fn_test group by kbool'''
	...
	qt_sql_percentile_approx_Double_Double_Double_agg_phase_1 '''
		select count(id), percentile_approx(kdbl, 0.6, 4096.0) from ${t} group by id'''
	qt_sql_percentile_approx_Double_Double_Double_agg_phase_2 '''
		select count(distinct id), percentile_approx(kdbl, 0.6, 4096.0) from ${t}'''
	qt_sql_percentile_approx_Double_Double_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), percentile_approx(kdbl, 0.6, 4096.0) from fn_test group by kbool'''
	...
	qt_sql_sequence_count_String_DateV2_Boolean_agg_phase_1 '''
		select count(id), sequence_count('(?1)(?2)', kdtv2, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_sequence_count_String_DateV2_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_count('(?1)(?2)', kdtv2, kint = 1, kint = 2) from ${t}'''
	qt_sql_sequence_count_String_DateV2_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sequence_count('(?1)(?2)', kdtv2, kint = 1, kint = 2) from fn_test group by kbool'''
	...
	qt_sql_sequence_count_String_DateTime_Boolean_agg_phase_1 '''
		select count(id), sequence_count('(?1)(?2)', kdtm, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_sequence_count_String_DateTime_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_count('(?1)(?2)', kdtm, kint = 1, kint = 2) from ${t}'''
	qt_sql_sequence_count_String_DateTime_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sequence_count('(?1)(?2)', kdtm, kint = 1, kint = 2) from fn_test group by kbool'''
	...
	qt_sql_sequence_count_String_DateTimeV2_Boolean_agg_phase_1 '''
		select count(id), sequence_count('(?1)(?2)', kdtmv2s1, kint = 1, kint = 5) from ${t} group by id'''
	qt_sql_sequence_count_String_DateTimeV2_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_count('(?1)(?2)', kdtmv2s1, kint = 1, kint = 5) from ${t}'''
	qt_sql_sequence_count_String_DateTimeV2_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sequence_count('(?1)(?2)', kdtmv2s1, kint = 1, kint = 5) from fn_test group by kbool'''
	...
	qt_sql_sequence_match_String_DateV2_Boolean_agg_phase_1 '''
		select count(id), sequence_match('(?1)(?2)', kdtv2, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_sequence_match_String_DateV2_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_match('(?1)(?2)', kdtv2, kint = 1, kint = 2) from ${t}'''
	qt_sql_sequence_match_String_DateV2_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sequence_match('(?1)(?2)', kdtv2, kint = 1, kint = 2) from fn_test group by kbool'''
	...
	qt_sql_sequence_match_String_DateTime_Boolean_agg_phase_1 '''
		select count(id), sequence_match('(?1)(?2)', kdtm, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_sequence_match_String_DateTime_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_match('(?1)(?2)', kdtm, kint = 1, kint = 2) from ${t}'''
	qt_sql_sequence_match_String_DateTime_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sequence_match('(?1)(?2)', kdtm, kint = 1, kint = 2) from fn_test group by kbool'''
	...
	qt_sql_sequence_match_String_DateTimeV2_Boolean_agg_phase_1 '''
		select count(id), sequence_match('(?1)(?2)', kdtmv2s1, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_sequence_match_String_DateTimeV2_Boolean_agg_phase_2 '''
		select count(distinct id), sequence_match('(?1)(?2)', kdtmv2s1, kint = 1, kint = 2) from ${t}'''
	qt_sql_sequence_match_String_DateTimeV2_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sequence_match('(?1)(?2)', kdtmv2s1, kint = 1, kint = 2) from fn_test group by kbool'''
	...
	qt_sql_stddev_TinyInt_agg_phase_1 '''
		select count(id), stddev(ktint) from fn_test group by id'''
	qt_sql_stddev_TinyInt_agg_phase_2 '''
		select count(distinct id), stddev(ktint) from fn_test'''
	qt_sql_stddev_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(ktint) from fn_test group by kbool'''
	...
	qt_sql_stddev_TinyInt_agg_phase_1_notnull '''
		select count(id), stddev(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_SmallInt_agg_phase_1 '''
		select count(id), stddev(ksint) from fn_test group by id'''
	qt_sql_stddev_SmallInt_agg_phase_2 '''
		select count(distinct id), stddev(ksint) from fn_test'''
	qt_sql_stddev_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(ksint) from fn_test group by kbool'''
	...
	qt_sql_stddev_SmallInt_agg_phase_1_notnull '''
		select count(id), stddev(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_Integer_agg_phase_1 '''
		select count(id), stddev(kint) from fn_test group by id'''
	qt_sql_stddev_Integer_agg_phase_2 '''
		select count(distinct id), stddev(kint) from fn_test'''
	qt_sql_stddev_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(kint) from fn_test group by kbool'''
	...
	qt_sql_stddev_Integer_agg_phase_1_notnull '''
		select count(id), stddev(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_BigInt_agg_phase_1 '''
		select count(id), stddev(kbint) from fn_test group by id'''
	qt_sql_stddev_BigInt_agg_phase_2 '''
		select count(distinct id), stddev(kbint) from fn_test'''
	qt_sql_stddev_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(kbint) from fn_test group by kbool'''
	...
	qt_sql_stddev_BigInt_agg_phase_1_notnull '''
		select count(id), stddev(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_Float_agg_phase_1 '''
		select count(id), stddev(kfloat) from fn_test group by id'''
	qt_sql_stddev_Float_agg_phase_2 '''
		select count(distinct id), stddev(kfloat) from fn_test'''
	qt_sql_stddev_Float_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(kfloat) from fn_test group by kbool'''
	...
	qt_sql_stddev_Float_agg_phase_1_notnull '''
		select count(id), stddev(kfloat) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_Double_agg_phase_1 '''
		select count(id), stddev(kdbl) from fn_test group by id'''
	qt_sql_stddev_Double_agg_phase_2 '''
		select count(distinct id), stddev(kdbl) from fn_test'''
	qt_sql_stddev_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(kdbl) from fn_test group by kbool'''
	...
	qt_sql_stddev_Double_agg_phase_1_notnull '''
		select count(id), stddev(kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_DecimalV2_agg_phase_1 '''
		select count(id), stddev(kdcmls1) from fn_test group by id'''
	...
	qt_sql_stddev_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev(kdcmls1) from fn_test group by kbool'''
	...
	qt_sql_stddev_DecimalV2_agg_phase_1_notnull '''
		select count(id), stddev(kdcmls1) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_TinyInt_agg_phase_1 '''
		select count(id), stddev_samp(ktint) from fn_test group by id'''
	...
	qt_sql_stddev_samp_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(ktint) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_TinyInt_agg_phase_1_notnull '''
		select count(id), stddev_samp(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_SmallInt_agg_phase_1 '''
		select count(id), stddev_samp(ksint) from fn_test group by id'''
	...
	qt_sql_stddev_samp_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(ksint) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_SmallInt_agg_phase_1_notnull '''
		select count(id), stddev_samp(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_Integer_agg_phase_1 '''
		select count(id), stddev_samp(kint) from fn_test group by id'''
	...
	qt_sql_stddev_samp_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(kint) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_Integer_agg_phase_1_notnull '''
		select count(id), stddev_samp(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_BigInt_agg_phase_1 '''
		select count(id), stddev_samp(kbint) from fn_test group by id'''
	...
	qt_sql_stddev_samp_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(kbint) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_BigInt_agg_phase_1_notnull '''
		select count(id), stddev_samp(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_Float_agg_phase_1 '''
		select count(id), stddev_samp(kfloat) from fn_test group by id'''
	...
	qt_sql_stddev_samp_Float_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(kfloat) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_Float_agg_phase_1_notnull '''
		select count(id), stddev_samp(kfloat) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_Double_agg_phase_1 '''
		select count(id), stddev_samp(kdbl) from fn_test group by id'''
	...
	qt_sql_stddev_samp_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(kdbl) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_Double_agg_phase_1_notnull '''
		select count(id), stddev_samp(kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_stddev_samp_DecimalV2_agg_phase_1 '''
		select count(id), stddev_samp(kdcmls1) from fn_test group by id'''
	...
	qt_sql_stddev_samp_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), stddev_samp(kdcmls1) from fn_test group by kbool'''
	...
	qt_sql_stddev_samp_DecimalV2_agg_phase_1_notnull '''
		select count(id), stddev_samp(kdcmls1) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_TinyInt_agg_phase_1 '''
		select count(id), sum(ktint) from fn_test group by id'''
	qt_sql_sum_TinyInt_agg_phase_2 '''
		select count(distinct id), sum(ktint) from fn_test'''
	qt_sql_sum_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(ktint) from fn_test group by kbool'''
	...
	qt_sql_sum_TinyInt_agg_phase_1_notnull '''
		select count(id), sum(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_SmallInt_agg_phase_1 '''
		select count(id), sum(ksint) from fn_test group by id'''
	qt_sql_sum_SmallInt_agg_phase_2 '''
		select count(distinct id), sum(ksint) from fn_test'''
	qt_sql_sum_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(ksint) from fn_test group by kbool'''
	...
	qt_sql_sum_SmallInt_agg_phase_1_notnull '''
		select count(id), sum(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_Integer_agg_phase_1 '''
		select count(id), sum(kint) from fn_test group by id'''
	qt_sql_sum_Integer_agg_phase_2 '''
		select count(distinct id), sum(kint) from fn_test'''
	qt_sql_sum_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(kint) from fn_test group by kbool'''
	...
	qt_sql_sum_Integer_agg_phase_1_notnull '''
		select count(id), sum(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_BigInt_agg_phase_1 '''
		select count(id), sum(kbint) from fn_test group by id'''
	qt_sql_sum_BigInt_agg_phase_2 '''
		select count(distinct id), sum(kbint) from fn_test'''
	qt_sql_sum_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(kbint) from fn_test group by kbool'''
	...
	qt_sql_sum_BigInt_agg_phase_1_notnull '''
		select count(id), sum(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_Double_agg_phase_1 '''
		select count(id), sum(kdbl) from fn_test group by id'''
	qt_sql_sum_Double_agg_phase_2 '''
		select count(distinct id), sum(kdbl) from fn_test'''
	qt_sql_sum_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(kdbl) from fn_test group by kbool'''
	...
	qt_sql_sum_Double_agg_phase_1_notnull '''
		select count(id), sum(kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_DecimalV2_agg_phase_1 '''
		select count(id), sum(kdcmls1) from fn_test group by id'''
	qt_sql_sum_DecimalV2_agg_phase_2 '''
		select count(distinct id), sum(kdcmls1) from fn_test'''
	qt_sql_sum_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(kdcmls1) from fn_test group by kbool'''
	...
	qt_sql_sum_DecimalV2_agg_phase_1_notnull '''
		select count(id), sum(kdcmls1) from fn_test_not_nullable group by id'''
	...
	qt_sql_sum_LargeInt_agg_phase_1 '''
		select count(id), sum(klint) from fn_test group by id'''
	qt_sql_sum_LargeInt_agg_phase_2 '''
		select count(distinct id), sum(klint) from fn_test'''
	qt_sql_sum_LargeInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), sum(klint) from fn_test group by kbool'''
	...
	qt_sql_sum_LargeInt_agg_phase_1_notnull '''
		select count(id), sum(klint) from fn_test_not_nullable group by id'''
	...
	qt_sql_topn_Varchar_Integer_agg_phase_1 '''
		select count(id), topn(kvchrs1, 3) from ${t} group by id'''
	qt_sql_topn_Varchar_Integer_agg_phase_2 '''
		select count(distinct id), topn(kvchrs1, 3) from ${t}'''
	qt_sql_topn_Varchar_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), topn(kvchrs1, 3) from fn_test group by kbool'''
	...
	qt_sql_topn_String_Integer_agg_phase_1 '''
		select count(id), topn(kstr, 3) from ${t} group by id'''
	qt_sql_topn_String_Integer_agg_phase_2 '''
		select count(distinct id), topn(kstr, 3) from ${t}'''
	qt_sql_topn_String_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), topn(kstr, 3) from fn_test group by kbool'''
	...
	qt_sql_topn_Varchar_Integer_Integer_agg_phase_1 '''
		select count(id), topn(kvchrs1, 3, 100) from ${t} group by id'''
	qt_sql_topn_Varchar_Integer_Integer_agg_phase_2 '''
		select count(distinct id), topn(kvchrs1, 3, 100) from ${t}'''
	qt_sql_topn_Varchar_Integer_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), topn(kvchrs1, 3, 100) from fn_test group by kbool'''
	...
	qt_sql_topn_String_Integer_Integer_agg_phase_1 '''
		select count(id), topn(kstr, 3, 100) from ${t} group by id'''
	qt_sql_topn_String_Integer_Integer_agg_phase_2 '''
		select count(distinct id), topn(kstr, 3, 100) from ${t}'''
	qt_sql_topn_String_Integer_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), topn(kstr, 3, 100) from fn_test group by kbool'''
	...
	qt_sql_variance_TinyInt_agg_phase_1 '''
		select count(id), variance(ktint) from fn_test group by id'''
	...
	qt_sql_variance_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(ktint) from fn_test group by kbool'''
	...
	qt_sql_variance_TinyInt_agg_phase_1_notnull '''
		select count(id), variance(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_SmallInt_agg_phase_1 '''
		select count(id), variance(ksint) from fn_test group by id'''
	...
	qt_sql_variance_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(ksint) from fn_test group by kbool'''
	...
	qt_sql_variance_SmallInt_agg_phase_1_notnull '''
		select count(id), variance(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_Integer_agg_phase_1 '''
		select count(id), variance(kint) from fn_test group by id'''
	...
	qt_sql_variance_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(kint) from fn_test group by kbool'''
	...
	qt_sql_variance_Integer_agg_phase_1_notnull '''
		select count(id), variance(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_BigInt_agg_phase_1 '''
		select count(id), variance(kbint) from fn_test group by id'''
	qt_sql_variance_BigInt_agg_phase_2 '''
		select count(distinct id), variance(kbint) from fn_test'''
	qt_sql_variance_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(kbint) from fn_test group by kbool'''
	...
	qt_sql_variance_BigInt_agg_phase_1_notnull '''
		select count(id), variance(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_Float_agg_phase_1 '''
		select count(id), variance(kfloat) from fn_test group by id'''
	qt_sql_variance_Float_agg_phase_2 '''
		select count(distinct id), variance(kfloat) from fn_test'''
	qt_sql_variance_Float_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(kfloat) from fn_test group by kbool'''
	...
	qt_sql_variance_Float_agg_phase_1_notnull '''
		select count(id), variance(kfloat) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_Double_agg_phase_1 '''
		select count(id), variance(kdbl) from fn_test group by id'''
	qt_sql_variance_Double_agg_phase_2 '''
		select count(distinct id), variance(kdbl) from fn_test'''
	qt_sql_variance_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(kdbl) from fn_test group by kbool'''
	...
	qt_sql_variance_Double_agg_phase_1_notnull '''
		select count(id), variance(kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_DecimalV2_agg_phase_1 '''
		select count(id), variance(kdcmls1) from fn_test group by id'''
	...
	qt_sql_variance_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance(kdcmls1) from fn_test group by kbool'''
	...
	qt_sql_variance_DecimalV2_agg_phase_1_notnull '''
		select count(id), variance(kdcmls1) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_TinyInt_agg_phase_1 '''
		select count(id), variance_samp(ktint) from fn_test group by id'''
	...
	qt_sql_variance_samp_TinyInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(ktint) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_TinyInt_agg_phase_1_notnull '''
		select count(id), variance_samp(ktint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_SmallInt_agg_phase_1 '''
		select count(id), variance_samp(ksint) from fn_test group by id'''
	...
	qt_sql_variance_samp_SmallInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(ksint) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_SmallInt_agg_phase_1_notnull '''
		select count(id), variance_samp(ksint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_Integer_agg_phase_1 '''
		select count(id), variance_samp(kint) from fn_test group by id'''
	...
	qt_sql_variance_samp_Integer_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(kint) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_Integer_agg_phase_1_notnull '''
		select count(id), variance_samp(kint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_BigInt_agg_phase_1 '''
		select count(id), variance_samp(kbint) from fn_test group by id'''
	...
	qt_sql_variance_samp_BigInt_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(kbint) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_BigInt_agg_phase_1_notnull '''
		select count(id), variance_samp(kbint) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_Float_agg_phase_1 '''
		select count(id), variance_samp(kfloat) from fn_test group by id'''
	...
	qt_sql_variance_samp_Float_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(kfloat) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_Float_agg_phase_1_notnull '''
		select count(id), variance_samp(kfloat) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_Double_agg_phase_1 '''
		select count(id), variance_samp(kdbl) from fn_test group by id'''
	...
	qt_sql_variance_samp_Double_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(kdbl) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_Double_agg_phase_1_notnull '''
		select count(id), variance_samp(kdbl) from fn_test_not_nullable group by id'''
	...
	qt_sql_variance_samp_DecimalV2_agg_phase_1 '''
		select count(id), variance_samp(kdcmls1) from fn_test group by id'''
	...
	qt_sql_variance_samp_DecimalV2_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), variance_samp(kdcmls1) from fn_test group by kbool'''
	...
	qt_sql_variance_samp_DecimalV2_agg_phase_1_notnull '''
		select count(id), variance_samp(kdcmls1) from fn_test_not_nullable group by id'''
	...
	qt_sql_window_funnel_BigInt_String_DateTime_Boolean_agg_phase_1 '''
		select count(id), window_funnel(3600 * 3, 'default', kdtm, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_window_funnel_BigInt_String_DateTime_Boolean_agg_phase_2 '''
		select count(distinct id), window_funnel(3600 * 3, 'default', kdtm, kint = 1, kint = 2) from ${t}'''
	qt_sql_window_funnel_BigInt_String_DateTime_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), window_funnel(3600 * 3, 'default', kdtm, kint = 1, kint = 2) from fn_test group by kbool'''
	...
	qt_sql_window_funnel_BigInt_String_DateTimeV2_Boolean_agg_phase_1 '''
		select count(id), window_funnel(3600 * 3, 'default', kdtmv2s1, kint = 1, kint = 2) from ${t} group by id'''
	qt_sql_window_funnel_BigInt_String_DateTimeV2_Boolean_agg_phase_2 '''
		select count(distinct id), window_funnel(3600 * 3, 'default', kdtmv2s1, kint = 1, kint = 2) from ${t}'''
	qt_sql_window_funnel_BigInt_String_DateTimeV2_Boolean_agg_phase_3 '''
		select /*+SET_VAR(disable_nereids_rules='THREE_PHASE_AGGREGATE_WITH_DISTINCT, TWO_PHASE_AGGREGATE_WITH_DISTINCT')*/ count(distinct id, kint), window_funnel(3600 * 3, 'default', kdtmv2s1, kint = 1, kint = 2) from fn_test group by kbool'''
