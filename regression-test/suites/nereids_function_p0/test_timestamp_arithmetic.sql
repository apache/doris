...
select kdtmv2s3 - interval 1 day from fn_test_not_nullable order by kdt;
select kdtmv2s3 - interval 1 second from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 year from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 month from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 week from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 day from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 hour from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 minute from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 second from fn_test order by kdt;
select interval 1 year + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select interval 1 month + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select interval 1 week + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select interval 1 day + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select interval 1 hour + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select interval 1 minute + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select interval 1 second + cast(kdtmv2s3 as timestamp_ns) from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) - interval 1 day from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) - interval 1 second from fn_test order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 year from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 month from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 week from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 day from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 hour from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 minute from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) + interval 1 second from fn_test_not_nullable order by kdt;
select interval 1 year + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select interval 1 month + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select interval 1 week + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select interval 1 day + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select interval 1 hour + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select interval 1 minute + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select interval 1 second + cast(kdtmv2s3 as timestamp_ns) from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) - interval 1 day from fn_test_not_nullable order by kdt;
select cast(kdtmv2s3 as timestamp_ns) - interval 1 second from fn_test_not_nullable order by kdt;
