...
select kdtmv2s3 - interval 1 day from fn_test_not_nullable order by kdt;
select kdtmv2s3 - interval 1 second from fn_test_not_nullable order by kdt;
select ktsns + interval 1 year from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 month from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 week from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 day from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 hour from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 minute from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 second from fn_test where id not in (0, 5) order by kdt;
select interval 1 year + ktsns from fn_test where id not in (0, 5) order by kdt;
select interval 1 month + ktsns from fn_test where id not in (0, 5) order by kdt;
select interval 1 week + ktsns from fn_test where id not in (0, 5) order by kdt;
select interval 1 day + ktsns from fn_test where id not in (0, 5) order by kdt;
select interval 1 hour + ktsns from fn_test where id not in (0, 5) order by kdt;
select interval 1 minute + ktsns from fn_test where id not in (0, 5) order by kdt;
select interval 1 second + ktsns from fn_test where id not in (0, 5) order by kdt;
select ktsns - interval 1 day from fn_test where id not in (0, 5) order by kdt;
select ktsns - interval 1 second from fn_test where id not in (0, 5) order by kdt;
select ktsns + interval 1 year from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns + interval 1 month from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns + interval 1 week from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns + interval 1 day from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns + interval 1 hour from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns + interval 1 minute from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns + interval 1 second from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 year + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 month + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 week + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 day + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 hour + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 minute + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select interval 1 second + ktsns from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns - interval 1 day from fn_test_not_nullable where id not in (0, 5) order by kdt;
select ktsns - interval 1 second from fn_test_not_nullable where id not in (0, 5) order by kdt;
