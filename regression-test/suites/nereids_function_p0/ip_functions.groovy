...
suite("ip_functions") {
    ...
    qt_ip31 "SELECT hex(ipv6stringtonum('192.168.0.1'));"
    qt_ip32 "SELECT hex(ipv6stringtonum('2a02:6b8::11'));"
    qt_ip33 "SELECT hex(ipv6stringtonum('::'));"
    qt_ip34 "SELECT hex(ipv6stringtonum('a0:50:9100::'));"
    qt_ip35 "SELECT hex(ipv6stringtonumordefault('192.168.0.1'));"
    qt_ip36 "SELECT hex(ipv6stringtonumordefault('2a02:6b8::11'));"
    qt_ip37 "SELECT hex(ipv6stringtonumordefault('::'));"
    qt_ip38 "SELECT hex(ipv6stringtonumordefault('KK'));"
    qt_ip39 "SELECT hex(ipv6stringtonumordefault('ffffffffffffffffffffffffffffffffffffffffffffffffffffff'));"
    qt_ip40 "SELECT hex(ipv6stringtonumornull('192.168.0.1'));"
    qt_ip41 "SELECT hex(ipv6stringtonumornull('2a02:6b8::11'));"
    qt_ip42 "SELECT hex(ipv6stringtonumornull('::'));"
    qt_ip43 "SELECT hex(ipv6stringtonumornull('KK'));"
    qt_ip44 "SELECT hex(ipv6stringtonumornull('ffffffffffffffffffffffffffffffffffffffffffffffffffffff'));"
    qt_ip45 "SELECT hex(ipv6stringtonumornull(''));"
    qt_ip46 "SELECT hex(ipv6stringtonumornull(NULL));"
    qt_ip47 "SELECT hex(ipv6stringtonumornull('\0'));"
    qt_ip48 "SELECT hex(ipv6stringtonumornull('00'));"
    qt_ip49 "SELECT hex(ipv6stringtonumornull('aaaa:aaaa:ffff:ffff:ffff:ffff:aaaa:aaaa'));"
