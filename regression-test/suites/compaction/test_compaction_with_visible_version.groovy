...
suite('test_compaction_with_visible_version') {
    ...
    docker(options) {
        ...
        def checkCompact = { isCumuCompactSucc, runBaseCompact, isInvisibleTimeout, version, visibleVersion ->
            ...
            tablets.each {
                ...
                lastInvisibleVersionCountMap[it.BackendId] =
                        (it.TotalVersionCount as long) - (it.VisibleVersionCount as long)
            ...
            tablets.each {
                ...
                def totalVersionCount = it.TotalVersionCount as long
        ...
        def getVersionCountMap = { ->
            ...
            def tablets = sql_return_maparray "SHOW TABLETS FROM ${tableName}"
            tablets.each {
                versionCountMap.put(it.BackendId as long, [it.VisibleVersionCount as long, it.TotalVersionCount as long])
            }
