...
suite("test_single_compaction_inject_error", "p2") {
    ...
    try {
        ...
        try {
            ...
            for (String id in follower_backend_id) {
                assertTrue(triggerSingleCompaction(backendId_to_backendIP[id], backendId_to_backendHttpPort[id], tablet_id).contains("tablet don't have peer replica"));
            } 
        } finally {
        ...
        try {
            ...
            for (String id in follower_backend_id) {
                assertTrue(triggerSingleCompaction(backendId_to_backendIP[id], backendId_to_backendHttpPort[id], tablet_id).contains("tablet failed get peer versions"));
            } 
        } finally {
        ...
        try {
            ...
            for (String id in follower_backend_id) {
                assertTrue(triggerSingleCompaction(backendId_to_backendIP[id], backendId_to_backendHttpPort[id], tablet_id).contains("failed snapshot"));
            } 
        } finally {
        ...
        //     for (String id in follower_backend_id) {
        //         assertTrue(triggerSingleCompaction(backendId_to_backendIP[id], backendId_to_backendHttpPort[id], tablet_id).contains("failed to download file"));
        //     } 
        // } finally {
