...
//    sql """DROP TABLE IF EXISTS ${table_name}"""
    ...
    sql """
        ...
        properties("replication_num" = "1", "disable_auto_compaction" = "true", "bloom_filter_columns" = "v", "deprecated_variant_enable_flatten_nested" = "true", "inverted_index_storage_format"= "v2", "enable_unique_key_merge_on_write" = "false");
    """
    // 2015
