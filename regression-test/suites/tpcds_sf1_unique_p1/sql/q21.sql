...
WHERE ((CASE WHEN (inv_before > 0) THEN (CAST(inv_after AS DECIMAL(27,9)) / inv_before) ELSE null END) BETWEEN (CAST('2.00' AS DECIMAL(27,9)) / CAST('3.00' AS DECIMAL(27,9))) AND (CAST('3.00' AS DECIMAL(27,9)) / CAST('2.00' AS DECIMAL(27,9))))
