...
suite("test_dup_table_inverted_index", "p1") {
    ...
    try {
        ...
        def dup_result7 = execute_sql.call("enable_segment_limit_pushdown", "true", all_dup_sql)
        logger.info("dup_result7 is {}", dup_result7);
        def dup_result8 = execute_sql.call("enable_segment_limit_pushdown", "false", all_dup_sql)
