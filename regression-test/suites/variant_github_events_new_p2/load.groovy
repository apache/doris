...
suite("regression_test_variant_github_events_p2", "nonConcurrent,p2"){
    setFeConfigTemporary([enable_variant_v2: true]) {
        ...
        // Keep the predefined array path materialized so this suite deterministically exercises the
        // Variant V2 shredded read and inverted-index profile path.
        boolean enable_typed_paths_to_sparse = false
