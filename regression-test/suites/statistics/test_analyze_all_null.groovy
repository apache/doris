...
suite("test_analyze_all_null") {
    ...
    sql """alter table invalidTest modify column col1 set stats ('row_count'='100', 'ndv'='1001', 'num_nulls'='0.0', 'data_size'='3.2E8', 'min_value'='1', 'max_value'='20000000');"""
    ...
    sql """alter table invalidTest modify column col3 set stats ('row_count'='100', 'ndv'='0', 'num_nulls'='3', 'data_size'='3.2E8', 'min_value'='null', 'max_value'='null');"""
    sql """alter table invalidTest modify column col4 set stats ('row_count'='100', 'ndv'='100', 'num_nulls'='0', 'data_size'='3.2E8', 'min_value'='min', 'max_value'='max');"""
    result = sql """show column stats invalidTest"""
    assertEquals(1, result.size())
    assertEquals("1.0E7", result[0][2])
    assertEquals("col4", result[0][0])
