...
suite("test_analyze_triggered_by_update_row_count") {
    ...
    //log.info("row_count: ${result1[0][2]}".toString())
    assertTrue(Integer.valueOf(result1[0][0]) == 8, "Insert should update 8 rows")
    //assertTrue(Integer.valueOf(result1[0][2]) == 8, "Insert should result in total 8 rows")
    ...
    //log.info("row_count: ${result2[0][2]}".toString())
    assertTrue(Integer.valueOf(result2[0][0]) == 16, "Insert should update 16 rows")
    //assertTrue(Integer.valueOf(result2[0][2]) == 16, "Insert twice total 16 rows")

    // below are known bugs, disabled temporarily
    //sql """
    //     analyze table ${tbl} with sync
    //    """
    ...
    //log.info("updated_rows: ${result3[0][0]}".toString())
    //log.info("row_count: ${result3[0][2]}".toString())
    //assertTrue(Integer.valueOf(result3[0][0]) == 0, "Analysis should reset updated_rows to 0 rows")
    //assertTrue(Integer.valueOf(result3[0][2]) == 16, "Insert twice total 16 rows")
}
