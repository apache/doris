...
(
    ...
    if ! deploy_doris_sql_convertor; then exit 1; else
        set_session_variable sql_converter_service_url "http://127.0.0.1:${doris_sql_convertor_port:-5001}/api/v1/convert"
    fi
