...
if ! [[ -f "${teamcity_build_checkoutDir}"/regression-test/pipeline/common/oss-utils.sh &&
    ...
    -f "${teamcity_build_checkoutDir}"/regression-test/pipeline/performance/run-parquet-microbenchmark.py &&
    ...
    -f "${teamcity_build_checkoutDir}"/regression-test/pipeline/performance/parquet-microbenchmark-policy.json &&
