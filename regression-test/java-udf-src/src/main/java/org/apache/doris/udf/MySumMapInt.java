...
public class MySumMapInt {
    private static final Logger LOG = Logger.getLogger(MySumMapInt.class);
    ...
    public void add(State state, HashMap<Integer,Integer> val) {
        if (val == null) {
            return;
        }
        for(Map.Entry<Integer,Integer> it : val.entrySet()){
