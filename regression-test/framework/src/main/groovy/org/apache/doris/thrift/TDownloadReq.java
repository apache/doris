            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.remote_tablet_snapshots = new java.util.ArrayList<TRemoteTabletSnapshot>(_list132.size);
                @org.apache.thrift.annotation.Nullable TRemoteTabletSnapshot _elem133;
                for (int _i134 = 0; _i134 < _list132.size; ++_i134)
                {
                  _elem133 = new TRemoteTabletSnapshot();
                  _elem133.read(iprot);
                  struct.remote_tablet_snapshots.add(_elem133);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter135 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBrokerProp()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter136 : struct.broker_prop.entrySet())
            {
      ...
      if (struct.remote_tablet_snapshots != null) {
        if (struct.isSetRemoteTabletSnapshots()) {
          oprot.writeFieldBegin(REMOTE_TABLET_SNAPSHOTS_FIELD_DESC);
          {
            ...
            for (TRemoteTabletSnapshot _iter137 : struct.remote_tablet_snapshots)
            {
  ...
  private static class TDownloadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDownloadReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.job_id);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter138 : struct.src_dest_map.entrySet())
        {
      ...
      if (struct.isSetBrokerProp()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter139 : struct.broker_prop.entrySet())
          {
      ...
      if (struct.isSetRemoteTabletSnapshots()) {
        {
          ...
          for (TRemoteTabletSnapshot _iter140 : struct.remote_tablet_snapshots)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      struct.setJobIdIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map141 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
        struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map141.size);
        ...
        for (int _i144 = 0; _i144 < _map141.size; ++_i144)
        {
          ...
          struct.src_dest_map.put(_key142, _val143);
        }
      }
      struct.setSrcDestMapIsSet(true);
      struct.broker_addr = new org.apache.doris.thrift.TNetworkAddress();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map145 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map145.size);
          ...
          for (int _i148 = 0; _i148 < _map145.size; ++_i148)
          {
            ...
            struct.broker_prop.put(_key146, _val147);
          }
        }
        struct.setBrokerPropIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.remote_tablet_snapshots = new java.util.ArrayList<TRemoteTabletSnapshot>(_list149.size);
          @org.apache.thrift.annotation.Nullable TRemoteTabletSnapshot _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = new TRemoteTabletSnapshot();
            _elem150.read(iprot);
            struct.remote_tablet_snapshots.add(_elem150);
          }
        }
        struct.setRemoteTabletSnapshotsIsSet(true);
      }
