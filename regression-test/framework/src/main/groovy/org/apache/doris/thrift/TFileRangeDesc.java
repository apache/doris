            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_from_path = new java.util.ArrayList<java.lang.String>(_list248.size);
                ...
                for (int _i250 = 0; _i250 < _list248.size; ++_i250)
                {
                  ...
                  struct.columns_from_path.add(_elem249);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_from_path_keys = new java.util.ArrayList<java.lang.String>(_list251.size);
                ...
                for (int _i253 = 0; _i253 < _list251.size; ++_i253)
                {
                  ...
                  struct.columns_from_path_keys.add(_elem252);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns_from_path != null) {
        if (struct.isSetColumnsFromPath()) {
          oprot.writeFieldBegin(COLUMNS_FROM_PATH_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter254 : struct.columns_from_path)
            {
      ...
      if (struct.columns_from_path_keys != null) {
        if (struct.isSetColumnsFromPathKeys()) {
          oprot.writeFieldBegin(COLUMNS_FROM_PATH_KEYS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter255 : struct.columns_from_path_keys)
            {
      ...
      if (struct.isSetColumnsFromPath()) {
        {
          ...
          for (java.lang.String _iter256 : struct.columns_from_path)
          {
      ...
      if (struct.isSetColumnsFromPathKeys()) {
        {
          ...
          for (java.lang.String _iter257 : struct.columns_from_path_keys)
          {
