            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.str_dict = new java.util.ArrayList<java.lang.String>(_list110.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TColumnDict struct) throws org.apache.thrift.TException {
      ...
      if (struct.str_dict != null) {
        oprot.writeFieldBegin(STR_DICT_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter113 : struct.str_dict)
          {
      ...
      if (struct.isSetStrDict()) {
        {
          ...
          for (java.lang.String _iter114 : struct.str_dict)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.str_dict = new java.util.ArrayList<java.lang.String>(_list115.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = iprot.readString();
            struct.str_dict.add(_elem116);
          }
        }
        struct.setStrDictIsSet(true);
      }
