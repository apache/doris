            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list340.size);
                @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem341;
                for (int _i342 = 0; _i342 < _list340.size; ++_i342)
                {
                  _elem341 = new TTabletCooldownInfo();
                  _elem341.read(iprot);
                  struct.confirm_list.add(_elem341);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.confirm_list != null) {
        if (struct.isSetConfirmList()) {
          oprot.writeFieldBegin(CONFIRM_LIST_FIELD_DESC);
          {
            ...
            for (TTabletCooldownInfo _iter343 : struct.confirm_list)
            {
      ...
      if (struct.isSetConfirmList()) {
        {
          ...
          for (TTabletCooldownInfo _iter344 : struct.confirm_list)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list345.size);
          @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem346;
          for (int _i347 = 0; _i347 < _list345.size; ++_i347)
          {
            _elem346 = new TTabletCooldownInfo();
            _elem346.read(iprot);
            struct.confirm_list.add(_elem346);
          }
        }
        struct.setConfirmListIsSet(true);
      }
