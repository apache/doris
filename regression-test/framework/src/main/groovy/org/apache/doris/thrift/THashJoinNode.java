            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list498.size);
                ...
                for (int _i500 = 0; _i500 < _list498.size; ++_i500)
                {
                  ...
                  _elem499.read(iprot);
                  struct.eq_join_conjuncts.add(_elem499);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hash_output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list504.size);
                int _elem505;
                for (int _i506 = 0; _i506 < _list504.size; ++_i506)
                {
                  _elem505 = iprot.readI32();
                  struct.hash_output_slot_ids.add(_elem505);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list507.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem508;
                for (int _i509 = 0; _i509 < _list507.size; ++_i509)
                {
                  _elem508 = new org.apache.doris.thrift.TExpr();
                  _elem508.read(iprot);
                  struct.srcExprList.add(_elem508);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list510.size);
                int _elem511;
                for (int _i512 = 0; _i512 < _list510.size; ++_i512)
                {
                  _elem511 = iprot.readI32();
                  struct.vintermediate_tuple_id_list.add(_elem511);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.eq_join_conjuncts != null) {
        oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter513 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOtherJoinConjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter514 : struct.other_join_conjuncts)
            {
      ...
      if (struct.hash_output_slot_ids != null) {
        if (struct.isSetHashOutputSlotIds()) {
          oprot.writeFieldBegin(HASH_OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter515 : struct.hash_output_slot_ids)
            {
      ...
      if (struct.srcExprList != null) {
        if (struct.isSetSrcExprList()) {
          oprot.writeFieldBegin(SRC_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter516 : struct.srcExprList)
            {
      ...
      if (struct.vintermediate_tuple_id_list != null) {
        if (struct.isSetVintermediateTupleIdList()) {
          oprot.writeFieldBegin(VINTERMEDIATE_TUPLE_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter517 : struct.vintermediate_tuple_id_list)
            {
  ...
  private static class THashJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<THashJoinNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.join_op.getValue());
      {
        ...
        for (TEqJoinCondition _iter518 : struct.eq_join_conjuncts)
        {
      ...
      if (struct.isSetOtherJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter519 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetHashOutputSlotIds()) {
        {
          ...
          for (int _iter520 : struct.hash_output_slot_ids)
          {
            oprot.writeI32(_iter520);
          }
        }
      }
      if (struct.isSetSrcExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter521 : struct.srcExprList)
          {
      ...
      if (struct.isSetVintermediateTupleIdList()) {
        {
          ...
          for (int _iter522 : struct.vintermediate_tuple_id_list)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      struct.setJoinOpIsSet(true);
      {
        ...
        struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list523.size);
        @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem524;
        for (int _i525 = 0; _i525 < _list523.size; ++_i525)
        {
          _elem524 = new TEqJoinCondition();
          _elem524.read(iprot);
          struct.eq_join_conjuncts.add(_elem524);
        }
      }
      struct.setEqJoinConjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list526 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.other_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list526.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem527;
          for (int _i528 = 0; _i528 < _list526.size; ++_i528)
          {
            _elem527 = new org.apache.doris.thrift.TExpr();
            _elem527.read(iprot);
            struct.other_join_conjuncts.add(_elem527);
          }
        }
        struct.setOtherJoinConjunctsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.hash_output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list529.size);
          int _elem530;
          for (int _i531 = 0; _i531 < _list529.size; ++_i531)
          {
            _elem530 = iprot.readI32();
            struct.hash_output_slot_ids.add(_elem530);
          }
        }
        struct.setHashOutputSlotIdsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list532.size);
          ...
          for (int _i534 = 0; _i534 < _list532.size; ++_i534)
          {
            ...
            _elem533.read(iprot);
            struct.srcExprList.add(_elem533);
          }
        }
        struct.setSrcExprListIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list535 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list535.size);
          int _elem536;
          for (int _i537 = 0; _i537 < _list535.size; ++_i537)
          {
            _elem536 = iprot.readI32();
            struct.vintermediate_tuple_id_list.add(_elem536);
          }
        }
        struct.setVintermediateTupleIdListIsSet(true);
      }
