...
public class TGetTabletReplicaInfosResult implements org.apache.thrift.TBase<TGetTabletReplicaInfosResult, TGetTabletReplicaInfosResult._Fields>, java.io.Serializable, Cloneable, Comparable<TGetTabletReplicaInfosResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tablet_replica_infos = new java.util.HashMap<java.lang.Long,java.util.List<org.apache.doris.thrift.TReplicaInfo>>(2*_map440.size);
                long _key441;
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TReplicaInfo> _val442;
                for (int _i443 = 0; _i443 < _map440.size; ++_i443)
                {
                  _key441 = iprot.readI64();
                  {
                    ...
                    _val442 = new java.util.ArrayList<org.apache.doris.thrift.TReplicaInfo>(_list444.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TReplicaInfo _elem445;
                    for (int _i446 = 0; _i446 < _list444.size; ++_i446)
                    {
                      _elem445 = new org.apache.doris.thrift.TReplicaInfo();
                      _elem445.read(iprot);
                      _val442.add(_elem445);
                    }
                    iprot.readListEnd();
                  }
                  struct.tablet_replica_infos.put(_key441, _val442);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.tablet_replica_infos != null) {
        if (struct.isSetTabletReplicaInfos()) {
          oprot.writeFieldBegin(TABLET_REPLICA_INFOS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.util.List<org.apache.doris.thrift.TReplicaInfo>> _iter447 : struct.tablet_replica_infos.entrySet())
            {
              oprot.writeI64(_iter447.getKey());
              {
                ...
                for (org.apache.doris.thrift.TReplicaInfo _iter448 : _iter447.getValue())
                {
  ...
  private static class TGetTabletReplicaInfosResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGetTabletReplicaInfosResult> {
      ...
      if (struct.isSetTabletReplicaInfos()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.util.List<org.apache.doris.thrift.TReplicaInfo>> _iter449 : struct.tablet_replica_infos.entrySet())
          {
            oprot.writeI64(_iter449.getKey());
            {
              oprot.writeI32(_iter449.getValue().size());
              for (org.apache.doris.thrift.TReplicaInfo _iter450 : _iter449.getValue())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetTabletReplicaInfosResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map451 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST); 
          struct.tablet_replica_infos = new java.util.HashMap<java.lang.Long,java.util.List<org.apache.doris.thrift.TReplicaInfo>>(2*_map451.size);
          long _key452;
          @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TReplicaInfo> _val453;
          for (int _i454 = 0; _i454 < _map451.size; ++_i454)
          {
            _key452 = iprot.readI64();
            {
              ...
              _val453 = new java.util.ArrayList<org.apache.doris.thrift.TReplicaInfo>(_list455.size);
              @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TReplicaInfo _elem456;
              for (int _i457 = 0; _i457 < _list455.size; ++_i457)
              {
                _elem456 = new org.apache.doris.thrift.TReplicaInfo();
                _elem456.read(iprot);
                _val453.add(_elem456);
              }
            }
            struct.tablet_replica_infos.put(_key452, _val453);
          }
        }
        struct.setTabletReplicaInfosIsSet(true);
      }
