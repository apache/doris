...
public class TLoadTxnCommitRequest implements org.apache.thrift.TBase<TLoadTxnCommitRequest, TLoadTxnCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnCommitRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER_IP,_Fields.COMMIT_INFOS,_Fields.AUTH_CODE,_Fields.TXN_COMMIT_ATTACHMENT,_Fields.THRIFT_RPC_TIMEOUT_MS,_Fields.TOKEN,_Fields.DB_ID,_Fields.TBLS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list276.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem277;
                for (int _i278 = 0; _i278 < _list276.size; ++_i278)
                {
                  _elem277 = new org.apache.doris.thrift.TTabletCommitInfo();
                  _elem277.read(iprot);
                  struct.commitInfos.add(_elem277);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tbls = new java.util.ArrayList<java.lang.String>(_list279.size);
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletCommitInfo _iter282 : struct.commitInfos)
            {
      ...
      if (struct.tbls != null) {
        if (struct.isSetTbls()) {
          oprot.writeFieldBegin(TBLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter283 : struct.tbls)
            {
  ...
  private static class TLoadTxnCommitRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLoadTxnCommitRequest> {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletCommitInfo _iter284 : struct.commitInfos)
          {
      ...
      if (struct.isSetTbls()) {
        {
          ...
          for (java.lang.String _iter285 : struct.tbls)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TLoadTxnCommitRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list286 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list286.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem287;
          for (int _i288 = 0; _i288 < _list286.size; ++_i288)
          {
            _elem287 = new org.apache.doris.thrift.TTabletCommitInfo();
            _elem287.read(iprot);
            struct.commitInfos.add(_elem287);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list289 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.tbls = new java.util.ArrayList<java.lang.String>(_list289.size);
