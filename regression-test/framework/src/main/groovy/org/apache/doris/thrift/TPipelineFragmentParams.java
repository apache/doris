...
public class TPipelineFragmentParams implements org.apache.thrift.TBase<TPipelineFragmentParams, TPipelineFragmentParams._Fields>, java.io.Serializable, Cloneable, Comparable<TPipelineFragmentParams> {
  ...
  private static final _Fields optionals[] = {_Fields.FRAGMENT_ID,_Fields.DESC_TBL,_Fields.RESOURCE_INFO,_Fields.NUM_SENDERS,_Fields.SEND_QUERY_STATISTICS_WITH_EVERY_BATCH,_Fields.COORD,_Fields.QUERY_GLOBALS,_Fields.QUERY_OPTIONS,_Fields.IMPORT_LABEL,_Fields.DB_NAME,_Fields.LOAD_JOB_ID,_Fields.LOAD_ERROR_HUB_INFO,_Fields.FRAGMENT_NUM_ON_HOST,_Fields.BACKEND_ID,_Fields.NEED_WAIT_EXECUTION_TRIGGER,_Fields.INSTANCES_SHARING_HASH_TABLE,_Fields.IS_SIMPLIFIED_PARAM,_Fields.GLOBAL_DICT,_Fields.FRAGMENT,_Fields.WORKLOAD_GROUPS,_Fields.TXN_CONF};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workload_groups = new java.util.ArrayList<TPipelineWorkloadGroup>(_list267.size);
                @org.apache.thrift.annotation.Nullable TPipelineWorkloadGroup _elem268;
                for (int _i269 = 0; _i269 < _list267.size; ++_i269)
                {
                  _elem268 = new TPipelineWorkloadGroup();
                  _elem268.read(iprot);
                  struct.workload_groups.add(_elem268);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.workload_groups != null) {
        if (struct.isSetWorkloadGroups()) {
          oprot.writeFieldBegin(WORKLOAD_GROUPS_FIELD_DESC);
          {
            ...
            for (TPipelineWorkloadGroup _iter274 : struct.workload_groups)
            {
      ...
      if (struct.isSetWorkloadGroups()) {
        {
          ...
          for (TPipelineWorkloadGroup _iter279 : struct.workload_groups)
          {
      ...
      if (incoming.get(21)) {
        {
          ...
          struct.workload_groups = new java.util.ArrayList<TPipelineWorkloadGroup>(_list293.size);
          @org.apache.thrift.annotation.Nullable TPipelineWorkloadGroup _elem294;
          for (int _i295 = 0; _i295 < _list293.size; ++_i295)
          {
            _elem294 = new TPipelineWorkloadGroup();
            _elem294.read(iprot);
            struct.workload_groups.add(_elem294);
          }
        }
        struct.setWorkloadGroupsIsSet(true);
      }
