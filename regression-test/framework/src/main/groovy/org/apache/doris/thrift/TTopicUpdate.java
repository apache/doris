...
public class TTopicUpdate implements org.apache.thrift.TBase<TTopicUpdate, TTopicUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<TTopicUpdate> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updates = new java.util.ArrayList<TTopicItem>(_list202.size);
                @org.apache.thrift.annotation.Nullable TTopicItem _elem203;
                for (int _i204 = 0; _i204 < _list202.size; ++_i204)
                {
                  _elem203 = new TTopicItem();
                  _elem203.read(iprot);
                  struct.updates.add(_elem203);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deletes = new java.util.ArrayList<java.lang.String>(_list205.size);
      ...
      if (struct.updates != null) {
        if (struct.isSetUpdates()) {
          oprot.writeFieldBegin(UPDATES_FIELD_DESC);
          {
            ...
            for (TTopicItem _iter208 : struct.updates)
            {
      ...
      if (struct.deletes != null) {
        if (struct.isSetDeletes()) {
          oprot.writeFieldBegin(DELETES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter209 : struct.deletes)
            {
  ...
  private static class TTopicUpdateTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTopicUpdate> {
      ...
      if (struct.isSetUpdates()) {
        {
          ...
          for (TTopicItem _iter210 : struct.updates)
          {
      ...
      if (struct.isSetDeletes()) {
        {
          ...
          for (java.lang.String _iter211 : struct.deletes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTopicUpdate struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list212 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
