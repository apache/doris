            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list186.size);
                @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem187;
                for (int _i188 = 0; _i188 < _list186.size; ++_i188)
                {
                  _elem187 = new TTabletMetaInfo();
                  _elem187.read(iprot);
                  struct.tabletMetaInfos.add(_elem187);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tabletMetaInfos != null) {
        if (struct.isSetTabletMetaInfos()) {
          oprot.writeFieldBegin(TABLET_META_INFOS_FIELD_DESC);
          {
            ...
            for (TTabletMetaInfo _iter189 : struct.tabletMetaInfos)
            {
      ...
      if (struct.isSetTabletMetaInfos()) {
        {
          ...
          for (TTabletMetaInfo _iter190 : struct.tabletMetaInfos)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list191.size);
          @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem192;
          for (int _i193 = 0; _i193 < _list191.size; ++_i193)
          {
            _elem192 = new TTabletMetaInfo();
            _elem192.read(iprot);
            struct.tabletMetaInfos.add(_elem192);
          }
        }
        struct.setTabletMetaInfosIsSet(true);
      }
