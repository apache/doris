            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.params_list = new java.util.ArrayList<TPipelineFragmentParams>(_list296.size);
                @org.apache.thrift.annotation.Nullable TPipelineFragmentParams _elem297;
                for (int _i298 = 0; _i298 < _list296.size; ++_i298)
                {
                  _elem297 = new TPipelineFragmentParams();
                  _elem297.read(iprot);
                  struct.params_list.add(_elem297);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.params_list != null) {
        if (struct.isSetParamsList()) {
          oprot.writeFieldBegin(PARAMS_LIST_FIELD_DESC);
          {
            ...
            for (TPipelineFragmentParams _iter299 : struct.params_list)
            {
      ...
      if (struct.isSetParamsList()) {
        {
          ...
          for (TPipelineFragmentParams _iter300 : struct.params_list)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.params_list = new java.util.ArrayList<TPipelineFragmentParams>(_list301.size);
          @org.apache.thrift.annotation.Nullable TPipelineFragmentParams _elem302;
          for (int _i303 = 0; _i303 < _list301.size; ++_i303)
          {
            _elem302 = new TPipelineFragmentParams();
            _elem302.read(iprot);
            struct.params_list.add(_elem302);
          }
        }
        struct.setParamsListIsSet(true);
      }
