...
/*              Swap A(I1, I2+1:M) with A(I2, I2+1:M) */
		...
		if (i2 < *m) {
		    i__1 = *m - i2;
		    dswap_(&i__1, &a[*j1 + i1 - 1 + (i2 + 1) * a_dim1], lda, &
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
		...
		if (a[k + (j + 1) * a_dim1] != 0.) {
		    ...
		    i__1 = *m - j - 1;
		    dcopy_(&i__1, &work[3], &c__1, &a[k + (j + 2) * a_dim1], 
			    lda);
		    i__1 = *m - j - 1;
		    dscal_(&i__1, &alpha, &a[k + (j + 2) * a_dim1], lda);
		} else {
		    i__1 = *m - j - 1;
		    dlaset_("Full", &c__1, &i__1, &c_b22, &c_b22, &a[k + (j + 
			    2) * a_dim1], lda);
		}
	    }
	}
...
/*              Swap A(I2+1:M, I1) with A(I2+1:M, I2) */
		...
		if (i2 < *m) {
		    i__1 = *m - i2;
		    dswap_(&i__1, &a[i2 + 1 + (*j1 + i1 - 1) * a_dim1], &c__1,
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
		...
		if (a[j + 1 + k * a_dim1] != 0.) {
		    ...
		    i__1 = *m - j - 1;
		    dcopy_(&i__1, &work[3], &c__1, &a[j + 2 + k * a_dim1], &
			    c__1);
		    i__1 = *m - j - 1;
		    dscal_(&i__1, &alpha, &a[j + 2 + k * a_dim1], &c__1);
		} else {
		    i__1 = *m - j - 1;
		    dlaset_("Full", &i__1, &c__1, &c_b22, &c_b22, &a[j + 2 + 
			    k * a_dim1], lda);
		}
	    }
	}
