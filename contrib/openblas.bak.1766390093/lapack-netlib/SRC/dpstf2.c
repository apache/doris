...
/* > \brief \b DPSTF2 computes the Cholesky factorization with complete pivoting of a real symmetric positive 
semidefinite matrix. */
...
/*           Compute elements J+1:N of row J */
		...
		i__2 = j - 1;
		i__3 = *n - j;
		dgemv_("Trans", &i__2, &i__3, &c_b17, &a[(j + 1) * a_dim1 + 1]
...
/*           Compute elements J+1:N of column J */
		...
		i__2 = *n - j;
		i__3 = j - 1;
		dgemv_("No Trans", &i__2, &i__3, &c_b17, &a[j + 1 + a_dim1], 
