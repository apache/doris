...
/* > \brief \b DLA_GBRPVGRW computes the reciprocal pivot growth factor norm(A)/norm(U) for a general banded m
atrix. */
...
/*  ===================================================================== */
doublereal dla_gbrpvgrw_(integer *n, integer *kl, integer *ku, integer *
