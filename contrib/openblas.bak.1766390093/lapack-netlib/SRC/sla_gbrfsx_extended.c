...
/* > \verbatim */
/* >          LDAFB is INTEGER */
/* >     The leading dimension of the array AF.  LDAFB >= f2cmax(1,N). */
/* > \endverbatim */
/* > */
/* > \param[in] IPIV */
/* > \verbatim */
	...
	*ignore_cwise__, integer *info)
{
    ...
    extern /* Subroutine */ void blas_sgbmv2_x_(integer *, integer *, integer 
	    *, integer *, integer *, real *, real *, integer *, real *, real *
	    ...
	    sgbmv_(char *, integer *, integer *, integer *, integer *, real *,
	     real *, integer *, real *, integer *, real *, real *, integer *);
    real dxrat;
    logical incr_prec__;
    real dzrat;
...
/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */
	...
	sla_gbamv_(trans_type__, n, n, kl, ku, &c_b8, &ab[ab_offset], ldab, &
