...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsyrfsx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsyrfsx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsyrfsx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	work, integer *iwork, integer *info)
{
    ...
    doublereal rthresh;
    extern doublereal dla_syrcond_(char *, integer *, doublereal *, integer *
...
/*     Perform refinement on each right-hand side */
	...
	dla_syrfsx_extended_(&prec_type__, uplo, n, nrhs, &a[a_offset], lda, 
...
/*     Compute scaled normwise condition number cond(A*C). */
	...
	if (rcequ) {
	    rcond_tmp__ = dla_syrcond_(uplo, n, &a[a_offset], lda, &af[
