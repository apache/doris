...
/* > \verbatim */
/* > */
/* >    DLANTB = ( f2cmax(abs(A(i,j))), NORM = 'M' or 'm' */
/* >             ( */
...
/* Computing MAX */
			i__2 = *k + 2 - j;
			dlassq_(&i__3, &ab[f2cmax(i__2,1) + j * ab_dim1], &c__1, 
				colssq, &colssq[1]);
...
/* Computing MAX */
		    i__5 = *k + 2 - j;
		    dlassq_(&i__3, &ab[f2cmax(i__5,1) + j * ab_dim1], &c__1, 
			    colssq, &colssq[1]);
		    dcombssq_(ssq, colssq);
/* L290: */
		}
...
/* Computing MIN */
			i__4 = *n - j;
			i__3 = f2cmin(i__4,*k);
			dlassq_(&i__3, &ab[j * ab_dim1 + 2], &c__1, colssq, &
				colssq[1]);
			dcombssq_(ssq, colssq);
/* L300: */
		    }
...
/* Computing MIN */
		    i__4 = *n - j + 1, i__2 = *k + 1;
		    i__3 = f2cmin(i__4,i__2);
		    dlassq_(&i__3, &ab[j * ab_dim1 + 1], &c__1, colssq, &
			    colssq[1]);
		    dcombssq_(ssq, colssq);
/* L310: */
		}
