...
/*        a 1-by-1 or 2-by-2 pivot block will be used */
	...
	i__1 = kc + k - 1;
	absakk = (r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[kc + k - 
		1]), abs(r__2));
...
/*                 no interchange, use 1-by-1 pivot block */
		    ...
		    i__1 = kpc + imax - 1;
		    if ((r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[
			    kpc + imax - 1]), abs(r__2)) >= alpha * rowmax) {
...
/*        a 1-by-1 or 2-by-2 pivot block will be used */
	...
	i__1 = kc;
	absakk = (r__1 = ap[i__1].r, abs(r__1)) + (r__2 = r_imag(&ap[kc]), 
		abs(r__2));
