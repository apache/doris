...
/*  ===================================================================== */
/* Subroutine */ void ctprfs_(char *uplo, char *trans, char *diag, integer *n, 
...
/*           Compute abs(A)*abs(X) + abs(B). */
		...
		if (nounit) {
			...
			for (i__ = 1; i__ <= i__3; ++i__) {
			    i__4 = kc + i__ - 1;
			    rwork[i__] += ((r__1 = ap[i__4].r, abs(r__1)) + (
				    r__2 = r_imag(&ap[kc + i__ - 1]), abs(
				    r__2))) * xk;
/* L30: */
			}
			kc += k;
...
/*           Compute abs(A**H)*abs(X) + abs(B). */
		...
		if (nounit) {
			...
			for (i__ = 1; i__ <= i__3; ++i__) {
			    i__4 = kc + i__ - 1;
			    i__5 = i__ + j * x_dim1;
			    s += ((r__1 = ap[i__4].r, abs(r__1)) + (r__2 = 
				    r_imag(&ap[kc + i__ - 1]), abs(r__2))) * (
