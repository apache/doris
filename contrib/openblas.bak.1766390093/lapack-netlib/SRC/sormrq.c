...
/*  ===================================================================== */
/* Subroutine */ void sormrq_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 real *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo, i1, i2, i3, ib, nb;
    extern /* Subroutine */ void sormr2_(char *, char *, integer *, integer *, 
