	 ...
	 doublereal *rt2i, doublereal *cs, doublereal *sn)
{
    ...
    /* Local variables */
    doublereal temp, p, scale, bcmax, z__, bcmis, sigma;
    integer count;
    doublereal safmn2;
    extern doublereal dlapy2_(doublereal *, doublereal *);
    doublereal safmx2, aa, bb, cc, dd;
    extern doublereal dlamch_(char *);
    doublereal safmin, cs1, sn1, sab, sac, eps, tau;
...
/* Computing MAX */
	...
	bcmax = f2cmax(d__1,d__2);
/* Computing MIN */
	d__1 = abs(*b), d__2 = abs(*c__);
	bcmis = f2cmin(d__1,d__2) * d_sign(&c_b6, b) * d_sign(&c_b6, c__);
/* Computing MAX */
	d__1 = abs(p);
	scale = f2cmax(d__1,bcmax);
