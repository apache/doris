...
/*  ===================================================================== */
/* Subroutine */ void sormql_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 real *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo, i1, i2, i3, ib;
    extern /* Subroutine */ void sorm2l_(char *, char *, integer *, integer *, 
