  ...
  for (const i in data) {
    arr.push(
      <tr className="ant-table-row" key={i}>
        <td className="ant-table-cell" width="200" key={i}>
          {i}
        </td>
        <td className="ant-table-cell" key={data[i]} width="200">
          {data[i] && data[i].includes("http") ? (
        ...
        <div className="ant-table-container">
          <div className="ant-table-content">
            <table style={{ width: "100%" }}>
              <tbody className="ant-table-tbody">{arr}</tbody>
            </table>
          </div>
        </div>
      </div>
