...
public final class AuthenticationResult {
    ...
    public enum Status {
         ...
         * The exception is available via {@link AuthenticationResult#getException()}.
         */
        FAILURE
    }
    ...
    /**
     * Creates a successful authentication result with an Identity.
     * This is a convenience method that accepts Identity (which implements Principal).
     *
     * @param identity the authenticated identity
     * @return success result
     * @throws NullPointerException if identity is null
     */
    public static AuthenticationResult success(Identity identity) {
        Objects.requireNonNull(identity, "identity is required for success");
        return new AuthenticationResult(Status.SUCCESS, identity, null, null, null);
    }
    ...
    /**
     * Returns the identity if the principal is an Identity.
     * This is a convenience method for backward compatibility.
     *
     * @return the identity, or null if not an Identity or not successful
     */
