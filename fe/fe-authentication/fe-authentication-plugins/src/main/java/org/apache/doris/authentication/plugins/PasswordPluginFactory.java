...
/**
 * Factory for creating password authentication plugins.
 */
public class PasswordPluginFactory implements AuthenticationPluginFactory {

    @Override
    public AuthenticationPluginType pluginType() {
        return AuthenticationPluginType.PASSWORD;
    }

    @Override
    public AuthenticationPlugin create() {
        return new PasswordPlugin();
    }
}
