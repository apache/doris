...
public interface MultipartUploadCapability {
    ...
    UploadPartResult uploadPart(UploadSession session, int partNumber,
            UploadContent content) throws IOException;

    void completeUpload(UploadSession session, List<UploadPartResult> parts) throws IOException;

    void abortUpload(UploadSession session) throws IOException;
}
