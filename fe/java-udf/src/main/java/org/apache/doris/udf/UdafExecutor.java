...
public class UdafExecutor extends BaseExecutor {
    ...
    public Object createAggState() throws UdfRuntimeException {
        try {
            ...
            LOG.info("invoke createAggState function meet some error: " + e.getCause().toString());
    ...
    public void destroy() throws UdfRuntimeException {
        try {
            ...
            LOG.info("invoke destroy function meet some error: " + e.getCause().toString());
    ...
    public byte[] serialize(long place) throws UdfRuntimeException {
        try {
            ...
            LOG.info("invoke serialize function meet some error: " + e.getCause().toString());
    ...
    public void merge(long place, byte[] data) throws UdfRuntimeException {
        try {
            ...
            LOG.info("invoke merge function meet some error: " + e.getCause().toString());
    ...
    public boolean getValue(long row, long place) throws UdfRuntimeException {
        try {
            ...
            LOG.info("invoke getValue function meet some error: " + e.getCause().toString());
