...
@Description(name = "bitmap_to_string", value = "_FUNC_(expr) - Convert Doris's bitmap to a string, "
        + " return a string")
public class BitmapToStringUDF extends GenericUDF {
    ...
    public String getDisplayString(String[] children) {
        return "Usage: bitmap_to_string(bitmap1)";
    }
}
