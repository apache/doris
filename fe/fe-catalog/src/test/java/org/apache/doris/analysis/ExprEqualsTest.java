...
class ExprEqualsTest {
    ...
    class FunctionCallExprEquals {
        ...
        void sameNameAndArgs() {
            Assertions.assertEquals(
                    new FunctionCallExpr("abs", ImmutableList.of(intLit(1)), true),
                    new FunctionCallExpr("abs", ImmutableList.of(intLit(1)), true));
        }
        ...
        void differentFunctionName() {
            Assertions.assertNotEquals(
                    new FunctionCallExpr("abs", ImmutableList.of(intLit(1)), true),
                    new FunctionCallExpr("ceil", ImmutableList.of(intLit(1)), true));
        }
        ...
        void differentArgs() {
            Assertions.assertNotEquals(
                    new FunctionCallExpr("abs", ImmutableList.of(intLit(1)), true),
                    new FunctionCallExpr("abs", ImmutableList.of(intLit(2)), true));
        }
    }
