...
public class HiveConnectorWriteProviderDivertTest {
    ...
    public void foreignHandleDelegatesToSiblingWriteProviderUnmodified() {
        ...
        Assertions.assertSame(sibling.provider, provider,
                "a foreign handle must return the OWNING sibling's OWN write provider");
    ...
    public void foreignHandleFailsLoudWhenNoBuiltSiblingOwnsIt() {
        ...
        // catalog), not NPE — the write-side stand-in for an orphan handle reaching a per-handle seam.
