...
/**
 * Paimon REST catalog metastore backend facts. Options-only (the REST server owns storage, so
 ...
 */
public final class PaimonRestMetaStoreProperties extends AbstractMetaStoreProperties
    ...
    private PaimonRestMetaStoreProperties(Map<String, String> raw) {
        super(raw);
    }

    public static PaimonRestMetaStoreProperties of(Map<String, String> raw) {
        PaimonRestMetaStoreProperties props = new PaimonRestMetaStoreProperties(raw);
