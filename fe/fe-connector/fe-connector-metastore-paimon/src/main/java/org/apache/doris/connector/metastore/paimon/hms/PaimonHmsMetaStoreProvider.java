...
/** Selects the paimon Hive Metastore backend ({@code paimon.catalog.type == hms}). */
public final class PaimonHmsMetaStoreProvider implements MetaStoreProvider<HmsMetaStoreProperties> {
    ...
    public HmsMetaStoreProperties bind(Map<String, String> properties, Map<String, String> storageHadoopConfig) {
        return PaimonHmsMetaStoreProperties.of(properties, storageHadoopConfig);
    }

    @Override
    public Set<String> sensitivePropertyKeys() {
        return ConnectorPropertiesUtils.getSensitiveKeys(PaimonHmsMetaStoreProperties.class);
    }
