...
/** Selects the paimon JDBC catalog backend ({@code paimon.catalog.type == jdbc}). */
public final class PaimonJdbcMetaStoreProvider implements MetaStoreProvider<JdbcMetaStoreProperties> {
    ...
    public JdbcMetaStoreProperties bind(Map<String, String> properties,
        ...
        return PaimonJdbcMetaStoreProperties.of(properties);
    }

    @Override
    public Set<String> sensitivePropertyKeys() {
        return ConnectorPropertiesUtils.getSensitiveKeys(PaimonJdbcMetaStoreProperties.class);
    }
