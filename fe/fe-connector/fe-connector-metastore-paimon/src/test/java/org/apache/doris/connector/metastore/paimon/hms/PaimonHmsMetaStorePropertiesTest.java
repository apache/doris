...
public class PaimonHmsMetaStorePropertiesTest {
    ...
    private static PaimonHmsMetaStoreProperties of(Map<String, String> raw) {
        return PaimonHmsMetaStoreProperties.of(raw, Collections.emptyMap());
    }

    @Test
    public void simpleEmitsUriAndSocketTimeoutOnly() {
        PaimonHmsMetaStoreProperties props = of(raw("hive.metastore.uris", "thrift://h:9083", "warehouse", "wh"));
    ...
    public void kerberosEmitsServicePrincipalSaslAndCarriesClientFacts() {
        PaimonHmsMetaStoreProperties props = of(raw(
    ...
    public void storageOverlayRunsBeforeKerberosBlockViaStorageMapChannel() {
        ...
        Map<String, String> conf = PaimonHmsMetaStoreProperties.of(raw(
