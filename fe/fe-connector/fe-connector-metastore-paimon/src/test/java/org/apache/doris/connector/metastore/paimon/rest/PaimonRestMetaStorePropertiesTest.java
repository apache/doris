...
package org.apache.doris.connector.metastore.paimon.rest;
...
public class PaimonRestMetaStorePropertiesTest {
    ...
    public void toRestOptionsStripsPaimonRestPrefix() {
        PaimonRestMetaStoreProperties props = PaimonRestMetaStoreProperties.of(raw(
    ...
    public void uriAliasResolvesFromPlainUri() {
        PaimonRestMetaStoreProperties props =
                PaimonRestMetaStoreProperties.of(raw("uri", "http://plain", "warehouse", "wh"));
    ...
    public void validateChecksWarehouseThenUriThenDlfToken() {
        ...
        Assertions.assertEquals("Property warehouse is required.",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> PaimonRestMetaStoreProperties.of(raw("paimon.rest.uri", "http://r")).validate())
                        .getMessage());
        // then uri
        Assertions.assertEquals("paimon.rest.uri or uri is required",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> PaimonRestMetaStoreProperties.of(raw("warehouse", "wh")).validate()).getMessage());
        ...
        Assertions.assertEquals("DLF token provider requires 'paimon.rest.dlf.access-key-id' "
                ...
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> PaimonRestMetaStoreProperties.of(raw(
