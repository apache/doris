...
public class PaimonJdbcMetaStorePropertiesTest {
    ...
    public void gettersReturnRawAliasResolvedValues() {
        PaimonJdbcMetaStoreProperties props = PaimonJdbcMetaStoreProperties.of(raw(
    ...
    public void validateChecksWarehouseThenUriThenDriverClass() {
        Assertions.assertEquals("Property warehouse is required.",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> PaimonJdbcMetaStoreProperties.of(raw("uri", "jdbc:x")).validate()).getMessage());
        Assertions.assertEquals("uri or paimon.jdbc.uri is required",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> PaimonJdbcMetaStoreProperties.of(raw("warehouse", "wh")).validate()).getMessage());
        Assertions.assertEquals("jdbc.driver_class or paimon.jdbc.driver_class is required when "
                ...
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> PaimonJdbcMetaStoreProperties.of(raw(
    ...
    public void uriPrefersFirstAlias() {
        ...
        Assertions.assertEquals("jdbc:a", PaimonJdbcMetaStoreProperties.of(raw(
