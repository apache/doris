...
public class PaimonFileSystemMetaStorePropertiesTest {
    ...
    public void carriesWarehouseAndDeclaresStorageNeeded() {
        ...
        PaimonFileSystemMetaStoreProperties props = PaimonFileSystemMetaStoreProperties.of(raw);
    ...
    public void validateRequiresWarehouse() {
        PaimonFileSystemMetaStoreProperties props = PaimonFileSystemMetaStoreProperties.of(new HashMap<>());
