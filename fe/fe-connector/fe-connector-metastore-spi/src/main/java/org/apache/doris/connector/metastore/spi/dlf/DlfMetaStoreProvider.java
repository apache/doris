...
/** Selects the Aliyun DLF backend ({@code paimon.catalog.type == dlf}). */
public final class DlfMetaStoreProvider implements MetaStoreProvider<DlfMetaStoreProperties> {
    ...
    public DlfMetaStoreProperties bind(Map<String, String> properties, Map<String, String> storageHadoopConfig) {
        return DlfMetaStorePropertiesImpl.of(properties, storageHadoopConfig);
    }

    @Override
    public Set<String> sensitivePropertyKeys() {
        return ConnectorPropertiesUtils.getSensitiveKeys(DlfMetaStorePropertiesImpl.class);
    }
