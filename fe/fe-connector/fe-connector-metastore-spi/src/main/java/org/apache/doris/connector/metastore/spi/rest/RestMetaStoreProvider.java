...
/** Selects the REST catalog backend ({@code paimon.catalog.type == rest}). */
public final class RestMetaStoreProvider implements MetaStoreProvider<RestMetaStoreProperties> {
    ...
    @Override
    public RestMetaStoreProperties bind(Map<String, String> properties,
            Map<String, String> storageHadoopConfig) {
        return RestMetaStorePropertiesImpl.of(properties);
    }

    @Override
    public Set<String> sensitivePropertyKeys() {
        return ConnectorPropertiesUtils.getSensitiveKeys(RestMetaStorePropertiesImpl.class);
    }
