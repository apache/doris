...
public class DlfMetaStorePropertiesTest {
    ...
    public void toDlfCatalogConfDerivesVpcEndpointAndCatalogIdFromUid() {
        DlfMetaStorePropertiesImpl props = DlfMetaStorePropertiesImpl.of(raw(
    ...
    public void validateInOrderWarehouseAkSkEndpointOss() {
        Assertions.assertEquals("Property warehouse is required.",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> DlfMetaStorePropertiesImpl.of(raw("dlf.access_key", "ak"), Collections.emptyMap())
                                .validate()).getMessage());
        Assertions.assertEquals("dlf.access_key is required",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> DlfMetaStorePropertiesImpl.of(raw("warehouse", "wh"), Collections.emptyMap())
                                .validate()).getMessage());
        Assertions.assertEquals("dlf.secret_key is required",
                Assertions.assertThrows(IllegalArgumentException.class,
                        () -> DlfMetaStorePropertiesImpl.of(raw("warehouse", "wh", "dlf.access_key", "ak"),
        ...
        DlfMetaStorePropertiesImpl.of(raw("warehouse", "wh", "dlf.access_key", "ak", "dlf.secret_key", "sk",
