 ...
 *
 * <p>NOTE: verbatim copy of fe-core {@code org.apache.doris.datasource.hive.HiveVersionUtil}, vendored into
 * the shared fe-connector-hms module. HMS-backed connector plugins run on their own child-first classloaders
 * and cannot see fe-core classes, but the bundled copy of Doris's patched
 * {@code org.apache.hadoop.hive.metastore.HiveMetaStoreClient} needs this to pick the Hive-version-aware
 * catalog-name handling (Hive 1/2 metastores reject the Hive-3 {@code @cat#} db marker). Keep in sync with
 * the fe-core original.</p>
 */
