...
public final class IdNameIndex {
    ...
    private final ConcurrentMap<Long, String> idToName = new ConcurrentHashMap<>();
    ...
    public synchronized void removeName(String name) {
        ...
        checkState(name.equals(indexedName),
    ...
    public synchronized int sizeForTest() {
        checkState(idToName.size() == nameToId.size(),
