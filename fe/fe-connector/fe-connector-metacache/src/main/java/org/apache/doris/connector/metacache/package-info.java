 ...
 *
 * <p>It is under the parent-first {@code org.apache.doris.connector.*} prefix, so all instances load on the app
 * classloader with a single {@code Class} identity across the fe-core &harr; plugin boundary. The module
