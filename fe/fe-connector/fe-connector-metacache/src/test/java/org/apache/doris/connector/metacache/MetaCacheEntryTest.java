...
public class MetaCacheEntryTest {
    ...
    @Test
    public void testDefaultConstructorsUseRuntimeObjectStripeCount() {
        ...
        try {
            ...
            Assert.assertEquals(MetaCacheEntry.defaultObjectStripeCount(), entry.stripeCountForTest());
            Assert.assertEquals(MetaCacheEntry.defaultObjectStripeCount(), syncRemovalEntry.stripeCountForTest());
    ...
    public void testSyncRemovalListenerDisablesRefreshAndRunsSynchronously() throws Exception {
        ...
        try {
            ...
            MetaCacheEntry<String, Integer> entry = MetaCacheEntry.withSyncRemovalListener(
                    ...
                    cacheSpec,
                    refreshExecutor,
                    (key, value) -> removalCounter.incrementAndGet());
