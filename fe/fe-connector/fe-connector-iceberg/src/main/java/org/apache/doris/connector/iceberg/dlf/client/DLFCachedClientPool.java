...
/**
 * Catalog-level cache of {@link DLFClientPool}s. Ported verbatim from the legacy fe-core
 * {@code org.apache.doris.datasource.iceberg.dlf.client.DLFCachedClientPool} into the plugin connector
 * (P6-T07); no fe-core dependencies (iceberg + relocated thrift from hive-catalog-shade + caffeine).
 */
