 ...
 *
 * <p>Verbatim connector port of fe-core {@code datasource/iceberg/rewrite/RewriteResult} (a dependency-free
 * POJO — only Guava + JDK). The legacy copy stays consumed by the fe-core rewrite executor until P6.7; this
 * copy is the connector-side carrier for the {@code rewrite_data_files} planning half (P6.4-T05).</p>
 */
