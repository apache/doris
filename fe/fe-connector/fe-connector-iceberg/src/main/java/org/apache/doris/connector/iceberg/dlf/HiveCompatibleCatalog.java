...
/**
 * Base for hive-metastore-compatible Iceberg catalogs (currently only {@link DLFCatalog}). Ported verbatim
 * from the legacy fe-core {@code org.apache.doris.datasource.iceberg.HiveCompatibleCatalog} into the plugin
 * connector (P6-T07); it has no fe-core dependencies (iceberg-core + iceberg-hive's relocated thrift, both
 * supplied by hive-catalog-shade at the same {@code iceberg.version} as the connector's direct iceberg-core).
 */
