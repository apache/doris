...
public class ConnectorPluginSurfaceTest {
    ...
    public void connectorApiMajorTracksTheRecordedSurfaceChange() throws IOException {
        ...
        // ConnectorScanPlanProvider gained a streaming-profile lifecycle hook in this surface revision. A plugin
        // built against major 5 must be refused rather than silently run against a lifecycle it did not opt into.
