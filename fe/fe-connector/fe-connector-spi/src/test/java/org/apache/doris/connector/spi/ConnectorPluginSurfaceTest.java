...
public class ConnectorPluginSurfaceTest {
    ...
    public void connectorApiMajorTracksTheRecordedSurfaceChange() throws IOException {
        ...
        // Major 8 moved the driver-jar policy out of the engine: ConnectorValidationContext lost its two
        ...
        // executeQuery. A plugin built against major 7 calls methods that no longer exist and must be
