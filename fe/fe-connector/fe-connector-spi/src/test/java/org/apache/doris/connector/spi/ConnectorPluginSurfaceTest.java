...
public class ConnectorPluginSurfaceTest {
    ...
    public void connectorApiMajorTracksTheRecordedSurfaceChange() throws IOException {
        ...
        // ConnectorMetadata gained listsPartitionsAtSnapshot in this surface revision - the method a
        // connector answers "my partition listing is exact at the pinned snapshot" with. A plugin built
        // against major 6 must be refused rather than run against a contract it did not compile against.
