...
public interface ConnectorProvider extends PluginFactory {
     ...
     * {@link #validateProperties}, which the engine runs on both CREATE and ALTER — and a connector
     * that overrides {@link #validatePropertiesForUpdate} without funneling back to
     * {@code validateProperties} must run the rule from that override too, or ALTER escapes it.
     */
