...
/**
 * Immutable definition of a logical metadata cache entry.
 *
 * <p>This class only describes "what an entry is", not "entry runtime data".
 * Runtime instances are created by the MetaCache runtime module.
 *
 ...
 * <pre>{@code
 * private final MetaCacheEntryDef<TableKey, TableValue> tableEntryDef =
...
public final class MetaCacheEntryDef<K, V> {
     ...
     *
     * <p>Used by the runtime to validate that callers use
     ...
     *
     * <p>Used by the runtime to validate value type
     * compatibility for the requested entry and to prevent cross-entry misuse.
     */
    private final Class<V> valueType;

    /**
     * Loader function used on a cache miss.
     *
    ...
    private MetaCacheEntryDef(String name, Class<K> keyType, Class<V> valueType,
            Function<K, V> loader, CacheSpec defaultCacheSpec, boolean autoRefresh, boolean contextualOnly,
     ...
     * @param loader miss loader invoked by the runtime
