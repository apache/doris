...
/** Selects the iceberg Hive Metastore backend ({@code iceberg.catalog.type == hms}). */
public final class IcebergHmsMetaStoreProvider implements MetaStoreProvider<HmsMetaStoreProperties> {
    ...
    public HmsMetaStoreProperties bind(Map<String, String> properties, Map<String, String> storageHadoopConfig) {
        return IcebergHmsMetaStoreProperties.of(properties, storageHadoopConfig);
    }

    @Override
    public Set<String> sensitivePropertyKeys() {
        return ConnectorPropertiesUtils.getSensitiveKeys(IcebergHmsMetaStoreProperties.class);
    }
