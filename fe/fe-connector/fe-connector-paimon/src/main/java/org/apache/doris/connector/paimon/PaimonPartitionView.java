...
/** Immutable Paimon partition-view cache value with its entry weight computed once at construction. */
final class PaimonPartitionView extends AbstractList<ConnectorPartitionInfo> implements RandomAccess {
    ...
    PaimonPartitionView(ConnectorTableKey key, List<ConnectorPartitionInfo> partitions) {
        ...
        this.estimatedBytes = PaimonPartitionViewSizeEstimator.estimateEntryOnConstruction(key, this);
    }
