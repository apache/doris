...
public class OptItemLikePredicate extends OptItem {
    ...
    public OptItemLikePredicate(LikePredicate.Operator op) {
    ...
    @Override
    public int hashCode() {
        return OptUtils.combineHash(super.hashCode(), op);
    }
    ...
    public boolean equals(Object object) {
        ...
        OptItemLikePredicate rhs = (OptItemLikePredicate) object;
        return op == rhs.op;
    }
    ...
    public String getExplainString(String prefix) {
        ...
        sb.append(prefix).append("ItemLikePredicate(op=").append(op).append(")");
        return sb.toString();
    }
}
