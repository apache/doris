...
public class SchedulerContextImp implements SchedulerContext {
    ...
    private SchedulerContextImp(OptMemo memo, Scheduler scheduler) {
        this.memo = memo;
        this.scheduler = scheduler;
    }

    public static SchedulerContext create(OptMemo memo, OptGroup firstGroup,
                                          OptimizationContext oContext, Scheduler scheduler) {
        final SchedulerContext sContext = new SchedulerContextImp(memo, scheduler);
