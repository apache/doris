...
public class OptItemCompoundPredicate extends OptItem {
    private CompoundPredicate.Operator op;

    public OptItemCompoundPredicate(CompoundPredicate.Operator op)  {
        super(OptOperatorType.OP_ITEM_COMPOUND_PREDICATE);
        this.op = op;
    }
    ...
    public boolean equals(Object object) {
        ...
        OptItemCompoundPredicate rhs = (OptItemCompoundPredicate) object;
        return op == rhs.op;
    }
