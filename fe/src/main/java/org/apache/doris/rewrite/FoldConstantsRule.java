...
public class FoldConstantsRule implements ExprRewriteRule {
    ...
    private static final ImmutableMultimap<String, FEFunctionInvoker> functions;
    private static final ImmutableSet<String> functionsHandlingNull;
    ...
    private Expr simplify(Expr constExpr) throws AnalysisException {
        if (constExpr instanceof ArithmeticExpr
            ...
            // null
            if (!functionsHandlingNull.contains(fn.getFunctionName().getFunction())) {
    ...
    private synchronized void registerFunctions() {
        ...
        setBuilder.add("if");
        this.functionsHandlingNull = setBuilder.build();
    }
