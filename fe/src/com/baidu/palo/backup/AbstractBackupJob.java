...
public class AbstractBackupJob implements Writable {
    private static final Logger LOG = LogManager.getLogger(AbstractBackupJob.class);
    ...
    public AbstractBackupJob(long jobId, long dbId, LabelName labelName, String remotePath,
