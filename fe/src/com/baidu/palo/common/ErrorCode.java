...
public enum ErrorCode {
    ...
    ERR_CLUSTER_NO_AUTHORITY(5030, new byte[] { 'H', 'Y', '0', '0', '0' }, "User '%s' has no permissions '%s' cluster"),
    ...
    ERR_CLUSTER_DES_CLUSTER_NO_EXIT(5047, new byte[] {'4', '2', '0', '0', '0'}, "Des cluster '%s' no exist"),
    ERR_CLUSTER_SRC_DB_NO_EXIT(5048, new byte[] {'4', '2', '0', '0', '0'}, "Src db '%s' no exist"),
    ERR_CLUSTER_DES_DB_NO_EXIT(5049, new byte[] {'4', '2', '0', '0', '0'}, "Des db '%s' no exist"),
    ...
    ERR_CLUSTER_ALTER_BE_IN_CLUSTER_DECOMMISSION(5059, new byte[] {'4', '2', '0', '0', '0'}, 
            "Cluster '%s' is in cluster decommission"),
    ERR_CLUSTER_ALTER_BE_IN_SYSTEM_DECOMMISSION(5060, new byte[] {'4', '2', '0', '0', '0'}, 
            "Cluster '%s' is in system decommission"),
