...
public class BackupProcNode implements ProcDirInterface {
    public static final ImmutableList<String> TITLE_NAMES = new ImmutableList.Builder<String>()
            .add("JobId").add("Lable").add("State").add("CreateTime")
            .add("MetaSavedTime").add("SnapshotFinishedTime").add("UploadFinishedTime").add("FinishedTime")
            .add("ErrMsg").add("BackupPath").add("Manifest").add("LeftTaskNum").add("LatestLoadLabel")
            .build();

    private BackupHandler backupHandler;
    private Database db;

    public BackupProcNode(BackupHandler backupHandler, Database db) {
    ...
    public ProcResult fetchResult() throws AnalysisException {
        ...
        List<List<Comparable>> backupJobInfos = backupHandler.getJobInfosByDb(db.getId(), BackupJob.class, null);
    ...
    public ProcNodeInterface lookup(String jobIdStr) throws AnalysisException {
        ...
        return new BackupJobProcNode(backupHandler, db.getId(), BackupJob.class);
    }
