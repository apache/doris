...
public class ColocateTableBalancerTest {
    ...
    public void testBalanceNormalWithOneBackend() {
        int replicateNum = 3;
        List<List<Long>> backendsPerBucketSeq  = Lists.partition(Lists.newArrayList(1L, 2L, 3L, 4L, 1L, 2L, 3L, 4L, 1L, 2L, 3L, 4L, 1L, 2L, 3L), replicateNum);
        System.out.println("old backendsPerBucketSeq: " + backendsPerBucketSeq);
