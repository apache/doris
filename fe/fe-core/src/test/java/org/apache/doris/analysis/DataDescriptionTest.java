...
public class DataDescriptionTest {
    ...
    public void testNormal() throws AnalysisException {
        ...
        desc.analyze("testDb");
        Assert.assertEquals("MERGE DATA INFILE ('abc.txt') INTO TABLE testTable COLUMNS TERMINATED BY ',' (col1, col2) FORMAT AS 'csv' WHERE 1 = 1 DELETE ON 1 = 1", desc.toString());
