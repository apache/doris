...
class RequestPropertyDeriverTest {
    ...
    @Test
    void testAggregateWithAggShuffleUseParentKeyEnabledAndLargeNullBucketBelowHotValueRatio() {
        Statistics childStats = new StatisticsBuilder()
                .setRowCount(1_000_000_000)
                .putColumnStatistics(aggregateKey1, new ColumnStatisticBuilder(1_000_000_000)
                        .setNdv(1_000_000)
        ...
        Assertions.assertEquals(
                fullAggregateRequests(), requestAggregateProperties(true, childStats, 100));
    }
    ...
    @Test
    void testHighNdvOtherParentKeyCannotDismissPotentialHotNullSkew() {
        ...
        Assertions.assertEquals(
                fullAggregateRequests(aggregateKey3),
                requestThreeKeyAggregateProperties(aggregateKey3, childStats, 3000));
    }

    @Test
    void testHotParentKeysCannotReuseParentShuffleWithoutJointStats() {
        SlotReference aggregateKey3 = new SlotReference(new ExprId(2), "col3",
                IntegerType.INSTANCE, true, ImmutableList.of());
        Statistics childStats = new StatisticsBuilder()
                .setRowCount(1_000_000_000)
