...
public class PartitionKeyTest {
    ...
    public void compareTest() throws AnalysisException {
        ...
        // case11
        pk1 = PartitionKey.createPartitionKey(
                Arrays.asList(new PartitionValue("beijing"), new PartitionValue("shanghai")),
        ...
        pk1 = PartitionKey.createPartitionKey(
                ...
                Arrays.asList(charString, varchar));
        pk2 = PartitionKey.createPartitionKey(
                Arrays.asList(new PartitionValue("shijiazhuang"), new PartitionValue("tianjin")),
                Arrays.asList(charString, varchar));
        Assert.assertTrue(pk1.hashCode() != pk2.hashCode());
        Assert.assertTrue(!pk1.equals(pk2) && pk1.compareTo(pk2) == -1);
        ...
        pk1 = PartitionKey.createPartitionKey(
                ...
                Arrays.asList(charString, varchar));
        pk2 = PartitionKey.createPartitionKey(
                Arrays.asList(new PartitionValue("beijing"), new PartitionValue("tianjin")),
                Arrays.asList(charString, varchar));
        Assert.assertTrue(pk1.hashCode() != pk2.hashCode());
        Assert.assertTrue(!pk1.equals(pk2) && pk1.compareTo(pk2) == -1);
    ...
    public void testSerialization() throws Exception {
        ...
        columns.add(new Column("column2", ScalarType.createType(PrimitiveType.TINYINT), true, null, "", "", null));
        keys.add(new PartitionValue("101"));
        columns.add(new Column("column3", ScalarType.createType(PrimitiveType.SMALLINT), true, null, "", "", null));
        keys.add(new PartitionValue("102"));
        columns.add(new Column("column4", ScalarType.createType(PrimitiveType.INT), true, null, "", "", null));
        keys.add(new PartitionValue("103"));
        columns.add(new Column("column5", ScalarType.createType(PrimitiveType.BIGINT), true, null, "", "", null));
        ...
        columns.add(new Column("column12", ScalarType.createType(PrimitiveType.VARCHAR), true, null, "", "", null));
        keys.add(new PartitionValue("shanghai"));
        columns.add(new Column("column13", ScalarType.createType(PrimitiveType.CHAR), true, null, "", "", null));
        keys.add(new PartitionValue("true"));
        columns.add(new Column("column14", ScalarType.createType(PrimitiveType.BOOLEAN), true, null, "", "", null));
        keys.add(new PartitionValue("false"));
        columns.add(new Column("column15", ScalarType.createType(PrimitiveType.BOOLEAN), true, null, "", "", null));
