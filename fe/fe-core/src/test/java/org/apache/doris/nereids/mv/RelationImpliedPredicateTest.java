...
public class RelationImpliedPredicateTest extends SqlTestBase {
    ...
    @Test
    void testNestedMvRewriteByGeneratedScanRelationImpliedPredicate() throws Exception {
        initMvRewriteSession();
        ...
        try {
            ...
            mockCandidateMtmv("mv_relation_implied_fact_with_score");
            ...
            createMvByNereids("create materialized view mv_relation_implied_explicit_join "
                    ...
                    + "where f.score = 1;");
            mockCandidateMtmv("mv_relation_implied_explicit_join");
            ...
            Assertions.assertTrue(plan.contains("mv_relation_implied_explicit_join"), plan);
        } finally {
            dropMvByNereids("drop materialized view if exists mv_relation_implied_explicit_join");
            dropMvByNereids("drop materialized view if exists mv_relation_implied_fact_with_score");
        }
    ...
    @Test
    void testNestedMvRewriteByInheritedRelationImpliedPredicate() throws Exception {
        initMvRewriteSession();
