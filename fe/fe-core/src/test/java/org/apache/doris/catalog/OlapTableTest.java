...
public class OlapTableTest {
    ...
    public void testGetSchemaAllIndexes() {
        ...
        table.addIndexNameToIdForUnitTest("__doris_shadow_test", 1L);
        ...
        table.addIndexNameToIdForUnitTest("normal_index", 2L);
        Assert.assertTrue(table.isShadowIndex(1L));
        Assert.assertFalse(table.isShadowIndex(2L));
