...
public class SingleStatementValidatorTest {
    ...
    @Test
    void rejectsEmptyMultipleAndUnterminatedInput() {
        assertInvalid("  ; ");
    ...
    private void assertInvalid(String sql) {
        WebSqlException exception = Assertions.assertThrows(
                WebSqlException.class, () -> SingleStatementValidator.requireSingleStatement(sql));
        Assertions.assertEquals(WebSqlError.INVALID_STATEMENT, exception.getError());
    }
}
