    ...
    public void testGetSetResourceTagFromAuth() throws Exception {
        new Expectations() {
            ...
            // 2 get a non-admin user without resource tag
            {
                ...
                Assert.assertTrue(((MergedComputeGroup) cg).getIdentifiers().contains(Tag.VALUE_DEFAULT_TAG));
                ...
                Assert.assertTrue(((MergedComputeGroup) cg2).getIdentifiers().contains("test_rg1"));
                ...
                Set<String> cgNameSet = ((MergedComputeGroup) cg3).getIdentifiers();
                ...
                Set<String> cgNameSets = ((MergedComputeGroup) cg4).getIdentifiers();
            ...
            // 4 get an admin user without resource tag
            {
                ...
                Assert.assertTrue(cg2 instanceof MergedComputeGroup);
                Assert.assertTrue(((MergedComputeGroup) cg2).getIdentifiers().contains("test_rg2"));
    ...
    public void testBrokerLoadToConnectContext() throws UserException, IOException {
        new Expectations() {
            ...
            // test get cg from user property
            {
                ...
                Assert.assertTrue(cg instanceof MergedComputeGroup);
                Assert.assertTrue(((MergedComputeGroup) cg).getIdentifiers().contains(tagName));
    ...
    public void testRoutineLoadToConnectContext() throws Exception {
        new Expectations() {
            ...
            // 3 get a valid compute group
            {
                ...
                ComputeGroup cg = ConnectContext.get().getComputeGroupSafely();
                Assert.assertTrue(cg instanceof MergedComputeGroup);
                Assert.assertTrue(((MergedComputeGroup) cg).getIdentifiers().contains("tag_rg_1"));
            }
