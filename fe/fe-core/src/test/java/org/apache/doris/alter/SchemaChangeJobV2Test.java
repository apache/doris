...
public class SchemaChangeJobV2Test {
    ...
    private static ColumnDefinition newCol2 = new ColumnDefinition("add_v", DataType.fromCatalogType(ScalarType.createType(PrimitiveType.INT)),
            false, AggregateType.MAX, false, Optional.of(new DefaultValue("1")), "");
    private static AddColumnOp addColumnOp = new AddColumnOp(newCol2, new ColumnPosition("v"), null, null);
