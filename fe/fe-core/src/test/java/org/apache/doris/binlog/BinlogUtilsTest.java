...
class BinlogUtilsTest {
    ...
    void testEffectiveStartTso() {
        Assertions.assertEquals(101L, BinlogUtils.effectiveStartTso(null, 100L, false));
        Assertions.assertEquals(101L, BinlogUtils.effectiveStartTso(99L, 100L, false));
        Assertions.assertEquals(101L, BinlogUtils.effectiveStartTso(100L, 100L, false));
        Assertions.assertEquals(101L, BinlogUtils.effectiveStartTso(101L, 100L, true));
        Assertions.assertEquals(102L, BinlogUtils.effectiveStartTso(102L, 100L, true));
        Assertions.assertEquals(TSOTimestamp.UNBOUNDED_TSO,
                BinlogUtils.effectiveStartTso(null, TSOTimestamp.MAX_REAL_TSO, false));
    }
    ...
    void testRejectExpiredMinDeltaOffset() {
        ...
        Assertions.assertThrows(AnalysisException.class,
                () -> BinlogUtils.effectiveStartTso(100L, 100L, true));
    }
