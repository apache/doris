...
public class StringEmptyToLengthRuleTest extends ExpressionRewriteTestHelper {
    ...
    public void testStructElementEqualEmptyRewrite() {
        ...
        ElementAt elementAt = new ElementAt(structSlot, new VarcharLiteral("f3"));
        VarcharLiteral empty = new VarcharLiteral("");
        assertRuleRewrite(
                new EqualTo(elementAt, empty),
                new EqualTo(new Length(elementAt), new IntegerLiteral(0))
        );
    }
    ...
    public void testNotStructElementEqualEmptyRewrite() {
        ...
        VarcharLiteral empty = new VarcharLiteral("");
        assertRuleRewrite(
                new Not(new EqualTo(elementAt, empty)),
                new Not(new EqualTo(new Length(elementAt), new IntegerLiteral(0)))
        );
    }
}
