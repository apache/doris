        ...
        PlanChecker.from(connectContext)
                ...
                .matchesFromRoot(
                    logicalJoin(
                            logicalFilter(
                                    logicalOlapScan()
                            ).when(filter -> filter.getConjuncts().get(0).toSql().contains("id > 1")),
                            logicalFilter(
                                    logicalOlapScan()
                            ).when(filer -> filer.getConjuncts().get(0).toSql().contains("sid > 1"))
                    )
                );
    }
        ...
        PlanChecker.from(connectContext)
                ...
                .matchesFromRoot(
                    logicalJoin(
                        logicalFilter(
                                logicalOlapScan()
                        ).when(filter -> filter.getConjuncts().get(0).toSql().contains("id IN (1, 2, 3)")),
                        logicalOlapScan()
                    )
                );
    }
                ...
                .matchesFromRoot(
                    logicalJoin(
                        logicalJoin(
                                ...
                                logicalFilter(
                                        logicalOlapScan()
                                ).when(filter -> filter.getConjuncts().get(0).toSql().contains("sid > 1"))
                        ),
                        logicalFilter(
                                logicalOlapScan()
                        ).when(filter -> filter.getConjuncts().get(0).toSql().contains("id > 1"))
        ...
        PlanChecker.from(connectContext)
                ...
                .matchesFromRoot(
                    logicalJoin(
                            logicalFilter(
                                    logicalOlapScan()
                            ).when(filer -> filer.getConjuncts().get(0).toSql().contains("id > 1")),
                            logicalFilter(
                                    logicalOlapScan()
                            ).when(filer -> filer.getConjuncts().get(0).toSql().contains("sid > 1"))
                    )
        ...
        PlanChecker.from(connectContext)
                ...
                .matchesFromRoot(
                    logicalJoin(
                        logicalFilter(
                                logicalOlapScan()
                        ).when(filter -> filter.getConjuncts().get(0).toSql().contains("k1 = 3")),
                        logicalProject(
                            logicalJoin(
                                logicalJoin(
                                   logicalProject(
