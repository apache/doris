...
public class CastTest {
    ...
    public void testTimeStampNsCastNullability() {
        ...
        Assertions.assertFalse(Cast.castNullable(false, TimeV2Type.MAX, TimeStampNsType.INSTANCE));
        Assertions.assertFalse(Cast.castNullable(false, TimeStampNsType.INSTANCE, TimeStampNsType.INSTANCE));
        Assertions.assertTrue(Cast.castNullable(false, TimeStampNsType.INSTANCE, DateTimeV2Type.MAX));
    }
