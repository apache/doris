...
public class AlterTest {
    ...
    public void testAlterRemoteStorageTableDataProperties() throws Exception {
        ...
        DataProperty oldDataProperty = new DataProperty(TStorageMedium.SSD, cooldownTimeMs, "remote_s3");
        ...
        DataProperty dataProperty2 = new DataProperty(TStorageMedium.SSD, newCooldownTimeMs, "remote_s3");
        for (Partition partition : partitionList) {
        ...
        DataProperty dataProperty4 = new DataProperty(TStorageMedium.HDD, DataProperty.MAX_COOLDOWN_TIME_MS, "remote_s3");
        for (Partition partition : partitionList) {
