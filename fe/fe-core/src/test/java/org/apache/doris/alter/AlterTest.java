...
public class AlterTest {
    ...
    public void testBatchUpdatePartitionProperties() throws Exception {
        ...
        DataProperty oldDataProperty = new DataProperty(TStorageMedium.SSD, coolDownTimeMs, "", TStorageMedium.S3);
        ...
        alterTable(stmt, false);
        DataProperty newDataProperty = new DataProperty(TStorageMedium.HDD, DataProperty.MAX_COOLDOWN_TIME_MS, "", TStorageMedium.S3);
        for (Partition partition : partitionList) {
