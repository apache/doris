...
public class SelectStmtTest {
    ...
    public void testSelectTablet() throws Exception {
        ...
        Set<Long> sampleTabletIds = planner.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
    ...
    public void testSelectSampleTable() throws Exception {
        ...
        Set<Long> sampleTabletIds1 = planner1.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds2 = planner2.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds3 = planner3.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds4 = planner4.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds5 = planner5.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds6 = planner6.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds7 = planner7.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds8 = planner8.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds9 = planner9.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds10 = planner10.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds11 = planner11.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds12 = planner12.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds13 = planner13.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds14 = planner14.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds15 = planner15.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
        ...
        Set<Long> sampleTabletIds16 = planner16.getScanNodes().get(0).getTupleDesc().getSampleTabletIds();
