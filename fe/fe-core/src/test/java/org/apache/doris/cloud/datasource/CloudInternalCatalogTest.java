...
public class CloudInternalCatalogTest {
    ...
    @Test
    public void testDirectRowTtlSchemaForCreateAndRestore() throws Exception {
        ...
        Assertions.assertFalse(ordinarySchema.hasRowTtlTimeZoneOffsetSeconds());
    ...
    private OlapFile.TabletMetaCloudPB createTabletMeta(Tablet tablet) throws Exception {
        return new CloudInternalCatalog().createTabletMetaBuilder(
                ...
                "", false, false,
                "table", 0L, -1L, Optional.empty(), false, false, false, 17, null, "size_based",
