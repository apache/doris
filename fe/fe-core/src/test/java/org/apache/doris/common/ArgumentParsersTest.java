...
class ArgumentParsersTest {
        ...
        void testNonEmptyString() {
                ...
                NullPointerException exception1 = Assertions.assertThrows(NullPointerException.class,
                                () -> parser.parse(null));
                Assertions.assertTrue(exception1.getMessage().contains("testParam cannot be null"));
        ...
        void testStringLength() {
                ...
                // Test null
                NullPointerException exception3 = Assertions.assertThrows(NullPointerException.class,
                                () -> parser.parse(null));
        ...
        void testStringChoiceIgnoreCase() {
                ...
                Assertions.assertTrue(
                                exception1.getMessage().contains(
        ...
        void testPositiveInt() {
                ...
                Assertions.assertEquals(Integer.valueOf(Integer.MAX_VALUE),
                                parser.parse(String.valueOf(Integer.MAX_VALUE)));
        ...
        void testDoubleRange() {
                ...
                IllegalArgumentException exception1 = Assertions.assertThrows(IllegalArgumentException.class,
                                () -> parser.parse("-0.1"));
                Assertions.assertTrue(exception1.getMessage().contains("percentage must be between 0.00 and 100.00"));

                IllegalArgumentException exception2 = Assertions.assertThrows(IllegalArgumentException.class,
                                () -> parser.parse("100.1"));
                Assertions.assertTrue(exception2.getMessage().contains("percentage must be between 0.00 and 100.00"));
        ...
        void testIntegerBoundaryValues() {
                ArgumentParser<Integer> parser = ArgumentParsers.intRange("value", Integer.MIN_VALUE,
                                Integer.MAX_VALUE);

                Assertions.assertEquals(Integer.valueOf(Integer.MIN_VALUE),
                                parser.parse(String.valueOf(Integer.MIN_VALUE)));
                Assertions.assertEquals(Integer.valueOf(Integer.MAX_VALUE),
                                parser.parse(String.valueOf(Integer.MAX_VALUE)));
        }
        ...
        void testDoubleBoundaryValues() {
                ArgumentParser<Double> parser = ArgumentParsers.doubleRange("value", -Double.MAX_VALUE,
                                Double.MAX_VALUE);

                Assertions.assertEquals(Double.valueOf(-Double.MAX_VALUE),
        ...
        void testDoubleSpecialValues() {
                ...
                // Test NaN
                Assertions.assertEquals(Double.NaN, parser.parse("NaN"));
        }
