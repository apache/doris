...
public class PlanEqualsTest {
    ...
    public void testLogicalJoin(@Mocked Plan left, @Mocked Plan right) {
        ...
        LogicalJoin innerJoin = new LogicalJoin(JoinType.INNER_JOIN, Optional.of(condition), JoinHint.NONE, left,
                right);
        ...
        LogicalJoin innerJoin1 = new LogicalJoin(JoinType.INNER_JOIN, Optional.of(condition1), JoinHint.NONE, left,
                right);
        ...
        LogicalJoin innerJoin2 = new LogicalJoin(JoinType.INNER_JOIN, Optional.of(condition2), JoinHint.NONE, left,
                right);
    ...
    public void testPhysicalJoin(@Mocked Plan left, @Mocked Plan right, @Mocked LogicalProperties logicalProperties) {
        ...
        PhysicalHashJoin innerJoin = new PhysicalHashJoin(JoinType.INNER_JOIN, Optional.of(expression), JoinHint.NONE,
