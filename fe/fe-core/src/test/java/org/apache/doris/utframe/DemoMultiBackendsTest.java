...
public class DemoMultiBackendsTest {
    ...
    public void testCreateDbAndTable() throws Exception {
        ...
        Assert.assertEquals("{\"location\" : \"default\"}",
                result.getRows().get(0).get(backendsTitleNames.size() - 12));
        Assert.assertEquals(
                ...
                result.getRows().get(0).get(backendsTitleNames.size() - 9));
        Assert.assertEquals("0", result.getRows().get(0).get(backendsTitleNames.size() - 8));
