...
public class DemoMultiBackendsTest {
    ...
    public void testCreateDbAndTable() throws Exception {
        ...
        Assert.assertEquals("0", result.getRows().get(0).get(BackendsProcDir.TITLE_NAMES.size() - 3));
        Assert.assertEquals(Tag.VALUE_MIX, result.getRows().get(0).get(BackendsProcDir.TITLE_NAMES.size() - 2));
    }
