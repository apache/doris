...
class DateTruncRangeDetectorTest {
    ...
    void testCoversWholeMonth_DateTimeLiteral_ShouldNotMatch() {
        // DateTimeLiteral with midnight times looks like a whole month by year/month/day,
        // but dt <= '2025-01-31 00:00:00' does not cover the full day of Jan 31.
        // The detection should exclude DateTimeLiteral at the caller level.
        // Here we verify that DateTimeLiteral is a subclass of DateLiteral (the reason filtering is needed).
