...
public class OlapQueryCacheTest {
    ...
    private OlapTable createProfileTable() {
        ...
        Deencapsulation.setField(table, "baseIndexId", 20001);
    ...
    private View createEventView1() {
        ...
        view.setInlineViewDefWithSqlMode(originStmt, 0L, Maps.newHashMap());
    ...
    public void testCacheModeNone() throws Exception {
        StatementBase parseStmt = parseSqlByNereids("select @@version_comment limit 1");
