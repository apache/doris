...
public class ClusterLoadStatisticsTest {
    ...
    public void setUp() {
        ...
        invertedIndex.addTablet(50000, new TabletMeta(1, 2, 3, 4, 5, TStorageMedium.HDD, -1, -1));
        ...
        invertedIndex.addTablet(60000, new TabletMeta(1, 2, 3, 4, 5, TStorageMedium.HDD, -1, -1));
        ...
        invertedIndex.addTablet(70000, new TabletMeta(1, 2, 3, 4, 5, TStorageMedium.HDD, -1, -1));
