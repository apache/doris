...
public class RewriteTopDownJobTest implements Plans {
    ...
    public void testSimplestScene() throws AnalysisException {
        ...
        Assertions.assertEquals(rootGroup.getLogicalProperties().getOutput().size(), 1);
        Assertions.assertEquals(rootGroup.getLogicalProperties().getOutput().get(0).getName(), "name");
        Assertions.assertEquals(rootGroup.getLogicalProperties().getOutput().get(0).getDataType(), StringType.INSTANCE);
        ...
        Assertions.assertEquals(leafGroup.getLogicalProperties().getOutput().size(), 2);
        Assertions.assertEquals(leafGroup.getLogicalProperties().getOutput().get(0).getName(), "id");
        Assertions.assertEquals(leafGroup.getLogicalProperties().getOutput().get(0).getDataType(), IntegerType.INSTANCE);
        Assertions.assertEquals(leafGroup.getLogicalProperties().getOutput().get(1).getName(), "name");
        Assertions.assertEquals(leafGroup.getLogicalProperties().getOutput().get(1).getDataType(), StringType.INSTANCE);
