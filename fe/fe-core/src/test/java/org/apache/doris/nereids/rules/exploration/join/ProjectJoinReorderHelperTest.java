...
class ProjectJoinReorderHelperTest {
    ...
    @Test
    void removeStandalonePushDownRulesFromClassicReorder() {
    ...
    void pushComplexExpressionsToBothInputsAndRestoreConditionSlots() {
        ...
        LogicalProject<LogicalJoin<Plan, Plan>> normalized
                = ProjectJoinReorderHelper.normalize(project).orElseThrow(AssertionError::new);
    ...
    void rejectHyperEdgeProject() {
        ...
        Assertions.assertFalse(ProjectJoinReorderHelper.normalize(project).isPresent());
    }
    ...
    void respectOuterJoinNullableSides() {
        ...
        LogicalProject<LogicalJoin<Plan, Plan>> normalized
                = ProjectJoinReorderHelper.normalize(leftOnly).orElseThrow(AssertionError::new);
        ...
        Assertions.assertFalse(ProjectJoinReorderHelper.normalize(leftAndNullableRight).isPresent());
        ...
        Assertions.assertFalse(ProjectJoinReorderHelper.normalize(nullableLeft).isPresent());
        ...
        Assertions.assertFalse(ProjectJoinReorderHelper.normalize(fullOuterProject).isPresent());
    }
    ...
    void pushLeftSemiProjectAndRejectMarkJoin() {
        ...
        Assertions.assertFalse(ProjectJoinReorderHelper.normalize(markProject).isPresent());
    }
