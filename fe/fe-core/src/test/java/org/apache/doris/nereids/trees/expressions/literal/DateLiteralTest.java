    ...
    void testTimeStampNsseconds() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new DateTimeV2Literal(
                        TimeStampNsType.INSTANCE, "1970-01-01 00:00:00.123456789"));
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> new DateTimeV2Literal(
                        TimeStampNsType.INSTANCE, 1970, 1, 1, 0, 0, 0, 123456789));
        ...
        for (String value : new String[] {
            ...
            Assertions.assertFalse(inferredType instanceof TimeStampNsType);
        }
