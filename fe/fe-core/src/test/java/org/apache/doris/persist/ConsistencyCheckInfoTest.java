...
public class ConsistencyCheckInfoTest {
    ...
    public void testSerialization() throws IOException, AnalysisException {
        ...
        Assert.assertEquals(consistencyCheckInfo1.getTableId(), consistencyCheckInfo2.getTableId());
        Assert.assertEquals(consistencyCheckInfo1.getPartitionId(), consistencyCheckInfo2.getPartitionId());
