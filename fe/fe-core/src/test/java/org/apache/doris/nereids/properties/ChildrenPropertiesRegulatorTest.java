...
public class ChildrenPropertiesRegulatorTest {
    ...
    @Test
    public void testOverlappingEquivalentActualKeysCountAsOneDimension() {
        PhysicalProperties result = adjustParentShuffleReuse(1000, 3, false, true);
    ...
    private PhysicalProperties adjustParentShuffleReuse(
        ...
        Statistics inputStatistics = new StatisticsBuilder()
                ...
                .putColumnStatistics(key2, new ColumnStatisticBuilder(1_000_000_000)
                        ...
                        .setHotValues(Maps.newHashMap())
                        .build())
                .putColumnStatistics(equivalentKey1, new ColumnStatisticBuilder(1_000_000_000)
                        .setNdv(equivalentKeyNdv)
                        .setHotValues(Maps.newHashMap())
                        .build())
                .putColumnStatistics(equivalentKey2, new ColumnStatisticBuilder(1_000_000_000)
                        .setNdv(equivalentKeyNdv)
                        .setHotValues(Maps.newHashMap())
                        .build())
                .build();
        ...
        List<ExprId> parentRequiredKeys = Lists.newArrayList(key1.getExprId(), key2.getExprId());
        if (parentRequiresAllGroupByKeys) {
        ...
        try (MockedStatic<CostCalculator> mockedCostCalculator = Mockito.mockStatic(CostCalculator.class)) {
            ...
            return regulator.adjustChildrenProperties().get(0).get(0);
        }
    }
