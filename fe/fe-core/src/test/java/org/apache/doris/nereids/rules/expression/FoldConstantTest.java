...
class FoldConstantTest extends ExpressionRewriteTestHelper {
    ...
    void testleFoldNumeric() {
        ...
        Assertions.assertEquals(new NullLiteral(DoubleType.INSTANCE), rewritten);
        log = new Log(new DoubleLiteral(10d), new DoubleLiteral(Double.POSITIVE_INFINITY));
        rewritten = executor.rewrite(log, context);
        Assertions.assertEquals(new DoubleLiteral(Double.POSITIVE_INFINITY), rewritten);
        ...
        rewritten = executor.rewrite(log10, context);
        Assertions.assertEquals(new NullLiteral(DoubleType.INSTANCE), rewritten);
        Dlog10 dlog10 = new Dlog10(new DoubleLiteral(Double.POSITIVE_INFINITY));
        ...
        rewritten = executor.rewrite(power, context);
        Assertions.assertEquals(new DoubleLiteral(0d), rewritten);
        power = new Power(new DoubleLiteral(1.1), new DoubleLiteral(Double.POSITIVE_INFINITY));
        rewritten = executor.rewrite(power, context);
        Assertions.assertEquals(new DoubleLiteral(Double.POSITIVE_INFINITY), rewritten);
        power = new Power(new DoubleLiteral(-1d), new DoubleLiteral(Double.POSITIVE_INFINITY));
        rewritten = executor.rewrite(power, context);
        Assertions.assertEquals(power, rewritten);
        power = new Power(new DoubleLiteral(-1d), new DoubleLiteral(Double.NaN));
        rewritten = executor.rewrite(power, context);
        Assertions.assertEquals(power, rewritten);
    ...
    void testDateTrunc() {
        ...
        String[] answer = {
                "'2001-01-01 00:00:00'", "'2001-01-01 00:00:00'", "'2001-12-01 00:00:00'",
                "'2001-12-01 00:00:00'", "'2001-12-31 00:00:00'", "'2001-12-31 00:00:00'",
                "'2001-12-31 01:00:00'", "'2001-12-31 01:00:00'", "'2001-12-31 01:01:00'",
                "'2001-12-31 01:01:00'", "'2001-12-31 01:01:01'", "'2001-12-31 01:01:01'",
