...
public class JdbcResourceTest {
    ...
    public void testJdbcResourceCreateWithDefaultProperties(@Mocked Env env,
        ...
        CreateResourceInfo createResourceInfo = new CreateResourceInfo(true, false, "jdbc_resource_pg_14", jdbcProperties);
        createResourceInfo.validate();
        resourceMgr.createResource(new CreateResourceCommand(createResourceInfo));
