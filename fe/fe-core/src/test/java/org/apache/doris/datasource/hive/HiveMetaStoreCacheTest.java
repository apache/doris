...
public class HiveMetaStoreCacheTest {
    ...
    private void putCache(
        ...
        HiveMetaStoreCache.FileCacheKey fileCacheKey1 = new HiveMetaStoreCache.FileCacheKey(fileId, tbName, "",
                new ArrayList<>());
        HiveMetaStoreCache.FileCacheKey fileCacheKey2 = HiveMetaStoreCache.FileCacheKey.createDummyCacheKey(fileId,
                tbName, "");
