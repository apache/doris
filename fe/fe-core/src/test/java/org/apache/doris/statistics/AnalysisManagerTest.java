...
public class AnalysisManagerTest {
    ...
    public void testBuildAndAssignJob2(@Injectable OlapAnalysisTask analysisTask) throws Exception {
        AnalysisInfo analysisInfo = new AnalysisInfoBuilder().setColToPartitions(new HashMap<>())
                ...
                .build();
        analysisTask.info = analysisInfo;
        new MockUp<StatisticsUtil>() {
    ...
    public void testSystemJobStartTime() {
        ...
        analysisManager.systemJobInfoMap.put(jobInfo.jobId, jobInfo);
        ...
        ot1.job = new AnalysisJob(jobInfo, Arrays.asList(ot2, ot1));
        ...
        jobInfo.state = AnalysisState.PENDING;
        analysisManager.systemJobInfoMap.put(jobInfo.jobId, jobInfo);
        Assertions.assertTrue(jobInfo.startTime >= 0);
    }
