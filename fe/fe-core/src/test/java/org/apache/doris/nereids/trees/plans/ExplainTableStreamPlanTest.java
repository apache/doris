...
public class ExplainTableStreamPlanTest extends TestWithFeService {
    ...
    public void testIncrTimestampRangePropagatesToScanRangeTso() throws Exception {
        ...
        long expectedStartTso = TSOTimestamp.composePhysicalTimestamp(OlapScanNode.parseChangeTimestamp(startTs)) + 1;
        long expectedEndTso = TSOTimestamp.composePhysicalTimestamp(OlapScanNode.parseChangeTimestamp(endTs)) + 1;
