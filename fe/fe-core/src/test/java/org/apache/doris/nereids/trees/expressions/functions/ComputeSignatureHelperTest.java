...
public class ComputeSignatureHelperTest {
    ...
    // FunctionSignature signature = FunctionSignature.ret(BooleanType.INSTANCE)
    // .args(TimeV2Type.SYSTEM_DEFAULT, TimeV2Type.SYSTEM_DEFAULT, TimeV2Type.SYSTEM_DEFAULT);
    // List<Expression> arguments = Lists.newArrayList(
    // new TimeV2Literal("12:34:56.12"),
    // new TimeV2Literal("12:34:56.123"),
    // new TimeV2Literal("12:34:56.1"));
    // signature = ComputeSignatureHelper.computePrecision(new FakeComputeSignature(), signature, arguments);
    ...
    // Assertions.assertEquals(TimeV2Type.of(3), signature.returnType);
    // }
    ...
    // .args(DateTimeV2Type.SYSTEM_DEFAULT, TimeV2Type.SYSTEM_DEFAULT, DateTimeV2Type.SYSTEM_DEFAULT);
    // List<Expression> arguments = Lists.newArrayList(
    // new DateTimeV2Literal("2020-02-02 00:00:00.12"),
    // new TimeV2Literal("12:34:56.123"),
    // new DateTimeV2Literal("2020-02-02 00:00:00.1"));
    // signature = ComputeSignatureHelper.computePrecision(new FakeComputeSignature(), signature, arguments);
    ...
    // FunctionSignature signature = FunctionSignature.ret(ArrayType.of(TimeV2Type.SYSTEM_DEFAULT))
    // .args(ArrayType.of(TimeV2Type.SYSTEM_DEFAULT),
    // MapType.of(IntegerType.INSTANCE, TimeV2Type.SYSTEM_DEFAULT),
    ...
    // FunctionSignature signature = FunctionSignature.ret(MapType.of(DateTimeV2Type.SYSTEM_DEFAULT,
    ...
    // ArrayType.of(MapType.of(TimeV2Type.SYSTEM_DEFAULT, DateTimeV2Type.SYSTEM_DEFAULT)),
    // DateTimeV2Type.SYSTEM_DEFAULT);
    ...
    // new MapLiteral(
    // Lists.newArrayList(new DateTimeV2Literal("2020-02-02 00:00:00.12")),
    // Lists.newArrayList(new ArrayLiteral(Lists.newArrayList(new TimeV2Literal("12:34:56.1"))))
    // ),
