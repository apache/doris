...
public class HavingClauseTest extends AnalyzeCheckTestBase implements PatternMatchSupported {
    ...
    public void testHavingGroupBySlot() throws Exception {
        ...
        Alias value = new Alias(new ExprId(1), a1, "value");
        PlanChecker.from(connectContext).analyze(sql)
    ...
    public void testHavingAggregateFunction() throws Exception {
        ...
        a2 = new SlotReference(
                new ExprId(4), "a2", TinyIntType.INSTANCE, true,
                ImmutableList.of("default_cluster:test_having", "t1")
        );
        Alias value = new Alias(new ExprId(1), new Sum(a2), "value");
        PlanChecker.from(connectContext).analyze(sql)
                .matchesFromRoot(
                    logicalProject(
                        logicalFilter(
    ...
    void testComplexQuery() throws Exception {
        ...
        SlotReference pk = new SlotReference(
                new ExprId(2), "pk", TinyIntType.INSTANCE, true,
                ImmutableList.of("default_cluster:test_having", "t1")
        );
        SlotReference a1 = new SlotReference(
                new ExprId(3), "a1", TinyIntType.INSTANCE, true,
        ...
        Alias pk1 = new Alias(new ExprId(8), new Add(pk, Literal.of((byte) 1)), "(pk + 1)");
        Alias pk11 = new Alias(new ExprId(9), new Add(new Add(pk, Literal.of((byte) 1)), Literal.of((short) 1)), "((pk + 1) + 1)");
        Alias pk2 = new Alias(new ExprId(10), new Add(pk, Literal.of((byte) 2)), "(pk + 2)");
        Alias sumA1 = new Alias(new ExprId(11), new Sum(a1), "SUM(a1)");
        Alias countA11 = new Alias(new ExprId(12), new Add(new Count(a1, false), Literal.of(1L)), "(COUNT(a1) + 1)");
        Alias sumA1A2 = new Alias(new ExprId(13), new Sum(new Add(a1, a2)), "SUM((a1 + a2))");
        Alias v1 = new Alias(new ExprId(1), new Count(a2, false), "v1");
        PlanChecker.from(connectContext).analyze(sql)
                .matchesFromRoot(
                    logicalProject(
                        logicalFilter(
