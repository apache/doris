...
//import org.apache.doris.nereids.rules.rewrite.DisassembleDistinctAggregate;
...
//                .applyTopDown(new AggregateStrategies())
//                .printlnTree()
//                .matchesFromRoot(
//                        logicalAggregate(
//                                logicalAggregate()
...
//
//        PlanChecker.from(MemoTestUtils.createConnectContext(), root)
//                .applyTopDown(new DisassembleDistinctAggregate())
//                .matchesFromRoot(
//                        logicalAggregate(
//                                logicalAggregate(
//                                        logicalAggregate(
