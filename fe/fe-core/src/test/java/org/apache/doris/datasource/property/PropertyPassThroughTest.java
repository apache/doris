...
public class PropertyPassThroughTest extends TestWithFeService  {
    ...
    public void testS3TVFPropertiesPassThrough() throws Exception {
        ...
        Assertions.assertFalse(s3Tvf.getBrokerDesc().getProperties().containsKey("fs.s3a.list.version"));
        Assertions.assertFalse(s3Tvf.getBrokerDesc().getProperties().containsKey("test_property"));
    }
    ...
    public void testHdfsTVFPropertiesPassThrough() throws Exception {
        ...
        Assertions.assertFalse(hdfsTvf.getBrokerDesc().getProperties().containsKey("test_property"));
    }
}
