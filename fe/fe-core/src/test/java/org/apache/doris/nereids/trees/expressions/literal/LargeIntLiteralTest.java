...
public class LargeIntLiteralTest {
    ...
    void testUncheckedCastTo() {
        ...
        Assertions.assertThrows(CastException.class, () -> finalD.uncheckedCastTo(TinyIntType.INSTANCE));
        ...
        Assertions.assertThrows(CastException.class, () -> finalD1.uncheckedCastTo(BigIntType.INSTANCE));
    }
}
