...
public class OlapAnalysisTaskTest {
    ...
    public void testGetSampleCollectInfo() {
        ...
        final Pair<List<Long>, Long>[] sampleTablets = new Pair[] {Pair.of(Lists.newArrayList(1L, 2L), 100L)};
    ...
    public void testDoSampleAlwaysCollectsHotValue() throws Exception {
        ...
        Mockito.doReturn(new OlapAnalysisTask.SampleCollectInfo(AnalyzeSampleAlgorithm.LINEAR, null))
                .when(task).getSampleCollectInfo(ArgumentMatchers.anyLong());
        task.doSample();
        Mockito.doReturn(new OlapAnalysisTask.SampleCollectInfo(AnalyzeSampleAlgorithm.DUJ1, null))
                .when(task).getSampleCollectInfo(ArgumentMatchers.anyLong());
        task.doSample();
    }
