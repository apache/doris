...
public class CatalogOperationTest {
    ...
    private static void createResource(String sql) throws Exception {
        CreateResourceStmt createResourceStmt =
            (CreateResourceStmt) UtFrameUtils.parseAndAnalyzeStmt(sql, connectContext);
    ...
    public void testRenameTable() throws Exception {
        ...
        AlterTableStmt alterTableStmt =
            (AlterTableStmt) UtFrameUtils.parseAndAnalyzeStmt(renameTblStmt, connectContext);
