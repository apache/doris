...
public class OrcFileFormatPropertiesTest {
    ...
    public void testAnalyzeFileFormatProperties() {
        ...
        Assertions.assertEquals(TFileCompressType.ZLIB, orcFileFormatProperties.getOrcCompressionType());
    }
    ...
    public void testSupportedCompressionTypes() {
        ...
        orcFileFormatProperties.analyzeFileFormatProperties(properties, true);
        Assertions.assertEquals(TFileCompressType.PLAIN, orcFileFormatProperties.getOrcCompressionType());

        properties.put("compress_type", "snappy");
        orcFileFormatProperties.analyzeFileFormatProperties(properties, true);
        Assertions.assertEquals(TFileCompressType.SNAPPYBLOCK, orcFileFormatProperties.getOrcCompressionType());
        ...
        orcFileFormatProperties.analyzeFileFormatProperties(properties, true);
        Assertions.assertEquals(TFileCompressType.ZSTD, orcFileFormatProperties.getOrcCompressionType());
    }
    ...
    public void testFullTResultFileSinkOptions() {
        ...
        Assertions.assertEquals(orcFileFormatProperties.getOrcCompressionType(), sinkOptions.getOrcCompressionType());
        Assertions.assertEquals(1, sinkOptions.getOrcWriterVersion());
    }
