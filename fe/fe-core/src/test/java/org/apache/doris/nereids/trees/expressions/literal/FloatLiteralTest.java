...
public class FloatLiteralTest {
    ...
    public void testFloatGetStringValue() {
        ...
        Assertions.assertEquals("0.001", ((StringLiteral) (new FloatLiteral(0.001f)
        ...
        Assertions.assertEquals("1234567.1", ((StringLiteral) (new FloatLiteral(1234567.12345f).uncheckedCastTo(StringType.INSTANCE))).getValue());
        ...
        Assertions.assertEquals("1.2345679e-15", ((StringLiteral) (new FloatLiteral(0.000000000000001234567890123456f).uncheckedCastTo(StringType.INSTANCE))).getValue());
        ...
        Assertions.assertEquals("-123.456", ((StringLiteral) (new FloatLiteral(-123.456000f).uncheckedCastTo(StringType.INSTANCE))).getValue());
        Assertions.assertEquals("-123", ((StringLiteral) (new FloatLiteral(-123.000f).uncheckedCastTo(StringType.INSTANCE))).getValue());
        Assertions.assertEquals("1e+23", ((StringLiteral) (new FloatLiteral(1e23f)
                .uncheckedCastTo(StringType.INSTANCE))).getValue());
        Assertions.assertEquals("1e-45", ((StringLiteral) (new FloatLiteral(Float.MIN_VALUE)
                .uncheckedCastTo(StringType.INSTANCE))).getValue());
    }
}
