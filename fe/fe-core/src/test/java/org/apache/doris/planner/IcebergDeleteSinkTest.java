...
public class IcebergDeleteSinkTest {
    ...
    public void testBindDataSinkIncludesRewritableDeleteFileSetsForV3() throws Exception {
        ...
        TIcebergDeleteSink thriftSink = sink.tDataSink.getIcebergDeleteSink();
        ...
        Assertions.assertEquals("file:///tmp/data.parquet",
                thriftSink.getRewritableDeleteFileSets().get(0).getReferencedDataFilePath());
    }
