...
class TimestampTzLiteralTest {
    ...
    @Test
    void testRoundMicroSecondWithExplicitTimeZone() {
        TimestampTzLiteral literal = new TimestampTzLiteral(TimeStampTzType.of(5),
                "9999-12-31 23:59:59.999999+08:00");

        Assertions.assertEquals(9999, literal.year);
        Assertions.assertEquals(12, literal.month);
        Assertions.assertEquals(31, literal.day);
        Assertions.assertEquals(16, literal.hour);
        Assertions.assertEquals(0, literal.minute);
        Assertions.assertEquals(0, literal.second);
        Assertions.assertEquals(0, literal.microSecond);
        Assertions.assertEquals("9999-12-31 16:00:00.00000+00:00", literal.getStringValue());
    }
