...
class TimestampTzLiteralTest {
    ...
    void testConstructorsAndParsing() {
        ...
        Assertions.assertEquals(TimeStampTzType.of(6),
                TimeStampTzType.MAX.scaleTypeForType(DateTimeV2Type.of(9)));
    ...
    @Test
    void testCastBetweenTimestampTzAndDateTimeV2Nano() {
        ConnectContext context = new ConnectContext();
        ...
        try {
            ...
            nano = (DateTimeV2Literal) timestampTz.uncheckedCastTo(DateTimeV2Type.of(9));
            ...
            Assertions.assertThrows(CastException.class,
                    () -> belowLowerBound.uncheckedCastTo(DateTimeV2Type.of(9)));
            Assertions.assertThrows(CastException.class,
                    () -> aboveUpperBound.uncheckedCastTo(DateTimeV2Type.of(9)));
        } finally {
            ConnectContext.remove();
        }
    }
