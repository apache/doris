...
public class CreateTableLikeTest {
    ...
    private static void checkCreateOlapTableLike(String createTableSql, String createTableLikeSql,
                                                 String newDbName, String existedDbName,
                                                 String newTblName, String existedTblName, int rollupSize)
        throws Exception {
    ...
    public void testNormal() throws Exception {
        ...
        checkCreateOlapTableLike(createTableWithRollup, createTableLikeWithRollupSql1_1, newDbName10, existedDbName10,
            newTblName10_1, existedTblName10, 2);
        checkCreateOlapTableLike(createTableWithRollup, createTableLikeWithRollupSql1_2, newDbName10, existedDbName10,
            newTblName10_2, existedTblName10, 4);

        String createTableLikeWithRollupSql2_1 =
            "create table test2.table_like_rollup like test.table_with_rollup with rollup (r1,r2)";
        String createTableLikeWithRollupSql2_2 =
        ...
        checkCreateOlapTableLike(createTableWithRollup, createTableLikeWithRollupSql2_1, newDbName11, existedDbName11,
            newTblName11_1, existedTblName11, 2);
        checkCreateOlapTableLike(createTableWithRollup, createTableLikeWithRollupSql2_2, newDbName11, existedDbName11,
            newTblName11_2, existedTblName11, 4);
