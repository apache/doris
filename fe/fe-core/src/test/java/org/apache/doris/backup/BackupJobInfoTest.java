...
public class BackupJobInfoTest {
    ...
    public void testActivatedBackupUsesSharedMetaVersion() {
        ...
        try (MockedStatic<Env> envStatic = Mockito.mockStatic(Env.class)) {
            ...
            Assertions.assertEquals(FeMetaVersion.VERSION_ROW_TTL_ACTIVATION, jobInfo.metaVersion);
        }
    }

    @Test
    public void testPreActivationRowTtlBackupIsRejected() throws Exception {
        Assertions.assertThrows(DdlException.class, () -> BackupHandler.validateRowTtlBackupVersion(
