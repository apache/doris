...
public class LikeTest {
    ...
    @Test
    public void testLikeWithoutEscape() {
        ...
        Assertions.assertEquals(like.toString(), "(name like %\\_\\%)");
    }
    ...
    public void testLikeWithEscape() {
        ...
        Like like = new Like(left, right, escape);
        Assertions.assertEquals(like.toString(), "(name like %|_|% escape |)");
    }
}
