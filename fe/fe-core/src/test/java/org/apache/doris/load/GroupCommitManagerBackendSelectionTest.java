...
public class GroupCommitManagerBackendSelectionTest {
    ...
    private static final class CountingLoadSelectionPolicy implements BackendSelectionProvider {
    ...
    private static final class NullRejectingLoadSelectionPolicy implements BackendSelectionProvider {
        @Override
        public boolean hasLoadSelectionPreference(BackendSelection.SelectionHint decision) {
            throw new AssertionError("null selection hints must be handled by BackendSelectionManager");
        }
    }

    private static final class RequiredLoadSelectionPolicy implements BackendSelectionProvider {
        private final BackendSelection.SelectionHint decision =
