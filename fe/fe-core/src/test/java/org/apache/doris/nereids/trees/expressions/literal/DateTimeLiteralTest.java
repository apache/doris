...
class DateTimeLiteralTest {
    ...
    void testDateTimeV1UncheckedCastTo() {
        ...
        Assertions.assertTrue(expression instanceof DateV2Literal);
        ...
        Assertions.assertEquals(25, dt2.minute);
        Assertions.assertEquals(59, dt2.second);
        Assertions.assertEquals(999, dt2.microSecond);

        try {
            v1 = new DateTimeLiteral(DateTimeType.INSTANCE, 9999, 12, 31, 23, 59, 59, 999999);
            v1.uncheckedCastTo(DateTimeV2Type.of(3));
            Assertions.fail();
        } catch (Exception e) {
    ...
    void testDateTimeV2UncheckedCastTo() {
        ...
        Assertions.assertTrue(expression instanceof DateTimeLiteral);
