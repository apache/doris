...
public class RowTtlFeatureGateTest {
    @Test
    public void testConstantQueryRemainsAvailableWithoutBackends() throws Exception {
    ...
    @Test
    public void testMissingBackendCapabilityIsRejected() throws Exception {
        Env env = Mockito.mock(Env.class);
    ...
    @Test
    public void testOldHeartbeatIsIncompatibleWithoutFeatureActivation() {
        Env env = Mockito.mock(Env.class);
