...
public class AlterComputeGroupCommandTest {
    ...
    public void testValidateNonCloudMode() throws Exception {
        ...
        properties.put("balance_type", "warmup_cache");
    ...
    public void testValidateSuccess() throws Exception {
        ...
        new MockUp<ComputeGroup>() {
            @Mock
            void checkProperties(Map<String, String> properties) throws DdlException {
                if (properties == null || properties.isEmpty()) {
                    return;
                }
                String timeout = properties.get("balance_warm_up_task_timeout");
                if (timeout != null) {
                    try {
        ...
        Map<String, String> invalidProperties = Maps.newHashMap();
        invalidProperties.put("balance_type", "warmup_cache");
        invalidProperties.put("balance_warm_up_task_timeout", "-1");
        AlterComputeGroupCommand invalidCommand = new AlterComputeGroupCommand("test_group", invalidProperties);
        Assertions.assertThrows(UserException.class, () -> invalidCommand.validate(connectContext));
    }
}
