...
public class S3ResourcePersistParityTest {
    ...
    public void testStdKeysInputPersistedMapExact() throws DdlException {
        ...
        // Dual-namespace write: the endpoint gets the default https:// prefix under BOTH keys.
        golden.put("s3.endpoint", "https://s3.us-east-1.amazonaws.com");
        golden.put("AWS_ENDPOINT", "https://s3.us-east-1.amazonaws.com");
    ...
    public void testLegacyAwsKeysInputPersistedMapExact() throws DdlException {
        ...
        // the endpoint then gets the default https:// prefix under both keys.
        golden.put("AWS_ENDPOINT", "https://s3.us-east-1.amazonaws.com");
        golden.put("s3.endpoint", "https://s3.us-east-1.amazonaws.com");
        golden.put("s3.region", "us-east-1");
    ...
    public void testVaultAndValidityConstantsFrozen() {
        ...
        // frozen literal (formerly asserted against the deleted legacy S3Properties constant)
