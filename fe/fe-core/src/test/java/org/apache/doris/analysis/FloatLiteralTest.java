...
public class FloatLiteralTest {
    ...
    public void testDoubleGetStringValue() {
        ...
        Assertions.assertEquals("1.2345678901234568e+16", new FloatLiteral(12345678901234567.12345, Type.DOUBLE).getStringValueForQuery(null));
        Assertions.assertEquals("0.00012345678901234567", new FloatLiteral(0.0001234567890123456789, Type.DOUBLE).getStringValueForQuery(null));
    ...
    public void testFloatGetStringValue() {
        ...
        Assertions.assertEquals("10000000", new FloatLiteral(1.0E7, Type.FLOAT).getStringValueForQuery(null));
        Assertions.assertEquals("-10000000", new FloatLiteral(-1.0E7, Type.FLOAT).getStringValueForQuery(null));
        ...
        Assertions.assertEquals("3.4028235e+38", new FloatLiteral((double) Float.MAX_VALUE, Type.FLOAT).getStringValueForQuery(null));
        ...
        Assertions.assertEquals("123456.125", new FloatLiteral(123456.12345, Type.FLOAT).getStringValueForQuery(null));
        Assertions.assertEquals("1234567.1", new FloatLiteral(1234567.12345, Type.FLOAT).getStringValueForQuery(null));
        Assertions.assertEquals("12345678", new FloatLiteral(12345678.12345, Type.FLOAT).getStringValueForQuery(null));
        Assertions.assertEquals("0.00012345679", new FloatLiteral(0.0001234567890123456789, Type.FLOAT).getStringValueForQuery(null));
        Assertions.assertEquals("1.2345679e-15", new FloatLiteral(0.000000000000001234567890123456, Type.FLOAT).getStringValueForQuery(null));
