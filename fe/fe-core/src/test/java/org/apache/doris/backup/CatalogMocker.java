...
public class CatalogMocker {
    ...
    public static Database mockDb() throws UserException {
        ...
        DataProperty dataProperty = new DataProperty(TStorageMedium.HDD, TStorageMedium.S3);
        ...
        DataProperty dataPropertyP1 = new DataProperty(TStorageMedium.HDD, TStorageMedium.S3);
        DataProperty dataPropertyP2 = new DataProperty(TStorageMedium.HDD, TStorageMedium.S3);
