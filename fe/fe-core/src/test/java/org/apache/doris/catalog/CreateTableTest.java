...
public class CreateTableTest {
    ...
    public void testDuplicateCreateTable() throws Exception {
        ...
        catalog.getTabletInvertedIndex().getTabletMetaTable().values().forEach(tabletMeta -> {
            tabletMetaSetBeforeCreateFirstTable.add(tabletMeta);
        });
        ...
        Set<Long> tabletIdSetAfterDuplicateCreateTable2 =
            catalog.getTabletInvertedIndex().getBackingReplicaMetaTable().columnKeySet();
        ...
        catalog.getTabletInvertedIndex().getTabletMetaTable().values().forEach(tabletMeta -> {
            tabletIdSetAfterDuplicateCreateTable4.add(tabletMeta);
        });
    ...
    public void testAbnormal() throws DdlException {
        ...
        ExceptionChecker
            .expectThrowsWithMsg(AnalysisException.class,
                "You can only use fixed or less than values to create range partitions",
