...
// from hadoop-common 3.4.2 (sources jar), and MUST stay byte-identical to the
// BE-side copy in fe/be-java-extensions/hadoop-deps (apart from this header
// paragraph). start_fe.sh forces doris-fe.jar to the front of the FE classpath
// exactly so that classes like this one (see also the shadowed
// org.apache.hadoop.hive.metastore.HiveMetaStoreClient) override the vanilla
// jars in fe/lib/, so this class shadows hadoop-common's for the FE JVM.
//
