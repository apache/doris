...
public class TableRef implements ParseNode {
    ...
    public TableRef(TableNameInfo name, String alias) {
        this(name, alias, null);
    }

    public TableRef(TableNameInfo name, String alias, PartitionNames partitionNames) {
        this(name, alias, partitionNames, null);
    }

    public TableRef(TableNameInfo name, String alias, PartitionNames partitionNames, ArrayList<String> commonHints) {
     ...
     */
    public TableRef(TableNameInfo name, String alias, PartitionNames partitionNames, ArrayList<Long> sampleTabletIds,
    ...
    public TableNameInfo getAliasAsName() {
        if (hasExplicitAlias()) {
            return new TableNameInfo(null, null, getUniqueAlias());
        }
        return name;
    }
    ...
    public void setName(TableNameInfo name) {
        this.name = name;
    }
}
