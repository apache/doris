...
public enum JoinType {
    ...
    private static final Map<JoinType, ImmutableSet<JoinType>> assocJoinMatrix
            ...
            .put(CROSS_JOIN, ImmutableSet.of(CROSS_JOIN, INNER_JOIN, LEFT_SEMI_JOIN, LEFT_ANTI_JOIN, LEFT_OUTER_JOIN))
            .put(INNER_JOIN, ImmutableSet.of(CROSS_JOIN, INNER_JOIN, LEFT_SEMI_JOIN, LEFT_ANTI_JOIN, LEFT_OUTER_JOIN))
            .put(RIGHT_SEMI_JOIN, ImmutableSet.of(CROSS_JOIN, INNER_JOIN))
            .put(RIGHT_ANTI_JOIN, ImmutableSet.of(CROSS_JOIN, INNER_JOIN))
            .put(RIGHT_OUTER_JOIN, ImmutableSet.of(CROSS_JOIN, INNER_JOIN))
            .build();
    ...
    private static final Map<JoinType, ImmutableSet<JoinType>> lAssocJoinMatrix
            ...
            .put(INNER_JOIN, ImmutableSet.of(CROSS_JOIN, INNER_JOIN, LEFT_SEMI_JOIN, LEFT_ANTI_JOIN, LEFT_OUTER_JOIN))
            .put(LEFT_SEMI_JOIN,
                    ImmutableSet.of(CROSS_JOIN, INNER_JOIN, LEFT_SEMI_JOIN, LEFT_ANTI_JOIN, LEFT_OUTER_JOIN))
            .put(LEFT_ANTI_JOIN,
                    ImmutableSet.of(CROSS_JOIN, INNER_JOIN, LEFT_SEMI_JOIN, LEFT_ANTI_JOIN, LEFT_OUTER_JOIN))
            .put(LEFT_OUTER_JOIN,
                    ImmutableSet.of(CROSS_JOIN, INNER_JOIN, LEFT_SEMI_JOIN, LEFT_ANTI_JOIN, LEFT_OUTER_JOIN))
    ...
    private static final Map<JoinType, ImmutableSet<JoinType>> rAssocJoinMatrix
            = ImmutableMap.<JoinType, ImmutableSet<JoinType>>builder()
            .put(CROSS_JOIN,
                    ImmutableSet.of(CROSS_JOIN, INNER_JOIN, RIGHT_SEMI_JOIN, RIGHT_ANTI_JOIN, RIGHT_OUTER_JOIN))
            .put(INNER_JOIN,
                    ImmutableSet.of(CROSS_JOIN, INNER_JOIN, RIGHT_SEMI_JOIN, RIGHT_ANTI_JOIN, RIGHT_OUTER_JOIN))
            .put(RIGHT_SEMI_JOIN,
                    ImmutableSet.of(CROSS_JOIN, INNER_JOIN, RIGHT_SEMI_JOIN, RIGHT_ANTI_JOIN, RIGHT_OUTER_JOIN))
