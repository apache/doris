...
/**
 * ScalarFunction 'day_hour_sub'.
 */
public class DayHourSub extends ScalarFunction
    ...
    public DayHourSub(Expression arg0, Expression arg1) {
        super("day_hour_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private DayHourSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public DayHourSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new DayHourSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDayHourSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new DayHourSub(literal, child(1));
    }
