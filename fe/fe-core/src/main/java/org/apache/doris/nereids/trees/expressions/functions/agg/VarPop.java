...
/**
 * AggregateFunction 'var_pop'. This class is generated by GenerateFunction.
 */
public class VarPop extends AggregateFunction
     ...
     * constructor with 1 argument.
     */
    public VarPop(boolean distinct, Expression arg) {
        super("var_pop", distinct, arg);
    }
     ...
     */
    @Override
    public VarPop withDistinctAndChildren(boolean distinct, List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1);
        return new VarPop(distinct, children.get(0));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitVarPop(this, context);
    }
