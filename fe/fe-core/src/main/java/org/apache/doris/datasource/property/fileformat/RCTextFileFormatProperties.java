...
public class RCTextFileFormatProperties extends FileFormatProperties {

    public RCTextFileFormatProperties() {
        super(TFileFormatType.FORMAT_RCTEXT, FileFormatProperties.FORMAT_RCTEXT);
    }
