...
public class RegrCount extends NotNullableAggregateFunction
    ...
    public void checkLegalityBeforeTypeCoercion() {
        ...
        if (!yType.isNumericType() && !yType.isNullType()) {
            throw new AnalysisException("regr_count requires numeric for first parameter: " + toSql());
        }
        if (!xType.isNumericType() && !xType.isNullType()) {
            throw new AnalysisException("regr_count requires numeric for second parameter: " + toSql());
        }
    }
