...
public final class Range
{
            ...
            @JsonProperty("high") Marker high)
    {
        ...
        if (!Utils.isCompatibleType(low.getType(), high.getType())) {
            throw new IllegalArgumentException("Marker types do not match: " + low.getType());
        }
    ...
    {
        if (!isCompatibleType(getType(), range.getType())) {
            throw new IllegalArgumentException("Mismatched Range types:" + getType());
        }
    }
    ...
    private void checkTypeCompatibility(Marker marker)
    {
        if (!isCompatibleType(getType(), marker.getType())) {
            throw new IllegalArgumentException("Marker of %s does not match Range of :" + marker.getType());
        }
    }
