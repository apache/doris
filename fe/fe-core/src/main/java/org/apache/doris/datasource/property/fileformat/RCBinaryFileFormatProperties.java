...
public class RCBinaryFileFormatProperties extends FileFormatProperties {

    public RCBinaryFileFormatProperties() {
        super(TFileFormatType.FORMAT_RCBINARY, FileFormatProperties.FORMAT_RCBINARY);
    }
