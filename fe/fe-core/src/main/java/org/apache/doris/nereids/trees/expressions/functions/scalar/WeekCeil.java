...
/**
 * ScalarFunction 'week_ceil'. This class is generated by GenerateFunction.
 */
public class WeekCeil extends ScalarFunction
    ...
    public Optional<Expression> previousBucketBoundary(Literal value) {
        ...
        return Optional.of(new WeeksSub(value, period.get()));
    }
    ...
    public Expression withConstantArgs(Expression literal) {
        switch (arity()) {
            case 1:
                return new WeekCeil(literal);
            case 2:
                return new WeekCeil(literal, child(1));
            case 3:
                return new WeekCeil(literal, child(1), child(2));
            default:
