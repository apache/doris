...
/**
 * Implementation rule that convert logical OlapTableSink to physical OlapTableSink.
 */
    ...
    public Rule build() {
        return logicalOlapTableSink().thenApply(ctx -> {
            ...
            return new PhysicalOlapTableSink<>(
                    ...
                    sink.getPartitionExprList(),
                    sink.getSyncMvWhereClauses(),
                    sink.getTargetTableSlots(),
                    Optional.empty(),
