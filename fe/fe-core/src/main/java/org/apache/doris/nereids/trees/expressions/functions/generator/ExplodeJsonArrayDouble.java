...
/**
 * explode_json_array_double("[1.1, 2.2, 3.3]"), generate 3 lines include 1.1, 2.2 and 3.3.
 */
public class ExplodeJsonArrayDouble extends TableGeneratingFunction
     ...
     */
    public ExplodeJsonArrayDouble(Expression arg) {
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitExplodeJsonArrayDouble(this, context);
    }
