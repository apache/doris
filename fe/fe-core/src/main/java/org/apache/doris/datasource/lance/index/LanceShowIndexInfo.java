...
/** Immutable SHOW INDEX description with resolved column names and display-safe properties. */
public final class LanceShowIndexInfo {
    private final String name;
    private final List<String> columns;
    private final String indexType;
    private final String properties;

    public LanceShowIndexInfo(String name, List<String> columns,
