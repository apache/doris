...
import org.apache.doris.hplsql.Utils;
...
public class BuiltinFunctions {
    ...
    protected HashMap<String, org.apache.doris.hplsql.functions.FuncCommand> map = new HashMap<>();
    protected HashMap<String, org.apache.doris.hplsql.functions.FuncSpecCommand> specMap = new HashMap<>();
    protected HashMap<String, org.apache.doris.hplsql.functions.FuncSpecCommand> specSqlMap = new HashMap<>();
    ...
    public boolean exec(String name, HplsqlParser.Expr_func_paramsContext ctx) {
        ...
        org.apache.doris.hplsql.functions.FuncCommand func = map.get(name.toUpperCase());
        if (func != null) {
            func.run(ctx);
            return true;
        } else {
    ...
    public void specExec(HplsqlParser.Expr_spec_funcContext ctx) {
        ...
        org.apache.doris.hplsql.functions.FuncSpecCommand func = specMap.get(name);
        if (func != null) {
            func.run(ctx);
    ...
    public void specExecSql(HplsqlParser.Expr_spec_funcContext ctx) {
        ...
        org.apache.doris.hplsql.functions.FuncSpecCommand func = specSqlMap.get(name);
        if (func != null) {
            func.run(ctx);
        } else {
