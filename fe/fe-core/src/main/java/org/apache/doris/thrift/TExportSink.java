            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.broker_addresses = new java.util.ArrayList<org.apache.doris.thrift.TNetworkAddress>(_list52.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNetworkAddress _elem53;
                for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                {
                  _elem53 = new org.apache.doris.thrift.TNetworkAddress();
                  _elem53.read(iprot);
                  struct.broker_addresses.add(_elem53);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map55.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key56;
                @org.apache.thrift.annotation.Nullable java.lang.String _val57;
      ...
      if (struct.broker_addresses != null) {
        if (struct.isSetBrokerAddresses()) {
          oprot.writeFieldBegin(BROKER_ADDRESSES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TNetworkAddress _iter59 : struct.broker_addresses)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetBrokerAddresses()) {
        {
          ...
          for (org.apache.doris.thrift.TNetworkAddress _iter61 : struct.broker_addresses)
          {
            _iter61.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.broker_addresses = new java.util.ArrayList<org.apache.doris.thrift.TNetworkAddress>(_list63.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNetworkAddress _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new org.apache.doris.thrift.TNetworkAddress();
            _elem64.read(iprot);
            struct.broker_addresses.add(_elem64);
          }
        }
        struct.setBrokerAddressesIsSet(true);
      }
