...
public class TLoadTxnCommitRequest implements org.apache.thrift.TBase<TLoadTxnCommitRequest, TLoadTxnCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnCommitRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER_IP,_Fields.COMMIT_INFOS,_Fields.AUTH_CODE,_Fields.TXN_COMMIT_ATTACHMENT,_Fields.THRIFT_RPC_TIMEOUT_MS,_Fields.TOKEN,_Fields.DB_ID};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list252.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem253;
                for (int _i254 = 0; _i254 < _list252.size; ++_i254)
                {
                  _elem253 = new org.apache.doris.thrift.TTabletCommitInfo();
                  _elem253.read(iprot);
                  struct.commitInfos.add(_elem253);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletCommitInfo _iter255 : struct.commitInfos)
            {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletCommitInfo _iter256 : struct.commitInfos)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list257.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem258;
          for (int _i259 = 0; _i259 < _list257.size; ++_i259)
          {
            _elem258 = new org.apache.doris.thrift.TTabletCommitInfo();
            _elem258.read(iprot);
            struct.commitInfos.add(_elem258);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
