...
public class IPv4CIDRToRange extends ScalarFunction
    ...
    static {
        ...
        SIGNATURES = ImmutableList.of(
                FunctionSignature.ret(retType).args(IPv4Type.INSTANCE, TinyIntType.INSTANCE),
                FunctionSignature.ret(retType).args(TinyIntType.INSTANCE, TinyIntType.INSTANCE),
                FunctionSignature.ret(retType).args(SmallIntType.INSTANCE, TinyIntType.INSTANCE),
                FunctionSignature.ret(retType).args(IntegerType.INSTANCE, TinyIntType.INSTANCE),
                FunctionSignature.ret(retType).args(BigIntType.INSTANCE, TinyIntType.INSTANCE));
    }
