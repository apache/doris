 ...
 **/
public class DropIndexPolicyStmt extends DdlStmt implements NotFallbackInParser {
    ...
    public DropIndexPolicyStmt(boolean ifExists, IndexPolicyTypeEnum type, String name) {
