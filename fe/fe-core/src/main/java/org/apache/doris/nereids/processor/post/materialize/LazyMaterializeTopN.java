...
public class LazyMaterializeTopN extends PlanPostProcessor {
     ...
     * -->topn
     * -->scan2
     * when we create materializeNode for the first union child, set
    ...
    public Plan visitPhysicalTopN(PhysicalTopN topN, CascadesContext ctx) {
        ...
        // the StatisticsCleaner
        // will generate two statementContext, and reuse the plan which generated by
        // outer StatementContext,
        // so we should generate exprId by the outer StatementContext, or else generate
        // conflict expr id
