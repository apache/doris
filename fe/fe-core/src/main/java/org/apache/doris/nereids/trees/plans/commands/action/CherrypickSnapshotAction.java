...
/**
 * Cherrypick snapshot action for Iceberg tables.
 */
public class CherrypickSnapshotAction extends OptimizeAction {
    public static final String SNAPSHOT_ID = "snapshot_id";

    public CherrypickSnapshotAction(Map<String, String> properties,
            Optional<PartitionNamesInfo> partitionNamesInfo,
            Optional<Expression> whereCondition,
            ExternalTable table) throws DdlException {
        super(ACTION_CHERRYPICK_SNAPSHOT, properties, partitionNamesInfo, whereCondition);
    ...
    public void execute(ExternalTable table) throws UserException {
        throw new DdlException("Cherrypick snapshot action implementation is not yet complete");
    }
    ...
    public String getDescription() {
        return "Cherrypick snapshot: " + properties.get(SNAPSHOT_ID);
    }
}
