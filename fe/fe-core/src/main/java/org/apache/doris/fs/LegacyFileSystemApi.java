...
/**
 * Legacy file system interface using {@link Status}-based error reporting.
 *
 * @deprecated Use {@link FileSystem} instead. This interface will be removed in Phase 3
 *             of the filesystem SPI refactoring. New code should implement or consume
 *             the IOException-based {@link FileSystem} interface.
 */
@Deprecated
public interface LegacyFileSystemApi {
