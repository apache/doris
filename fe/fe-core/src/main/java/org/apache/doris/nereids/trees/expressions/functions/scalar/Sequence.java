 ...
 */
public class Sequence extends ScalarFunction
     ...
     */
    public Sequence(Expression arg) {
        super("sequence", arg);
    }
     ...
     */
    public Sequence(Expression arg0, Expression arg1) {
        super("sequence", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public Sequence(Expression arg0, Expression arg1, Expression arg2) {
        super("sequence", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public Sequence withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new Sequence(children.get(0));
        } else if (children.size() == 2) {
            return new Sequence(children.get(0), children.get(1));
        } else {
            return new Sequence(children.get(0), children.get(1), children.get(2));
        }
    }
