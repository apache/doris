...
import static org.apache.doris.mysql.MysqlProto.sendResponsePacket;
...
public class MysqlAuth {
    ...
    public static MysqlAuthType useWhichAuthType(ConnectContext context, String qualifiedUser) throws IOException {
