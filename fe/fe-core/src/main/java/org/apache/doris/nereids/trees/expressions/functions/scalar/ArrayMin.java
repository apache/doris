 ...
 */
public class ArrayMin extends ScalarFunction implements ExplicitlyCastableSignature,
        UnaryExpression, AlwaysNullable, NeedSessionVarGuard {
    ...
    public void checkLegalityBeforeTypeCoercion() {
        ...
        if (argType.isArrayType()) {
            ...
            if (!ArrayFunctionTypeChecker.isSupportedByArrayMinMaxFunctions(itemType)) {
                throw new AnalysisException("array_min does not support element type " + itemType.toSql());
            }
        }
    }
