...
public enum SchemaTableType {
    ...
    SCH_STREAMS("STREAMS", "STREAMS", TSchemaTableType.SCH_STREAMS),
    SCH_STREAM_CONSUMPTION("STREAM_CONSUMPTION", "STREAM_CONSUMPTION", TSchemaTableType.SCH_STREAM_CONSUMPTION);
