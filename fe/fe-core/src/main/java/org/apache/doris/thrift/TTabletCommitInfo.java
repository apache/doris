            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.invalid_dict_cols = new java.util.ArrayList<java.lang.String>(_list48.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = iprot.readString();
                  struct.invalid_dict_cols.add(_elem49);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.invalid_dict_cols != null) {
        if (struct.isSetInvalidDictCols()) {
          oprot.writeFieldBegin(INVALID_DICT_COLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter51 : struct.invalid_dict_cols)
            {
      ...
      if (struct.isSetInvalidDictCols()) {
        {
          ...
          for (java.lang.String _iter52 : struct.invalid_dict_cols)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.invalid_dict_cols = new java.util.ArrayList<java.lang.String>(_list53.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = iprot.readString();
            struct.invalid_dict_cols.add(_elem54);
          }
        }
        struct.setInvalidDictColsIsSet(true);
      }
