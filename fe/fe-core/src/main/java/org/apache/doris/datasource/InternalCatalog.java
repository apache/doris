...
public class InternalCatalog implements CatalogIf<Database> {
    ...
    protected Partition createPartitionWithIndices(long dbId, OlapTable tbl, long partitionId,
        ...
        for (Map.Entry<Long, MaterializedIndex> entry : indexMap.entrySet()) {
            ...
            realStorageMedium = createTablets(index, ReplicaState.NORMAL, distributionInfo, version, replicaAlloc,
                tabletMeta, tabletIdSet, idGeneratorBuffer, dataProperty.getMediumAllocationPolicy());
    ...
    private boolean createOlapTable(Database db, CreateTableStmt stmt) throws UserException {
        ...
        if (partitionInfo.getType() == PartitionType.UNPARTITIONED) {
            ...
            try {
                ...
                olapTable.setMediumAllocationPolicy(dataProperty.getMediumAllocationPolicy());
            } catch (AnalysisException e) {
                throw new DdlException(e.getMessage());
            }
            Preconditions.checkNotNull(dataProperty);
        ...
        try {
            if (partitionInfo.getType() == PartitionType.UNPARTITIONED) {
                ...
                try {
                    ...
                    // Remove medium_allocation_policy from properties check as it's handled separately
                    propertiesCheck.entrySet().removeIf(entry -> entry.getKey()
                            .equalsIgnoreCase(PropertyAnalyzer.PROPERTIES_MEDIUM_ALLOCATION_POLICY));
    ...
    public TStorageMedium createTablets(MaterializedIndex index, ReplicaState replicaState,
            ...
            Set<Long> tabletIdSet, IdGeneratorBuffer idGeneratorBuffer, MediumAllocationPolicy mediumAllocationPolicy)
            throws DdlException {
        ...
        for (int i = 0; i < distributionInfo.getBucketNum(); ++i) {
            ...
            if (chooseBackendsArbitrary) {
                ...
                Pair<Map<Tag, List<Long>>, TStorageMedium> chosenBackendIdsAndMedium
                        ...
                        storageMedium, mediumAllocationPolicy, false);
