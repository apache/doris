 ...
 */
public class RemoteDorisLastedRestClient extends RemoteDorisRestClient {
    /**
     * For DorisTable.
     */
    public RemoteDorisLastedRestClient(List<String> feNodes, String authUser, String authPassword, boolean httpSslEnable) {
