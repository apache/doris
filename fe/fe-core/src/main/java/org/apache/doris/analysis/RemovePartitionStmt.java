...
/**
 * Statement for remove a partition in catalog recycle bin.
 */
public class RemovePartitionStmt extends DdlStmt {
    private TableName dbTblName;
    private String partitionName;
    private long partitionId = -1;

    public RemovePartitionStmt(TableName dbTblName, String partitionName, long partitionId) {
    ...
    public String toSql() {
        ...
        sb.append("REMOVE PARTITION ").append(partitionName);
