...
public class IcebergScanNode extends FileQueryScanNode {
    ...
    public List<String> getPathPartitionKeys() throws UserException {
        // Iceberg identity partition columns are still file columns. Per-range partition values are
        // only used for partition pruning and as a fallback for files written before partition evolution.
