...
public class Decode extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            FunctionSignature.ret(StringType.INSTANCE).args(VarBinaryType.INSTANCE, StringType.INSTANCE)
    );
     ...
     */
    @Override
    public Decode withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new Decode(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDecode(this, context);
    }
}
