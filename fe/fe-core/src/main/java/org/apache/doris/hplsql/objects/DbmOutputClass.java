...
public class DbmOutputClass implements org.apache.doris.hplsql.objects.HplClass {
    public static final DbmOutputClass INSTANCE = new DbmOutputClass();
    private final org.apache.doris.hplsql.objects.MethodDictionary<DbmOutput> methodDictionary
            = new org.apache.doris.hplsql.objects.MethodDictionary();
    ...
    @Override
    public org.apache.doris.hplsql.objects.MethodDictionary methodDictionary() {
