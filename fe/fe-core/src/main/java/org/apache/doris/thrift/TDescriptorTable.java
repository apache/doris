            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slotDescriptors = new java.util.ArrayList<TSlotDescriptor>(_list192.size);
                @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem193;
                for (int _i194 = 0; _i194 < _list192.size; ++_i194)
                {
                  _elem193 = new TSlotDescriptor();
                  _elem193.read(iprot);
                  struct.slotDescriptors.add(_elem193);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tupleDescriptors = new java.util.ArrayList<TTupleDescriptor>(_list195.size);
                @org.apache.thrift.annotation.Nullable TTupleDescriptor _elem196;
                for (int _i197 = 0; _i197 < _list195.size; ++_i197)
                {
                  _elem196 = new TTupleDescriptor();
                  _elem196.read(iprot);
                  struct.tupleDescriptors.add(_elem196);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableDescriptors = new java.util.ArrayList<TTableDescriptor>(_list198.size);
                @org.apache.thrift.annotation.Nullable TTableDescriptor _elem199;
                for (int _i200 = 0; _i200 < _list198.size; ++_i200)
                {
                  _elem199 = new TTableDescriptor();
                  _elem199.read(iprot);
                  struct.tableDescriptors.add(_elem199);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDescriptorTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.slotDescriptors != null) {
        if (struct.isSetSlotDescriptors()) {
          oprot.writeFieldBegin(SLOT_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TSlotDescriptor _iter201 : struct.slotDescriptors)
            {
      ...
      if (struct.tupleDescriptors != null) {
        oprot.writeFieldBegin(TUPLE_DESCRIPTORS_FIELD_DESC);
        {
          ...
          for (TTupleDescriptor _iter202 : struct.tupleDescriptors)
          {
      ...
      if (struct.tableDescriptors != null) {
        if (struct.isSetTableDescriptors()) {
          oprot.writeFieldBegin(TABLE_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TTableDescriptor _iter203 : struct.tableDescriptors)
            {
  ...
  private static class TDescriptorTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDescriptorTable> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (TTupleDescriptor _iter204 : struct.tupleDescriptors)
        {
      ...
      if (struct.isSetSlotDescriptors()) {
        {
          ...
          for (TSlotDescriptor _iter205 : struct.slotDescriptors)
          {
      ...
      if (struct.isSetTableDescriptors()) {
        {
          ...
          for (TTableDescriptor _iter206 : struct.tableDescriptors)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.tupleDescriptors = new java.util.ArrayList<TTupleDescriptor>(_list207.size);
        @org.apache.thrift.annotation.Nullable TTupleDescriptor _elem208;
        for (int _i209 = 0; _i209 < _list207.size; ++_i209)
        {
          _elem208 = new TTupleDescriptor();
          _elem208.read(iprot);
          struct.tupleDescriptors.add(_elem208);
        }
      }
      struct.setTupleDescriptorsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.slotDescriptors = new java.util.ArrayList<TSlotDescriptor>(_list210.size);
          @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem211;
          for (int _i212 = 0; _i212 < _list210.size; ++_i212)
          {
            _elem211 = new TSlotDescriptor();
            _elem211.read(iprot);
            struct.slotDescriptors.add(_elem211);
          }
        }
        struct.setSlotDescriptorsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.tableDescriptors = new java.util.ArrayList<TTableDescriptor>(_list213.size);
          @org.apache.thrift.annotation.Nullable TTableDescriptor _elem214;
          for (int _i215 = 0; _i215 < _list213.size; ++_i215)
          {
            _elem214 = new TTableDescriptor();
            _elem214.read(iprot);
            struct.tableDescriptors.add(_elem214);
          }
        }
        struct.setTableDescriptorsIsSet(true);
      }
