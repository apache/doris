...
public class PartitionInfo {
    ...
    // ATTN: no lock here, just Read-Only Access
    public Map<Long, PartitionItem> getIdToItemWithoutLock(boolean isTemp) {
        if (isTemp) {
            return idToTempItem;
        } else {
            return idToItem;
    ...
    public PartitionItem getItemWithoutLock(long partitionId) {
    ...
    public void setItem(long partitionId, boolean isTemp, PartitionItem item) {
        setItemInternalWithLock(partitionId, isTemp, item);
    }

    private void setItemInternalWithLock(long partitionId, boolean isTemp, PartitionItem item) {
        writeLock();
        try {
            if (isTemp) {
    ...
    public Map<Long, ReplicaAllocation> getPartitionReplicaAllocationsWithoutLock() {
