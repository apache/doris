...
/**
 * ScalarFunction 'day_minute_sub'.
 */
public class DayMinuteSub extends ScalarFunction
    ...
    public DayMinuteSub(Expression arg0, Expression arg1) {
        super("day_minute_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private DayMinuteSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public DayMinuteSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new DayMinuteSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDayMinuteSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new DayMinuteSub(literal, child(1));
    }
