...
/**
 * ScalarFunction 'hour_microsecond_add'.
 */
public class HourMicrosecondAdd extends ScalarFunction
    ...
    public HourMicrosecondAdd(Expression arg0, Expression arg1) {
        super("hour_microsecond_add", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private HourMicrosecondAdd(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public HourMicrosecondAdd withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new HourMicrosecondAdd(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitHourMicrosecondAdd(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new HourMicrosecondAdd(literal, child(1));
    }
