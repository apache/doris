...
public class StatsCalculator extends DefaultPlanVisitor<StatsDeriveResult, Void> {
    ...
    @Override
    public StatsDeriveResult visitPhysicalLocalQuickSort(PhysicalLocalQuickSort<Plan> sort, Void context) {
        return groupExpression.getCopyOfChildStats(0);
    }
    ...
    @Override
    public StatsDeriveResult visitPhysicalDistribution(PhysicalDistribute<Plan> distribution,
            Void context) {
        return groupExpression.getCopyOfChildStats(0);
    }
