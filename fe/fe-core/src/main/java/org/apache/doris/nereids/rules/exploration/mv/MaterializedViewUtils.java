...
public class MaterializedViewUtils {
    ...
    public static RelatedTableInfo getRelatedTableInfo(String column, String timeUnit,
        ...
        for (Map.Entry<NamedExpression, RelatedTableColumnInfo> entry
            ...
            if (entry.getValue().isOriginalPartition() && entry.getValue().isFromTablePartitionColumn()) {
    ...
    public static RelatedTableInfo getRelatedTableInfos(String column, String timeUnit,
        ...
        for (Map.Entry<NamedExpression, RelatedTableColumnInfo> entry
                : checkContext.getPartitionAndRefExpressionMap().entrySet()) {
            NamedExpression partitionColumn = entry.getKey();
            Column relatedColumn = entry.getValue().getColumn();
            ...
            if (entry.getValue().isFromTablePartitionColumn()) {
                checkedTableColumnInfos.add(entry.getValue());
            }
        }
