...
/**
 * Insert executor for Paimon tables.
 */
public class PaimonInsertExecutor extends BaseExternalTableInsertExecutor {
    ...
    public void beginTransaction() {
        ...
        PaimonInsertCommandContext paimonCtx = (PaimonInsertCommandContext) insertCtx.get();
        paimonCtx.setTxnId(txnId);
        paimonCtx.setCommitUser(PaimonTransaction.commitUser(txnId));
    }
