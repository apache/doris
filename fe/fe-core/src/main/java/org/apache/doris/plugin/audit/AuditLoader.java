...
public class AuditLoader extends Plugin implements AuditPlugin {
    ...
    private void fillLogBuffer(AuditEvent event, StringBuilder logBuffer) {
        ...
        logBuffer.append(event.effectivePreferredResourceGroup).append(AUDIT_TABLE_COL_SEPARATOR);
        logBuffer.append(event.resourceGroupSelectPolicy).append(AUDIT_TABLE_COL_SEPARATOR);
