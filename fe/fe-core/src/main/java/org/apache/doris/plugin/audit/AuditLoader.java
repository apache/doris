...
public class AuditLoader extends Plugin implements AuditPlugin {
    ...
    private void fillLogBuffer(AuditEvent event, StringBuilder logBuffer) {
        ...
        logBuffer.append(event.backendSelectionPreferredKey).append(AUDIT_TABLE_COL_SEPARATOR);
        logBuffer.append(event.backendSelectionMode).append(AUDIT_TABLE_COL_SEPARATOR);
