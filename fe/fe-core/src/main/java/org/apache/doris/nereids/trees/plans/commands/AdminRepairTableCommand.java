...
public class AdminRepairTableCommand extends Command implements ForwardWithSync {
    ...
    public AdminRepairTableCommand(TableRefInfo tableRefInfo) {
        super(PlanType.ADMIN_REPAIR_TAVLE_COMMAND);
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitAdminRepairTableCommand(this, context);
    }
