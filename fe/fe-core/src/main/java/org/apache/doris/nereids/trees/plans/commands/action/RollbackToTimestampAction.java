...
/**
 * Rollback to timestamp action for Iceberg tables.
 */
public class RollbackToTimestampAction extends OptimizeAction {
    ...
    public void validate(TableNameInfo tableNameInfo, UserIdentity currentUser) throws UserException {
        ...
        try {
            ...
            throw new DdlException("'timestamp' must be a valid timestamp in milliseconds");
        }
    }

    @Override
    public void execute(ExternalTable table) throws UserException {
        throw new DdlException("Rollback to timestamp action implementation is not yet complete");
    }
    ...
    public String getDescription() {
        return "Rollback table to timestamp: " + properties.get(TIMESTAMP);
    }
}
