...
public class LLMExtract extends LLMFunction {
     ...
     */
    public LLMExtract(Expression arg0, Expression arg1, Expression arg2) {
        super("llm_extract", arg0, arg1, arg2);
    }

    @Override
    public LLMExtract withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2 || children.size() == 3,
                "LLM_EXTRACT only accepts 2 or 3 arguments");
        if (children.size() == 2) {
            return new LLMExtract(children.get(0), children.get(1));
        }
