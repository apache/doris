...
/**
 * LLM function 'LLM_FixGrammar'
 */
public class LLMFixGrammar extends LLMFunction {
    ...
    public LLMFixGrammar(Expression arg) {
        super("llm_fixgrammar", arg);
    }

    /**
     * constructor with 2 argument.
     */
    public LLMFixGrammar(Expression arg0, Expression arg1) {
        super("llm_fixgrammar", arg0, arg1);
    }

    @Override
    public LLMFixGrammar withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1 || children.size() == 2,
                "LLM_FIXGRAMMAR only accepts 1 or 2 arguments");
        if (children.size() == 1) {
            return new LLMFixGrammar(children.get(0));
        }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitLLMFixGrammar(this, context);
    }
}
