...
public class MTMVCacheManager implements MTMVHookService {
    ...
    public boolean isAvailableMTMV(MaterializedView mtmv, ConnectContext ctx) throws AnalysisException, DdlException {
    ...
    private MTMVCache generateMTMVCache(MaterializedView materializedView) {
        // TODO: 2023/10/26 implement this method when transparently rewriting
        return new MTMVCache(Sets.newHashSet(), Sets.newHashSet());
    }

    private Set<MaterializedView> getOrCreateMTMVs(BaseTableInfo baseTableInfo) {
    ...
    @Override
    public void createMTMV(MaterializedView materializedView) {
    ...
    @Override
    public void alterMTMV(MaterializedView materializedView, AlterMTMV alterMTMV) {
