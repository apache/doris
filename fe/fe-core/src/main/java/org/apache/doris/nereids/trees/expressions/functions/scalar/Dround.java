...
public class Dround extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            FunctionSignature.ret(DecimalV2Type.SYSTEM_DEFAULT).args(DecimalV2Type.SYSTEM_DEFAULT, IntegerType.INSTANCE)
    );

    /**
     * constructor with 1 argument.
     */
    public Dround(Expression arg) {
        super("dround", arg);
    }
     ...
     */
    public Dround(Expression arg0, Expression arg1) {
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDround(this, context);
    }
}
