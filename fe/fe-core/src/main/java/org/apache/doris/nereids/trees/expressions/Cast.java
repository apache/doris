...
public class Cast extends Expression implements UnaryExpression, Monotonic {
    ...
    public Cast withTargetType(DataType targetType) {
        return this.targetType.equals(targetType)
                ? this : new Cast(children, targetType, isExplicitType, losslessDecimalCast);
    }
    ...
    public String toDigest() {
        ...
        sb.append(losslessDecimalCast ? "lossless_decimal_cast(" : "cast(")
    ...
    public Expression withConstantArgs(Expression literal) {
        return new Cast(literal, targetType, isExplicitType, losslessDecimalCast);
    }
