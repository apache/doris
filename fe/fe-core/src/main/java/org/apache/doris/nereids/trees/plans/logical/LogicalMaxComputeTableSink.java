...
/**
 * logical maxcompute table sink for insert command
 */
public class LogicalMaxComputeTableSink<CHILD_TYPE extends Plan> extends LogicalTableSink<CHILD_TYPE>
        implements Sink, PropagateFuncDeps {
    private final MaxComputeExternalDatabase database;
     ...
     * constructor
     */
    public LogicalMaxComputeTableSink(MaxComputeExternalDatabase database,
                                      ...
                                      CHILD_TYPE child) {
        super(PlanType.LOGICAL_MAX_COMPUTE_TABLE_SINK, outputExprs, groupExpression, logicalProperties, cols, child);
        this.database = Objects.requireNonNull(database, "database != null in LogicalMaxComputeTableSink");
        this.targetTable = Objects.requireNonNull(targetTable, "targetTable != null in LogicalMaxComputeTableSink");
    ...
    public MaxComputeExternalTable getTargetTable() {
        return targetTable;
    }
    ...
    public boolean equals(Object o) {
        ...
        LogicalMaxComputeTableSink<?> that = (LogicalMaxComputeTableSink<?>) o;
    ...
    public String toString() {
        return Utils.toSqlString("LogicalMaxComputeTableSink[" + id.asInt() + "]",
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitLogicalMaxComputeTableSink(this, context);
    }
