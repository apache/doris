...
public class JdbcExternalTable extends ExternalTable {
    ...
    private JdbcTable toJdbcTable() {
        ...
        // Set real properties
        jdbcTable.setRealDatabaseName(jdbcCatalog.getJdbcClient().getRealDatabaseName(this.dbName));
        jdbcTable.setRealTableName(jdbcCatalog.getJdbcClient().getRealTableName(this.dbName, this.name));
