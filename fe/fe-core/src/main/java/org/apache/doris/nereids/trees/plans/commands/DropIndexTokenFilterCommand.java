 ...
 **/
public class DropIndexTokenFilterCommand extends DropCommand {
    private final boolean ifExists;
    private final String name;

    public DropIndexTokenFilterCommand(String name, boolean ifExists) {
        super(PlanType.DROP_INDEX_TOKEN_FILTER_COMMAND);
        this.name = name;
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitDropIndexTokenFilterCommand(this, context);
    }
}
