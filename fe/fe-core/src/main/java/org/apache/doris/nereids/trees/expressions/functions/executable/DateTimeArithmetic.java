...
public class DateTimeArithmetic {
    ...
    @ExecFunction(hasVarArgs = false, name = "date_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression dateAdd(DateTimeLiteral date, IntegerLiteral day) {
        return daysAdd(date, day);
    }

    @ExecFunction(hasVarArgs = false, name = "date_add", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression dateAdd(DateV2Literal date, IntegerLiteral day) {
        return daysAdd(date, day);
    }

    @ExecFunction(hasVarArgs = false, name = "date_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "date_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression dateSub(DateTimeLiteral date, IntegerLiteral day) {
        return dateAdd(date, new IntegerLiteral(-day.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "date_sub", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression dateSub(DateV2Literal date, IntegerLiteral day) {
        return dateAdd(date, new IntegerLiteral(-day.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "date_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "years_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression yearsAdd(DateTimeLiteral date, IntegerLiteral year) {
        return date.plusYears(year.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "years_add", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression yearsAdd(DateV2Literal date, IntegerLiteral year) {
        return date.plusYears(year.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "years_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "months_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression monthsAdd(DateTimeLiteral date, IntegerLiteral month) {
        return date.plusMonths(month.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "months_add", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression monthsAdd(DateV2Literal date, IntegerLiteral month) {
        return date.plusMonths(month.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "months_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "weeks_add", argTypes = {"DATE", "INT"}, returnType = "DATE")
    public static Expression weeksAdd(DateLiteral date, IntegerLiteral weeks) {
        return date.plusWeeks(weeks.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "weeks_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression weeksAdd(DateTimeLiteral date, IntegerLiteral weeks) {
        return date.plusWeeks(weeks.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "weeks_add", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression weeksAdd(DateV2Literal date, IntegerLiteral weeks) {
        return date.plusWeeks(weeks.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "weeks_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "days_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression daysAdd(DateTimeLiteral date, IntegerLiteral day) {
        return date.plusDays(day.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "days_add", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression daysAdd(DateV2Literal date, IntegerLiteral day) {
        return date.plusDays(day.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "days_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "hours_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression hoursAdd(DateTimeLiteral date, IntegerLiteral hour) {
        return date.plusHours(hour.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "hours_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "minutes_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression minutesAdd(DateTimeLiteral date, IntegerLiteral minute) {
        return date.plusMinutes(minute.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "minutes_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "seconds_add", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression secondsAdd(DateTimeLiteral date, IntegerLiteral second) {
        return date.plusSeconds(second.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "seconds_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "microseconds_add", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "microseconds_sub", argTypes = { "DATETIMEV2", "INT" }, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "milliseconds_add", argTypes = { "DATETIMEV2", "INT" }, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "milliseconds_sub", argTypes = { "DATETIMEV2", "INT" }, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "years_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression yearsSub(DateTimeLiteral date, IntegerLiteral year) {
        return yearsAdd(date, new IntegerLiteral(-year.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "years_sub", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression yearsSub(DateV2Literal date, IntegerLiteral year) {
        return yearsAdd(date, new IntegerLiteral(-year.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "years_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "months_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression monthsSub(DateTimeLiteral date, IntegerLiteral month) {
        return monthsAdd(date, new IntegerLiteral(-month.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "months_sub", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression monthsSub(DateV2Literal date, IntegerLiteral month) {
        return monthsAdd(date, new IntegerLiteral(-month.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "months_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "weeks_sub", argTypes = {"DATE", "INT"}, returnType = "DATE")
    public static Expression weeksSub(DateLiteral date, IntegerLiteral weeks) {
        return date.plusWeeks(-weeks.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "weeks_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression weeksSub(DateTimeLiteral date, IntegerLiteral weeks) {
        return date.plusWeeks(-weeks.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "weeks_sub", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression weeksSub(DateV2Literal date, IntegerLiteral weeks) {
        return date.plusWeeks(-weeks.getValue());
    }

    @ExecFunction(hasVarArgs = false, name = "weeks_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
    ...
    @ExecFunction(hasVarArgs = false, name = "days_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    public static Expression daysSub(DateTimeLiteral date, IntegerLiteral day) {
        return daysAdd(date, new IntegerLiteral(-day.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "days_sub", argTypes = {"DATEV2", "INT"}, returnType = "DATEV2")
    public static Expression daysSub(DateV2Literal date, IntegerLiteral day) {
        return daysAdd(date, new IntegerLiteral(-day.getValue()));
    }

    @ExecFunction(hasVarArgs = false, name = "days_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "hours_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    ...
    @ExecFunction(hasVarArgs = false, name = "hours_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "minutes_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    ...
    @ExecFunction(hasVarArgs = false, name = "minutes_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "seconds_sub", argTypes = {"DATETIME", "INT"}, returnType = "DATETIME")
    ...
    @ExecFunction(hasVarArgs = false, name = "seconds_sub", argTypes = {"DATETIMEV2", "INT"}, returnType = "DATETIMEV2")
     ...
     */
    @ExecFunction(hasVarArgs = false, name = "datediff", argTypes = {"DATETIME", "DATETIME"}, returnType = "INT")
    ...
    @ExecFunction(hasVarArgs = false, name = "datediff", argTypes = {"DATEV2", "DATEV2"}, returnType = "INT")
    public static Expression dateDiff(DateV2Literal date1, DateV2Literal date2) {
        return new IntegerLiteral(dateDiff(date1.toJavaDateType(), date2.toJavaDateType()));
    }

    @ExecFunction(hasVarArgs = false, name = "datediff", argTypes = {"DATEV2", "DATETIMEV2"}, returnType = "INT")
    public static Expression dateDiff(DateV2Literal date1, DateTimeV2Literal date2) {
        return new IntegerLiteral(dateDiff(date1.toJavaDateType(), date2.toJavaDateType()));
    }

    @ExecFunction(hasVarArgs = false, name = "datediff", argTypes = {"DATETIMEV2", "DATEV2"}, returnType = "INT")
    public static Expression dateDiff(DateTimeV2Literal date1, DateV2Literal date2) {
        return new IntegerLiteral(dateDiff(date1.toJavaDateType(), date2.toJavaDateType()));
    }

    @ExecFunction(hasVarArgs = false, name = "datediff", argTypes = {"DATETIMEV2", "DATETIMEV2"}, returnType = "INT")
