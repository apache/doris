 ...
 */
public class DaysAdd extends ScalarFunction implements BinaryExpression, ExplicitlyCastableSignature,
    ...
    private DaysAdd(ScalarFunctionParams functionParams) {
    ...
    public DaysAdd withChildren(List<Expression> children) {
        ...
        return new DaysAdd(getFunctionParams(children));
    }
