 ...
 * show data command
 */
public class ShowDataCommand extends ShowCommand {
    ...
    private List<OrderKey> orderByElements = null;
     ...
     * constructor
     */
    public ShowDataCommand(TableNameInfo tableName, List<OrderKey> orderByElements,
                           Map<String, String> properties, boolean detailed) {
        super(PlanType.SHOW_DATA_COMMAND);
    ...
    public void validate(ConnectContext ctx) throws UserException {
        ...
        if (orderByElements != null && !orderByElements.isEmpty()) {
            ...
            for (OrderKey orderByElement : orderByElements) {
                ...
                int index = analyzeColumn(slot.getName(), tableName == null ? null : tableName.getTbl());
        ...
        if (hasTable()) {
            ...
            OlapTable table = (OlapTable) db.getTableOrMetaException(tableName.getTbl(), TableIf.TableType.OLAP);
    ...
    public String toSql() {
        ...
        if (orderByElements != null) {
            ...
            for (int i = 0; i < orderByElements.size(); ++i) {
                ...
                builder.append((orderByElements.get(i).isAsc()) ? " ASC" : " DESC");
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitShowDataCommand(this, context);
    }
}
