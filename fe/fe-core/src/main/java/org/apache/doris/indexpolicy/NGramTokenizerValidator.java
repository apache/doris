...
public class NGramTokenizerValidator extends BasePolicyValidator {
    ...
    protected void validateSpecific(Map<String, String> props) throws DdlException {
        ...
        // Without mode, density/lower_case are meaningless, so reject them outright
     ...
     * defaults and the ordering of min/max_gram, the value domains of density/lower_case, and the
