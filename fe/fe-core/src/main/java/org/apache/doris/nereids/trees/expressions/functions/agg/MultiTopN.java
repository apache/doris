...
public class MultiTopN extends NullableAggregateFunction
    ...
    public MultiTopN(boolean distinct, boolean alwaysNullable, Expression... varArgs) {
        super("multi_topn", distinct, alwaysNullable, varArgs);
    }
    ...
    @Override
    public MultiTopN withDistinctAndChildren(boolean distinct, List<Expression> children) {
        Preconditions.checkArgument(children.size() >= 3);
        return new MultiTopN(distinct, alwaysNullable, children.toArray(new Expression[0]));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitMultiTopN(this, context);
    }
