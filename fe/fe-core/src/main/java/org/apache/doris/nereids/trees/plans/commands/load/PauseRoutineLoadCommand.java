...
public class PauseRoutineLoadCommand extends Command implements ForwardWithSync {
    ...
    public PauseRoutineLoadCommand(LabelNameInfo labelNameInfo) {
        super(PlanType.PAUSE_ROUTINE_LOAD_COMMAND);
        this.labelNameInfo = labelNameInfo;
        this.isAll = false;
    }

    public PauseRoutineLoadCommand() {
        super(PlanType.PAUSE_ALL_ROUTINE_COMMAND);
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitPauseRoutineLoadCommand(this, context);
    }
