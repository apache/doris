...
public class SequenceFileFormatProperties extends FileFormatProperties {

    public SequenceFileFormatProperties() {
        super(TFileFormatType.FORMAT_SEQUENCE, FileFormatProperties.FORMAT_SEQUENCE);
    }
