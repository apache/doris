...
/**
 * ScalarFunction 'hour_minute_sub'.
 */
public class HourMinuteSub extends ScalarFunction
    ...
    public HourMinuteSub(Expression arg0, Expression arg1) {
        super("hour_minute_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private HourMinuteSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public HourMinuteSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new HourMinuteSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitHourMinuteSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new HourMinuteSub(literal, child(1));
    }
