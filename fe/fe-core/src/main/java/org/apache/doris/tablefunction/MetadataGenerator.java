...
public class MetadataGenerator {
    ...
    private static final ImmutableMap<String, Integer> VIEW_DEPENDENCE_COLUMN_TO_INDEX;
    ...
    static {
        ...
        List<Column> mvDependenceBuilderColList = SchemaTable.TABLE_MAP.get("view_dependence").getFullSchema();
        ...
        VIEW_DEPENDENCE_COLUMN_TO_INDEX = mvDependenceBuilder.build();
    }
    ...
    public static TFetchSchemaTableDataResult getSchemaTableData(TFetchSchemaTableDataRequest request)
        ...
        switch (request.getSchemaTableName()) {
            ...
            case PARTITIONS:
                ...
                break;
            case VIEW_DEPENDENCE:
                result = viewDependenceMetadataResult(schemaTableParams);
                columnIndex = VIEW_DEPENDENCE_COLUMN_TO_INDEX;
                break;
            default:
    ...
    private static TFetchSchemaTableDataResult viewDependenceMetadataResult(TSchemaTableRequestParams params) {
        if (!params.isSetCurrentUserIdent()) {
            return errorResult("current user ident is not set.");
        }
