...
public class DropAuthenticationIntegrationOperationLog implements Writable {
    ...
    public static DropAuthenticationIntegrationOperationLog read(DataInput in) throws IOException {
        return GsonUtils.GSON.fromJson(Text.readString(in), DropAuthenticationIntegrationOperationLog.class);
    }
}
