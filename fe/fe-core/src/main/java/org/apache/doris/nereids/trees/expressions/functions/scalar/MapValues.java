...
public class MapValues extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            FunctionSignature.ret(ArrayType.of(new FollowToAnyDataType(0))).args(MapType.of(
                    AnyDataType.INSTANCE_WITHOUT_INDEX, new AnyDataType(0)))
    );

    /**
     * constructor with 1 argument.
     */
    public MapValues(Expression arg) {
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitMapValues(this, context);
    }
    ...
    public FunctionSignature deriveSignatureFromChildren(
        ...
        return resolvedSignature.withArgumentType(0, mapType)
                .withReturnType(ArrayType.of(mapType.getValueType()));
    }
}
