...
/**
 * Implementation rule that converts logical MaxComputeTableSink to physical MaxComputeTableSink.
 */
public class LogicalMaxComputeTableSinkToPhysicalMaxComputeTableSink extends OneImplementationRuleFactory {
    @Override
    public Rule build() {
        return logicalMaxComputeTableSink().thenApply(ctx -> {
            LogicalMaxComputeTableSink<? extends Plan> sink = ctx.root;
