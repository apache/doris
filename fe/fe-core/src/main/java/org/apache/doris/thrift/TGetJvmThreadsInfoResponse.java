            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.threads = new java.util.ArrayList<TJvmThreadInfo>(_list40.size);
                @org.apache.thrift.annotation.Nullable TJvmThreadInfo _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new TJvmThreadInfo();
                  _elem41.read(iprot);
                  struct.threads.add(_elem41);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.threads != null) {
        if (struct.isSetThreads()) {
          oprot.writeFieldBegin(THREADS_FIELD_DESC);
          {
            ...
            for (TJvmThreadInfo _iter43 : struct.threads)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetThreads()) {
        {
          ...
          for (TJvmThreadInfo _iter44 : struct.threads)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.threads = new java.util.ArrayList<TJvmThreadInfo>(_list45.size);
          @org.apache.thrift.annotation.Nullable TJvmThreadInfo _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new TJvmThreadInfo();
            _elem46.read(iprot);
            struct.threads.add(_elem46);
          }
        }
        struct.setThreadsIsSet(true);
      }
