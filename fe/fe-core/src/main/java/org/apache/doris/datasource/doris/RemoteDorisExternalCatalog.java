...
public class RemoteDorisExternalCatalog extends ExternalCatalog {
    ...
    private static final List<String> REQUIRED_PROPERTIES = ImmutableList.of(
        RemoteDorisProperties.FE_HOSTS,
    ...
    public List<String> getFeNodes() {
        return parseHttpHosts(catalogProperty.getOrDefault(RemoteDorisProperties.FE_HOSTS, ""));
    }
    ...
    protected void initLocalObjectsImpl() {
        if (isCompatible()) {
            dorisRestClient = new RemoteDorisCompatibleRestClient(getFeNodes(), getUsername(), getPassword(), enableSsl());
        } else {
            dorisRestClient = new RemoteDorisLastedRestClient(getFeNodes(), getUsername(), getPassword(), enableSsl());
        }
