...
public class Backend implements Writable {
    ...
    public boolean handleHbResponse(BackendHbResponse hbResponse, boolean isReplay) {
        ...
        if (hbResponse.getStatus() == HbStatus.OK) {
            ...
            boolean incompatible = !supportsNodeFeature(NodeFeature.ROW_TTL);
            ...
            heartbeatErrMsg = nodeFeatureIncompatible
                    ? "backend does not support the required Row TTL feature" : "";
    ...
    public static Backend fromThrift(TBackend backend) {
        ...
        result.setNodeFeatureFlags(backend.getNodeFeatureFlags());
        return result;
    }
