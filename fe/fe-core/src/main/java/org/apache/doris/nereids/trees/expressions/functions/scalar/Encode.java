...
public class Encode extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            FunctionSignature.ret(VarBinaryType.INSTANCE).args(StringType.INSTANCE, StringType.INSTANCE)
    );
     ...
     */
    @Override
    public Encode withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new Encode(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitEncode(this, context);
    }
}
