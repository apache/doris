 ...
 */
public class TransactionRollbackCommand extends TransactionCommand {
    private static final Logger LOG = LogManager.getLogger(TransactionRollbackCommand.class);

    public TransactionRollbackCommand() {
        super(PlanType.TRANSACTION_ROLLBACK_COMMAND);
    }
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitTransactionRollbackCommand(this, context);
    }
