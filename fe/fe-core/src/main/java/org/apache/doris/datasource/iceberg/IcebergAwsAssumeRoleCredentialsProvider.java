...
public class IcebergAwsAssumeRoleCredentialsProvider implements AwsCredentialsProvider {
    ...
    private IcebergAwsAssumeRoleCredentialsProvider(AwsCredentialsProvider provider) {
        this.provider = provider;
    }

    public static IcebergAwsAssumeRoleCredentialsProvider create(Map<String, String> props) {
        return new IcebergAwsAssumeRoleCredentialsProvider(S3Properties.of(props).getAwsCredentialsProvider());
    }
