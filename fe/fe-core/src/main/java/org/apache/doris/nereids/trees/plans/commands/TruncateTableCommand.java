 ...
 */
public class TruncateTableCommand extends Command implements ForwardWithSync, NeedAuditEncryption {
    ...
    public void validate(ConnectContext ctx) throws AnalysisException {
        ...
        partitionNamesInfo.ifPresent(PartitionNamesInfo::validate);
    }
