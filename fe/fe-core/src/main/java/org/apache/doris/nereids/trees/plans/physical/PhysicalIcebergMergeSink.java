...
public class PhysicalIcebergMergeSink<CHILD_TYPE extends Plan> extends PhysicalBaseExternalTableSink<CHILD_TYPE> {
    ...
    public Plan withGroupExpression(Optional<GroupExpression> groupExpression) {
        return new PhysicalIcebergMergeSink<>(
                ...
                deleteContext, requireMergeCardinalityCheck, groupExpression, getLogicalProperties(), child());
    }
    ...
    public Plan withGroupExprLogicalPropChildren(Optional<GroupExpression> groupExpression,
        ...
        return new PhysicalIcebergMergeSink<>(
                database, targetTable, cols, outputExprs,
                deleteContext, requireMergeCardinalityCheck, groupExpression, logicalProperties.get(), children.get(0));
    }
    ...
    public PhysicalPlan withPhysicalPropertiesAndStats(PhysicalProperties physicalProperties, Statistics statistics) {
        return new PhysicalIcebergMergeSink<>(
                database, targetTable, cols, outputExprs,
                deleteContext, requireMergeCardinalityCheck, groupExpression, getLogicalProperties(),
