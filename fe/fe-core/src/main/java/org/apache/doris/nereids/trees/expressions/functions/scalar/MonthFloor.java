...
public class MonthFloor extends ScalarFunction
    ...
    private MonthFloor(ScalarFunctionParams functionParams) {
    ...
    public MonthFloor withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        return new MonthFloor(getFunctionParams(children));
    }
    ...
    public Optional<Expression> nextBucketBoundary(Literal value) {
        ...
        return Optional.of(new MonthsAdd(value, period.get()));
    }
