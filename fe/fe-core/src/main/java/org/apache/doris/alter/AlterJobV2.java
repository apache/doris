...
public abstract class AlterJobV2 implements Writable {
    ...
    protected boolean isReplicaReadyForAlterTask(Replica replica, long visibleVersion) {
        return replica.isScheduleAvailable() && replica.isAlive()
                && replica.getLastFailedVersion() < 0 && replica.checkVersionCatchUp(visibleVersion, false);
    }
