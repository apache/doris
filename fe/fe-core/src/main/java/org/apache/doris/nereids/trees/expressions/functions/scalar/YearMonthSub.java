...
/**
 * ScalarFunction 'year_month_sub'.
 */
public class YearMonthSub extends ScalarFunction
    ...
    public YearMonthSub(Expression arg0, Expression arg1) {
        super("year_month_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private YearMonthSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public YearMonthSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new YearMonthSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitYearMonthSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new YearMonthSub(literal, child(1));
    }
