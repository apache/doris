...
/**
 * AggregateFunction 'var_samp'. This class is generated by GenerateFunction.
 */
public class VarSamp extends AggregateFunction
     ...
     * constructor with 1 argument.
     */
    public VarSamp(boolean distinct, Expression arg) {
        super("var_samp", distinct, arg);
    }
     ...
     */
    @Override
    public VarSamp withDistinctAndChildren(boolean distinct, List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1);
        return new VarSamp(distinct, children.get(0));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitVarSamp(this, context);
    }
