...
public class FrontendServiceImpl implements FrontendService.Iface {
    ...
    public TGetDbsResult getDbNames(TGetDbsParams params) throws TException {
        ...
        for (CatalogIf catalog : catalogIfs) {
            ...
            for (String fullName : dbNames) {
                if (!env.getAccessCtlMgr().checkDbPriv(currentUser, fullName, PrivPredicate.SHOW)) {
                    continue;
                }
        ...
        if (catalog != null) {
            ...
            if (db != null) {
                ...
                for (TableIf table : tables) {
                    if (!Env.getCurrentEnv().getAccessCtlMgr().checkTblPriv(currentUser, params.db,
    ...
    private void checkPasswordAndPrivs(String cluster, String user, String passwd, String db, String tbl,
        ...
        if (!Env.getCurrentEnv().getAccessCtlMgr().checkTblPriv(currentUser.get(0), fullDbName, tbl, predicate)) {
