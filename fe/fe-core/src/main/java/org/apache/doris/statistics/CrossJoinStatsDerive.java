...
public class CrossJoinStatsDerive extends BaseStatsDerive {
    private final static Logger LOG = LogManager.getLogger(CrossJoinStatsDerive.class);
    @Override
    ...
    protected long deriveRowCount() {
        if (childrenStatsResult.get(0).getRowCount() == -1 || childrenStatsResult.get(1).getRowCount() == -1) {
            ...
            rowCount = CheckedMath.checkedMultiply(childrenStatsResult.get(0).getRowCount(), childrenStatsResult.get(1).getRowCount());
