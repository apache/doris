...
/**
 * ScalarFunction 'year_ceil'. This class is generated by GenerateScalarFunction.
 */
public class YearCeil extends ScalarFunction
     ...
     */
    public YearCeil(Expression arg) {
        super("year_ceil", arg);
    }
     ...
     */
    public YearCeil(Expression arg0, Expression arg1) {
        super("year_ceil", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public YearCeil(Expression arg0, Expression arg1, Expression arg2) {
        super("year_ceil", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public YearCeil withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new YearCeil(children.get(0));
        } else if (children.size() == 2) {
            return new YearCeil(children.get(0), children.get(1));
        } else {
            return new YearCeil(children.get(0), children.get(1), children.get(2));
        }
    }
