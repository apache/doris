...
public class DaysDiff extends ScalarFunction implements BinaryExpression, ExplicitlyCastableSignature,
    ...
    private static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            FunctionSignature.ret(BigIntType.INSTANCE).args(TimeStampNsType.INSTANCE, TimeStampNsType.INSTANCE),
    ...
    private DaysDiff(ScalarFunctionParams functionParams) {
    ...
    public DaysDiff withChildren(List<Expression> children) {
        ...
        return new DaysDiff(getFunctionParams(children));
    }
