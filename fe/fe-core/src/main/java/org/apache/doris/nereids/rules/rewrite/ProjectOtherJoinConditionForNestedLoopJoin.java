    ...
    public Rule build() {
        return logicalJoin().when(
                join -> join.getHashJoinConjuncts().isEmpty()
                        ...
                        && !join.getJoinReorderContext().isExtractSubExpressionForChild()
        ).then(
                join -> {
                    join.getJoinReorderContext().setExtractSubExpressionForChild(true);
                    ...
                    if (changed) {
                        ...
                        join = join.withJoinConjuncts(join.getHashJoinConjuncts(),
