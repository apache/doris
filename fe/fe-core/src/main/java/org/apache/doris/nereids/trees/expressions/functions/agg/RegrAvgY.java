...
/**
 * AggregateFunction 'regr_avgy'.
 */
public class RegrAvgY extends NullableAggregateFunction
     ...
     */
    public RegrAvgY(Expression arg1, Expression arg2) {
     ...
     */
    public RegrAvgY(boolean distinct, Expression arg1, Expression arg2) {
        this(distinct, false, arg1, arg2);
    }

    private RegrAvgY(boolean distinct, boolean alwaysNullable, Expression arg1, Expression arg2) {
        super("regr_avgy", distinct, alwaysNullable, arg1, arg2);
    }
    ...
    public void checkLegalityBeforeTypeCoercion() {
        ...
        if ((!arg0Type.isNumericType() && !arg0Type.isNullType())
            ...
            throw new AnalysisException("regr_avgy requires numeric for first parameter: " + toSql());
        } else if ((!arg1Type.isNumericType() && !arg1Type.isNullType())
                || arg1Type.isOnlyMetricType()) {
            throw new AnalysisException("regr_avgy requires numeric for second parameter: " + toSql());
        }
    }
    ...
    public FunctionSignature computePrecision(FunctionSignature signature) {
        ...
        if (signature.getArgType(0) instanceof DecimalV3Type) {
            ...
            return signature.withArgumentType(0, decimalV3Type).withReturnType(ret);
        } else {
            return signature;
        }
    }
    ...
    public AggregateFunction withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        return new RegrAvgY(distinct, alwaysNullable, left(), right());
    }
