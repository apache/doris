...
public enum PlanType {
    ...
    LOGICAL_EXTERNAL_ROW_LEVEL_DELETE_SINK,
    LOGICAL_EXTERNAL_ROW_LEVEL_MERGE_SINK,
    LOGICAL_JDBC_TABLE_SINK,
    LOGICAL_CONNECTOR_TABLE_SINK,
    LOGICAL_RESULT_SINK,
    ...
    LOGICAL_UNBOUND_CONNECTOR_TABLE_SINK,
    ...
    PHYSICAL_EXTERNAL_ROW_LEVEL_DELETE_SINK,
    PHYSICAL_EXTERNAL_ROW_LEVEL_MERGE_SINK,
    ...
    HBO_STATISTICS_COMMAND,
    HBO_SHOW_STATISTICS_COMMAND,
    HBO_EXPANSION_COMMAND,
    HBO_SHOW_EXPANSION_COMMAND,
