...
public enum PlanType {
    ...
    ADMIN_BACKUP_CLUSTER_SNAPSHOT_COMMAND,
    ADMIN_SET_CLUSTER_SNAPSHOT_COMMAND,
    ADMIN_SHOW_CLUSTER_SNAPSHOT_PROPERTIES_COMMAND,
    ADMIN_SHOW_CLUSTER_SNAPSHOT_COMMAND,
