...
public class ExecuteActionFactory {
    ...
    /**
     * Create an ExecuteAction instance based on the table type and action type.
     *
    ...
    public static ExecuteAction createAction(String actionType, Map<String, String> properties,
        ...
        if (table instanceof IcebergExternalTable) {
            ...
            throw new DdlException("Execute actions for internal tables are not yet supported");
        }
    }
