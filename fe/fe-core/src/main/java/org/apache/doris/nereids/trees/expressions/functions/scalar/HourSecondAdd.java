...
/**
 * ScalarFunction 'hour_second_add'.
 */
public class HourSecondAdd extends ScalarFunction
    ...
    public HourSecondAdd(Expression arg0, Expression arg1) {
        super("hour_second_add", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private HourSecondAdd(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public HourSecondAdd withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new HourSecondAdd(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitHourSecondAdd(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new HourSecondAdd(literal, child(1));
    }
