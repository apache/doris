...
public class BindSink implements AnalysisRuleFactory {
    ...
    private Plan bindPaimonTableSink(MatchingContext<UnboundPaimonTableSink<Plan>> ctx) {
        ...
        Map<String, NamedExpression> columnToOutput = getSpecifiedColumnToOutput(bindColumns, child);
    ...
    /**
     * Build column-to-output mapping for external table sinks that preserve specified columns.
     ...
     */
    private static Map<String, NamedExpression> getSpecifiedColumnToOutput(
