...
public class Default extends Expression implements UnaryExpression, AlwaysNullable {

    public Default(Expression child) {
        super(ImmutableList.of(child));
    }

    /** Constructor with one argument and an expected target type. */
    public Default(Expression argument, DataType targetType) {
