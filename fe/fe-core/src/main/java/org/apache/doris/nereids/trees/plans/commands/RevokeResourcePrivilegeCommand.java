 ...
 */
public class RevokeResourcePrivilegeCommand extends Command implements ForwardWithSync, NeedAuditEncryption {
    ...
    public void validate() throws AnalysisException {
        ...
        if (resourcePattern.isPresent()) {
            ...
            GrantStmt.checkResourcePrivileges(privileges, resourcePattern.get());
        } else if (workloadGroupPattern.isPresent()) {
            // modify when grantCommand merged
            GrantStmt.checkWorkloadGroupPrivileges(privileges, workloadGroupPattern.get());
        }
    }
