...
/**
 * ScalarFunction 'positive'. This class is generated by GenerateFunction.
 */
public class Positive extends ScalarFunction
        implements UnaryExpression, ExplicitlyCastableSignature, PropagateNullable, DecimalSamePrecision, Monotonic {
     ...
     */
    public Positive(Expression arg) {
        super("positive", arg);
    }
    ...
    public boolean isMonotonic(Literal lower, Literal upper) {
        return !(child(0) instanceof Literal);
    }
