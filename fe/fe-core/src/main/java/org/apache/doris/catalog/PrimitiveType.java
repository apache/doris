...
public enum PrimitiveType {
    ...
    public MysqlColType toMysqlType() {
        switch (this) {
            ...
            case JSONB:
                return MysqlColType.MYSQL_TYPE_JSONB;
            default:
