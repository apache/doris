 ...
 **/
public class DropIndexTokenizerCommand extends DropCommand {
    private final boolean ifExists;
    private final String name;

    public DropIndexTokenizerCommand(String name, boolean ifExists) {
        super(PlanType.DROP_INDEX_TOKENIZER_COMMAND);
        this.name = name;
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitDropIndexTokenizerCommand(this, context);
    }
}
