...
public class RegrSyy extends AggregateFunction
     ...
     */
    public RegrSyy(Expression arg1, Expression arg2) {
     ...
     */
    public RegrSyy(boolean distinct, Expression arg1, Expression arg2) {
        super("regr_syy", distinct, arg1, arg2);
    }
    ...
    public void checkLegalityBeforeTypeCoercion() throws AnalysisException {
        ...
        if ((!arg0Type.isNumericType() && !arg0Type.isNullType())
            ...
            throw new AnalysisException("regr_syy requires numeric for first parameter: " + toSql());
        } else if ((!arg1Type.isNumericType() && !arg1Type.isNullType())
                || arg1Type.isOnlyMetricType()) {
            throw new AnalysisException("regr_syy requires numeric for second parameter: " + toSql());
        }
    }
    ...
    public RegrSyy withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        return new RegrSyy(distinct, children.get(0), children.get(1));
    }
