...
public class RegrSyy extends AggregateFunction
    ...
    public RegrSyy(boolean distinct, Expression arg0, Expression arg1) {
        super("regr_syy", distinct, arg0, arg1);
    }

    public RegrSyy(AggregateFunctionParams functionParams) {
    ...
    public void checkLegalityBeforeTypeCoercion() {
        ...
        if (!yType.isNumericType() && !yType.isBooleanType()
            ...
            throw new AnalysisException("regr_syy(y, x): y must be numeric, boolean or string type: " + toSql());
        }
        if (!xType.isNumericType() && !xType.isBooleanType()
                && !xType.isNullType() && !xType.isStringLikeType()) {
            throw new AnalysisException("regr_syy(y, x): x must be numeric, boolean or string type: " + toSql());
        }
    }
    ...
    public RegrSyy withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        return new RegrSyy(getFunctionParams(distinct, children));
    }
