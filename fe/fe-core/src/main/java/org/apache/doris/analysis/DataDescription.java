...
public class DataDescription {
    ...
    private void checkLoadPriv(String fullDbName) throws AnalysisException {
        ...
        // check auth
        if (!Env.getCurrentEnv().getAccessCtlMgr().checkTblPriv(ConnectContext.get(), fullDbName, tableName,
                PrivPredicate.LOAD)) {
        ...
        if (isLoadFromTable()) {
            if (!Env.getCurrentEnv().getAccessCtlMgr().checkTblPriv(ConnectContext.get(), fullDbName, srcTableName,
