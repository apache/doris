 ...
 */
public class PhysicalGroupingSets<CHILD_TYPE extends Plan> extends PhysicalGroupBy<CHILD_TYPE> {
    ...
    public PhysicalGroupingSets<Plan> withChildren(List<Plan> children) {
        ...
        return new PhysicalGroupingSets<>(groupByExpressions, originGroupByExprs, outputExpressions,
                groupingIdList, virtualSlotRefs, virtualGroupingExprs, groupingList,
