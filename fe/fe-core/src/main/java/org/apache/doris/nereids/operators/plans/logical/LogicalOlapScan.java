...
/**
 * Logical olap-scan plan operator.
 */
public class LogicalOlapScan extends LogicalScan {
    private final long selectedIndexId;
    private final List<Long> selectedTabletId;
    private final List<Long> selectedPartitionId;
    private final OlapTable olapTable;
    public LogicalOlapScan(OlapTable olapTable, List<String> qualifier) {
        super(OperatorType.LOGICAL_OLAP_SCAN, qualifier);
