...
public class TableStreamInfo {
    private static final Logger LOG = LogManager.getLogger(TableStreamInfo.class);
    ...
    public TableStreamInfo(TableIf table) {
    ...
    public boolean equals(Object o) {
        ...
        TableStreamInfo that = (TableStreamInfo) o;
        if (isInternalTable()) {
