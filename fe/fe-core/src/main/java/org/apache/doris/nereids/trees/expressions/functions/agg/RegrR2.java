...
/**
 * AggregateFunction 'regr_r2'. This class is generated by GenerateFunction.
 */
public class RegrR2 extends NullableAggregateFunction
     ...
     */
    public RegrR2(Expression arg1, Expression arg2) {
     ...
     */
    public RegrR2(boolean distinct, Expression arg1, Expression arg2) {
        this(distinct, false, arg1, arg2);
    }

    private RegrR2(boolean distinct, boolean alwaysNullable, Expression arg1, Expression arg2) {
        super("regr_r2", distinct, alwaysNullable, arg1, arg2);
    }

    @Override
    public AggregateFunction withDistinctAndChildren(boolean distinct, List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new RegrR2(distinct, alwaysNullable, children.get(0), children.get(1));
    }

    @Override
    public NullableAggregateFunction withAlwaysNullable(boolean alwaysNullable) {
        return new RegrR2(distinct, alwaysNullable, child(0), child(1));
    }
