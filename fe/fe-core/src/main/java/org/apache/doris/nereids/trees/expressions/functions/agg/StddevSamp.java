...
/**
 * AggregateFunction 'stddev_samp'. This class is generated by GenerateFunction.
 */
public class StddevSamp extends AggregateFunction
        implements UnaryExpression, ExplicitlyCastableSignature, AlwaysNullable, DecimalStddevPrecision {
     ...
     */
    public StddevSamp(Expression arg) {
        super("stddev_samp", arg);
    }

    /**
     * constructor with 1 argument.
     */
    public StddevSamp(boolean distinct, Expression arg) {
        super("stddev_samp", distinct, arg);
    }
    ...
    public StddevSamp withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        return new StddevSamp(distinct, children.get(0));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitStddevSamp(this, context);
    }
