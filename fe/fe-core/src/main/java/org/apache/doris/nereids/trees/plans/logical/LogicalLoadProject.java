...
/**
 * Logical load project plan.
 */
public class LogicalLoadProject<CHILD_TYPE extends Plan> extends LogicalUnary<CHILD_TYPE>
    ...
    public LogicalLoadProject(List<NamedExpression> projects, CHILD_TYPE child) {
        this(projects, false, ImmutableList.of(child));
    }

    public LogicalLoadProject(List<NamedExpression> projects, boolean isDistinct, List<Plan> child) {
        this(projects, isDistinct, Optional.empty(), Optional.empty(), child);
    }

    public LogicalLoadProject(List<NamedExpression> projects, boolean isDistinct, Plan child) {
    ...
    public String toString() {
        return Utils.toSqlString("LogicalLoadProject[" + id.asInt() + "]",
                "distinct", isDistinct,
                "projects", projects);
    }
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitLogicalLoadProject(this, context);
    }
    ...
    public boolean equals(Object o) {
        ...
        LogicalLoadProject<?> that = (LogicalLoadProject<?>) o;
    ...
    public void computeFd(DataTrait.Builder builder) {
        ...
        for (NamedExpression expr : getProjects()) {
            ...
            if (expr.containsUniqueScalarFunction()) {
                continue;
            }
