 ...
 */
public class Column {
    private org.apache.doris.hplsql.ColumnDefinition definition;
    private Var value;

    public Column(String name, String type, Var value) {
        this.definition = new org.apache.doris.hplsql.ColumnDefinition(name,
                org.apache.doris.hplsql.ColumnType.parse(type));
        this.value = value;
    }
    ...
    public org.apache.doris.hplsql.ColumnDefinition definition() {
        return definition;
    }
