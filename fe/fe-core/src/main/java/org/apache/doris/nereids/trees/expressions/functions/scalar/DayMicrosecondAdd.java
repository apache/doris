...
/**
 * ScalarFunction 'day_microsecond_add'.
 */
public class DayMicrosecondAdd extends ScalarFunction
    ...
    public DayMicrosecondAdd(Expression arg0, Expression arg1) {
        super("day_microsecond_add", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private DayMicrosecondAdd(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public DayMicrosecondAdd withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new DayMicrosecondAdd(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDayMicrosecondAdd(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new DayMicrosecondAdd(literal, child(1));
    }
