...
public class ComputeGroup {
    ...
    private static final String INVALID_COMPUTE_GROUP_NAME = "_invalid_compute_group_name";
    ...
    public boolean containsBackend(String computeGroupName) {
        return StringUtils.equals(this.name, computeGroupName);
    }
    ...
    public String toString() {
        return String.format("%s id=%s, name=%s", ComputeGroup.class.getSimpleName(), id, name);
    }
