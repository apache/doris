...
public class PaimonSnapshotCache {
    ...
    private static Map<SnapshotCacheKey, PaimonSchemaCacheValue> snapshotCache = Maps.newHashMap();
    // snapshotId ==> refNum
    private static Map<SnapshotCacheKey, AtomicInteger> snapshotIdRefs = Maps.newHashMap();
