...
// For stmt like:
// show export profile "/";   # list all saving export job ids
// show export profile "/10014"  # show task ids of specified job
// show export profile "/10014/e0f7390f5363419e-b416a2a79996083e/" # show instance list of the task
// show export profile "/10014/e0f7390f5363419e-b416a2a79996083e/e0f7390f5363419e-b416a2a7999" # show instance's graph
public class ShowExportProfileStmt extends ShowStmt {
    ...
    public ShowExportProfileStmt(String idPath) {
        this.idPath = idPath;
    }
    ...
    public void analyze(Analyzer analyzer) throws UserException {
        ...
        if (parts.length > 4) {
            throw new AnalysisException("Path must in format '/jobId'");
        }
    ...
    @Override
    public String toSql() {
        StringBuilder sb = new StringBuilder("SHOW EXPORT PROFILE ").append(idPath);
        return sb.toString();
    }
