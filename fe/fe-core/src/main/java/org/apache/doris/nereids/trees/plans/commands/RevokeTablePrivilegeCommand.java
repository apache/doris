...
public class RevokeTablePrivilegeCommand extends Command implements ForwardWithSync, NeedAuditEncryption{
    ...
    public void validate() throws AnalysisException
    {
        ...
        if (tablePattern != null) {
            // need to modify when grant command merged
            GrantStmt.checkTablePrivileges(privileges, tablePattern, colPrivileges);
        }
    }
