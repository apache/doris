...
/** AdaptiveTopDownRewriteJob */
public class AdaptiveTopDownRewriteJob implements RewriteJob {
    private TopDownVisitorRewriteJob visitorJob;
    private RootPlanTreeRewriteJob stackJob;

    public AdaptiveTopDownRewriteJob(TopDownVisitorRewriteJob visitorJob, RootPlanTreeRewriteJob stackJob) {
    ...
    public TopDownVisitorRewriteJob getVisitorJob() {
        return visitorJob;
    }
