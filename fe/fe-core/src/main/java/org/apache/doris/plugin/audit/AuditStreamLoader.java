...
public class AuditStreamLoader {
    ...
    private HttpURLConnection getConnection(String urlStr, String label, String clusterToken) throws IOException {
        ...
        conn.addRequestProperty("column_separator", AuditLoader.AUDIT_TABLE_COL_SEPARATOR);
        conn.addRequestProperty("line_delimiter", AuditLoader.AUDIT_TABLE_LINE_DELIMITER);
