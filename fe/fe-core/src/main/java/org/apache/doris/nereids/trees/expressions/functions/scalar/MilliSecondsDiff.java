 ...
 */
public class MilliSecondsDiff extends ScalarFunction implements BinaryExpression, ExplicitlyCastableSignature,
    ...
    private MilliSecondsDiff(ScalarFunctionParams functionParams) {
    ...
    public MilliSecondsDiff withChildren(List<Expression> children) {
        ...
        return new MilliSecondsDiff(getFunctionParams(children));
    }
