...
/**
 * ScalarFunction 'week_floor'. This class is generated by GenerateFunction.
 */
public class WeekFloor extends ScalarFunction
     ...
     */
    public WeekFloor(Expression arg) {
        super("week_floor", arg);
    }

    /**
     * constructor with 2 arguments.
     */
    public WeekFloor(Expression arg0, Expression arg1) {
        super("week_floor", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public WeekFloor(Expression arg0, Expression arg1, Expression arg2) {
     ...
     */
    @Override
    public WeekFloor withChildren(List<Expression> children) {
    ...
    public Optional<Expression> nextBucketBoundary(Literal value) {
        ...
        return Optional.of(new WeeksAdd(value, period.get()));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitWeekFloor(this, context);
    }
    ...
    public Expression withConstantArgs(Expression literal) {
        switch (arity()) {
            case 1:
                return new WeekFloor(literal);
            case 2:
                return new WeekFloor(literal, child(1));
            case 3:
                return new WeekFloor(literal, child(1), child(2));
            default:
