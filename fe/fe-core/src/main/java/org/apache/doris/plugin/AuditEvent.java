...
public class AuditEvent {
    ...
    @AuditField(value = "HitQueryCache")
    public boolean hitQueryCache = false;
    ...
    @AuditField(value = "ChangedFeConfigs")
    public String changedFeConfigs = "";
    ...
    public static class AuditEventBuilder {
        ...
        public AuditEventBuilder setHitQueryCache(boolean hitQueryCache) {
            auditEvent.hitQueryCache = hitQueryCache;
            return this;
        }
