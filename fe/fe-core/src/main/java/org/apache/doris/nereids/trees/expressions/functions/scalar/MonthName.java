...
/**
 * ScalarFunction 'monthname'. This class is generated by GenerateScalarFunction.
 */
public class MonthName extends ScalarFunction
     ...
     */
    public MonthName(Expression arg) {
        super("monthname", arg);
    }
     ...
     */
    @Override
    public MonthName withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1);
        return new MonthName(children.get(0));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitMonthName(this, context);
    }
}
