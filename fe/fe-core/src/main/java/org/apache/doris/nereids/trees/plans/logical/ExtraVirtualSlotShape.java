...
/**
 * ExtraVirtualSlot shape.
 * eg:
 * select k1 from t1 group by grouping sets((k1, k2), (k1, v1), (v2, k2));
 *
 ...
 */
public class ExtraVirtualSlotShape extends GroupingSetShape {
    // all slots in nonVirtualGroupByExpressions.
    protected final List<Expression> groupingSlots;

    public ExtraVirtualSlotShape(List<Expression> groupingSlots, List<List<Boolean>> shouldBeErasedToNull) {
    ...
    public String toString() {
        ...
        return "ExtraVirtualSlotShape(groupingSlots=["
