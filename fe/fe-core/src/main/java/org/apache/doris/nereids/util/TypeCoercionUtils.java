...
public class TypeCoercionUtils {
    ...
    public static Expression processComparisonPredicate(ComparisonPredicate comparisonPredicate) {
        ...
        Optional<DataType> commonType = findWiderTypeForTwo(left.getDataType(), right.getDataType(), false);
    ...
    public static Expression processInPredicate(InPredicate inPredicate) {
        ...
        Optional<DataType> optionalCommonType = TypeCoercionUtils.findWiderCommonType(
                fmtInPredicate.children()
                        .stream()
                        .map(Expression::getDataType).collect(Collectors.toList()), false);
    ...
    public static Expression processCaseWhen(CaseWhen caseWhen) {
        ...
        Optional<DataType> optionalCommonType = TypeCoercionUtils.findWiderCommonType(dataTypesForCoercion, false);
        return optionalCommonType
                .map(commonType -> {
