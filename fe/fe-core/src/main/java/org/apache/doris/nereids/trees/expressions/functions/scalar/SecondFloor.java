...
/**
 * ScalarFunction 'second_floor'. This class is generated by GenerateScalarFunction.
 */
public class SecondFloor extends ScalarFunction
     ...
     */
    public SecondFloor(Expression arg) {
        super("second_floor", arg);
    }

    /**
     * constructor with 2 arguments.
     */
    public SecondFloor(Expression arg0, Expression arg1) {
        super("second_floor", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public SecondFloor(Expression arg0, Expression arg1, Expression arg2) {
        super("second_floor", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public SecondFloor withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new SecondFloor(children.get(0));
        } else if (children.size() == 2) {
            return new SecondFloor(children.get(0), children.get(1));
        } else {
            return new SecondFloor(children.get(0), children.get(1), children.get(2));
        }
    }
