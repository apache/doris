...
/**
 * AggregateFunction 'entropy'. Calculates Shannon Entropy of the input values.
 */
public class Entropy extends NullableAggregateFunction implements ExplicitlyCastableSignature {
    ...
    /**
     * constructor with distinct flag and 1 or more arguments.
     */
    public Entropy(boolean distinct, Expression arg0, Expression... varArgs) {
        this(distinct, false, arg0, varArgs);
    }

    private Entropy(boolean distinct, boolean alwaysNullable, Expression arg0, Expression... varArgs) {
        super("entropy", distinct, alwaysNullable, ExpressionUtils.mergeArguments(arg0, varArgs));
    }
