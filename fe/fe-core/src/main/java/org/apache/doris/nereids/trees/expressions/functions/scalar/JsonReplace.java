 ...
 */
public class JsonReplace extends ScalarFunction implements CustomSignature, AlwaysNullable {
    ...
    public JsonReplace withChildren(List<Expression> children) {
        ...
        return new JsonReplace(children.get(0), children.get(1), children.get(2),
