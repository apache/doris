...
public class IcebergMetadataCache {
    ...
    public void init() {
        ...
        CacheFactory snapshotCacheFactory = new CacheFactory(
                ...
                true,
                null);
        this.snapshotCache = snapshotCacheFactory.buildCache(this::loadSnapshot, null, executor);
        this.viewCache = tableCacheFactory.buildCache(this::loadView, null, executor);
    }
