...
public class IcebergMetadataCache {
    ...
    public Table getIcebergTable(ExternalTable dorisTable) {
        ...
        Table table = tableCache.get(key).getIcebergTable();
        LOG.info("[BranchDebug] getIcebergTable: table={}, currentSnapshotId={}, refs={}",
                dorisTable.getName(),
    ...
    public IcebergSnapshotCacheValue getSnapshotCache(ExternalTable dorisTable) {
        ...
        return tableCacheValue.getLatestSnapshotCacheValue();
    }
    ...
    private IcebergTableCacheValue loadTableCacheValue(IcebergMetadataCacheKey key) {
        ...
        try {
            ...
            return new IcebergTableCacheValue(table,
                    () -> loadSnapshot(
                            (ExternalTable) ((ExternalCatalog) Env.getCurrentEnv().getCatalogMgr()
                                    .getCatalog(nameMapping.getCtlId()))
                                    .getDbNullable(nameMapping.getLocalDbName())
                                    .getTableNullable(nameMapping.getLocalTblName()),
                            table));
        } catch (Exception e) {
