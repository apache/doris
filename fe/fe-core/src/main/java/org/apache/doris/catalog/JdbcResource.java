...
public class JdbcResource extends Resource {
    ...
    static {
        ...
        OPTIONAL_PROPERTIES_DEFAULT_VALUE.put(CatalogProperty.ENABLE_MAPPING_TIMESTAMP_TZ, "true");
    }
    ...
    public static String getFullDriverUrl(String driverUrl) throws IllegalArgumentException {
        ...
        if (schema == null && !driverUrl.startsWith("/")) {
            ...
            // catalog is created or altered, in JdbcExternalCatalog.checkDriverUrlSecurityRule.
