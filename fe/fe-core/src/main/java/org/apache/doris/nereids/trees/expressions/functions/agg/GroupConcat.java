...
public class GroupConcat extends AggregateFunction
    ...
    public GroupConcat withDistinctAndChildren(boolean distinct, List<Expression> children) {
        ...
        List<OrderExpression> orders = Lists.newArrayList();
        ...
        for (int i = 0; i < children.size(); i++) {
            ...
            Set<OrderExpression> orderExpressionSet = child.collect(OrderExpression.class::isInstance);
            if (!orderExpressionSet.isEmpty()) {
                orders.addAll(orderExpressionSet);
                foundOrderExpr = true;
