...
public class BitmapIntersect extends AggregateFunction
     ...
     */
    public BitmapIntersect(Expression arg) {
        super("bitmap_intersect", arg);
    }

    /**
     * constructor with 1 argument.
     */
    public BitmapIntersect(boolean distinct, Expression arg) {
        this(arg);
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitBitmapIntersect(this, context);
    }
