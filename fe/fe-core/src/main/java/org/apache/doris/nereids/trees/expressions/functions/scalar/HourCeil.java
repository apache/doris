...
/**
 * ScalarFunction 'hour_ceil'. This class is generated by GenerateScalarFunction.
 */
public class HourCeil extends ScalarFunction
     ...
     */
    public HourCeil(Expression arg) {
        super("hour_ceil", arg);
    }
     ...
     */
    public HourCeil(Expression arg0, Expression arg1) {
        super("hour_ceil", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public HourCeil(Expression arg0, Expression arg1, Expression arg2) {
        super("hour_ceil", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public HourCeil withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new HourCeil(children.get(0));
        } else if (children.size() == 2) {
            return new HourCeil(children.get(0), children.get(1));
        } else {
            return new HourCeil(children.get(0), children.get(1), children.get(2));
        }
    }
