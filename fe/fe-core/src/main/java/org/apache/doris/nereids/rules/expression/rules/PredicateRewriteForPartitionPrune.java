...
public class PredicateRewriteForPartitionPrune
    ...
    @Override
    public Expression visitGreaterThan(GreaterThan greaterThan, CascadesContext context) {
    ...
    @Override
    public Expression visitGreaterThanEqual(GreaterThanEqual greaterThanEqual, CascadesContext context) {
    ...
    @Override
    public Expression visitLessThan(LessThan lessThan, CascadesContext context) {
    ...
    @Override
    public Expression visitLessThanEqual(LessThanEqual lessThanEqual, CascadesContext context) {
