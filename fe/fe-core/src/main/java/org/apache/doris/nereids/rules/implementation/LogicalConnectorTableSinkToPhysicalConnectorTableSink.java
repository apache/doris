...
/**
 * Implementation rule that converts logical ConnectorTableSink to physical ConnectorTableSink.
 */
public class LogicalConnectorTableSinkToPhysicalConnectorTableSink extends OneImplementationRuleFactory {
    @Override
    public Rule build() {
        return logicalConnectorTableSink().thenApply(ctx -> {
            LogicalConnectorTableSink<? extends Plan> sink = ctx.root;
