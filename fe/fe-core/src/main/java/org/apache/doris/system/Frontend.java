...
public class Frontend implements Writable {
    ...
    public boolean isNodeFeatureIncompatible() {
        return nodeFeatureIncompatible || !supportsNodeFeature(NodeFeature.ROW_TTL);
    }
    ...
    public boolean handleHbResponse(FrontendHbResponse hbResponse, boolean isReplay) {
        ...
        if (hbResponse.getStatus() == HbStatus.OK) {
            ...
            nodeFeatureIncompatible = !supportsNodeFeature(NodeFeature.ROW_TTL);
            ...
            heartbeatErrMsg = nodeFeatureIncompatible
                    ? "frontend does not support the required Row TTL feature" : "";
