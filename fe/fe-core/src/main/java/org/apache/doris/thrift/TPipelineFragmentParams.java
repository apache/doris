...
public class TPipelineFragmentParams implements org.apache.thrift.TBase<TPipelineFragmentParams, TPipelineFragmentParams._Fields>, java.io.Serializable, Cloneable, Comparable<TPipelineFragmentParams> {
  ...
  public TPipelineFragmentParams setDestinations(@org.apache.thrift.annotation.Nullable java.util.List<TPlanFragmentDestination> destinations) {
    this.destinations = destinations;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_exch_num_senders = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map228.size);
                int _key229;
                int _val230;
                for (int _i231 = 0; _i231 < _map228.size; ++_i231)
                {
                  ...
                  struct.per_exch_num_senders.put(_key229, _val230);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.destinations = new java.util.ArrayList<TPlanFragmentDestination>(_list232.size);
                @org.apache.thrift.annotation.Nullable TPlanFragmentDestination _elem233;
                for (int _i234 = 0; _i234 < _list232.size; ++_i234)
                {
                  _elem233 = new TPlanFragmentDestination();
                  _elem233.read(iprot);
                  struct.destinations.add(_elem233);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instances_sharing_hash_table = new java.util.ArrayList<org.apache.doris.thrift.TUniqueId>(_list235.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TUniqueId _elem236;
                for (int _i237 = 0; _i237 < _list235.size; ++_i237)
                {
                  _elem236 = new org.apache.doris.thrift.TUniqueId();
                  _elem236.read(iprot);
                  struct.instances_sharing_hash_table.add(_elem236);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.local_params = new java.util.ArrayList<TPipelineInstanceParams>(_list238.size);
                @org.apache.thrift.annotation.Nullable TPipelineInstanceParams _elem239;
                for (int _i240 = 0; _i240 < _list238.size; ++_i240)
                {
                  _elem239 = new TPipelineInstanceParams();
                  _elem239.read(iprot);
                  struct.local_params.add(_elem239);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resource_groups = new java.util.ArrayList<TPipelineResourceGroup>(_list241.size);
                @org.apache.thrift.annotation.Nullable TPipelineResourceGroup _elem242;
                for (int _i243 = 0; _i243 < _list241.size; ++_i243)
                {
                  _elem242 = new TPipelineResourceGroup();
                  _elem242.read(iprot);
                  struct.resource_groups.add(_elem242);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPipelineFragmentParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.per_exch_num_senders != null) {
        oprot.writeFieldBegin(PER_EXCH_NUM_SENDERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter244 : struct.per_exch_num_senders.entrySet())
          {
      ...
      if (struct.destinations != null) {
        oprot.writeFieldBegin(DESTINATIONS_FIELD_DESC);
        {
          ...
          for (TPlanFragmentDestination _iter245 : struct.destinations)
          {
      ...
      if (struct.instances_sharing_hash_table != null) {
        if (struct.isSetInstancesSharingHashTable()) {
          oprot.writeFieldBegin(INSTANCES_SHARING_HASH_TABLE_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TUniqueId _iter246 : struct.instances_sharing_hash_table)
            {
      ...
      if (struct.local_params != null) {
        oprot.writeFieldBegin(LOCAL_PARAMS_FIELD_DESC);
        {
          ...
          for (TPipelineInstanceParams _iter247 : struct.local_params)
          {
      ...
      if (struct.resource_groups != null) {
        if (struct.isSetResourceGroups()) {
          oprot.writeFieldBegin(RESOURCE_GROUPS_FIELD_DESC);
          {
            ...
            for (TPipelineResourceGroup _iter248 : struct.resource_groups)
            {
  ...
  private static class TPipelineFragmentParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPipelineFragmentParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPipelineFragmentParams struct) throws org.apache.thrift.TException {
      ...
      struct.query_id.write(oprot);
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter249 : struct.per_exch_num_senders.entrySet())
        {
      ...
      if (struct.isSetDestinations()) {
        {
          ...
          for (TPlanFragmentDestination _iter250 : struct.destinations)
          {
      ...
      if (struct.isSetInstancesSharingHashTable()) {
        {
          ...
          for (org.apache.doris.thrift.TUniqueId _iter251 : struct.instances_sharing_hash_table)
          {
      ...
      if (struct.isSetLocalParams()) {
        {
          ...
          for (TPipelineInstanceParams _iter252 : struct.local_params)
          {
      ...
      if (struct.isSetResourceGroups()) {
        {
          ...
          for (TPipelineResourceGroup _iter253 : struct.resource_groups)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPipelineFragmentParams struct) throws org.apache.thrift.TException {
      ...
      struct.setQueryIdIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map254 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32); 
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.destinations = new java.util.ArrayList<TPlanFragmentDestination>(_list258.size);
          @org.apache.thrift.annotation.Nullable TPlanFragmentDestination _elem259;
          for (int _i260 = 0; _i260 < _list258.size; ++_i260)
          {
            _elem259 = new TPlanFragmentDestination();
            _elem259.read(iprot);
