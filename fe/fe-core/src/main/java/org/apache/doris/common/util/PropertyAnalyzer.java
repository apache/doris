...
public class PropertyAnalyzer {
    ...
    public static final String PROPERTIES_BINLOG_ROW_TTL_ENABLED = "binlog.row_ttl_enabled";
    ...
    public static boolean analyzeEnableRowTtl(Map<String, String> properties, KeysType keysType)
        ...
        if (enabled) {
            ...
            if (!hasTtlCol && properties.containsKey(timeZoneProperty)) {
                throw new AnalysisException(timeZoneProperty + " requires function_column.ttl_col");
            }
        }
    ...
    public static Map<String, String> analyzeBinlogConfig(Map<String, String> properties) throws AnalysisException {
        ...
        if (properties.containsKey(PROPERTIES_BINLOG_ROW_TTL_ENABLED)) {
            binlogConfigMap.put(PROPERTIES_BINLOG_ROW_TTL_ENABLED,
                    properties.remove(PROPERTIES_BINLOG_ROW_TTL_ENABLED));
        }
        if (properties.containsKey(BinlogConfig.EFFECTIVE_ROW_TTL_SECONDS)) {
            binlogConfigMap.put(BinlogConfig.EFFECTIVE_ROW_TTL_SECONDS,
                    properties.remove(BinlogConfig.EFFECTIVE_ROW_TTL_SECONDS));
        }
