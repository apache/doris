...
public class PropertyAnalyzer {
    ...
    public static final String PROPERTIES_MEDIUM_ALLOCATION_POLICY = "medium_allocation_policy";
    ...
    /**
     * Validate medium allocation policy configuration consistency.
     *
     * @param policy medium allocation policy to validate
     * @param storageMedium storage medium setting
     * @throws AnalysisException if configuration is invalid
     */
    public static void validateMediumAllocationPolicy(MediumAllocationPolicy policy, TStorageMedium storageMedium)
            throws AnalysisException {
        if (policy == MediumAllocationPolicy.STRICT && storageMedium == null) {
            throw new AnalysisException(
                    "medium_allocation_policy 'strict' requires storage_medium to be specified. "
    ...
    public static DataProperty analyzeDataProperty(Map<String, String> properties, final DataProperty oldDataProperty)
        ...
        MediumAllocationPolicy mediumAllocationPolicy = oldDataProperty.getMediumAllocationPolicy();
        ...
        for (Map.Entry<String, String> entry : properties.entrySet()) {
            ...
            } else if (key.equalsIgnoreCase(PROPERTIES_MEDIUM_ALLOCATION_POLICY)) {
                try {
                    mediumAllocationPolicy = MediumAllocationPolicy.fromString(value);
                } catch (AnalysisException e) {
                    LOG.error("Failed to parse medium_allocation_policy value: '{}'. Error: {}", value, e.getMessage());
                    throw e;
                }
        ...
        properties.remove(PROPERTIES_MEDIUM_ALLOCATION_POLICY);
        ...
        // Validate medium allocation policy consistency
        validateMediumAllocationPolicy(mediumAllocationPolicy, storageMedium);
            ...
            if (checkBackends) {
                try {
                    ...
                    systemInfoService.selectBackendIdsForReplicaCreation(
                            replicaAlloc, nextIndexs, null, MediumAllocationPolicy.ADAPTIVE, true);
