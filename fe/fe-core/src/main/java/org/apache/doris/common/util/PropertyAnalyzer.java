...
public class PropertyAnalyzer {
    ...
    public static final String ENABLE_UNIQUE_KEY_REPLACE_IF_NOT_NULL = "enable_unique_key_replace_if_not_null";
    ...
    public static boolean analyzeUniqueKeyReplaceIfNotNull(Map<String, String> properties) throws AnalysisException {
        if (properties == null || properties.isEmpty()) {
            return false;
        }
        String value = properties.get(PropertyAnalyzer.ENABLE_UNIQUE_KEY_REPLACE_IF_NOT_NULL);
        if (value == null) {
            return false;
        }
        properties.remove(PropertyAnalyzer.ENABLE_UNIQUE_KEY_REPLACE_IF_NOT_NULL);
        if (value.equals("true")) {
            return true;
        } else if (value.equals("false")) {
            return false;
        }
        throw new AnalysisException(PropertyAnalyzer.ENABLE_UNIQUE_KEY_REPLACE_IF_NOT_NULL
                + " must be `true` or `false`");
    }
