...
public class UnassignedAllBEJob extends AbstractUnassignedJob {
    public UnassignedAllBEJob(PlanFragment fragment, ListMultimap<ExchangeNode, UnassignedJob> exchangeToUpstreamJob) {
        super(fragment, ImmutableList.of(), exchangeToUpstreamJob);
    }
    ...
    public List<AssignedJob> computeAssignedJobs(DistributedPlanWorkerManager workerManager,
        ...
        for (int i = 0; i < beIds.size(); ++i) {
            ...
            if (worker != null) {
                assignedJobs.add(assignWorkerAndDataSources(i, context.nextInstanceId(), worker,
