...
public class DorisTable extends Table {
    ...
    private static final String ENABLE_PARALLEL_RESULT_SINK = "enable_parallel_result_sink";
    ...
    private boolean enableParallelResultSink =
            Boolean.parseBoolean(DorisResource.ENABLE_PARALLEL_RESULT_SINK_DEFAULT_VALUE);
    ...
    public void write(DataOutput out) throws IOException {
        ...
        serializeMap.put(ENABLE_PARALLEL_RESULT_SINK, String.valueOf(enableParallelResultSink));
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        enableParallelResultSink = serializeMap.get(ENABLE_PARALLEL_RESULT_SINK) != null
            ? Boolean.parseBoolean(serializeMap.get(ENABLE_PARALLEL_RESULT_SINK))
            : Boolean.parseBoolean(DorisResource.ENABLE_PARALLEL_RESULT_SINK_DEFAULT_VALUE);
