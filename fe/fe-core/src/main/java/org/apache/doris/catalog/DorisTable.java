...
public class DorisTable extends Table {
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        maxExecBeNum = serializeMap.get(MAX_EXEC_BE_NUM) != null ? Integer.parseInt(serializeMap.get(MAX_EXEC_BE_NUM)) : Integer.parseInt(DorisResource.MAX_EXEC_BE_NUM_DEFAULT_VALUE);
        httpSslEnabled = serializeMap.get(HTTP_SSL_ENABLED) != null ? Boolean.parseBoolean(serializeMap.get(HTTP_SSL_ENABLED)) : Boolean.parseBoolean(DorisResource.HTTP_SSL_ENABLED_DEFAULT_VALUE);
