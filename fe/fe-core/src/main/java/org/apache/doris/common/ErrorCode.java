...
public enum ErrorCode {
    ...
    ERROR_DYNAMIC_PARTITION_RESERVED_HISTORY_STARTS_EMPTY(5076, new byte[] {'4', '2', '0', '0', '0'},
            "Dynamic reserved history starts is empty."),
    ERROR_DYNAMIC_PARTITION_RESERVED_HISTORY_ENDS_EMPTY(5077, new byte[] {'4', '2', '0', '0', '0'},
            "Dynamic reserved history ends is empty."),
    ERROR_DYNAMIC_PARTITION_RESERVED_HISTORY_STARTS_ENDS_LENGTH_NOT_EQUAL(5078, new byte[] {'4', '2', '0', '0', '0'},
            "RESERVED_HISTORY_STARTS and RESERVED_HISTORY_ENDS should have the same length. RESERVED_HISTORY_STARTS length: %s, RESERVED_HISTORY_STARTS length: %s."),
    ERROR_DYNAMIC_PARTITION_RESERVED_HISTORY_STARTS_LARGER_THAN_ENDS(5079, new byte[] {'4', '2', '0', '0', '0'},
            "RESERVED_HISTORY_STARTS %s is larger than RESERVED_HISTORY_ENDS %s."),
