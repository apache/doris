...
public enum ErrorCode {
    ...
    ERR_SUM_REQUIRES_NUMERIC_OR_BOOLEAN(9000, new byte[]{'4', '2', '0', '0', '0'},
            "Sum requires a numeric or boolean parameter"),
    ERR_SQL_PARSING_ERROR(9001, new byte[]{'4', '2', '0', '0', '0'}, "Please check your SQL"),
    ERR_UNSUPPORTED_HIVE_INPUT_FORMAT(9002, new byte[]{'4', '2', '0', '0', '0'},
            "Not Supported: Unsupported hive input format: %s"),
    ERR_NOT_IN_AGGREGATE_OUTPUT(9003, new byte[]{'4', '2', '0', '0', '0'}, "Not in aggregate's output"),
    ERR_NEREIDS_TIMEOUT(9004, new byte[]{'4', '2', '0', '0', '0'}, "Nereids cost too much time (> 30s)"),
    ERR_INVALID_CALL_TO_SLOT(9005, new byte[]{'4', '2', '0', '0', '0'},
            "Invalid call to toSlot on unbound object"),
    ERR_GET_FILE_SPLIT_FAILED_FOR_TABLE(9006, new byte[]{'4', '2', '0', '0', '0'},
            "Get file split failed for table '%s'"),
    ERR_FAILED_TO_OPEN_TRANSACTION(9007, new byte[]{'4', '2', '0', '0', '0'},
            "Failed to open transaction, because %s "),
    ERR_CONFIG_NOT_MUTABLE(9008, new byte[]{'4', '2', '0', '0', '0'}, "Config '%s' is not mutable"),
    ERR_CATALOG_ALREADY_EXISTS(9009, new byte[]{'4', '2', '0', '0', '0'},
            "Catalog already exists with name '%s'"),
    ERR_COMPATIBILITY_FUNCTION_SIGNATURE_NOT_FOUND(9010, new byte[]{'4', '2', '0', '0', '0'},
            "Cannot find the compatibility function signature: %s"),
    ERR_BACKEND_PROCESS_EPOCH_CHANGED(9011, new byte[]{'4', '2', '0', '0', '0'},
            "Backend process epoch changed"),
    ERR_BACKEND_ERROR(9012, new byte[]{'4', '2', '0', '0', '0'}, "Backend [id=%s] encountered an error"),
    ERR_SHOULD_BE_GROUPED_BY(9013, new byte[]{'4', '2', '0', '0', '0'},
            "'%s' should be grouped by."),
    ERR_FAILED_TO_CONNECT_BACKEND(9014, new byte[]{'4', '2', '0', '0', '0'},
            "[%s] Failed to connect to backend %s: [E110] Fail to connect Socket"),
    ERR_FETCH_SPLIT_BATCH_INTERNAL_ERROR(9015, new byte[]{'4', '2', '0', '0', '0'},
            "[%s] Failed to get batch of split source: Internal error processing fetchSplitBatch"),
    ERR_FAILED_TO_INIT_READER(9016, new byte[]{'4', '2', '0', '0', '0'},
            "[%s] Failed to initialize reader"),
    ERR_MINORGC_KILL_OVERCOMMIT_QUERY(9017, new byte[]{'4', '2', '0', '0', '0'},
            "[%s] MinorGC killed overcommit query"),
    ERR_PROCESS_MEMORY_NOT_ENOUGH_CANCEL_QUERY(9018, new byte[]{'4', '2', '0', '0', '0'},
            "[%s] Process memory not enough"),
    ERR_CREATE_EXPR_MEM_ALLOC_FAILED(9019, new byte[]{'4', '2', '0', '0', '0'},
            "[%s][MEM_ALLOC_FAILED] Create Expr failed because [E11] Allocator sys memory check failed"),
    ERR_PRECATCH_MEM_LIMIT_EXCEEDED(9020, new byte[]{'4', '2', '0', '0', '0'},
            "[%s][MEM_LIMIT_EXCEEDED] PreCatch error code: %d"),
    ERR_FAILED_TO_SEND_BRPC_HOST_DOWN(9021, new byte[]{'4', '2', '0', '0', '0'},
            "[%s][CANCELLED] Failed to send brpc when exchange"),
    ERR_HYPERSCAN_ERROR(9022, new byte[]{'4', '2', '0', '0', '0'},
            "[%s][CANCELLED] Hyperscan error: %d"),
    ERR_CANCELLED(9023, new byte[]{'4', '2', '0', '0', '0'}, "[%s][CANCELLED] Cancelled'"),
    ERR_ORC_ROW_READER_NEXTBATCH_FAILED(9024, new byte[]{'4', '2', '0', '0', '0'},
            "[%s][CANCELLED] Current path: %s. Orc row reader nextBatch failed. "
                    + "Reason: Failed to read hdfs://%s [INTERNAL_ERROR] Read hdfs file failed. (BE: %s) namenode: %s"),
    ERR_FULLGC_RELEASE_OVERCOMMIT_MEM(9025, new byte[]{'4', '2', '0', '0', '0'},
            "[%s][CANCELLED] FullGC released overcommit memory for wg"),
    ERR_CANNOT_BUILD_QUERY_TABLE_VALUED_FUNCTION(9026, new byte[]{'4', '2', '0', '0', '0'},
            "Cannot build QueryTableValuedFunction by query %s, msg: %s"),
    ERR_SYNTAX_ERROR(9027, new byte[]{'4', '2', '0', '0', '0'}, "Syntax error"),
    ERR_UMATCHED_STRING_LITERAL(9028, new byte[]{'4', '2', '0', '0', '0'}, "Unmatched string literal"),
    ERR_ILLEGAL_STATE_EXCEPTION(9029, new byte[]{'4', '2', '0', '0', '0'},
            "IllegalStateException, msg: Incomplete escape sequence"),
    ERR_SEND_FRAGMENTS_FAILED(9030, new byte[]{'4', '2', '0', '0', '0'}, "send fragments failed. "),
    ERR_USER_CANCELED(9031, new byte[]{'4', '2', '0', '0', '0'}, "user cancel"),
    ERR_FAILED_TO_COMMIT_TRANSACTION(9032, new byte[]{'4', '2', '0', '0', '0'},
            "Failed to commit transaction, txnid: %d, msg: %s "),
    ERR_FAILED_TO_ACQUIRE_LOCK(9033, new byte[]{'4', '2', '0', '0', '0'},
            "Failed to acquire lock, txnid: %d, lock in state: %s "),
    ...
    ERR_MetaException(9077, new byte[]{'4', '2', '0', '0', '0'},
        "failed to get table %s"),
    ERR_QUERY_TIMEOUT(9078, new byte[]{'4', '2', '0', '0', '0'}, "Query timeout"),
    ERR_USER_CANCEL(9079, new byte[]{'4', '2', '0', '0', '0'}, "User cancel query"),
    ERR_READ_HDFS_FILE_FAILED_CN(9080, new byte[]{'4', '2', '0', '0', '0'}, "Read hdfs file failed"),
    ERR_WORK_POOL_OFFER_FAILED(9081, new byte[]{'4', '2', '0', '0', '0'}, "Fail to offer request to the work pool"),
    ERR_QUERY_CANCELLED(9082, new byte[]{'4', '2', '0', '0', '0'}, "Query is cancelled"),
    ERR_COLUMN_MUST_WITH_SPEC_FUNC(9083, new byte[]{'4', '2', '0', '0', '0'}, "Column must use with specific function"),
    ERR_SUBMIT_SCANNER_FAILED(9084, new byte[]{'4', '2', '0', '0', '0'}, "Failed to submit scanner to scanner pool reason"),
    ERR_REGEX_COMPILE_FAILED(9085, new byte[]{'4', '2', '0', '0', '0'}, "Could not compile regexp pattern"),
    ERR_UDF_EVALUATE_FAILED_CN(9086, new byte[]{'4', '2', '0', '0', '0'}, "UDF failed to evaluate"),
    ERR_PRUNE_HIVE_PARTITIONS_FAILED(9087, new byte[]{'4', '2', '0', '0', '0'}, "Prune hive partitions failed"),
    ERR_INFINITY_RESULT_INVALID(9088, new byte[]{'4', '2', '0', '0', '0'}, "Infinity result is invalid"),
    ERR_INVALID_DATE_LITERAL(9089, new byte[]{'4', '2', '0', '0', '0'}, "Date/datetime literal is invalid"),
    ERR_INVALID_REGEX_EXPRESSION(9090, new byte[]{'4', '2', '0', '0', '0'}, "Invalid regex expression"),
    ERR_BUILD_TVF_BY_PARTITION_VALUES_FAILED(9091, new byte[]{'4', '2', '0', '0', '0'}, "Can not build PartitionsTableValuedFunction by partition_values"),
    ERR_DATE_TRUNC_SECOND_PARAM_UNSUPPORTED(9092, new byte[]{'4', '2', '0', '0', '0'}, "date_trunc function second param only support argument is year|quarter|month|week|day|hour|minute|second"),
    ERR_CAST_TEXT_TO_UNSUPPORTED(9093, new byte[]{'4', '2', '0', '0', '0'}, "Can not cast from origin type TEXT to target type=UNSUPPORTED"),
    ERR_CONN_RESET_BY_PEER(9094, new byte[]{'4', '2', '0', '0', '0'}, "Doris process failed: Connection reset by peer"),
    ERR_CATALOG_NOT_EXIST_CN(9095, new byte[]{'4', '2', '0', '0', '0'}, "Catalog .* does not exist"),
    ERR_DECODE_URL_FAILED(9096, new byte[]{'4', '2', '0', '0', '0'}, "Decode url failed"),
    ERR_THRIFT_DESERIALIZE_FAILED(9097, new byte[]{'4', '2', '0', '0', '0'}, "Couldn't deserialize thrift msg"),
    ERR_COLUMN_TYPE_NOT_MATCH(9098, new byte[]{'4', '2', '0', '0', '0'}, "Column_type not match"),
    ERR_GROUP_BY_NOT_CONTAIN_AGG(9099, new byte[]{'4', '2', '0', '0', '0'}, "GROUP BY expression must not contain aggregate functions"),
    ERR_REQUIRED_QUERY_ID_NOT_PRESENT(9100, new byte[]{'4', '2', '0', '0', '0'}, "Required field 'queryId' was not present"),
    ERR_MAX_EXPRESSION_TREE(9101, new byte[]{'4', '2', '0', '0', '0'}, "Maximum expression tree"),
    ERR_SUBSTRING_INDEX(9102, new byte[]{'4', '2', '0', '0', '0'}, "substring_index"),
    ERR_QUERY_QUEUE_TIMEOUT(9103, new byte[]{'4', '2', '0', '0', '0'}, "Query queue timeout"),
    ERR_NO_TABLE_AUTH(9104, new byte[]{'4', '2', '0', '0', '0'}, "No table auth"),
    ERR_CAST_ARRAY_FAILED(9105, new byte[]{'4', '2', '0', '0', '0'}, "Can not cast from origin type ARRAY"),
    ERR_INVALID_JSON_PATH_VALUE(9106, new byte[]{'4', '2', '0', '0', '0'}, "Json path error: Invalid Json Path for value"),
    ERR_BROKEN_PIPE(9107, new byte[]{'4', '2', '0', '0', '0'}, "Doris process failed: Broken pipe"),
    ERR_UNKNOWN_ERROR_255(9108, new byte[]{'4', '2', '0', '0', '0'}, "Unknown error 255"),
    ERR_ANALYSIS_ERR_CN(9109, new byte[]{'4', '2', '0', '0', '0'}, "Analysis err"),
    ERR_LZO_DECOMPRESS_FAILED(9110, new byte[]{'4', '2', '0', '0', '0'}, "Lzo decompression failed: MalformedInputException"),
    ERR_LOWEST_COST_PLANS(9111, new byte[]{'4', '2', '0', '0', '0'}, "LowestCostPlans with physicalProperties"),
    ERR_INVALID_CALL(9112, new byte[]{'4', '2', '0', '0', '0'}, "Invalid call to"),
    ERR_GC_WG_HARD_LIMIT(9113, new byte[]{'4', '2', '0', '0', '0'}, "GC wg for hard limit"),
    ERR_EXPECT_EQ1_BY_EXPR(9114, new byte[]{'4', '2', '0', '0', '0'}, "Expected EQ 1 to be returned by expression"),
    ERR_TABLE_NOT_FOUND_CN(9115, new byte[]{'4', '2', '0', '0', '0'}, "Table not found"),
    ERR_AGG_FUNC_CONTAIN_AGG_PARAMS(9116, new byte[]{'4', '2', '0', '0', '0'}, "Aggregate function cannot contain aggregate parameters"),
    ERR_OPERANDS_UNEQUAL_COLUMNS(9117, new byte[]{'4', '2', '0', '0', '0'}, "Operands have unequal number of columns"),
    ERR_UNSUPPORT_CHUBAOFs(9118, new byte[]{'4', '2', '0', '0', '0'}, "Unsupport chubaofs"),
    ERR_EXCEED_MAX_BYTES_SINGLE_HUDI(9119, new byte[]{'4', '2', '0', '0', '0'}, "Exceed max bytes for single hive/hudi table"),
    ERR_RETURN_TYPE_NULLABLE(9120, new byte[]{'4', '2', '0', '0', '0'}, "Return type is Nullable"),
    ERR_COUNT_DISTINCT_TYPE_UNSUPPORTED(9121, new byte[]{'4', '2', '0', '0', '0'}, "COUNT DISTINCT could not process type"),
    ERR_CANNOT_CAST_TO_STRUCTTYPE(9122, new byte[]{'4', '2', '0', '0', '0'}, "Cannot be cast to class org.apache.doris.nereids.types.StructType"),
    ERR_LOGICAL_PROJECT_TGF(9123, new byte[]{'4', '2', '0', '0', '0'}, "LOGICAL_PROJECT can not contains TableGeneratingFunction expression"),
    ERR_LEFT_OUTER_JOIN_NEED_ON(9124, new byte[]{'4', '2', '0', '0', '0'}, "LEFT OUTER JOIN requires an ON or USING clause"),
    ERR_NO_SUCH_FILE_OR_DIR(9125, new byte[]{'4', '2', '0', '0', '0'}, "No such file or directory"),
    ERR_WINDOWFRAME_NEED_ORDERBY(9126, new byte[]{'4', '2', '0', '0', '0'}, "WindowFrame clause requires OrderBy clause"),
    ERR_LOGICAL_PROJECT_NO_ANALYTIC(9127, new byte[]{'4', '2', '0', '0', '0'}, "Analytic function is not allowed in LOGICAL_PROJECT"),
    ERR_EXCEEDED_MAX_CHILD_EXPR(9128, new byte[]{'4', '2', '0', '0', '0'}, "Exceeded the maximum number of child expressions"),
    ERR_UNKNOWN_LAMBDA_SLOT(9129, new byte[]{'4', '2', '0', '0', '0'}, "Unknown lambda slot"),
    ERR_UNSUPPORTED_ORDER_BY_EXPR(9130, new byte[]{'4', '2', '0', '0', '0'}, "Doesn't support order by expression"),
    ERR_NO_MATCHING_FUNCTION_SIGNATURE(9131, new byte[]{'4', '2', '0', '0', '0'}, "No matching function with signature"),
    ERR_STRING_CANNOT_CAST_TO_DOUBLE(9132, new byte[]{'4', '2', '0', '0', '0'}, "String cannot be cast to double"),
    ERR_EXPECTING_SCALE(9133, new byte[]{'4', '2', '0', '0', '0'}, "IllegalArgumentException: Expecting scale"),
    ERR_NO_COLUMN_PERMISSION(9134, new byte[]{'4', '2', '0', '0', '0'}, "Has no permission on column"),
    ERR_TYPE_UNSUPPORTED_FOR_NEREIDS(9135, new byte[]{'4', '2', '0', '0', '0'}, "Type UNSUPPORTED is unsupported for Nereids"),
    ERR_REQUESTED_URL_404(9136, new byte[]{'4', '2', '0', '0', '0'}, "The requested URL returned error: 404"),
    ERR_FAILED_OPEN_INPUT_STREAM(9137, new byte[]{'4', '2', '0', '0', '0'}, "Failed to open input stream for file, such as avro..."),
    ERR_LOGICAL_SORT_CANNOT_CONTAINS(9138, new byte[]{'4', '2', '0', '0', '0'}, "LOGICAL_SORT can not contains"),
    ERR_COORDINATOR_DEAD(9139, new byte[]{'4', '2', '0', '0', '0'}, "Coordinator dead"),
    ERR_SELECT_ITEM_IN_CORRELATED_SUBQUERY(9140, new byte[]{'4', '2', '0', '0', '0'}, "The select item in correlated subquery"),
    ERR_ARITHMETIC_OVERFLOW(9141, new byte[]{'4', '2', '0', '0', '0'}, "Arithmetic overflow when converting value"),
    ERR_TABLE_FUNCTION_OUTPUT_EMPTY(9142, new byte[]{'4', '2', '0', '0', '0'}, "Output slots of table function node is empty"),
    ERR_NO_VALUE_PRESENT(9143, new byte[]{'4', '2', '0', '0', '0'}, "No value present"),
    ERR_CAST_MAP_FAILED(9144, new byte[]{'4', '2', '0', '0', '0'}, "Can not cast from origin type MAP"),
    ERR_STRING_COLUMN_LENGTH_TOO_LARGE(9145, new byte[]{'4', '2', '0', '0', '0'}, "String column length is too large"),
    ERR_LOGICAL_FILTER_CONTAIN_AGG_FUNC(9146, new byte[]{'4', '2', '0', '0', '0'}, "LOGICAL_FILTER can not contains AggregateFunction expression"),
    ERR_CANT_SUPPORT_MULTI_DISTINCT(9147, new byte[]{'4', '2', '0', '0', '0'}, "Can't support multi distinct"),
    ERR_DISTINCT_NOT_ALLOWED_IN_ANALYTIC(9148, new byte[]{'4', '2', '0', '0', '0'}, "DISTINCT not allowed in analytic function"),
    ERR_FUNCTION_EQ_GET_FAILED(9149, new byte[]{'4', '2', '0', '0', '0'}, "Function eq get failed"),
    ERR_FAILED_FETCH_INTERNAL_SQL_RESULT(9150, new byte[]{'4', '2', '0', '0', '0'}, "Failed to fetch internal SQL result"),
    ERR_REGION_DATA_NOT_READY(9151, new byte[]{'4', '2', '0', '0', '0'}, "Region data is not ready"),
    ERR_GROUPING_OR_AGG_LOGICAL_PROJECT(9152, new byte[]{'4', '2', '0', '0', '0'}, "Grouping and/or aggregation LogicalProject"),
    ERR_UNKNOWN_QUALIFIER(9153, new byte[]{'4', '2', '0', '0', '0'}, "Unknown qualifier"),
    ERR_COUNT_OR_SUM_DISTINCT_MULTI_COLUMNS(9154, new byte[]{'4', '2', '0', '0', '0'}, "Count or sum distinct have multi columns"),
    ERR_SCALAR_SUBQUERY_PREDICATE_MUST_EQ(9155, new byte[]{'4', '2', '0', '0', '0'}, "Scalar subquery's correlatedPredicates's operator must be EQ"),
    ERR_GET_NEXT_ROW_ARRAY_INDEX_OOBE(9156, new byte[]{'4', '2', '0', '0', '0'}, "Failed to get next row of data. CAUSED BY: ArrayIndexOutOfBoundsException"),
    ERR_SUBQUERY_MULTI_COLUMNS_NOT_SUPPORTED(9157, new byte[]{'4', '2', '0', '0', '0'}, "Multiple columns returned by subquery are not yet supported"),
    ERR_REMOTE_TABLE_STORAGE_INPUT_FORMAT_NULL(9158, new byte[]{'4', '2', '0', '0', '0'}, "Remote table.* storage input format is null"),
    ERR_QUERY_WAIT_QUEUE_FULL(9159, new byte[]{'4', '2', '0', '0', '0'}, "Query waiting queue is full"),
    ERR_EXPR_TREE_TOO_DEEP(9160, new byte[]{'4', '2', '0', '0', '0'}, "The depth of the expression tree is too big, make it less than"),
    ERR_OUT_OF_BOUNDS_FOR_LENGTH(9161, new byte[]{'4', '2', '0', '0', '0'}, "Out of bounds for length"),
    ERR_LOGICAL_HAVING_CONTAIN_WINDOW_EXPR(9162, new byte[]{'4', '2', '0', '0', '0'}, "LOGICAL_HAVING can not contains WindowExpression expression"),
    ERR_COMPARISON_PREDICATE_NOT_CONTAIN_COMPLEX_TYPE(9163, new byte[]{'4', '2', '0', '0', '0'}, "Comparison predicate could not contains complex type"),
    ERR_CANNOT_CONVERT_INF_OR_NAN_TO_DECIMAL(9164, new byte[]{'4', '2', '0', '0', '0'}, "Cannot convert infinity or NaN to decimal"),
    ERR_AGG_FUNCTION_NOT_IMPLEMENTED(9165, new byte[]{'4', '2', '0', '0', '0'}, "Agg Function .* is not implemented"),
    ERR_DATE_TRUNC_SECOND_PARAM_MUST_STRING_CONST(9166, new byte[]{'4', '2', '0', '0', '0'}, "The second parameter of date_trunc function must be a string constant: date_trunc"),
    ERR_HUDI_JNI_SCANNER_GET_NEXT_FAILED(9167, new byte[]{'4', '2', '0', '0', '0'}, "Failed to get next in hadoop hudi jni scanner"),
    ERR_CASTEXPR_CANNOT_CAST_TO_LITERAL(9168, new byte[]{'4', '2', '0', '0', '0'}, "CastExpr cannot be cast to class org.apache.doris.analysis.LiteralExp"),
    ERR_EMPTY_ERROR(9169, new byte[]{'4', '2', '0', '0', '0'}, "Empty error"),
    ERR_HUDI_PRIMARY_KEY_NOT_SET(9170, new byte[]{'4', '2', '0', '0', '0'}, "Primary key is not set in hudi table"),
    ERR_CONVERT_HIVE_PARTITION_FAILED(9171, new byte[]{'4', '2', '0', '0', '0'}, "Failed to convert hive partition"),
    ERR_REQUIRES_NUMERIC_PARAMETER(9172, new byte[]{'4', '2', '0', '0', '0'}, "Requires a numeric parameter"),
    ERR_LOGICAL_FILTER_CONTAIN_WINDOW_EXPR(9173, new byte[]{'4', '2', '0', '0', '0'}, "LOGICAL_FILTER can not contains WindowExpression expression"),
    ...
    ERR_SQL_BLOCK_RULE_HIT(9183, new byte[]{'4', '2', '0', '0', '0'}, "SQL is blocked by SQL block rule: %s");
