...
public class SlotRef extends Expr {
    ...
    public boolean columnEqual(Expr srcExpr) {
        ...
        if (srcColumnName == null && srcSlotRef.desc != null
                && srcSlotRef.getDesc().getColumn() != null) {
        ...
        if (thisColumnName != null
                && !thisColumnName.toLowerCase().equals(srcColumnName.toLowerCase())) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return Objects
                .hashCode((tblName == null ? "" : tblName.toSql() + "." + label).toLowerCase());
    }
