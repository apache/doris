...
public abstract class BaseAnalysisTask {
    ...
    protected static final String INSERT_PART_STATISTICS = "INSERT INTO "
            ...
            + " SELECT "
            + "CONCAT(${tblId}, '-', ${idxId}, '-', '${colName}', '-', ${partId}) AS id, "
    ...
    protected static final String INSERT_COL_STATISTICS = "INSERT INTO "
            ...
            + "        ndv, null_count, min, max, data_size, update_time, catalog_name, db_name, tbl_name \n"
            + "    FROM \n"
            + "     (SELECT CONCAT(${tblId}, '-', ${idxId}, '-', '${colName}') AS id, "
            + "         ${catalogId} AS catalog_id, "
            + "         ${dbId} AS db_id, "
            + "         ${tblId} AS tbl_id, "
            + "         ${idxId} AS idx_id, "
            ...
            + "     ${internalDB}.${columnStatTbl}.col_id='${colName}' AND "
