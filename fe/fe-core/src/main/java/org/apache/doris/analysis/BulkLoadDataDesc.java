 ...
 */
public class BulkLoadDataDesc implements InsertStmt.DataDesc {
    ...
    public BulkLoadDataDesc(String tableName,
    ...
    public BulkLoadDataDesc(TableName tableName,
                            PartitionNames partitionNames,
                            String file,
                            boolean clientLocal,
                            List<String> columns,
    ...
    public BulkLoadDataDesc(String tableName, LoadTaskInfo taskInfo) {
        this.tableName = tableName;
