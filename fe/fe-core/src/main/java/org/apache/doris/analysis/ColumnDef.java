...
// Syntax:
//      name type [key] [agg_type] [NULL | NOT NULL] [AUTO_INCREMENT] [ENABLE_DICT_ENCODING] [DEFAULT default_value] [comment]
// Example:
...
public class ColumnDef {
    ...
    public void setEnableDictEncoding(boolean enableDictEncoding) {
    ...
    public Column toColumn() {
        ...
        return new Column(name, type, isKey, aggregateType, isAllowNull, isAutoInc, enableDictEncoding,
                defaultValue.value, comment, visible, defaultValue.defaultValueExprDef,
