...
public class K8sDeployManager extends DeployManager {
    ...
    private List<SystemInfoService.HostInfo> getGroupHostInfosByStatefulSet(NodeType nodeType) {
    ...
    private List<SystemInfoService.HostInfo> getGroupHostInfosByEndpoint(NodeType nodeType) {
        // get portName
        ...
        for (EndpointSubset subset : subsets) {
            ...
            for (EndpointAddress eaddr : addrs) {
                result.add(
                        new SystemInfoService.HostInfo(eaddr.getIp(), getDomainName(eaddr.getHostname(), serviceName),
                                port));
            }
        }
