...
/**
 * ScalarFunction for approx distance
 */
public abstract class ApproxVectorDistanceFunc extends ScalarFunction
    ...
    public ApproxVectorDistanceFunc(String name, Expression arg0, Expression arg1) {
    ...
    public abstract void checkVectorRange(Expression expr) throws AnalysisIllegalParamException;
}
