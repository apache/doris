...
/**
 * Job that used to swap filter and project.
 */
public class SwapFilterAndProjectJob extends BatchRulesJob {
    /**
     * Execute the merge consecutive job.
     * @param ctx planner context for execute job
     */
    public SwapFilterAndProjectJob(CascadesContext ctx) {
        //TODO: eliminate consecutive projects for view
        super(ctx);
        rulesJob.addAll(ImmutableList.of(
                bottomUpBatch(ImmutableList.of(
                        new SwapFilterAndProject()))));
    }
}
