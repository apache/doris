...
public class ShowExecutor {
    ...
    private void handleShowProc() throws AnalysisException {
        ...
        if (procNode instanceof BackendsProcDir) {
            if (!Env.getCurrentEnv().getAccessCtlMgr().checkGlobalPriv(ConnectContext.get(), PrivPredicate.OPERATOR)) {
                // hide host info
    ...
    private void handleShowDb() throws AnalysisException {
        ...
        for (String fullName : dbNames) {
            ...
            if (!Env.getCurrentEnv().getAccessCtlMgr().checkDbPriv(ConnectContext.get(), showDbStmt.getCatalogName(),
