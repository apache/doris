...
public class PhysicalPaimonTableSink<CHILD_TYPE extends Plan>
    ...
    public PhysicalPaimonTableSink(PaimonExternalDatabase database,
                                    ...
                                    CHILD_TYPE child) {
        super(PlanType.PHYSICAL_PAIMON_TABLE_SINK, outputExprs, groupExpression,
                logicalProperties, physicalProperties, connectContext, cols, child);
    ...
    public Plan withChildren(List<Plan> children) {
        return AbstractPlan.copyWithSameId(this, () ->
                new PhysicalPaimonTableSink<>(database, targetTable, cols, outputExprs,
    ...
    public PhysicalPaimonTableSink<Plan> withPhysicalPropertiesAndStats(
            PhysicalProperties physicalProperties, org.apache.doris.statistics.Statistics stats) {
        return AbstractPlan.copyWithSameId(this, () ->
                new PhysicalPaimonTableSink<>(database, targetTable, cols, outputExprs,
                        groupExpression, getLogicalProperties(),
                        physicalProperties, connectContext, child()));
