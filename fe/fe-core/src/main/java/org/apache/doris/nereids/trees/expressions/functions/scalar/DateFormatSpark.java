...
/**
 * ScalarFunction 'date_format_spark'.
 */
public class DateFormatSpark extends ScalarFunction
     ...
     */
    public DateFormatSpark(Expression arg0, Expression arg1) {
        super("date_format_spark", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private DateFormatSpark(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public DateFormatSpark withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new DateFormatSpark(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDateFormatSpark(this, context);
    }
    ...
    public Expression withConstantArgs(Expression literal) {
        return new DateFormatSpark(literal, child(1));
    }
}
