...
public class DynamicPartitionProperty {
    ...
    public static final String STORAGE_COLD_MEDIUM = "dynamic_partition.storage_cold_medium";
    ...
    public DynamicPartitionProperty(Map<String, String> properties) {
        if (properties != null && !properties.isEmpty()) {
            ...
            this.storageMedium = TStorageMedium.valueOf(properties.getOrDefault(STORAGE_MEDIUM, "SSD"));
            this.storageColdMedium = TStorageMedium.valueOf(properties.getOrDefault(STORAGE_COLD_MEDIUM, "HDD"));
