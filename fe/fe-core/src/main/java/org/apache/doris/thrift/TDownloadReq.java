            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map124.size);
                ...
                for (int _i127 = 0; _i127 < _map124.size; ++_i127)
                {
                  ...
                  struct.src_dest_map.put(_key125, _val126);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map128.size);
                ...
                for (int _i131 = 0; _i131 < _map128.size; ++_i131)
                {
                  ...
                  struct.broker_prop.put(_key129, _val130);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter132 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBrokerProp()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter133 : struct.broker_prop.entrySet())
            {
  ...
  private static class TDownloadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDownloadReq> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      struct.setJobIdIsSet(true);
      {
        ...
        struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map136.size);
        ...
        for (int _i139 = 0; _i139 < _map136.size; ++_i139)
        {
          ...
          struct.src_dest_map.put(_key137, _val138);
        }
      }
      struct.setSrcDestMapIsSet(true);
      struct.broker_addr = new org.apache.doris.thrift.TNetworkAddress();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map140.size);
          ...
          for (int _i143 = 0; _i143 < _map140.size; ++_i143)
          {
            ...
            struct.broker_prop.put(_key141, _val142);
          }
        }
        struct.setBrokerPropIsSet(true);
      }
