...
public class TOlapTableIndexSchema implements org.apache.thrift.TBase<TOlapTableIndexSchema, TOlapTableIndexSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TOlapTableIndexSchema> {
  ...
  static {
    ...
    tmpMap.put(_Fields.INDEXES_DESC, new org.apache.thrift.meta_data.FieldMetaData("indexes_desc", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "TOlapTableIndex"))));
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_desc = new java.util.ArrayList<TColumn>(_list83.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem84;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes_desc = new java.util.ArrayList<TOlapTableIndex>(_list86.size);
                @org.apache.thrift.annotation.Nullable TOlapTableIndex _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = new TOlapTableIndex();
                  _elem87.read(iprot);
                  struct.indexes_desc.add(_elem87);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns_desc != null) {
        if (struct.isSetColumnsDesc()) {
          oprot.writeFieldBegin(COLUMNS_DESC_FIELD_DESC);
          {
            ...
            for (TColumn _iter90 : struct.columns_desc)
            {
              _iter90.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.indexes_desc != null) {
        if (struct.isSetIndexesDesc()) {
          oprot.writeFieldBegin(INDEXES_DESC_FIELD_DESC);
          {
            ...
            for (TOlapTableIndex _iter91 : struct.indexes_desc)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TOlapTableIndexSchemaTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableIndexSchema> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTableIndexSchema struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.id);
      {
        ...
        for (java.lang.String _iter92 : struct.columns)
        {
      ...
      if (struct.isSetColumnsDesc()) {
        {
          ...
          for (TColumn _iter93 : struct.columns_desc)
          {
            _iter93.write(oprot);
          }
        }
      ...
      if (struct.isSetIndexesDesc()) {
        {
          ...
          for (TOlapTableIndex _iter94 : struct.indexes_desc)
          {
            _iter94.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableIndexSchema struct) throws org.apache.thrift.TException {
      ...
      struct.setIdIsSet(true);
      {
        ...
        struct.columns = new java.util.ArrayList<java.lang.String>(_list95.size);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.columns_desc = new java.util.ArrayList<TColumn>(_list98.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem99;
          for (int _i100 = 0; _i100 < _list98.size; ++_i100)
          {
            _elem99 = new TColumn();
            _elem99.read(iprot);
            struct.columns_desc.add(_elem99);
          }
        }
        struct.setColumnsDescIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.indexes_desc = new java.util.ArrayList<TOlapTableIndex>(_list101.size);
          @org.apache.thrift.annotation.Nullable TOlapTableIndex _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = new TOlapTableIndex();
            _elem102.read(iprot);
