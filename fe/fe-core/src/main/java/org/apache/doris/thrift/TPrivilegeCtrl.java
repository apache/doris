...
public class TPrivilegeCtrl implements org.apache.thrift.TBase<TPrivilegeCtrl, TPrivilegeCtrl._Fields>, java.io.Serializable, Cloneable, Comparable<TPrivilegeCtrl> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.cols = new java.util.HashSet<java.lang.String>(2*_set300.size);
      ...
      if (struct.cols != null) {
        if (struct.isSetCols()) {
          oprot.writeFieldBegin(COLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter303 : struct.cols)
            {
  ...
  private static class TPrivilegeCtrlTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPrivilegeCtrl> {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (java.lang.String _iter304 : struct.cols)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPrivilegeCtrl struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TSet _set305 = iprot.readSetBegin(org.apache.thrift.protocol.TType.STRING);
          struct.cols = new java.util.HashSet<java.lang.String>(2*_set305.size);
