...
/**
 * function builder for python udaf
 */
public class PythonUdafBuilder extends UdfBuilder {
    private final PythonUdaf udaf;
    private final int arity;
    private final boolean isVarArgs;

    public PythonUdafBuilder(PythonUdaf udaf) {
        this.udaf = udaf;
