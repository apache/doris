...
public class ShowCreateStorageVaultCommand extends ShowCommand {
    ...
    public ShowResultSet doRun(ConnectContext ctx, StmtExecutor executor) throws Exception {
        ...
        String createStmt = "";
        if (storageVaultPB.get().getHdfsInfo() != null) {
            createStmt = getHdfsCreateStmt(storageVaultPB.get().getHdfsInfo());
        }
        if (storageVaultPB.get().getObjInfo() != null) {
    ...
    private String getHdfsCreateStmt(Cloud.HdfsVaultInfo hdfsInfo) {
        ...
        properties.put("path_prefix", getPathPrefix(hdfsInfo.getPrefix()));
    ...
    private String getPathPrefix(String prefix) {
        Pattern pattern = Pattern.compile("^(.*?)(?:_[^_]+){1}$");
