...
/**
 * ScalarFunction 'minute_floor'. This class is generated by GenerateScalarFunction.
 */
public class MinuteFloor extends ScalarFunction
     ...
     */
    public MinuteFloor(Expression arg) {
        super("minute_floor", arg);
    }

    /**
     * constructor with 2 arguments.
     */
    public MinuteFloor(Expression arg0, Expression arg1) {
        super("minute_floor", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public MinuteFloor(Expression arg0, Expression arg1, Expression arg2) {
        super("minute_floor", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public MinuteFloor withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new MinuteFloor(children.get(0));
        } else if (children.size() == 2) {
            return new MinuteFloor(children.get(0), children.get(1));
        } else {
            return new MinuteFloor(children.get(0), children.get(1), children.get(2));
        }
    }
