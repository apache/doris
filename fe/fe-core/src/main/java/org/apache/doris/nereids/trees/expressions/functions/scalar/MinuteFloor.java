...
public class MinuteFloor extends ScalarFunction
    ...
    private MinuteFloor(ScalarFunctionParams functionParams) {
    ...
    public MinuteFloor withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        return new MinuteFloor(getFunctionParams(children));
    }
    ...
    public Optional<Expression> nextBucketBoundary(Literal value) {
        ...
        return Optional.of(new MinutesAdd(value, period.get()));
    }
