...
import org.apache.doris.nereids.trees.expressions.functions.CalendarCeilMonotonic;
...
public class MonthCeil extends ScalarFunction
        implements ExplicitlyCastableSignature, PropagateNullLiteral, PropagateNullable, CalendarCeilMonotonic {
    ...
    private static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            FunctionSignature.ret(TimeStampTzType.WILDCARD).args(TimeStampTzType.WILDCARD, TimeStampTzType.WILDCARD),
            FunctionSignature.ret(TimeStampTzType.WILDCARD).args(TimeStampTzType.WILDCARD, IntegerType.INSTANCE),
     ...
     */
    public MonthCeil(Expression arg) {
        super("month_ceil", arg);
    }

    /**
     * constructor with 2 arguments.
     */
    public MonthCeil(Expression arg0, Expression arg1) {
        super("month_ceil", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public MonthCeil(Expression arg0, Expression arg1, Expression arg2) {
        super("month_ceil", arg0, arg1, arg2);
    }

    /** constructor for withChildren and reuse signature */
    private MonthCeil(ScalarFunctionParams functionParams) {
     ...
     */
    @Override
    public MonthCeil withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        return new MonthCeil(getFunctionParams(children));
    }
