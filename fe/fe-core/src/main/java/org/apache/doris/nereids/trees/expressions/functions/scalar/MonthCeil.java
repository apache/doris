...
/**
 * ScalarFunction 'month_ceil'. This class is generated by GenerateScalarFunction.
 */
public class MonthCeil extends ScalarFunction
    ...
    public MonthCeil withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                ...
                || children.size() == 3);
        if (children.size() == 1) {
            return new MonthCeil(children.get(0));
        } else if (children.size() == 2) {
            return new MonthCeil(children.get(0), children.get(1));
        } else {
            return new MonthCeil(children.get(0), children.get(1), children.get(2));
        }
    }
