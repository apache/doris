...
public abstract class StringLikeLiteral extends Literal implements ComparableLiteral {
    ...
    protected Expression uncheckedCastTo(DataType targetType) throws AnalysisException {
        ...
        if (targetType.isDateType() || targetType.isDateV2Type()) {
            ...
            return new TimestampTzLiteral(expression.year, expression.month, expression.day,
                    expression.hour, expression.minute, expression.second, expression.microSecond);
