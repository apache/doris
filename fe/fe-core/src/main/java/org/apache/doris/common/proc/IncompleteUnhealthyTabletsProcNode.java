...
public class IncompleteUnhealthyTabletsProcNode implements ProcNodeInterface {
    ...
    public IncompleteUnhealthyTabletsProcNode(Database db) {
        this.db = db;
    }

    @Override
    public ProcResult fetchResult() throws AnalysisException {
        ClusterHealthProcDir.DBTabletStatistic statistic = new ClusterHealthProcDir.DBTabletStatistic(db);
