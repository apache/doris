...
/**
 * ScalarFunction 'day_minute_add'.
 */
public class DayMinuteAdd extends ScalarFunction
    ...
    public DayMinuteAdd(Expression arg0, Expression arg1) {
        super("day_minute_add", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private DayMinuteAdd(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public DayMinuteAdd withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new DayMinuteAdd(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitDayMinuteAdd(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new DayMinuteAdd(literal, child(1));
    }
