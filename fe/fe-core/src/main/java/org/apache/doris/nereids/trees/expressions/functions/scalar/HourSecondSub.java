...
/**
 * ScalarFunction 'hour_second_sub'.
 */
public class HourSecondSub extends ScalarFunction
    ...
    public HourSecondSub(Expression arg0, Expression arg1) {
        super("hour_second_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private HourSecondSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public HourSecondSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new HourSecondSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitHourSecondSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new HourSecondSub(literal, child(1));
    }
