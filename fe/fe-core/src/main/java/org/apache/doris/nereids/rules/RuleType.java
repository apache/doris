...
public enum RuleType {
    ...
    BINDING_INSERT_TRINO_CONNECTOR_TABLE(RuleTypeClass.REWRITE),
    ...
    LOGICAL_TRINO_CONNECTOR_TABLE_SINK_TO_PHYSICAL_TRINO_CONNECTOR_TABLE_SINK_RULE(RuleTypeClass.IMPLEMENTATION),
