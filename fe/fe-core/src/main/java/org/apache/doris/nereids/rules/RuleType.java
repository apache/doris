...
public enum RuleType {
    ...
    BINDING_EXTERNAL_ROW_LEVEL_DELETE_SINK_OUTPUT(RuleTypeClass.REWRITE),
    BINDING_EXTERNAL_ROW_LEVEL_MERGE_SINK_OUTPUT(RuleTypeClass.REWRITE),
    ...
    REORDER_JOIN_BEFORE_EAGER_AGG(RuleTypeClass.REWRITE),
    ...
    LOGICAL_EXTERNAL_ROW_LEVEL_DELETE_SINK_TO_PHYSICAL_EXTERNAL_ROW_LEVEL_DELETE_SINK_RULE(
            RuleTypeClass.IMPLEMENTATION),
    LOGICAL_EXTERNAL_ROW_LEVEL_MERGE_SINK_TO_PHYSICAL_EXTERNAL_ROW_LEVEL_MERGE_SINK_RULE(
            RuleTypeClass.IMPLEMENTATION),
    ...
    STORAGE_LAYER_PARTITION_VALUE_WITH_FILTER_FOR_FILE_SCAN(RuleTypeClass.IMPLEMENTATION),
    STORAGE_LAYER_PARTITION_VALUE_WITH_PROJECT_FILTER_FOR_FILE_SCAN(RuleTypeClass.IMPLEMENTATION),
