...
public enum RuleType {
    ...
    BINDING_GROUP_BY_SLOT(RuleTypeClass.REWRITE),
    BINDING_GROUP_BY_FUNCTION(RuleTypeClass.REWRITE),
    RESOLVE_HAVING_GROUP_BY(RuleTypeClass.REWRITE),
    GROUP_BY_RESOLVE(RuleTypeClass.REWRITE),
    UPDATE_AGG_GROUP_BY_WITH_GROUPING(RuleTypeClass.REWRITE),
    ...
    COLUMN_PRUNE_GROUP_BY_CHILD(RuleTypeClass.REWRITE),
    ...
    LOGICAL_ROLLUP_TO_PHYSICAL_ROLLUP_RULE(RuleTypeClass.IMPLEMENTATION),
    LOGICAL_CUBE_TO_PHYSICAL_CUBE_RULE(RuleTypeClass.IMPLEMENTATION),
