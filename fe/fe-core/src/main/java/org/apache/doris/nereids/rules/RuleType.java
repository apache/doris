...
public enum RuleType {
    ...
    STORAGE_LAYER_AGGREGATE(RuleTypeClass.IMPLEMENTATION),
    DISASSEMBLE_ONE_PHASE_AGGREGATE(RuleTypeClass.IMPLEMENTATION),
    DISASSEMBLE_TWO_PHASE_AGGREGATE(RuleTypeClass.IMPLEMENTATION),
    DISASSEMBLE_THREE_PHASE_AGGREGATE(RuleTypeClass.IMPLEMENTATION),
