...
public enum RuleType {
    ...
    // Make sure OUTPUT_PRUNING is behind MERGE_PROJECTS, so invoke OUTPUT_PRUNING first
    // Make sure OUTPUT_PRUNING is behind ELIMINATE_UNNECESSARY_PROJECT, so invoke OUTPUT_PRUNING first
    OUTPUT_PRUNING(RuleTypeClass.REWRITE),
    // Make sure ADD_PROJECT_TO_CHILD is behind OUTPUT_PRUNING, so invoke ADD_PROJECT_TO_CHILD first
    ADD_PROJECT_TO_CHILD(RuleTypeClass.REWRITE),
