...
public enum RuleType {
    ...
    LOGICAL_CTE_PRODUCE_TO_PHYSICAL_CTE_PRODUCE_RULE(RuleTypeClass.IMPLEMENTATION),
    LOGICAL_CTE_CONSUME_TO_PHYSICAL_CTE_CONSUME_RULE(RuleTypeClass.IMPLEMENTATION),
