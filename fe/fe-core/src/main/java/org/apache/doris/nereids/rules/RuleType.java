...
public enum RuleType {
    ...
    MASKING_OPTIMIZER(RuleTypeClass.REWRITE),
    ...
    HMS_SCAN_PARTITION_PRUNE(RuleTypeClass.REWRITE),
    ...
    REWRITE_COUNT_AGG_TO_FILE_SCAN(RuleTypeClass.REWRITE),
    ...
    STORAGE_LAYER_AGGREGATE_COUNT_FROM_METADATA_FOR_FILE_SCAN(RuleTypeClass.IMPLEMENTATION),
