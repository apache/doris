...
public enum RuleType {
    ...
    ADD_PROJECT_FOR_NON_FOLDABLE_GENERATE(RuleTypeClass.REWRITE),
    ADD_PROJECT_FOR_NON_FOLDABLE_ONE_ROW_RELATION(RuleTypeClass.REWRITE),
    ADD_PROJECT_FOR_NON_FOLDABLE_PROJECT(RuleTypeClass.REWRITE),
    ADD_PROJECT_FOR_NON_FOLDABLE_FILTER(RuleTypeClass.REWRITE),
    ADD_PROJECT_FOR_NON_FOLDABLE_HAVING(RuleTypeClass.REWRITE),
