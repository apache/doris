...
public class NumericArithmetic {
     ...
     */
    @ExecFunction(varArgs = false, name = "add", argTypes = {"TINYINT", "TINYINT"}, returnType = "SMALLINT")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"TINYINT", "SMALLINT"}, returnType = "INT")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"TINYINT", "INT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"TINYINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression addTinyIntBigInt(TinyIntLiteral first, BigIntLiteral second) {
        long result = Math.addExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"TINYINT", "LARGEINT"}, returnType = "LARGEINT")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"SMALLINT", "TINYINT"}, returnType = "INT")
    public static Expression addSmallIntTinyInt(SmallIntLiteral first, TinyIntLiteral second) {
        int result = Math.addExact(first.getValue(), second.getValue());
        return new IntegerLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"SMALLINT", "SMALLINT"}, returnType = "INT")
    public static Expression addSmallIntSmallInt(SmallIntLiteral first, SmallIntLiteral second) {
        int result = Math.addExact(first.getValue(), second.getValue());
        return new IntegerLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"SMALLINT", "INT"}, returnType = "BIGINT")
    public static Expression addSmallIntInt(SmallIntLiteral first, IntegerLiteral second) {
        long result = Math.addExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"SMALLINT", "BIGINT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"SMALLINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression addSmallIntLargeInt(SmallIntLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().add(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"INT", "TINYINT"}, returnType = "BIGINT")
    public static Expression addIntTinyInt(IntegerLiteral first, TinyIntLiteral second) {
        long result = Math.addExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"INT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression addIntSmallInt(IntegerLiteral first, SmallIntLiteral second) {
        long result = Math.addExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"INT", "INT"}, returnType = "BIGINT")
    public static Expression addIntInt(IntegerLiteral first, IntegerLiteral second) {
        long result = Math.addExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"INT", "BIGINT"}, returnType = "BIGINT")
    public static Expression addIntBigInt(IntegerLiteral first, BigIntLiteral second) {
        long result = Math.addExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"INT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression addIntLargeInt(IntegerLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().add(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"BIGINT", "TINYINT"}, returnType = "BIGINT")
    public static Expression addBigIntTinyInt(BigIntLiteral first, TinyIntLiteral second) {
        long result = Math.addExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"BIGINT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression addBigIntSmallInt(BigIntLiteral first, SmallIntLiteral second) {
        long result = Math.addExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"BIGINT", "INT"}, returnType = "BIGINT")
    public static Expression addBigIntInt(BigIntLiteral first, IntegerLiteral second) {
        long result = Math.addExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"BIGINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression addBigIntBigInt(BigIntLiteral first, BigIntLiteral second) {
        long result = Math.addExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"BIGINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression addBigIntLargeInt(BigIntLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().add(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"LARGEINT", "TINYINT"}, returnType = "LARGEINT")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"LARGEINT", "SMALLINT"}, returnType = "LARGEINT")
    public static Expression addLargeIntSmallInt(LargeIntLiteral first, SmallIntLiteral second) {
        BigInteger result = first.getValue().add(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"LARGEINT", "INT"}, returnType = "LARGEINT")
    public static Expression addLargeIntInt(LargeIntLiteral first, IntegerLiteral second) {
        BigInteger result = first.getValue().add(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"LARGEINT", "BIGINT"}, returnType = "LARGEINT")
    public static Expression addLargeIntBigInt(LargeIntLiteral first, BigIntLiteral second) {
        BigInteger result = first.getValue().add(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"LARGEINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression addLargeIntLargeInt(LargeIntLiteral first, LargeIntLiteral second) {
        BigInteger result = first.getValue().add(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "add", argTypes = {"DOUBLE", "DOUBLE"}, returnType = "DOUBLE")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"DECIMALV2", "DECIMALV2"}, returnType = "DECIMALV2")
    ...
    @ExecFunction(varArgs = false, name = "add", argTypes = {"DECIMALV3", "DECIMALV3"}, returnType = "DECIMALV3")
     ...
     */
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"TINYINT", "TINYINT"}, returnType = "SMALLINT")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"TINYINT", "SMALLINT"}, returnType = "INT")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"TINYINT", "INT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"TINYINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression subtractTinyIntBigInt(TinyIntLiteral first, BigIntLiteral second) {
        long result = Math.subtractExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"TINYINT", "LARGEINT"}, returnType = "LARGEINT")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"SMALLINT", "TINYINT"}, returnType = "INT")
    public static Expression subtractSmallIntTinyInt(SmallIntLiteral first, TinyIntLiteral second) {
        int result = Math.subtractExact(first.getValue(), second.getValue());
        return new IntegerLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"SMALLINT", "SMALLINT"}, returnType = "INT")
    public static Expression subtractSmallIntSmallInt(SmallIntLiteral first, SmallIntLiteral second) {
        int result = Math.subtractExact(first.getValue(), second.getValue());
        return new IntegerLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"SMALLINT", "INT"}, returnType = "BIGINT")
    public static Expression subtractSmallIntInt(SmallIntLiteral first, IntegerLiteral second) {
        long result = Math.subtractExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"SMALLINT", "BIGINT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"SMALLINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression subtractSmallIntLargeInt(SmallIntLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().subtract(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"INT", "TINYINT"}, returnType = "BIGINT")
    public static Expression subtractIntTinyInt(IntegerLiteral first, TinyIntLiteral second) {
        long result = Math.subtractExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"INT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression subtractIntSmallInt(IntegerLiteral first, SmallIntLiteral second) {
        long result = Math.subtractExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"INT", "INT"}, returnType = "BIGINT")
    public static Expression subtractIntInt(IntegerLiteral first, IntegerLiteral second) {
        long result = Math.subtractExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"INT", "BIGINT"}, returnType = "BIGINT")
    public static Expression subtractIntBigInt(IntegerLiteral first, BigIntLiteral second) {
        long result = Math.subtractExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"INT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression subtractIntLargeInt(IntegerLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().subtract(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"BIGINT", "TINYINT"}, returnType = "BIGINT")
    public static Expression subtractBigIntTinyInt(BigIntLiteral first, TinyIntLiteral second) {
        long result = Math.subtractExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"BIGINT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression subtractBigIntSmallInt(BigIntLiteral first, SmallIntLiteral second) {
        long result = Math.subtractExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"BIGINT", "INT"}, returnType = "BIGINT")
    public static Expression subtractBigIntInt(BigIntLiteral first, IntegerLiteral second) {
        long result = Math.subtractExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"BIGINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression subtractBigIntBigInt(BigIntLiteral first, BigIntLiteral second) {
        long result = Math.subtractExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"BIGINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression subtractBigIntLargeInt(BigIntLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().subtract(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"LARGEINT", "TINYINT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"LARGEINT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression subtractLargeIntSmallInt(LargeIntLiteral first, SmallIntLiteral second) {
        BigInteger result = first.getValue().subtract(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"LARGEINT", "INT"}, returnType = "BIGINT")
    public static Expression subtractLargeIntInt(LargeIntLiteral first, IntegerLiteral second) {
        BigInteger result = first.getValue().subtract(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"LARGEINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression subtractLargeIntBigInt(LargeIntLiteral first, BigIntLiteral second) {
        BigInteger result = first.getValue().subtract(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"LARGEINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression subtractLargeIntLargeInt(LargeIntLiteral first, LargeIntLiteral second) {
        BigInteger result = first.getValue().subtract(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"DOUBLE", "DOUBLE"}, returnType = "DOUBLE")
    public static Expression subtractDoubleDouble(DoubleLiteral first, DoubleLiteral second) {
        double result = first.getValue() - second.getValue();
        return new DoubleLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"DECIMALV2", "DECIMALV2"}, returnType = "DECIMALV2")
    ...
    @ExecFunction(varArgs = false, name = "subtract", argTypes = {"DECIMALV3", "DECIMALV3"}, returnType = "DECIMALV3")
     ...
     */
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"TINYINT", "TINYINT"}, returnType = "SMALLINT")
    ...
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"TINYINT", "SMALLINT"}, returnType = "INT")
    ...
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"TINYINT", "INT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"TINYINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression multiplyTinyIntBigInt(TinyIntLiteral first, BigIntLiteral second) {
        long result = Math.multiplyExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"TINYINT", "LARGEINT"}, returnType = "LARGEINT")
    ...
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"SMALLINT", "TINYINT"}, returnType = "INT")
    public static Expression multiplySmallIntTinyInt(SmallIntLiteral first, TinyIntLiteral second) {
        int result = Math.multiplyExact(first.getValue(), second.getValue());
        return new IntegerLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"SMALLINT", "SMALLINT"}, returnType = "INT")
    public static Expression multiplySmallIntSmallInt(SmallIntLiteral first, SmallIntLiteral second) {
        int result = Math.multiplyExact(first.getValue(), second.getValue());
        return new IntegerLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"SMALLINT", "INT"}, returnType = "BIGINT")
    public static Expression multiplySmallIntInt(SmallIntLiteral first, IntegerLiteral second) {
        long result = Math.multiplyExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"SMALLINT", "BIGINT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"SMALLINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression multiplySmallIntLargeInt(SmallIntLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().multiply(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"INT", "TINYINT"}, returnType = "BIGINT")
    public static Expression multiplyIntTinyInt(IntegerLiteral first, TinyIntLiteral second) {
        long result = Math.multiplyExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"INT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression multiplyIntSmallInt(IntegerLiteral first, SmallIntLiteral second) {
        long result = Math.multiplyExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"INT", "INT"}, returnType = "BIGINT")
    public static Expression multiplyIntInt(IntegerLiteral first, IntegerLiteral second) {
        long result = Math.multiplyExact((long) first.getValue(), (long) second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"INT", "BIGINT"}, returnType = "BIGINT")
    public static Expression multiplyIntBigInt(IntegerLiteral first, BigIntLiteral second) {
        long result = Math.multiplyExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"INT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression multiplyIntLargeInt(IntegerLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().multiply(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"BIGINT", "TINYINT"}, returnType = "BIGINT")
    public static Expression multiplyBigIntTinyInt(BigIntLiteral first, TinyIntLiteral second) {
        long result = Math.multiplyExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"BIGINT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression multiplyBigIntSmallInt(BigIntLiteral first, SmallIntLiteral second) {
        long result = Math.multiplyExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"BIGINT", "INT"}, returnType = "BIGINT")
    public static Expression multiplyBigIntInt(BigIntLiteral first, IntegerLiteral second) {
        long result = Math.multiplyExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"BIGINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression multiplyBigIntBigInt(BigIntLiteral first, BigIntLiteral second) {
        long result = Math.multiplyExact(first.getValue(), second.getValue());
        return new BigIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"BIGINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression multiplyBigIntLargeInt(BigIntLiteral first, LargeIntLiteral second) {
        BigInteger result = second.getValue().multiply(new BigInteger(first.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"LARGEINT", "TINYINT"}, returnType = "BIGINT")
    ...
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"LARGEINT", "SMALLINT"}, returnType = "BIGINT")
    public static Expression multiplyLargeIntSmallInt(LargeIntLiteral first, SmallIntLiteral second) {
        BigInteger result = first.getValue().multiply(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"LARGEINT", "INT"}, returnType = "BIGINT")
    public static Expression multiplyLargeIntInt(LargeIntLiteral first, IntegerLiteral second) {
        BigInteger result = first.getValue().multiply(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"LARGEINT", "BIGINT"}, returnType = "BIGINT")
    public static Expression multiplyLargeIntBigInt(LargeIntLiteral first, BigIntLiteral second) {
        BigInteger result = first.getValue().multiply(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"LARGEINT", "LARGEINT"}, returnType = "LARGEINT")
    public static Expression multiplyLargeIntLargeInt(LargeIntLiteral first, LargeIntLiteral second) {
        BigInteger result = first.getValue().multiply(new BigInteger(second.getValue().toString()));
        return new LargeIntLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"DOUBLE", "DOUBLE"}, returnType = "DOUBLE")
    public static Expression multiplyDoubleDouble(DoubleLiteral first, DoubleLiteral second) {
        double result = first.getValue() * second.getValue();
        return new DoubleLiteral(result);
    }

    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"DECIMALV2", "DECIMALV2"}, returnType = "DECIMALV2")
     ...
     */
    @ExecFunction(varArgs = false, name = "multiply", argTypes = {"DECIMALV3", "DECIMALV3"}, returnType = "DECIMALV3")
     ...
     */
    @ExecFunction(varArgs = false, name = "divide", argTypes = {"DOUBLE", "DOUBLE"}, returnType = "DOUBLE")
     ...
     * Executable arithmetic functions divide
     */
    @ExecFunction(varArgs = false, name = "divide", argTypes = {"DECIMALV2", "DECIMALV2"}, returnType = "DECIMALV2")
     ...
     */
    @ExecFunction(varArgs = false, name = "divide", argTypes = {"DECIMALV3", "DECIMALV3"}, returnType = "DECIMALV3")
