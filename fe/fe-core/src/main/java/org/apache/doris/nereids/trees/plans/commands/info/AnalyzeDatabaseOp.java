 ...
 * AnalyzeDatabaseOp
 */
public class AnalyzeDatabaseOp extends AnalyzeOp {
    ...
    public AnalyzeDatabaseOp(String ctlName, String dbName, AnalyzeProperties analyzeProperties) {
        super(analyzeProperties, PlanType.ANALYZE_DATABASE);
