...
public interface InternalHttpClientProvider {
    ...
    /** Opens the URL returned by {@link #normalizeInternalUrl(String, Target)} without rewriting it. */
    HttpURLConnection openConnection(String normalizedUrl, Target target) throws IOException;
