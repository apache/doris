            ...
            .put("events",
                    new SchemaTable(SystemIdGenerator.getNextId(), "events", TableType.SCHEMA,
                            builder().column("EVENT_CATALOG", ScalarType.createVarchar(64))
                                    ...
                                    .column("DATABASE_COLLATION", ScalarType.createVarchar(32)).build()))
            .put("profiling",
                new SchemaTable(SystemIdGenerator.getNextId(), "profiling", TableType.SCHEMA,
                    builder().column("QUERY_ID", ScalarType.createType(PrimitiveType.BIGINT))
                        .column("SEQ", ScalarType.createType(PrimitiveType.BIGINT))
                        .column("STATE", ScalarType.createVarchar(30))
                        .column("DURATION", ScalarType.createType(PrimitiveType.DECIMALV2))
                        .column("CPU_USER", ScalarType.createType(PrimitiveType.DECIMALV2))
                        .column("CPU_SYSTEM", ScalarType.createType(PrimitiveType.DECIMALV2))
                        ...
                        .column("SOURCE_LINE", ScalarType.createType(PrimitiveType.BIGINT)).build()))
