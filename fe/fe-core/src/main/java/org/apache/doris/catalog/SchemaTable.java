    ...
    public static Map<String, Table> TABLE_MAP = ImmutableMap.<String, Table>builder().put("tables",
            ...
            .put("processlist", new SchemaTable(SystemIdGenerator.getNextId(), "processlist", TableType.SCHEMA,
                    builder().column("CURRENT_CONNECTED", ScalarType.createVarchar(16))
                            ...
                            .column("USER", ScalarType.createVarchar(32)).column("HOST", ScalarType.createVarchar(261))
                            .column("LOGIN_TIME", ScalarType.createType(PrimitiveType.DATETIMEV2))
                            .column("CATALOG", ScalarType.createVarchar(64)).column("DB", ScalarType.createVarchar(64))
