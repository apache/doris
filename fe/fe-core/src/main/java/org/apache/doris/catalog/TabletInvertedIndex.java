...
public class TabletInvertedIndex {
    ...
    public static final int TABLET_REPORT_PARALLELISM = 10;

    private ForkJoinPool tabletReportPool = new ForkJoinPool(TABLET_REPORT_PARALLELISM);
