...
public class FunctionSet<T> {
    ...
    private static final Map<Type, String> MIN_INIT_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.BOOLEAN, "8min_initIN9doris_udf10BooleanValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.TINYINT, "8min_initIN9doris_udf10TinyIntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.SMALLINT, "8min_initIN9doris_udf11SmallIntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.INT, "8min_initIN9doris_udf6IntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.BIGINT, "8min_initIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.FLOAT, "8min_initIN9doris_udf8FloatValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DOUBLE, "8min_initIN9doris_udf9DoubleValEEEvPNS2_15FunctionContextEPT_")
            // .put(Type.CHAR,
            // "3minIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.VARCHAR, "8min_initIN9doris_udf9StringValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.STRING, "8min_initIN9doris_udf9StringValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DATE, "8min_initIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DATETIME, "8min_initIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DECIMALV2,
                    "8min_initIN9doris_udf12DecimalV2ValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.LARGEINT, "8min_initIN9doris_udf11LargeIntValEEEvPNS2_15FunctionContextEPT_")
            .build();

    private static final Map<Type, String> MAX_INIT_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.BOOLEAN, "8max_initIN9doris_udf10BooleanValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.TINYINT, "8max_initIN9doris_udf10TinyIntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.SMALLINT, "8max_initIN9doris_udf11SmallIntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.INT, "8max_initIN9doris_udf6IntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.BIGINT, "8max_initIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.FLOAT, "8max_initIN9doris_udf8FloatValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DOUBLE, "8max_initIN9doris_udf9DoubleValEEEvPNS2_15FunctionContextEPT_")
            // .put(Type.CHAR,
            // "3minIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.VARCHAR, "8max_initIN9doris_udf9StringValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.STRING, "8max_initIN9doris_udf9StringValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DATE, "8max_initIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DATETIME, "8max_initIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.DECIMALV2,
                    "8max_initIN9doris_udf12DecimalV2ValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.LARGEINT, "8max_initIN9doris_udf11LargeIntValEEEvPNS2_15FunctionContextEPT_")
            .build();

    private static final Map<Type, String> MIN_UPDATE_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.BOOLEAN, "3minIN9doris_udf10BooleanValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.TINYINT, "3minIN9doris_udf10TinyIntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.SMALLINT, "3minIN9doris_udf11SmallIntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.INT, "3minIN9doris_udf6IntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.BIGINT, "3minIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.FLOAT, "3minIN9doris_udf8FloatValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DOUBLE, "3minIN9doris_udf9DoubleValEEEvPNS2_15FunctionContextERKT_PS6_")
            // .put(Type.CHAR,
            // "3minIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.VARCHAR, "3minIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.STRING, "3minIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DATE, "3minIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DATETIME, "3minIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DECIMALV2,
    ...
    private static final Map<Type, String> MAX_UPDATE_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.BOOLEAN, "3maxIN9doris_udf10BooleanValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.TINYINT, "3maxIN9doris_udf10TinyIntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.SMALLINT, "3maxIN9doris_udf11SmallIntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.INT, "3maxIN9doris_udf6IntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.BIGINT, "3maxIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.FLOAT, "3maxIN9doris_udf8FloatValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DOUBLE, "3maxIN9doris_udf9DoubleValEEEvPNS2_15FunctionContextERKT_PS6_")
            // .put(Type.CHAR,
            // "3maxIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.VARCHAR, "3maxIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.STRING, "3maxIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DATE, "3maxIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DATETIME, "3maxIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextERKT_PS6_")
            .put(Type.DECIMALV2,
    ...
    private static final Map<Type, Type> MULTI_DISTINCT_SUM_RETURN_TYPE = ImmutableMap
            .<Type, Type>builder().put(Type.TINYINT, Type.BIGINT).put(Type.SMALLINT, Type.BIGINT)
            .put(Type.INT, Type.BIGINT).put(Type.BIGINT, Type.BIGINT).put(Type.FLOAT, Type.DOUBLE)
            .put(Type.DOUBLE, Type.DOUBLE).put(Type.LARGEINT, Type.LARGEINT)
            .put(Type.DECIMALV2, Type.DECIMALV2).build();

    private static final Map<Type, String> MULTI_DISTINCT_INIT_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> MULTI_DISTINCT_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> MULTI_DISTINCT_MERGE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> MULTI_DISTINCT_SERIALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> MULTI_DISTINCT_COUNT_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> MULTI_DISTINCT_SUM_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.BIGINT,
    ...
    private static final Map<Type, Type> STDDEV_RETTYPE_SYMBOL = ImmutableMap.<Type, Type>builder()
            .put(Type.TINYINT, Type.DOUBLE).put(Type.SMALLINT, Type.DOUBLE)
            .put(Type.INT, Type.DOUBLE).put(Type.BIGINT, Type.DOUBLE).put(Type.FLOAT, Type.DOUBLE)
            .put(Type.DOUBLE, Type.DOUBLE).put(Type.DECIMALV2, Type.DECIMALV2).build();

    private static final Map<Type, String> STDDEV_INIT_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.TINYINT, "14knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .put(Type.SMALLINT, "14knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .put(Type.INT, "14knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .put(Type.BIGINT, "14knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .put(Type.FLOAT, "14knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .put(Type.DOUBLE, "14knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .put(Type.DECIMALV2,
                    "24decimalv2_knuth_var_initEPN9doris_udf15FunctionContextEPNS1_9StringValE")
            .build();

    private static final Map<Type, String> STDDEV_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> STDDEV_REMOVE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
            ...
            .build();
    private static final Map<Type, String> STDDEV_MERGE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
                    "15knuth_var_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_")
            .put(Type.SMALLINT,
                    "15knuth_var_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_")
            .put(Type.INT, "15knuth_var_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_")
            .put(Type.BIGINT,
                    "15knuth_var_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_")
            .put(Type.FLOAT,
                    "15knuth_var_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_")
    ...
    private static final Map<Type, String> STDDEV_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> STDDEV_GET_VALUE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> STDDEV_POP_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> STDDEV_POP_GET_VALUE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> VAR_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
                    "18knuth_var_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.SMALLINT,
                    "18knuth_var_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.INT, "18knuth_var_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.BIGINT,
                    "18knuth_var_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.FLOAT, "18knuth_var_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.DOUBLE,
                    "18knuth_var_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.DECIMALV2,
    ...
    private static final Map<Type, String> VAR_GET_VALUE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
                    "19knuth_var_get_valueEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.SMALLINT,
                    "19knuth_var_get_valueEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.INT, "19knuth_var_get_valueEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.BIGINT,
                    "19knuth_var_get_valueEPN9doris_udf15FunctionContextERKNS1_9StringValE")
            .put(Type.FLOAT,
                    "19knuth_var_get_valueEPN9doris_udf15FunctionContextERKNS1_9StringValE")
    ...
    private static final Map<Type, String> VAR_POP_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> VAR_POP_GET_VALUE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> HLL_UPDATE_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.BOOLEAN,
    ...
    private static final Map<Type, String> HLL_UNION_AGG_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.VARCHAR,
    ...
    private static final Map<Type, String> OFFSET_FN_INIT_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.BOOLEAN,
            ...
            .put(Type.DATETIME,
                    "14offset_fn_initIN9doris_udf11DateTimeValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.INT, "14offset_fn_initIN9doris_udf6IntValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.FLOAT, "14offset_fn_initIN9doris_udf8FloatValEEEvPNS2_15FunctionContextEPT_")
            .put(Type.BIGINT,
    ...
    private static final Map<Type, String> OFFSET_FN_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.BOOLEAN,
            ...
            .put(Type.STRING,
                    "16offset_fn_updateIN9doris_udf9StringValEEEvPNS2_15FunctionContextERKT_RKNS2_9BigIntValES8_PS6_")
            .put(Type.LARGEINT, "16offset_fn_updateIN9doris_udf11LargeIntValEEEvPNS2_15"
                    + "FunctionContextERKT_RKNS2_9BigIntValES8_PS6_")
            .build();

    private static final Map<Type, String> LAST_VALUE_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.BOOLEAN,
    ...
    private static final Map<Type, String> FIRST_VALUE_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.BOOLEAN,
    ...
    private static final Map<Type, String> ORTHOGONAL_BITMAP_INTERSECT_INIT_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> ORTHOGONAL_BITMAP_INTERSECT_SERIALIZE_SYMBOL =
            ImmutableMap.<Type, String>builder().put(Type.TINYINT,
    ...
    private static final Map<Type, String> BITMAP_UNION_INT_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> BITMAP_INTERSECT_INIT_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> BITMAP_INTERSECT_UPDATE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> BITMAP_INTERSECT_MERGE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> BITMAP_INTERSECT_SERIALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> BITMAP_INTERSECT_FINALIZE_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.TINYINT,
    ...
    private static final Map<Type, String> TOPN_UPDATE_SYMBOL = ImmutableMap.<Type, String>builder()
            .put(Type.CHAR,
    ...
    private static final Map<Type, String> TOPN_UPDATE_MORE_PARAM_SYMBOL = ImmutableMap
            .<Type, String>builder()
            .put(Type.CHAR,
    ...
    /**
     * There are essential differences in the implementation of some functions for different types
     * params, which should be prohibited.
     *
     * @param desc
     * @param candicate
     * @return
    ...
    public static boolean isCastMatchAllowed(Function desc, Function candicate) {
        ...
        if (functionName.equalsIgnoreCase("hex") || functionName.equalsIgnoreCase("greast")
                || functionName.equalsIgnoreCase("least") || functionName.equalsIgnoreCase("lead")
    ...
    private boolean addFunction(Function fn, boolean isBuiltin) {
        ...
        List<Function> fns = fn.isVectorized() ? vectorizedFunctions.get(fn.functionName())
                : functions.get(fn.functionName());
        if (fns == null) {
    ...
    public void addScalarBuiltin(String fnName, String symbol, boolean userVisible,
            String prepareFnSymbol, String closeFnSymbol, Function.NullableMode nullableMode,
            Type retType, boolean varArgs, Type... args) {
        ArrayList<Type> argsType = new ArrayList<Type>();
        for (Type type : args) {
            argsType.add(type);
        }
        addBuiltin(ScalarFunction.createBuiltin(fnName, retType, nullableMode, argsType, varArgs,
    ...
    public void addScalarAndVectorizedBuiltin(String fnName, String symbol, boolean userVisible,
        ...
        addBuiltinBothScalaAndVectorized(ScalarFunction.createBuiltin(fnName, retType, nullableMode,
                argsType, varArgs, symbol, prepareFnSymbol, closeFnSymbol, userVisible));
    }
    ...
    /**
     * Adds a function both in FunctionSet and VecFunctionSet to this database. The function must
     * not already exist and need to be not vectorized
     */
    public void addBuiltinBothScalaAndVectorized(Function fn) {
        ...
        vecFns.add(ScalarFunction.createVecBuiltin(scalarFunction.functionName(),
                scalarFunction.getPrepareFnSymbol(), scalarFunction.getSymbolName(),
                scalarFunction.getCloseFnSymbol(), Lists.newArrayList(scalarFunction.getArgs()),
                scalarFunction.hasVarArgs(), scalarFunction.getReturnType(),
    ...
    private void initAggregateBuiltins() {
        ...
        final String initNullString =
                prefix + "16init_null_stringEPN9doris_udf15FunctionContextEPNS1_9StringValE";
        ...
        final String stringValGetValue =
                prefix + "20string_val_get_valueEPN9doris_udf15FunctionContextERKNS1_9StringValE";

        // Type stringType[] = {Type.CHAR, Type.VARCHAR};
        // count(*)
        addBuiltin(AggregateFunction.createBuiltin(FunctionSet.COUNT, new ArrayList<Type>(),
                ...
                prefix + "11count_mergeEPN9doris_udf15FunctionContextERKNS1_9BigIntValEPS4_", null,
                null, prefix + "17count_star_removeEPN9doris_udf15FunctionContextEPNS1_9BigIntValE",
        ...
        addBuiltin(AggregateFunction.createBuiltin(FunctionSet.WINDOW_FUNNEL,
                Lists.newArrayList(Type.BIGINT, Type.STRING, Type.DATETIME, Type.BOOLEAN), Type.INT,
                Type.VARCHAR, true,
        ...
        addBuiltin(AggregateFunction.createBuiltin(FunctionSet.WINDOW_FUNNEL,
                Lists.newArrayList(Type.BIGINT, Type.STRING, Type.DATETIME, Type.BOOLEAN), Type.INT,
                Type.VARCHAR, true, "", "", "", "", "", "", "", true, false, true, true));

        addBuiltin(AggregateFunction.createBuiltin(FunctionSet.GLOBAL_DICT,
                Lists.newArrayList(Type.VARCHAR), Type.VARCHAR, Type.VARCHAR, true, false, false,
                false, true));
        ...
        for (Type t : Type.getSupportedTypes()) {
            ...
            // Count
            addBuiltin(AggregateFunction.createBuiltin(FunctionSet.COUNT, Lists.newArrayList(t),
                    Type.BIGINT, Type.BIGINT,
                    prefix + "18init_zero_not_nullIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextEPT_",
            ...
            if (t.equals(Type.CHAR) || t.equals(Type.VARCHAR)) {
                ...
                // vectorized
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_count",
                        Lists.newArrayList(t), Type.BIGINT, Type.VARCHAR, prefix + "", prefix + "",
                        prefix + "", prefix + "", null, null, prefix + "", false, true, true,
                        true));
                ...
                // vectorized
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_count",
                        Lists.newArrayList(t), Type.BIGINT, Type.STRING, prefix + "", prefix + "",
                        prefix + "", prefix + "", null, null, prefix + "", false, true, true,
                        true));
                ...
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_count",
                        ...
                        prefix + MULTI_DISTINCT_SERIALIZE_SYMBOL.get(t), null, null,
                        prefix + MULTI_DISTINCT_COUNT_FINALIZE_SYMBOL.get(t), false, true, true));
                // vectorized
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_count",
                ...
                // vectorized
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_count",
                        Lists.newArrayList(t), Type.BIGINT, Type.DECIMALV2, prefix + "",
                        prefix + "", prefix + "", prefix + "", null, null, prefix + "", false, true,
                        true, true));
            }
            ...
            if (t.equals(Type.BIGINT) || t.equals(Type.LARGEINT) || t.equals(Type.DOUBLE)) {
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_sum",
                        Lists.newArrayList(t), t, Type.VARCHAR,
                        prefix + MULTI_DISTINCT_INIT_SYMBOL.get(t),
                        prefix + MULTI_DISTINCT_UPDATE_SYMBOL.get(t),
                        prefix + MULTI_DISTINCT_MERGE_SYMBOL.get(t),
                        prefix + MULTI_DISTINCT_SERIALIZE_SYMBOL.get(t), null, null,
                        prefix + MULTI_DISTINCT_SUM_FINALIZE_SYMBOL.get(t), false, true, true));

                // vectorized
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_sum",
                        Lists.newArrayList(t), t, t, prefix + MULTI_DISTINCT_INIT_SYMBOL.get(t),
                        prefix + MULTI_DISTINCT_UPDATE_SYMBOL.get(t),
                        prefix + MULTI_DISTINCT_MERGE_SYMBOL.get(t),
                        prefix + MULTI_DISTINCT_SERIALIZE_SYMBOL.get(t), null, null,
                        prefix + MULTI_DISTINCT_SUM_FINALIZE_SYMBOL.get(t), false, true, true,
                ...
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_sum",
                        Lists.newArrayList(t), MULTI_DISTINCT_SUM_RETURN_TYPE.get(t), Type.VARCHAR,
                        prefix + "36count_or_sum_distinct_decimalv2_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
                        prefix + "38count_or_sum_distinct_decimalv2_updateEPN9doris_udf15FunctionContextERNS1_12DecimalV2ValEPNS1_9StringValE",
                        prefix + "37count_or_sum_distinct_decimalv2_mergeEPN9doris_udf15FunctionContextERNS1_9StringValEPS4_",
                        prefix + "41count_or_sum_distinct_decimalv2_serializeEPN9doris_udf15FunctionContextERKNS1_9StringValE",
                ...
                // vectorized
                addBuiltin(AggregateFunction.createBuiltin("multi_distinct_sum",
                        Lists.newArrayList(t), MULTI_DISTINCT_SUM_RETURN_TYPE.get(t),
                        Type.DECIMALV2, prefix + "", prefix + "", prefix + "", prefix + "", null,
                        null, prefix + "", false, true, true, true));
            }
            // Min
            String minMaxSerializeOrFinalize =
                    t.isStringType() ? stringValSerializeOrFinalize : null;
            String minMaxGetValue = t.isStringType() ? stringValGetValue : null;
            addBuiltin(AggregateFunction.createBuiltin("min", Lists.newArrayList(t), t, t,
                    prefix + MIN_INIT_SYMBOL.get(t), prefix + MIN_UPDATE_SYMBOL.get(t),
                    prefix + MIN_UPDATE_SYMBOL.get(t), minMaxSerializeOrFinalize, minMaxGetValue,
            ...
            // Max
            addBuiltin(AggregateFunction.createBuiltin("max", Lists.newArrayList(t), t, t,
                    prefix + MAX_INIT_SYMBOL.get(t), prefix + MAX_UPDATE_SYMBOL.get(t),
                    prefix + MAX_UPDATE_SYMBOL.get(t), minMaxSerializeOrFinalize, minMaxGetValue,
                    null, minMaxSerializeOrFinalize, true, true, false));
            // vectorized
            addBuiltin(AggregateFunction.createBuiltin("max", Lists.newArrayList(t), t, t,
                    prefix + MAX_INIT_SYMBOL.get(t), prefix + MAX_UPDATE_SYMBOL.get(t),
            ...
            for (Type kt : Type.getSupportedTypes()) {
                ...
                addBuiltin(AggregateFunction.createBuiltin("max_by", Lists.newArrayList(t, kt), t,
                        Type.VARCHAR, "", "", "", "", "", null, "", true, true, false, true));
                addBuiltin(AggregateFunction.createBuiltin("min_by", Lists.newArrayList(t, kt), t,
                        Type.VARCHAR, "", "", "", "", "", null, "", true, true, false, true));
            }
            ...
            // NDV
            // ndv return string
            addBuiltin(AggregateFunction.createBuiltin("ndv", Lists.newArrayList(t), Type.BIGINT,
                    Type.VARCHAR,
            ...
            // BITMAP_UNION_INT
            addBuiltin(AggregateFunction.createBuiltin(BITMAP_UNION_INT, Lists.newArrayList(t),
            ...
            // vectorized
            addBuiltin(AggregateFunction.createBuiltin(BITMAP_UNION_INT, Lists.newArrayList(t),
                    Type.BIGINT, t, "", BITMAP_UNION_INT_SYMBOL.get(t), "", "", "", true, false,
                    true, true));
            ...
            addBuiltin(AggregateFunction.createBuiltin(INTERSECT_COUNT,
                    ...
                    BITMAP_INTERSECT_INIT_SYMBOL.get(t), BITMAP_INTERSECT_UPDATE_SYMBOL.get(t),
                    BITMAP_INTERSECT_MERGE_SYMBOL.get(t), BITMAP_INTERSECT_SERIALIZE_SYMBOL.get(t),
                    null, null, BITMAP_INTERSECT_FINALIZE_SYMBOL.get(t), true, false, true));
            ...
            addBuiltin(AggregateFunction.createBuiltin(INTERSECT_COUNT,
                    ...
                    BITMAP_INTERSECT_INIT_SYMBOL.get(t), BITMAP_INTERSECT_UPDATE_SYMBOL.get(t),
                    BITMAP_INTERSECT_MERGE_SYMBOL.get(t), BITMAP_INTERSECT_SERIALIZE_SYMBOL.get(t),
                    null, null, BITMAP_INTERSECT_FINALIZE_SYMBOL.get(t), true, false, true, true));

            // HLL_UNION_AGG
            addBuiltin(AggregateFunction.createBuiltin("hll_union_agg", Lists.newArrayList(t),
                    Type.BIGINT, Type.VARCHAR,
                    "_ZN5doris12HllFunctions8hll_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
            ...
            // HLL_UNION
            addBuiltin(AggregateFunction.createBuiltin(HLL_UNION, Lists.newArrayList(t), Type.HLL,
                    Type.HLL,
                    "_ZN5doris12HllFunctions8hll_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
                    "_ZN5doris12HllFunctions9hll_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_",
                    "_ZN5doris12HllFunctions9hll_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_",
            ...
            addBuiltin(AggregateFunction.createBuiltin("hll_raw_agg", Lists.newArrayList(t),
                    Type.HLL, Type.HLL,
                    "_ZN5doris12HllFunctions8hll_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
                    "_ZN5doris12HllFunctions9hll_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_",
                    "_ZN5doris12HllFunctions9hll_mergeEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_",
            ...
            if (TOPN_UPDATE_SYMBOL.containsKey(t)) {
                addBuiltin(AggregateFunction.createBuiltin("topn", Lists.newArrayList(t, Type.INT),
            ...
            if (STDDEV_UPDATE_SYMBOL.containsKey(t)) {
                addBuiltin(AggregateFunction.createBuiltin("stddev", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), Type.VARCHAR,
                        prefix + STDDEV_INIT_SYMBOL.get(t), prefix + STDDEV_UPDATE_SYMBOL.get(t),
                        prefix + STDDEV_MERGE_SYMBOL.get(t), null,
                        prefix + STDDEV_POP_GET_VALUE_SYMBOL.get(t),
                        prefix + STDDEV_REMOVE_SYMBOL.get(t),
                        prefix + STDDEV_POP_FINALIZE_SYMBOL.get(t), false, true, false));

                addBuiltin(AggregateFunction.createBuiltin("stddev_samp", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), Type.VARCHAR,
                        prefix + STDDEV_INIT_SYMBOL.get(t), prefix + STDDEV_UPDATE_SYMBOL.get(t),
                        prefix + STDDEV_MERGE_SYMBOL.get(t), null,
                        prefix + STDDEV_GET_VALUE_SYMBOL.get(t),
                        prefix + STDDEV_REMOVE_SYMBOL.get(t),
                        prefix + STDDEV_FINALIZE_SYMBOL.get(t), false, true, false));

                addBuiltin(AggregateFunction.createBuiltin("stddev_pop", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), Type.VARCHAR,
                        prefix + STDDEV_INIT_SYMBOL.get(t), prefix + STDDEV_UPDATE_SYMBOL.get(t),
                        prefix + STDDEV_MERGE_SYMBOL.get(t), null,
                        prefix + STDDEV_POP_GET_VALUE_SYMBOL.get(t),
                ...
                addBuiltin(AggregateFunction.createBuiltin("stddev", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + STDDEV_POP_FINALIZE_SYMBOL.get(t), false, true,
                        false, true));
                addBuiltin(AggregateFunction.createBuiltin("stddev_samp", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + STDDEV_FINALIZE_SYMBOL.get(t), false, true,
                        false, true));
                addBuiltin(AggregateFunction.createBuiltin("stddev_pop", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                ...
                addBuiltin(AggregateFunction.createBuiltin("variance", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + VAR_POP_FINALIZE_SYMBOL.get(t), false, true,
                        false, true));
                addBuiltin(AggregateFunction.createBuiltin("variance_pop", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + VAR_POP_FINALIZE_SYMBOL.get(t), false, true,
                        false, true));
                addBuiltin(AggregateFunction.createBuiltin("var_pop", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + VAR_POP_FINALIZE_SYMBOL.get(t), false, true,
                        false, true));
                addBuiltin(AggregateFunction.createBuiltin("variance_samp", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + VAR_FINALIZE_SYMBOL.get(t), false, true, false,
                        true));
                addBuiltin(AggregateFunction.createBuiltin("var_samp", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), t, prefix + STDDEV_INIT_SYMBOL.get(t),
                        prefix + STDDEV_UPDATE_SYMBOL.get(t), prefix + STDDEV_MERGE_SYMBOL.get(t),
                        null, null, null, prefix + VAR_FINALIZE_SYMBOL.get(t), false, true, false,
                        true));
                ...
                addBuiltin(AggregateFunction.createBuiltin("variance", Lists.newArrayList(t),
                        ...
                        prefix + STDDEV_INIT_SYMBOL.get(t), prefix + STDDEV_UPDATE_SYMBOL.get(t),
                        prefix + STDDEV_MERGE_SYMBOL.get(t), null,
                        prefix + VAR_POP_GET_VALUE_SYMBOL.get(t),
                        prefix + STDDEV_REMOVE_SYMBOL.get(t),
                        prefix + VAR_POP_FINALIZE_SYMBOL.get(t), false, true, false));

                addBuiltin(AggregateFunction.createBuiltin("variance_samp", Lists.newArrayList(t),
                        STDDEV_RETTYPE_SYMBOL.get(t), Type.VARCHAR,
                        prefix + STDDEV_INIT_SYMBOL.get(t), prefix + STDDEV_UPDATE_SYMBOL.get(t),
                        prefix + STDDEV_MERGE_SYMBOL.get(t), null,
                        prefix + VAR_GET_VALUE_SYMBOL.get(t), prefix + STDDEV_REMOVE_SYMBOL.get(t),
                        prefix + VAR_FINALIZE_SYMBOL.get(t), false, true, false));
        ...
        for (String name : sumNames) {
            addBuiltin(AggregateFunction.createBuiltin(name, Lists.<Type>newArrayList(Type.BIGINT),
                    Type.BIGINT, Type.BIGINT,
                    prefix + "14init_zero_nullIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextEPT_",
            ...
            addBuiltin(AggregateFunction.createBuiltin(name, Lists.<Type>newArrayList(Type.DOUBLE),
                    Type.DOUBLE, Type.DOUBLE,
                    prefix + "14init_zero_nullIN9doris_udf9DoubleValEEEvPNS2_15FunctionContextEPT_",
            ...
            addBuiltin(AggregateFunction.createBuiltin(name,
                    ...
                    prefix + "14init_zero_nullIN9doris_udf12DecimalV2ValEEEvPNS2_15FunctionContextEPT_",
            ...
            addBuiltin(AggregateFunction.createBuiltin(name,
                    ...
                    prefix + "14init_zero_nullIN9doris_udf11LargeIntValEEEvPNS2_15FunctionContextEPT_",
            ...
            // vectorized
            addBuiltin(AggregateFunction.createBuiltin(name, Lists.<Type>newArrayList(Type.TINYINT),
                    Type.BIGINT, Type.BIGINT, initNull,
                    prefix + "3sumIN9doris_udf9BigIntValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    prefix + "3sumIN9doris_udf9BigIntValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    null, null,
                    prefix + "10sum_removeIN9doris_udf9BigIntValES3_EEvPNS2_15FunctionContextERKT_PT0_",
            ...
            addBuiltin(AggregateFunction.createBuiltin(name,
                    ...
                    prefix + "10sum_removeIN9doris_udf9BigIntValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    null, false, true, false, true));
            addBuiltin(AggregateFunction.createBuiltin(name, Lists.<Type>newArrayList(Type.INT),
                    Type.BIGINT, Type.BIGINT, initNull,
                    prefix + "3sumIN9doris_udf9BigIntValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    prefix + "3sumIN9doris_udf9BigIntValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    null, null,
            ...
            addBuiltin(AggregateFunction.createBuiltin(name, Lists.<Type>newArrayList(Type.BIGINT),
                    ...
                    null, false, true, false, true));
            addBuiltin(AggregateFunction.createBuiltin(name, Lists.<Type>newArrayList(Type.DOUBLE),
                    Type.DOUBLE, Type.DOUBLE, initNull,
                    prefix + "3sumIN9doris_udf9DoubleValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    prefix + "3sumIN9doris_udf9DoubleValES3_EEvPNS2_15FunctionContextERKT_PT0_",
                    null, null,
                    prefix + "10sum_removeIN9doris_udf9DoubleValES3_EEvPNS2_15FunctionContextERKT_PT0_",
        ...
        Type[] types = {Type.SMALLINT, Type.TINYINT, Type.INT, Type.BIGINT, Type.FLOAT, Type.DOUBLE,
                Type.CHAR, Type.VARCHAR, Type.STRING};
        for (Type t : types) {
            ...
            addBuiltin(AggregateFunction.createBuiltin(ORTHOGONAL_BITMAP_INTERSECT,
                    Lists.newArrayList(Type.BITMAP, t, t), Type.BITMAP, Type.BITMAP, true, "", "",
                    "", "", "", "", "", true, false, true, true));
        ...
        addBuiltin(AggregateFunction.createBuiltin(BITMAP_UNION, Lists.newArrayList(Type.BITMAP),
                Type.BITMAP, Type.BITMAP, "", "", "", "", "", true, false, true, true));


        addBuiltin(AggregateFunction.createBuiltin(BITMAP_UNION_COUNT,
                Lists.newArrayList(Type.BITMAP), Type.BIGINT, Type.VARCHAR,
                "_ZN5doris15BitmapFunctions11bitmap_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
                "_ZN5doris15BitmapFunctions12bitmap_unionEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_",
                "_ZN5doris15BitmapFunctions12bitmap_unionEPN9doris_udf15FunctionContextERKNS1_9StringValEPS4_",
                "_ZN5doris15BitmapFunctions16bitmap_serializeEPN9doris_udf15FunctionContextERKNS1_9StringValE",
        ...
        addBuiltin(AggregateFunction.createBuiltin(BITMAP_UNION_COUNT,
                Lists.newArrayList(Type.BITMAP), Type.BIGINT, Type.BITMAP, "", "", "", "", "", null,
                "", true, true, true, true));
        ...
        addBuiltin(AggregateFunction.createBuiltin(BITMAP_INTERSECT,
                Lists.newArrayList(Type.BITMAP), Type.BITMAP, Type.VARCHAR,
        ...
        addBuiltin(
                AggregateFunction.createBuiltin(BITMAP_INTERSECT, Lists.newArrayList(Type.BITMAP),
                        Type.BITMAP, Type.BITMAP, "", "", "", "", "", true, false, true, true));
        // quantile_state
        addBuiltin(AggregateFunction.createBuiltin(QUANTILE_UNION,
                Lists.newArrayList(Type.QUANTILE_STATE), Type.QUANTILE_STATE, Type.QUANTILE_STATE,
        ...
        addBuiltin(AggregateFunction.createBuiltin("avg", Lists.<Type>newArrayList(Type.BIGINT),
                ...
                prefix + "12avg_finalizeEPN9doris_udf15FunctionContextERKNS1_9StringValE", false,
                true, false));
        addBuiltin(AggregateFunction.createBuiltin("avg", Lists.<Type>newArrayList(Type.DOUBLE),
                Type.DOUBLE, Type.VARCHAR,
                prefix + "8avg_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
        ...
        addBuiltin(AggregateFunction.createBuiltin("avg", Lists.<Type>newArrayList(Type.DECIMALV2),
                Type.DECIMALV2, Type.VARCHAR,
        ...
        // Avg(Timestamp)
        addBuiltin(AggregateFunction.createBuiltin("avg", Lists.<Type>newArrayList(Type.DATE),
                ...
                false, true, false));
        addBuiltin(AggregateFunction.createBuiltin("avg", Lists.<Type>newArrayList(Type.DATETIME),
        ...
        // analytic functions
        // Rank
        addBuiltin(AggregateFunction.createAnalyticBuiltin("rank", Lists.<Type>newArrayList(),
                Type.BIGINT, Type.VARCHAR,
                prefix + "9rank_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
                prefix + "11rank_updateEPN9doris_udf15FunctionContextEPNS1_9StringValE", null,
        ...
        // Dense rank
        addBuiltin(AggregateFunction.createAnalyticBuiltin("dense_rank", Lists.<Type>newArrayList(),
                Type.BIGINT, Type.VARCHAR,
                prefix + "9rank_initEPN9doris_udf15FunctionContextEPNS1_9StringValE",
                prefix + "17dense_rank_updateEPN9doris_udf15FunctionContextEPNS1_9StringValE", null,
                prefix + "20dense_rank_get_valueEPN9doris_udf15FunctionContextERNS1_9StringValE",
                prefix + "13rank_finalizeEPN9doris_udf15FunctionContextERNS1_9StringValE"));
        // row_number
        addBuiltin(AggregateFunction.createAnalyticBuiltin("row_number", new ArrayList<Type>(),
                Type.BIGINT, Type.BIGINT,
                prefix + "18init_zero_not_nullIN9doris_udf9BigIntValEEEvPNS2_15FunctionContextEPT_",
                prefix + "17count_star_updateEPN9doris_udf15FunctionContextEPNS1_9BigIntValE",
                prefix + "11count_mergeEPN9doris_udf15FunctionContextERKNS1_9BigIntValEPS4_", null,
        ...
        addBuiltin(AggregateFunction.createAnalyticBuiltin("ntile",
                Collections.singletonList(Type.BIGINT), Type.BIGINT, Type.BIGINT, null, null, null,
                null, null));
        ...
        for (Type t : Type.getSupportedTypes()) {
            ...
            addBuiltin(AggregateFunction.createAnalyticBuiltin("first_value", Lists.newArrayList(t),
                    t, t, t.isStringType() ? initNullString : initNull,
                    prefix + FIRST_VALUE_UPDATE_SYMBOL.get(t), null,
                    t.isStringType() ? stringValGetValue : null,
                    t.isStringType() ? stringValSerializeOrFinalize : null));

            addBuiltin(AggregateFunction.createAnalyticBuiltin("last_value", Lists.newArrayList(t),
                    t, t, t.isStringType() ? initNullString : initNull,
            ...
            addBuiltin(AggregateFunction.createAnalyticBuiltin("first_value_rewrite",
                    Lists.newArrayList(t, Type.BIGINT), t, t,
                    t.isStringType() ? initNullString : initNull,
                    prefix + FIRST_VALUE_REWRITE_UPDATE_SYMBOL.get(t), null,
                    t.isStringType() ? stringValGetValue : null,
                    t.isStringType() ? stringValSerializeOrFinalize : null, false, false));
            // vec last_value
            addBuiltin(AggregateFunction.createAnalyticBuiltin("last_value", Lists.newArrayList(t),
                    t, t, t.isStringType() ? initNullString : initNull,
                    prefix + LAST_VALUE_UPDATE_SYMBOL.get(t),
            ...
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lag",
                    Lists.newArrayList(t, Type.BIGINT, t), t, t,
                    prefix + OFFSET_FN_INIT_SYMBOL.get(t), prefix + OFFSET_FN_UPDATE_SYMBOL.get(t),
                    null, t.isStringType() ? stringValGetValue : null, null));

            addBuiltin(AggregateFunction.createAnalyticBuiltin("lead",
                    Lists.newArrayList(t, Type.BIGINT, t), t, t,
                    prefix + OFFSET_FN_INIT_SYMBOL.get(t), prefix + OFFSET_FN_UPDATE_SYMBOL.get(t),
                    null, t.isStringType() ? stringValGetValue : null, null));
            // vec
            ...
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lag", Lists.newArrayList(t), t, t,
                    false));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lag",
                    Lists.newArrayList(t, Type.BIGINT), t, t, false));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lead", Lists.newArrayList(t), t, t,
                    false));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lead",
                    Lists.newArrayList(t, Type.BIGINT), t, t, false));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lag", Lists.newArrayList(t), t, t,
                    true));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lag",
                    Lists.newArrayList(t, Type.BIGINT), t, t, true));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lead", Lists.newArrayList(t), t, t,
                    true));
            addBuiltin(AggregateFunction.createAnalyticBuiltin("lead",
                    Lists.newArrayList(t, Type.BIGINT), t, t, true));
    ...
    private void addTableFunction(String name, Type retType, NullableMode nullableMode,
            ArrayList<Type> argTypes, boolean hasVarArgs, String symbol) {
        List<Function> functionList = tableFunctions.get(name);
        functionList.add(ScalarFunction.createBuiltin(name, retType, nullableMode, argTypes,
                hasVarArgs, symbol, null, null, true));
    }

    private void addTableFunctionWithCombinator(String name, Type retType,
            NullableMode nullableMode, ArrayList<Type> argTypes, boolean hasVarArgs,
            String symbol) {
        addTableFunction(name, retType, nullableMode, argTypes, hasVarArgs, symbol);
        addTableFunction(name + "_outer", retType, Function.NullableMode.ALWAYS_NULLABLE, argTypes,
                hasVarArgs, symbol);
    }
    ...
    private void initTableFunction() {
        ...
        addTableFunctionWithCombinator(EXPLODE_BITMAP, Type.BIGINT,
                Function.NullableMode.DEPEND_ON_ARGUMENT, Lists.newArrayList(Type.BITMAP), false,
        ...
        addTableFunctionWithCombinator(EXPLODE_NUMBERS, Type.INT,
                Function.NullableMode.DEPEND_ON_ARGUMENT, Lists.newArrayList(Type.INT), false,
