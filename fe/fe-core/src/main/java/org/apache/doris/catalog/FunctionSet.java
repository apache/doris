            ...
            for (ScalarType type2: symbolsMap.keySet()) {
                if (symbolsMap.get(type1).equals(symbolsMap.get(type2)) && !type1.isStringType()) {
                    addBuiltin(AggregateFunction.createBuiltin("max_by",
                            ...
                            prefix + "18numeric_maxby_initIN9doris_udf" + symbolsMap.get(type1) + "ES3_EEvPNS2_15FunctionContextEPNS2_9StringValE",
                            prefix + "20numeric_maxby_updateIN9doris_udf" + symbolsMap.get(type1) + "ES3_EEvPNS2_15FunctionContextERKT_RKT0_PNS2_9StringValE",
                            prefix + "19numeric_maxby_mergeIN9doris_udf" + symbolsMap.get(type1) + "ES3_EEvPNS2_15FunctionContextERKNS2_9StringValEPS6_",
                            prefix + "23numeric_maxby_serializeIN9doris_udf" + symbolsMap.get(type1) + "ES3_EENS2_9StringValEPNS2_15FunctionContextERKS4_",
                            prefix + "23numeric_maxby_get_valueIN9doris_udf" + symbolsMap.get(type1) + "ES3_EET_PNS2_15FunctionContextERKNS2_9StringValE",
                            null,
                            prefix + "22numeric_maxby_finalizeIN9doris_udf" + symbolsMap.get(type1) + "ES3_EET_PNS2_15FunctionContextERKNS2_9StringValE",
                            false, true, false));
                } else if (type1.isStringType() && !symbolsMap.get(type1).equals(symbolsMap.get(type2))) {
                    addBuiltin(AggregateFunction.createBuiltin("max_by",
                            Lists.<Type>newArrayList(type1, type2), type1, Type.VARCHAR,
                            prefix + "18numeric_maxby_initIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextEPS3_",
                            prefix + "20numeric_maxby_updateIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextERKT_RKT0_PS3_",
                            prefix + "19numeric_maxby_mergeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextERKS3_PS3_",
                            prefix + "23numeric_maxby_serializeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEES3_PNS2_15FunctionContextERKS3_",
                            prefix + "23numeric_maxby_get_valueIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEET_PNS2_15FunctionContextERKS3_",
                            null,
                            prefix + "22numeric_maxby_finalizeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEET_PNS2_15FunctionContextERKS3_",
                            false, true, false));
                } else if (type2.isStringType() && !symbolsMap.get(type1).equals(symbolsMap.get(type2))) {
                    addBuiltin(AggregateFunction.createBuiltin("max_by",
                            Lists.<Type>newArrayList(type1, type2), type1, Type.VARCHAR,
                            prefix + "18numeric_maxby_initIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextEPS4_",
                            prefix + "20numeric_maxby_updateIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextERKT_RKT0_PS4_",
                            prefix + "19numeric_maxby_mergeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextERKS4_PS4_",
                            prefix + "23numeric_maxby_serializeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEES4_PNS2_15FunctionContextERKS4_",
                            prefix + "23numeric_maxby_get_valueIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEET_PNS2_15FunctionContextERKS4_",
                            null,
                            prefix + "22numeric_maxby_finalizeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEET_PNS2_15FunctionContextERKS4_",
                            false, true, false));
                } else if (type1.isStringType() && symbolsMap.get(type1).equals(symbolsMap.get(type2))) {
                    addBuiltin(AggregateFunction.createBuiltin("max_by",
                            Lists.<Type>newArrayList(type1, type2), type1, Type.VARCHAR,
                            prefix + "18numeric_maxby_initIN9doris_udf" + symbolsMap.get(type1) + "ES3_EEvPNS2_15FunctionContextEPS3_",
                            prefix + "20numeric_maxby_updateIN9doris_udf" + symbolsMap.get(type1) + "ES3_EEvPNS2_15FunctionContextERKT_RKT0_PS3_",
                            prefix + "19numeric_maxby_mergeIN9doris_udf" + symbolsMap.get(type1) + "ES3_EEvPNS2_15FunctionContextERKS3_PS3_",
                            prefix + "23numeric_maxby_serializeIN9doris_udf" + symbolsMap.get(type1) + "ES3_EES3_PNS2_15FunctionContextERKS3_",
                            prefix + "23numeric_maxby_get_valueIN9doris_udf" + symbolsMap.get(type1) + "ES3_EET_PNS2_15FunctionContextERKS3_",
                            null,
                            prefix + "22numeric_maxby_finalizeIN9doris_udf" + symbolsMap.get(type1) + "ES3_EET_PNS2_15FunctionContextERKS3_",
                            false, true, false));
                } else {
                    addBuiltin(AggregateFunction.createBuiltin("max_by",
                            Lists.<Type>newArrayList(type1, type2), type1, Type.VARCHAR,
                            prefix + "18numeric_maxby_initIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextEPNS2_9StringValE",
                            prefix + "20numeric_maxby_updateIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextERKT_RKT0_PNS2_9StringValE",
                            prefix + "19numeric_maxby_mergeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEEvPNS2_15FunctionContextERKNS2_9StringValEPS7_",
                            prefix + "23numeric_maxby_serializeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEENS2_9StringValEPNS2_15FunctionContextERKS5_",
                            prefix + "23numeric_maxby_get_valueIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEET_PNS2_15FunctionContextERKNS2_9StringValE",
                            null,
                            prefix + "22numeric_maxby_finalizeIN9doris_udf" + symbolsMap.get(type1) + "ENS2_" + symbolsMap.get(type2) + "EEET_PNS2_15FunctionContextERKNS2_9StringValE",
                            false, true, false));
                }
            }
        }
