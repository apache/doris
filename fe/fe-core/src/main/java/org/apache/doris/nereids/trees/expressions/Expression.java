...
public abstract class Expression extends AbstractTreeNode<Expression> implements ExpressionTrait {
    ...
    protected final String exprName = normalizeName(this.getClass().getSimpleName(), DEFAULT_EXPRESSION_NAME);
    ...
    /**
     * Normalize the name to lower underscore style.
     */
    public static String normalizeName(String str, String defaultStr) {
