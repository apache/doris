...
/**
 * Implementation rule that convert logical PaimonTableSink to physical PaimonTableSink.
 */
public class LogicalPaimonTableSinkToPhysicalPaimonTableSink extends OneImplementationRuleFactory {
    @Override
    public Rule build() {
