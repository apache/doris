 ...
 */
public class YearsSub extends ScalarFunction implements BinaryExpression, ExplicitlyCastableSignature,
    ...
    private YearsSub(ScalarFunctionParams functionParams) {
    ...
    public YearsSub withChildren(List<Expression> children) {
        ...
        return new YearsSub(getFunctionParams(children));
    }
