...
/**
 * ScalarFunction 'second_ceil'. This class is generated by GenerateScalarFunction.
 */
public class SecondCeil extends ScalarFunction
     ...
     */
    public SecondCeil(Expression arg) {
        super("second_ceil", arg);
    }

    /**
     * constructor with 2 arguments.
     */
    public SecondCeil(Expression arg0, Expression arg1) {
        super("second_ceil", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public SecondCeil(Expression arg0, Expression arg1, Expression arg2) {
        super("second_ceil", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public SecondCeil withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new SecondCeil(children.get(0));
        } else if (children.size() == 2) {
            return new SecondCeil(children.get(0), children.get(1));
        } else {
            return new SecondCeil(children.get(0), children.get(1), children.get(2));
        }
    }
