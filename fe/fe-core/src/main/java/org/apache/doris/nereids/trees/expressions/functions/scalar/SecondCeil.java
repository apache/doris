...
public class SecondCeil extends ScalarFunction
    ...
    private SecondCeil(ScalarFunctionParams functionParams) {
    ...
    public SecondCeil withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        return new SecondCeil(getFunctionParams(children));
    }
    ...
    public Optional<Expression> previousBucketBoundary(Literal value) {
        ...
        return Optional.of(new SecondsSub(value, period.get()));
    }
