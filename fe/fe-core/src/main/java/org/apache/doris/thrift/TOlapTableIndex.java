            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map123.size);
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter127 : struct.columns)
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter129 : struct.columns)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter130 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<java.lang.String>(_list131.size);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map134.size);
          ...
          for (int _i137 = 0; _i137 < _map134.size; ++_i137)
          {
            ...
            struct.properties.put(_key135, _val136);
          }
        }
        struct.setPropertiesIsSet(true);
      }
