...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String FETCH_HIVE_ROW_COUNT_SYNCHRONOUS = "fetch_hive_row_count_synchronous";
    ...
    @VariableMgr.VarAttr(name = FETCH_HIVE_ROW_COUNT_SYNCHRONOUS,
            description = {"同步获取Hive外表行数", "Fetch Hive external table row count synchronously"})
    public boolean fetchHiveRowCountSynchronous = true;
