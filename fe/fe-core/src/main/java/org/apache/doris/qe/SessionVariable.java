...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String ENABLE_PROFILE_MERGE_BY_BE = "enable_profile_merge_by_be";
    ...
    // if true, need report to coordinator when plan fragment execute successfully.
    @VariableMgr.VarAttr(name = ENABLE_PROFILE_MERGE_BY_BE, needForward = true)
    public boolean enableProfileMergeByBe = false;
    ...
    public TQueryOptions toThrift() {
        ...
        tResult.setEnableProfileMergeByBe(enableProfileMergeByBe);
        return tResult;
    }
