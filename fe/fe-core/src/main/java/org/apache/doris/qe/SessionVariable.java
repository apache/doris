...
public class SessionVariable implements Serializable, Writable {
    ...
    // Default value 100000 means at most 100000 splits will be generated for the entire query.
    // Set to 0 to disable this limit.
    @VariableMgr.VarAttr(
            name = MAX_FILE_SPLITS_NUM,
            fuzzy = true,
            description = {"所有文件的最大 split 总数，用于防止 file_split_size 设置过小时产生过多 split 导致 OOM。"
                    + "系统会在 split 前估算总数，如果超过限制会自动增大 file_split_size。默认值 100000。设置为 0 表示不限制。",
                    ...
                    + "file_split_size if needed. Default value is 100000. Set to 0 to disable this limit."},
            needForward = true)
    public int maxFileSplitsNum = 100000;
