...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String ENABLE_STREAMING_AGG_FORCE_PASSTHROUGH = "enable_streaming_agg_force_passthrough";
    ...
    @VariableMgr.VarAttr(name = ENABLE_STREAMING_AGG_FORCE_PASSTHROUGH, fuzzy = true)
    public boolean enableStreamingAggForcePassthrough = false;
    ...
    public void initFuzzyModeVariables() {
        ...
        this.enableStreamingAggForcePassthrough = random.nextBoolean();
    ...
    public TQueryOptions toThrift() {
        ...
        tResult.setEnableStreamingAggForcePassthrough(enableStreamingAggForcePassthrough);
