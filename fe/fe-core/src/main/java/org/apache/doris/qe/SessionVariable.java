...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String TABLET_SWITCH_ROW_THRESHOLD = "tablet_switch_row_threshold";
    ...
    @VariableMgr.VarAttr(name = TABLET_SWITCH_ROW_THRESHOLD, needForward = true)
    public long tabletSwitchRowThreshold = 10000000L; // default 10M rows
