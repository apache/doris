...
public class FeNameFormat {
    private static final String LABEL_REGEX = "^[-_A-Za-z0-9\\p{L}]{1,128}$";
    private static final String COMMON_NAME_REGEX = "^[a-zA-Z\\p{L}][a-zA-Z0-9_\\p{L}]{0,63}$";
    private static final String COMMON_TABLE_NAME_REGEX = "^[a-zA-Z\\p{L}][a-zA-Z0-9_\\p{L}]*$";
    private static final String COLUMN_NAME_REGEX = "^[_a-zA-Z@\\p{L}][a-zA-Z0-9_\\p{L}]{0,63}$";
