...
/**
 * ScalarFunction 'money_format'. This class is generated by GenerateScalarFunction.
 */
public class MoneyFormat extends ScalarFunction
    ...
    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            ...
            FunctionSignature.ret(VarcharType.SYSTEM_DEFAULT).args(DecimalV2Type.MAX)
    );

    /**
     * constructor with 1 argument.
     */
    public MoneyFormat(Expression arg) {
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitMoneyFormat(this, context);
    }
}
