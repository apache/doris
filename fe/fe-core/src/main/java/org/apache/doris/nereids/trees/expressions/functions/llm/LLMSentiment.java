...
/**
 * LLM function 'LLM_Sentiment'
 */
public class LLMSentiment extends LLMFunction {
    ...
    public LLMSentiment(Expression arg) {
        super("llm_sentiment", arg);
    }

    /**
     * constructor with 2 argument.
     */
    public LLMSentiment(Expression arg0, Expression arg1) {
        super("llm_sentiment", arg0, arg1);
    }

    @Override
    public LLMSentiment withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1 || children.size() == 2,
                "LLM_SENTIMENT only accepts 1 or 2 arguments");
        if (children.size() == 1) {
            return new LLMSentiment(children.get(0));
        }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitLLMSentiment(this, context);
    }
}
