...
public class PartitionsProcDir implements ProcDirInterface {
    public static final ImmutableList<String> TITLE_NAMES = new ImmutableList.Builder<String>()
            ...
            .add("Buckets").add("ReplicationNum").add("StorageMedium")
            .add("StorageColdMedium").add("RemoteStorage").add("CooldownTime")
    ...
    private List<List<Comparable>> getPartitionInfos() {
        ...
        try {
            ...
            for (Long partitionId : partitionIds) {
                ...
                partitionInfo.add(dataProperty.getRemoteStorageName());
