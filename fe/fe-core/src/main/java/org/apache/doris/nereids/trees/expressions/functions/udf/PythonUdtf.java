...
/**
 * {@link PythonUdtf} represents the python table generating function in the Nereids optimizer.
 * It supports the registry and management of global user-defined table functions.
 */
public class PythonUdtf extends TableGeneratingFunction implements ExplicitlyCastableSignature, Udf {
    ...
    /**
     * The constructor of {@link PythonUdtf}.
     */
    ...
    /**
     * Translate the Python udtf into Nereids optimizer.
     */
    public static void translateToNereidsFunction(String dbName, org.apache.doris.catalog.ScalarFunction scalar) {
        ...
        PythonUdtf udf = new PythonUdtf(fnName, scalar.getId(), dbName, scalar.getBinaryType(), sig,
                ...
                scalar.getChecksum(),
                virtualSlots);
        PythonUdtfBuilder builder = new PythonUdtfBuilder(udf);
