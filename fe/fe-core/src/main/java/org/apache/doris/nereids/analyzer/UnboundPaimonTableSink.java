...
/**
 * Represent a paimon table sink plan node that has not been bound.
 */
public class UnboundPaimonTableSink<CHILD_TYPE extends Plan> extends UnboundBaseExternalTableSink<CHILD_TYPE> {

    public UnboundPaimonTableSink(List<String> nameParts, List<String> colNames, List<String> hints,
    ...
    public UnboundPaimonTableSink(List<String> nameParts,
                                  ...
                                  CHILD_TYPE child) {
        super(nameParts, PlanType.LOGICAL_UNBOUND_PAIMON_TABLE_SINK, ImmutableList.of(), groupExpression,
                logicalProperties, colNames, dmlCommandType, child, hints, partitions);
    }

    @Override
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitUnboundPaimonTableSink(this, context);
    }
