...
public class IcebergRestConnectivityTester extends AbstractIcebergConnectivityTester {
    ...
    public void testConnection() throws Exception {
        ...
        try (RESTSessionCatalog catalog = new RESTSessionCatalog()) {
            ...
            this.warehouseLocation = mergedProps.get(CatalogProperties.WAREHOUSE_LOCATION);
            if (this.warehouseLocation == null) {
                this.warehouseLocation = mergedProps.get(DEFAULT_BASE_LOCATION);
            }
        }
    }
    ...
    public String getTestLocation() {
        ...
        // If configured warehouse is not valid, fallback to REST API warehouse
        return validateAndGetLocation(warehouseLocation);
    }
}
