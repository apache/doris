...
public class AggregateUtils {
    ...
    /** Full aggregate shuffle keys in GROUP BY order, excluding constants and duplicate slots. */
    public static List<ExprId> getFullAggregateShuffleKeys(PhysicalHashAggregate<? extends Plan> aggregate) {
        return aggregate.getGroupByExpressions().stream()
