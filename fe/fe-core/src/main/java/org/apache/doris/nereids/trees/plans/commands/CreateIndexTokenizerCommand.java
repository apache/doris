 ...
 */
public class CreateIndexTokenizerCommand extends Command implements ForwardWithSync {
     ...
     * Constructor
     */
    public CreateIndexTokenizerCommand(boolean ifNotExists, String policyName, Map<String, String> properties) {
        super(PlanType.CREATE_INDEX_TOKENIZER_COMMAND);
    ...
    public void run(ConnectContext ctx, StmtExecutor executor) throws UserException {
        ...
        Env.getCurrentEnv().getIndexPolicyMgr().createIndexPolicy(ifNotExists, policyName,
                IndexPolicyTypeEnum.TOKENIZER, properties);
    }

    @Override
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitCreateIndexTokenizerCommand(this, context);
    }
}
