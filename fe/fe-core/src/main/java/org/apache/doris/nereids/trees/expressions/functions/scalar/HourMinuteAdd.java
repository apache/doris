...
/**
 * ScalarFunction 'hour_minute_add'.
 */
public class HourMinuteAdd extends ScalarFunction
    ...
    public HourMinuteAdd(Expression arg0, Expression arg1) {
        super("hour_minute_add", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private HourMinuteAdd(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public HourMinuteAdd withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new HourMinuteAdd(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitHourMinuteAdd(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new HourMinuteAdd(literal, child(1));
    }
