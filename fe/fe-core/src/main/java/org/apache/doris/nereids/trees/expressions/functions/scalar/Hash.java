 ...
 * ScalarFunction 'hash'.
 */
public class Hash extends ScalarFunction
     ...
     */
    public Hash(Expression arg, Expression... varArgs) {
        super("hash", ExpressionUtils.mergeArguments(arg, varArgs));
    }
     ...
     */
    @Override
    public Hash withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() >= 1);
        return new Hash(children.get(0),
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitHash(this, context);
    }
}
