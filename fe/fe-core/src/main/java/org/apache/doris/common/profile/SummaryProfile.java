...
public class SummaryProfile {
    ...
    public static final ImmutableList<String> EXECUTION_SUMMARY_KEYS = ImmutableList.of(
            ...
            ANALYSIS_TIME, PLAN_TIME, JOIN_REORDER_TIME, CREATE_SINGLE_NODE_TIME, QUERY_DISTRIBUTED_TIME,
    ...
    private String getPrettyNereidsAnalysisTime() {
        if (nereidsAnalysisFinishTime == -1 || queryBeginTime == -1) {
            return "N/A";
        }
