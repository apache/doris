...
public class CassandraExternalDatabase extends ExternalDatabase<CassandraExternalTable> {
    ...
    @Override
    protected CassandraExternalTable getExternalTable(String tableName, long tblId, ExternalCatalog catalog) {
        return new CassandraExternalTable(tblId, tableName, name, (CassandraExternalCatalog) extCatalog);
    }
}
