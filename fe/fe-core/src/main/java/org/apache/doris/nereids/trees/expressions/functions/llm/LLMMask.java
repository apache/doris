...
public class LLMMask extends LLMFunction {
     ...
     */
    public LLMMask(Expression arg0, Expression arg1, Expression arg2) {
        super("llm_mask", arg0, arg1, arg2);
    }

    @Override
    public LLMMask withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2 || children.size() == 3,
                "LLM_Mask only accepts 2 or 3 arguments");
        if (children.size() == 2) {
            return new LLMMask(children.get(0), children.get(1));
        }
