...
public class LLMResource extends Resource {
    ...
    private static HttpURLConnection getHttpURLConnection(Map<String, String> properties) throws IOException {
        ...
        // Set up authentication according to different providers
    ...
    public String getEndpoint() {
        return this.properties.get(LLMProperties.ENDPOINT);
    }

    public String getProviderType() {
        return this.properties.get(LLMProperties.PROVIDER_TYPE);
    }

    public String getApiKey() {
        return this.properties.get(LLMProperties.API_KEY);
    }

    public String getModelName() {
        return this.properties.get(LLMProperties.MODEL_NAME);
    }

    public String getTemperature() {
        return this.properties.get(LLMProperties.TEMPERATURE);
    }

    public String getMaxToken() {
        return this.properties.get(LLMProperties.MAX_TOKEN);
    }

    public String getMaxRetries() {
        return this.properties.get(LLMProperties.MAX_RETRIES);
    }

    public String getRetryDelayMs() {
        return this.properties.get(LLMProperties.RETRY_DELAY_MS);
    }

    public String getTimeoutMs() {
        return this.properties.get(LLMProperties.TIMEOUT_MS);
    }

    public String getAnthropicVersion() {
        return this.properties.get(LLMProperties.ANTHROPIC_VERSION);
    }
}
