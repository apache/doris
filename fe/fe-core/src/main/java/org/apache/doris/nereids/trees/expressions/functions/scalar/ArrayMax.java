 ...
 */
public class ArrayMax extends ScalarFunction implements ExplicitlyCastableSignature,
         AlwaysNullable {

    public static final List<FunctionSignature> SIGNATURES = ImmutableList.of(
            FunctionSignature.ret(new FollowToAnyDataType(0))
                    .varArgs(new LambdaType(), ArrayType.of(new AnyDataType(0))),
     ...
     */
    public ArrayMax(List<Expression> arg) {
        super("array_max", arg);
    }
    ...
    public DataType getDataType() {
        if (child(0) instanceof LambdaClosure) {
            return ((LambdaClosure) child(0)).getRetType();
        }
        return ((ArrayType) (child(0).getDataType())).getItemType();
    }
