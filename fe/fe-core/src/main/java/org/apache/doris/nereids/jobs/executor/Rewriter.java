...
import org.apache.doris.nereids.rules.rewrite.RecordPlanAndTryToMvRewrite;
        ...
        return notTraverseChildrenOf(
            ...
            () -> {
                ...
                rewriteJobs.addAll(jobs(
                        ...
                        topic("record mv plan and rewrite based cbo frame work",
                                custom(RuleType.RECORD_MV_PLAN_AND_REWRITE_BASED_CBO, RecordPlanAndTryToMvRewrite::new)
                        ),
