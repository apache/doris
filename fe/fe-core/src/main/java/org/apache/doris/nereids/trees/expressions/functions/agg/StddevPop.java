...
/**
 * AggregateFunction 'stddev_pop'. This class is generated by GenerateFunction.
 */
public class StddevPop extends AggregateFunction
     ...
     */
    public StddevPop(Expression arg) {
        super("stddev_pop", arg);
    }

    /**
     * constructor with 1 argument.
     */
    public StddevPop(boolean distinct, Expression arg) {
        super("stddev_pop", distinct, arg);
    }
     ...
     */
    @Override
    public StddevPop withDistinctAndChildren(boolean distinct, List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1);
        return new StddevPop(distinct, children.get(0));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitStddevPop(this, context);
    }
