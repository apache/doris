...
/**
 * ScalarFunction 'year_month_add'.
 */
public class YearMonthAdd extends ScalarFunction
    ...
    public YearMonthAdd(Expression arg0, Expression arg1) {
        super("year_month_add", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private YearMonthAdd(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public YearMonthAdd withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new YearMonthAdd(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitYearMonthAdd(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new YearMonthAdd(literal, child(1));
    }
