...
/**
 * ScalarFunction 'st_contains'. This class is generated by GenerateFunction.
 */
public class StContains extends ScalarFunction
     ...
     */
    public StContains(Expression arg0, Expression arg1) {
    ...
    public FunctionSignature searchSignature(List<FunctionSignature> signatures) {
        FunctionSignature signature = SpatialFunctionSignature.binary(child(0), child(1), BooleanType.INSTANCE);
        return signature != null ? signature : ExplicitlyCastableSignature.super.searchSignature(signatures);
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitStContains(this, context);
    }
}
