...
/**
 * ScalarFunction 'bitmap_xor'. This class is generated by GenerateFunction.
 */
public class BitmapXor extends ScalarFunction
    ...
    private BitmapXor(ScalarFunctionParams functionParams) {
    ...
    public BitmapXor withChildren(List<Expression> children) {
        ...
        return new BitmapXor(getFunctionParams(children));
    }
