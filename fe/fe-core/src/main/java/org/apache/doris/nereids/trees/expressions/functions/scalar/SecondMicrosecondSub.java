...
/**
 * ScalarFunction 'second_microsecond_sub'.
 */
public class SecondMicrosecondSub extends ScalarFunction
    ...
    public SecondMicrosecondSub(Expression arg0, Expression arg1) {
        super("second_microsecond_sub", arg0, arg1);
    }

    /** constructor for withChildren and reuse signature */
    private SecondMicrosecondSub(ScalarFunctionParams functionParams) {
        super(functionParams);
    }

    @Override
    public SecondMicrosecondSub withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 2);
        return new SecondMicrosecondSub(getFunctionParams(children));
    }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitSecondMicrosecondSub(this, context);
    }

    @Override
    public Expression withConstantArgs(Expression literal) {
        return new SecondMicrosecondSub(literal, child(1));
    }
