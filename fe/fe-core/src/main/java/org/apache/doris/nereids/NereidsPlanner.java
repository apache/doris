...
public class NereidsPlanner extends Planner {
     ...
     * @param requestProperties request physical properties constraints
     * @return plan generated by this planner
     * @throws AnalysisException throw exception if failed in ant stage
     */
    public Plan plan(LogicalPlan plan, PhysicalProperties requestProperties, ExplainLevel explainLevel) {
        ...
        try (Lock lock = new Lock(plan, cascadesContext)) {
            ...
            PhysicalPlan physicalPlan = chooseBestPlan(getRoot(), requestProperties);
