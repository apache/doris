...
public class TTypeDesc implements org.apache.thrift.TBase<TTypeDesc, TTypeDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TTypeDesc> {
  ...
  private static final _Fields optionals[] = {_Fields.IS_NULLABLE,_Fields.BYTE_SIZE};
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTypeDesc struct) throws org.apache.thrift.TException {
      ...
      if (struct.types != null) {
        oprot.writeFieldBegin(TYPES_FIELD_DESC);
        {
          ...
          for (TTypeNode _iter19 : struct.types)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTypes()) {
        {
          ...
          for (TTypeNode _iter20 : struct.types)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.types = new java.util.ArrayList<TTypeNode>(_list21.size);
          @org.apache.thrift.annotation.Nullable TTypeNode _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new TTypeNode();
            _elem22.read(iprot);
