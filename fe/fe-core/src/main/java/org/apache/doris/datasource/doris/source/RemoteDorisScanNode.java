...
public class RemoteDorisScanNode extends FileQueryScanNode {
    ...
    public List<Split> getSplits(int numBackends) throws UserException {
        List<Pair<String, ByteBuffer>> locationAndTicketList = executeAdbcQuery();

        List<Split> splits = Lists.newArrayList();

        for (Pair<String, ByteBuffer> locationAndTicket : locationAndTicketList) {
    ...
    public static List<Pair<String, ByteBuffer>> getUriAndTickets(Pair<String, Integer> hostAndPort,
