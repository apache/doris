 ...
 */
public class SetDefaultStorageVaultCommand extends Command implements ForwardWithSync {
    private final String vaultName;

    public SetDefaultStorageVaultCommand(String vaultName) {
        super(PlanType.SET_DEFAULT_STORAGE_VAULT_COMMAND);
    ...
    public void run(ConnectContext ctx, StmtExecutor executor) throws Exception {
        ...
        ctx.getEnv().getStorageVaultMgr().setDefaultStorageVault(vaultName);
    }

    @Override
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitSetDefaultStorageVault(this, context);
    }
