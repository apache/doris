...
public class TableProperty implements GsonPostProcessable {
    ...
    public TableProperty buildBinlogConfig() {
        ...
        if (properties.containsKey(BinlogConfig.EFFECTIVE_ROW_TTL_SECONDS)) {
            binlogConfig.setEffectiveRowTtlSeconds(
                    Long.parseLong(properties.get(BinlogConfig.EFFECTIVE_ROW_TTL_SECONDS)));
        }
    ...
    public void setBinlogConfig(BinlogConfig newBinlogConfig) {
        ...
        binlogProperties.put(BinlogConfig.EFFECTIVE_ROW_TTL_SECONDS,
                String.valueOf(newBinlogConfig.getEffectiveRowTtlSeconds()));
