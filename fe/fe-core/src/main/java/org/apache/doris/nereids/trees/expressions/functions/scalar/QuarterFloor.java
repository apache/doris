...
/**
 * ScalarFunction 'quarter_floor'. This class is generated by GenerateFunction.
 */
public class QuarterFloor extends ScalarFunction
     ...
     */
    public QuarterFloor(Expression arg) {
        super("quarter_floor", arg);
    }

    /**
     * constructor with 2 arguments.
     */
    public QuarterFloor(Expression arg0, Expression arg1) {
        super("quarter_floor", arg0, arg1);
    }

    /**
     * constructor with 3 arguments.
     */
    public QuarterFloor(Expression arg0, Expression arg1, Expression arg2) {
        super("quarter_floor", arg0, arg1, arg2);
    }
     ...
     */
    @Override
    public QuarterFloor withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1
                || children.size() == 2
                || children.size() == 3);
        if (children.size() == 1) {
            return new QuarterFloor(children.get(0));
        } else if (children.size() == 2) {
            return new QuarterFloor(children.get(0), children.get(1));
        } else {
            return new QuarterFloor(children.get(0), children.get(1), children.get(2));
        }
    }
    ...
    public Optional<Expression> nextBucketBoundary(Literal value) {
        ...
        return Optional.of(new QuartersAdd(value, period.get()));
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitQuarterFloor(this, context);
    }
    ...
    public Expression withConstantArgs(Expression literal) {
        switch (arity()) {
            case 1:
                return new QuarterFloor(literal);
            case 2:
                return new QuarterFloor(literal, child(1));
            case 3:
                return new QuarterFloor(literal, child(1), child(2));
            default:
