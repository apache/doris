...
public class DynamicPartitionUtil {
    ...
    private static void checkReservedHistoryPeriodValidate(String reservedHistoryPeriods, String timeUnit)
        throws DdlException {
    ...
    public static Map<String, String> analyzeDynamicPartition(Map<String, String> properties,
        ...
        if (hasEnd && (expectCreatePartitionNum > Config.max_dynamic_partition_num)) {
            throw new DdlException("Too many dynamic partitions: " + expectCreatePartitionNum + ". Limit: " +
    ...
    public static String getHistoryPartitionRangeString(DynamicPartitionProperty dynamicPartitionProperty, String time,
                                                        String format) {
        ...
        try {
            ...
            return getFormattedTimeWithoutMinuteSecond(ZonedDateTime.parse(timestamp.toString(), dateTimeFormatter),
                format);
        }
