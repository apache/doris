...
public class LogicalAggregate<CHILD_TYPE extends Plan> extends LogicalUnary<CHILD_TYPE>
     ...
     */
    public LogicalAggregate(List<Expression> groupByExpressions, List<NamedExpression> outputExpressions,
            CHILD_TYPE child) {
        this(groupByExpressions, outputExpressions, false, Optional.empty(), child);
    }
     ...
     */
    public LogicalAggregate(List<Expression> groupByExpressions, List<NamedExpression> outputExpressions,
            Optional<LogicalRepeat> sourceRepeat, CHILD_TYPE child) {
        this(groupByExpressions, outputExpressions, false, sourceRepeat, child);
    }

    public LogicalAggregate(List<Expression> groupByExpressions, List<NamedExpression> outputExpressions,
            boolean normalized, Optional<LogicalRepeat> sourceRepeat, CHILD_TYPE child) {
        this(groupByExpressions, outputExpressions, normalized, sourceRepeat, Optional.empty(), Optional.empty(),
                child);
    }
     ...
     */
    private LogicalAggregate(List<Expression> groupByExpressions, List<NamedExpression> outputExpressions,
            boolean normalized, Optional<LogicalRepeat> sourceRepeat, Optional<GroupExpression> groupExpression,
    ...
    public String toString() {
        return Utils.toSqlString("LogicalAggregate[" + id.asInt() + "]", "groupByExpr", groupByExpressions,
                "outputExpr", outputExpressions, "hasRepeat", sourceRepeat.isPresent());
    }

    @Override
    public List<Slot> computeOutput() {
        return outputExpressions.stream().map(NamedExpression::toSlot).collect(ImmutableList.toImmutableList());
    }
    ...
    public LogicalAggregate<Plan> withChildren(List<Plan> children) {
        ...
        return new LogicalAggregate<>(groupByExpressions, outputExpressions, normalized, sourceRepeat, children.get(0));
    }

    @Override
    public LogicalAggregate<Plan> withGroupExpression(Optional<GroupExpression> groupExpression) {
        return new LogicalAggregate<>(groupByExpressions, outputExpressions, normalized, sourceRepeat, groupExpression,
    ...
    public LogicalAggregate<Plan> withLogicalProperties(Optional<LogicalProperties> logicalProperties) {
        return new LogicalAggregate<>(groupByExpressions, outputExpressions, normalized, sourceRepeat, Optional.empty(),
    ...
    public LogicalAggregate<CHILD_TYPE> withAggOutput(List<NamedExpression> newOutput) {
        return new LogicalAggregate<>(groupByExpressions, newOutput, normalized, sourceRepeat, child());
    }
    ...
    public LogicalAggregate<Plan> withNormalized(List<Expression> normalizedGroupBy,
        ...
        return new LogicalAggregate<>(normalizedGroupBy, normalizedOutput, true, sourceRepeat, normalizedChild);
    }
