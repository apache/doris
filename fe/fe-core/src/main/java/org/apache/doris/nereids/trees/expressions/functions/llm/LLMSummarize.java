...
/**
 * LLM function 'LLM_Summarize'
 */
public class LLMSummarize extends LLMFunction {
    ...
    public LLMSummarize(Expression arg) {
        super("llm_summarize", arg);
    }

    /**
     * constructor with 2 argument.
     */
    public LLMSummarize(Expression arg0, Expression arg1) {
        super("llm_summarize", arg0, arg1);
    }

    @Override
    public LLMSummarize withChildren(List<Expression> children) {
        Preconditions.checkArgument(children.size() == 1 || children.size() == 2,
                "LLM_SUMMARIZE only accepts 1 or 2 arguments");
        if (children.size() == 1) {
            return new LLMSummarize(children.get(0));
        }
    ...
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitLLMSummarize(this, context);
    }
}
