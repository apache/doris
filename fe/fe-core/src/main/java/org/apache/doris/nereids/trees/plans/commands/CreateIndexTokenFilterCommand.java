 ...
 */
public class CreateIndexTokenFilterCommand extends Command implements ForwardWithSync {
     ...
     * Constructor
     */
    public CreateIndexTokenFilterCommand(boolean ifNotExists, String policyName, Map<String, String> properties) {
        super(PlanType.CREATE_INDEX_TOKEN_FILTER_COMMAND);
    ...
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitCreateIndexTokenFilterCommand(this, context);
    }
}
