...
public class CloudEnv extends Env {
    ...
    protected void getClusterIdAndRole() throws IOException {
        ...
        if (type != NodeInfoPB.NodeType.FE_OBSERVER && (isMyself() || (roleFile.exists() && versionFile.exists()))) {
            if (!isMyself()) {
            ...
            if (!roleFile.exists()) {
                ...
                if (type == NodeInfoPB.NodeType.FE_MASTER || type == NodeInfoPB.NodeType.FE_FOLLOWER) {
