 ...
 * Physical Rollup.
 */
public class PhysicalRollup<CHILD_TYPE extends Plan> extends PhysicalGroupBy<CHILD_TYPE> {

    private final List<Expression> groupByExpressions;
    private final List<Expression> originGroupByExprs;

    public PhysicalRollup(List<Expression> groupingByExpressions,
        ...
        this(groupingByExpressions, originGroupByExprs, outputExpressions,
    ...
    public PhysicalRollup(List<Expression> groupingByExpressions,
        ...
        this.originGroupByExprs = originGroupByExprs;
    }
    ...
    public String toString() {
        return Utils.toSqlString("PhysicalRollup",
    ...
    public boolean equals(Object o) {
        ...
        PhysicalRollup that = (PhysicalRollup) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(groupByExpressions, originGroupByExprs, outputExpressions);
    }

    @Override
    public <R, C> R accept(PlanVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalRollup(this, context);
    }
    ...
    @Override
    public PhysicalRollup<Plan> withChildren(List<Plan> children) {
        Preconditions.checkArgument(children.size() == 1);
        return new PhysicalRollup<>(groupByExpressions, originGroupByExprs, outputExpressions,
                groupingIdList, virtualSlotRefs, virtualGroupingExprs, groupingList,
                getLogicalProperties(), children.get(0));
    }

    @Override
    public PhysicalRollup<CHILD_TYPE> withGroupExpression(Optional<GroupExpression> groupExpression) {
        return new PhysicalRollup<>(groupByExpressions, originGroupByExprs, outputExpressions,
                groupingIdList, virtualSlotRefs, virtualGroupingExprs, groupingList,
    ...
    @Override
    public PhysicalRollup<CHILD_TYPE> withLogicalProperties(Optional<LogicalProperties> logicalProperties) {
        return new PhysicalRollup<>(groupByExpressions, originGroupByExprs, outputExpressions,
                groupingIdList, virtualSlotRefs, virtualGroupingExprs, groupingList,
    ...
    @Override
    public PhysicalRollup<CHILD_TYPE> withPhysicalPropertiesAndStats(PhysicalProperties physicalProperties,
