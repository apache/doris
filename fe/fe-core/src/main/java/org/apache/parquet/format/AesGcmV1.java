...
public class AesGcmV1 implements org.apache.thrift.TBase<AesGcmV1, AesGcmV1._Fields>, java.io.Serializable, Cloneable, Comparable<AesGcmV1> {
   ...
   * AAD prefix *
   */
  public AesGcmV1 setAadPrefix(byte[] aad_prefix) {
    this.aad_prefix = aad_prefix == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(aad_prefix.clone());
    return this;
  }

  public AesGcmV1 setAadPrefix(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer aad_prefix) {
   ...
   * Unique file identifier part of AAD suffix *
   */
  public AesGcmV1 setAadFileUnique(byte[] aad_file_unique) {
    this.aad_file_unique = aad_file_unique == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(aad_file_unique.clone());
    return this;
  }

  public AesGcmV1 setAadFileUnique(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer aad_file_unique) {
   ...
   * readers must supply the prefix *
   */
  public AesGcmV1 setSupplyAadPrefix(boolean supply_aad_prefix) {
