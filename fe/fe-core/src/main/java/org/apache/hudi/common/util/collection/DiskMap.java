...
public abstract class DiskMap<T extends Serializable, R extends Serializable> implements Map<T, R>, Iterable<R> {
    ...
    /**
     * Constructor for DiskMap.
     *
     * @param basePath The base path for the disk map.
     * @param prefix   The prefix for the disk map.
     * @throws IOException If an I/O error occurs.
     */
    public DiskMap(String basePath, String prefix) throws IOException {
        this.diskMapPath = String.format("%s/%s-%s-%s", basePath, SUBFOLDER_PREFIX, prefix,
