...
%{
    ...
    static {
        ...
        keywordMap.put("analyzer", new Integer(SqlParserSymbols.KW_ANALYZER));
        ...
        keywordMap.put("cipher", new Integer(SqlParserSymbols.KW_CIPHER));
        ...
        keywordMap.put("issuer", new Integer(SqlParserSymbols.KW_ISSUER));
        ...
        keywordMap.put("none", new Integer(SqlParserSymbols.KW_NONE));
        ...
        keywordMap.put("retention", new Integer(SqlParserSymbols.KW_RETENTION));
        keywordMap.put("require", new Integer(SqlParserSymbols.KW_REQUIRE));
        ...
        keywordMap.put("san", new Integer(SqlParserSymbols.KW_SAN));
        ...
        keywordMap.put("snapshots", new Integer(SqlParserSymbols.KW_SNAPSHOTS));
        ...
        keywordMap.put("subject", new Integer(SqlParserSymbols.KW_SUBJECT));
        ...
        keywordMap.put("tokenizer", new Integer(SqlParserSymbols.KW_TOKENIZER));
        keywordMap.put("token_filter", new Integer(SqlParserSymbols.KW_TOKEN_FILTER));
