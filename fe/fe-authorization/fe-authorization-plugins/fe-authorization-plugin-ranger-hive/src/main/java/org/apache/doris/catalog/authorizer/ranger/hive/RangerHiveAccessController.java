...
public class RangerHiveAccessController extends RangerAccessController {
    ...
    /**
     * Locale.ROOT because this spelling has to be the one the Hive service definition declares, and that is
     * not a property of whoever started the FE: with a Turkish locale the default rules fold the "I" of INDEX
     * to "ı", an access type no service definition declares.
     */
