...
public class TNestedLoopJoinNode implements org.apache.thrift.TBase<TNestedLoopJoinNode, TNestedLoopJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TNestedLoopJoinNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list548.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem549;
                for (int _i550 = 0; _i550 < _list548.size; ++_i550)
                {
                  _elem549 = new org.apache.doris.thrift.TExpr();
                  _elem549.read(iprot);
                  struct.srcExprList.add(_elem549);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list551.size);
                int _elem552;
                for (int _i553 = 0; _i553 < _list551.size; ++_i553)
                {
                  _elem552 = iprot.readI32();
                  struct.vintermediate_tuple_id_list.add(_elem552);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list554.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem555;
                for (int _i556 = 0; _i556 < _list554.size; ++_i556)
                {
                  _elem555 = new org.apache.doris.thrift.TExpr();
                  _elem555.read(iprot);
                  struct.join_conjuncts.add(_elem555);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.srcExprList != null) {
        if (struct.isSetSrcExprList()) {
          oprot.writeFieldBegin(SRC_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter557 : struct.srcExprList)
            {
      ...
      if (struct.vintermediate_tuple_id_list != null) {
        if (struct.isSetVintermediateTupleIdList()) {
          oprot.writeFieldBegin(VINTERMEDIATE_TUPLE_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter558 : struct.vintermediate_tuple_id_list)
            {
      ...
      if (struct.join_conjuncts != null) {
        if (struct.isSetJoinConjuncts()) {
          oprot.writeFieldBegin(JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter559 : struct.join_conjuncts)
            {
  ...
  private static class TNestedLoopJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TNestedLoopJoinNode> {
      ...
      if (struct.isSetSrcExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter560 : struct.srcExprList)
          {
      ...
      if (struct.isSetVintermediateTupleIdList()) {
        {
          ...
          for (int _iter561 : struct.vintermediate_tuple_id_list)
          {
      ...
      if (struct.isSetJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter562 : struct.join_conjuncts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TNestedLoopJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list563.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem564;
          for (int _i565 = 0; _i565 < _list563.size; ++_i565)
          {
            _elem564 = new org.apache.doris.thrift.TExpr();
            _elem564.read(iprot);
            struct.srcExprList.add(_elem564);
          }
        }
        struct.setSrcExprListIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list566 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list566.size);
          int _elem567;
          for (int _i568 = 0; _i568 < _list566.size; ++_i568)
          {
            _elem567 = iprot.readI32();
            struct.vintermediate_tuple_id_list.add(_elem567);
          }
        }
        struct.setVintermediateTupleIdListIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list569.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem570;
          for (int _i571 = 0; _i571 < _list569.size; ++_i571)
          {
            _elem570 = new org.apache.doris.thrift.TExpr();
            _elem570.read(iprot);
            struct.join_conjuncts.add(_elem570);
          }
        }
        struct.setJoinConjunctsIsSet(true);
      }
