            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list194.size);
                @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem195;
                for (int _i196 = 0; _i196 < _list194.size; ++_i196)
                {
                  _elem195 = new TTabletMetaInfo();
                  _elem195.read(iprot);
                  struct.tabletMetaInfos.add(_elem195);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tabletMetaInfos != null) {
        if (struct.isSetTabletMetaInfos()) {
          oprot.writeFieldBegin(TABLET_META_INFOS_FIELD_DESC);
          {
            ...
            for (TTabletMetaInfo _iter197 : struct.tabletMetaInfos)
            {
      ...
      if (struct.isSetTabletMetaInfos()) {
        {
          ...
          for (TTabletMetaInfo _iter198 : struct.tabletMetaInfos)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list199.size);
          @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem200;
          for (int _i201 = 0; _i201 < _list199.size; ++_i201)
          {
            _elem200 = new TTabletMetaInfo();
            _elem200.read(iprot);
            struct.tabletMetaInfos.add(_elem200);
          }
        }
        struct.setTabletMetaInfosIsSet(true);
      }
