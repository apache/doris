...
public enum PrimitiveType {
    ...
    private static ArrayList<PrimitiveType> availableInDdlTypes;
    ...
    static {
        ...
        availableInDdlTypes = Lists.newArrayList();
        availableInDdlTypes.add(BOOLEAN);
        availableInDdlTypes.add(TINYINT);
        availableInDdlTypes.add(SMALLINT);
        availableInDdlTypes.add(INT);
        availableInDdlTypes.add(BIGINT);
        availableInDdlTypes.add(LARGEINT);
        availableInDdlTypes.add(FLOAT);
        availableInDdlTypes.add(DOUBLE);
        availableInDdlTypes.add(VARCHAR);
        availableInDdlTypes.add(JSONB);
        availableInDdlTypes.add(STRING);
        availableInDdlTypes.add(HLL);
        availableInDdlTypes.add(CHAR);
        availableInDdlTypes.add(DATE);
        availableInDdlTypes.add(DATETIME);
        availableInDdlTypes.add(DATEV2);
        availableInDdlTypes.add(DATETIMEV2);
        availableInDdlTypes.add(DECIMALV2);
        availableInDdlTypes.add(DECIMAL32);
        availableInDdlTypes.add(DECIMAL64);
        availableInDdlTypes.add(DECIMAL128);
        availableInDdlTypes.add(BITMAP);
        availableInDdlTypes.add(ARRAY);
        availableInDdlTypes.add(MAP);
        availableInDdlTypes.add(QUANTILE_STATE);
    }
    ...
    public static ArrayList<PrimitiveType> getavailableInDdlTypes() {
        return availableInDdlTypes;
    }
