            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<TScanRangeParams>>(2*_map226.size);
                int _key227;
                @org.apache.thrift.annotation.Nullable java.util.List<TScanRangeParams> _val228;
                for (int _i229 = 0; _i229 < _map226.size; ++_i229)
                {
                  _key227 = iprot.readI32();
                  {
                    ...
                    _val228 = new java.util.ArrayList<TScanRangeParams>(_list230.size);
                    @org.apache.thrift.annotation.Nullable TScanRangeParams _elem231;
                    for (int _i232 = 0; _i232 < _list230.size; ++_i232)
                    {
                      _elem231 = new TScanRangeParams();
                      _elem231.read(iprot);
                      _val228.add(_elem231);
                    }
                    iprot.readListEnd();
                  }
                  struct.per_node_scan_ranges.put(_key227, _val228);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_node_shared_scans = new java.util.HashMap<java.lang.Integer,java.lang.Boolean>(2*_map233.size);
                int _key234;
                boolean _val235;
                for (int _i236 = 0; _i236 < _map233.size; ++_i236)
                {
                  _key234 = iprot.readI32();
                  _val235 = iprot.readBool();
                  struct.per_node_shared_scans.put(_key234, _val235);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPipelineInstanceParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.per_node_scan_ranges != null) {
        oprot.writeFieldBegin(PER_NODE_SCAN_RANGES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.util.List<TScanRangeParams>> _iter237 : struct.per_node_scan_ranges.entrySet())
          {
            oprot.writeI32(_iter237.getKey());
            {
              ...
              for (TScanRangeParams _iter238 : _iter237.getValue())
              {
      ...
      if (struct.per_node_shared_scans != null) {
        if (struct.isSetPerNodeSharedScans()) {
          oprot.writeFieldBegin(PER_NODE_SHARED_SCANS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Boolean> _iter239 : struct.per_node_shared_scans.entrySet())
            {
              oprot.writeI32(_iter239.getKey());
              oprot.writeBool(_iter239.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TPipelineInstanceParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPipelineInstanceParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPipelineInstanceParams struct) throws org.apache.thrift.TException {
      ...
      struct.fragment_instance_id.write(oprot);
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, java.util.List<TScanRangeParams>> _iter240 : struct.per_node_scan_ranges.entrySet())
        {
          oprot.writeI32(_iter240.getKey());
          {
            oprot.writeI32(_iter240.getValue().size());
            for (TScanRangeParams _iter241 : _iter240.getValue())
            {
      ...
      if (struct.isSetPerNodeSharedScans()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Boolean> _iter242 : struct.per_node_shared_scans.entrySet())
          {
            oprot.writeI32(_iter242.getKey());
            oprot.writeBool(_iter242.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPipelineInstanceParams struct) throws org.apache.thrift.TException {
      ...
      struct.setFragmentInstanceIdIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map243 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.LIST); 
        struct.per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<TScanRangeParams>>(2*_map243.size);
        int _key244;
        @org.apache.thrift.annotation.Nullable java.util.List<TScanRangeParams> _val245;
        for (int _i246 = 0; _i246 < _map243.size; ++_i246)
        {
          _key244 = iprot.readI32();
          {
            ...
            _val245 = new java.util.ArrayList<TScanRangeParams>(_list247.size);
            @org.apache.thrift.annotation.Nullable TScanRangeParams _elem248;
            for (int _i249 = 0; _i249 < _list247.size; ++_i249)
            {
              _elem248 = new TScanRangeParams();
              _elem248.read(iprot);
              _val245.add(_elem248);
            }
          }
          struct.per_node_scan_ranges.put(_key244, _val245);
        }
      }
      struct.setPerNodeScanRangesIsSet(true);
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map250 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.BOOL); 
          struct.per_node_shared_scans = new java.util.HashMap<java.lang.Integer,java.lang.Boolean>(2*_map250.size);
          int _key251;
          boolean _val252;
          for (int _i253 = 0; _i253 < _map250.size; ++_i253)
          {
            _key251 = iprot.readI32();
            _val252 = iprot.readBool();
            struct.per_node_shared_scans.put(_key251, _val252);
          }
        }
        struct.setPerNodeSharedScansIsSet(true);
      }
