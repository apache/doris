...
public class TEsScanNode implements org.apache.thrift.TBase<TEsScanNode, TEsScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TEsScanNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.docvalue_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map342.size);
                ...
                for (int _i345 = 0; _i345 < _map342.size; ++_i345)
                {
                  ...
                  struct.docvalue_context.put(_key343, _val344);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.fields_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map346.size);
                ...
                for (int _i349 = 0; _i349 < _map346.size; ++_i349)
                {
                  ...
                  struct.fields_context.put(_key347, _val348);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter350 : struct.properties.entrySet())
            {
      ...
      if (struct.docvalue_context != null) {
        if (struct.isSetDocvalueContext()) {
          oprot.writeFieldBegin(DOCVALUE_CONTEXT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter351 : struct.docvalue_context.entrySet())
            {
      ...
      if (struct.fields_context != null) {
        if (struct.isSetFieldsContext()) {
          oprot.writeFieldBegin(FIELDS_CONTEXT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter352 : struct.fields_context.entrySet())
            {
  ...
  private static class TEsScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TEsScanNode> {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter353 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetDocvalueContext()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter354 : struct.docvalue_context.entrySet())
          {
      ...
      if (struct.isSetFieldsContext()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter355 : struct.fields_context.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TEsScanNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map356 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map356.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.docvalue_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map360.size);
          ...
          for (int _i363 = 0; _i363 < _map360.size; ++_i363)
          {
            ...
            struct.docvalue_context.put(_key361, _val362);
          }
        }
        struct.setDocvalueContextIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.fields_context = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map364.size);
          ...
          for (int _i367 = 0; _i367 < _map364.size; ++_i367)
          {
            ...
            struct.fields_context.put(_key365, _val366);
          }
        }
        struct.setFieldsContextIsSet(true);
      }
