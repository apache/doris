      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter304 : struct.columns)
            {
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter305 : struct.filters)
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter306 : struct.columns)
          {
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (java.lang.String _iter307 : struct.filters)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.columns = new java.util.ArrayList<java.lang.String>(_list308.size);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.filters = new java.util.ArrayList<java.lang.String>(_list311.size);
