            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list812.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem813;
                for (int _i814 = 0; _i814 < _list812.size; ++_i814)
                {
                  {
                    org.apache.thrift.protocol.TList _list815 = iprot.readListBegin();
                    _elem813 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list815.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem816;
                    for (int _i817 = 0; _i817 < _list815.size; ++_i817)
                    {
                      _elem816 = new org.apache.doris.thrift.TExpr();
                      _elem816.read(iprot);
                      _elem813.add(_elem816);
                    }
                    iprot.readListEnd();
                  }
                  struct.result_expr_lists.add(_elem813);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list818.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem819;
                for (int _i820 = 0; _i820 < _list818.size; ++_i820)
                {
                  {
                    org.apache.thrift.protocol.TList _list821 = iprot.readListBegin();
                    _elem819 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list821.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem822;
                    for (int _i823 = 0; _i823 < _list821.size; ++_i823)
                    {
                      _elem822 = new org.apache.doris.thrift.TExpr();
                      _elem822.read(iprot);
                      _elem819.add(_elem822);
                    }
                    iprot.readListEnd();
                  }
                  struct.const_expr_lists.add(_elem819);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter824 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter824.size()));
              for (org.apache.doris.thrift.TExpr _iter825 : _iter824)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter826 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter826.size()));
              for (org.apache.doris.thrift.TExpr _iter827 : _iter826)
              {
  ...
  private static class TExceptNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExceptNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter828 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter828.size());
            for (org.apache.doris.thrift.TExpr _iter829 : _iter828)
            {
      ...
      }
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter830 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter830.size());
            for (org.apache.doris.thrift.TExpr _iter831 : _iter830)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list832 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list832.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem833;
        ...
        {
          {
            ...
            _elem833 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list835.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem836;
            for (int _i837 = 0; _i837 < _list835.size; ++_i837)
            {
              _elem836 = new org.apache.doris.thrift.TExpr();
              _elem836.read(iprot);
              _elem833.add(_elem836);
            }
          }
          struct.result_expr_lists.add(_elem833);
        }
      }
      struct.setResultExprListsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list838 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list838.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem839;
        for (int _i840 = 0; _i840 < _list838.size; ++_i840)
        {
          {
            org.apache.thrift.protocol.TList _list841 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
            _elem839 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list841.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem842;
            for (int _i843 = 0; _i843 < _list841.size; ++_i843)
            {
              _elem842 = new org.apache.doris.thrift.TExpr();
              _elem842.read(iprot);
              _elem839.add(_elem842);
            }
          }
          struct.const_expr_lists.add(_elem839);
        }
      }
      struct.setConstExprListsIsSet(true);
      struct.first_materialized_child_idx = iprot.readI64();
