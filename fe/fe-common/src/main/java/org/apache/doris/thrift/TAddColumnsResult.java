            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.allColumns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list348.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem349;
                for (int _i350 = 0; _i350 < _list348.size; ++_i350)
                {
                  _elem349 = new org.apache.doris.thrift.TColumn();
                  _elem349.read(iprot);
                  struct.allColumns.add(_elem349);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.allColumns != null) {
        if (struct.isSetAllColumns()) {
          oprot.writeFieldBegin(ALL_COLUMNS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter351 : struct.allColumns)
            {
      ...
      if (struct.isSetAllColumns()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter352 : struct.allColumns)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.allColumns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list353.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem354;
          for (int _i355 = 0; _i355 < _list353.size; ++_i355)
          {
            _elem354 = new org.apache.doris.thrift.TColumn();
            _elem354.read(iprot);
            struct.allColumns.add(_elem354);
          }
        }
        struct.setAllColumnsIsSet(true);
      }
