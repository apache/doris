            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.allColumns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list284.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem285;
                for (int _i286 = 0; _i286 < _list284.size; ++_i286)
                {
                  _elem285 = new org.apache.doris.thrift.TColumn();
                  _elem285.read(iprot);
                  struct.allColumns.add(_elem285);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.allColumns != null) {
        if (struct.isSetAllColumns()) {
          oprot.writeFieldBegin(ALL_COLUMNS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter287 : struct.allColumns)
            {
      ...
      if (struct.isSetAllColumns()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter288 : struct.allColumns)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.allColumns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list289.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem290;
          for (int _i291 = 0; _i291 < _list289.size; ++_i291)
          {
            _elem290 = new org.apache.doris.thrift.TColumn();
            _elem290.read(iprot);
            struct.allColumns.add(_elem290);
          }
        }
        struct.setAllColumnsIsSet(true);
      }
