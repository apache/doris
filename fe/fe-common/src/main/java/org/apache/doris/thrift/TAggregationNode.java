...
public class TAggregationNode implements org.apache.thrift.TBase<TAggregationNode, TAggregationNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAggregationNode> {
  ...
  private static final _Fields optionals[] = {_Fields.GROUPING_EXPRS,_Fields.USE_STREAMING_PREAGGREGATION,_Fields.AGG_SORT_INFOS,_Fields.IS_FIRST_PHASE};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list588.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem589;
                for (int _i590 = 0; _i590 < _list588.size; ++_i590)
                {
                  _elem589 = new org.apache.doris.thrift.TExpr();
                  _elem589.read(iprot);
                  struct.grouping_exprs.add(_elem589);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list591.size);
                ...
                for (int _i593 = 0; _i593 < _list591.size; ++_i593)
                {
                  ...
                  _elem592.read(iprot);
                  struct.aggregate_functions.add(_elem592);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.agg_sort_infos = new java.util.ArrayList<TSortInfo>(_list594.size);
                @org.apache.thrift.annotation.Nullable TSortInfo _elem595;
                for (int _i596 = 0; _i596 < _list594.size; ++_i596)
                {
                  _elem595 = new TSortInfo();
                  _elem595.read(iprot);
                  struct.agg_sort_infos.add(_elem595);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGroupingExprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter597 : struct.grouping_exprs)
            {
      ...
      if (struct.aggregate_functions != null) {
        oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter598 : struct.aggregate_functions)
          {
      ...
      if (struct.agg_sort_infos != null) {
        if (struct.isSetAggSortInfos()) {
          oprot.writeFieldBegin(AGG_SORT_INFOS_FIELD_DESC);
          {
            ...
            for (TSortInfo _iter599 : struct.agg_sort_infos)
            {
  ...
  private static class TAggregationNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAggregationNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter600 : struct.aggregate_functions)
        {
      ...
      if (struct.isSetGroupingExprs()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter601 : struct.grouping_exprs)
          {
      ...
      if (struct.isSetAggSortInfos()) {
        {
          ...
          for (TSortInfo _iter602 : struct.agg_sort_infos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list603 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.aggregate_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list603.size);
        ...
        for (int _i605 = 0; _i605 < _list603.size; ++_i605)
        {
          ...
          _elem604.read(iprot);
          struct.aggregate_functions.add(_elem604);
        }
      }
      struct.setAggregateFunctionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.grouping_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list606.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem607;
          for (int _i608 = 0; _i608 < _list606.size; ++_i608)
          {
            _elem607 = new org.apache.doris.thrift.TExpr();
            _elem607.read(iprot);
            struct.grouping_exprs.add(_elem607);
          }
        }
        struct.setGroupingExprsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.agg_sort_infos = new java.util.ArrayList<TSortInfo>(_list609.size);
          @org.apache.thrift.annotation.Nullable TSortInfo _elem610;
          for (int _i611 = 0; _i611 < _list609.size; ++_i611)
          {
            _elem610 = new TSortInfo();
            _elem610.read(iprot);
            struct.agg_sort_infos.add(_elem610);
          }
        }
        struct.setAggSortInfosIsSet(true);
      }
