...
public class TLoadTxnRollbackRequest implements org.apache.thrift.TBase<TLoadTxnRollbackRequest, TLoadTxnRollbackRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnRollbackRequest> {
  ...
  private static final org.apache.thrift.protocol.TField TBLS_FIELD_DESC = new org.apache.thrift.protocol.TField("tbls", org.apache.thrift.protocol.TType.LIST, (short)13);
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER_IP,_Fields.REASON,_Fields.AUTH_CODE,_Fields.TXN_COMMIT_ATTACHMENT,_Fields.TOKEN,_Fields.DB_ID,_Fields.TBLS};
  ...
  public TLoadTxnRollbackRequest setTbls(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> tbls) {
    this.tbls = tbls;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tbls = new java.util.ArrayList<java.lang.String>(_list300.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem301;
                for (int _i302 = 0; _i302 < _list300.size; ++_i302)
                {
                  _elem301 = iprot.readString();
                  struct.tbls.add(_elem301);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tbls != null) {
        if (struct.isSetTbls()) {
          oprot.writeFieldBegin(TBLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter303 : struct.tbls)
            {
  ...
  private static class TLoadTxnRollbackRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLoadTxnRollbackRequest> {
      ...
      if (struct.isSetTbls()) {
        {
          ...
          for (java.lang.String _iter304 : struct.tbls)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TLoadTxnRollbackRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list305 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.tbls = new java.util.ArrayList<java.lang.String>(_list305.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem306;
          for (int _i307 = 0; _i307 < _list305.size; ++_i307)
          {
            _elem306 = iprot.readString();
            struct.tbls.add(_elem306);
          }
        }
        struct.setTblsIsSet(true);
      }
