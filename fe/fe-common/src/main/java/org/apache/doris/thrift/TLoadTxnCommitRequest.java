...
public class TLoadTxnCommitRequest implements org.apache.thrift.TBase<TLoadTxnCommitRequest, TLoadTxnCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnCommitRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list284.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem285;
                for (int _i286 = 0; _i286 < _list284.size; ++_i286)
                {
                  _elem285 = new org.apache.doris.thrift.TTabletCommitInfo();
                  _elem285.read(iprot);
                  struct.commitInfos.add(_elem285);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tbls = new java.util.ArrayList<java.lang.String>(_list287.size);
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletCommitInfo _iter290 : struct.commitInfos)
            {
      ...
      if (struct.tbls != null) {
        if (struct.isSetTbls()) {
          oprot.writeFieldBegin(TBLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter291 : struct.tbls)
            {
  ...
  private static class TLoadTxnCommitRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLoadTxnCommitRequest> {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletCommitInfo _iter292 : struct.commitInfos)
          {
      ...
      if (struct.isSetTbls()) {
        {
          ...
          for (java.lang.String _iter293 : struct.tbls)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TLoadTxnCommitRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list294 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list294.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem295;
          for (int _i296 = 0; _i296 < _list294.size; ++_i296)
          {
            _elem295 = new org.apache.doris.thrift.TTabletCommitInfo();
            _elem295.read(iprot);
            struct.commitInfos.add(_elem295);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.tbls = new java.util.ArrayList<java.lang.String>(_list297.size);
