            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.confirmed_tablets = new java.util.ArrayList<java.lang.Long>(_list364.size);
                long _elem365;
                for (int _i366 = 0; _i366 < _list364.size; ++_i366)
                {
                  _elem365 = iprot.readI64();
                  struct.confirmed_tablets.add(_elem365);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.confirmed_tablets != null) {
        if (struct.isSetConfirmedTablets()) {
          oprot.writeFieldBegin(CONFIRMED_TABLETS_FIELD_DESC);
          {
            ...
            for (long _iter367 : struct.confirmed_tablets)
            {
      ...
      if (struct.isSetConfirmedTablets()) {
        {
          ...
          for (long _iter368 : struct.confirmed_tablets)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confirmed_tablets = new java.util.ArrayList<java.lang.Long>(_list369.size);
          long _elem370;
          for (int _i371 = 0; _i371 < _list369.size; ++_i371)
          {
            _elem370 = iprot.readI64();
            struct.confirmed_tablets.add(_elem370);
          }
        }
        struct.setConfirmedTabletsIsSet(true);
      }
