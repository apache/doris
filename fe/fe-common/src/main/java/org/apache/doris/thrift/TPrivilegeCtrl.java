            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.cols = new java.util.HashSet<java.lang.String>(2*_set372.size);
      ...
      if (struct.cols != null) {
        if (struct.isSetCols()) {
          oprot.writeFieldBegin(COLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter375 : struct.cols)
            {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (java.lang.String _iter376 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new java.util.HashSet<java.lang.String>(2*_set377.size);
