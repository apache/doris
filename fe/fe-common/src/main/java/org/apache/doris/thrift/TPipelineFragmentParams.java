            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_exch_num_senders = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map264.size);
                int _key265;
                int _val266;
                for (int _i267 = 0; _i267 < _map264.size; ++_i267)
                {
                  ...
                  struct.per_exch_num_senders.put(_key265, _val266);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.destinations = new java.util.ArrayList<org.apache.doris.thrift.TPlanFragmentDestination>(_list268.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPlanFragmentDestination _elem269;
                for (int _i270 = 0; _i270 < _list268.size; ++_i270)
                {
                  _elem269 = new org.apache.doris.thrift.TPlanFragmentDestination();
                  _elem269.read(iprot);
                  struct.destinations.add(_elem269);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.instances_sharing_hash_table = new java.util.ArrayList<org.apache.doris.thrift.TUniqueId>(_list271.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TUniqueId _elem272;
                for (int _i273 = 0; _i273 < _list271.size; ++_i273)
                {
                  _elem272 = new org.apache.doris.thrift.TUniqueId();
                  _elem272.read(iprot);
                  struct.instances_sharing_hash_table.add(_elem272);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.local_params = new java.util.ArrayList<TPipelineInstanceParams>(_list274.size);
                @org.apache.thrift.annotation.Nullable TPipelineInstanceParams _elem275;
                for (int _i276 = 0; _i276 < _list274.size; ++_i276)
                {
                  _elem275 = new TPipelineInstanceParams();
                  _elem275.read(iprot);
                  struct.local_params.add(_elem275);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.workload_groups = new java.util.ArrayList<TPipelineWorkloadGroup>(_list277.size);
                @org.apache.thrift.annotation.Nullable TPipelineWorkloadGroup _elem278;
                for (int _i279 = 0; _i279 < _list277.size; ++_i279)
                {
                  _elem278 = new TPipelineWorkloadGroup();
                  _elem278.read(iprot);
                  struct.workload_groups.add(_elem278);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.file_scan_params = new java.util.HashMap<java.lang.Integer,org.apache.doris.thrift.TFileScanRangeParams>(2*_map280.size);
                int _key281;
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TFileScanRangeParams _val282;
                for (int _i283 = 0; _i283 < _map280.size; ++_i283)
                {
                  _key281 = iprot.readI32();
                  _val282 = new org.apache.doris.thrift.TFileScanRangeParams();
                  _val282.read(iprot);
                  struct.file_scan_params.put(_key281, _val282);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPipelineFragmentParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.per_exch_num_senders != null) {
        oprot.writeFieldBegin(PER_EXCH_NUM_SENDERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter284 : struct.per_exch_num_senders.entrySet())
          {
      ...
      if (struct.destinations != null) {
        oprot.writeFieldBegin(DESTINATIONS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TPlanFragmentDestination _iter285 : struct.destinations)
          {
      ...
      if (struct.instances_sharing_hash_table != null) {
        if (struct.isSetInstancesSharingHashTable()) {
          oprot.writeFieldBegin(INSTANCES_SHARING_HASH_TABLE_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TUniqueId _iter286 : struct.instances_sharing_hash_table)
            {
      ...
      if (struct.local_params != null) {
        oprot.writeFieldBegin(LOCAL_PARAMS_FIELD_DESC);
        {
          ...
          for (TPipelineInstanceParams _iter287 : struct.local_params)
          {
      ...
      if (struct.workload_groups != null) {
        if (struct.isSetWorkloadGroups()) {
          oprot.writeFieldBegin(WORKLOAD_GROUPS_FIELD_DESC);
          {
            ...
            for (TPipelineWorkloadGroup _iter288 : struct.workload_groups)
            {
      ...
      if (struct.file_scan_params != null) {
        if (struct.isSetFileScanParams()) {
          oprot.writeFieldBegin(FILE_SCAN_PARAMS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, org.apache.doris.thrift.TFileScanRangeParams> _iter289 : struct.file_scan_params.entrySet())
            {
  ...
  private static class TPipelineFragmentParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPipelineFragmentParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPipelineFragmentParams struct) throws org.apache.thrift.TException {
      ...
      struct.query_id.write(oprot);
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter290 : struct.per_exch_num_senders.entrySet())
        {
      ...
      if (struct.isSetDestinations()) {
        {
          ...
          for (org.apache.doris.thrift.TPlanFragmentDestination _iter291 : struct.destinations)
          {
      ...
      if (struct.isSetInstancesSharingHashTable()) {
        {
          ...
          for (org.apache.doris.thrift.TUniqueId _iter292 : struct.instances_sharing_hash_table)
          {
      ...
      if (struct.isSetLocalParams()) {
        {
          ...
          for (TPipelineInstanceParams _iter293 : struct.local_params)
          {
      ...
      if (struct.isSetWorkloadGroups()) {
        {
          ...
          for (TPipelineWorkloadGroup _iter294 : struct.workload_groups)
          {
      ...
      if (struct.isSetFileScanParams()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, org.apache.doris.thrift.TFileScanRangeParams> _iter295 : struct.file_scan_params.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPipelineFragmentParams struct) throws org.apache.thrift.TException {
      ...
      struct.setQueryIdIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map296 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32); 
        struct.per_exch_num_senders = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map296.size);
        int _key297;
        int _val298;
        for (int _i299 = 0; _i299 < _map296.size; ++_i299)
        {
          ...
          struct.per_exch_num_senders.put(_key297, _val298);
        }
      }
      struct.setPerExchNumSendersIsSet(true);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.destinations = new java.util.ArrayList<org.apache.doris.thrift.TPlanFragmentDestination>(_list300.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPlanFragmentDestination _elem301;
          for (int _i302 = 0; _i302 < _list300.size; ++_i302)
          {
            _elem301 = new org.apache.doris.thrift.TPlanFragmentDestination();
            _elem301.read(iprot);
            struct.destinations.add(_elem301);
          }
        }
        struct.setDestinationsIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.instances_sharing_hash_table = new java.util.ArrayList<org.apache.doris.thrift.TUniqueId>(_list303.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TUniqueId _elem304;
          for (int _i305 = 0; _i305 < _list303.size; ++_i305)
          {
            _elem304 = new org.apache.doris.thrift.TUniqueId();
            _elem304.read(iprot);
            struct.instances_sharing_hash_table.add(_elem304);
          }
        }
        struct.setInstancesSharingHashTableIsSet(true);
      }
      ...
      if (incoming.get(20)) {
        {
          ...
          struct.local_params = new java.util.ArrayList<TPipelineInstanceParams>(_list306.size);
          @org.apache.thrift.annotation.Nullable TPipelineInstanceParams _elem307;
          for (int _i308 = 0; _i308 < _list306.size; ++_i308)
          {
            _elem307 = new TPipelineInstanceParams();
            _elem307.read(iprot);
            struct.local_params.add(_elem307);
          }
        }
        struct.setLocalParamsIsSet(true);
      }
      if (incoming.get(21)) {
        {
          ...
          struct.workload_groups = new java.util.ArrayList<TPipelineWorkloadGroup>(_list309.size);
          @org.apache.thrift.annotation.Nullable TPipelineWorkloadGroup _elem310;
          for (int _i311 = 0; _i311 < _list309.size; ++_i311)
          {
            _elem310 = new TPipelineWorkloadGroup();
            _elem310.read(iprot);
            struct.workload_groups.add(_elem310);
          }
        }
        struct.setWorkloadGroupsIsSet(true);
      }
      ...
      if (incoming.get(24)) {
        {
          org.apache.thrift.protocol.TMap _map312 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
          struct.file_scan_params = new java.util.HashMap<java.lang.Integer,org.apache.doris.thrift.TFileScanRangeParams>(2*_map312.size);
          int _key313;
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TFileScanRangeParams _val314;
          for (int _i315 = 0; _i315 < _map312.size; ++_i315)
          {
            _key313 = iprot.readI32();
            _val314 = new org.apache.doris.thrift.TFileScanRangeParams();
            _val314.read(iprot);
            struct.file_scan_params.put(_key313, _val314);
          }
        }
        struct.setFileScanParamsIsSet(true);
      }
