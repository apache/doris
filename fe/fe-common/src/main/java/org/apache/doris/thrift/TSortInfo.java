            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ordering_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list420.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem421;
                for (int _i422 = 0; _i422 < _list420.size; ++_i422)
                {
                  _elem421 = new org.apache.doris.thrift.TExpr();
                  _elem421.read(iprot);
                  struct.ordering_exprs.add(_elem421);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.is_asc_order = new java.util.ArrayList<java.lang.Boolean>(_list423.size);
                boolean _elem424;
                for (int _i425 = 0; _i425 < _list423.size; ++_i425)
                {
                  _elem424 = iprot.readBool();
                  struct.is_asc_order.add(_elem424);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nulls_first = new java.util.ArrayList<java.lang.Boolean>(_list426.size);
                boolean _elem427;
                for (int _i428 = 0; _i428 < _list426.size; ++_i428)
                {
                  _elem427 = iprot.readBool();
                  struct.nulls_first.add(_elem427);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sort_tuple_slot_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list429.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem430;
                for (int _i431 = 0; _i431 < _list429.size; ++_i431)
                {
                  _elem430 = new org.apache.doris.thrift.TExpr();
                  _elem430.read(iprot);
                  struct.sort_tuple_slot_exprs.add(_elem430);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slot_exprs_nullability_changed_flags = new java.util.ArrayList<java.lang.Boolean>(_list432.size);
                boolean _elem433;
                for (int _i434 = 0; _i434 < _list432.size; ++_i434)
                {
                  _elem433 = iprot.readBool();
                  struct.slot_exprs_nullability_changed_flags.add(_elem433);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSortInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.ordering_exprs != null) {
        oprot.writeFieldBegin(ORDERING_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter435 : struct.ordering_exprs)
          {
      ...
      if (struct.is_asc_order != null) {
        oprot.writeFieldBegin(IS_ASC_ORDER_FIELD_DESC);
        {
          ...
          for (boolean _iter436 : struct.is_asc_order)
          {
            oprot.writeBool(_iter436);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.nulls_first != null) {
        oprot.writeFieldBegin(NULLS_FIRST_FIELD_DESC);
        {
          ...
          for (boolean _iter437 : struct.nulls_first)
          {
      ...
      if (struct.sort_tuple_slot_exprs != null) {
        if (struct.isSetSortTupleSlotExprs()) {
          oprot.writeFieldBegin(SORT_TUPLE_SLOT_EXPRS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter438 : struct.sort_tuple_slot_exprs)
            {
      ...
      if (struct.slot_exprs_nullability_changed_flags != null) {
        if (struct.isSetSlotExprsNullabilityChangedFlags()) {
          oprot.writeFieldBegin(SLOT_EXPRS_NULLABILITY_CHANGED_FLAGS_FIELD_DESC);
          {
            ...
            for (boolean _iter439 : struct.slot_exprs_nullability_changed_flags)
            {
              oprot.writeBool(_iter439);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TSortInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TSortInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TSortInfo struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter440 : struct.ordering_exprs)
        {
      ...
      }
      {
        ...
        for (boolean _iter441 : struct.is_asc_order)
        {
      ...
      }
      {
        ...
        for (boolean _iter442 : struct.nulls_first)
        {
      ...
      if (struct.isSetSortTupleSlotExprs()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter443 : struct.sort_tuple_slot_exprs)
          {
      ...
      if (struct.isSetSlotExprsNullabilityChangedFlags()) {
        {
          ...
          for (boolean _iter444 : struct.slot_exprs_nullability_changed_flags)
          {
            oprot.writeBool(_iter444);
          }
        }
      }
      if (struct.isSetUseTwoPhaseRead()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSortInfo struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.ordering_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list445.size);
        ...
        for (int _i447 = 0; _i447 < _list445.size; ++_i447)
        {
          ...
          _elem446.read(iprot);
          struct.ordering_exprs.add(_elem446);
        }
      }
      struct.setOrderingExprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list448 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.is_asc_order = new java.util.ArrayList<java.lang.Boolean>(_list448.size);
        boolean _elem449;
        for (int _i450 = 0; _i450 < _list448.size; ++_i450)
        {
          _elem449 = iprot.readBool();
          struct.is_asc_order.add(_elem449);
        }
      }
      struct.setIsAscOrderIsSet(true);
      {
        org.apache.thrift.protocol.TList _list451 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.nulls_first = new java.util.ArrayList<java.lang.Boolean>(_list451.size);
        boolean _elem452;
        for (int _i453 = 0; _i453 < _list451.size; ++_i453)
        {
          _elem452 = iprot.readBool();
          struct.nulls_first.add(_elem452);
        }
      }
      struct.setNullsFirstIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list454 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.sort_tuple_slot_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list454.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem455;
          for (int _i456 = 0; _i456 < _list454.size; ++_i456)
          {
            _elem455 = new org.apache.doris.thrift.TExpr();
            _elem455.read(iprot);
            struct.sort_tuple_slot_exprs.add(_elem455);
          }
        }
        struct.setSortTupleSlotExprsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list457 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
          struct.slot_exprs_nullability_changed_flags = new java.util.ArrayList<java.lang.Boolean>(_list457.size);
          boolean _elem458;
          for (int _i459 = 0; _i459 < _list457.size; ++_i459)
          {
            _elem458 = iprot.readBool();
            struct.slot_exprs_nullability_changed_flags.add(_elem458);
          }
        }
        struct.setSlotExprsNullabilityChangedFlagsIsSet(true);
      }
