            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.binlogs = new java.util.ArrayList<TBinlog>(_list432.size);
                @org.apache.thrift.annotation.Nullable TBinlog _elem433;
                for (int _i434 = 0; _i434 < _list432.size; ++_i434)
                {
                  _elem433 = new TBinlog();
                  _elem433.read(iprot);
                  struct.binlogs.add(_elem433);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.binlogs != null) {
        if (struct.isSetBinlogs()) {
          oprot.writeFieldBegin(BINLOGS_FIELD_DESC);
          {
            ...
            for (TBinlog _iter435 : struct.binlogs)
            {
      ...
      if (struct.isSetBinlogs()) {
        {
          ...
          for (TBinlog _iter436 : struct.binlogs)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.binlogs = new java.util.ArrayList<TBinlog>(_list437.size);
          @org.apache.thrift.annotation.Nullable TBinlog _elem438;
          for (int _i439 = 0; _i439 < _list437.size; ++_i439)
          {
            _elem438 = new TBinlog();
            _elem438.read(iprot);
            struct.binlogs.add(_elem438);
          }
        }
        struct.setBinlogsIsSet(true);
      }
