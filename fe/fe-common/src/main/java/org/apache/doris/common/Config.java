...
public class Config extends ConfigBase {
    ...
    @ConfField(mutable = true, masterOnly = true, description = "Upload cloud memtable segments from sink BEs "
            + "to object storage in HTTP Stream, Routine Load, and Group Commit internal loads. "
            + "Ordinary Stream Load uses this default unless the cloud_memtable_sink_upload header is set.")
    public static boolean cloud_stream_load_default_memtable_sink_upload = true;
