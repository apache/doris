...
public class Config extends ConfigBase {
    ...
    */
    ...
    @ConfField(description = {"指定存算分离模式下所有Compute group的扩缩容预热方式。"
            + "without_warmup: 直接修改tablet分片映射，首次读从S3拉取，性能最快但波动最大；"
            + "async_warmup: 异步预热，尽力而为拉取cache，性能较快但可能cache miss；"
            + "sync_warmup: 同步预热，确保cache迁移完成，性能较慢但无cache miss。"
