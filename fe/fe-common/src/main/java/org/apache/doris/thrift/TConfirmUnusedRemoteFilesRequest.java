            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list292.size);
                @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem293;
                for (int _i294 = 0; _i294 < _list292.size; ++_i294)
                {
                  _elem293 = new TTabletCooldownInfo();
                  _elem293.read(iprot);
                  struct.confirm_list.add(_elem293);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.confirm_list != null) {
        if (struct.isSetConfirmList()) {
          oprot.writeFieldBegin(CONFIRM_LIST_FIELD_DESC);
          {
            ...
            for (TTabletCooldownInfo _iter295 : struct.confirm_list)
            {
      ...
      if (struct.isSetConfirmList()) {
        {
          ...
          for (TTabletCooldownInfo _iter296 : struct.confirm_list)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list297.size);
          @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem298;
          for (int _i299 = 0; _i299 < _list297.size; ++_i299)
          {
            _elem298 = new TTabletCooldownInfo();
            _elem298.read(iprot);
            struct.confirm_list.add(_elem298);
          }
        }
        struct.setConfirmListIsSet(true);
      }
