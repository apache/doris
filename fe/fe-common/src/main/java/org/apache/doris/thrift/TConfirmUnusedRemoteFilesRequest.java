            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list348.size);
                @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem349;
                for (int _i350 = 0; _i350 < _list348.size; ++_i350)
                {
                  _elem349 = new TTabletCooldownInfo();
                  _elem349.read(iprot);
                  struct.confirm_list.add(_elem349);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.confirm_list != null) {
        if (struct.isSetConfirmList()) {
          oprot.writeFieldBegin(CONFIRM_LIST_FIELD_DESC);
          {
            ...
            for (TTabletCooldownInfo _iter351 : struct.confirm_list)
            {
      ...
      if (struct.isSetConfirmList()) {
        {
          ...
          for (TTabletCooldownInfo _iter352 : struct.confirm_list)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list353.size);
          @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem354;
          for (int _i355 = 0; _i355 < _list353.size; ++_i355)
          {
            _elem354 = new TTabletCooldownInfo();
            _elem354.read(iprot);
            struct.confirm_list.add(_elem354);
          }
        }
        struct.setConfirmListIsSet(true);
      }
