            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.addColumns = new java.util.ArrayList<TColumnDef>(_list340.size);
                @org.apache.thrift.annotation.Nullable TColumnDef _elem341;
                for (int _i342 = 0; _i342 < _list340.size; ++_i342)
                {
                  _elem341 = new TColumnDef();
                  _elem341.read(iprot);
                  struct.addColumns.add(_elem341);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addColumns != null) {
        if (struct.isSetAddColumns()) {
          oprot.writeFieldBegin(ADD_COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumnDef _iter343 : struct.addColumns)
            {
      ...
      if (struct.isSetAddColumns()) {
        {
          ...
          for (TColumnDef _iter344 : struct.addColumns)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.addColumns = new java.util.ArrayList<TColumnDef>(_list345.size);
          @org.apache.thrift.annotation.Nullable TColumnDef _elem346;
          for (int _i347 = 0; _i347 < _list345.size; ++_i347)
          {
            _elem346 = new TColumnDef();
            _elem346.read(iprot);
            struct.addColumns.add(_elem346);
          }
        }
        struct.setAddColumnsIsSet(true);
      }
