            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.addColumns = new java.util.ArrayList<TColumnDef>(_list332.size);
                @org.apache.thrift.annotation.Nullable TColumnDef _elem333;
                for (int _i334 = 0; _i334 < _list332.size; ++_i334)
                {
                  _elem333 = new TColumnDef();
                  _elem333.read(iprot);
                  struct.addColumns.add(_elem333);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addColumns != null) {
        if (struct.isSetAddColumns()) {
          oprot.writeFieldBegin(ADD_COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumnDef _iter335 : struct.addColumns)
            {
      ...
      if (struct.isSetAddColumns()) {
        {
          ...
          for (TColumnDef _iter336 : struct.addColumns)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.addColumns = new java.util.ArrayList<TColumnDef>(_list337.size);
          @org.apache.thrift.annotation.Nullable TColumnDef _elem338;
          for (int _i339 = 0; _i339 < _list337.size; ++_i339)
          {
            _elem338 = new TColumnDef();
            _elem338.read(iprot);
            struct.addColumns.add(_elem338);
          }
        }
        struct.setAddColumnsIsSet(true);
      }
