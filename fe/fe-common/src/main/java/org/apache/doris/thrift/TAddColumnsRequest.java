            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.addColumns = new java.util.ArrayList<TColumnDef>(_list276.size);
                @org.apache.thrift.annotation.Nullable TColumnDef _elem277;
                for (int _i278 = 0; _i278 < _list276.size; ++_i278)
                {
                  _elem277 = new TColumnDef();
                  _elem277.read(iprot);
                  struct.addColumns.add(_elem277);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addColumns != null) {
        if (struct.isSetAddColumns()) {
          oprot.writeFieldBegin(ADD_COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumnDef _iter279 : struct.addColumns)
            {
      ...
      if (struct.isSetAddColumns()) {
        {
          ...
          for (TColumnDef _iter280 : struct.addColumns)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.addColumns = new java.util.ArrayList<TColumnDef>(_list281.size);
          @org.apache.thrift.annotation.Nullable TColumnDef _elem282;
          for (int _i283 = 0; _i283 < _list281.size; ++_i283)
          {
            _elem282 = new TColumnDef();
            _elem282.read(iprot);
            struct.addColumns.add(_elem282);
          }
        }
        struct.setAddColumnsIsSet(true);
      }
