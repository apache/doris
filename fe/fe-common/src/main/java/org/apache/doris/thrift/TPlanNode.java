      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.row_tuples = new java.util.ArrayList<java.lang.Integer>(_list894.size);
                int _elem895;
                for (int _i896 = 0; _i896 < _list894.size; ++_i896)
                {
                  _elem895 = iprot.readI32();
                  struct.row_tuples.add(_elem895);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nullable_tuples = new java.util.ArrayList<java.lang.Boolean>(_list897.size);
                boolean _elem898;
                for (int _i899 = 0; _i899 < _list897.size; ++_i899)
                {
                  _elem898 = iprot.readBool();
                  struct.nullable_tuples.add(_elem898);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list900.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem901;
                for (int _i902 = 0; _i902 < _list900.size; ++_i902)
                {
                  _elem901 = new org.apache.doris.thrift.TExpr();
                  _elem901.read(iprot);
                  struct.conjuncts.add(_elem901);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.runtime_filters = new java.util.ArrayList<TRuntimeFilterDesc>(_list903.size);
                @org.apache.thrift.annotation.Nullable TRuntimeFilterDesc _elem904;
                for (int _i905 = 0; _i905 < _list903.size; ++_i905)
                {
                  _elem904 = new TRuntimeFilterDesc();
                  _elem904.read(iprot);
                  struct.runtime_filters.add(_elem904);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list906.size);
                int _elem907;
                for (int _i908 = 0; _i908 < _list906.size; ++_i908)
                {
                  _elem907 = iprot.readI32();
                  struct.output_slot_ids.add(_elem907);
                }
                iprot.readListEnd();
              }
          ...
          case 101: // PROJECTIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list909 = iprot.readListBegin();
                struct.projections = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list909.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem910;
                for (int _i911 = 0; _i911 < _list909.size; ++_i911)
                {
                  _elem910 = new org.apache.doris.thrift.TExpr();
                  _elem910.read(iprot);
                  struct.projections.add(_elem910);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.row_tuples != null) {
        oprot.writeFieldBegin(ROW_TUPLES_FIELD_DESC);
        {
          ...
          for (int _iter912 : struct.row_tuples)
          {
      ...
      if (struct.nullable_tuples != null) {
        oprot.writeFieldBegin(NULLABLE_TUPLES_FIELD_DESC);
        {
          ...
          for (boolean _iter913 : struct.nullable_tuples)
          {
            oprot.writeBool(_iter913);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.conjuncts != null) {
        if (struct.isSetConjuncts()) {
          oprot.writeFieldBegin(CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter914 : struct.conjuncts)
            {
      ...
      if (struct.runtime_filters != null) {
        if (struct.isSetRuntimeFilters()) {
          oprot.writeFieldBegin(RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (TRuntimeFilterDesc _iter915 : struct.runtime_filters)
            {
      ...
      if (struct.output_slot_ids != null) {
        if (struct.isSetOutputSlotIds()) {
          oprot.writeFieldBegin(OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter916 : struct.output_slot_ids)
            {
              oprot.writeI32(_iter916);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.projections != null) {
        if (struct.isSetProjections()) {
          oprot.writeFieldBegin(PROJECTIONS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter917 : struct.projections)
            {
  ...
  private static class TPlanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPlanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.limit);
      {
        ...
        for (int _iter918 : struct.row_tuples)
        {
          oprot.writeI32(_iter918);
        }
      }
      {
        oprot.writeI32(struct.nullable_tuples.size());
        for (boolean _iter919 : struct.nullable_tuples)
        {
          oprot.writeBool(_iter919);
        }
      }
      oprot.writeBool(struct.compact_data);
      ...
      if (struct.isSetConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter920 : struct.conjuncts)
          {
      ...
      if (struct.isSetRuntimeFilters()) {
        {
          ...
          for (TRuntimeFilterDesc _iter921 : struct.runtime_filters)
          {
      ...
      if (struct.isSetOutputSlotIds()) {
        {
          ...
          for (int _iter922 : struct.output_slot_ids)
          {
            oprot.writeI32(_iter922);
          }
        }
      }
      if (struct.isSetDataGenScanNode()) {
      ...
      if (struct.isSetProjections()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter923 : struct.projections)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setLimitIsSet(true);
      {
        org.apache.thrift.protocol.TList _list924 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
        struct.row_tuples = new java.util.ArrayList<java.lang.Integer>(_list924.size);
        int _elem925;
        for (int _i926 = 0; _i926 < _list924.size; ++_i926)
        {
          _elem925 = iprot.readI32();
          struct.row_tuples.add(_elem925);
        }
      }
      struct.setRowTuplesIsSet(true);
      {
        org.apache.thrift.protocol.TList _list927 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.nullable_tuples = new java.util.ArrayList<java.lang.Boolean>(_list927.size);
        boolean _elem928;
        for (int _i929 = 0; _i929 < _list927.size; ++_i929)
        {
          _elem928 = iprot.readBool();
          struct.nullable_tuples.add(_elem928);
        }
      }
      struct.setNullableTuplesIsSet(true);
      struct.compact_data = iprot.readBool();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list930 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list930.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem931;
          for (int _i932 = 0; _i932 < _list930.size; ++_i932)
          {
            _elem931 = new org.apache.doris.thrift.TExpr();
            _elem931.read(iprot);
            struct.conjuncts.add(_elem931);
          }
        }
        struct.setConjunctsIsSet(true);
      }
      ...
      if (incoming.get(24)) {
        {
          ...
          struct.runtime_filters = new java.util.ArrayList<TRuntimeFilterDesc>(_list933.size);
          @org.apache.thrift.annotation.Nullable TRuntimeFilterDesc _elem934;
          for (int _i935 = 0; _i935 < _list933.size; ++_i935)
          {
            _elem934 = new TRuntimeFilterDesc();
            _elem934.read(iprot);
            struct.runtime_filters.add(_elem934);
          }
        }
        struct.setRuntimeFiltersIsSet(true);
      }
      ...
      if (incoming.get(27)) {
        {
          org.apache.thrift.protocol.TList _list936 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list936.size);
          int _elem937;
          for (int _i938 = 0; _i938 < _list936.size; ++_i938)
          {
            _elem937 = iprot.readI32();
            struct.output_slot_ids.add(_elem937);
          }
        }
        struct.setOutputSlotIdsIsSet(true);
      }
      ...
      if (incoming.get(35)) {
        {
          ...
          struct.projections = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list939.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem940;
          for (int _i941 = 0; _i941 < _list939.size; ++_i941)
          {
            _elem940 = new org.apache.doris.thrift.TExpr();
            _elem940.read(iprot);
            struct.projections.add(_elem940);
          }
        }
        struct.setProjectionsIsSet(true);
      }
