            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.expr_map = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,org.apache.doris.thrift.TExpr>>(2*_map174.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key175;
                @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,org.apache.doris.thrift.TExpr> _val176;
                for (int _i177 = 0; _i177 < _map174.size; ++_i177)
                {
                  _key175 = iprot.readString();
                  {
                    ...
                    _val176 = new java.util.HashMap<java.lang.String,org.apache.doris.thrift.TExpr>(2*_map178.size);
                    @org.apache.thrift.annotation.Nullable java.lang.String _key179;
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _val180;
                    for (int _i181 = 0; _i181 < _map178.size; ++_i181)
                    {
                      _key179 = iprot.readString();
                      _val180 = new org.apache.doris.thrift.TExpr();
                      _val180.read(iprot);
                      _val176.put(_key179, _val180);
                    }
                    iprot.readMapEnd();
                  }
                  struct.expr_map.put(_key175, _val176);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFoldConstantParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.expr_map != null) {
        oprot.writeFieldBegin(EXPR_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,org.apache.doris.thrift.TExpr>> _iter182 : struct.expr_map.entrySet())
          {
            oprot.writeString(_iter182.getKey());
            {
              oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, _iter182.getValue().size()));
              for (java.util.Map.Entry<java.lang.String, org.apache.doris.thrift.TExpr> _iter183 : _iter182.getValue().entrySet())
              {
  ...
  private static class TFoldConstantParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFoldConstantParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TFoldConstantParams struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.Map<java.lang.String,org.apache.doris.thrift.TExpr>> _iter184 : struct.expr_map.entrySet())
        {
          oprot.writeString(_iter184.getKey());
          {
            oprot.writeI32(_iter184.getValue().size());
            for (java.util.Map.Entry<java.lang.String, org.apache.doris.thrift.TExpr> _iter185 : _iter184.getValue().entrySet())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFoldConstantParams struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map186 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP); 
        struct.expr_map = new java.util.HashMap<java.lang.String,java.util.Map<java.lang.String,org.apache.doris.thrift.TExpr>>(2*_map186.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key187;
        @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,org.apache.doris.thrift.TExpr> _val188;
        for (int _i189 = 0; _i189 < _map186.size; ++_i189)
        {
          _key187 = iprot.readString();
          {
            org.apache.thrift.protocol.TMap _map190 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
            _val188 = new java.util.HashMap<java.lang.String,org.apache.doris.thrift.TExpr>(2*_map190.size);
          ...
          struct.expr_map.put(_key187, _val188);
        }
      }
      struct.setExprMapIsSet(true);
      struct.query_globals = new TQueryGlobals();
