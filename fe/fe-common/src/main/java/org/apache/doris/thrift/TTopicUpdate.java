...
public class TTopicUpdate implements org.apache.thrift.TBase<TTopicUpdate, TTopicUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<TTopicUpdate> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updates = new java.util.ArrayList<TTopicItem>(_list210.size);
                @org.apache.thrift.annotation.Nullable TTopicItem _elem211;
                for (int _i212 = 0; _i212 < _list210.size; ++_i212)
                {
                  _elem211 = new TTopicItem();
                  _elem211.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deletes = new java.util.ArrayList<java.lang.String>(_list213.size);
      ...
      if (struct.updates != null) {
        if (struct.isSetUpdates()) {
          oprot.writeFieldBegin(UPDATES_FIELD_DESC);
          {
            ...
            for (TTopicItem _iter216 : struct.updates)
            {
      ...
      if (struct.deletes != null) {
        if (struct.isSetDeletes()) {
          oprot.writeFieldBegin(DELETES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter217 : struct.deletes)
            {
  ...
  private static class TTopicUpdateTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTopicUpdate> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTopicUpdate struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list220 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.updates = new java.util.ArrayList<TTopicItem>(_list220.size);
          @org.apache.thrift.annotation.Nullable TTopicItem _elem221;
          for (int _i222 = 0; _i222 < _list220.size; ++_i222)
          {
            _elem221 = new TTopicItem();
            _elem221.read(iprot);
            struct.updates.add(_elem221);
          }
        }
        struct.setUpdatesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.deletes = new java.util.ArrayList<java.lang.String>(_list223.size);
