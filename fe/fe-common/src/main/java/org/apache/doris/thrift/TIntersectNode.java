            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list770.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem771;
                for (int _i772 = 0; _i772 < _list770.size; ++_i772)
                {
                  {
                    org.apache.thrift.protocol.TList _list773 = iprot.readListBegin();
                    _elem771 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list773.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem774;
                    for (int _i775 = 0; _i775 < _list773.size; ++_i775)
                    {
                      _elem774 = new org.apache.doris.thrift.TExpr();
                      _elem774.read(iprot);
                      _elem771.add(_elem774);
                    }
                    iprot.readListEnd();
                  }
                  struct.result_expr_lists.add(_elem771);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list776.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem777;
                for (int _i778 = 0; _i778 < _list776.size; ++_i778)
                {
                  {
                    org.apache.thrift.protocol.TList _list779 = iprot.readListBegin();
                    _elem777 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list779.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem780;
                    for (int _i781 = 0; _i781 < _list779.size; ++_i781)
                    {
                      _elem780 = new org.apache.doris.thrift.TExpr();
                      _elem780.read(iprot);
                      _elem777.add(_elem780);
                    }
                    iprot.readListEnd();
                  }
                  struct.const_expr_lists.add(_elem777);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter782 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter782.size()));
              for (org.apache.doris.thrift.TExpr _iter783 : _iter782)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter784 : struct.const_expr_lists)
          {
            {
  ...
  private static class TIntersectNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TIntersectNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter786 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter786.size());
      ...
      }
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter788 : struct.const_expr_lists)
        {
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list790 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list790.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem791;
        ...
        {
          {
            ...
            _elem791 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list793.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem794;
            for (int _i795 = 0; _i795 < _list793.size; ++_i795)
            {
              _elem794 = new org.apache.doris.thrift.TExpr();
              _elem794.read(iprot);
              _elem791.add(_elem794);
            }
          }
          struct.result_expr_lists.add(_elem791);
        }
      }
      struct.setResultExprListsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list796 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list796.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem797;
        for (int _i798 = 0; _i798 < _list796.size; ++_i798)
        {
          {
            org.apache.thrift.protocol.TList _list799 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
            _elem797 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list799.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem800;
            for (int _i801 = 0; _i801 < _list799.size; ++_i801)
            {
              _elem800 = new org.apache.doris.thrift.TExpr();
              _elem800.read(iprot);
              _elem797.add(_elem800);
            }
          }
          struct.const_expr_lists.add(_elem797);
        }
      }
      struct.setConstExprListsIsSet(true);
      struct.first_materialized_child_idx = iprot.readI64();
