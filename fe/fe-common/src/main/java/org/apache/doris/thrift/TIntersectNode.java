            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list780.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem781;
                for (int _i782 = 0; _i782 < _list780.size; ++_i782)
                {
                  {
                    org.apache.thrift.protocol.TList _list783 = iprot.readListBegin();
                    _elem781 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list783.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem784;
                    for (int _i785 = 0; _i785 < _list783.size; ++_i785)
                    {
                      _elem784 = new org.apache.doris.thrift.TExpr();
                      _elem784.read(iprot);
                      _elem781.add(_elem784);
                    }
                    iprot.readListEnd();
                  }
                  struct.result_expr_lists.add(_elem781);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list786.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem787;
                for (int _i788 = 0; _i788 < _list786.size; ++_i788)
                {
                  {
                    org.apache.thrift.protocol.TList _list789 = iprot.readListBegin();
                    _elem787 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list789.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem790;
                    for (int _i791 = 0; _i791 < _list789.size; ++_i791)
                    {
                      _elem790 = new org.apache.doris.thrift.TExpr();
                      _elem790.read(iprot);
                      _elem787.add(_elem790);
                    }
                    iprot.readListEnd();
                  }
                  struct.const_expr_lists.add(_elem787);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter792 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter792.size()));
              for (org.apache.doris.thrift.TExpr _iter793 : _iter792)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter794 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter794.size()));
              for (org.apache.doris.thrift.TExpr _iter795 : _iter794)
              {
  ...
  private static class TIntersectNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TIntersectNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter796 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter796.size());
            for (org.apache.doris.thrift.TExpr _iter797 : _iter796)
            {
      ...
      }
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter798 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter798.size());
            for (org.apache.doris.thrift.TExpr _iter799 : _iter798)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list800 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list800.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem801;
        ...
        {
          {
            ...
            _elem801 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list803.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem804;
            for (int _i805 = 0; _i805 < _list803.size; ++_i805)
            {
              _elem804 = new org.apache.doris.thrift.TExpr();
              _elem804.read(iprot);
              _elem801.add(_elem804);
            }
          }
          struct.result_expr_lists.add(_elem801);
        }
      }
      struct.setResultExprListsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list806 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list806.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem807;
        ...
        {
          {
            ...
            _elem807 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list809.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem810;
            for (int _i811 = 0; _i811 < _list809.size; ++_i811)
            {
              _elem810 = new org.apache.doris.thrift.TExpr();
              _elem810.read(iprot);
              _elem807.add(_elem810);
            }
          }
          struct.const_expr_lists.add(_elem807);
        }
      }
      struct.setConstExprListsIsSet(true);
      struct.first_materialized_child_idx = iprot.readI64();
