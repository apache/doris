...
public class TRestoreSnapshotRequest implements org.apache.thrift.TBase<TRestoreSnapshotRequest, TRestoreSnapshotRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TRestoreSnapshotRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_refs = new java.util.ArrayList<TTableRef>(_list466.size);
                @org.apache.thrift.annotation.Nullable TTableRef _elem467;
                for (int _i468 = 0; _i468 < _list466.size; ++_i468)
                {
                  _elem467 = new TTableRef();
                  _elem467.read(iprot);
                  struct.table_refs.add(_elem467);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map469.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key470;
                @org.apache.thrift.annotation.Nullable java.lang.String _val471;
                for (int _i472 = 0; _i472 < _map469.size; ++_i472)
                {
                  _key470 = iprot.readString();
                  _val471 = iprot.readString();
                  struct.properties.put(_key470, _val471);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.table_refs != null) {
        if (struct.isSetTableRefs()) {
          oprot.writeFieldBegin(TABLE_REFS_FIELD_DESC);
          {
            ...
            for (TTableRef _iter473 : struct.table_refs)
            {
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter474 : struct.properties.entrySet())
            {
  ...
  private static class TRestoreSnapshotRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRestoreSnapshotRequest> {
      ...
      if (struct.isSetTableRefs()) {
        {
          ...
          for (TTableRef _iter475 : struct.table_refs)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter476 : struct.properties.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRestoreSnapshotRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.table_refs = new java.util.ArrayList<TTableRef>(_list477.size);
          @org.apache.thrift.annotation.Nullable TTableRef _elem478;
          for (int _i479 = 0; _i479 < _list477.size; ++_i479)
          {
            _elem478 = new TTableRef();
            _elem478.read(iprot);
            struct.table_refs.add(_elem478);
          }
        }
        struct.setTableRefsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TMap _map480 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map480.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key481;
          @org.apache.thrift.annotation.Nullable java.lang.String _val482;
          for (int _i483 = 0; _i483 < _map480.size; ++_i483)
          {
            _key481 = iprot.readString();
            _val482 = iprot.readString();
            struct.properties.put(_key481, _val482);
          }
        }
        struct.setPropertiesIsSet(true);
      }
