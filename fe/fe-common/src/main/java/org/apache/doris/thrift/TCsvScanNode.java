            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.file_paths = new java.util.ArrayList<java.lang.String>(_list358.size);
                ...
                for (int _i360 = 0; _i360 < _list358.size; ++_i360)
                {
                  ...
                  struct.file_paths.add(_elem359);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.column_type_mapping = new java.util.HashMap<java.lang.String,org.apache.doris.thrift.TColumnType>(2*_map361.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key362;
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumnType _val363;
                for (int _i364 = 0; _i364 < _map361.size; ++_i364)
                {
                  _key362 = iprot.readString();
                  _val363 = new org.apache.doris.thrift.TColumnType();
                  _val363.read(iprot);
                  struct.column_type_mapping.put(_key362, _val363);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.lang.String>(_list365.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.unspecified_columns = new java.util.ArrayList<java.lang.String>(_list368.size);
                ...
                for (int _i370 = 0; _i370 < _list368.size; ++_i370)
                {
                  ...
                  struct.unspecified_columns.add(_elem369);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.default_values = new java.util.ArrayList<java.lang.String>(_list371.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem372;
                for (int _i373 = 0; _i373 < _list371.size; ++_i373)
                {
                  _elem372 = iprot.readString();
                  struct.default_values.add(_elem372);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.column_function_mapping = new java.util.HashMap<java.lang.String,TMiniLoadEtlFunction>(2*_map374.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key375;
                @org.apache.thrift.annotation.Nullable TMiniLoadEtlFunction _val376;
                for (int _i377 = 0; _i377 < _map374.size; ++_i377)
                {
                  _key375 = iprot.readString();
                  _val376 = new TMiniLoadEtlFunction();
                  _val376.read(iprot);
                  struct.column_function_mapping.put(_key375, _val376);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCsvScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.file_paths != null) {
        oprot.writeFieldBegin(FILE_PATHS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter378 : struct.file_paths)
          {
      ...
      if (struct.column_type_mapping != null) {
        if (struct.isSetColumnTypeMapping()) {
          oprot.writeFieldBegin(COLUMN_TYPE_MAPPING_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, org.apache.doris.thrift.TColumnType> _iter379 : struct.column_type_mapping.entrySet())
            {
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter380 : struct.columns)
            {
      ...
      if (struct.unspecified_columns != null) {
        if (struct.isSetUnspecifiedColumns()) {
          oprot.writeFieldBegin(UNSPECIFIED_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter381 : struct.unspecified_columns)
            {
      ...
      if (struct.default_values != null) {
        if (struct.isSetDefaultValues()) {
          oprot.writeFieldBegin(DEFAULT_VALUES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter382 : struct.default_values)
            {
      ...
      if (struct.column_function_mapping != null) {
        if (struct.isSetColumnFunctionMapping()) {
          oprot.writeFieldBegin(COLUMN_FUNCTION_MAPPING_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, TMiniLoadEtlFunction> _iter383 : struct.column_function_mapping.entrySet())
            {
  ...
  private static class TCsvScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCsvScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TCsvScanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.lang.String _iter384 : struct.file_paths)
        {
      ...
      if (struct.isSetColumnTypeMapping()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, org.apache.doris.thrift.TColumnType> _iter385 : struct.column_type_mapping.entrySet())
          {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter386 : struct.columns)
          {
      ...
      if (struct.isSetUnspecifiedColumns()) {
        {
          ...
          for (java.lang.String _iter387 : struct.unspecified_columns)
          {
      ...
      if (struct.isSetDefaultValues()) {
        {
          ...
          for (java.lang.String _iter388 : struct.default_values)
          {
      ...
      if (struct.isSetColumnFunctionMapping()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, TMiniLoadEtlFunction> _iter389 : struct.column_function_mapping.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCsvScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list390 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
        struct.file_paths = new java.util.ArrayList<java.lang.String>(_list390.size);
        ...
        for (int _i392 = 0; _i392 < _list390.size; ++_i392)
        {
          ...
          struct.file_paths.add(_elem391);
        }
      }
      struct.setFilePathsIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map393 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.column_type_mapping = new java.util.HashMap<java.lang.String,org.apache.doris.thrift.TColumnType>(2*_map393.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key394;
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumnType _val395;
          for (int _i396 = 0; _i396 < _map393.size; ++_i396)
          {
            _key394 = iprot.readString();
            _val395 = new org.apache.doris.thrift.TColumnType();
            _val395.read(iprot);
            struct.column_type_mapping.put(_key394, _val395);
          }
        }
        struct.setColumnTypeMappingIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.columns = new java.util.ArrayList<java.lang.String>(_list397.size);
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list400 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.unspecified_columns = new java.util.ArrayList<java.lang.String>(_list400.size);
          ...
          for (int _i402 = 0; _i402 < _list400.size; ++_i402)
          {
            ...
            struct.unspecified_columns.add(_elem401);
          }
        }
        struct.setUnspecifiedColumnsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list403 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.default_values = new java.util.ArrayList<java.lang.String>(_list403.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem404;
          for (int _i405 = 0; _i405 < _list403.size; ++_i405)
          {
            _elem404 = iprot.readString();
            struct.default_values.add(_elem404);
          }
        }
        struct.setDefaultValuesIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map406 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.column_function_mapping = new java.util.HashMap<java.lang.String,TMiniLoadEtlFunction>(2*_map406.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key407;
          @org.apache.thrift.annotation.Nullable TMiniLoadEtlFunction _val408;
          for (int _i409 = 0; _i409 < _map406.size; ++_i409)
          {
            _key407 = iprot.readString();
            _val408 = new TMiniLoadEtlFunction();
            _val408.read(iprot);
            struct.column_function_mapping.put(_key407, _val408);
          }
        }
        struct.setColumnFunctionMappingIsSet(true);
      }
