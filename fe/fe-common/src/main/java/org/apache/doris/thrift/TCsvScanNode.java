            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.file_paths = new java.util.ArrayList<java.lang.String>(_list368.size);
                ...
                for (int _i370 = 0; _i370 < _list368.size; ++_i370)
                {
                  ...
                  struct.file_paths.add(_elem369);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.column_type_mapping = new java.util.HashMap<java.lang.String,org.apache.doris.thrift.TColumnType>(2*_map371.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key372;
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumnType _val373;
                for (int _i374 = 0; _i374 < _map371.size; ++_i374)
                {
                  _key372 = iprot.readString();
                  _val373 = new org.apache.doris.thrift.TColumnType();
                  _val373.read(iprot);
                  struct.column_type_mapping.put(_key372, _val373);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.lang.String>(_list375.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem376;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.unspecified_columns = new java.util.ArrayList<java.lang.String>(_list378.size);
                ...
                for (int _i380 = 0; _i380 < _list378.size; ++_i380)
                {
                  ...
                  struct.unspecified_columns.add(_elem379);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.default_values = new java.util.ArrayList<java.lang.String>(_list381.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem382;
                for (int _i383 = 0; _i383 < _list381.size; ++_i383)
                {
                  _elem382 = iprot.readString();
                  struct.default_values.add(_elem382);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.column_function_mapping = new java.util.HashMap<java.lang.String,TMiniLoadEtlFunction>(2*_map384.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key385;
                @org.apache.thrift.annotation.Nullable TMiniLoadEtlFunction _val386;
                for (int _i387 = 0; _i387 < _map384.size; ++_i387)
                {
                  _key385 = iprot.readString();
                  _val386 = new TMiniLoadEtlFunction();
                  _val386.read(iprot);
                  struct.column_function_mapping.put(_key385, _val386);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCsvScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.file_paths != null) {
        oprot.writeFieldBegin(FILE_PATHS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter388 : struct.file_paths)
          {
      ...
      if (struct.column_type_mapping != null) {
        if (struct.isSetColumnTypeMapping()) {
          oprot.writeFieldBegin(COLUMN_TYPE_MAPPING_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, org.apache.doris.thrift.TColumnType> _iter389 : struct.column_type_mapping.entrySet())
            {
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter390 : struct.columns)
            {
      ...
      if (struct.unspecified_columns != null) {
        if (struct.isSetUnspecifiedColumns()) {
          oprot.writeFieldBegin(UNSPECIFIED_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter391 : struct.unspecified_columns)
            {
      ...
      if (struct.default_values != null) {
        if (struct.isSetDefaultValues()) {
          oprot.writeFieldBegin(DEFAULT_VALUES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter392 : struct.default_values)
            {
      ...
      if (struct.column_function_mapping != null) {
        if (struct.isSetColumnFunctionMapping()) {
          oprot.writeFieldBegin(COLUMN_FUNCTION_MAPPING_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, TMiniLoadEtlFunction> _iter393 : struct.column_function_mapping.entrySet())
            {
  ...
  private static class TCsvScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCsvScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TCsvScanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.lang.String _iter394 : struct.file_paths)
        {
      ...
      if (struct.isSetColumnTypeMapping()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, org.apache.doris.thrift.TColumnType> _iter395 : struct.column_type_mapping.entrySet())
          {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.lang.String _iter396 : struct.columns)
          {
      ...
      if (struct.isSetUnspecifiedColumns()) {
        {
          ...
          for (java.lang.String _iter397 : struct.unspecified_columns)
          {
      ...
      if (struct.isSetDefaultValues()) {
        {
          ...
          for (java.lang.String _iter398 : struct.default_values)
          {
      ...
      if (struct.isSetColumnFunctionMapping()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, TMiniLoadEtlFunction> _iter399 : struct.column_function_mapping.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCsvScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        ...
        struct.file_paths = new java.util.ArrayList<java.lang.String>(_list400.size);
        ...
        for (int _i402 = 0; _i402 < _list400.size; ++_i402)
        {
          ...
          struct.file_paths.add(_elem401);
        }
      }
      struct.setFilePathsIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map403 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.column_type_mapping = new java.util.HashMap<java.lang.String,org.apache.doris.thrift.TColumnType>(2*_map403.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key404;
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumnType _val405;
          for (int _i406 = 0; _i406 < _map403.size; ++_i406)
          {
            _key404 = iprot.readString();
            _val405 = new org.apache.doris.thrift.TColumnType();
            _val405.read(iprot);
            struct.column_type_mapping.put(_key404, _val405);
          }
        }
        struct.setColumnTypeMappingIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.columns = new java.util.ArrayList<java.lang.String>(_list407.size);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.unspecified_columns = new java.util.ArrayList<java.lang.String>(_list410.size);
          ...
          for (int _i412 = 0; _i412 < _list410.size; ++_i412)
          {
            ...
            struct.unspecified_columns.add(_elem411);
          }
        }
        struct.setUnspecifiedColumnsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.default_values = new java.util.ArrayList<java.lang.String>(_list413.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem414;
          for (int _i415 = 0; _i415 < _list413.size; ++_i415)
          {
            _elem414 = iprot.readString();
            struct.default_values.add(_elem414);
          }
        }
        struct.setDefaultValuesIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map416 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.column_function_mapping = new java.util.HashMap<java.lang.String,TMiniLoadEtlFunction>(2*_map416.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key417;
          @org.apache.thrift.annotation.Nullable TMiniLoadEtlFunction _val418;
          for (int _i419 = 0; _i419 < _map416.size; ++_i419)
          {
            _key417 = iprot.readString();
            _val418 = new TMiniLoadEtlFunction();
            _val418.read(iprot);
            struct.column_function_mapping.put(_key417, _val418);
          }
        }
        struct.setColumnFunctionMappingIsSet(true);
      }
