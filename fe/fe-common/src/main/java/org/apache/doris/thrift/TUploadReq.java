            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map112.size);
                ...
                for (int _i115 = 0; _i115 < _map112.size; ++_i115)
                {
                  ...
                  struct.src_dest_map.put(_key113, _val114);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map116.size);
                ...
                for (int _i119 = 0; _i119 < _map116.size; ++_i119)
                {
                  ...
                  struct.broker_prop.put(_key117, _val118);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter120 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBrokerProp()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter121 : struct.broker_prop.entrySet())
            {
  ...
  private static class TUploadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUploadReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.job_id);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter122 : struct.src_dest_map.entrySet())
        {
      ...
      if (struct.isSetBrokerProp()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter123 : struct.broker_prop.entrySet())
          {
