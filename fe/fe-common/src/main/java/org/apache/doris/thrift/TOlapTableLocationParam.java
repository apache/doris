            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablets = new java.util.ArrayList<TTabletLocation>(_list154.size);
                @org.apache.thrift.annotation.Nullable TTabletLocation _elem155;
                for (int _i156 = 0; _i156 < _list154.size; ++_i156)
                {
                  _elem155 = new TTabletLocation();
                  _elem155.read(iprot);
                  struct.tablets.add(_elem155);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.tablets != null) {
        oprot.writeFieldBegin(TABLETS_FIELD_DESC);
        {
          ...
          for (TTabletLocation _iter157 : struct.tablets)
          {
  ...
  private static class TOlapTableLocationParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableLocationParam> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.version);
      {
        ...
        for (TTabletLocation _iter158 : struct.tablets)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        struct.tablets = new java.util.ArrayList<TTabletLocation>(_list159.size);
        @org.apache.thrift.annotation.Nullable TTabletLocation _elem160;
        for (int _i161 = 0; _i161 < _list159.size; ++_i161)
        {
          _elem160 = new TTabletLocation();
          _elem160.read(iprot);
          struct.tablets.add(_elem160);
        }
      }
      struct.setTabletsIsSet(true);
    }
