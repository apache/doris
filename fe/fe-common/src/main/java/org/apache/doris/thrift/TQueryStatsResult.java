...
public class TQueryStatsResult implements org.apache.thrift.TBase<TQueryStatsResult, TQueryStatsResult._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryStatsResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.simple_result = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map380.size);
                ...
                for (int _i383 = 0; _i383 < _map380.size; ++_i383)
                {
                  ...
                  struct.simple_result.put(_key381, _val382);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list384.size);
                @org.apache.thrift.annotation.Nullable TTableQueryStats _elem385;
                for (int _i386 = 0; _i386 < _list384.size; ++_i386)
                {
                  _elem385 = new TTableQueryStats();
                  _elem385.read(iprot);
                  struct.table_stats.add(_elem385);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_verbos_stats = new java.util.ArrayList<TTableIndexQueryStats>(_list387.size);
                @org.apache.thrift.annotation.Nullable TTableIndexQueryStats _elem388;
                for (int _i389 = 0; _i389 < _list387.size; ++_i389)
                {
                  _elem388 = new TTableIndexQueryStats();
                  _elem388.read(iprot);
                  struct.table_verbos_stats.add(_elem388);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tablet_stats = new java.util.HashMap<java.lang.Long,java.lang.Long>(2*_map390.size);
                long _key391;
                long _val392;
                for (int _i393 = 0; _i393 < _map390.size; ++_i393)
                {
                  ...
                  struct.tablet_stats.put(_key391, _val392);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.simple_result != null) {
        if (struct.isSetSimpleResult()) {
          oprot.writeFieldBegin(SIMPLE_RESULT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter394 : struct.simple_result.entrySet())
            {
      ...
      if (struct.table_stats != null) {
        if (struct.isSetTableStats()) {
          oprot.writeFieldBegin(TABLE_STATS_FIELD_DESC);
          {
            ...
            for (TTableQueryStats _iter395 : struct.table_stats)
            {
      ...
      if (struct.table_verbos_stats != null) {
        if (struct.isSetTableVerbosStats()) {
          oprot.writeFieldBegin(TABLE_VERBOS_STATS_FIELD_DESC);
          {
            ...
            for (TTableIndexQueryStats _iter396 : struct.table_verbos_stats)
            {
      ...
      if (struct.tablet_stats != null) {
        if (struct.isSetTabletStats()) {
          oprot.writeFieldBegin(TABLET_STATS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter397 : struct.tablet_stats.entrySet())
            {
  ...
  private static class TQueryStatsResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TQueryStatsResult> {
      ...
      if (struct.isSetSimpleResult()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter398 : struct.simple_result.entrySet())
          {
      ...
      if (struct.isSetTableStats()) {
        {
          ...
          for (TTableQueryStats _iter399 : struct.table_stats)
          {
      ...
      if (struct.isSetTableVerbosStats()) {
        {
          ...
          for (TTableIndexQueryStats _iter400 : struct.table_verbos_stats)
          {
      ...
      if (struct.isSetTabletStats()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter401 : struct.tablet_stats.entrySet())
          {
            oprot.writeI64(_iter401.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TQueryStatsResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map402 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64); 
          struct.simple_result = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map402.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key403;
          long _val404;
          for (int _i405 = 0; _i405 < _map402.size; ++_i405)
          {
            _key403 = iprot.readString();
            _val404 = iprot.readI64();
            struct.simple_result.put(_key403, _val404);
          }
        }
        struct.setSimpleResultIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list406.size);
          @org.apache.thrift.annotation.Nullable TTableQueryStats _elem407;
          for (int _i408 = 0; _i408 < _list406.size; ++_i408)
          {
            _elem407 = new TTableQueryStats();
            _elem407.read(iprot);
            struct.table_stats.add(_elem407);
          }
        }
        struct.setTableStatsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.table_verbos_stats = new java.util.ArrayList<TTableIndexQueryStats>(_list409.size);
          @org.apache.thrift.annotation.Nullable TTableIndexQueryStats _elem410;
          for (int _i411 = 0; _i411 < _list409.size; ++_i411)
          {
            _elem410 = new TTableIndexQueryStats();
            _elem410.read(iprot);
            struct.table_verbos_stats.add(_elem410);
          }
        }
        struct.setTableVerbosStatsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map412 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I64); 
          struct.tablet_stats = new java.util.HashMap<java.lang.Long,java.lang.Long>(2*_map412.size);
          long _key413;
          long _val414;
          for (int _i415 = 0; _i415 < _map412.size; ++_i415)
          {
            _key413 = iprot.readI64();
            _val414 = iprot.readI64();
            struct.tablet_stats.put(_key413, _val414);
          }
        }
        struct.setTabletStatsIsSet(true);
      }
