            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.planId_to_target_expr = new java.util.HashMap<java.lang.Integer,org.apache.doris.thrift.TExpr>(2*_map874.size);
                int _key875;
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _val876;
                for (int _i877 = 0; _i877 < _map874.size; ++_i877)
                {
                  _key875 = iprot.readI32();
                  _val876 = new org.apache.doris.thrift.TExpr();
                  _val876.read(iprot);
                  struct.planId_to_target_expr.put(_key875, _val876);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeFilterDesc struct) throws org.apache.thrift.TException {
      ...
      if (struct.planId_to_target_expr != null) {
        oprot.writeFieldBegin(PLAN_ID_TO_TARGET_EXPR_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, org.apache.doris.thrift.TExpr> _iter878 : struct.planId_to_target_expr.entrySet())
          {
  ...
  private static class TRuntimeFilterDescTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRuntimeFilterDesc> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRuntimeFilterDesc struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.expr_order);
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, org.apache.doris.thrift.TExpr> _iter879 : struct.planId_to_target_expr.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRuntimeFilterDesc struct) throws org.apache.thrift.TException {
      ...
      struct.setExprOrderIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map880 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
        struct.planId_to_target_expr = new java.util.HashMap<java.lang.Integer,org.apache.doris.thrift.TExpr>(2*_map880.size);
        int _key881;
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _val882;
        for (int _i883 = 0; _i883 < _map880.size; ++_i883)
        {
          _key881 = iprot.readI32();
          _val882 = new org.apache.doris.thrift.TExpr();
          _val882.read(iprot);
          struct.planId_to_target_expr.put(_key881, _val882);
        }
      }
      struct.setPlanIdToTargetExprIsSet(true);
      struct.is_broadcast_join = iprot.readBool();
