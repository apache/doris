      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list508.size);
                ...
                for (int _i510 = 0; _i510 < _list508.size; ++_i510)
                {
                  ...
                  _elem509.read(iprot);
                  struct.eq_join_conjuncts.add(_elem509);
                }
                iprot.readListEnd();
              }
          ...
          case 3: // OTHER_JOIN_CONJUNCTS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list511 = iprot.readListBegin();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hash_output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list514.size);
                int _elem515;
                for (int _i516 = 0; _i516 < _list514.size; ++_i516)
                {
                  _elem515 = iprot.readI32();
                  struct.hash_output_slot_ids.add(_elem515);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list517.size);
                ...
                for (int _i519 = 0; _i519 < _list517.size; ++_i519)
                {
                  ...
                  _elem518.read(iprot);
                  struct.srcExprList.add(_elem518);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list520.size);
                int _elem521;
                for (int _i522 = 0; _i522 < _list520.size; ++_i522)
                {
                  _elem521 = iprot.readI32();
                  struct.vintermediate_tuple_id_list.add(_elem521);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.eq_join_conjuncts != null) {
        oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter523 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOtherJoinConjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter524 : struct.other_join_conjuncts)
            {
      ...
      if (struct.hash_output_slot_ids != null) {
        if (struct.isSetHashOutputSlotIds()) {
          oprot.writeFieldBegin(HASH_OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter525 : struct.hash_output_slot_ids)
            {
              oprot.writeI32(_iter525);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.srcExprList != null) {
        if (struct.isSetSrcExprList()) {
          oprot.writeFieldBegin(SRC_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter526 : struct.srcExprList)
            {
      ...
      if (struct.vintermediate_tuple_id_list != null) {
        if (struct.isSetVintermediateTupleIdList()) {
          oprot.writeFieldBegin(VINTERMEDIATE_TUPLE_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter527 : struct.vintermediate_tuple_id_list)
            {
  ...
  private static class THashJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<THashJoinNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.join_op.getValue());
      {
        ...
        for (TEqJoinCondition _iter528 : struct.eq_join_conjuncts)
        {
      ...
      if (struct.isSetOtherJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter529 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetHashOutputSlotIds()) {
        {
          ...
          for (int _iter530 : struct.hash_output_slot_ids)
          {
      ...
      if (struct.isSetSrcExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter531 : struct.srcExprList)
          {
      ...
      if (struct.isSetVintermediateTupleIdList()) {
        {
          ...
          for (int _iter532 : struct.vintermediate_tuple_id_list)
          {
            oprot.writeI32(_iter532);
          }
        }
      }
      if (struct.isSetIsBroadcastJoin()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      struct.setJoinOpIsSet(true);
      {
        ...
        struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list533.size);
        @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem534;
        for (int _i535 = 0; _i535 < _list533.size; ++_i535)
        {
          _elem534 = new TEqJoinCondition();
          _elem534.read(iprot);
          struct.eq_join_conjuncts.add(_elem534);
        }
      }
      struct.setEqJoinConjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list536 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.other_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list536.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem537;
          for (int _i538 = 0; _i538 < _list536.size; ++_i538)
          {
            _elem537 = new org.apache.doris.thrift.TExpr();
            _elem537.read(iprot);
            struct.other_join_conjuncts.add(_elem537);
          }
        }
        struct.setOtherJoinConjunctsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list539 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.hash_output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list539.size);
          int _elem540;
          for (int _i541 = 0; _i541 < _list539.size; ++_i541)
          {
            _elem540 = iprot.readI32();
            struct.hash_output_slot_ids.add(_elem540);
          }
        }
        struct.setHashOutputSlotIdsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list542 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list542.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem543;
          for (int _i544 = 0; _i544 < _list542.size; ++_i544)
          {
            _elem543 = new org.apache.doris.thrift.TExpr();
            _elem543.read(iprot);
            struct.srcExprList.add(_elem543);
          }
        }
        struct.setSrcExprListIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list545 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list545.size);
          int _elem546;
          for (int _i547 = 0; _i547 < _list545.size; ++_i547)
          {
            _elem546 = iprot.readI32();
            struct.vintermediate_tuple_id_list.add(_elem546);
          }
        }
        struct.setVintermediateTupleIdListIsSet(true);
      }
