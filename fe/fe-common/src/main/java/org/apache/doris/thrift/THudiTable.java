            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map190.size);
                ...
                for (int _i193 = 0; _i193 < _map190.size; ++_i193)
                {
                  ...
                  struct.properties.put(_key191, _val192);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter194 : struct.properties.entrySet())
            {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter195 : struct.properties.entrySet())
          {
