...
public class TGetQueryStatsRequest implements org.apache.thrift.TBase<TGetQueryStatsRequest, TGetQueryStatsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TGetQueryStatsRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.replica_ids = new java.util.ArrayList<java.lang.Long>(_list380.size);
                long _elem381;
                for (int _i382 = 0; _i382 < _list380.size; ++_i382)
                {
                  _elem381 = iprot.readI64();
                  struct.replica_ids.add(_elem381);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.replica_ids != null) {
        if (struct.isSetReplicaIds()) {
          oprot.writeFieldBegin(REPLICA_IDS_FIELD_DESC);
          {
            ...
            for (long _iter383 : struct.replica_ids)
            {
  ...
  private static class TGetQueryStatsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGetQueryStatsRequest> {
      ...
      if (struct.isSetReplicaIds()) {
        {
          ...
          for (long _iter384 : struct.replica_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetQueryStatsRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list385 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.replica_ids = new java.util.ArrayList<java.lang.Long>(_list385.size);
          long _elem386;
          for (int _i387 = 0; _i387 < _list385.size; ++_i387)
          {
            _elem386 = iprot.readI64();
            struct.replica_ids.add(_elem386);
          }
        }
        struct.setReplicaIdsIsSet(true);
      }
