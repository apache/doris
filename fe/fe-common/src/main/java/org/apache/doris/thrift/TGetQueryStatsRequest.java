...
public class TGetQueryStatsRequest implements org.apache.thrift.TBase<TGetQueryStatsRequest, TGetQueryStatsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TGetQueryStatsRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.replica_ids = new java.util.ArrayList<java.lang.Long>(_list372.size);
                long _elem373;
                for (int _i374 = 0; _i374 < _list372.size; ++_i374)
                {
                  _elem373 = iprot.readI64();
                  struct.replica_ids.add(_elem373);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.replica_ids != null) {
        if (struct.isSetReplicaIds()) {
          oprot.writeFieldBegin(REPLICA_IDS_FIELD_DESC);
          {
            ...
            for (long _iter375 : struct.replica_ids)
            {
  ...
  private static class TGetQueryStatsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGetQueryStatsRequest> {
      ...
      if (struct.isSetReplicaIds()) {
        {
          ...
          for (long _iter376 : struct.replica_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetQueryStatsRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list377 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.replica_ids = new java.util.ArrayList<java.lang.Long>(_list377.size);
          long _elem378;
          for (int _i379 = 0; _i379 < _list377.size; ++_i379)
          {
            _elem378 = iprot.readI64();
            struct.replica_ids.add(_elem378);
          }
        }
        struct.setReplicaIdsIsSet(true);
      }
