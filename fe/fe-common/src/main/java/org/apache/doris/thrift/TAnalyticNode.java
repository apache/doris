            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list692.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem693;
                for (int _i694 = 0; _i694 < _list692.size; ++_i694)
                {
                  _elem693 = new org.apache.doris.thrift.TExpr();
                  _elem693.read(iprot);
                  struct.partition_exprs.add(_elem693);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.order_by_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list695.size);
                ...
                for (int _i697 = 0; _i697 < _list695.size; ++_i697)
                {
                  ...
                  _elem696.read(iprot);
                  struct.order_by_exprs.add(_elem696);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.analytic_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list698.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem699;
                for (int _i700 = 0; _i700 < _list698.size; ++_i700)
                {
                  _elem699 = new org.apache.doris.thrift.TExpr();
                  _elem699.read(iprot);
                  struct.analytic_functions.add(_elem699);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAnalyticNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.partition_exprs != null) {
        oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter701 : struct.partition_exprs)
          {
      ...
      if (struct.order_by_exprs != null) {
        oprot.writeFieldBegin(ORDER_BY_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter702 : struct.order_by_exprs)
          {
      ...
      if (struct.analytic_functions != null) {
        oprot.writeFieldBegin(ANALYTIC_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter703 : struct.analytic_functions)
          {
  ...
  private static class TAnalyticNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAnalyticNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter704 : struct.partition_exprs)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter705 : struct.order_by_exprs)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter706 : struct.analytic_functions)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.partition_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list707.size);
        ...
        for (int _i709 = 0; _i709 < _list707.size; ++_i709)
        {
          ...
          _elem708.read(iprot);
          struct.partition_exprs.add(_elem708);
        }
      }
      struct.setPartitionExprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list710 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.order_by_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list710.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem711;
        for (int _i712 = 0; _i712 < _list710.size; ++_i712)
        {
          _elem711 = new org.apache.doris.thrift.TExpr();
          _elem711.read(iprot);
          struct.order_by_exprs.add(_elem711);
        }
      }
      struct.setOrderByExprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list713 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.analytic_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list713.size);
        ...
        for (int _i715 = 0; _i715 < _list713.size; ++_i715)
        {
          ...
          _elem714.read(iprot);
          struct.analytic_functions.add(_elem714);
        }
      }
      struct.setAnalyticFunctionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
