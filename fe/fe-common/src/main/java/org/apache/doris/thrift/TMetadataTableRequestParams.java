...
public class TMetadataTableRequestParams implements org.apache.thrift.TBase<TMetadataTableRequestParams, TMetadataTableRequestParams._Fields>, java.io.Serializable, Cloneable, Comparable<TMetadataTableRequestParams> {
  ...
  private static final _Fields optionals[] = {_Fields.METADATA_TYPE,_Fields.ICEBERG_METADATA_PARAMS,_Fields.BACKENDS_METADATA_PARAMS,_Fields.COLUMNS_NAME,_Fields.FRONTENDS_METADATA_PARAMS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_name = new java.util.ArrayList<java.lang.String>(_list308.size);
                ...
                for (int _i310 = 0; _i310 < _list308.size; ++_i310)
                {
                  ...
                  struct.columns_name.add(_elem309);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns_name != null) {
        if (struct.isSetColumnsName()) {
          oprot.writeFieldBegin(COLUMNS_NAME_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter311 : struct.columns_name)
            {
      ...
      if (struct.isSetColumnsName()) {
        {
          ...
          for (java.lang.String _iter312 : struct.columns_name)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.columns_name = new java.util.ArrayList<java.lang.String>(_list313.size);
          ...
          for (int _i315 = 0; _i315 < _list313.size; ++_i315)
          {
            ...
            struct.columns_name.add(_elem314);
          }
        }
        struct.setColumnsNameIsSet(true);
      }
