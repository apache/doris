...
public class TMetadataTableRequestParams implements org.apache.thrift.TBase<TMetadataTableRequestParams, TMetadataTableRequestParams._Fields>, java.io.Serializable, Cloneable, Comparable<TMetadataTableRequestParams> {
  ...
  private static final _Fields optionals[] = {_Fields.METADATA_TYPE,_Fields.ICEBERG_METADATA_PARAMS,_Fields.BACKENDS_METADATA_PARAMS,_Fields.COLUMNS_NAME};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_name = new java.util.ArrayList<java.lang.String>(_list260.size);
                ...
                for (int _i262 = 0; _i262 < _list260.size; ++_i262)
                {
                  ...
                  struct.columns_name.add(_elem261);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.columns_name != null) {
        if (struct.isSetColumnsName()) {
          oprot.writeFieldBegin(COLUMNS_NAME_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter263 : struct.columns_name)
            {
      ...
      if (struct.isSetColumnsName()) {
        {
          ...
          for (java.lang.String _iter264 : struct.columns_name)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.columns_name = new java.util.ArrayList<java.lang.String>(_list265.size);
          ...
          for (int _i267 = 0; _i267 < _list265.size; ++_i267)
          {
            ...
            struct.columns_name.add(_elem266);
          }
        }
        struct.setColumnsNameIsSet(true);
      }
