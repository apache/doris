            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list748.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem749;
                for (int _i750 = 0; _i750 < _list748.size; ++_i750)
                {
                  {
                    org.apache.thrift.protocol.TList _list751 = iprot.readListBegin();
                    _elem749 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list751.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem752;
                    for (int _i753 = 0; _i753 < _list751.size; ++_i753)
                    {
                      _elem752 = new org.apache.doris.thrift.TExpr();
                      _elem752.read(iprot);
                      _elem749.add(_elem752);
                    }
                    iprot.readListEnd();
                  }
                  struct.result_expr_lists.add(_elem749);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list754.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem755;
                for (int _i756 = 0; _i756 < _list754.size; ++_i756)
                {
                  {
                    org.apache.thrift.protocol.TList _list757 = iprot.readListBegin();
                    _elem755 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list757.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem758;
                    for (int _i759 = 0; _i759 < _list757.size; ++_i759)
                    {
                      _elem758 = new org.apache.doris.thrift.TExpr();
                      _elem758.read(iprot);
                      _elem755.add(_elem758);
                    }
                    iprot.readListEnd();
                  }
                  struct.const_expr_lists.add(_elem755);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUnionNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter760 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter760.size()));
              for (org.apache.doris.thrift.TExpr _iter761 : _iter760)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter762 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter762.size()));
              for (org.apache.doris.thrift.TExpr _iter763 : _iter762)
              {
  ...
  private static class TUnionNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUnionNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUnionNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter764 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter764.size());
            for (org.apache.doris.thrift.TExpr _iter765 : _iter764)
            {
      ...
      }
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter766 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter766.size());
            for (org.apache.doris.thrift.TExpr _iter767 : _iter766)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUnionNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list768 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list768.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem769;
        ...
        {
          {
            ...
            _elem769 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list771.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem772;
            for (int _i773 = 0; _i773 < _list771.size; ++_i773)
            {
              _elem772 = new org.apache.doris.thrift.TExpr();
              _elem772.read(iprot);
              _elem769.add(_elem772);
            }
          }
          struct.result_expr_lists.add(_elem769);
        }
      }
      struct.setResultExprListsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list774 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list774.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem775;
        ...
        {
          {
            ...
            _elem775 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list777.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem778;
            for (int _i779 = 0; _i779 < _list777.size; ++_i779)
            {
              _elem778 = new org.apache.doris.thrift.TExpr();
              _elem778.read(iprot);
              _elem775.add(_elem778);
            }
          }
          struct.const_expr_lists.add(_elem775);
        }
      }
      struct.setConstExprListsIsSet(true);
      struct.first_materialized_child_idx = iprot.readI64();
