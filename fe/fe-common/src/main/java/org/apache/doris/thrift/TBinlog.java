...
public class TBinlog implements org.apache.thrift.TBase<TBinlog, TBinlog._Fields>, java.io.Serializable, Cloneable, Comparable<TBinlog> {
  ...
  private static final _Fields optionals[] = {_Fields.COMMIT_SEQ,_Fields.TIMESTAMP,_Fields.TYPE,_Fields.DB_ID,_Fields.TABLE_IDS,_Fields.DATA,_Fields.BELONG,_Fields.TABLE_REF};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list424.size);
                long _elem425;
                for (int _i426 = 0; _i426 < _list424.size; ++_i426)
                {
                  _elem425 = iprot.readI64();
                  struct.table_ids.add(_elem425);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_ids != null) {
        if (struct.isSetTableIds()) {
          oprot.writeFieldBegin(TABLE_IDS_FIELD_DESC);
          {
            ...
            for (long _iter427 : struct.table_ids)
            {
  ...
  private static class TBinlogTupleScheme extends org.apache.thrift.scheme.TupleScheme<TBinlog> {
      ...
      if (struct.isSetTableIds()) {
        {
          ...
          for (long _iter428 : struct.table_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TBinlog struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list429 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list429.size);
          long _elem430;
          for (int _i431 = 0; _i431 < _list429.size; ++_i431)
          {
            _elem430 = iprot.readI64();
            struct.table_ids.add(_elem430);
          }
        }
        struct.setTableIdsIsSet(true);
      }
