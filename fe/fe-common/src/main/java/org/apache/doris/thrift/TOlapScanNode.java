        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.key_column_name = new java.util.ArrayList<java.lang.String>(_list460.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem461;
                for (int _i462 = 0; _i462 < _list460.size; ++_i462)
                {
                  _elem461 = iprot.readString();
                  struct.key_column_name.add(_elem461);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.key_column_type = new java.util.ArrayList<org.apache.doris.thrift.TPrimitiveType>(_list463.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPrimitiveType _elem464;
                for (int _i465 = 0; _i465 < _list463.size; ++_i465)
                {
                  _elem464 = org.apache.doris.thrift.TPrimitiveType.findByValue(iprot.readI32());
                  if (_elem464 != null)
                  {
                    struct.key_column_type.add(_elem464);
                  }
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_desc = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list466.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem467;
                for (int _i468 = 0; _i468 < _list466.size; ++_i468)
                {
                  _elem467 = new org.apache.doris.thrift.TColumn();
                  _elem467.read(iprot);
                  struct.columns_desc.add(_elem467);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes_desc = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list469.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem470;
                for (int _i471 = 0; _i471 < _list469.size; ++_i471)
                {
                  _elem470 = new org.apache.doris.thrift.TOlapTableIndex();
                  _elem470.read(iprot);
                  struct.indexes_desc.add(_elem470);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // OUTPUT_COLUMN_UNIQUE_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set472 = iprot.readSetBegin();
                struct.output_column_unique_ids = new java.util.HashSet<java.lang.Integer>(2*_set472.size);
                int _elem473;
                for (int _i474 = 0; _i474 < _set472.size; ++_i474)
                {
                  _elem473 = iprot.readI32();
                  struct.output_column_unique_ids.add(_elem473);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.distribute_column_ids = new java.util.ArrayList<java.lang.Integer>(_list475.size);
                int _elem476;
                for (int _i477 = 0; _i477 < _list475.size; ++_i477)
                {
                  _elem476 = iprot.readI32();
                  struct.distribute_column_ids.add(_elem476);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.key_column_name != null) {
        oprot.writeFieldBegin(KEY_COLUMN_NAME_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter478 : struct.key_column_name)
          {
      ...
      if (struct.key_column_type != null) {
        oprot.writeFieldBegin(KEY_COLUMN_TYPE_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TPrimitiveType _iter479 : struct.key_column_type)
          {
      ...
      if (struct.columns_desc != null) {
        if (struct.isSetColumnsDesc()) {
          oprot.writeFieldBegin(COLUMNS_DESC_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter480 : struct.columns_desc)
            {
      ...
      if (struct.indexes_desc != null) {
        if (struct.isSetIndexesDesc()) {
          oprot.writeFieldBegin(INDEXES_DESC_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TOlapTableIndex _iter481 : struct.indexes_desc)
            {
      ...
      if (struct.output_column_unique_ids != null) {
        if (struct.isSetOutputColumnUniqueIds()) {
          oprot.writeFieldBegin(OUTPUT_COLUMN_UNIQUE_IDS_FIELD_DESC);
          {
            ...
            for (int _iter482 : struct.output_column_unique_ids)
            {
              oprot.writeI32(_iter482);
            }
            oprot.writeSetEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.distribute_column_ids != null) {
        if (struct.isSetDistributeColumnIds()) {
          oprot.writeFieldBegin(DISTRIBUTE_COLUMN_IDS_FIELD_DESC);
          {
            ...
            for (int _iter483 : struct.distribute_column_ids)
            {
  ...
  private static class TOlapScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.lang.String _iter484 : struct.key_column_name)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TPrimitiveType _iter485 : struct.key_column_type)
        {
          oprot.writeI32(_iter485.getValue());
        }
      }
      oprot.writeBool(struct.is_preaggregation);
      ...
      if (struct.isSetColumnsDesc()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter486 : struct.columns_desc)
          {
      ...
      if (struct.isSetIndexesDesc()) {
        {
          ...
          for (org.apache.doris.thrift.TOlapTableIndex _iter487 : struct.indexes_desc)
          {
      ...
      if (struct.isSetOutputColumnUniqueIds()) {
        {
          ...
          for (int _iter488 : struct.output_column_unique_ids)
          {
      ...
      if (struct.isSetDistributeColumnIds()) {
        {
          ...
          for (int _iter489 : struct.distribute_column_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list490 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
        struct.key_column_name = new java.util.ArrayList<java.lang.String>(_list490.size);
        ...
        for (int _i492 = 0; _i492 < _list490.size; ++_i492)
        {
          ...
          struct.key_column_name.add(_elem491);
        }
      }
      struct.setKeyColumnNameIsSet(true);
      {
        org.apache.thrift.protocol.TList _list493 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
        struct.key_column_type = new java.util.ArrayList<org.apache.doris.thrift.TPrimitiveType>(_list493.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPrimitiveType _elem494;
        for (int _i495 = 0; _i495 < _list493.size; ++_i495)
        {
          _elem494 = org.apache.doris.thrift.TPrimitiveType.findByValue(iprot.readI32());
          if (_elem494 != null)
          {
            struct.key_column_type.add(_elem494);
          }
        }
      }
      struct.setKeyColumnTypeIsSet(true);
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list496 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.columns_desc = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list496.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem497;
          for (int _i498 = 0; _i498 < _list496.size; ++_i498)
          {
            _elem497 = new org.apache.doris.thrift.TColumn();
            _elem497.read(iprot);
            struct.columns_desc.add(_elem497);
          }
        }
        struct.setColumnsDescIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.indexes_desc = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list499.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem500;
          for (int _i501 = 0; _i501 < _list499.size; ++_i501)
          {
            _elem500 = new org.apache.doris.thrift.TOlapTableIndex();
            _elem500.read(iprot);
            struct.indexes_desc.add(_elem500);
          }
        }
        struct.setIndexesDescIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TSet _set502 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_column_unique_ids = new java.util.HashSet<java.lang.Integer>(2*_set502.size);
          int _elem503;
          for (int _i504 = 0; _i504 < _set502.size; ++_i504)
          {
            _elem503 = iprot.readI32();
            struct.output_column_unique_ids.add(_elem503);
          }
        }
        struct.setOutputColumnUniqueIdsIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list505 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.distribute_column_ids = new java.util.ArrayList<java.lang.Integer>(_list505.size);
          int _elem506;
          for (int _i507 = 0; _i507 < _list505.size; ++_i507)
          {
            _elem506 = iprot.readI32();
            struct.distribute_column_ids.add(_elem506);
          }
        }
        struct.setDistributeColumnIdsIsSet(true);
      }
