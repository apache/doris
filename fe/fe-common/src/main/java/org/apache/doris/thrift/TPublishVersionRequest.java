            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_version_infos = new java.util.ArrayList<TPartitionVersionInfo>(_list178.size);
                @org.apache.thrift.annotation.Nullable TPartitionVersionInfo _elem179;
                for (int _i180 = 0; _i180 < _list178.size; ++_i180)
                {
                  _elem179 = new TPartitionVersionInfo();
                  _elem179.read(iprot);
                  struct.partition_version_infos.add(_elem179);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partition_version_infos != null) {
        oprot.writeFieldBegin(PARTITION_VERSION_INFOS_FIELD_DESC);
        {
          ...
          for (TPartitionVersionInfo _iter181 : struct.partition_version_infos)
          {
  ...
  private static class TPublishVersionRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPublishVersionRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.transaction_id);
      {
        ...
        for (TPartitionVersionInfo _iter182 : struct.partition_version_infos)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPublishVersionRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTransactionIdIsSet(true);
      {
        ...
        struct.partition_version_infos = new java.util.ArrayList<TPartitionVersionInfo>(_list183.size);
        @org.apache.thrift.annotation.Nullable TPartitionVersionInfo _elem184;
        for (int _i185 = 0; _i185 < _list183.size; ++_i185)
        {
          _elem184 = new TPartitionVersionInfo();
          _elem184.read(iprot);
          struct.partition_version_infos.add(_elem184);
        }
      }
      struct.setPartitionVersionInfosIsSet(true);
