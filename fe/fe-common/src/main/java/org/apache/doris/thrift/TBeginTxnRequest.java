...
public class TBeginTxnRequest implements org.apache.thrift.TBase<TBeginTxnRequest, TBeginTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TBeginTxnRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER,_Fields.PASSWD,_Fields.DB,_Fields.TABLE_IDS,_Fields.USER_IP,_Fields.LABEL,_Fields.AUTH_CODE,_Fields.TIMEOUT,_Fields.REQUEST_ID,_Fields.TOKEN};
  ...
  public TBeginTxnRequest setTableIds(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> table_ids) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list242.size);
                long _elem243;
                for (int _i244 = 0; _i244 < _list242.size; ++_i244)
                {
                  _elem243 = iprot.readI64();
                  struct.table_ids.add(_elem243);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_ids != null) {
        if (struct.isSetTableIds()) {
          oprot.writeFieldBegin(TABLE_IDS_FIELD_DESC);
          {
            ...
            for (long _iter245 : struct.table_ids)
            {
  ...
  private static class TBeginTxnRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TBeginTxnRequest> {
      ...
      if (struct.isSetTableIds()) {
        {
          ...
          for (long _iter246 : struct.table_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TBeginTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list247 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list247.size);
          long _elem248;
          for (int _i249 = 0; _i249 < _list247.size; ++_i249)
          {
            _elem248 = iprot.readI64();
            struct.table_ids.add(_elem248);
          }
        }
        struct.setTableIdsIsSet(true);
      }
