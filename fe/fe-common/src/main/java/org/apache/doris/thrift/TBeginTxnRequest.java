...
public class TBeginTxnRequest implements org.apache.thrift.TBase<TBeginTxnRequest, TBeginTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TBeginTxnRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TBeginTxnRequest");
  ...
  private static final org.apache.thrift.protocol.TField TABLES_FIELD_DESC = new org.apache.thrift.protocol.TField("tables", org.apache.thrift.protocol.TType.LIST, (short)5);
  ...
  private static final org.apache.thrift.protocol.TField REQUEST_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("request_id", org.apache.thrift.protocol.TType.STRUCT, (short)10);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TBeginTxnRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TBeginTxnRequestTupleSchemeFactory();
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER,_Fields.PASSWD,_Fields.DB,_Fields.TABLES,_Fields.USER_IP,_Fields.LABEL,_Fields.AUTH_CODE,_Fields.TIMEOUT,_Fields.REQUEST_ID,_Fields.TOKEN};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TBeginTxnRequest.class, metaDataMap);
  }

  public TBeginTxnRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TBeginTxnRequest(TBeginTxnRequest other) {
  ...
  @Override
  public TBeginTxnRequest deepCopy() {
    return new TBeginTxnRequest(this);
  }
  ...
  public TBeginTxnRequest setCluster(@org.apache.thrift.annotation.Nullable java.lang.String cluster) {
  ...
  public TBeginTxnRequest setUser(@org.apache.thrift.annotation.Nullable java.lang.String user) {
    this.user = user;
    return this;
  }
  ...
  public TBeginTxnRequest setPasswd(@org.apache.thrift.annotation.Nullable java.lang.String passwd) {
    this.passwd = passwd;
    return this;
  }
  ...
  public TBeginTxnRequest setDb(@org.apache.thrift.annotation.Nullable java.lang.String db) {
    this.db = db;
    return this;
  }
  ...
  public TBeginTxnRequest setTables(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> tables) {
    this.tables = tables;
    return this;
  }
  ...
  public TBeginTxnRequest setUserIp(@org.apache.thrift.annotation.Nullable java.lang.String user_ip) {
  ...
  public TBeginTxnRequest setLabel(@org.apache.thrift.annotation.Nullable java.lang.String label) {
    this.label = label;
    return this;
  }
  ...
  public TBeginTxnRequest setAuthCode(long auth_code) {
  ...
  public TBeginTxnRequest setTimeout(long timeout) {
  ...
  public TBeginTxnRequest setRequestId(@org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TUniqueId request_id) {
  ...
  public TBeginTxnRequest setToken(@org.apache.thrift.annotation.Nullable java.lang.String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TBeginTxnRequest)
      return this.equals((TBeginTxnRequest)that);
    return false;
  }

  public boolean equals(TBeginTxnRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TBeginTxnRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TBeginTxnRequest(");
    boolean first = true;
  ...
  private static class TBeginTxnRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TBeginTxnRequestStandardScheme getScheme() {
      return new TBeginTxnRequestStandardScheme();
    }
  }

  private static class TBeginTxnRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TBeginTxnRequest> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TBeginTxnRequest struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tables = new java.util.ArrayList<java.lang.String>(_list242.size);
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TBeginTxnRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.tables != null) {
        if (struct.isSetTables()) {
          oprot.writeFieldBegin(TABLES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter245 : struct.tables)
            {
  ...
  private static class TBeginTxnRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TBeginTxnRequestTupleScheme getScheme() {
      return new TBeginTxnRequestTupleScheme();
    }
  }

  private static class TBeginTxnRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TBeginTxnRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TBeginTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetTables()) {
        {
          ...
          for (java.lang.String _iter246 : struct.tables)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TBeginTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.tables = new java.util.ArrayList<java.lang.String>(_list247.size);
