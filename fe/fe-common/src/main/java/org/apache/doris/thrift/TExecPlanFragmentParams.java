...
public class TExecPlanFragmentParams implements org.apache.thrift.TBase<TExecPlanFragmentParams, TExecPlanFragmentParams._Fields>, java.io.Serializable, Cloneable, Comparable<TExecPlanFragmentParams> {
  ...
  private static final org.apache.thrift.protocol.TField FILE_SCAN_PARAMS_FIELD_DESC = new org.apache.thrift.protocol.TField("file_scan_params", org.apache.thrift.protocol.TType.MAP, (short)24);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FILE_SCAN_PARAMS((short)24, "file_scan_params");
  ...
  public TExecPlanFragmentParams setFileScanParams(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,org.apache.doris.thrift.TFileScanRangeParams> file_scan_params) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.file_scan_params = new java.util.HashMap<java.lang.Integer,org.apache.doris.thrift.TFileScanRangeParams>(2*_map141.size);
                int _key142;
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TFileScanRangeParams _val143;
                for (int _i144 = 0; _i144 < _map141.size; ++_i144)
                {
                  _key142 = iprot.readI32();
                  _val143 = new org.apache.doris.thrift.TFileScanRangeParams();
                  _val143.read(iprot);
                  struct.file_scan_params.put(_key142, _val143);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.instances_sharing_hash_table != null) {
        if (struct.isSetInstancesSharingHashTable()) {
          oprot.writeFieldBegin(INSTANCES_SHARING_HASH_TABLE_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TUniqueId _iter145 : struct.instances_sharing_hash_table)
            {
      ...
      if (struct.file_scan_params != null) {
        if (struct.isSetFileScanParams()) {
          oprot.writeFieldBegin(FILE_SCAN_PARAMS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, org.apache.doris.thrift.TFileScanRangeParams> _iter146 : struct.file_scan_params.entrySet())
            {
  ...
  private static class TExecPlanFragmentParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExecPlanFragmentParams> {
      ...
      if (struct.isSetInstancesSharingHashTable()) {
        {
          ...
          for (org.apache.doris.thrift.TUniqueId _iter147 : struct.instances_sharing_hash_table)
          {
      ...
      if (struct.isSetFileScanParams()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, org.apache.doris.thrift.TFileScanRangeParams> _iter148 : struct.file_scan_params.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExecPlanFragmentParams struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(20)) {
        {
          ...
          struct.instances_sharing_hash_table = new java.util.ArrayList<org.apache.doris.thrift.TUniqueId>(_list149.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TUniqueId _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = new org.apache.doris.thrift.TUniqueId();
            _elem150.read(iprot);
            struct.instances_sharing_hash_table.add(_elem150);
          }
        }
        struct.setInstancesSharingHashTableIsSet(true);
      }
      ...
      if (incoming.get(22)) {
        {
          org.apache.thrift.protocol.TMap _map152 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
          struct.file_scan_params = new java.util.HashMap<java.lang.Integer,org.apache.doris.thrift.TFileScanRangeParams>(2*_map152.size);
          int _key153;
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TFileScanRangeParams _val154;
          for (int _i155 = 0; _i155 < _map152.size; ++_i155)
          {
            _key153 = iprot.readI32();
            _val154 = new org.apache.doris.thrift.TFileScanRangeParams();
            _val154.read(iprot);
            struct.file_scan_params.put(_key153, _val154);
          }
        }
        struct.setFileScanParamsIsSet(true);
      }
