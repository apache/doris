...
public class TTableFunctionNode implements org.apache.thrift.TBase<TTableFunctionNode, TTableFunctionNode._Fields>, java.io.Serializable, Cloneable, Comparable<TTableFunctionNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fnCallExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list858.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem859;
                for (int _i860 = 0; _i860 < _list858.size; ++_i860)
                {
                  _elem859 = new org.apache.doris.thrift.TExpr();
                  _elem859.read(iprot);
                  struct.fnCallExprList.add(_elem859);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputSlotIds = new java.util.ArrayList<java.lang.Integer>(_list861.size);
                int _elem862;
                for (int _i863 = 0; _i863 < _list861.size; ++_i863)
                {
                  _elem862 = iprot.readI32();
                  struct.outputSlotIds.add(_elem862);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.fnCallExprList != null) {
        if (struct.isSetFnCallExprList()) {
          oprot.writeFieldBegin(FN_CALL_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter864 : struct.fnCallExprList)
            {
      ...
      if (struct.outputSlotIds != null) {
        if (struct.isSetOutputSlotIds()) {
          oprot.writeFieldBegin(OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter865 : struct.outputSlotIds)
            {
              oprot.writeI32(_iter865);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TTableFunctionNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTableFunctionNode> {
      ...
      if (struct.isSetFnCallExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter866 : struct.fnCallExprList)
          {
      ...
      if (struct.isSetOutputSlotIds()) {
        {
          ...
          for (int _iter867 : struct.outputSlotIds)
          {
            oprot.writeI32(_iter867);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableFunctionNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list868 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.fnCallExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list868.size);
          ...
          for (int _i870 = 0; _i870 < _list868.size; ++_i870)
          {
            ...
            _elem869.read(iprot);
            struct.fnCallExprList.add(_elem869);
          }
        }
        struct.setFnCallExprListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list871 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.outputSlotIds = new java.util.ArrayList<java.lang.Integer>(_list871.size);
          int _elem872;
          for (int _i873 = 0; _i873 < _list871.size; ++_i873)
          {
            _elem872 = iprot.readI32();
            struct.outputSlotIds.add(_elem872);
          }
        }
        struct.setOutputSlotIdsIsSet(true);
      }
