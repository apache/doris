...
public class TTableFunctionNode implements org.apache.thrift.TBase<TTableFunctionNode, TTableFunctionNode._Fields>, java.io.Serializable, Cloneable, Comparable<TTableFunctionNode> {
      ...
      if (struct.fnCallExprList != null) {
        if (struct.isSetFnCallExprList()) {
          oprot.writeFieldBegin(FN_CALL_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter874 : struct.fnCallExprList)
            {
      ...
      if (struct.outputSlotIds != null) {
        if (struct.isSetOutputSlotIds()) {
          oprot.writeFieldBegin(OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter875 : struct.outputSlotIds)
            {
  ...
  private static class TTableFunctionNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTableFunctionNode> {
      ...
      if (struct.isSetFnCallExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter876 : struct.fnCallExprList)
          {
      ...
      if (struct.isSetOutputSlotIds()) {
        {
          ...
          for (int _iter877 : struct.outputSlotIds)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableFunctionNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fnCallExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list878.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem879;
          for (int _i880 = 0; _i880 < _list878.size; ++_i880)
          {
            _elem879 = new org.apache.doris.thrift.TExpr();
            _elem879.read(iprot);
            struct.fnCallExprList.add(_elem879);
          }
        }
        struct.setFnCallExprListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list881 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.outputSlotIds = new java.util.ArrayList<java.lang.Integer>(_list881.size);
          int _elem882;
          for (int _i883 = 0; _i883 < _list881.size; ++_i883)
          {
            _elem882 = iprot.readI32();
            struct.outputSlotIds.add(_elem882);
          }
        }
        struct.setOutputSlotIdsIsSet(true);
      }
