...
public class TExportSink implements org.apache.thrift.TBase<TExportSink, TExportSink._Fields>, java.io.Serializable, Cloneable, Comparable<TExportSink> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.broker_addresses = new java.util.ArrayList<org.apache.doris.thrift.TNetworkAddress>(_list84.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNetworkAddress _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = new org.apache.doris.thrift.TNetworkAddress();
                  _elem85.read(iprot);
                  struct.broker_addresses.add(_elem85);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map87.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key88;
                @org.apache.thrift.annotation.Nullable java.lang.String _val89;
      ...
      if (struct.broker_addresses != null) {
        if (struct.isSetBrokerAddresses()) {
          oprot.writeFieldBegin(BROKER_ADDRESSES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TNetworkAddress _iter91 : struct.broker_addresses)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TExportSinkTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExportSink> {
      ...
      if (struct.isSetBrokerAddresses()) {
        {
          ...
          for (org.apache.doris.thrift.TNetworkAddress _iter93 : struct.broker_addresses)
          {
            _iter93.write(oprot);
          }
        }
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter94 : struct.properties.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExportSink struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.broker_addresses = new java.util.ArrayList<org.apache.doris.thrift.TNetworkAddress>(_list95.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNetworkAddress _elem96;
          for (int _i97 = 0; _i97 < _list95.size; ++_i97)
          {
            _elem96 = new org.apache.doris.thrift.TNetworkAddress();
            _elem96.read(iprot);
            struct.broker_addresses.add(_elem96);
          }
        }
        struct.setBrokerAddressesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map98 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map98.size);
          ...
          for (int _i101 = 0; _i101 < _map98.size; ++_i101)
          {
            ...
            struct.properties.put(_key99, _val100);
          }
        }
        struct.setPropertiesIsSet(true);
      }
