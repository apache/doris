            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.broker_addresses = new java.util.ArrayList<org.apache.doris.thrift.TNetworkAddress>(_list108.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNetworkAddress _elem109;
                for (int _i110 = 0; _i110 < _list108.size; ++_i110)
                {
                  _elem109 = new org.apache.doris.thrift.TNetworkAddress();
                  _elem109.read(iprot);
                  struct.broker_addresses.add(_elem109);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map111.size);
      ...
      if (struct.broker_addresses != null) {
        if (struct.isSetBrokerAddresses()) {
          oprot.writeFieldBegin(BROKER_ADDRESSES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TNetworkAddress _iter115 : struct.broker_addresses)
            {
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter116 : struct.properties.entrySet())
            {
      ...
      if (struct.isSetBrokerAddresses()) {
        {
          ...
          for (org.apache.doris.thrift.TNetworkAddress _iter117 : struct.broker_addresses)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter118 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.broker_addresses = new java.util.ArrayList<org.apache.doris.thrift.TNetworkAddress>(_list119.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNetworkAddress _elem120;
          for (int _i121 = 0; _i121 < _list119.size; ++_i121)
          {
            _elem120 = new org.apache.doris.thrift.TNetworkAddress();
            _elem120.read(iprot);
            struct.broker_addresses.add(_elem120);
          }
        }
        struct.setBrokerAddressesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map122.size);
          ...
          for (int _i125 = 0; _i125 < _map122.size; ++_i125)
          {
            ...
            struct.properties.put(_key123, _val124);
          }
        }
        struct.setPropertiesIsSet(true);
      }
