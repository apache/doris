            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list380.size);
                @org.apache.thrift.annotation.Nullable TTableQueryStats _elem381;
                for (int _i382 = 0; _i382 < _list380.size; ++_i382)
                {
                  _elem381 = new TTableQueryStats();
                  _elem381.read(iprot);
                  struct.table_stats.add(_elem381);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_stats != null) {
        if (struct.isSetTableStats()) {
          oprot.writeFieldBegin(TABLE_STATS_FIELD_DESC);
          {
            ...
            for (TTableQueryStats _iter383 : struct.table_stats)
            {
      ...
      if (struct.isSetTableStats()) {
        {
          ...
          for (TTableQueryStats _iter384 : struct.table_stats)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list385.size);
          @org.apache.thrift.annotation.Nullable TTableQueryStats _elem386;
          for (int _i387 = 0; _i387 < _list385.size; ++_i387)
          {
            _elem386 = new TTableQueryStats();
            _elem386.read(iprot);
            struct.table_stats.add(_elem386);
          }
        }
        struct.setTableStatsIsSet(true);
      }
