            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list388.size);
                @org.apache.thrift.annotation.Nullable TTableQueryStats _elem389;
                for (int _i390 = 0; _i390 < _list388.size; ++_i390)
                {
                  _elem389 = new TTableQueryStats();
                  _elem389.read(iprot);
                  struct.table_stats.add(_elem389);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_stats != null) {
        if (struct.isSetTableStats()) {
          oprot.writeFieldBegin(TABLE_STATS_FIELD_DESC);
          {
            ...
            for (TTableQueryStats _iter391 : struct.table_stats)
            {
      ...
      if (struct.isSetTableStats()) {
        {
          ...
          for (TTableQueryStats _iter392 : struct.table_stats)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list393.size);
          @org.apache.thrift.annotation.Nullable TTableQueryStats _elem394;
          for (int _i395 = 0; _i395 < _list393.size; ++_i395)
          {
            _elem394 = new TTableQueryStats();
            _elem394.read(iprot);
            struct.table_stats.add(_elem394);
          }
        }
        struct.setTableStatsIsSet(true);
      }
