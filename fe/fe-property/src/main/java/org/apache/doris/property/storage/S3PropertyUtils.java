...
public class S3PropertyUtils {
     ...
     * @throws StoragePropertiesException if the input path is blank or invalid
     *                       <p>
     *                       Example:
    ...
    public static String validateAndNormalizeUri(String path,
                                                 String stringUsePathStyle,
                                                 String stringForceParsingByStandardUri)
            throws StoragePropertiesException {
     ...
     * @throws StoragePropertiesException if the map is empty or does not contain 'uri'
     *                       <p>
     *                       Example:
