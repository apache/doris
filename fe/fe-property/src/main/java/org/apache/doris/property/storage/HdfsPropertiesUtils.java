...
public class HdfsPropertiesUtils {
    ...
    // Inlined from org.apache.hadoop.hdfs.client.HdfsClientConfigKeys (hadoop-hdfs-client) to keep fe-property free
    // of a hadoop-hdfs dependency. These are stable, well-known HDFS HA configuration keys.
    ...
    public static String validateAndGetUri(Map<String, String> props, String host, String defaultFs,
                                           Set<String> supportSchemas) throws StoragePropertiesException {
        if (props.isEmpty()) {
    ...
    public static void checkHaConfig(Map<String, String> hdfsProperties) {
        ...
        String dfsNameservices = hdfsProperties.getOrDefault(DFS_NAMESERVICES, "");
