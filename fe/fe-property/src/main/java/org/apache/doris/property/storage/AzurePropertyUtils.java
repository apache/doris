...
public class AzurePropertyUtils {
     ...
     */
    public static String validateAndNormalizeUri(String path) throws StoragePropertiesException {
    ...
    public static boolean isAzureBlobEndpoint(String endpointOrHost) {
        ...
        return matchesAnySuffix(normalizedHost, AzureProperties.azureBlobHostSuffixes);
    }
