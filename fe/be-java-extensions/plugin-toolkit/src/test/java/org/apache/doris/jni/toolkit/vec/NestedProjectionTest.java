...
public class NestedProjectionTest {
    ...
    public void structChildResolvesByNameNotByPosition() {
        ...
        Assertions.assertEquals(NestedProjection.Kind.STRUCT, shape.getKind());
        Assertions.assertFalse(shape.isIdentity());
        Assertions.assertEquals(2, shape.childCount());
        Assertions.assertEquals(2, shape.sourceChildIndex(0));
        Assertions.assertEquals(1, shape.sourceChildIndex(1));
    }
    ...
    public void structChildNameMatchIsCaseInsensitive() {
        ...
        Assertions.assertEquals(0, project("struct<CITY:string>", source).sourceChildIndex(0));
    }
    ...
    public void missingStructChildFailsLoudNamingTheField() {
        ...
        try {
            ...
            Assertions.fail("a requested field that does not exist must not resolve silently");
    ...
    public void shapeConflictFailsLoudShowingBothSides() {
        try {
            ...
            Assertions.fail("Doris STRUCT over a source ARRAY must not resolve");
        } catch (IllegalArgumentException e) {
            Assertions.assertTrue(e.getMessage().contains("STRUCT"), e.getMessage());
            Assertions.assertTrue(e.getMessage().contains("ARRAY"), e.getMessage());
        }
    }
    ...
    public void wholeStructRequestedInSourceOrderIsIdentity() {
        ...
        Assertions.assertTrue(project("struct<a:int,b:int>", source).isIdentity());
    }
    ...
    public void reorderedWholeStructIsNotIdentity() {
        ...
        Assertions.assertFalse(project("struct<b:int,a:int>", source).isIdentity());
    }
    ...
    public void arrayElementIsWalkedAndCarriesPruning() {
        ...
        Assertions.assertEquals(NestedProjection.Kind.ARRAY, shape.getKind());
        Assertions.assertFalse(shape.isIdentity());
        Assertions.assertEquals(1, shape.elementProjection().sourceChildIndex(0));
    }
    ...
    public void mapWalksTheKeyAndPrunesTheValue() {
        ...
        Assertions.assertEquals(NestedProjection.Kind.MAP, shape.getKind());
        Assertions.assertFalse(shape.keyProjection().isIdentity());
        Assertions.assertEquals(1, shape.keyProjection().sourceChildIndex(0));
        Assertions.assertEquals(1, shape.valueProjection().sourceChildIndex(0));
    }
    ...
    public void ambiguousCaseInsensitiveMatchFailsLoudNamingBothFields() {
        ...
        try {
            ...
            Assertions.fail("two case-insensitive matches must not resolve silently");
        } catch (IllegalArgumentException e) {
            Assertions.assertTrue(e.getMessage().contains("ID"), e.getMessage());
            Assertions.assertTrue(e.getMessage().contains("Id"), e.getMessage());
        }
    }
    ...
    public void exactMatchWinsOverCaseInsensitiveNeighbors() {
        ...
        Assertions.assertEquals(1, project("struct<city:int>", source).sourceChildIndex(0));
    }
    ...
    public void twoRequestedChildrenResolvingToOneSourceFieldFailsLoud() {
        ...
        try {
            ...
            Assertions.assertTrue(e.getMessage().contains("a"), e.getMessage());
        }
    }
    ...
    public void scalarRequestOverComplexSourceFailsLoud() {
        ...
        try {
            ...
            Assertions.fail("a Doris scalar over a source STRUCT must not resolve");
        } catch (IllegalArgumentException e) {
            Assertions.assertTrue(e.getMessage().contains("SCALAR"), e.getMessage());
            Assertions.assertTrue(e.getMessage().contains("STRUCT"), e.getMessage());
        }
    }
    ...
    public void scalarKeepsTheSourceTypeRatherThanTheDorisOne() {
        ...
        Assertions.assertEquals(NestedProjection.Kind.SCALAR, shape.getKind());
        Assertions.assertTrue(shape.isIdentity());
        Assertions.assertSame(source, shape.getSourceType());
    }
    ...
    public void nestingThreeLevelsDeepRemapsEveryLevel() {
        ...
        Assertions.assertEquals(1, value.sourceChildIndex(0));
        Assertions.assertEquals(1, value.child(0).sourceChildIndex(0));
    }
    ...
    public void unsupportedColumnIsTreatedAsScalarIdentity() {
        ...
        Assertions.assertTrue(NestedProjection.of(
