...
public final class JniSchemaParams {
    ...
    public static boolean usesEncodedSchema(Map<String, String> params) {
        ...
        // Spelled out rather than a guava checkArgument: plugin-toolkit is copied into every plugin
        // that uses it and so stays dependency-free (see its pom), guava included.
        if (hasFields != hasTypes) {
