...
/** Builds {@link FlussJniScanner}. BE reaches it as {@code (fluss, reader)}. */
public class FlussScannerFactory implements JniScannerFactory {
    ...
    public JniScanner create(int batchSize, Map<String, String> params) {
        return new FlussJniScanner(batchSize, params);
    }
}
