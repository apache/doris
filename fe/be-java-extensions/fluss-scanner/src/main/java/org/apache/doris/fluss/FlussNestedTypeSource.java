...
/** Navigates fluss's type system for {@link NestedProjection}. Stateless, so one instance serves all. */
final class FlussNestedTypeSource implements NestedProjection.TypeSource<DataType> {

    static final FlussNestedTypeSource INSTANCE = new FlussNestedTypeSource();

    private FlussNestedTypeSource() {
    }
