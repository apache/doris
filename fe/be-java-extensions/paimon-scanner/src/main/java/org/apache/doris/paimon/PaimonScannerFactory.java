...
/** Builds {@link PaimonJniScanner}. BE reaches it as {@code (paimon, reader)}. */
public class PaimonScannerFactory implements JniScannerFactory {
    ...
    public JniScanner create(int batchSize, Map<String, String> params) {
        return new PaimonJniScanner(batchSize, params);
    }
}
