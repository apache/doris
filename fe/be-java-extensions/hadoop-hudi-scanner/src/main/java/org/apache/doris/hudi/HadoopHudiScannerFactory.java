...
/** Builds {@link HadoopHudiJniScanner}. BE reaches it as {@code (hudi, reader)}. */
public class HadoopHudiScannerFactory implements JniScannerFactory {
    ...
    public JniScanner create(int batchSize, Map<String, String> params) {
        return new HadoopHudiJniScanner(batchSize, params);
    }
}
