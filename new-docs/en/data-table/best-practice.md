...
### Physical and Chemical View (rollup)
...
#### Low ratio of data aggregation in the Base Table
...
#### The prefix index in Base Table cannot be hit
...
There is no need to reorder, but there is a need to convert the data. For example, modify
...
No need to transform data, for example add columns.
