...
3. Manually migrate data using the API
   ...
   Doris provides [HTTP API](../advanced/http-actions/tablet-migration-action.html), which can manually specify the migration of data shards on one disk to another disk.
