...
export ASAN_OPTIONS=detect_leaks=1:log_path=/tmp/lsan.log:suppressions=${DORIS_HOME}/conf/asan_suppr.conf

## set asan and ubsan env to generate core file
## detect_container_overflow=0, https://github.com/google/sanitizers/issues/193
export ASAN_OPTIONS=detect_leaks=1:log_path=/tmp/lsan.log:symbolize=1:abort_on_error=1:disable_coredump=0:unmap_shadow_on_exit=1:detect_container_overflow=0:check_malloc_usable_size=0:${ASAN_OPTIONS}
