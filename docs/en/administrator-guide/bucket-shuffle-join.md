...
* The current Bucket Shuffle Join cannot make use of the distribution information of colocation for join planning. We will support the planning in the subsequent versions.