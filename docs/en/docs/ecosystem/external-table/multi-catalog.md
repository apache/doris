...
> 5. Support access to hive tables whose data stored on Juicefs, usage is same as common hive table(juicefs-hadoop-x.x.x.jar needs to be placed under fe/lib/ and apache_hdfs_broker/lib/).
