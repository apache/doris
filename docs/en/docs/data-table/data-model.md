...
We illustrate what the aggregation model is and how to use it correctly with practical examples.

### Example 1: aggregate import data

Assume that your business has the following data table schema:
...
| last_visit_date | DATETIME | REPLACE | Last visit time of the user |
...
(
    ...
    `last_visit_date` DATETIME REPLACE DEFAULT "1970-01-01 00:00:00" COMMENT "Last visit time of the user",
...
| Data | Description|
|---|---|
| 10000 | User ID; unique to each user |
| 2017-10-01 | Date when the data are imported |
| Beijing | User location city |
| 20 | User age|
| 0 | Male (1 stands for female) |
| 2017-10-01 06:00 | Time point when the user visited this page (with second-level accuracy) |
| 20 | Consumption of the user in this visit |
| 10 | Time that the user spent on this page |
| 10 | Time that the user spent on this page (redundancy) |
