...
3. If there is an error message like
...
It may be that there are unsupported characters in your bucket name, such as `_`, etc. The bucket name should preferably consist of numbers, letters, and `-`.
