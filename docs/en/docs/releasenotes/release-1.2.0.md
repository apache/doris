...
Documentation: https://doris.apache.org/docs/admin-manual/http-actions/fe/query-profile-action

- Optimized the way to specify the sequence column, you can directly specify the column name. (#13872)
Documentation: https://doris.apache.org/docs/data-operate/update-delete/sequence-column-manual
