...
4. Compile Doris
    ...
    > ** Note: **
     ...
     >
     > This is because the code generated by the old THRIFT belt Boost relies on the file part of the file, there is no lock-dependent file in the new version of Thrift, you need to clean up the rebound-generated dependence，Need to add - Clean parameters 
