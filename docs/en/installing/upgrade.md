...
Because the database is a stateful service, Palo/Doris cannot support version rollback (version downgrade) in most cases. In some cases, the rollback of the 3-bit or 4-bit version can be supported, but the rollback of the 2-bit version will not be supported.
...
If there is a rollback requirement, please contact Palo/Doris developers for confirmation in advance.
