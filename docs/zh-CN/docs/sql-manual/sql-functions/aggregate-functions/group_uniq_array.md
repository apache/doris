...
mysql> select group_uniq_array(k1),group_uniq_array(k1,2) from group_uniq_array_test group by k1 order by k1;
+-------------------------+--------------------------+
...
### keywords
GROUP_UNIQ_ARRAY,ARRAY,DISTINCT