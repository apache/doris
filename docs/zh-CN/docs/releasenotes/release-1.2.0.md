...
其他升级注意事项，请完整阅读本发版通告最后一节“升级注意事项”以及安装部署文档 [https://doris.apache.org/zh-CN/docs/install/standard-deployment](https://doris.apache.org/zh-CN/docs/install/standard-deployment) 和集群升级文档 [https://doris.apache.org/zh-CN/docs/admin-manual/cluster-management/upgrade](https://doris.apache.org/zh-CN/docs/admin-manual/cluster-management/upgrade)
...
文档：[https://doris.apache.org/zh-CN/docs/ecosystem/udaf/remote-user-defined-aggregation-function](https://doris.apache.org/zh-CN/docs/ecosystem/udaf/remote-user-defined-aggregation-function)
...
文档：[https://doris.apache.org/zh-CN/docs/sql-manual/sql-reference/Data-Manipulation-Statements/OUTFILE](https://doris.apache.org/zh-CN/docs/sql-manual/sql-reference/Data-Manipulation-Statements/OUTFILE)
...
文档：[https://doris.apache.org/zh-CN/docs/admin-manual/http-actions/fe/query-profile-action](https://doris.apache.org/zh-CN/docs/admin-manual/http-actions/fe/query-profile-action)
