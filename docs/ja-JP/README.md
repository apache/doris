...
は、MPPアーキテクチャに基づいた使いやすく、高性能でリアルタイムの分析データベースであり、その極めて高速な処理速度と使いやすさで知られています。大量のデータ下でもサブ秒レベルの応答時間でクエリ結果を返すことができ、高並行ポイントクエリシナリオだけでなく、高スループットの複雑な分析シナリオもサポートできます。
