  ...
  <div>
   ...
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="BeId" label="BeId">
      </el-table-column>
      <el-table-column sortable prop="AvgRate" label="AvgRate">
      </el-table-column>
      <el-table-column sortable prop="BalanceSlot" label="BalanceSlot">
      </el-table-column>
      <el-table-column sortable prop="TotalSlots" label="TotalSlots">
      </el-table-column>
      <el-table-column sortable prop="AvailSlots" label="AvailSlots">
      </el-table-column>
