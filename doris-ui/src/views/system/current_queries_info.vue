...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/system/current_queries' }">Current Queries</el-breadcrumb-item>
      <el-breadcrumb-item>Current Queries Info</el-breadcrumb-item>
   ...
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="SQL" label="SQL">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getdata(parameter) {
      this.loading = true
      current_queries_info_list(self.$route.params.id)
        .then(res => {
          this.loading = false
