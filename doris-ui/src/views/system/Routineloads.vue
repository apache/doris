...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Routine Load</el-breadcrumb-item>
    </el-breadcrumb>
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;" >
      ...
      <el-table-column sortable prop="DbName" label="DbName" >
      </el-table-column>
      <el-table-column sortable prop="Statistic" label="Statistic" >
      </el-table-column>
      <el-table-column sortable prop="TaskStatistic" label="TaskStatistic" >
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
