...
<template>
  <div>
   ...
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <!--列表-->
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;" @row-click="goto_balanceinfo">
...
<script>
import { cluster_balance_List} from '../../api/userMG'
