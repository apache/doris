  ...
  <div>
   ...
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="TaskType" label="TaskType">
      </el-table-column>
      <el-table-column sortable prop="TotalNum" label="TotalNum" >
      </el-table-column>
      <el-table-column sortable prop="FailedNum" label="FailedNum" >
      </el-table-column>
      <el-table-column sortable prop="ExecTime" label="ExecTime" >
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
