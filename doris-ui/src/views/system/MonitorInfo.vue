...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/system/Monitor' }">Monitor</el-breadcrumb-item>
      <el-breadcrumb-item >Monitor Info</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    getdata(parameter) {
      this.loading = true
      monitorInfoList(self.$route.params.id)
        .then(res => {
          this.loading = false
