...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/system/statistic' }">Statistic</el-breadcrumb-item>
      <el-breadcrumb-item>Statistic Info</el-breadcrumb-item>
    </el-breadcrumb>
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="UnhealthyTablets" label="UnhealthyTablets">
      </el-table-column>
      <el-table-column sortable prop="CloningTablets" label="CloningTablets" >
      </el-table-column>
      <el-table-column sortable prop="InconsistentTablets" label="InconsistentTablets" >
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
