...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item >Priority Repair</el-breadcrumb-item>
    </el-breadcrumb>
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="Database" label="Database">
      </el-table-column>
      <el-table-column sortable prop="Table" label="Table">
      </el-table-column>
      <el-table-column sortable prop="Partition" label="Partition">
      </el-table-column>
      <el-table-column sortable prop="RemainingTimeMs" label="RemainingTimeMs">
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
