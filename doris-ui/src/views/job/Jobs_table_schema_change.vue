...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Jobs Schema Change</el-breadcrumb-item>
    </el-breadcrumb>
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;" >
      ...
      <el-table-column sortable prop="TableName" label="TableName" >
      </el-table-column> 
      <el-table-column sortable prop="CreateTime" label="CreateTime" >
      </el-table-column> 
      <el-table-column sortable prop="FinishedTime" label="FinishedTime" >
      </el-table-column>  
      <el-table-column sortable prop="IndexName" label="IndexName" >
      </el-table-column> 
      <el-table-column sortable prop="IndexId" label="IndexId" >
      </el-table-column> 
      <el-table-column sortable prop="OriginIndexId" label="OriginIndexId" >
      </el-table-column>  
      <el-table-column sortable prop="SchemaVersion" label="SchemaVersion" >
      </el-table-column>  
      <el-table-column sortable prop="TransactionId" label="TransactionId" >
      </el-table-column>  
      <el-table-column sortable prop="State" label="State" >
      </el-table-column>  
      <el-table-column sortable prop="Msg" label="Msg" >
      </el-table-column>  
