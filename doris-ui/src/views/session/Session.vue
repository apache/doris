...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item >Session</el-breadcrumb-item>
    </el-breadcrumb>
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="Host" label="Host" >
      </el-table-column>
      <el-table-column sortable prop="Time" label="Time" >
      </el-table-column>
      <el-table-column sortable prop="Db" label="Db" >
      </el-table-column>
      <el-table-column sortable prop="Command" label="Command" >
      </el-table-column>
      <el-table-column sortable prop="Info" label="Info" >
      </el-table-column>      
    </el-table>
    <!-- 分页组件 -->
