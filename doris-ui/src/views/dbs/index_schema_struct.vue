...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Struct</el-breadcrumb-item>
    </el-breadcrumb>
   <el-form :inline="true" :model="formInline" class="user-search">
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="loading..." style="width: 100%;">
      ...
      <el-table-column sortable prop="Field" label="Field">
      </el-table-column>
      <el-table-column sortable prop="Type" label="Type">
      </el-table-column>
      <el-table-column sortable prop="Null" label="Null">
      </el-table-column>
      <el-table-column sortable prop="Extra" label="Extra">
      </el-table-column>
      <el-table-column sortable prop="Default" label="Default">
      </el-table-column>
...
export default {
  ...
  created() {
    this.getdata(this.formInline)
     console.log("index schema Parameter = "+ self.$route.params.id)
    self = this
  },
  ...
  methods: {
    goto_table_info(row, event, column){
      ...
      self.$router.push({ 
         path: '/dbs/table_info/' + row.hrefPath.replace(new RegExp(/\//g),'\\')
      })
    },
    // 获取Frontend列表
    getdata(parameter) {
