...
add_thirdparty(openmp LIBNAME "lib64/libomp.a")
add_thirdparty(opencc LIBNAME "lib64/libopencc.a")
add_thirdparty(marisa LIBNAME "lib64/libmarisa.a")
if (USE_AVX2 AND NOT OS_MACOSX)
    add_thirdparty(tenann  LIBNAME "lib64/libtenann-bundle-avx2.a")
else()
    add_thirdparty(tenann  LIBNAME "lib64/libtenann-bundle.a")
endif()
