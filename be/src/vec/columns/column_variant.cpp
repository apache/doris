...
void ColumnVariant::get(size_t n, Field& res) const {
    ...
    for (size_t i = offset; i != end; ++i) {
        ...
        const auto& data = ColumnVariant::deserialize_from_sparse_column(value, i);
...
size_t ColumnVariant::Subcolumn::serialize_text_json(size_t n, BufferWritable& output) const {
    if (least_common_type.get_base_type_id() == PrimitiveType::INVALID_TYPE) {
