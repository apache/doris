...
#if DORIS_ENABLE_JIT
    DataTypePtr data_type() const { return _data_type; }
...
protected:
    ...
    FunctionBasePtr _compiled_function;
    PreparedFunctionPtr _prepared_compiled_function;
    bool _is_function_compiled = false;
#endif
