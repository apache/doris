...
struct RowRefListWithFlagAtomic {
    std::atomic<int> matched_count;
    RowRefList row_list;

    RowRefListWithFlagAtomic() = default;
    RowRefListWithFlagAtomic(RowRefList&& list) : matched_count(0), row_list(list) {}

    RowRefListWithFlagAtomic& operator=(const RowRefListWithFlagAtomic& other) {
        matched_count = other.matched_count.load();
        row_list = other.row_list;
        return *this;
    }
};

using SetOperationHashTableVariants =
        std::variant<SerializedHashTableContext<RowRefListWithFlagAtomic>,
                     I8HashTableContext<RowRefListWithFlagAtomic>,
                     I16HashTableContext<RowRefListWithFlagAtomic>,
                     I32HashTableContext<RowRefListWithFlagAtomic>,
                     I64HashTableContext<RowRefListWithFlagAtomic>,
                     I128HashTableContext<RowRefListWithFlagAtomic>,
                     I256HashTableContext<RowRefListWithFlagAtomic>,
                     I64FixedKeyHashTableContext<true, RowRefListWithFlagAtomic>,
                     I64FixedKeyHashTableContext<false, RowRefListWithFlagAtomic>,
                     I128FixedKeyHashTableContext<true, RowRefListWithFlagAtomic>,
                     I128FixedKeyHashTableContext<false, RowRefListWithFlagAtomic>,
                     I256FixedKeyHashTableContext<true, RowRefListWithFlagAtomic>,
                     I256FixedKeyHashTableContext<false, RowRefListWithFlagAtomic>>;
...
public:
    ...
    bool is_build_finished() const { return _finished_children_index[0]; }
...
private:
    ...
    std::unique_ptr<SetOperationHashTableVariants> _hash_table_variants;
    ...
    std::vector<bool> _finished_children_index;
