...
public:
    VTableValuedFunctionInf(VTableValuedFunctionScanNode& tbf_scan_node) : _tuple_id(tbf_scan_node._tuple_id), _tuple_desc(tbf_scan_node._tuple_desc) {}
    
    ~VTableValuedFunctionInf() {}
