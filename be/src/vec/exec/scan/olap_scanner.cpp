...
void OlapScanner::_collect_profile_before_close() {
    ...
    COUNTER_UPDATE(local_state->_ann_index_topn_search_costs, stats.ann_index_topn_ns);
    COUNTER_UPDATE(local_state->_ann_index_topn_search_cnt, stats.ann_index_topn_search_cnt);
    COUNTER_UPDATE(local_state->_ann_index_range_search_cnt, stats.ann_index_range_search_cnt);
}
