    ...
    while (true) {
        ...
        case TFileFormatType::FORMAT_PARQUET: {
            ...
            if (range.__isset.table_format_params &&
                ...
                init_status = iceberg_reader->init_reader_for_parquet(
        ...
        case TFileFormatType::FORMAT_ORC: {
            ...
            if (range.__isset.table_format_params &&
                ...
                _cur_reader = std::move(tran_orc_reader);
                       ...
                       range.table_format_params.table_format_type == "iceberg") {
                std::unique_ptr<IcebergTableReader> iceberg_reader =
                        IcebergTableReader::create_unique(std::move(orc_reader), _profile, _state,
                                                          *_params, range, _kv_cache, _io_ctx.get(),
                                                          _get_push_down_count());

                init_status = iceberg_reader->init_reader_for_orc(
                        _file_col_names, _col_id_name_map, _colname_to_value_range,
                        _push_down_conjuncts, _real_tuple_desc, _default_val_row_desc.get(),
                        _col_name_to_slot_id, &_not_single_slot_filter_conjuncts,
                        &_slot_id_to_filter_conjuncts);
