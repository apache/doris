    ...
    while (true) {
        ...
        case TFileFormatType::FORMAT_PARQUET: {
            ...
            if (range.__isset.table_format_params &&
                ...
                bool hive_parquet_use_column_names = range.__isset.table_format_params &&
        ...
        case TFileFormatType::FORMAT_ORC: {
            ...
            if (range.__isset.table_format_params &&
                ...
                bool hive_orc_use_column_names = range.__isset.table_format_params &&
                                                 range.table_format_params.table_format_type == "hive"
                                                 && _state != nullptr
                                                 && _state->query_options().hive_orc_use_column_names;
                hive_orc_use_column_names = false;
                init_status = orc_reader->init_reader(
                        &_file_col_names, _colname_to_value_range, _push_down_conjuncts, false,
                        _real_tuple_desc, _default_val_row_desc.get(),
                        &_not_single_slot_filter_conjuncts, &_slot_id_to_filter_conjuncts,hive_orc_use_column_names);
