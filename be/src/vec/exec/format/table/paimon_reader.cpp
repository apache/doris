...
PaimonJniReader::PaimonJniReader(const std::vector<SlotDescriptor*>& file_slot_descs,
    ...
    params["ctl_id"] = range.table_format_params.paimon_params.ctl_id;
    params["db_id"] = range.table_format_params.paimon_params.db_id;
    params["tbl_id"] = range.table_format_params.paimon_params.tbl_id;
    params["last_update_time"] = range.table_format_params.paimon_params.last_update_time;
