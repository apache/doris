...
ArrowResultJniReader::ArrowResultJniReader(const std::vector<SlotDescriptor*>& file_slot_descs,
    ...
    std::map<String, String> params = {
            ...
            {"location_uri", range.table_format_params.arrow_result_params.location_uri},
            {"user", range.table_format_params.arrow_result_params.user},
            {"password", range.table_format_params.arrow_result_params.password},
