...
DeltaLakeJniReader::DeltaLakeJniReader(const std::vector<SlotDescriptor*>& file_slot_descs,
    ...
    _jni_connector = std::make_unique<JniConnector>(
            "org/apache/doris/deltalake/DeltaLakeJniScanner", params, column_names);
}
