    ...
    for (uint64_t i = 0; i < type.getSubtypeCount(); ++i) {
        ...
        case orc::TypeKind::MAP:
            ...
            if (i == 0 && only_access_keys) {
                child_field_id = "KEYS";
                std::cout << "[IcebergOrcNestedColumnUtils] MAP KEYS optimization: Processing key "
                             "field (column_id: "
                          << child->getColumnId() << ")" << std::endl;
            } else if (i == 1 && only_access_values) {
                child_field_id = "VALUES";
                std::cout << "[IcebergOrcNestedColumnUtils] MAP VALUES optimization: Processing "
            ...
            //     std::cout << "[IcebergOrcNestedColumnUtils] MAP VALUES optimization: Adding key column_ids "
