...
private:
    static ColumnIdResult _create_column_ids_and_names(const orc::Type* orc_type,
...
private:
    static ColumnIdResult _create_column_ids_and_names(const FieldDescriptor* field_desc,
                                                       const TupleDescriptor* tuple_descriptor);
