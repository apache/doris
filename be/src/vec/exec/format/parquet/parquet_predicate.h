    ...
    static Status parse_min_max_value(const FieldSchema* col_schema, const std::string& encoded_min,
        ...
        *max_field = logical_column->operator[](1);
        ...
        if (logical_prim_type == TYPE_FLOAT) {
            auto& min_value = min_field->get<PrimitiveTypeTraits<TYPE_FLOAT>::CppType>();
            auto& max_value = max_field->get<PrimitiveTypeTraits<TYPE_FLOAT>::CppType>();
            ...
            auto& min_value = min_field->get<PrimitiveTypeTraits<TYPE_DOUBLE>::CppType>();
            auto& max_value = max_field->get<PrimitiveTypeTraits<TYPE_DOUBLE>::CppType>();
            ...
            auto min_value = min_field->get<PrimitiveTypeTraits<TYPE_DATETIMEV2>::CppType>();
            auto max_value = min_field->get<PrimitiveTypeTraits<TYPE_DATETIMEV2>::CppType>();
