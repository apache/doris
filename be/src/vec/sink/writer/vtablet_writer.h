...
public:
    ...
    int64_t calculate_avg_node_channel_speed() {
    ...
    int64_t get_node_channel_speed(const int64_t& node_id) { return _node_channel_speed[node_id]; }
...
private:
    ...
    // key is node_id, value is the speed of this node
    std::unordered_map<int64_t, int64_t> _node_channel_speed;
