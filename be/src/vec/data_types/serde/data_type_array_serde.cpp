...
Status DataTypeArraySerDe::write_column_to_jsonb(const IColumn& column, JsonbWriter& result,
...
Status DataTypeArraySerDe::read_column_from_jsonb(IColumn& column, const JsonbValue* arg) const {
