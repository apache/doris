...
Status DataTypeArraySerDe::serialize_column_to_text(const IColumn& column, int64_t row_num,
    ...
    for (size_t i = offset; i < next_offset; ++i) {
        ...
        RETURN_IF_ERROR(nested_serde->serialize_column_to_text(nested_column, i, bw));
    }
    bw.write("]", 1);
    return Status::OK();
}
