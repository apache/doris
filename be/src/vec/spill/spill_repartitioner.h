...
public:
    ...
    Status setup_output(RuntimeState* state,
    ...
    Status repartition(RuntimeState* state, vectorized::SpillFileSPtr& input_spill_file,
                       bool* done);
    ...
    static Status create_output_spill_files(
