...
/**
 * {@link BooleanConverter} is the specific implementation of {@link DataTypeConverter}, which is
 * responsible for converting between BOOLEAN column data and Python objects.
 */
class BooleanConverter final : public DataTypeConverter {
public:
