...
/**
 * {@link FloatConverter} is the specific implementation of {@link DataTypeConverter}, which is
 * responsible for converting between FLOAT column data and Python objects.
 */
class FloatConverter final : public DataTypeConverter {
public:
...
/**
 * {@link DoubleConverter} is the specific implementation of {@link DataTypeConverter}, which is
 * responsible for converting between DOUBLE column data and Python objects.
 */
class DoubleConverter final : public DataTypeConverter {
public:
    Status convert_to_python_object(const vectorized::ColumnPtr& column,
                                    const vectorized::DataTypePtr& type, size_t row_index,
                                    PyObject*& py_object) const override;
