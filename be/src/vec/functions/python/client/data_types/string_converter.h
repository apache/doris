...
/**
 * {@link StringConverter} is the specific implementation of {@link DataTypeConverter}, which is
 * responsible for converting between CHAR/VARCHAR/STRING column data and Python objects.
 */
class StringConverter final : public DataTypeConverter {
public:
