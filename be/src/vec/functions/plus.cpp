        ...
        if constexpr (ResultType == TYPE_DECIMALV2) {
            ...
            if (check_overflow) {
                ...
                if (res > max_result_number.value || res < -max_result_number.value) {
                    THROW_DECIMAL_BINARY_OP_OVERFLOW_EXCEPTION(
                            DecimalV2Value(a).to_string(), "add", DecimalV2Value(b).to_string(),
                            DecimalV2Value(res).to_string(), type_to_string(ResultType));
                }
                return res;
            } else {
            ...
            if (check_overflow) {
                ...
                if (UNLIKELY(apply<ResultType>(a, b, res))) {
                    THROW_DECIMAL_BINARY_OP_OVERFLOW_EXCEPTION(
                            type_left.to_string(ArgA(a)), "add", type_right.to_string(ArgB(b)),
...
void register_function_plus(SimpleFunctionFactory& factory) {
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMALV2, TYPE_DECIMALV2>>>();

    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL32, TYPE_DECIMAL32>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL32, TYPE_DECIMAL64>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL32, TYPE_DECIMAL128I>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL32, TYPE_DECIMAL256>>>();

    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL64, TYPE_DECIMAL32>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL64, TYPE_DECIMAL64>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL64, TYPE_DECIMAL128I>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL64, TYPE_DECIMAL256>>>();

    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL128I, TYPE_DECIMAL32>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL128I, TYPE_DECIMAL64>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL128I, TYPE_DECIMAL128I>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL128I, TYPE_DECIMAL256>>>();

    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL256, TYPE_DECIMAL32>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL256, TYPE_DECIMAL64>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL256, TYPE_DECIMAL128I>>>();
    factory.register_function<FunctionPlus<PlusDecimalImpl<TYPE_DECIMAL256, TYPE_DECIMAL256>>>();

    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_TINYINT>>>();
    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_SMALLINT>>>();
    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_INT>>>();
    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_BIGINT>>>();
    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_LARGEINT>>>();
    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_FLOAT>>>();
    factory.register_function<FunctionPlus<PlusIntegralImpl<TYPE_DOUBLE>>>();
}
