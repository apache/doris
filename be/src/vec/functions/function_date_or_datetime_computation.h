    ...
    struct CLASS {                                                                                  \
        ...
        struct SubtractMicrosecondsImpl : SubtractIntervalImpl<AddMicrosecondsImpl<DateType>> {
            ...
            struct SubtractMillisecondsImpl : SubtractIntervalImpl<AddMillisecondsImpl<DateType>> {
                template <PrimitiveType DateType>
                struct SubtractMillisecondsImpl
                        : SubtractIntervalImpl<AddMillisecondsImpl<DateType>> {
                ...
                struct SubtractSecondsImpl : SubtractIntervalImpl<AddSecondsImpl<DateType>> {
                    ...
                    struct SubtractMinutesImpl : SubtractIntervalImpl<AddMinutesImpl<DateType>> {
                        template <PrimitiveType DateType>
                        struct SubtractMinutesImpl
                                : SubtractIntervalImpl<AddMinutesImpl<DateType>> {
                        ...
                        struct SubtractHoursImpl : SubtractIntervalImpl<AddHoursImpl<DateType>> {
                            template <PrimitiveType DateType>
                            struct SubtractHoursImpl
                                    : SubtractIntervalImpl<AddHoursImpl<DateType>> {
                            ...
                            struct SubtractDaysImpl : SubtractIntervalImpl<AddDaysImpl<DateType>> {
                                template <PrimitiveType DateType>
                                struct SubtractDaysImpl
                                        : SubtractIntervalImpl<AddDaysImpl<DateType>> {
                                    static constexpr auto name = "days_sub";
                                };

                                template <PrimitiveType DateType>
                                struct SubtractWeeksImpl
                                        : SubtractIntervalImpl<AddWeeksImpl<DateType>> {
                                    template <PrimitiveType DateType>
                                    struct SubtractWeeksImpl
                                            : SubtractIntervalImpl<AddWeeksImpl<DateType>> {
                                    ...
                                    template <PrimitiveType DateType>
                                    struct SubtractMonthsImpl
                                            : SubtractIntervalImpl<AddMonthsImpl<DateType>> {
                                        template <PrimitiveType DateType>
                                        struct SubtractMonthsImpl
                                                : SubtractIntervalImpl<AddMonthsImpl<DateType>> {
                                        ...
                                        struct SubtractQuartersImpl
                                                : SubtractIntervalImpl<AddQuartersImpl<DateType>> {
                                            template <PrimitiveType DateType>
                                            struct SubtractQuartersImpl
                                                    : SubtractIntervalImpl<
                                                              AddQuartersImpl<DateType>> {
                                                static constexpr auto name = "quarters_sub";
                                            };

                                            template <PrimitiveType DateType>
                                            struct SubtractYearsImpl
                                                    : SubtractIntervalImpl<AddYearsImpl<DateType>> {
                                                template <PrimitiveType DateType>
                                                struct SubtractYearsImpl
                                                        : SubtractIntervalImpl<
                                                                  AddYearsImpl<DateType>> {
...
#define DECLARE_DATE_FUNCTIONS(NAME, FN_NAME, RETURN_TYPE, STMT)                                  \
    ...
    struct NAME {                                                                                 \
        using NativeType1 = typename PrimitiveTypeTraits<DateType1>::DataType::FieldType;         \
        using NativeType2 = typename PrimitiveTypeTraits<DateType2>::DataType::FieldType;         \
        using DateValueType1 = typename PrimitiveTypeTraits<DateType1>::CppType;                  \
        using DateValueType2 = typename PrimitiveTypeTraits<DateType2>::CppType;                  \
        ...
        static DataTypes get_variadic_argument_types() {                                          \
            return {std::make_shared<typename PrimitiveTypeTraits<DateType1>::DataType>(),        \
                    std::make_shared<typename PrimitiveTypeTraits<DateType2>::DataType>()};       \
        }                                                                                         \
        #define DECLARE_DATE_FUNCTIONS(                                                           \
                NAME, FN_NAME, RETURN_TYPE,                                                       \
                STMT) template <PrimitiveType DateType1, PrimitiveType DateType2>                 \
        struct NAME {                                                                             \
            using NativeType1 = typename PrimitiveTypeTraits<DateType1>::DataType::FieldType;     \
            using NativeType2 = typename PrimitiveTypeTraits<DateType2>::DataType::FieldType;     \
            using DateValueType1 = typename PrimitiveTypeTraits<DateType1>::CppType;              \
            ...
            static DataTypes get_variadic_argument_types() {                                      \
                return {std::make_shared<typename PrimitiveTypeTraits<DateType1>::DataType>(),    \
                        std::make_shared<typename PrimitiveTypeTraits<DateType2>::DataType>()};   \
                                                ...
                                                DECLARE_DATE_FUNCTIONS(DateDiffImpl, datediff,
                                                                       TYPE_INT,
                                                                       (ts0.daynr() - ts1.daynr()));
                                                ...
                                                template <PrimitiveType DateType1,
                                                          PrimitiveType DateType2>
                                                template <PrimitiveType DateType1,
                                                          PrimitiveType DateType2>
                                                struct TimeDiffImpl {
                                                    using NativeType1 =
                                                            typename PrimitiveTypeTraits<
                                                                    DateType1>::CppType;
                                                    using NativeType2 =
                                                            typename PrimitiveTypeTraits<
                                                                    DateType2>::CppType;
                                                    using ArgType1 = typename PrimitiveTypeTraits<
                                                            DateType1>::DataType::FieldType;
                                                    using ArgType2 = typename PrimitiveTypeTraits<
                                                            DateType2>::DataType::FieldType;
                                                    using NativeType1 =
                                                            typename PrimitiveTypeTraits<
                                                                    DateType1>::CppType;
                                                    using NativeType2 =
                                                    ...
                                                    static constexpr int64_t limit_value =
                                                            3020399000000; // 838:59:59 convert to microsecond
                                                    static inline DataTypeTimeV2::FieldType execute(
                                                            const ArgType1& t0, const ArgType2& t1,
                                                            bool& is_null) {
                                                            static inline DataTypeTimeV2::FieldType execute(
                                                                    const ArgType1& t0,
                                                                    const ArgType2& t1,
                                                                    bool& is_null) {
                                                                    const auto& ts0 = reinterpret_cast<
                                                                            const NativeType1&>(t0);
                                                    const auto& ts1 =
                                                            reinterpret_cast<const NativeType2&>(
                                                                    t1);
                                                    ...
                                                    if constexpr (UsingTimev2) {
                                                        ...
                                                        int64_t diff_m =
                                                                ts0.datetime_diff_in_microseconds(
                                                                        ts1);
...
#define TIME_DIFF_FUNCTION_IMPL(CLASS, NAME, UNIT) \
    DECLARE_DATE_FUNCTIONS(CLASS, NAME, TYPE_BIGINT, datetime_diff<TimeUnit::UNIT>(ts1, ts0))
                                            DECLARE_DATE_FUNCTIONS(
                                                    CLASS, NAME, TYPE_BIGINT,
                                                    datetime_diff<TimeUnit::UNIT>(ts1, ts0))

                                            // all these functions implemented by datediff
                                            TIME_DIFF_FUNCTION_IMPL(YearsDiffImpl, years_diff,
                                                                    YEAR);
                                            TIME_DIFF_FUNCTION_IMPL(MonthsDiffImpl, months_diff,
                                                                    MONTH);
                                            TIME_DIFF_FUNCTION_IMPL(WeeksDiffImpl, weeks_diff,
                                                                    WEEK);
                                            TIME_DIFF_FUNCTION_IMPL(DaysDiffImpl, days_diff, DAY);
                                            TIME_DIFF_FUNCTION_IMPL(HoursDiffImpl, hours_diff,
                                                                    HOUR);
                                            TIME_DIFF_FUNCTION_IMPL(MintuesDiffImpl, minutes_diff,
                                                                    MINUTE);
                                            TIME_DIFF_FUNCTION_IMPL(SecondsDiffImpl, seconds_diff,
                                                                    SECOND);
                                            TIME_DIFF_FUNCTION_IMPL(MilliSecondsDiffImpl,
                                                                    milliseconds_diff, MILLISECOND);
                                            TIME_DIFF_FUNCTION_IMPL(MicroSecondsDiffImpl,
...
#define TIME_FUNCTION_TWO_ARGS_IMPL(CLASS, NAME, FUNCTION, RETURN_TYPE)                           \
    ...
    struct CLASS {                                                                                \
        ...
        #define TIME_FUNCTION_TWO_ARGS_IMPL(CLASS, NAME, FUNCTION,                                \
                                            RETURN_TYPE) template <PrimitiveType DateType>        \
        struct CLASS {                                                                            \
            using ArgType = typename PrimitiveTypeTraits<DateType>::DataType::FieldType;          \
            using DateValueType = typename PrimitiveTypeTraits<DateType>::CppType;                \
            static constexpr PrimitiveType ReturnType = RETURN_TYPE;                              \
            ...
            static DataTypes get_variadic_argument_types() {                                      \
                return {std::make_shared<typename PrimitiveTypeTraits<DateType>::DataType>(),     \
                        std::make_shared<DataTypeInt32>()};                                       \
                                            ...
                                            TIME_FUNCTION_TWO_ARGS_IMPL(
                                                    ToYearWeekTwoArgsImpl, yearweek,
                                                    year_week(mysql_week_mode(mode)), TYPE_INT);
                                            TIME_FUNCTION_TWO_ARGS_IMPL(ToWeekTwoArgsImpl, week,
                                                                        week(mysql_week_mode(mode)),
                                                                        TYPE_TINYINT);
                            TYPE_INT);
                            TIME_FUNCTION_TWO_ARGS_IMPL(ToWeekTwoArgsImpl, week,
                                                        week(mysql_week_mode(mode)), TYPE_TINYINT);
                            ...
                            template <PrimitiveType DataType0, PrimitiveType DataType1,
                                      typename ToType, typename Transform>
                            template <PrimitiveType DataType0, PrimitiveType DataType1,
                                      typename ToType, typename Transform>
                            struct DateTimeOp {
                                using NativeType0 = typename PrimitiveTypeTraits<
                                        DataType0>::DataType::FieldType;
                                using NativeType1 = typename PrimitiveTypeTraits<
                                        DataType1>::DataType::FieldType;
                                ...
                                static void throw_out_of_bound(NativeType0 arg0, NativeType1 arg1) {
                                    ...
                                    if constexpr (CastType1) {
                                        auto value1 = binary_cast<
                                                NativeType1,
                                                typename PrimitiveTypeTraits<DataType1>::CppType>(
                                                arg1);
                                        auto value1 = binary_cast<
                                                NativeType1,
                                                typename PrimitiveTypeTraits<DataType1>::CppType>(
                                ...
                                static void vector_vector(
                                        const PaddedPODArray<NativeType0>& vec_from0,
                                    ...
                                    for (size_t i = 0; i < size; ++i) {
                                        if ((nullmap0 && (*nullmap0)[i]) ||
                                            (nullmap1 && (*nullmap1)[i])) [[unlikely]] {
                                            continue;
                                        }
                                ...
                                static void vector_constant(
                                        const PaddedPODArray<NativeType0>& vec_from,
                                ...
                                static void constant_vector(
                                        const NativeType0& from, PaddedPODArray<ToType>& vec_to,
                                        const PaddedPODArray<NativeType1>& delta,
                                        const NullMap* nullmap0, const NullMap* nullmap1) {
                            ...
                            public:
                                ...
                                static FunctionPtr create() {
                                    return std::make_shared<FunctionDateOrDateTimeComputation>();
                                }
                                ...
                                DataTypePtr get_return_type_impl(
                                        const ColumnsWithTypeAndName& arguments) const override {
                                ...
                                Status execute_impl(FunctionContext* context, Block& block,
                                    ...
                                    const auto& first_arg_type =
                                            block.get_by_position(arguments[0]).type;
                                    const auto& second_arg_type =
                                    ...
                                    if (second_arg_type->get_primitive_type() ==
                                        PrimitiveType::TYPE_INT) {
                                        switch (first_arg_type->get_primitive_type()) {
                                        case PrimitiveType::TYPE_DATE:
                                            return execute_inner<TYPE_DATE, TYPE_INT>(
                                                    block, arguments, result, input_rows_count);
                                            break;
                                        case PrimitiveType::TYPE_DATETIME:
                                            return execute_inner<TYPE_DATETIME, TYPE_INT>(
                                                    block, arguments, result, input_rows_count);
                                            break;
                                        case PrimitiveType::TYPE_DATEV2:
                                            return execute_inner<TYPE_DATEV2, TYPE_INT>(
                                                    block, arguments, result, input_rows_count);
                                            break;
                                        case PrimitiveType::TYPE_DATETIMEV2:
                                            return execute_inner<TYPE_DATETIMEV2, TYPE_INT>(
                                                    block, arguments, result, input_rows_count);
                                            break;
                                        default:
                                            return Status::InternalError(
                                                    "Illegal argument {} and {} of function {}",
                                    ...
                                    if (first_arg_type->get_primitive_type() ==
                                                PrimitiveType::TYPE_DATEV2 &&
                                        second_arg_type->get_primitive_type() ==
                                                PrimitiveType::TYPE_DATEV2) {
                                        return execute_inner<TYPE_DATEV2, TYPE_DATEV2>(
                                                block, arguments, result, input_rows_count);
                                    } else if (first_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATETIMEV2 &&
                                               second_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATETIMEV2) {
                                        return execute_inner<TYPE_DATETIMEV2, TYPE_DATETIMEV2>(
                                                block, arguments, result, input_rows_count);
                                    } else if (first_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATEV2 &&
                                               second_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATETIMEV2) {
                                        return execute_inner<TYPE_DATEV2, TYPE_DATETIMEV2>(
                                                block, arguments, result, input_rows_count);
                                    } else if (first_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATETIMEV2 &&
                                               second_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATEV2) {
                                        return execute_inner<TYPE_DATETIMEV2, TYPE_DATEV2>(
                                                block, arguments, result, input_rows_count);
                                    } else if (first_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATETIME &&
                                               second_arg_type->get_primitive_type() ==
                                                       PrimitiveType::TYPE_DATETIME) {
                                        return execute_inner<TYPE_DATETIME, TYPE_DATETIME>(
                                                block, arguments, result, input_rows_count);
                                    }
                                    return Status::InternalError(
                                            "Illegal argument {} and {} of function {}",
                                ...
                                template <PrimitiveType DataType0, PrimitiveType DataType1>
                                template <PrimitiveType DataType0, PrimitiveType DataType1>
                                static Status execute_inner(Block& block,
                                                            const ColumnNumbers& arguments,
                                                            uint32_t result,
                                                            size_t input_rows_count) {
                                    using ResFieldType = typename PrimitiveTypeTraits<
                                            Transform::ReturnType>::DataType::FieldType;
                                    using ResFieldType = typename PrimitiveTypeTraits<
                                            Transform::ReturnType>::DataType::FieldType;
                                    using Op = DateTimeOp<DataType0, DataType1, ResFieldType,
                                                          Transform>;

                                    auto get_null_map = [](const ColumnPtr& col) -> const NullMap* {
                                        if (col->is_nullable()) {
                                            return &static_cast<const ColumnNullable&>(*col)
                                                            .get_null_map_data();
                                        }
                                        // Const(Nullable)
                                        if (const auto* const_col =
                                            ...
                                            const_col != nullptr &&
                                            const_col->is_concrete_nullable()) {
                                            return &static_cast<const ColumnNullable&>(
                                                            const_col->get_data_column())
                                                            .get_null_map_data();
                                        }
                                        return nullptr;
                                    };
                                    ...
                                    if (const auto* sources =
                                                check_and_get_column<ColumnVector<DataType0>>(
                                                        src_nested_col.get())) {
                    check_and_get_column<ColumnVector<DataType0>>(src_nested_col.get())) {
                        ...
                        if (const auto* nest_col1_const =
                            ...
                            rconst = true;
                const auto col1_inside_const = assert_cast<const ColumnVector<DataType1>&>(
                const auto col1_inside_const = assert_cast<const ColumnVector<DataType1>&>(
                ...
                Op::vector_constant(sources->get_data(), res_col->get_data(),
                            ...
                            const auto concrete_col1 =
                                    assert_cast<const ColumnVector<DataType1>&>(*nest_col1);
                            const auto concrete_col1 =
                                    assert_cast<const ColumnVector<DataType1>&>(*nest_col1);
                        ...
                        if (result_nullable) {
                            ...
                            block.replace_by_position(result, std::move(res_col));
                                     ...
                                     check_and_get_column_const<ColumnVector<DataType0>>(
                                             src_nested_col.get())) {
                        // const-vector
                        const auto col0_inside_const = assert_cast<const ColumnVector<DataType0>&>(
                                sources_const->get_data_column());
                        assert_cast<const ColumnVector<DataType0>&>(
                                sources_const->get_data_column());
                        const ColumnPtr nested_col1 = remove_nullable(col1);
                        const auto concrete_col1 =
                                assert_cast<const ColumnVector<DataType1>&>(*nested_col1);
                        const auto concrete_col1 =
                                assert_cast<const ColumnVector<DataType1>&>(*nested_col1);
                    ...
                    return Status::OK();
                                ...
                                public:
                                    static constexpr bool has_variadic_argument =
                                            !std::is_void_v<decltype(has_variadic_argument_types(
                                                    std::declval<FunctionImpl>()))>;

                                    static constexpr auto name = FunctionImpl::name;
                                    static FunctionPtr create() {
                                        return std::make_shared<FunctionCurrentDateOrDateTime>();
                                    }
                                    ...
                                    DataTypePtr get_return_type_impl(
                                            ...
                                            const override {
                                        return std::make_shared<typename PrimitiveTypeTraits<
                                                FunctionImpl::ReturnType>::DataType>();
                                        return std::make_shared<typename PrimitiveTypeTraits<
                                                FunctionImpl::ReturnType>::DataType>();
                                    }
                                    ...
                                    Status execute_impl(FunctionContext* context, Block& block,
                                                        ...
                                                        uint32_t result,
                                                        size_t input_rows_count) const override {
                                        return FunctionImpl::execute(context, block, arguments,
                                ...
                                struct CurrentDateTimeImpl {
                                    ...
                                    static constexpr PrimitiveType ReturnType =
                                            WithPrecision ? TYPE_DATETIMEV2 : TYPE_DATETIME;
                                    static constexpr PrimitiveType ReturnType =
                                            WithPrecision ? TYPE_DATETIMEV2 : TYPE_DATETIME;
                                    ...
                                    static Status execute(FunctionContext* context, Block& block,
                                                          ...
                                                          size_t input_rows_count) {
                                        if constexpr (WithPrecision) {
                                            DCHECK(block.get_by_position(result)
                                                                   .type->get_primitive_type() ==
                                                           TYPE_DATETIMEV2 ||
                                                   block.get_by_position(result)
                                                                   .type->get_primitive_type() ==
                                                           TYPE_DATEV2);
                                            if (block.get_by_position(result)
                                                        .type->get_primitive_type() ==
                                                TYPE_DATETIMEV2) {
                                                return executeImpl<TYPE_DATETIMEV2>(
                                                ...
                                                if (block.get_by_position(result)
                                                    ...
                                                    return executeImpl<
                                                            ...
                                                            UInt64>(context, block, arguments,
                                                                    result, input_rows_count);
                                                } else {
                                                    return executeImpl<TYPE_DATEV2>(
                                                            context, block, arguments, result,
                                                            input_rows_count);
                                                }
                                            } else {
                                                if (block.get_by_position(result)
                                                    ...
                                                    return executeImpl<TYPE_DATETIMEV2>(
                                                            context, block, arguments, result,
                                                            input_rows_count);
                                                } else if (block.get_by_position(result)
                                                                   .type->get_primitive_type() ==
                                                           TYPE_DATEV2) {
                                                    return executeImpl<TYPE_DATEV2>(
                                                            context, block, arguments, result,
                                                    ...
                                                    if (block.get_by_position(result)
                                                        ...
                                                        return executeImpl<TYPE_DATETIME>(
                                                                context, block, arguments, result,
                                                                input_rows_count);
                                                    }
                                                }
                   ...
                   if (block.get_by_position(result).type->get_primitive_type() ==
                       ...
                       return executeImpl<TYPE_DATEV2>(context, block, arguments, result,
                                            ...
                                            if (block.get_by_position(result)
                                                ...
                                                return executeImpl<TYPE_DATETIMEV2>(
                                                        ...
                                                        input_rows_count);
                                                               ...
                                                               .type->get_primitive_type() ==
                                                       TYPE_DATEV2) {
                                                return executeImpl<TYPE_DATEV2>(context, block,
                                                                                arguments, result,
                                                                                input_rows_count);
                                            } else {
                                                return executeImpl<TYPE_DATETIME>(context, block,
                                                                                  arguments, result,
                                                                                  input_rows_count);
                                            }
                                        }
                                    ...
                                    static Status executeImpl(FunctionContext* context,
                                                              Block& block,
                                                              const ColumnNumbers& arguments,
                                                              uint32_t result,
                                                              size_t input_rows_count) {
                                        using DateValueType =
                                                typename PrimitiveTypeTraits<PType>::CppType;
                                        using NativeType =
                                                typename PrimitiveTypeTraits<PType>::CppNativeType;
                                        ...
                                        if constexpr (WithPrecision) {
                                            if (const auto* const_column =
                                                ...
                                                dtv.from_unixtime(
                                                        context->state()->timestamp_ms() / 1000,
                                                        context->state()->nano_seconds(),
                                                        context->state()->timezone_obj(), scale);
                                                if constexpr (std::is_same_v<DateValueType,
                                                                             VecDateTimeValue>) {
                                                    reinterpret_cast<DateValueType*>(&dtv)
                                                            ->set_type(TIME_DATETIME);
                                                }
                                                auto date_packed_int =
                                                        binary_cast<DateValueType, NativeType>(dtv);
                                                col_to->insert_data(
                                                ...
                                                static Status executeImpl(
                                                    ...
                                                    using DateValueType =
                                                            typename PrimitiveTypeTraits<
                                                                    PType>::CppType;
                                                    using NativeType = typename PrimitiveTypeTraits<
                                                            PType>::CppNativeType;
                                                    auto col_to = ColumnVector<PType>::create();
                                                    DateValueType dtv;
                                                    bool use_const;
                                                        ...
                                                        if (const auto* const_column =
                                                            ...
                                                            if constexpr (
                                                                    std::is_same_v<
                                                                            DateValueType,
                                                                            VecDateTimeValue>) {
                                                                reinterpret_cast<DateValueType*>(
                                                                        &dtv)
                                                                        ->set_type(TIME_DATETIME);
                                                            }
                                                            auto date_packed_int =
                                                            ...
                                                            const auto& null_map =
                                                                    nullable_column
                                                                            ->get_null_map_data();
                                                            const auto& nested_column = assert_cast<
                                                                    const ColumnInt32*>(
                                                                    nullable_column
                                                                            ->get_nested_column_ptr()
                                                                            .get());
                                                            for (int i = 0; i < input_rows_count;
                                                                 i++) {
                                                                if (!null_map[i]) {
                                                                    dtv.from_unixtime(
                                                                            context->state()->timestamp_ms() /
                                                            ...
                                                            const auto* int_column = assert_cast<
                                                                    const ColumnInt32*>(
                                                                    block.get_by_position(
                                                                                 arguments[0])
                                                                            .column.get());
                                        ...
                                        static Status execute(FunctionContext* context,
                                            ...
                                            if constexpr (PType == TYPE_DATEV2) {
                                                ...
                                                auto date_packed_int = binary_cast<
                                                        DateV2Value<DateV2ValueType>, uint32_t>(
                                                        *reinterpret_cast<
                                                                DateV2Value<DateV2ValueType>*>(
                                                                &dtv));
                                                col_to->insert_data(
                                                ...
                                                dtv.from_unixtime(
                                                        context->state()->timestamp_ms() / 1000,
                                                        context->state()->timezone_obj());
                                                reinterpret_cast<VecDateTimeValue*>(&dtv)->set_type(
                                                        TIME_DATE);
                                                auto date_packed_int = binary_cast<
                                                        doris::VecDateTimeValue, int64_t>(
                                    ...
                                    struct TimeToSecImpl {
                                        ...
                                        static Status execute(FunctionContext* context,
                                            ...
                                            const auto& column_data =
                                                    assert_cast<const ColumnTimeV2&>(*arg_col);

                                            auto& res_data = res_col->get_data();
                                            for (int i = 0; i < input_rows_count; ++i) {
                                                res_data[i] = cast_set<int>(
                                                        static_cast<int64_t>(
                                                                column_data.get_element(i)) /
                                    ...
                                    struct SecToTimeImpl {
                                        ...
                                        static Status execute(FunctionContext* context,
                                            ...
                                            const auto& arg_col =
                                                    block.get_by_position(arguments[0]).column;
                                            const auto& column_data =
                                                    assert_cast<const ColumnInt32&>(*arg_col);

                                            auto res_col = ColumnTimeV2::create(input_rows_count);
                                            auto& res_data = res_col->get_data();
                                            for (int i = 0; i < input_rows_count; ++i) {
                                                res_data[i] = TimeValue::from_second(
                                                        column_data.get_element(i));
                                            }
                                    ...
                                    struct TimestampToDateTime : IFunction {
                                        ...
                                        static constexpr Int64 ratio_to_micro =
                                                (1000 * 1000) / Impl::ratio;
                                        String get_name() const override { return name; }
                                        ...
                                        static FunctionPtr create() {
                                            return std::make_shared<TimestampToDateTime<Impl>>();
                                        }
                                        ...
                                        static Status execute(FunctionContext* context,
                                            ...
                                            if (block.get_by_position(result)
                                                ...
                                                if (block.get_by_position(result)
                                                    ...
                                                    return executeImpl<DateV2Value<DateV2ValueType>,
                                                                       UInt32>(context, block,
                                                                               result,
                                                                               input_rows_count);
                                                } else {
                                                    return executeImpl<VecDateTimeValue, Int64>(
                                            ...
                                            static Status executeImpl(
                                                ...
                                                if (dtv.from_unixtime(
                                                    ...
                                                    auto date_packed_int =
                                                            binary_cast<DateValueType, NativeType>(
                                                                    *reinterpret_cast<
                                                                            DateValueType*>(&dtv));
                                    ...
                                    protected:
                                        DataTypePtr get_return_type_impl(
                                                const DataTypes& arguments) const override {
                                        ...
                                        FunctionBasePtr build_impl(
                                            ...
                                            if (return_type->get_primitive_type() == TYPE_DATEV2) {
                                                if (return_type->get_primitive_type() ==
                                                    TYPE_DATEV2) {
                                                    auto function = FunctionCurrentDateOrDateTime<
                                                            CurrentDateImpl<FunctionName,
                                                                            TYPE_DATEV2>>::create();
                                                    return std::make_shared<DefaultFunction>(
                                                            function, data_types, return_type);
                                                } else if (return_type->get_primitive_type() ==
                                                           TYPE_DATETIMEV2) {
                                                } else if (return_type->get_primitive_type() ==
                                                           TYPE_DATETIMEV2) {
                                                    auto function = FunctionCurrentDateOrDateTime<
                                    ...
                                    public:
                                        ...
                                        static FunctionPtr create() {
                                            return std::make_shared<FunctionMonthsBetween>();
                                        }
                                        String get_name() const override { return name; }
                                        size_t get_number_of_arguments() const override {
                                            return 3;
                                        ...
                                        Status execute_impl(
                                            ...
                                            bool date_consts[2];
                                            date_consts[0] = is_column_const(
                                                    *block.get_by_position(arguments[0]).column);
                                            date_consts[1] = is_column_const(
                                                    *block.get_by_position(arguments[1]).column);
                                            ColumnPtr date_cols[2];
                                            // convert const columns to full columns if necessary
                                            default_preprocess_parameter_columns(
                                                    date_cols, date_consts, {0, 1}, block,
                                                    arguments);

                                            const auto& [col3, col3_const] = unpack_if_const(
                                            ...
                                            const auto& round_off_col =
                                                    *assert_cast<const ColumnBool*>(col3.get());

                                            if (date_consts[0] && date_consts[1]) {
                                                execute_vector<true, false>(input_rows_count,
                                                                            date1_col, date2_col,
                                                                            round_off_col, *res);
                                            } else if (col3_const) {
                                                execute_vector<false, true>(input_rows_count,
                                                                            date1_col, date2_col,
                                                                            round_off_col, *res);
                                            } else {
                                                execute_vector<false, false>(input_rows_count,
                                                                             date1_col, date2_col,
                                                                             round_off_col, *res);
                                            }
                                    ...
                                    private:
                                        ...
                                        static void execute_vector(const size_t input_rows_count,
                                                                   const ColumnDateV2& date1_col,
                                                                   const ColumnDateV2& date2_col,
                                                                   const ColumnBool& round_off_col,
                                                                   ColumnFloat64& res) {
                                            ...
                                            if constexpr (is_date_const) {
                                                auto dtv1 =
                                                        binary_cast<UInt32,
                                                                    DateV2Value<DateV2ValueType>>(
                                                                date1_col.get_element(0));
                                                auto dtv2 =
                                                        binary_cast<UInt32,
                                                                    DateV2Value<DateV2ValueType>>(
                                                                date2_col.get_element(0));
                                            ...
                                            for (int i = 0; i < input_rows_count; ++i) {
                                                if constexpr (!is_date_const) {
                                                    auto dtv1 = binary_cast<
                                                            UInt32, DateV2Value<DateV2ValueType>>(
                                                            date1_col.get_element(i));
                                                    auto dtv2 = binary_cast<
                                                            UInt32, DateV2Value<DateV2ValueType>>(
                                                            date2_col.get_element(i));
                                                    months_between =
                                                            calc_months_between(dtv1, dtv2);
                                                }
                                                if constexpr (!is_round_off_const) {
                                                ...
                                                if (round_off) {
                                                    months_between =
                                                            round_months_between(months_between);
                                                }
                                                res.insert_value(months_between);
                                            }
                                        }

                                        static double calc_months_between(
                                                const DateV2Value<DateV2ValueType>& dtv1,
                                            ...
                                            if (UNLIKELY(is_leap(dtv1.year()) &&
                                                         dtv1.month() == 2)) {
                                                days_in_month1 = 29;
                                            }
                                            auto days_in_month2 = S_DAYS_IN_MONTH[dtv2.month()];
                                            if (UNLIKELY(is_leap(dtv2.year()) &&
                                                         dtv2.month() == 2)) {
                                                days_in_month2 = 29;
                                            }
                                            double days_between = 0;
                                            // if date1 and date2 are all the last day of the month, days_between is 0
                                            if (UNLIKELY(dtv1.day() == days_in_month1 &&
                                                         dtv2.day() == days_in_month2)) {
                                                days_between = 0;
                                            } else {
                                                days_between =
                                                        (dtv1.day() - dtv2.day()) / (double)31.0;
                                            }

                                            // calculate months between
                                            return year_between * 12 + months_between +
                                                   days_between;
                                        }
                                    ...
                                    public:
                                        ...
                                        static FunctionPtr create() {
                                            return std::make_shared<FunctionNextDay>();
                                        }
                                        String get_name() const override { return name; }
                                        size_t get_number_of_arguments() const override {
                                            return 2;
                                        ...
                                        Status execute_impl(
                                            ...
                                            res->reserve(input_rows_count);
                                            const auto& [left_col, left_const] = unpack_if_const(
                                                    block.get_by_position(arguments[0]).column);
                                            const auto& [right_col, right_const] = unpack_if_const(
                                                    block.get_by_position(arguments[1]).column);
                                            const auto& date_col =
                                                    *assert_cast<const ColumnDateV2*>(
                                                            left_col.get());
                                            ...
                                            if (left_const && right_const) {
                                                status = execute_vector<true, true>(
                                                        input_rows_count, date_col, week_col, *res);
                                            } else if (left_const) {
                                                status = execute_vector<true, false>(
                                                        input_rows_count, date_col, week_col, *res);
                                            } else if (right_const) {
                                                status = execute_vector<false, true>(
                                                        input_rows_count, date_col, week_col, *res);
                                            } else {
                                                status = execute_vector<false, false>(
                                                        input_rows_count, date_col, week_col, *res);
                                            }
                                            if (!status.ok()) {
                                                return status;
                                    ...
                                    private:
                                        static int day_of_week(const StringRef& weekday) {
                                            ...
                                            std::transform(weekday_upper.begin(),
                                                           weekday_upper.end(),
                                        ...
                                        static Status compute_next_day(
                                                DateV2Value<DateV2ValueType>& dtv,
                                                const int week_day) {
                                            auto days_to_add =
                                                    (week_day - (dtv.weekday() + 1) + 7) % 7;
                                            days_to_add = days_to_add == 0 ? 7 : days_to_add;
                                            dtv.date_add_interval<TimeUnit::DAY>(TimeInterval(
                                                    TimeUnit::DAY, days_to_add, false));
                                            return Status::OK();
                                        }

                                        template <bool left_const, bool right_const>
                                        static Status execute_vector(size_t input_rows_count,
                                                                     const ColumnDateV2& left_col,
                                            ...
                                            if constexpr (right_const) {
                                                ...
                                                if (week_day == 0) {
                                                    return Status::InvalidArgument(
                                                            "Function {} failed to parse weekday: "
                                                            "{}",
                                                            name, week);
                                                }
                                            }
                                            ...
                                            for (size_t i = 0; i < input_rows_count; ++i) {
                                                ...
                                                res_col.insert_value(
                                                        binary_cast<DateV2Value<DateV2ValueType>,
                                                                    UInt32>(dtv));
                                            }
                                            return Status::OK();
                                        }
                                    ...
                                    public:
                                        ...
                                        static FunctionPtr create() {
                                            return std::make_shared<FunctionTime>();
                                        }
                                        String get_name() const override { return name; }
                                        size_t get_number_of_arguments() const override {
                                            return 1;
                                        ...
                                        Status execute_impl(
                                            ...
                                            ColumnPtr col =
                                                    block.get_by_position(arguments[0]).column;
                                            const auto* arg =
                                                    assert_cast<const ColumnOffset64*>(col.get());
                                            ColumnFloat64::MutablePtr res =
                                                    ColumnFloat64::create(input_rows_count);
                                            ...
                                            for (int i = 0; i < arg->size(); i++) {
                                                ...
                                                res_data[i] = TimeValue::make_time(
                                                        DataTypeDateTimeV2::get_hour(v),
