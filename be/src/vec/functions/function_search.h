...
public:
    FieldReaderResolver(
            ...
            const std::unordered_map<std::string, InvertedIndexIterator*>& iterators,
    ...
    InvertedIndexIterator* get_iterator(const std::string& field_name) const {
...
private:
    ...
    const std::unordered_map<std::string, InvertedIndexIterator*>& _iterators;
...
public:
    ...
    Status evaluate_inverted_index(
            ...
            std::vector<InvertedIndexIterator*> iterators, uint32_t num_rows,
    ...
    Status evaluate_inverted_index_with_search_param(
            ...
            const std::unordered_map<std::string, vectorized::IndexFieldNameAndTypePair>&
                    data_type_with_names,
            std::unordered_map<std::string, InvertedIndexIterator*> iterators, uint32_t num_rows,
    ...
    Status collect_all_field_nulls(
