...
struct CastToString {
    ...
    template <class SRC>
    static inline void push_decimal(const SRC& from, UInt32 scale, ColumnString::Chars& chars);
    ...
    template <class SRC>
    static inline void push_ip(const SRC& from, ColumnString::Chars& chars);
    ...
    static inline void push_time(const TimeValue::TimeType& from, UInt32 scale,
                                 ColumnString::Chars& chars);
...
template <>
inline void CastToString::push_decimal(const Decimal32& from, UInt32 scale,
                                       ColumnString::Chars& chars) {
...
template <>
inline void CastToString::push_decimal(const Decimal64& from, UInt32 scale,
                                       ColumnString::Chars& chars) {
    std::string str = from.to_string(scale);
    chars.insert(str.data(), str.data() + str.size());
}
...
template <>
inline void CastToString::push_decimal(const Decimal128V3& from, UInt32 scale,
                                       ColumnString::Chars& chars) {
    std::string str = from.to_string(scale);
    chars.insert(str.data(), str.data() + str.size());
}
...
template <>
inline void CastToString::push_decimal(const Decimal256& from, UInt32 scale,
                                       ColumnString::Chars& chars) {
    std::string str = from.to_string(scale);
    chars.insert(str.data(), str.data() + str.size());
}
...
template <>
inline void CastToString::push_decimal(const Decimal128V2& from, UInt32 scale,
                                       ColumnString::Chars& chars) {
    auto value = (DecimalV2Value)from;
...
template <>
inline void CastToString::push_ip(const IPv4& from, ColumnString::Chars& chars) {
    auto value = IPv4Value(from);
...
template <>
inline void CastToString::push_ip(const IPv6& from, ColumnString::Chars& chars) {
    auto value = IPv6Value(from);
    std::string str = value.to_string();
    chars.insert(str.data(), str.data() + str.size());
}
