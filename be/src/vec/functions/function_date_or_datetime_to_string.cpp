...
using FunctionIso8601 = FunctionDateOrDateTimeToString<ToIso8601Impl<UInt32>>;
using FunctionIso8601V2 = FunctionDateOrDateTimeToString<ToIso8601Impl<UInt64>>;
...
void register_function_date_time_to_string(SimpleFunctionFactory& factory) {
    ...
    factory.register_function<FunctionIso8601>();
    factory.register_function<FunctionIso8601V2>();
}
