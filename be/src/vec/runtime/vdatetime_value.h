...
public:
    ...
    const char* month_name_with_locale(const std::vector<std::string>& month_names) const;

    const char* day_name() const;
    const char* day_name_with_locale(const std::vector<std::string>& day_names) const;
