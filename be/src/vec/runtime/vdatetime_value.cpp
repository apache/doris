...
uint8_t VecDateTimeValue::calc_week(const VecDateTimeValue& value, uint8_t week_start, uint8_t day_in_first_week, uint32_t *year) {
    uint64_t day_nr = value.daynr();
    uint64_t daynr_first_day = calc_daynr(value._year, 1, 1);
...
uint32_t VecDateTimeValue::year_week(uint8_t week_start, uint8_t day_in_first_week) const {
    uint32_t year = 0;
...
uint8_t VecDateTimeValue::calc_weekday(uint64_t day_nr, uint8_t week_start) {
