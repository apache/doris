...
void Field::create(const Field& field) {
    ...
    case PrimitiveType::TYPE_DECIMAL32:
        create_concrete<TYPE_DECIMAL32>(
                field.template get<typename PrimitiveTypeTraits<TYPE_DECIMAL32>::ColumnItemType>());
        return;
    case PrimitiveType::TYPE_DECIMAL64:
        create_concrete<TYPE_DECIMAL64>(
                field.template get<typename PrimitiveTypeTraits<TYPE_DECIMAL64>::ColumnItemType>());
        return;
    case PrimitiveType::TYPE_DECIMALV2:
        create_concrete<TYPE_DECIMALV2>(
                field.template get<typename PrimitiveTypeTraits<TYPE_DECIMALV2>::ColumnItemType>());
        return;
    case PrimitiveType::TYPE_DECIMAL128I:
        create_concrete<TYPE_DECIMAL128I>(
                field.template get<
                        typename PrimitiveTypeTraits<TYPE_DECIMAL128I>::ColumnItemType>());
        return;
    case PrimitiveType::TYPE_DECIMAL256:
        create_concrete<TYPE_DECIMAL256>(
                field.template get<
                        typename PrimitiveTypeTraits<TYPE_DECIMAL256>::ColumnItemType>());
        return;
