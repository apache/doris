...
IF_NULL_COMPUTE_FUNCTION(Decimal_V2Val, decimal_v2_val);
...
IF_COMPUTE_FUNCTION(Decimal_V2Val, decimal_v2_val);
...
COALESCE_COMPUTE_FUNCTION(Decimal_V2Val, decimal_v2_val);
