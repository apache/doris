...
struct RangeImplUtil {
    ...
    static constexpr const char* get_function_name() {
        if constexpr ((std::is_same_v<SourceDataType, DateV2Value<DateTimeV2ValueType>> ||
                       std::is_same_v<SourceDataType, DateTimeV2NanoValue>)&&!std::
                              is_same_v<TimeUnitOrVoid, void>) {
...
void register_function_array_range(SimpleFunctionFactory& factory) {
    ...
    factory.register_function<FunctionArrayRange<RangeTwoImpl<TYPE_DATETIMEV2_NANO>>>();
    ...
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::YEAR>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::QUARTER>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::MONTH>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::WEEK>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::DAY>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::HOUR>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::MINUTE>>>>();
    factory.register_function<FunctionArrayRange<RangeThreeImpl<
            TYPE_DATETIMEV2_NANO, std::integral_constant<TimeUnit, TimeUnit::SECOND>>>>();
