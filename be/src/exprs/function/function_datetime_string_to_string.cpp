...
using FunctionDateTimeV2NanoDateFormat =
        FunctionDateTimeStringToString<DateFormatImpl<TYPE_DATETIMEV2_NANO>>;
// old version
...
using FunctionTimeFormatDateTimeNano = FunctionTimeFormat<TYPE_DATETIMEV2_NANO>;
...
void register_function_date_time_string_to_string(SimpleFunctionFactory& factory) {
    ...
    factory.register_function<FunctionDateTimeV2NanoDateFormat>();
    factory.register_function<FunctionTimeFormatDate>();
    factory.register_function<FunctionTimeFormatDateTime>();
    factory.register_function<FunctionTimeFormatDateTimeNano>();
