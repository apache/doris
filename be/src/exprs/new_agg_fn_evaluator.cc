...
NewAggFnEvaluator::NewAggFnEvaluator(const AggFn& agg_fn, MemPool* mem_pool, MemTracker* tracker,
                                     bool is_clone)
...
Status NewAggFnEvaluator::Create(const AggFn& agg_fn, RuntimeState* state, ObjectPool* pool,
                                 MemPool* mem_pool, NewAggFnEvaluator** result, MemTracker* tracker,
...
Status NewAggFnEvaluator::Create(const vector<AggFn*>& agg_fns, RuntimeState* state,
                                 ...
                                 vector<NewAggFnEvaluator*>* evals, MemTracker* tracker,
                                 const RowDescriptor& row_desc) {
