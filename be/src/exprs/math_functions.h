...
public:
    ...
    static doris_udf::DecimalVal greatest(
        doris_udf::FunctionContext* ctx, int num_args, const doris_udf::DecimalVal* val);
    static doris_udf::Decimal_V2Val least(
        doris_udf::FunctionContext* ctx, int num_args, const doris_udf::Decimal_V2Val* val);
    static doris_udf::Decimal_V2Val greatest(
        doris_udf::FunctionContext* ctx, int num_args, const doris_udf::Decimal_V2Val* val);
private:
