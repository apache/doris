...
Status AggregatePythonUDAFData::add(int64_t place_id, const IColumn** columns,
    ...
    RETURN_IF_ERROR(converter.convert_to_arrow(input_block,
...
Status AggregatePythonUDAFData::add_batch(AggregateDataPtr* places, size_t place_offset,
    ...
    RETURN_IF_ERROR(converter.convert_to_arrow(
            input_block, ExecEnv::GetInstance()->arrow_memory_pool(), &batch, start, end));
