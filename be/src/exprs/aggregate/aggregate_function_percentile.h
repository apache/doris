...
struct PercentileApproxState {
    ...
    void init(double quantile, float compression = 10000) {
        if (!init_flag) {
            ...
            //The compression parameter setting range is [100, 10000].
            //If the value of compression parameter is not specified set, or is outside the range of [100, 10000],
            //will use the default value of 10000
            if (compression < 100 || compression > 10000) {
                compression = 10000;
            }
