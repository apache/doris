...
struct WindowFunnelStateV2 {
    using TimestampType = std::conditional_t<T == TYPE_DATETIMEV2_NANO, Int64, UInt64>;
    ...
    using DateValueType = std::conditional_t<T == TYPE_DATETIMEV2_NANO, DateTimeV2NanoValue,
