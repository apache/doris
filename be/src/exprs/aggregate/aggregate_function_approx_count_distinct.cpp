...
#include "exprs/aggregate/aggregate_function_approx_count_distinct.h"
...
AggregateFunctionPtr create_aggregate_function_approx_count_distinct(
    ...
    return creator_with_type_list<
            ...
            TYPE_TIMESTAMP_NS, TYPE_IPV4, TYPE_IPV6, TYPE_TIMESTAMPTZ,
            TYPE_UUID>::create<AggregateFunctionApproxCountDistinct>(argument_types,
