...
AggregateFunctionPtr create_aggregate_function_histogram(const std::string& name,
    ...
    using creator = creator_with_type_list<TYPE_BOOLEAN, TYPE_TINYINT, TYPE_SMALLINT, TYPE_INT,
                                           TYPE_BIGINT, TYPE_LARGEINT, TYPE_FLOAT, TYPE_DOUBLE,
                                           TYPE_DECIMAL32, TYPE_DECIMAL64, TYPE_DECIMAL128I,
                                           TYPE_DECIMAL256, TYPE_VARCHAR, TYPE_DATEV2,
                                           TYPE_DATETIMEV2, TYPE_DATETIMEV2_NANO, TYPE_TIMESTAMPTZ>;
