...
ZoneMapFilterResult VRuntimeFilterWrapper::evaluate_zonemap_filter(
...
bool VRuntimeFilterWrapper::can_evaluate_zonemap_filter() const {
    return _impl->can_evaluate_zonemap_filter();
}

void VRuntimeFilterWrapper::collect_slot_column_ids(std::set<int>& column_ids) const {
