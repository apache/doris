...
public:
    ...
    static Status create(const TExpr& texpr, const RowDescriptor& row_desc,
        RuntimeState* state, ObjectPool* pool, Expr** expr, std::shared_ptr<MemTracker> tracker);
    ...
    static Status create(const TExpr& texpr, const RowDescriptor& row_desc,
        RuntimeState* state, Expr** expr, std::shared_ptr<MemTracker> tracker);
    ...
    static Status create(const std::vector<TExpr>& texprs, const RowDescriptor& row_desc,
        RuntimeState* state, ObjectPool* pool, std::vector<Expr*>* exprs, std::shared_ptr<MemTracker> tracker);

    /// Convenience functions creating multiple ScalarExpr.
    static Status create(const std::vector<TExpr>& texprs, const RowDescriptor& row_desc,
        RuntimeState* state, std::vector<Expr*>* exprs, std::shared_ptr<MemTracker> tracker);
