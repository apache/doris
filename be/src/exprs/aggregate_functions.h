...
public:
    ...
    static void numeric_maxby_init(doris_udf::FunctionContext* ctx, doris_udf::StringVal* dst);
    template <typename T, typename KT>
    static void numeric_maxby_update(doris_udf::FunctionContext* ctx, const T& slot1,
                                     const KT& slot2, doris_udf::StringVal* dst);
    template <typename T, typename KT>
    static StringVal numeric_maxby_serialize(FunctionContext* ctx, const StringVal& src);
    template <typename T, typename KT>
    static void numeric_maxby_merge(FunctionContext* ctx, const StringVal& src, StringVal* dst);
    template <typename T, typename KT>
    static T numeric_maxby_get_value(doris_udf::FunctionContext* ctx,
                                                 const doris_udf::StringVal& val);
    template <typename T, typename KT>
    static T numeric_maxby_finalize(doris_udf::FunctionContext* ctx,
                                                const doris_udf::StringVal& val);
