...
template BooleanVal IsNullPredicate::is_null(FunctionContext*, const Decimal_V2Val&);
...
template BooleanVal IsNullPredicate::is_not_null(FunctionContext*, const Decimal_V2Val&);
