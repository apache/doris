...
Status CsvReader::_create_file_reader(bool need_schema) {
    if (_params.file_type == TFileType::FILE_STREAM) {
        ...
        const TQueryOptions default_query_options;
        const auto& query_options =
                _state != nullptr ? _state->query_options() : default_query_options;
        io::FileReaderOptions reader_options =
                FileFactory::get_reader_options(query_options, _file_description);
