...
public:
    ...
    void multiget_data_v2(google::protobuf::RpcController* controller, const PMultiGetRequestV2* request,
                       PMultiGetResponseV2* response, google::protobuf::Closure* done) override;
