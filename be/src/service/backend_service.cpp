...
void _ingest_binlog(StorageEngine& engine, IngestBinlogArg* arg) {
    ...
    LOG(INFO) << "segment_index_file_urls.size=" << segment_index_file_urls.size() << ", "
              << "segment_index_file_names.size=" << segment_index_file_names.size() << ", "
              << "segment_index_file_sizes.size=" << segment_index_file_sizes.size();
