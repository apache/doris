...
#ifndef BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BLOOM_FILTER_READER_H
#define BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BLOOM_FILTER_READER_H
...
#endif // BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BLOOM_FILTER_READER_H
