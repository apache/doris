...
#ifndef BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BYTE_BUFFER_H
#define BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BYTE_BUFFER_H
...
#endif // BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BYTE_BUFFER_H
