...
#ifndef BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BIT_FIELD_WRITER_H
#define BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BIT_FIELD_WRITER_H
...
#endif // BDG_PALO_BE_SRC_OLAP_COLUMN_FILE_BIT_FIELD_WRITER_H
