...
public:
    ...
    CharField* clone() const override { return new CharField(*this); }
...
public:
    ...
    VarcharField* clone() const override { return new VarcharField(*this); }
...
public:
    ...
    BitmapAggField* clone() const override { return new BitmapAggField(*this); }
};
...
public:
    ...
    HllAggField* clone() const override { return new HllAggField(*this); }
};
...
public:
    static Field* create(const TabletColumn& column) {
        ...
        if (aggregate_info == nullptr) {
            LOG(WARNING) << "failed to get aggregate info with aggregation type="
                         << column.aggregation() << " column type=" << column.type();
        }
