...
std::string inverted_index_parser_type_to_string(InvertedIndexParserType parser_type) {
    ...
    case InvertedIndexParserType::PARSER_SIMPLE:
        return INVERTED_INDEX_PARSER_SIMPLE;
    default:
...
InvertedIndexParserType get_inverted_index_parser_type_from_string(const std::string& parser_str) {
    ...
    } else if (parser_str_lower == INVERTED_INDEX_PARSER_SIMPLE) {
        return InvertedIndexParserType::PARSER_SIMPLE;
    }
