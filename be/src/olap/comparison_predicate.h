...
public:
    ...
    Status evaluate(const Schema& schema, InvertedIndexIterator* iterator, uint32_t num_rows,
        ...
        set_inverted_index_query_value(query_value, schema);
    ...
    void set_inverted_index_query_value(std::unique_ptr<InvertedIndexQueryBase>& query_value,
