...
public:
    explicit RowBlockMerger(TabletPtr olap_table);
...
public:
    ...
    OLAPStatus schema_version_convert(TabletPtr ref_olap_table,
                                      TabletPtr new_olap_table,
    ...
    static OLAPStatus clear_schema_change_single_info(TabletPtr olap_table,
                                                      AlterTabletType* alter_table_type,
                                                      bool only_one,
                                                      bool check_only);
...
private:
    ...
    OLAPStatus _check_and_clear_schema_change_info(TabletPtr olap_table,
                                                   const TAlterTabletReq& request);

    OLAPStatus _get_versions_to_be_changed(TabletPtr ref_olap_table,
    ...
    OLAPStatus _create_new_olap_table(const TabletPtr ref_olap_table,
    ...
    static OLAPStatus _parse_request(TabletPtr ref_olap_table,
                                     TabletPtr new_olap_table,
