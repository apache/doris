...
ColumnDataWriter* ColumnDataWriter::create(TabletPtr table, SegmentGroup* segment_group, bool is_push_write) {
...
ColumnDataWriter::ColumnDataWriter(TabletPtr table, SegmentGroup* segment_group, bool is_push_write)
