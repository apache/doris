...
void TabletColumn::init_from_pb(const ColumnPB& column) {
    ...
    if (column.has_variant_sparse_bucket_num()) {
        _variant_sparse_bucket_num = column.variant_sparse_bucket_num();
    }
...
void TabletColumn::to_schema_pb(ColumnPB* column) const {
    ...
    column->set_variant_max_sparse_column_statistics_size(
            _variant_max_sparse_column_statistics_size);
    column->set_variant_sparse_bucket_num(_variant_sparse_bucket_num);
}
