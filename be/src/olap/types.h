...
public:
    ...
    inline void deep_copy_by_arena(void* dest, const void* src, Arena* arena) const {
        _deep_copy_by_arena(dest, src, arena);
    }
...
private:
    ...
    void (*_deep_copy_by_arena)(void* dest, const void* src, Arena* arena);
...
struct BaseFieldtypeTraits : public CppTypeTraits<field_type> {
    ...
    static inline void deep_copy_by_arena(void* dest, const void* src, Arena* arena) {
        *reinterpret_cast<CppType*>(dest) = *reinterpret_cast<const CppType*>(src);
    }
...
struct FieldTypeTraits<OLAP_FIELD_TYPE_LARGEINT> : public BaseFieldtypeTraits<OLAP_FIELD_TYPE_LARGEINT> {
    ...
    static void deep_copy_by_arena(void* dest, const void* src, Arena* arena) {
        *reinterpret_cast<PackedInt128*>(dest) = *reinterpret_cast<const PackedInt128*>(src);
    }
