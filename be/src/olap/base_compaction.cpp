...
Status BaseCompaction::prepare_compact() {
    ...
    OLAP_RETURN_NOT_OK(pick_rowsets_to_compact());
...
Status BaseCompaction::execute_compact_impl() {
    ...
    OLAP_RETURN_NOT_OK(do_compaction(permits));
...
Status BaseCompaction::pick_rowsets_to_compact() {
    ...
    OLAP_RETURN_NOT_OK(check_version_continuity(_input_rowsets));
    OLAP_RETURN_NOT_OK(_check_rowset_overlapping(_input_rowsets));
