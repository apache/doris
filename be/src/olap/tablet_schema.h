...
public:
    ...
    const TabletIndex* inverted_index(int32_t col_unique_id, const std::string& suffix_path) const;
    ...
    // TabletIndex information will be returned as long as it exists.
    const TabletIndex* ngram_bf_index(int32_t col_unique_id, const std::string& suffix_path) const;
