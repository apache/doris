...
private:
    ...
    std::shared_ptr<RowInBlockComparator> _vec_row_comparator = nullptr;
    ...
    std::shared_ptr<MemTracker> _insert_mem_tracker = nullptr;
    std::shared_ptr<MemTracker> _flush_mem_tracker = nullptr;
    ...
    std::unique_ptr<MemTracker> _insert_mem_tracker_use_hook = nullptr;
    ...
    std::unique_ptr<vectorized::Arena> _arena = nullptr;
