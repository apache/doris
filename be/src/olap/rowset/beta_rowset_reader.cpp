...
Status BetaRowsetReader::get_segment_iterators(RowsetReaderContext* read_context,
                                               ...
                                               bool use_cache) {
    OLAP_RETURN_NOT_OK(_rowset->load());
    ...
    OLAP_RETURN_NOT_OK(SegmentLoader::instance()->load_segments(_rowset, &_segment_cache_handle,
                                                           should_use_cache));
...
Status BetaRowsetReader::init(RowsetReaderContext* read_context,
    ...
    OLAP_RETURN_NOT_OK(get_segment_iterators(_context, &iterators, segment_offset));
