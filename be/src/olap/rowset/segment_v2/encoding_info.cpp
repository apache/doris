...
EncodingInfoResolver::EncodingInfoResolver() {
    ...
    _add_map<FieldType::OLAP_FIELD_TYPE_GEOMETRY, DICT_ENCODING>();
    _add_map<FieldType::OLAP_FIELD_TYPE_GEOMETRY, PLAIN_ENCODING>();
    _add_map<FieldType::OLAP_FIELD_TYPE_GEOMETRY, PREFIX_ENCODING, true>();
