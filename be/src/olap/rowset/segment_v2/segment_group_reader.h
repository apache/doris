...
class SegmentGroupIterator : public StorageRowwiseIterator {
public:
    SegmentGroupIterator();
    ~SegmentGroupIterator() override;

    Status prepare(const StorageReadOptions& opts) override;
    Status next_batch(RowBlock* block) override;
private:
    SegmentGroup* 
};
...
private:
    ...
    SegmentIterator* _segment_iterator;
