...
Status VerticalSegmentWriter::_finalize_column_writer_and_update_meta(size_t cid) {
    ...
    column_meta->set_compressed_data_bytes(_column_writers[cid]->get_total_compressed_data_pages_bytes());
    column_meta->set_uncompressed_data_bytes(_column_writers[cid]->get_total_uncompressed_data_pages_bytes());
