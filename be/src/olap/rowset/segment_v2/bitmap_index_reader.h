...
public:
    explicit BitmapIndexReader(FilePathDesc path_desc, const BitmapIndexPB* bitmap_index_meta)
            : _path_desc(std::move(path_desc)), _bitmap_index_meta(bitmap_index_meta) {
