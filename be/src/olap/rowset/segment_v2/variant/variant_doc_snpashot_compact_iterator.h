...
public:
    ...
    Status init(const ColumnIteratorOptions& opts) override {
        return _doc_snapshot_iterator->init(opts);
    }

    Status seek_to_ordinal(ordinal_t ord) override {
        return _doc_snapshot_iterator->seek_to_ordinal(ord);
    }
    ...
    ordinal_t get_current_ordinal() const override {
        return _doc_snapshot_iterator->get_current_ordinal();
    }
...
private:
    ...
    ColumnIteratorUPtr _doc_snapshot_iterator;
};
