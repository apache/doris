...
bool InvertedIndexReader::is_fulltext_index() {
    return type() == InvertedIndexReaderType::FULLTEXT;
}

bool InvertedIndexReader::is_string_index() {
    return type() == InvertedIndexReaderType::STRING_TYPE;
}

bool InvertedIndexReader::is_bkd_index() {
    return type() == InvertedIndexReaderType::BKD;
}
