...
TokenizerPtr CharGroupTokenizerFactory::create() {
    struct CharGroupConfig {
        bool tokenize_on_space;
        bool tokenize_on_letter;
        bool tokenize_on_digit;
        bool tokenize_on_punctuation;
        bool tokenize_on_symbol;
        std::unordered_set<UChar32> tokenize_on_chars;

        CharGroupConfig(bool space, bool letter, bool digit, bool punct, bool symbol,
    ...
    public:
        ...
        bool is_token_char(int32_t c) override {
    ...
    CharGroupConfig config(_tokenize_on_space, _tokenize_on_letter, _tokenize_on_digit,
                           _tokenize_on_punctuation, _tokenize_on_symbol, _tokenize_on_chars);
