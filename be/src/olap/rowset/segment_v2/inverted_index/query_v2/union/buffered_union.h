...
public:
    BufferedUnion(std::vector<ScorerPtrT> scorers, std::vector<TinySetPtr> bitsets,
    ...
    template <typename ScoreCombinerPtrU>
    friend ScorerPtr build(const std::vector<ScorerPtr>& scorers, ScoreCombinerPtrU score_combiner);
