...
ScorerPtr build(const std::vector<ScorerPtr>& scorers, ScoreCombinerPtrU score_combiner) {
...
void BufferedUnion<ScorerPtrT, ScoreCombinerPtrT>::refill(std::vector<ScorerPtrT>& scorers,
                                                          const std::vector<TinySetPtr>& bitsets,
                                                          std::vector<ScoreCombinerPtrT>& scores,
                                                          uint32_t min_doc) {
...
template ScorerPtr build(const std::vector<ScorerPtr>& scorers, SumCombinerPtr score_combiner);
template ScorerPtr build(const std::vector<ScorerPtr>& scorers,
