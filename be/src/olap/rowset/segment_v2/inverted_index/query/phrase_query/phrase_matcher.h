...
public:
    PostingsAndFreq(const TermPositionIterator& postings, int32_t position,
                    std::vector<std::string> terms)
            : _postings(postings), _position(position), _terms(std::move(terms)) {
