...
#include "olap/rowset/segment_v2/ann_index/vector_index.h"
...
Status SegmentIterator::_apply_ann_topn_predicate() {
    ...
    RETURN_IF_ERROR(_ann_topn_runtime->evaluate_vector_ann_search(
            ann_index_iterator, _row_bitmap, result_column, result_row_ids, ann_index_stats));
    ...
    _opts.stats->ann_index_topn_ns += ann_index_stats.search_costs_ns.value();
