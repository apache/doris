...
public:
    ...
    virtual Status init(const ColumnIteratorOptions& opts, long tz_offset = 0) {
        _opts = opts;
        return Status::OK();
    }
...
public:
    ...
    Status init(const ColumnIteratorOptions& opts, long tz_offset) override;
...
public:
    ...
    Status init(const ColumnIteratorOptions& opts, long tz_offset) override {
        return _inner_iter->init(opts, tz_offset);
    }
