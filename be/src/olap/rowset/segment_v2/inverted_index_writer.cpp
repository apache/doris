...
InvertedIndexColumnWriterImpl<field_type>::InvertedIndexColumnWriterImpl(
        const std::string& field_name, IndexFileWriter* index_file_writer,
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::init() {
    try {
...
template <FieldType field_type>
void InvertedIndexColumnWriterImpl<field_type>::close_on_error() {
    try {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::init_bkd_index() {
...
InvertedIndexColumnWriterImpl<field_type>::create_char_string_reader(
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::open_index_directory() {
...
InvertedIndexColumnWriterImpl<field_type>::create_index_writer() {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::create_field(lucene::document::Field** field) {
    int field_config =
...
InvertedIndexColumnWriterImpl<field_type>::create_analyzer(
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::init_fulltext_index() {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_document() {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_null_document() {
    try {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_nulls(uint32_t count) {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_array_nulls(const uint8_t* null_map,
                                                                  size_t num_rows) {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::new_inverted_index_field(
        const char* field_value_data, size_t field_value_size) {
    try {
        if (_should_analyzer) {
...
template <FieldType field_type>
void InvertedIndexColumnWriterImpl<field_type>::new_char_token_stream(
        const char* s, size_t len, lucene::document::Field* field) {
...
template <FieldType field_type>
void InvertedIndexColumnWriterImpl<field_type>::new_field_value(const char* s, size_t len,
...
template <FieldType field_type>
void InvertedIndexColumnWriterImpl<field_type>::new_field_char_value(
        const char* s, size_t len, lucene::document::Field* field) {
    field->setValue((char*)s, len);
}

template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_values(const std::string fn,
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_array_values(size_t field_size,
                                                                   const void* value_ptr,
                                                                   const uint8_t* nested_null_map,
                                                                   const uint8_t* offsets_ptr,
                                                                   size_t count) {
    DBUG_EXECUTE_IF("InvertedIndexColumnWriterImpl::add_array_values_count_is_zero", { count = 0; })
    if (count == 0) {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_numeric_values(const void* values,
                                                                     size_t count) {
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::add_value(const CppType& value) {
    try {
...
template <FieldType field_type>
int64_t InvertedIndexColumnWriterImpl<field_type>::size() const {
    //TODO: get memory size of inverted index
    return 0;
}

template <FieldType field_type>
void InvertedIndexColumnWriterImpl<field_type>::write_null_bitmap(
...
template <FieldType field_type>
Status InvertedIndexColumnWriterImpl<field_type>::finish() {
    if (_dir != nullptr) {
...
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_CHAR>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_VARCHAR>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_STRING>;

template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_TINYINT>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_SMALLINT>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_INT>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_UNSIGNED_INT>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_BIGINT>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_LARGEINT>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DATE>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DATETIME>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DECIMAL>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DATEV2>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DATETIMEV2>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DECIMAL32>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DECIMAL64>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DECIMAL128I>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_DECIMAL256>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_BOOL>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_IPV4>;
template class InvertedIndexColumnWriterImpl<FieldType::OLAP_FIELD_TYPE_IPV6>;
