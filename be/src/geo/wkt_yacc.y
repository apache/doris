...
point:
     KW_POINT '(' coordinate ')'
     {
        std::unique_ptr<doris::GeoPoint> point(doris::GeoPoint::create_unique().release());
...
linestring:
    KW_LINESTRING '(' coordinate_list ')'
    {
        ...
        std::unique_ptr<doris::GeoLine> line(doris::GeoLine::create_unique().release());
...
polygon:
    KW_POLYGON '(' coordinate_list_list ')'
    {
        ...
        std::unique_ptr<doris::GeoPolygon> polygon(doris::GeoPolygon::create_unique().release());
