...
%type <multi_polygon_value> multi_polygon_body
...
%destructor { delete $$; } multi_polygon_body
...
multi_polygon:
    KW_MULTI_POLYGON '(' multi_polygon_body ')'
    {
...
multi_polygon_body:
    ...
    | multi_polygon_body ',' '(' coordinate_list_list ')'
    {
        $1->push_back(*$4);
        delete $4;
        $$ = $1;
