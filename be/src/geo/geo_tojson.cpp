...
namespace doris {
    ...
    bool toGeoJson::multi_polygon_tojson(GeoMultiPolygon* multipolygon, std::string& result){
        ...
        if(!multipolygon->is_empty()){
            std::unique_ptr<GeoCoordinateListCollections> coords_collections = multipolygon->to_coords();
            coordinates_list_collections_tojson(*coords_collections,coords_list_collections_array,allocator);
        }
        document.AddMember(type,type_value,allocator);
    ...
    void toGeoJson::coordinates_list_collections_tojson(const GeoCoordinateListCollections& coords_list_collections,rapidjson::Value& coords_list_array,rapidjson::Document::AllocatorType& allocator){
    ...
    void toGeoJson::coordinates_list_tojson(const GeoCoordinateLists& coords_list,rapidjson::Value& coords_list_array,rapidjson::Document::AllocatorType& allocator){
    ...
    void toGeoJson::coordinates_tojson(const GeoCoordinates& coords,rapidjson::Value& coords_array,rapidjson::Document::AllocatorType& allocator){
    ...
    void toGeoJson::coordinate_tojson(const GeoCoordinate& coord,rapidjson::Value& coord_array,rapidjson::Document::AllocatorType& allocator){
