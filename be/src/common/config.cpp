...
DEFINE_mDouble(quorum_success_max_wait_time_multiplier, "0.2");
DEFINE_mInt64(quorum_success_min_wait_time_ms, "10000");
DEFINE_mInt32(quorum_success_load_timeout_remaining_seconds, "30");
