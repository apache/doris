...
CONF_Bool(cooldown_single_remote_file, "false");   // create single remote file when cooldown.
CONF_mInt64(cooldown_safe_time_sec, "1800");       // upload will not run after be is started,
                                                   // until cooldown_safe_time_sec reached.
