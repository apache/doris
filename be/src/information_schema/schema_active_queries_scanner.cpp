...
std::vector<SchemaScanner::ColumnDesc> SchemaActiveQueriesScanner::_s_tbls_columns = {
        ...
        {"TOTAL_INSTANCES", TYPE_BIGINT, sizeof(int64_t), true},
        {"FINISHED_INSTANCES", TYPE_BIGINT, sizeof(int64_t), true},
        {"PROGRESS", TYPE_VARCHAR, sizeof(StringRef), true}};
...
Status SchemaActiveQueriesScanner::get_next_block_internal(Block* block, bool* eos) {
    if (!_is_init) {
