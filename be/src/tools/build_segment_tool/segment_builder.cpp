...
DEFINE_string(format, "parquet",
              "input data's format, currently just support parquet");
...
int main(int argc, char **argv, char **envp) {
  ...
  LOG(INFO) << "meta file:" << FLAGS_meta_file
            << " data path:" << FLAGS_data_path << " format:" << FLAGS_format;
