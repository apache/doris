...
// Enumerates logical plain terms while retaining each matching physical
// DictEntry for direct posting resolution. PrefixHit::term is decoded logical
// text; PrefixHit::entry.term remains the physical dictionary key.
