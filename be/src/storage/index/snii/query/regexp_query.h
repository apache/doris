...
// regexp_query -- MATCH_REGEXP semantics over dictionary terms. Hyperscan applies
// the same unanchored matching semantics and flags as the V3 inverted index. An
// invalid pattern produces no matches. Matching terms are executed as a sorted
