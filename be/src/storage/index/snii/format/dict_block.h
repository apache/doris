...
public:
    ...
    // Streams entries in [lower_inclusive, upper_exclusive). A missing upper
    // bound scans to the end of the block. Like visit_prefix_range, this starts
    // from the nearest anchor and only decodes accepted entry bodies.
