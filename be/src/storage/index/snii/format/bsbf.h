...
// L0/L1 tiering threshold (the "fast-reject absent terms" design): a bsbf section whose total
...
public:
    ...
    size_t resident_capacity_bytes() const { return words_.capacity() * sizeof(uint32_t); }
