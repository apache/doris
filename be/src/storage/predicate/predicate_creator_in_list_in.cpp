...
template <>
std::shared_ptr<ColumnPredicate> create_in_list_predicate<PredicateType::IN_LIST>(
    ...
    case TYPE_TINYINT: {
        return create_in_list_predicate_impl<TYPE_TINYINT, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_SMALLINT: {
        return create_in_list_predicate_impl<TYPE_SMALLINT, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_INT: {
        return create_in_list_predicate_impl<TYPE_INT, PredicateType::IN_LIST>(cid, col_name, set,
                                                                               is_opposite);
    }
    case TYPE_BIGINT: {
    ...
    case TYPE_DECIMAL32: {
        return create_in_list_predicate_impl<TYPE_DECIMAL32, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_DECIMAL64: {
        return create_in_list_predicate_impl<TYPE_DECIMAL64, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_DECIMAL128I: {
        return create_in_list_predicate_impl<TYPE_DECIMAL128I, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_DECIMAL256: {
        return create_in_list_predicate_impl<TYPE_DECIMAL256, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_CHAR: {
        return create_in_list_predicate_impl<TYPE_CHAR, PredicateType::IN_LIST>(cid, col_name, set,
                                                                                is_opposite);
    }
    case TYPE_VARCHAR: {
        return create_in_list_predicate_impl<TYPE_VARCHAR, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_STRING: {
    ...
    case TYPE_DATETIMEV2_NANO: {
        return create_in_list_predicate_impl<TYPE_DATETIMEV2_NANO, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    ...
    case TYPE_BOOLEAN: {
        return create_in_list_predicate_impl<TYPE_BOOLEAN, PredicateType::IN_LIST>(
                cid, col_name, set, is_opposite);
    }
    case TYPE_IPV4: {
