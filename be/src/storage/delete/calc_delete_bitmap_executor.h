...
private:
    ...
    // Null for synchronous children; shared ownership allows concurrent load cancellation.
    // The deleter retains the workload group until the underlying token is destroyed.
