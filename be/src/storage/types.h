...
template <>
struct CppTypeTraits<FieldType::OLAP_FIELD_TYPE_DATETIMEV2_NANO> {
    using CppType = int64_t;
    using UnsignedCppType = uint64_t;
};
template <>
...
template <>
struct FieldTypeTraits<FieldType::OLAP_FIELD_TYPE_DATETIMEV2_NANO>
        : public BaseFieldTypeTraits<FieldType::OLAP_FIELD_TYPE_DATETIMEV2_NANO> {};
...
#define DORIS_FIELD_TYPE_SIZE_CASE(ft) \
    case FieldType::ft:                \
        ...
        DORIS_FIELD_TYPE_SIZE_CASE(OLAP_FIELD_TYPE_DATETIMEV2_NANO)
