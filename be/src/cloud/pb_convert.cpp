...
void doris_rowset_meta_to_cloud(RowsetMetaCloudPB* out, const RowsetMetaPB& in) {
    ...
    out->set_enable_inverted_index_file_size(in.enable_inverted_index_file_size());
    out->mutable_inverted_index_file_size()->CopyFrom(in.inverted_index_file_size());
}
...
void doris_rowset_meta_to_cloud(RowsetMetaCloudPB* out, RowsetMetaPB&& in) {
    ...
    out->set_enable_inverted_index_file_size(in.enable_inverted_index_file_size());
    out->mutable_inverted_index_file_size()->Swap(in.mutable_inverted_index_file_size());
}
