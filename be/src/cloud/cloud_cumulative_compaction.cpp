...
CloudCumulativeCompaction::CloudCumulativeCompaction(CloudStorageEngine& engine, CloudTabletSPtr tablet)
...
Status CloudCumulativeCompaction::modify_rowsets() {
    ...
    */
    ...
    LOG(INFO) << "tablet stats=" << stats.ShortDebugString();
    {
        ...
        cloud_tablet()->set_cumulative_compaction_cnt(cloud_tablet()->cumulative_compaction_cnt() + 1);
