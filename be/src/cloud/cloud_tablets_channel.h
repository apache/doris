...
class CloudTabletsChannel final : public BaseTabletsChannel {
public:
    CloudTabletsChannel(CloudStorageEngine& engine, const TabletsChannelKey& key,
                        const UniqueId& load_id, bool is_high_priority, RuntimeProfile* profile);
...
private:
    Status _prepare_receiver_side_random_bucket_writer(BaseDeltaWriter* writer) override;
