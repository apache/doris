...
Status AggSinkLocalState::init(RuntimeState* state, LocalSinkStateInfo& info) {
    ...
    _hash_table_size_counter = ADD_COUNTER(operator_custom_profile(), "HashTableSize", TUnit::UNIT);
    ...
    _serialize_key_arena_memory_usage = ADD_COUNTER_WITH_LEVEL(
            Base::operator_custom_profile(), "MemoryUsageSerializeKeyArena", TUnit::BYTES, 1);

    _build_timer = ADD_TIMER(Base::operator_custom_profile(), "BuildTime");
    _merge_timer = ADD_TIMER(Base::operator_custom_profile(), "MergeTime");
    _expr_timer = ADD_TIMER(Base::operator_custom_profile(), "ExprTime");
    ...
    _hash_table_limit_compute_timer =
            ADD_TIMER(Base::operator_custom_profile(), "DoLimitComputeTime");
    _hash_table_emplace_timer = ADD_TIMER(Base::operator_custom_profile(), "HashTableEmplaceTime");
    _hash_table_input_counter =
            ADD_COUNTER(Base::operator_custom_profile(), "HashTableInputCount", TUnit::UNIT);

    _memory_usage_container = ADD_COUNTER(Base::operator_custom_profile(), "MemoryUsageContainer", TUnit::BYTES);
    _memory_usage_arena = ADD_COUNTER(Base::operator_custom_profile(), "MemoryUsageArena", TUnit::BYTES);
