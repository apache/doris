...
template <bool is_intersect>
class PartitionedSetSourceLocalState final : public PipelineXLocalState<PartitionedSetSharedState> {
public:
    ENABLE_FACTORY_CREATOR(PartitionedSetSourceLocalState);
    using Base = PipelineXLocalState<PartitionedSetSharedState>;
...
private:
    ...
    uint32_t _probe_child_cursor {0};
