...
Status RepeatLocalState::init(RuntimeState* state, LocalStateInfo& info) {
    ...
    _evaluate_input_timer = ADD_TIMER(operator_custom_profile(), "EvaluateInputDataTime");
    _get_repeat_data_timer = ADD_TIMER(operator_custom_profile(), "GetRepeatDataTime");
