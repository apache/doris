...
class IcebergTableSinkOperatorBuilder final
        : public DataSinkOperatorBuilder<vectorized::VIcebergTableSink> {
public:
    IcebergTableSinkOperatorBuilder(int32_t id, DataSink* sink)
            : DataSinkOperatorBuilder(id, "IcebergTableSinkOperator", sink) {}

    OperatorPtr build_operator() override;
};

class IcebergTableSinkOperator final : public DataSinkOperator<vectorized::VIcebergTableSink> {
public:
    IcebergTableSinkOperator(OperatorBuilderBase* operator_builder, DataSink* sink)
