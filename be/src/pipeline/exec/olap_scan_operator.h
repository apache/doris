...
private:
    ...
    RuntimeProfile::Counter* _filtered_rowset_counter = nullptr;
    RuntimeProfile::Counter* _total_rowset_counter = nullptr;
    RuntimeProfile::Counter* _rowset_cached_zone_maps_counter = nullptr;
