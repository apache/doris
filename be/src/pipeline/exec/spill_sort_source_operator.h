...
class SpillSortSourceOperator final : public SourceOperator<SpillSortSourceOperatorBuilder> {
public:
    SpillSortSourceOperator(OperatorBuilderBase* operator_builder, ExecNode* sort_node);
