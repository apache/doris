...
Status MultiCastDataStreamer::pull(int sender_idx, doris::vectorized::Block* block, bool* eos) {
    std::atomic_int* un_finish_copy = nullptr;
    int use_count = 0;
    {
...
void MultiCastDataStreamer::_copy_block(vectorized::Block* block, std::atomic_int& un_finish_copy) {
...
void MultiCastDataStreamer::_wait_copy_block(vectorized::Block* block,
                                             std::atomic_int& un_finish_copy) {
