...
Status StreamingAggLocalState::init(RuntimeState* state, LocalStateInfo& info) {
    ...
    _serialize_key_arena_memory_usage = Base::operator_custom_profile()->AddHighWaterMarkCounter(
    ...
    _insert_values_to_column_timer =
            ADD_TIMER(Base::operator_custom_profile(), "InsertValuesToColumnTime");
    ...
    _streaming_agg_timer = ADD_TIMER(operator_custom_profile(), "StreamingAggTime");
    _build_timer = ADD_TIMER(operator_custom_profile(), "BuildTime");
    _expr_timer = ADD_TIMER(Base::operator_custom_profile(), "ExprTime");
