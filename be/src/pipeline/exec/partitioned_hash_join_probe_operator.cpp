...
void PartitionedHashJoinProbeLocalState::update_build_custom_profile(
    ...
    update_profile_from_inner_profile<spilled>("PublishRuntimeFilterTime", custom_profile(),
                                               child_profile);
    update_profile_from_inner_profile<spilled>("BuildRuntimeFilterTime", custom_profile(),
                                               child_profile);
    ...
    update_profile_from_inner_profile<spilled>("BuildExprCallTime", custom_profile(),
                                               child_profile);
    update_profile_from_inner_profile<spilled>("RuntimeFilterInitTime", custom_profile(),
                                               child_profile);
