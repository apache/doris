...
private:
    ...
    std::atomic_bool _spill_eof {false};
...
public:
    ...
    void set_inner_operator(
            std::shared_ptr<SetSinkOperatorX<is_intersect>> inner_sink_operator,
            std::shared_ptr<SetSourceOperatorX<is_intersect>> inner_source_operator) {
        _inner_sink_operator = std::move(inner_sink_operator);
        _inner_source_operator = std::move(inner_source_operator);
    }
