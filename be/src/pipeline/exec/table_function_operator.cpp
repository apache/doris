...
Status TableFunctionLocalState::init(RuntimeState* state, LocalStateInfo& info) {
    ...
    _init_function_timer = ADD_TIMER(operator_custom_profile(), "InitTableFunctionTime");
    _process_rows_timer = ADD_TIMER(operator_custom_profile(), "ProcessRowsTime");
    _copy_data_timer = ADD_TIMER(operator_custom_profile(), "CopyDataTime");
    _filter_timer = ADD_TIMER(operator_custom_profile(), "FilterTime");
    _repeat_data_timer = ADD_TIMER(operator_custom_profile(), "RepeatDataTime");
    return Status::OK();
}
