...
Status OlapScanLocalState::_init_profile() {
    ...
    */
    ...
    _ann_index_topn_filter_counter =
            ADD_COUNTER(_segment_profile, "AnnIndexTopNFiltered", TUnit::UNIT);

    _ann_index_load_costs = ADD_TIMER(_segment_profile, "AnnIndexLoadCosts");

    _ann_index_topn_search_costs = ADD_TIMER(_segment_profile, "AnnIndexTopNSearchCosts");
    _ann_index_topn_search_cnt =
            ADD_COUNTER(_segment_profile, "AnnIndexTopNSearchCnt", TUnit::UNIT);
    _ann_index_range_search_costs = ADD_TIMER(_segment_profile, "AnnIndexRangeSearchCosts");
    _ann_index_range_search_cnt =
            ADD_COUNTER(_segment_profile, "AnnIndexRangeSearchCnt", TUnit::UNIT);
