...
Status OlapScanLocalState::_init_profile() {
    ...
    */
    ...
    _variant_subtree_doc_snapshot_extract_iter_count =
            ADD_COUNTER(_segment_profile, "VariantSubtreeDocSnapshotExtractIterCount", TUnit::UNIT);
    _variant_subtree_doc_snapshot_all_iter_count =
            ADD_COUNTER(_segment_profile, "VariantSubtreeDocSnapshotAllIterCount", TUnit::UNIT);
