...
Status LocalExchangeSinkLocalState::init(RuntimeState* state, LocalSinkStateInfo& info) {
    ...
    _compute_hash_value_timer = ADD_TIMER(operator_custom_profile(), "ComputeHashValueTime");
    _distribute_timer = ADD_TIMER(operator_custom_profile(), "DistributeDataTime");
