...
Status NewFileFactory::create_file_writer(
...
Status NewFileFactory::create_file_reader(
        TFileType::type type, ExecEnv* env, RuntimeProfile* profile,
        const std::vector<TNetworkAddress>& broker_addresses,
...
Status NewFileFactory::create_file_reader(RuntimeProfile* profile, const FileSystemProperties& system_properties,
...
//                                                            &file_reader_ptr));
            ...
            RETURN_IF_ERROR(HdfsReaderWriter::create_new_reader(system_properties.hdfs_params, file_description.path,
