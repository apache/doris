...
Status S3FileReader::read_at_impl(size_t offset, Slice result, size_t* bytes_read,
    ...
    SCOPED_RAW_TIMER(&_s3_stats.total_get_request_time);
...
void S3FileReader::_collect_profile_before_close() {
    if (_profile != nullptr) {
        ...
        RuntimeProfile::Counter* total_get_request_time =
        ...
        COUNTER_UPDATE(total_get_request_time, _s3_stats.total_get_request_time);
    }
}
