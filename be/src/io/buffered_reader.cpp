...
// buffered reader
BufferedReader::BufferedReader(/*RuntimeProfile* profile, */ io::FileReaderSPtr reader,
                               int64_t buffer_size)
    ...
    for (int i = 0; i < buffer_num; i++) {
        _pre_buffers.emplace_back(
                std::make_shared<PrefetchBuffer>(i * s_max_pre_buffer_size, s_max_pre_buffer_size,
