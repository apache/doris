...
INSTANTIATE(DateV2Value<DateV2ValueType>, IColumn::Offset)
...
INSTANTIATE(DateTimeV2NanoValue, IColumn::Offset)
INSTANTIATE(DateTimeV2NanoValue, ColumnArray::Offset64)
...
INSTANTIATE(VecDateTimeValue, IColumn::Offset)
INSTANTIATE(VecDateTimeValue, ColumnArray::Offset64)
