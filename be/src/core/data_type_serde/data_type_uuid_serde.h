...
class DataTypeUUIDSerDe : public DataTypeNumberSerDe<PrimitiveType::TYPE_UUID> {
public:
    explicit DataTypeUUIDSerDe(int nesting_level = 1)
            : DataTypeNumberSerDe<PrimitiveType::TYPE_UUID>(nesting_level) {}
