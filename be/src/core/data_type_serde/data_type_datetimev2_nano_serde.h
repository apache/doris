...
class DataTypeDateTimeV2NanoSerDe final
        : public DataTypeNumberSerDe<PrimitiveType::TYPE_DATETIMEV2_NANO> {
public:
    DataTypeDateTimeV2NanoSerDe(int scale, int nesting_level = 1)
            : DataTypeNumberSerDe<PrimitiveType::TYPE_DATETIMEV2_NANO>(nesting_level),
              _scale(scale) {}
