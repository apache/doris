...
class DataTypeTimeStampNsSerDe final
        : public DataTypeNumberSerDe<PrimitiveType::TYPE_TIMESTAMP_NS> {
public:
    explicit DataTypeTimeStampNsSerDe(int nesting_level = 1)
            : DataTypeNumberSerDe<PrimitiveType::TYPE_TIMESTAMP_NS>(nesting_level) {}
    ...
    int get_scale() const override { return TimeStampNsValue::FRACTIONAL_DIGITS; }
