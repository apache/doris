...
const IColumn& DataTypeFileSerDe::get_struct_column(const IColumn& column) const {
    return assert_cast<const ColumnFile&>(column).get_struct_column();
}

IColumn& DataTypeFileSerDe::get_struct_column(IColumn& column) const {
    return assert_cast<ColumnFile&>(column).get_struct_column();
}

Status DataTypeFileSerDe::from_string(StringRef& str, IColumn& column,
                                      const FormatOptions& options) const {
    return _physical_serde->from_string(str, get_struct_column(column), options);
}

Status DataTypeFileSerDe::from_string_strict_mode(StringRef& str, IColumn& column,
                                                  const FormatOptions& options) const {
    return _physical_serde->from_string_strict_mode(str, get_struct_column(column), options);
}

Status DataTypeFileSerDe::serialize_one_cell_to_json(const IColumn& column, int64_t row_num,
                                                     BufferWritable& bw,
                                                     FormatOptions& options) const {
    return _physical_serde->serialize_one_cell_to_json(get_struct_column(column), row_num, bw,
                                                       options);
}
...
Status DataTypeFileSerDe::serialize_column_to_json(const IColumn& column, int64_t start_idx,
                                                   ...
                                                   FormatOptions& options) const {
    return _physical_serde->serialize_column_to_json(get_struct_column(column), start_idx, end_idx,
                                                     bw, options);
}

Status DataTypeFileSerDe::deserialize_one_cell_from_json(IColumn& column, Slice& slice,
                                                         const FormatOptions& options) const {
    return _physical_serde->deserialize_one_cell_from_json(get_struct_column(column), slice, options);
}

Status DataTypeFileSerDe::deserialize_column_from_json_vector(
        IColumn& column, std::vector<Slice>& slices, uint64_t* num_deserialized,
        const FormatOptions& options) const {
    return _physical_serde->deserialize_column_from_json_vector(get_struct_column(column), slices,
...
Status DataTypeFileSerDe::deserialize_one_cell_from_hive_text(
    ...
    return _physical_serde->deserialize_one_cell_from_hive_text(
            get_struct_column(column), slice, options, hive_text_complex_type_delimiter_level);
}
...
Status DataTypeFileSerDe::deserialize_column_from_hive_text_vector(
    ...
    return _physical_serde->deserialize_column_from_hive_text_vector(
            get_struct_column(column), slices, num_deserialized, options,
...
Status DataTypeFileSerDe::serialize_one_cell_to_hive_text(
        ...
        int hive_text_complex_type_delimiter_level) const {
    return _physical_serde->serialize_one_cell_to_hive_text(get_struct_column(column), row_num, bw,
                                                            options,
                                                            hive_text_complex_type_delimiter_level);
}
...
Status DataTypeFileSerDe::serialize_column_to_jsonb(const IColumn& from_column, int64_t row_num,
    ...
    return _physical_serde->serialize_column_to_jsonb(get_struct_column(from_column), row_num, writer);
}
...
Status DataTypeFileSerDe::deserialize_column_from_jsonb(IColumn& column,
    ...
    return _physical_serde->deserialize_column_from_jsonb(get_struct_column(column), jsonb_value,
                                                          castParms);
}

Status DataTypeFileSerDe::write_column_to_pb(const IColumn& column, PValues& result, int64_t start,
                                             int64_t end) const {
    return _physical_serde->write_column_to_pb(get_struct_column(column), result, start, end);
}

Status DataTypeFileSerDe::read_column_from_pb(IColumn& column, const PValues& arg) const {
    return _physical_serde->read_column_from_pb(get_struct_column(column), arg);
}
...
void DataTypeFileSerDe::write_one_cell_to_jsonb(const IColumn& column, JsonbWriter& result,
                                                ...
                                                const FormatOptions& options) const {
    _physical_serde->write_one_cell_to_jsonb(get_struct_column(column), result, mem_pool, col_id,
                                             row_num, options);
}

void DataTypeFileSerDe::read_one_cell_from_jsonb(IColumn& column, const JsonbValue* arg) const {
    _physical_serde->read_one_cell_from_jsonb(get_struct_column(column), arg);
}
...
Status DataTypeFileSerDe::write_column_to_mysql_binary(const IColumn& column,
                                                       ...
                                                       const FormatOptions& options) const {
    return _physical_serde->write_column_to_mysql_binary(get_struct_column(column), row_buffer,
...
Status DataTypeFileSerDe::write_column_to_arrow(const IColumn& column, const NullMap* null_map,
    ...
    return _physical_serde->write_column_to_arrow(get_struct_column(column), null_map, array_builder,
                                                  start, end, ctz);
}
...
Status DataTypeFileSerDe::read_column_from_arrow(IColumn& column, const arrow::Array* arrow_array,
    ...
    return _physical_serde->read_column_from_arrow(get_struct_column(column), arrow_array, start, end,
                                                   ctz);
}
...
Status DataTypeFileSerDe::write_column_to_orc(const std::string& timezone, const IColumn& column,
                                              ...
                                              const FormatOptions& options) const {
    return _physical_serde->write_column_to_orc(timezone, get_struct_column(column), null_map,
...
bool DataTypeFileSerDe::write_column_to_presto_text(const IColumn& column, BufferWritable& bw,
                                                    int64_t row_idx,
                                                    const FormatOptions& options) const {
    return _physical_serde->write_column_to_presto_text(get_struct_column(column), bw, row_idx,
                                                        options);
}
...
bool DataTypeFileSerDe::write_column_to_hive_text(const IColumn& column, BufferWritable& bw,
                                                  int64_t row_idx,
                                                  const FormatOptions& options) const {
    return _physical_serde->write_column_to_hive_text(get_struct_column(column), bw, row_idx,
                                                      options);
}

void DataTypeFileSerDe::to_string(const IColumn& column, size_t row_num, BufferWritable& bw,
                                  const FormatOptions& options) const {
    _physical_serde->to_string(get_struct_column(column), row_num, bw, options);
}
