...
public:
    ...
    // Formatting emits the requested leading fractional digits without rounding. The SQL type
    // normally requests scale 9; smaller scales are retained for generic date-format callers.
