...
namespace doris {
const std::string REUQEST_SCROLL_FILTER_PATH =
        "filter_path=_scroll_id,hits.hits._source,hits.total,_id,hits.hits._source.fields,hits."
        "hits.fields";
...
ESScanReader::ESScanReader(const std::string& target,
    ...
    if (props.find(KEY_TERMINATE_AFTER) != props.end()) {
        ...
        scratch << _target << REQUEST_SEPARATOR << _index << REQUEST_SEPARATOR << _type
                ...
                << _shards << "&" << REUQEST_SCROLL_FILTER_PATH;
        ...
        scratch << _target << REQUEST_SEPARATOR << _index << REQUEST_SEPARATOR << _type
                ...
                << REUQEST_SCROLL_FILTER_PATH << "&terminate_after=" << batch_size_str;
