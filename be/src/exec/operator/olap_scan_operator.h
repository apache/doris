...
private:
    ...
    // Number of page zone maps evaluated (ordinary and expression predicates).
    RuntimeProfile::Counter* _zonemap_index_pages_evaluated_counter = nullptr;
    // Number of page Bloom filters read and evaluated.
    RuntimeProfile::Counter* _bloom_filter_index_pages_evaluated_counter = nullptr;
