...
#ifndef BDG_PALO_BE_SRC_EXEC_PARTITIONED_HASH_TABLE_INLINE_H
#define BDG_PALO_BE_SRC_EXEC_PARTITIONED_HASH_TABLE_INLINE_H
...
#endif // BDG_PALO_BE_SRC_EXEC_PARTITIONED_HASH_TABLE_INLINE_H
