...
class SchemaAuditErrorHubScanner : public SchemaScanner {
    ENABLE_FACTORY_CREATOR(SchemaAuditErrorHubScanner);

public:
    SchemaAuditErrorHubScanner();
    ~SchemaAuditErrorHubScanner() override;
