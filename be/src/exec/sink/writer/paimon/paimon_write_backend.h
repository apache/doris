...
/// underlying Paimon SDK (Java JNI or Rust FFI). An upstream Exchange may
/// establish writer ownership, while authoritative partition and bucket
/// assignment remains inside the selected SDK backend.
///
