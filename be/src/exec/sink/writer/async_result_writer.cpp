...
// Declared with its default argument in exec/exchange/local_exchanger.h; a unity build may
// compile this file together with a sibling that includes that header, so the default
// argument must not be repeated here.
template <typename T>
