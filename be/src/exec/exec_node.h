...
public:
    ...
    */
    ...
    // // The origin_block obtains intermediate results through intermediate_projections, which are preserved in place in the origin_block.
    // // They have not been copied to the output_block yet.
    // // Only be copied to the output_block after executing the final_projections.
    // [[nodiscard]] static Status do_projections_with_intermediate_expr(
