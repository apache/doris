...
// Shared type aliases and utility types for join hash table contexts.
// This header is self-contained and does NOT depend on join_utils.h,
// join_hash_table_context.h, or join_hash_table_context_impl.h.
// It exists to break the include cycle between those headers.
