...
const string ScanNode::_s_per_read_thread_throughput_counter = "PerReadThreadRawHdfsThroughput";
...
const string ScanNode::_s_scanner_thread_total_wallclock_time = "ScannerThreadsTotalWallClockTime";
...
Status ScanNode::prepare(RuntimeState* state) {
    ...
    _per_read_thread_throughput_counter = runtime_profile()->add_derived_counter(
            ...
            boost::bind<int64_t>(&RuntimeProfile::units_per_second, _bytes_read_counter,
                                 _read_timer),
            "");
