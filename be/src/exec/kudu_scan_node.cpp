...
KuduScanNode::KuduScanNode(ObjectPool* pool, const TPlanNode& tnode, const DescriptorTbl& descs)
...
void KuduScanNode::run_scanner_thread(KuduScanNode* scanNode, const string& name,
                                      const string* initial_token) {
