...
public:
    struct ColumnStatistics {
        ...
        ColumnStatistics(ColumnChunkReaderStatistics& cs, int64_t null_map_time)
                : page_index_read_calls(0),
                  ...
                  leaf_page_read_counters {cs.data_page_read_counter} {}
        ...
        // Preserve per-leaf identity when complex readers aggregate their other counters.
        std::vector<int64_t> leaf_page_read_counters;
        ...
        void merge(ColumnStatistics& col_statistics) {
            ...
            leaf_page_read_counters.insert(leaf_page_read_counters.end(),
                                           col_statistics.leaf_page_read_counters.begin(),
                                           col_statistics.leaf_page_read_counters.end());
    ...
    virtual Status read_dictionary_filter(const IColumn::Filter&, FilterMap&, size_t,
                                          ...
                                          DictionaryFilterOutput* output, size_t* read_rows,
    ...
    virtual Result<MutableColumnPtr> materialize_dictionary_values(const ColumnInt32* dict_column,
                                                                   const DataTypePtr& target_type) {
        throw Exception(
...
public:
    ...
    Status read_dictionary_filter(const IColumn::Filter& dictionary_filter, FilterMap& filter_map,
                                  ...
                                  DictionaryFilterOutput* output, size_t* read_rows, bool* eof,
