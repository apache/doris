...
struct OSSClientConf {
    ...
    // Override STS endpoint; empty = "sts.<region>.aliyuncs.com" (standard public cloud).
    // Set for Alibaba Cloud finance/gov cloud regions that use non-standard STS endpoints.
