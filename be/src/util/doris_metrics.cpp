...
DEFINE_ENGINE_COUNTER_METRIC(alter_vector_index_requests_total, alter_vector_index, total);
DEFINE_ENGINE_COUNTER_METRIC(alter_vector_index_requests_failed, alter_vector_index, failed);
...
DorisMetrics::DorisMetrics() : _metric_registry(_s_registry_name) {
    ...
    INT_COUNTER_METRIC_REGISTER(_server_metric_entity, alter_vector_index_requests_total);
    INT_COUNTER_METRIC_REGISTER(_server_metric_entity, alter_vector_index_requests_failed);
