 ...
 */
typedef wasm_trap_t* (*wasmtime_func_callback_t)(void* env, wasmtime_caller_t* caller,
 ...
 */
WASM_API_EXTERN void wasmtime_func_new(wasmtime_context_t* store, const wasm_functype_t* type,
                                       wasmtime_func_callback_t callback, void* env,
 ...
 * the arguments.
 */
typedef wasm_trap_t* (*wasmtime_func_unchecked_callback_t)(void* env, wasmtime_caller_t* caller,
 ...
 * existence).
 */
WASM_API_EXTERN void wasmtime_func_new_unchecked(wasmtime_context_t* store,
 ...
 */
WASM_API_EXTERN wasm_functype_t* wasmtime_func_type(const wasmtime_context_t* store,
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_func_call(wasmtime_context_t* store,
                                                     const wasmtime_func_t* func,
                                                     const wasmtime_val_t* args, size_t nargs,
                                                     wasmtime_val_t* results, size_t nresults,
                                                     wasm_trap_t** trap);
 ...
 */
WASM_API_EXTERN wasmtime_error_t* wasmtime_func_call_unchecked(wasmtime_context_t* store,
                                                               const wasmtime_func_t* func,
                                                               wasmtime_val_raw_t* args_and_results,
 ...
 */
WASM_API_EXTERN bool wasmtime_caller_export_get(wasmtime_caller_t* caller, const char* name,
 ...
 */
WASM_API_EXTERN void wasmtime_func_from_raw(wasmtime_context_t* context, size_t raw,
                                            wasmtime_func_t* ret);
 ...
 */
WASM_API_EXTERN size_t wasmtime_func_to_raw(wasmtime_context_t* context,
                                            const wasmtime_func_t* func);
