 ...
 */
WASM_API_EXTERN wasmtime_externref_t* wasmtime_externref_from_raw(wasmtime_context_t* context,
                                                                  size_t raw);
 ...
 */
WASM_API_EXTERN size_t wasmtime_externref_to_raw(wasmtime_context_t* context,
