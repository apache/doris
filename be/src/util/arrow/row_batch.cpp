...
Status convert_to_arrow_type(const TypeDescriptor& type, std::shared_ptr<arrow::DataType>* result) {
    ...
    case TYPE_ARRAY: {
        ...
        RETURN_IF_ERROR(convert_to_arrow_type(type.children[0], &item_type));
    ...
    case TYPE_MAP: {
        ...
        RETURN_IF_ERROR(convert_to_arrow_type(type.children[0], &key_type));
        RETURN_IF_ERROR(convert_to_arrow_type(type.children[1], &val_type));
    ...
    case TYPE_STRUCT: {
        ...
        for (size_t i = 0; i < type.children.size(); i++) {
            ...
            RETURN_IF_ERROR(convert_to_arrow_type(type.children[i], &field_type));
