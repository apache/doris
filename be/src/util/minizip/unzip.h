/* unzip.h -- IO for uncompress .minizip files using zlib
   ...
   part of the MiniZip project - ( http://www.winimage.com/zLibDll/minizip.html )
         ...
         Modifications for Zip64 support on both minizip and unzip
...
extern int ZEXPORT unzStringFileNameCompare OF((const char* fileName1, const char* fileName2,
...
/*
  Open a Zip file. path contain the full pathname (by example,
     on a Windows XP computer "c:\\zlib\\zlib113.minizip" or on an Unix computer
     "zlib/zlib113.minizip".
...
/*
   Open a Zip file, like unzOpen, but provide a set of file low level API
      for read/write the minizip file (see ioapi.h)
*/
...
typedef struct unz_file_pos_s {
    uLong pos_in_zip_directory; /* offset in minizip file directory */
...
typedef struct unz64_file_pos_s {
    ZPOS64_T pos_in_zip_directory; /* offset in minizip file directory */
...
extern int ZEXPORT unzGetCurrentFileInfo64 OF((unzFile file, unz_file_info64* pfile_info,
...
extern int ZEXPORT unzOpenCurrentFile3 OF((unzFile file, int* method, int* level, int raw,
                                           const char* password));
/*
  Same than unzOpenCurrentFile, but open for read raw the file (not uncompress)
    if raw==1
...
/*
  Close the file in minizip opened with unzOpenCurrentFile
