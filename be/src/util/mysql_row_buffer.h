...
#ifndef  BDG_PALO_BE_SRC_QUERY_MYSQL_MYSQL_ROW_BUFFER_H
#define  BDG_PALO_BE_SRC_QUERY_MYSQL_MYSQL_ROW_BUFFER_H
...
#endif  // BDG_PALO_BE_SRC_QUERY_MYSQL_MYSQL_ROW_BUFFER_H
