...
public:
    RuntimeFilterMgr(const UniqueId& query_id, RuntimeFilterparams* state);
...
public:
    RuntimeFilterMergeControllerEntity(RuntimeFilterparams* state)
