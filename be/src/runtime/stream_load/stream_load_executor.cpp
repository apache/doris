...
Status StreamLoadExecutor::commit_txn(StreamLoadContext* ctx) {
    ...
    DorisBvarMetrics::instance()->stream_load_txn_commit_request_total->increment(1);
...
void StreamLoadExecutor::rollback_txn(StreamLoadContext* ctx) {
    ...
    DorisBvarMetrics::instance()->stream_load_txn_rollback_request_total->increment(1);
