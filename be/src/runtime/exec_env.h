...
public:
    ...
    ThreadPool* s3_parallel_read_thread_pool() { return _s3_parallel_read_thread_pool.get(); }
...
private:
    ...
    // Threadpool used to parallel read s3 file
    std::unique_ptr<ThreadPool> _s3_parallel_read_thread_pool;
