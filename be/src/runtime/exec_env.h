...
public:
    ...
    void set_ann_index_page_cache(AnnIndexDataPageCache* c) { this->_ann_index_page_cache = c; }
    ...
    AnnIndexDataPageCache* get_ann_index_page_cache() { return _ann_index_page_cache; }
...
private:
    ...
    AnnIndexDataPageCache* _ann_index_page_cache = nullptr;
