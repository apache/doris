...
public:
    enum class CacheType {
        ...
        CONDITION_CACHE = 23,
        ANN_INDEX_TOPN_RESULT_CACHE = 24,
    };
    ...
    static std::string type_string(CacheType type) {
        ...
        case CacheType::ANN_INDEX_TOPN_RESULT_CACHE:
            return "AnnIndexTopnResultCache";
        default:
    ...
    inline static std::unordered_map<std::string, CacheType> StringToType = {
            ...
            {"AnnIndexTopnResultCache", CacheType::ANN_INDEX_TOPN_RESULT_CACHE},
    };
