...
DEFINE_GAUGE_METRIC_PROTOTYPE_5ARG(scanner_thread_pool_queue_size, MetricUnit::NOUNIT);
DEFINE_GAUGE_METRIC_PROTOTYPE_5ARG(etl_thread_pool_queue_size, MetricUnit::NOUNIT);
