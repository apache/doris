...
Status ExecEnv::_init(const std::vector<StorePath>& store_paths,
    ...
    RETURN_IF_ERROR(_init_dummy_workload_group());
...
Status ExecEnv::_init_dummy_workload_group() {
    LOG(INFO) << "begin init dummy workload group.";

    RETURN_IF_ERROR(WorkloadGroup::create_dummy_wg(&_dummpy_workload_group));
