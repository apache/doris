...
Status ExecEnv::_init_mem_tracker() {
    ...
    int64_t buffer_pool_limit = ParseUtil::parse_mem_spec(config::buffer_pool_limit,
                                                          global_memory_limit_bytes, &is_percent);
    ...
    int64_t clean_pages_limit = ParseUtil::parse_mem_spec(config::buffer_pool_clean_pages_limit,
                                                          buffer_pool_limit, &is_percent);
