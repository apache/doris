...
bool DateTimeValue::unix_timestamp(int64_t* timestamp, const std::string& timezone) const {
    ...
    boost::posix_time::ptime pt =
            boost::posix_time::time_from_string(std::string(buf, to - buf - 1));

    boost::local_time::local_date_time lt(
            pt.date(), pt.time_of_day(), local_time_zone,
...
bool DateTimeValue::from_unixtime(int64_t timestamp, const std::string& timezone) {
    ...
    boost::local_time::local_date_time lt(boost::posix_time::from_time_t(timestamp),
                                          local_time_zone);
