...
public:
    ...
    static Status create(
            ...
            RuntimeState* state, MemTracker* parent, RuntimeProfile* profile,
            TmpFileMgr* tmp_file_mgr, int64_t mem_limit, int64_t buffer_size,
    ...
    Status register_client(int num_reserved_buffers, MemTracker* tracker, RuntimeState* state,
                           Client** client);
...
private:
    ...
    void init(DiskIoMgr* io_mgr, RuntimeProfile* profile, MemTracker* parent_tracker,
              int64_t mem_limit);
