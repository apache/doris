...
void ResultCache::update_monitor() {
    ...
    DorisBvarMetrics::instance()->query_cache_memory_total_byte->set_value(_cache_size);
    DorisBvarMetrics::instance()->query_cache_sql_total_count->set_value(_node_count);
    DorisBvarMetrics::instance()->query_cache_partition_total_count->set_value(_partition_count);
}
