...
class Decimal_V2Value {
public:
    friend Decimal_V2Value operator+(const Decimal_V2Value& v1, const Decimal_V2Value& v2);
    friend Decimal_V2Value operator-(const Decimal_V2Value& v1, const Decimal_V2Value& v2);
    friend Decimal_V2Value operator*(const Decimal_V2Value& v1, const Decimal_V2Value& v2);
    friend Decimal_V2Value operator/(const Decimal_V2Value& v1, const Decimal_V2Value& v2);
    friend std::istream& operator>>(std::istream& ism, Decimal_V2Value& decimal_value);
    friend Decimal_V2Value operator-(const Decimal_V2Value& v);
    ...
    Decimal_V2Value(int64_t int_value, int64_t frac_value) {
    ...
    Decimal_V2Value& assign_from_float(const float float_value) {
        _value = static_cast<int128_t>(float_value * ONE_BILLION);
        return *this;
    }

    Decimal_V2Value& assign_from_double(const double double_value) {
    ...
    // e.g. "ComputeFunctions::Cast_Decimal_V2Value_double()"
    ...
    Decimal_V2Value& operator+=(const Decimal_V2Value& other);
    ...
    bool operator==(const Decimal_V2Value& other) const {
    ...
    static Decimal_V2Value get_min_decimal() {
        return Decimal_V2Value(-MAX_INT_VALUE, MAX_FRAC_VALUE);
    }

    static Decimal_V2Value get_max_decimal() {
        return Decimal_V2Value(MAX_INT_VALUE, MAX_FRAC_VALUE);
    }
    ...
    int round(Decimal_V2Value *to, int scale, DecimalRoundMode mode);
...
namespace std {
    template<>
    struct hash<doris::Decimal_V2Value> {
        size_t operator()(const doris::Decimal_V2Value& v) const {
