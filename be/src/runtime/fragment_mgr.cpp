...
DEFINE_GAUGE_METRIC_PROTOTYPE_2ARG(fragment_thread_pool_active_threads, MetricUnit::NOUNIT);
...
FragmentMgr::FragmentMgr(ExecEnv* exec_env)
    ...
    REGISTER_HOOK_METRIC(fragment_thread_pool_active_threads,
...
FragmentMgr::~FragmentMgr() {
    ...
    DEREGISTER_HOOK_METRIC(fragment_thread_pool_active_threads);
