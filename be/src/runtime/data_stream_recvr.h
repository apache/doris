...
public:
    ...
    void update_sub_plan_statistics(const PQueryStatistics& statistics, int sender_id) {
...
private:
    ...
    // Query statistics returned with batch
    QueryStatistics* _sub_plan_query_statistics;
