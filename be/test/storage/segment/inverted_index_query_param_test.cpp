...
TEST_F(InvertedIndexQueryParamTest, TestBooleanWithField) {
    ...
    std::unique_ptr<InvertedIndexQueryParam> param;
    auto status = InvertedIndexQueryParamFactory::create_query_value(PrimitiveType::TYPE_BOOLEAN,
                                                                     &field, param);
    ASSERT_TRUE(status.ok());
    ASSERT_NE(param, nullptr);
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_BOOLEAN>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestTinyIntWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_TINYINT>*>(param.get())->value();
    EXPECT_EQ(*value, 42);
}
...
TEST_F(InvertedIndexQueryParamTest, TestSmallIntWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_SMALLINT>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestIntWithField) {
    ...
    auto status = InvertedIndexQueryParamFactory::create_query_value(PrimitiveType::TYPE_INT,
                                                                     &field, param);
    ASSERT_TRUE(status.ok());
    const auto* value = &static_cast<TypedInvertedIndexQueryParam<TYPE_INT>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestBigIntWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_BIGINT>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestLargeIntWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_LARGEINT>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestFloatWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_FLOAT>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestDoubleWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_DOUBLE>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestCharWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_CHAR>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestVarcharWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_VARCHAR>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestStringWithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_STRING>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestIPv4WithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_IPV4>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestIPv6WithField) {
    ...
    ASSERT_TRUE(status.ok());
    const auto* value =
            &static_cast<TypedInvertedIndexQueryParam<TYPE_IPV6>*>(param.get())->value();
...
TEST_F(InvertedIndexQueryParamTest, TestZeroValues) {
    // Test zero values for different types
    {
        ...
        ASSERT_TRUE(status.ok());
        const auto* value =
                &static_cast<TypedInvertedIndexQueryParam<TYPE_INT>*>(param.get())->value();
        EXPECT_EQ(*value, 0);
    }
    {
