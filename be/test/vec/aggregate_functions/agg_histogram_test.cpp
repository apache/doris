...
TEST_F(VAggHistogramTest, test_empty) {
    test_agg_histogram<DataTypeInt8>("histogram");
    test_agg_histogram<DataTypeInt16>("histogram");
    test_agg_histogram<DataTypeInt32>("histogram");
    test_agg_histogram<DataTypeInt64>("histogram");
    test_agg_histogram<DataTypeInt128>("histogram");

    test_agg_histogram<DataTypeDecimal<Decimal128>>("histogram");

    test_agg_histogram<DataTypeDate>("histogram");

    test_agg_histogram<DataTypeString>("histogram");
}

TEST_F(VAggHistogramTest, test_with_data) {
    test_agg_histogram<DataTypeInt32>("histogram", 8);
    test_agg_histogram<DataTypeInt128>("histogram", 10);

    test_agg_histogram<DataTypeDecimal<Decimal128>>("histogram", 12);

    test_agg_histogram<DataTypeDateTime>("histogram", 14);

    test_agg_histogram<DataTypeString>("histogram", 10);
}
