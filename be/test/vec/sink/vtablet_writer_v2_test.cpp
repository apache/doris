...
using pipeline::OperatorContext;
using vectorized::Block;
using vectorized::ColumnHelper;
using vectorized::DataTypeInt32;
using vectorized::DeltaWriterV2Pool;
using vectorized::Rows;
using vectorized::VExprContextSPtrs;
using vectorized::VTabletWriterV2;
namespace sink_test_utils = vectorized::sink_test_utils;
...
static TColumn create_int_column_desc(bool is_nullable) {
    ...
    column.column_type.type = TPrimitiveType::INT;
