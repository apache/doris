...
class VTestDeltaWriter : public ::testing::Test {
public:
    VTestDeltaWriter() {}
    ~VTestDeltaWriter() {}
...
//     const std::vector<SlotDescriptor*>& slots = tuple_desc->slots();
    ...
    auto columns = block.mutate_columns();
    {
        ...
        res = delta_writer->write_block(&block, {0});
        ASSERT_EQ(OLAP_SUCCESS, res);
    }
...
TEST_F(VTestDeltaWriter, sequence_col) {
    TCreateTabletReq request;
