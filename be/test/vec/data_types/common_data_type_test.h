...
=======
            if (is_decimal(data_type) || data_type->is_nullable() || is_struct(data_type) ||
                ...
                is_ip(data_type)) {
>>>>>>> 954311c1aad ([feature](semi-structure) support variant and index with many features)
                ASSERT_EQ(data_type->get_size_of_value_in_memory(),
                          meta_info.size_of_value_in_memory);
            } else {
...
=======
>>>>>>> ac71c3d55e5 ([feature](semi-structure) support variant and index with many features)
