...
protected:
    void SetUp() override {
        ...
        ADD_COUNTER_WITH_LEVEL(_custom_profile.get(), "SpillReadFileTime", TUnit::UNIT, 1);
        ADD_COUNTER_WITH_LEVEL(_custom_profile.get(), "SpillReadDerializeBlockTime", TUnit::UNIT,
                               1);
