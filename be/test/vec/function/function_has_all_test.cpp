...
TEST(FunctionHasAllTest, function_has_all_test) {
    std::string func_name = "has_all";
    {
        ...
        DataSet data_set = {
                {{vec1, vec2}, UInt8(1)}, {{vec1, vec3}, UInt8(0)}, {{vec1, vec4}, UInt8(1)},
                {{vec1, vec5}, UInt8(1)}, {{vec6, vec5}, UInt8(1)},
        };
    ...
    }
    {
        ...
        DataSet data_set = {
                {{vec1, vec2}, UInt8(1)}, {{vec1, vec3}, UInt8(0)}, {{vec1, vec4}, UInt8(1)},
                {{vec1, vec5}, UInt8(0)}, {{vec6, vec5}, UInt8(1)}, {{Null(), vec1}, Null()},
        };
    ...
    }
    {
        ...
        DataSet data_set = {
                {{vec1, vec2}, UInt8(1)}, {{vec1, vec3}, UInt8(0)}, {{vec1, vec4}, UInt8(1)},
                {{vec1, vec5}, UInt8(0)}, {{vec6, vec5}, UInt8(1)},
        };
    ...
    }
    {
        ...
        Array vec1 = {str_to_date_time("2022-11-02 00:00:00"),
                      str_to_date_time("2022-11-12 00:00:00"), str_to_date_time("")};
