...
TEST(function_bitmap_test, function_bitmap_min_test) {
    ...
    InputTypeSet input_types = {PrimitiveType::TYPE_OBJECT};
...
TEST(function_bitmap_test, function_bitmap_remove) {
    ...
    InputTypeSet input_types = {PrimitiveType::TYPE_OBJECT, PrimitiveType::TYPE_BIGINT};
...
TEST(function_bitmap_test, function_bitmap_and_count) {
    ...
    InputTypeSet input_types = {PrimitiveType::TYPE_OBJECT, PrimitiveType::TYPE_OBJECT};
