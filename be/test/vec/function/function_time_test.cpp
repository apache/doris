...
TEST(VTimestampFunctionsTest, unix_timestamp_test) {
...

    {
        InputTypeSet input_types = {PrimitiveType::TYPE_DATEV2};
        DataSet data_set = {
                {{std::string("2022-05-24")}, int64_t {1653321600}},
...
TEST(VTimestampFunctionsTest, convert_tz_test) {
...

    {
        ...
        // A 3.1 FE uses DATETIME (v1) for both the argument and result of convert_tz.
        InputTypeSet legacy_input_types = {PrimitiveType::TYPE_DATETIME,
                                           Consted {PrimitiveType::TYPE_VARCHAR},
                                           Consted {PrimitiveType::TYPE_VARCHAR}};
        DataSet legacy_data_set = {{{std::string {"2019-08-01 02:18:27"},
                                     std::string {"Asia/Shanghai"}, std::string {"UTC"}},
                                    std::string("2019-07-31 18:18:27")}};
        static_cast<void>(check_function<DataTypeDateTime, true>(func_name, legacy_input_types,
                                                                 legacy_data_set));
    }
...
TEST(VTimestampFunctionsTest, makedate_test) {
    ...
    DataSet data_set = {
            {{2021, 3}, std::string("2021-01-03")},
            {{2021, 95}, std::string("2021-04-05")},
            {{2021, 400}, std::string("2022-02-04")},
    };

    static_cast<void>(check_function<DataTypeDateV2, true>(func_name, input_types, data_set));
    // A 3.1 FE sends the same function and arguments with a DATE (v1) result slot.
...
TEST(VTimestampFunctionsTest, day_of_week_v2_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2001-02-03")}, int8_t {7}},
        };
    ...
    }
    {
        ...
        DataSet data_set = {
                {{std::string("2001-02-03 01:00:00")}, int8_t {7}},
...
TEST(VTimestampFunctionsTest, day_of_month_v2_test) {
...

    {
        ...
        DataSet data_set = {{{std::string("2020-01-01")}, int8_t {1}},
    ...
    }
    {
        ...
        DataSet data_set = {{{std::string("2020-01-01 01:00:00")}, int8_t {1}},
...
TEST(VTimestampFunctionsTest, day_of_year_v2_test) {
...

    {
        ...
        DataSet data_set = {{{std::string("2020-02-29")}, int16_t {60}}};
    ...
    }
    {
        ...
        DataSet data_set = {{{std::string("2020-02-29 01:00:00.1232")}, int16_t {60}}};
...
TEST(VTimestampFunctionsTest, week_of_year_v2_test) {
...

    {
        ...
        DataSet data_set = {{{std::string("2020-02-29")}, int8_t {9}}};
    ...
    }
    {
        ...
        DataSet data_set = {{{std::string("2020-02-29 01:00:00")}, int8_t {9}},
...
TEST(VTimestampFunctionsTest, hour_v2_test) {
    ...
    }
    {
        ...
        DataSet data_set = {
                {{std::string("2021-01-01 00:00:00.123")}, int8_t {0}},
...
TEST(VTimestampFunctionsTest, months_add_v2_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2020-10-23"), -4}, std::string("2020-06-23")},
...
TEST(VTimestampFunctionsTest, months_sub_v2_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2020-05-23"), 4}, std::string("2020-01-23")},
                {{std::string("2020-05-23"), -4}, std::string("2020-09-23")},
...
TEST(VTimestampFunctionsTest, days_add_v2_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2020-10-23"), -4}, std::string("2020-10-19")},
...
TEST(VTimestampFunctionsTest, days_sub_v2_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2020-05-23"), 4}, std::string("2020-05-19")},
                {{std::string("2020-05-23"), -4}, std::string("2020-05-27")},
...
TEST(VTimestampFunctionsTest, weeks_add_v2_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2020-10-23"), 5}, std::string("2020-11-27")},
...
TEST(VTimestampFunctionsTest, day_second_add_v2_test) {
    ...
    {
        DataSet data_set = {
                {{std::string("2020-10-23 00:00:11.123"), std::string("1 0:0:1")},
    ...
    {
        DataSet data_set = {
                {{std::string("2020-05-23 00:00:11.123"), std::string("1 10:11:12")},
    ...
    {
        DataSet data_set = {
                {{std::string("2020-05-23 00:00:11.123"), std::string("10 0:0:1")},
...
TEST(VTimestampFunctionsTest, dayname_test) {
...

    {
        ...
        DataSet data_set = {
                {{std::string("2007-02-03 00:00:11.123")}, std::string("Saturday")},
        };
...
TEST(VTimestampFunctionsTest, hours_add_v2_test) {
    std::string func_name = "hours_add";
    {
        ...
        DataSet data_set = {
                {{std::string("2020-10-23 10:00:00.123"), -4},
...
TEST(VTimestampFunctionsTest, minutes_add_v2_test) {
    std::string func_name = "minutes_add";
    {
        ...
        DataSet data_set = {
                {{std::string("2020-10-23 10:00:00.123"), int64_t(40)},
...
TEST(VTimestampFunctionsTest, year_of_week_test) {
    std::string func_name = "year_of_week";
    {
        InputTypeSet input_types = {PrimitiveType::TYPE_DATEV2};
        DataSet data_set = {
                {{std::string("2005-01-01")}, int16_t(2004)},
...
TEST(VTimestampFunctionsTest, now_legacy_datetime_result_for_old_plan) {
    ColumnsWithTypeAndName arguments;
    auto legacy_datetime_type = std::make_shared<DataTypeDateTime>();
    auto now =
            SimpleFunctionFactory::instance().get_function("now", arguments, legacy_datetime_type);
    ASSERT_NE(now, nullptr);

    FunctionUtils fn_utils(legacy_datetime_type, {}, false);
    auto* fn_ctx = fn_utils.get_fn_ctx();
    ASSERT_TRUE(now->open(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
    ASSERT_TRUE(now->open(fn_ctx, FunctionContext::THREAD_LOCAL).ok());

    Block now_block {{nullptr, legacy_datetime_type, "now"}};
    ASSERT_TRUE(now->execute(fn_ctx, now_block, {}, 0, 1).ok());
    const auto* now_const =
            check_and_get_column<ColumnConst>(now_block.get_by_position(0).column.get());
    ASSERT_NE(now_const, nullptr);
    ASSERT_NE(check_and_get_column<ColumnDateTime>(&now_const->get_data_column()), nullptr);

    // This is the expression shape generated by an old FE for
    ...
    EXPECT_TRUE(now->close(fn_ctx, FunctionContext::THREAD_LOCAL).ok());
    EXPECT_TRUE(now->close(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
}

TEST(VTimestampFunctionsTest, curdate_legacy_date_result_for_old_plan) {
    ColumnsWithTypeAndName arguments;
    auto legacy_date_type = std::make_shared<DataTypeDate>();
    auto curdate =
            SimpleFunctionFactory::instance().get_function("curdate", arguments, legacy_date_type);
    ASSERT_NE(curdate, nullptr);

    FunctionUtils fn_utils(legacy_date_type, {}, false);
    auto* fn_ctx = fn_utils.get_fn_ctx();
    ASSERT_TRUE(curdate->open(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
    ASSERT_TRUE(curdate->open(fn_ctx, FunctionContext::THREAD_LOCAL).ok());

    Block curdate_block {{nullptr, legacy_date_type, "curdate"}};
    ASSERT_TRUE(curdate->execute(fn_ctx, curdate_block, {}, 0, 1).ok());
    const auto* curdate_const =
            check_and_get_column<ColumnConst>(curdate_block.get_by_position(0).column.get());
    ASSERT_NE(curdate_const, nullptr);
    ...
    EXPECT_TRUE(curdate->close(fn_ctx, FunctionContext::THREAD_LOCAL).ok());
    EXPECT_TRUE(curdate->close(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
}

TEST(VTimestampFunctionsTest, utc_timestamp_legacy_datetime_result_for_old_plan) {
    ColumnsWithTypeAndName arguments;
    auto legacy_datetime_type = std::make_shared<DataTypeDateTime>();
    auto utc_timestamp = SimpleFunctionFactory::instance().get_function("utc_timestamp", arguments,
                                                                        legacy_datetime_type);
    ASSERT_NE(utc_timestamp, nullptr);

    FunctionUtils fn_utils(legacy_datetime_type, {}, false);
    auto* fn_ctx = fn_utils.get_fn_ctx();
    ASSERT_TRUE(utc_timestamp->open(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
    ASSERT_TRUE(utc_timestamp->open(fn_ctx, FunctionContext::THREAD_LOCAL).ok());

    Block utc_timestamp_block {{nullptr, legacy_datetime_type, "utc_timestamp"}};
    ASSERT_TRUE(utc_timestamp->execute(fn_ctx, utc_timestamp_block, {}, 0, 1).ok());
    const auto* utc_timestamp_const =
            check_and_get_column<ColumnConst>(utc_timestamp_block.get_by_position(0).column.get());
    ASSERT_NE(utc_timestamp_const, nullptr);
    ASSERT_NE(check_and_get_column<ColumnDateTime>(&utc_timestamp_const->get_data_column()),
              nullptr);
    ...
    EXPECT_TRUE(utc_timestamp->close(fn_ctx, FunctionContext::THREAD_LOCAL).ok());
    EXPECT_TRUE(utc_timestamp->close(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
}

TEST(VTimestampFunctionsTest, curtime_legacy_thrift_time_result_for_old_plan) {
    // TIME used thrift enum value 18 before it was removed from the IDL. Build the type exactly as
    // it arrives from a 3.1 FE and verify that the 4.0 BE normalizes it to TIMEV2.
    TScalarType scalar_type;
    scalar_type.__set_type(static_cast<TPrimitiveType::type>(18));
    TTypeNode type_node;
    ...
    auto legacy_time_type = DataTypeFactory::instance().create_data_type(type_desc);
    ASSERT_NE(legacy_time_type, nullptr);
    ASSERT_EQ(legacy_time_type->get_primitive_type(), TYPE_TIMEV2);

    ColumnsWithTypeAndName arguments;
    auto curtime =
            SimpleFunctionFactory::instance().get_function("curtime", arguments, legacy_time_type);
    ASSERT_NE(curtime, nullptr);

    FunctionUtils fn_utils(legacy_time_type, {}, false);
    auto* fn_ctx = fn_utils.get_fn_ctx();
    ASSERT_TRUE(curtime->open(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
    ASSERT_TRUE(curtime->open(fn_ctx, FunctionContext::THREAD_LOCAL).ok());

    Block block {{nullptr, legacy_time_type, "curtime"}};
    ASSERT_TRUE(curtime->execute(fn_ctx, block, {}, 0, 1).ok());
    const auto* result_const =
            check_and_get_column<ColumnConst>(block.get_by_position(0).column.get());
    ASSERT_NE(result_const, nullptr);
    EXPECT_NE(check_and_get_column<ColumnTimeV2>(&result_const->get_data_column()), nullptr);

    EXPECT_TRUE(curtime->close(fn_ctx, FunctionContext::THREAD_LOCAL).ok());
    EXPECT_TRUE(curtime->close(fn_ctx, FunctionContext::FRAGMENT_LOCAL).ok());
}
