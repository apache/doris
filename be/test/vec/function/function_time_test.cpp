...
TEST(VTimestampFunctionsTest, unix_timestamp_test) {
...

    {
        ...
        DataSet data_set = {
                ...
                {{Null()}, Null()}};
        static_cast<void>(
                check_function<DataTypeDecimal64, true, 3, 15>(func_name, input_types, data_set));
    }

    {
        ...
        DataSet data_set = {
                ...
                {{Null()}, Null()}};
        static_cast<void>(
                check_function<DataTypeDecimal64, true, 6, 18>(func_name, input_types, data_set));
    }
    ...
    // negative case
    {
        ...
        static_cast<void>(check_function<DataTypeDecimal64, true, 6, 18>(func_name, input_types,
                                                                         data_set, false, true));
    }
}
