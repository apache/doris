...
TEST_F(FunctionCastToDecimalTest, test_to_decimal128_from_float) {
    int table_index = 0;
    ...
    std::string regression_case_name = "test_cast_to_decimal128_from_float";
    ...
    from_float_double_test_func<TYPE_FLOAT, Decimal128V3>(
