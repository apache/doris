...
TEST_F(FunctionCastTest, strict_test_from_string_to_datetime) {
    ...
    DataSet data_set = {
            ...
            {{std::string("120102030405")}, std::string("2012-01-02 03:04:05")},
            {{std::string("20120102030405")}, std::string("2012-01-02 03:04:05")},
            {{std::string("120102030405.999")}, std::string("2012-01-02 03:04:05.999000")},
            ...
            {{std::string("2024-05-01T00:00+14:30")}, std::string("2024-04-30 17:30:00")},
...
TEST_F(FunctionCastTest, non_strict_test_from_string_to_datetime) {
    ...
    DataSet data_set = {
            ...
            {{std::string("2024-02-29T23:59:59.999999 UTC")},
             std::string("2024-02-29 23:59:59.999999")},
            {{std::string("70-01-01T00:00:00+14")}, Null()},
            {{std::string("0023-1-1T1:2:3. -00:00")}, std::string("0023-01-01 01:02:03")},
            ...
            // Invalid formats
            {{std::string("123.123")}, std::string("2012-03-12 03:00:00")},
...
TEST_F(FunctionCastTest, test_from_decimal_to_datetime) {
    ...
    // Test casting from Decimal(18,6)
    {
        ...
        DataSet data_set = {{{DECIMAL64(123123, 123456, 6)}, Null()},
                            {{DECIMAL64(20150102, 123456, 6)}, std::string("2015-01-02 12:34:56")},
                            {{DECIMAL64(20151231, 999999, 6)}, Null()},
                            {{Null()}, Null()}};
        check_function_for_cast<DataTypeDateTimeV2, 6>(input_types, data_set);
    }
}
...
TEST_F(FunctionCastTest, test_from_time_to_datetime) {
    ...
    //FIXME: now microsecond not useful
    {
        InputTypeSet input_types = {{PrimitiveType::TYPE_TIMEV2, 3}};
        DataSet data_set = {{{std::string("500:00:00.123456")}, std::string("2019-08-26 20:00:00")},
                            {{std::string("23:59:59")}, std::string("2019-08-06 23:59:59")},
                            {{std::string("-128:00:00")}, std::string("2019-07-31 16:00:00")},
                            {{Null()}, Null()}};
