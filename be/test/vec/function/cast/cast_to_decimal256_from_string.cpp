...
void FunctionCastToDecimalTest::from_string_to_decimal256_test_func() {
    ...
    from_string_test_func<Decimal256, 76, 0>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                             ofs_expected_result, regression_case_name, table_index,
                                             test_data_index);
    ++table_index;

    from_string_test_func<Decimal256, 76, 1>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                             ofs_expected_result, regression_case_name, table_index,
                                             test_data_index);
    ++table_index;
    from_string_test_func<Decimal256, 76, 1>(ofs_const_case, ofs_const_expected_result, ofs_case,
    ...
    from_string_test_func<Decimal256, 76, 38>(ofs_const_case, ofs_const_expected_result, ofs_case,
    ...
    from_string_test_func<Decimal256, 76, 38>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                              ofs_expected_result, regression_case_name,
                                              table_index, test_data_index, 38);
    ++table_index;
    from_string_test_func<Decimal256, 76, 38>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                              ofs_expected_result, regression_case_name,
    ...
    from_string_test_func<Decimal256, 76, 75>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                              ofs_expected_result, regression_case_name,
                                              table_index, test_data_index);
    ++table_index;
    from_string_test_func<Decimal256, 76, 75>(ofs_const_case, ofs_const_expected_result, ofs_case,
    ...
    from_string_test_func<Decimal256, 76, 75>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                              ofs_expected_result, regression_case_name,
                                              table_index, test_data_index, 75);
    ++table_index;
    from_string_test_func<Decimal256, 76, 75>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                              ofs_expected_result, regression_case_name,
                                              table_index, test_data_index, 100);
    ...
    from_string_test_func<Decimal256, 76, 76>(ofs_const_case, ofs_const_expected_result, ofs_case,
                                              ofs_expected_result, regression_case_name,
                                              table_index, test_data_index);
    ++table_index;
    if (FLAGS_gen_regression_case) {
