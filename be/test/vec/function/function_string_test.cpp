...
TEST(function_string_test, function_string_splitpart_test) {
    ...
    {
        DataSet data_set = {
                {{std::string("prefix_string1"), std::string("_"), INT(2)}, std::string("string1")},
                {{std::string("prefix__string2"), std::string("__"), INT(2)},
                 std::string("string2")},
                {{std::string("prefix__string2"), std::string("_"), INT(2)}, std::string("")}};

        check_function<DataTypeString, true>(func_name, input_types, data_set);
    }

    {
        DataSet data_set = {{{std::string("prefix_string2"), std::string("__"), 1}, Null()},
    ...
    {
        DataSet data_set = {{{std::string("prefix_string"), std::string("__"), Null()}, Null()},
...

    {
        DataSet data_set = {
                ...
                {{std::string("prefix1_string2"), std::string("_"), -1}, std::string("string2")},
                {{std::string("ab##123####xyz###o"), std::string("##"), -1}, std::string("o")},
                {{std::string("2019年9月-12月"), std::string("月"), -1}, std::string("")}};
    ...
    {
        DataSet data_set = {
                {{std::string("prefix2_string3"), std::string("_"), -2}, std::string("prefix2")},
                {{std::string("ab##123####xyz###o"), std::string("##"), -2}, std::string("xyz#")},
                {{std::string("2019年9月-12月"), std::string("月"), -2}, std::string("-12")}};
    ...
    {
        DataSet data_set = {
                {{std::string("prefix1_string2"), std::string("_"), -3}, Null()},
                {{std::string("ab##123####xyz###o"), std::string("##"), -3}, std::string("")},
                {{std::string("2019年9月-12月"), std::string("月"), -3}, std::string("2019年9")}};
    ...
    {
        DataSet data_set = {
                {{std::string("ab##123####xyz###o"), std::string("##"), -4}, std::string("123")}};
    ...
    {
        DataSet data_set = {
                {{std::string("ab##123####xyz###o"), std::string("##"), -5}, std::string("ab")}};

        check_function<DataTypeString, true>(func_name, input_types, data_set);
    }

    {
        DataSet data_set = {{{std::string("ab##123####xyz###o"), std::string("##"), -6}, Null()}};
