...
TEST(function_string_test, function_xpath_string_test) {
    ...
    TEST(function_string_test, function_printf_test) {
        ...
        {
            BaseInputTypeSet input_types = {TypeIndex::String, TypeIndex::Int32};
            DataSet data_set = {{{std::string("%1$d %1$d %1$d"), std::int32_t(123)},
                                 std::string("123 123 123")}};
            check_function_all_arg_comb<DataTypeString, true>(func_name, input_types, data_set);
        }

        // Test floating point types and precision
        {
            BaseInputTypeSet input_types = {TypeIndex::String, TypeIndex::Float32,
                                            TypeIndex::Float64};
            DataSet data_set = {
                    {{std::string("%f %f"), std::float_t(1.23), std::double_t(4.56)},
        ...
        // Test mixed types
        {
            ...
            DataSet data_set = {
                    {{std::string("int:%d float:%.1f str:%s int:%ld"), std::int32_t(-123),
