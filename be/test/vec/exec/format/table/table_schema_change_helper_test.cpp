...
TEST(MockTableSchemaChangeHelper, IcebergParquetSchemaChange) {
    schema::external::TStructField root_field;
    {
        ...
        {
            schema::external::TField col1_field;
            col1_field.name = "col1";
            col1_field.id = 1;
            col1_field.type = int_type;
            root_field.fields.emplace_back(col1_field);
        }

        {
            schema::external::TField col2_field;
            ...
            {
                schema::external::TField a_field;
                a_field.name = "a";
                a_field.id = 3;
                a_field.type = int_type;
                struct_field.fields.emplace_back(a_field);
            }

            col2_field.nestedField.struct_field = struct_field;
            root_field.fields.emplace_back(col2_field);
        }
    }
...
TEST(MockTableSchemaChangeHelper, IcebergOrcSchemaChange) {
    schema::external::TStructField root_field;
    {
...

        {
            ...
            {
                schema::external::TField b_field;
                b_field.name = "b";
                b_field.id = 4;
                b_field.type = int_type;
                struct_field.fields.emplace_back(b_field);
            }
    ...
    schema::external::TStructField table_schema;
    {
        ...
        }
        {
...

            {
                ...
                b_field.nestedField.array_field.item_field = b_element_filed;
            }
            struct_field.fields.emplace_back(b_field);
        }
        item_field->nestedField.struct_field = struct_field;
        col1_field.nestedField.array_field.item_field = item_field;
        table_schema.fields.emplace_back(col1_field);
    }
    ...
    schema::external::TStructField table_schema;
    {
        ...
        schema::external::TStructField struct_field;
        {
            ...
            a_field.type.type = TPrimitiveType::MAP;
            {
                ...
                map_field.key_field = key_field;
                map_field.value_field = value_field;
        ...
        }
        {
            ...
            {
                schema::external::TField c_field;
                c_field.name = "d";
                c_field.id = 4;
                c_field.type.type = TPrimitiveType::INT;
                nested_struct_field.fields.emplace_back(c_field);
            }
            {
                schema::external::TField d_field;
                ...
                nested_struct_field.fields.emplace_back(d_field);
            }
