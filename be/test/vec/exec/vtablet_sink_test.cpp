...
TEST_F(VOlapTableSinkTest, normal) {
    ...
    auto column_vector_int = assert_cast<vectorized::ColumnVector<int32_t>*>(column_ptr);
    int int_val = 12;
    ...
    auto column_vector_bigint = assert_cast<vectorized::ColumnVector<int64_t>*>(column_ptr);
    int64_t int64_val = 9;
    ...
    column_ptr = columns[col_idx++].get();
    auto column_vector_str = assert_cast<vectorized::ColumnString*>(column_ptr);
...
TEST_F(VOlapTableSinkTest, convert) {
    ...
    column_vector_str->insert_data("abc", 3);
    column_vector_str->insert_data("abcd", 4);
    column_vector_str->insert_data("abcde", 15);
...
TEST_F(VOlapTableSinkTest, decimal) {
    ...
    column_ptr = columns[col_idx++].get();
    auto column_vector_dec = assert_cast<vectorized::ColumnDecimal<vectorized::Decimal128>*>(column_ptr);
