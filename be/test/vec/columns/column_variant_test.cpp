...
TEST_F(ColumnVariantTest, replicate) {
...
TEST_F(ColumnVariantTest, get_field_info_all_types) {
    ...
    // Test Map which is invalid
    {
        ...
        EXPECT_EQ(info.scalar_type_id, PrimitiveType::TYPE_MAP)
                << "info.scalar_type_id: " << info.scalar_type_id;
    }
...
TEST_F(ColumnVariantTest, subcolumn_operations_coverage) {
    ...
    // Test parse_binary_from_sparse_column
    {
        ...
        // Test Nothing type
        {
            ...
            EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_NULL, data, res,
                                                             field_info));
        }
        ...
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_BOOLEAN, nullptr, res,
                                                         field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_UINT32, nullptr, res,
                                                         field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_UINT64, nullptr, res,
                                                         field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_DATE, nullptr, res,
                                                         field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_DATETIME, nullptr, res,
                                                         field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_DECIMAL32, nullptr,
                                                         res, field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_DECIMAL64, nullptr,
                                                         res, field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_DECIMALV2, nullptr,
                                                         res, field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_STRUCT, nullptr, res,
                                                         field_info));
        EXPECT_ANY_THROW(
                parse_binary_from_sparse_column(PrimitiveType::TYPE_MAP, nullptr, res, field_info));
        EXPECT_ANY_THROW(parse_binary_from_sparse_column(PrimitiveType::TYPE_VARIANT, nullptr, res,
                                                         field_info));
    }
