...
*/
    ...
    void _common_test_all_types(
        ...
        // decimal32
        {
            ...
            columns.push_back(column_decimal32_1->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal32_1->get_serde()};
            check_data(test_result_dir + "/column_decimal32_1_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal32_2->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal32_2->get_serde()};
            check_data(test_result_dir + "/column_decimal32_2_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal32_3->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal32_3->get_serde()};
            check_data(test_result_dir + "/column_decimal32_3_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal32_4->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal32_4->get_serde()};
            check_data(test_result_dir + "/column_decimal32_4_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal32_5->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal32_5->get_serde()};
            check_data(test_result_dir + "/column_decimal32_5_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        ...
        // decimal64
        {
            ...
            columns.push_back(column_decimal64_1->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal64_1->get_serde()};
            check_data(test_result_dir + "/column_decimal64_1_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal64_2->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal64_2->get_serde()};
            check_data(test_result_dir + "/column_decimal64_2_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal64_3->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal64_3->get_serde()};
            check_data(test_result_dir + "/column_decimal64_3_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        ...
        // decimal128
        {
            ...
            columns.push_back(column_decimal128_1->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal128_1->get_serde()};
            check_data(test_result_dir + "/column_decimal128_1_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal128_2->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal128_2->get_serde()};
            check_data(test_result_dir + "/column_decimal128_2_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal128_3->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal128_3->get_serde()};
            check_data(test_result_dir + "/column_decimal128_3_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        ...
        // decimal256
        {
            ...
            columns.push_back(column_decimal256_1->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal256_1->get_serde()};
            check_data(test_result_dir + "/column_decimal256_1_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal256_2->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal256_2->get_serde()};
            check_data(test_result_dir + "/column_decimal256_2_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
        {
            MutableColumns columns;
            columns.push_back(column_decimal256_3->get_ptr());
            DataTypeSerDeSPtrs serde = {dt_decimal256_3->get_serde()};
            check_data(test_result_dir + "/column_decimal256_3_" + function_name + ".out", columns,
                       serde, assert_callback);
        }
    }
    ...
    void _column_decimal_common_test(
            const std::string& function_name,
            std::function<void(const MutableColumns& load_cols)> callback) {
        {
            MutableColumns columns;
            columns.push_back(column_decimal32_1->get_ptr());
            DataTypeSerDeSPtrs serdes = {dt_decimal32_1->get_serde()};
...
TEST_F(ColumnDecimalTest, get_data_at_test) {
    auto cb = [](auto x, const MutableColumns& load_cols) {
        using T = decltype(x);
        for (const auto& source_column : load_cols) {
            auto* col_vec_src = assert_cast<ColumnDecimal<T>*>(source_column.get());
    ...
    _column_decimal_common_test_with_type("get_data_at", cb);
}
...
TEST_F(ColumnDecimalTest, insert_indices_from_test) {
    ...
    _column_decimal_common_test("insert_indices_from",
...
TEST_F(ColumnDecimalTest, insert_data_test) {
    _common_test_all_types("insert_data", assert_insert_data_from_callback);
}
