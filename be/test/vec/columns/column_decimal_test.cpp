...
TEST_F(ColumnDecimalTest, byte_size_test) {
...
TEST_F(ColumnDecimalTest, allocated_bytes_test) {
...
TEST_F(ColumnDecimalTest, compare_at_test) {
    {
...
TEST_F(ColumnDecimalTest, clone_resized_test) {
...
TEST_F(ColumnDecimalTest, compare_internal_test) {
    _column_decimal_common_test_with_type(assert_column_vector_compare_internal_callback);
}

TEST_F(ColumnDecimalTest, get_scale_test) {
...
TEST_F(ColumnDecimalTest, get_scale_multiplier_test) {
