...
TEST(VDateTimeValueTest, from_simple_format_test) {
    uint16_t year = 2022;
    uint8_t month = 5;
    uint8_t day = 24;

    {
        ...
        std::string origin_date = "2022-05-24";
        std::string date_format = "%Y-%m-%d";
        EXPECT_TRUE(date_v2.from_simple_format(date_format.data(), date_format.size(),
                                                 origin_date.data(), origin_date.size()));
    ...
    {
        DateV2Value<DateV2ValueType> date_v2;
        std::string origin_date = "2022-05-24 10:11:12";
        std::string date_format = "%Y-%m-%d";
        EXPECT_TRUE(date_v2.from_simple_format(date_format.data(), date_format.size(),
                                                 origin_date.data(), origin_date.size()));
    ...
    {
        DateV2Value<DateV2ValueType> date_v2;
        std::string origin_date = "10:11:12";
        std::string date_format = "%H:%i:%s";
        EXPECT_FALSE(date_v2.from_simple_format(date_format.data(), date_format.size(),
                                                 origin_date.data(), origin_date.size()));
    ...
    }
    {
        ...
        EXPECT_TRUE(date_v2.from_simple_format(date_format.data(), date_format.size(),
                                               origin_date.data(), origin_date.size()));
        EXPECT_TRUE(date_v2.hour() == 10);
        EXPECT_TRUE(date_v2.minute() == 11);
        EXPECT_TRUE(date_v2.second() == 12);
    }
    {
        DateV2Value<DateTimeV2ValueType> datetime_v2;
        std::string origin_date = "2022-05-24 10:11:12";
        std::string date_format = "%Y-%m-%d %H:%i:%s";
        EXPECT_TRUE(datetime_v2.from_simple_format(date_format.data(), date_format.size(),
                                                     origin_date.data(), origin_date.size()));
        EXPECT_TRUE(datetime_v2.year() == year);
        EXPECT_TRUE(datetime_v2.month() == month);
        EXPECT_TRUE(datetime_v2.day() == day);
        EXPECT_TRUE(datetime_v2.hour() == 10);
        EXPECT_TRUE(datetime_v2.minute() == 11);
        EXPECT_TRUE(datetime_v2.second() == 12);
