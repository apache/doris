...
TEST_F(VectorSearchTest, TestAnnIndexStatsInitialization) {
    ...
    // Test setting values
    stats.search_costs_ns.set(static_cast<int64_t>(1000));
    stats.load_index_costs_ns.set(static_cast<int64_t>(2000));
...
TEST_F(VectorSearchTest, TestAnnIndexStatsCopyConstructor) {
    ...
    original.search_costs_ns.set(static_cast<int64_t>(1500));
    original.load_index_costs_ns.set(static_cast<int64_t>(2500));
