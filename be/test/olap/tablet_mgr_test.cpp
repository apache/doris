...
TEST_F(TabletMgrTest, CreateTablet) {
    ...
    TabletSharedPtr tablet = _tablet_mgr->get_tablet(111, 0, 3333);
    ...
    OLAPStatus drop_st = _tablet_mgr->drop_tablet(111, 0, 3333, false);
...
TEST_F(TabletMgrTest, DropTablet) {
    ...
    ASSERT_TRUE(drop_st == OLAP_SUCCESS);
    tablet = _tablet_mgr->get_tablet(111, 0, 3333);
    ASSERT_TRUE(tablet != nullptr);

    // drop exist tablet will be success
    drop_st = _tablet_mgr->drop_tablet(111, 0, 3333, false);
    ASSERT_TRUE(drop_st == OLAP_SUCCESS);
    tablet = _tablet_mgr->get_tablet(111, 0, 3333);
    ASSERT_TRUE(tablet == nullptr);
    tablet = _tablet_mgr->get_tablet(111, 0, 3333, true);
    ASSERT_TRUE(tablet != nullptr);
