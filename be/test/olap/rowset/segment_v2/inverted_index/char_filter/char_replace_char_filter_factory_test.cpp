...
ReaderPtr create_char_replace_filter(const std::string& text, const std::string& pattern,
    ...
    Settings settings;
    settings.set(CHAR_REPLACE_CHAR_FILTER_PATTERN, pattern);
    settings.set(CHAR_REPLACE_CHAR_FILTER_REPLACEMENT, replacement);
...
TEST_F(CharReplaceCharFilterFactoryTest, FactoryInitialization) {
    Settings settings;
    settings.set(CHAR_REPLACE_CHAR_FILTER_PATTERN, ",");
    settings.set(CHAR_REPLACE_CHAR_FILTER_REPLACEMENT, " ");
