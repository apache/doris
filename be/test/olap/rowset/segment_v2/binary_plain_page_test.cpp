...
public:
    ...
    void TestBinarySeekByValueSmallPage() {
        ...
        ColumnBlock block(get_type_info(OLAP_FIELD_TYPE_VARCHAR), (uint8_t*)values, null_bitmap,
                          size, &pool);
        ...
        ColumnBlock block2(get_type_info(OLAP_FIELD_TYPE_VARCHAR), (uint8_t*)values2, null_bitmap,
                           1, &pool);
