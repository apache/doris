...
protected:
    ...
    vectorized::Block create_full_block(const TabletSchemaSPtr& tablet_schema,
                                        int32_t start_key = 1) {
    ...
    vectorized::Block create_column_block(const TabletSchemaSPtr& tablet_schema,
                                          const std::vector<uint32_t>& column_ids,
                                          int32_t row_count = 8, int32_t start_key = 1) {
