...
TEST_F(TestSchemaTest, TestGetFieldTypeByPrimitiveType) {
    ...
    EXPECT_EQ(FieldType::OLAP_FIELD_TYPE_DECIMAL256,
              TabletColumn::get_field_type_by_type(PrimitiveType::TYPE_DECIMAL256));
    EXPECT_EQ(FieldType::OLAP_FIELD_TYPE_IPV4,
              TabletColumn::get_field_type_by_type(PrimitiveType::TYPE_IPV4));
    EXPECT_EQ(FieldType::OLAP_FIELD_TYPE_IPV6,
              TabletColumn::get_field_type_by_type(PrimitiveType::TYPE_IPV6));
