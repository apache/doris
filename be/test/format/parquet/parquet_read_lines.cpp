...
+---------------------------+------------------------------+--------------------------------+----------------------+----------------------------+--------------------------+----------------------------+
|                          1|                             2|                               2|                     2|                           2|                 2.1400001|          2.1400000000000001|
|                          0|                             6|                               6|                     6|                           6|                6.13999987|          6.1399999999999997|
|                          0|                             8|                               8|                     8|                           8|                8.14000034|          8.1400000000000006|
+---------------------------+------------------------------+--------------------------------+----------------------+----------------------------+--------------------------+----------------------------+
)__DORIS__";
...
+----------------------------+----------------------+--------------------------+
|          2.1400000000000001|                     2|                 2.1400001|
|         -5.1399999999999997|                    -5|               -5.13999987|
|          10.140000000000001|                    10|                10.1400003|
+----------------------------+----------------------+--------------------------+
)__DORIS__";
    read_parquet_lines(numeric_types, types, read_lines, block_dump);
}
...
|double_col(Nullable(DOUBLE))|int_col(Nullable(INT))|float_col(Nullable(FLOAT))|
+----------------------------+----------------------+--------------------------+
|          4.1399999999999997|                     4|                4.13999987|
|         -7.1399999999999997|                    -7|               -7.13999987|
|         -9.1400000000000006|                    -9|               -9.14000034|
+----------------------------+----------------------+--------------------------+
)__DORIS__";
    read_parquet_lines(numeric_types, types, read_lines, block_dump);
}
