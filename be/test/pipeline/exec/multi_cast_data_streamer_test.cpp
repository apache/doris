...
public:
    ...
    void SetUp() override {
...

        {
            ...
            ADD_COUNTER_WITH_LEVEL(custom_profile.get(), "SpillReadDeserializeBlockTime", TUnit::UNIT,
                                   1);
        ...
        for (int i = 0; i < cast_sender_count; i++) {
            ...
            ADD_TIMER_WITH_LEVEL(source_custom_profiles[i].get(), "SpillReadDeserializeBlockTime", 1);
