...
TEST_F(S3UTILTest, is_s3_express_context) {
    EXPECT_TRUE(is_s3_express("bucket--use1-az4--x-s3", "https://s3.us-east-1.amazonaws.com",
                              "us-east-1"));
    EXPECT_TRUE(is_s3_express("bucket--use1-az4--x-s3", "s3.us-east-1.amazonaws.com", "us-east-1"));
    EXPECT_TRUE(is_s3_express("bucket--cnn1-az1--x-s3", "https://s3.cn-north-1.amazonaws.com.cn",
                              "cn-north-1"));
    ...
    EXPECT_FALSE(is_s3_express("bucket--use1-az4--x-s3", "https://minio.example.com", "us-east-1"));
    EXPECT_FALSE(is_s3_express("bucket--use1-az4--x-s3",
                               "https://s3.us-east-1.amazonaws.com.example.com", "us-east-1"));
    EXPECT_FALSE(is_s3_express("bucket--x-s3", "https://s3.us-east-1.amazonaws.com", "us-east-1"));
    EXPECT_FALSE(
            is_s3_express("bucket--zone--x-s3", "https://s3.us-east-1.amazonaws.com", "us-east-1"));
    ...
    EXPECT_FALSE(is_s3_express("bucket--use1-az4--x-s3", "http://s3.us-east-1.amazonaws.com",
                               "us-east-1"));
    EXPECT_FALSE(is_s3_express("bucket--use1-az4--x-s3", "https://s3.us-east-1.amazonaws.com",
                               "us-west-2"));
    EXPECT_FALSE(is_s3_express("bucket--use1-az4--x-s3",
