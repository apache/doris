...
TEST(function_string_test, function_parse_url_test) {
...

    {
        ...
        DataSet data_set = {
                ...
                {{std::string("http://www.baidu.com:9090?a=b"), std::string("ref")}, {Null()}},
                {{std::string("http://[2001:db8::1]:8080/a?x=1#r"), std::string("HOST")},
                 {std::string("[2001:db8::1]")}},
                {{std::string("http://[2001:db8::1]:8080/a?x=1#r"), std::string("PORT")},
                 {std::string("8080")}},
                {{std::string("http://example.com/path/user@evil:123/file"), std::string("HOST")},
                 {std::string("example.com")}},
                {{std::string("http://example.com/index.html?u=a@evil:123"), std::string("HOST")},
                 {std::string("example.com")}},
                {{std::string("http://user:pass@example.com:8080/path"), std::string("USERINFO")},
                 {std::string("user:pass")}},
                {{std::string("http://h?x=1"), std::string("AUTHORITY")}, {std::string("h")}},
                {{std::string("http://h#r"), std::string("HOST")}, {std::string("h")}},
                {{std::string("http://h/p#f?q"), std::string("QUERY")}, {Null()}},
                {{std::string("http://h/p#f?q"), std::string("PATH")}, {std::string("/p")}},
                {{std::string("http://h?x=/not-a-path"), std::string("PATH")}, {std::string("")}},
                {{std::string("http://h#f/not-a-file"), std::string("FILE")}, {std::string("")}},
                {{std::string("http://h/a%40b:c?q=x%23y"), std::string("PATH")},
                 {std::string("/a%40b:c")}},
...

    {
        ...
        DataSet data_set = {
                ...
                {{std::string("http://facebook.com/path/p1"), std::string("QUERY"),
                  std::string("q")},
                 {Null()}},
                {{std::string("http://fb.com/path#fragment?q=1"), std::string("QUERY"),
                  std::string("q")},
                 {Null()}},
                {{std::string("http://fb.com/path/p1.p?q=1#f"), std::string("HOST"),
                  std::string("q")},
