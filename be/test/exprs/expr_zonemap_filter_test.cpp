...
TEST(ExprZonemapFilterTest, RuntimeFilterWrapperNullAwareZonemapKeepsZonesWithNull) {
    auto type = int_type();
    auto slot = make_slot(0, type);
    ...
    auto runtime_filter = VRuntimeFilterWrapper::create_shared(make_in_predicate_node(false, 1),
