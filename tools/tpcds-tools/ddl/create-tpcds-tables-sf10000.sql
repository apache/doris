...
DISTRIBUTED BY HASH(cs_item_sk, cs_order_number) BUCKETS 256
PROPERTIES (
  "replication_num" = "1",
...
DISTRIBUTED BY HASH(inv_item_sk, inv_warehouse_sk) BUCKETS 256
PROPERTIES (
  "replication_num" = "1"
);
...
DISTRIBUTED BY HASH(cr_item_sk, cr_order_number) BUCKETS 256
PROPERTIES (
  "replication_num" = "1",
  "colocate_with" = "catalog"
);
...
DISTRIBUTED BY HASH(ca_address_sk) BUCKETS 256
PROPERTIES (
  "replication_num" = "1"
);
...
DISTRIBUTED BY HASH(wr_item_sk, wr_order_number) BUCKETS 256
PROPERTIES (
  "replication_num" = "1",
  "colocate_with" = "web"
);
