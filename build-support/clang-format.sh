...
if [[ ${CLANG_FORMAT_VERSION} -lt 16 ]]; then
    echo "clang-format version should equal or higher than 16, please install clang-format version 16 or upgrade your clang-format version to 16"
    exit 1
fi
