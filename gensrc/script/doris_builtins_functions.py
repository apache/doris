...
visible_functions = {
    ...
    "Conditional": [
        ...
        [['esquery'], 'BOOLEAN', ['ARRAY_BOOLEAN', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_TINYINT', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_SMALLINT', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_INT', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_BIGINT', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_LARGEINT', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_FLOAT', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DOUBLE', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_TIME', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DATE', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DATETIME', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_TIMEV2', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DATEV2', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DATETIMEV2', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_CHAR', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_VARCHAR', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_JSONB', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DECIMALV2', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DECIMAL32', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DECIMAL64', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_DECIMAL128', 'VARCHAR'], ''],
        [['esquery'], 'BOOLEAN', ['ARRAY_STRING', 'VARCHAR'], ''],
