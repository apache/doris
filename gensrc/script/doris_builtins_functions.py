...
visible_functions = {
    ...
    "Timestamp": [
        ...
        [['from_unixtime'], 'VARCHAR', ['DECIMAL64'], 'ALWAYS_NULLABLE'],
        [['from_unixtime'], 'VARCHAR', ['DECIMAL64', 'VARCHAR'], 'ALWAYS_NULLABLE'],
        [['from_unixtime'], 'VARCHAR', ['DECIMAL64', 'STRING'], 'ALWAYS_NULLABLE'],
