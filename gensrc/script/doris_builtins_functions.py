...
visible_functions = [
    ...
    [['not_empty'], 'BOOLEAN', ['VARCHAR'],
        '_ZN5doris15StringFunctions9not_emptyEPN9doris_udf15FunctionContextERKNS1_9StringValE'],
    [['empty'], 'BOOLEAN', ['VARCHAR'],
        '_ZN5doris15StringFunctions5emptyEPN9doris_udf15FunctionContextERKNS1_9StringValE'],
    [['space'], 'VARCHAR', ['INT'],
