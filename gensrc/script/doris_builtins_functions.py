...
visible_functions = {
    ...
    "IP": [
        ...
        [['ipv4_cidr_to_range'], 'STRUCT<IPV4, IPV4>', ['TINYINT', 'SMALLINT'], ''],
        [['ipv4_cidr_to_range'], 'STRUCT<IPV4, IPV4>', ['SMALLINT', 'SMALLINT'], ''],
        [['ipv4_cidr_to_range'], 'STRUCT<IPV4, IPV4>', ['INT', 'SMALLINT'], ''],
        [['ipv4_cidr_to_range'], 'STRUCT<IPV4, IPV4>', ['BIGINT', 'SMALLINT'], ''],
