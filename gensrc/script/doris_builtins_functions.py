...
visible_functions = [
    ...
    [['array_remove'], 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', 'BOOLEAN', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'TINYINT'], ''],
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'TINYINT', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'SMALLINT'], ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'SMALLINT', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_INT',       ['ARRAY_INT', 'INT'], ''],
    [['array_remove'], 'ARRAY_INT',       ['ARRAY_INT', 'INT', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'BIGINT'], ''],
    [['array_remove'], 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'BIGINT', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', 'LARGEINT'], ''],
    [['array_remove'], 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', 'LARGEINT', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_FLOAT',     ['ARRAY_FLOAT', 'FLOAT'], ''],
    [['array_remove'], 'ARRAY_FLOAT',     ['ARRAY_FLOAT', 'FLOAT', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', 'DOUBLE'], ''],
    [['array_remove'], 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', 'DOUBLE', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', 'DECIMALV2'], ''],
    [['array_remove'], 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', 'DECIMALV2', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DECIMAL32', ['ARRAY_DECIMAL32', 'DECIMAL32'], ''],
    [['array_remove'], 'ARRAY_DECIMAL32', ['ARRAY_DECIMAL32', 'DECIMAL32', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DECIMAL64', ['ARRAY_DECIMAL64', 'DECIMAL64'], ''],
    [['array_remove'], 'ARRAY_DECIMAL64', ['ARRAY_DECIMAL64', 'DECIMAL64', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DECIMAL128', ['ARRAY_DECIMAL128', 'DECIMAL128'], ''],
    [['array_remove'], 'ARRAY_DECIMAL128', ['ARRAY_DECIMAL128', 'DECIMAL128', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DATETIME',  ['ARRAY_DATETIME', 'DATETIME'], ''],
    [['array_remove'], 'ARRAY_DATETIME',  ['ARRAY_DATETIME', 'DATETIME', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DATE',      ['ARRAY_DATE', 'DATE'], ''],
    [['array_remove'], 'ARRAY_DATE',      ['ARRAY_DATE', 'DATE', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DATETIMEV2',  ['ARRAY_DATETIMEV2', 'DATETIMEV2'], ''],
    [['array_remove'], 'ARRAY_DATETIMEV2',  ['ARRAY_DATETIMEV2', 'DATETIMEV2', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_DATEV2',    ['ARRAY_DATEV2', 'DATEV2'], ''],
    [['array_remove'], 'ARRAY_DATEV2',    ['ARRAY_DATEV2', 'DATEV2', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', 'VARCHAR'], ''],
    [['array_remove'], 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', 'VARCHAR', 'BOOLEAN'], ''],
    [['array_remove'], 'ARRAY_STRING',    ['ARRAY_STRING', 'STRING'], ''],
    [['array_remove'], 'ARRAY_STRING',    ['ARRAY_STRING', 'STRING', 'BOOLEAN'], ''],
