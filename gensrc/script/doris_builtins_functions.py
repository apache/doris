...
visible_functions = [
    ...
    [['array_with_constant'], 'ARRAY_BOOLEAN', ['BIGINT', 'BOOLEAN'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_TINYINT', ['BIGINT', 'TINYINT'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_SMALLINT', ['BIGINT','SMALLINT'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_INT', ['BIGINT', 'INT'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_BIGINT', ['BIGINT', 'BIGINT'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_LARGEINT', ['BIGINT', 'LARGEINT'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_DATETIME', ['BIGINT', 'DATETIME'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_DATE', ['BIGINT', 'DATE'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_FLOAT', ['BIGINT', 'FLOAT'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_DOUBLE', ['BIGINT', 'DOUBLE'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_DECIMALV2', ['BIGINT', 'DECIMALV2'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_VARCHAR', ['BIGINT', 'VARCHAR'], '', '', '', 'vec', ''],
    [['array_with_constant'], 'ARRAY_STRING', ['BIGINT', 'STRING'], '', '', '', 'vec', ''],
