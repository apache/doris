...
visible_functions = [
    ...
    [['bitmap_count'], 'BIGINT', ['BITMAP'],
        ...
        '', '', 'vec', ''],
    [['bitmap_and_not_count'], 'BIGINT', ['BITMAP'],
        '_ZN5doris15BitmapFunctions12bitmap_and_not_countEPN9doris_udf15FunctionContextERKNS1_9StringValE',
        '', '', '', ''],
    [['bitmap_empty'], 'BITMAP', [],
    ...
    [['bitmap_and_not'], 'BITMAP', ['BITMAP','BITMAP'],
        '_ZN5doris15BitmapFunctions10bitmap_and_notEPN9doris_udf15FunctionContextERKNS1_9StringValES6_',
        '', '', '', ''],
