...
visible_functions = [
    ...
    [['bitmap_max'], 'BIGINT', ['BITMAP'],
        ...
        '', '', '', ''],
    [['bitmap_subset_in_range'], 'BITMAP', ['BITMAP', 'INT', 'INT'],
        '_ZN5doris15BitmapFunctions22bitmap_subset_in_rangeEPN9doris_udf15FunctionContextERKNS1_9StringValERKNS1_6IntValES9_',
        '', '', 'vec', ''],
