...
visible_functions = [
    ...
    [['from_days'], 'DATE', ['INT'],
        ...
        '', '', 'vec', 'ALWAYS_NULLABLE'],
    [['first_month_day'], 'DATE', ['DATETIME'],
        '_ZN5doris18TimestampFunctions15first_month_dayEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE',
        '', '', 'vec', 'ALWAYS_NULLABLE'],
    [['first_month_day'], 'DATE', ['DATE'],
        '_ZN5doris18TimestampFunctions15first_month_dayEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE',
        '', '', 'vec', 'ALWAYS_NULLABLE'],
    [['first_month_day'], 'DATEV2', ['DATETIMEV2'],
        '', '', '', 'vec', 'ALWAYS_NULLABLE'],
    [['first_month_day'], 'DATEV2', ['DATEV2'],
        '','', '', 'vec', 'ALWAYS_NULLABLE'],
    [['to_days'], 'INT', ['DATE'],
