...
visible_functions = [
    ...
    [['array_sort'], 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', 'INT'], ''],
    [['array_sort'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'INT'], ''],
    [['array_sort'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'INT'], ''],
    [['array_sort'], 'ARRAY_INT',       ['ARRAY_INT', 'INT'], ''],
    [['array_sort'], 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'INT'], ''],
    [['array_sort'], 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', 'INT'], ''],
    [['array_sort'], 'ARRAY_DATETIME',  ['ARRAY_DATETIME', 'INT'], ''],
    [['array_sort'], 'ARRAY_DATE',      ['ARRAY_DATE', 'INT'], ''],
    [['array_sort'], 'ARRAY_DATETIMEV2',  ['ARRAY_DATETIMEV2', 'INT'], ''],
    [['array_sort'], 'ARRAY_DATEV2',      ['ARRAY_DATEV2', 'INT'], ''],
    [['array_sort'], 'ARRAY_FLOAT',     ['ARRAY_FLOAT', 'INT'], ''],
    [['array_sort'], 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', 'INT'], ''],
    [['array_sort'], 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', 'INT'], ''],
    [['array_sort'], 'ARRAY_DECIMAL32', ['ARRAY_DECIMAL32', 'INT'], ''],
    [['array_sort'], 'ARRAY_DECIMAL64', ['ARRAY_DECIMAL64', 'INT'], ''],
    [['array_sort'], 'ARRAY_DECIMAL128', ['ARRAY_DECIMAL128', 'INT'], ''],
    [['array_sort'], 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', 'INT'], ''],
    [['array_sort'], 'ARRAY_STRING',    ['ARRAY_STRING', 'INT'], ''],
