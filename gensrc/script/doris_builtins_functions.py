...
<<<<<<< HEAD
    ...
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'SMALLINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'INT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'BIGINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'LARGEINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'DECIMALV2'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'SMALLINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'INT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'BIGINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'LARGEINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'DECIMALV2'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_INT',       ['ARRAY_INT', 'INT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_INT',       ['ARRAY_INT', 'BIGINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_INT',       ['ARRAY_INT', 'LARGEINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_INT',       ['ARRAY_INT', 'DECIMALV2'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'BIGINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'LARGEINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'DECIMALV2'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', 'LARGEINT'], '', '', '', 'vec', ''],
    [['array_remove'], 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', 'DECIMALV2'], '', '', '', 'vec', ''],
