...
visible_functions = [
    ...
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_BOOLEAN', 'ARRAY_BOOLEAN'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_TINYINT', 'ARRAY_TINYINT'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_SMALLINT', 'ARRAY_SMALLINT'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_INT', 'ARRAY_INT'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_BIGINT', 'ARRAY_BIGINT'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_LARGEINT', 'ARRAY_LARGEINT'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_FLOAT', 'ARRAY_FLOAT'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DOUBLE', 'ARRAY_DOUBLE'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DECIMALV2', 'ARRAY_DECIMALV2'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DECIMAL32', 'ARRAY_DECIMAL32'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DECIMAL64', 'ARRAY_DECIMAL64'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DECIMAL128', 'ARRAY_DECIMAL128'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DATETIME', 'ARRAY_DATETIME'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DATE', 'ARRAY_DATE'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DATETIMEV2', 'ARRAY_DATETIMEV2'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_DATEV2', 'ARRAY_DATEV2'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_VARCHAR', 'ARRAY_VARCHAR'], ''],
    [['array_contains_any'], 'BOOLEAN', ['ARRAY_STRING', 'ARRAY_STRING'], ''],
