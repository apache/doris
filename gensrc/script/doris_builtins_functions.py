...
visible_functions = {
    ...
    "IP": [
        ...
        [['ipv4_string_to_num','inet_aton'], 'BIGINT', ['VARCHAR'], 'ALWAYS_NOT_NULLABLE'],
        [['ipv4_string_to_num','inet_aton'], 'BIGINT', ['STRING'], 'ALWAYS_NOT_NULLABLE'],
        ...
        [['ipv6_string_to_num','inet6_aton'], 'VARCHAR', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['ipv6_string_to_num','inet6_aton'], 'STRING', ['STRING'], 'ALWAYS_NULLABLE'],
        ...
        [['is_ipv4_compat'], 'BOOLEAN', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['is_ipv4_compat'], 'BOOLEAN', ['STRING'], 'ALWAYS_NULLABLE'],
        [['is_ipv4_mapped'], 'BOOLEAN', ['VARCHAR'], 'ALWAYS_NULLABLE'],
        [['is_ipv4_mapped'], 'BOOLEAN', ['STRING'], 'ALWAYS_NULLABLE'],
