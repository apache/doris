...
enum TFileFormatType {
    ...
    FORMAT_PROTO,
    //csv withnames
    FORMAT_CSVWITHNAMES_PLAIN,
    FORMAT_CSVWITHNAMES_GZ,
    FORMAT_CSVWITHNAMES_LZO,
    FORMAT_CSVWITHNAMES_BZ2,
    FORMAT_CSVWITHNAMES_LZ4FRAME,
    FORMAT_CSVWITHNAMES_LZOP,
    FORMAT_CSVWITHNAMES_DEFLATE,
    //csv withnamesandtypes
    FORMAT_CSVWITHNAMESANDTYPES_PLAIN,
    FORMAT_CSVWITHNAMESANDTYPES_GZ,
    FORMAT_CSVWITHNAMESANDTYPES_LZO,
    FORMAT_CSVWITHNAMESANDTYPES_BZ2,
    FORMAT_CSVWITHNAMESANDTYPES_LZ4FRAME,
    FORMAT_CSVWITHNAMESANDTYPES_LZOP,
    FORMAT_CSVWITHNAMESANDTYPES_DEFLATE
}
