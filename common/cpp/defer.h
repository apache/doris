...
//   };
//
#define DORIS_COMMON_DEFER_IMPL(line, counter)                                 \
  ::doris::DeferFn defer_fn_##line##_##counter = [&]()
#define DORIS_COMMON_DEFER_EXPAND(line, counter)                               \
  DORIS_COMMON_DEFER_IMPL(line, counter)
#define DORIS_COMMON_DEFER DORIS_COMMON_DEFER_EXPAND(__LINE__, __COUNTER__)
...
//
// Usage:
//   DORIS_COMMON_DEFER_COPY(param1, param2) {
...
//       DORIS_COMMON_DEFER_COPY(a, b) mutable {
//          a += 1;
//          b *= 2;
//       };
//   }
...
// the captured values.
#define DORIS_COMMON_DEFER_COPY_IMPL(line, counter, ...)                       \
  ::doris::DeferFn defer_fn_##line##_##counter = [&, __VA_ARGS__ ]()
#define DORIS_COMMON_DEFER_COPY_EXPAND(line, counter, ...)                     \
  DORIS_COMMON_DEFER_COPY_IMPL(line, counter, __VA_ARGS__)
#define DORIS_COMMON_DEFER_COPY(...)                                           \
  DORIS_COMMON_DEFER_COPY_EXPAND(__LINE__, __COUNTER__, __VA_ARGS__)
