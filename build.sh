...
#export CC="/data/common/clang-11/bin/clang --gcc-toolchain=/usr/local/gcc-10.1.0"
#export CXX="/data/common/clang-11/bin/clang++ --gcc-toolchain=/usr/local/gcc-10.1.0"
