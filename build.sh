...
Usage: $0 <options>
  ...
  Eg.
    ...
    $0 --be-extension-ignore hadoop-hudi-scanner   build be-java-extensions, choose which modules to ignore. Multiple modules separated by commas, like --be-extension-ignore hadoop-hudi-scanner
